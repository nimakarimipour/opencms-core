...
public class CmsSetupTestResult {
   ...
   *
   * <p>This string will be displayed in a help bubble.
   *
   * <p>
   *
  ...
  /**
   * Returns true if the test found a violated condition. It is assumed that it will be impossible
   * to run OpenCms.
   *
   * <p>
   *
  ...
  /**
   * Returns true if the test found a questionable condition. It is possible that OpenCms will not
   * run.
   *
   * <p>
   *
