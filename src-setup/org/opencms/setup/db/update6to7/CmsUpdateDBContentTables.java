...
public class CmsUpdateDBContentTables extends A_CmsUpdateDBPart {
  ...
  /**
   * Constant for the sql query to read the max publish tag.
   *
   * <p>
   */
  ...
  /**
   * Constant for the sql query to transfer the backup contents.
   *
   * <p>
   */
  ...
  /**
   * Constant for the table CMS_BACKUP_CONTENTS.
   *
   * <p>
   */
  ...
  /**
   * Constant for the table CMS_ONLINE_CONTENTS.
   *
   * <p>
   */
  ...
  /**
   * After the transfer the tables CMS_ONLINE_CONTENTS and CMS_BACKUP contents are dropped as they
