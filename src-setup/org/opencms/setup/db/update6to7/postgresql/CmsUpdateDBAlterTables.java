...
public class CmsUpdateDBAlterTables extends org.opencms.setup.db.update6to7.CmsUpdateDBAlterTables {
  ...
  /**
   * Constant for the sql query to alter table field.
   *
   * <p>
   */
  ...
  /**
   * Constant for the sql query to set default value of table field.
   *
   * <p>
   */
  ...
  /**
   * Constant for the sql query to drop default value of table field.
   *
   * <p>
   */
  ...
  /**
   * Constant for the sql query to set not null values of table field.
   *
   * <p>
   */
  ...
  /**
   * Constant for the sql query to drop not null constraint of table field.
   *
   * <p>
   */
  ...
  /**
   * Constant for the sql replacement of the field name.
   *
   * <p>
   */
  ...
  /**
   * Constant for the sql replacement of the field type.
   *
   * <p>
   */
  ...
  /**
   * Constant for the sql replacement of the field default value.
   *
   * <p>
   */
