...
public class CmsUpdateDBProjectId extends A_CmsUpdateDBPart {
   ...
   * <p>
   */
  protected static final String QUERY_CREATE_HISTORY_PROJECTS_TABLE =
   ...
   * <p>
   */
  protected static final String[] RESOURCE_TABLES = {
    "CMS_OFFLINE_RESOURCES", "CMS_ONLINE_RESOURCES"
  };
   ...
   * <p>
   */
  protected static final List<String> RESOURCES_TABLES_LIST =
      Collections.unmodifiableList(Arrays.asList(RESOURCE_TABLES));
  ...
  protected static final String[] TABLES = {
    "CMS_OFFLINE_RESOURCES", "CMS_ONLINE_RESOURCES", "CMS_PROJECTRESOURCES", "CMS_PROJECTS"
  };
   ...
   * <p>
   */
  protected static final List<String> TABLES_LIST =
      Collections.unmodifiableList(Arrays.asList(TABLES));
   ...
   * <p>
   */
  private static final String QUERY_SELECT_DATA_FROM_BACKUP_PROJECTS =
   ...
   */
  protected void addPrimaryKey(CmsSetupDb dbCon, String tablename, String primaryKey)
      throws SQLException {
   ...
   * @throws SQLException if something goes wrong
   */
  protected void addUUIDColumnToTable(CmsSetupDb dbCon, String tablename, String column)
      throws SQLException {

    System.out.println(new Exception().getStackTrace()[0].toString());
    if (!dbCon.hasTableOrColumn(tablename, column)) {
      String query = readQuery(QUERY_ADD_TEMP_UUID_COLUMN); // Get the query
      // if the table is not one of the ONLINE or OFFLINE resources add the new column in the first
      // position
  ...
  protected void internalExecute(CmsSetupDb dbCon) throws SQLException {
    ...
    if (update) {
      System.out.println(
          "table " + HISTORY_PROJECTS_TABLE + " has no content, create a dummy entry");
   ...
   *
   * <p>The datetime type for the column PROJECT_PUBLISHDATE is converted to the new long value.
   *
   * <p>
   *
   * @param dbCon the db connection interface
  ...
  /**
   * Drops the column of the given table.
   *
   * <p>
   *
   * @param dbCon the db connection interface
  ...
  /**
   * Updates the given table with the new UUID value.
   *
   * <p>
   *
   * @param dbCon the db connection interface
  ...
  /**
   * Generates the new UUIDs for the project ids.
   *
   * <p>The new uuids are stored in the temporary table.
   *
   * <p>
   *
   * @param dbCon the db connection interface
  ...
  /**
   * Gets the UUIDs from the temporary table TEMP_CMS_UUIDS.
   *
   * <p>
   *
   * @param dbCon the db connection interface
   ...
   * @throws SQLException if something goes wrong
   */
  private void renameColumn(CmsSetupDb dbCon, String tablename, String oldname, String newname)
      throws SQLException {
