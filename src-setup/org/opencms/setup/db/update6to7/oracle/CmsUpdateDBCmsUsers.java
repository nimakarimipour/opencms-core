...
public class CmsUpdateDBCmsUsers extends org.opencms.setup.db.update6to7.CmsUpdateDBCmsUsers {
  ...
  /**
   * @see
   *     org.opencms.setup.db.update6to7.CmsUpdateDBCmsUsers#writeUserInfo(org.opencms.setup.CmsSetupDb,
  ...
  protected void writeUserInfo(CmsSetupDb dbCon, String id, String key, Object value) {
    ...
    try {
      ...
      if (db.getResultSet().next()) {
        ...
        OutputStream output =
            CmsUserDriver.getOutputStreamFromBlob(db.getResultSet(), "DATA_VALUE");
