...
public class CmsUpdateDBProjectId extends org.opencms.setup.db.update6to7.CmsUpdateDBProjectId {
  ...
  /**
   * @see
   *     org.opencms.setup.db.update6to7.CmsUpdateDBProjectId#addPrimaryKey(org.opencms.setup.CmsSetupDb,
  ...
  /**
   * @see
   *     org.opencms.setup.db.update6to7.CmsUpdateDBProjectId#addUUIDColumnToTable(org.opencms.setup.CmsSetupDb,
   *     java.lang.String, java.lang.String)
   */
  @Override
  ...
  /**
   * @see
   *     org.opencms.setup.db.update6to7.CmsUpdateDBProjectId#createHistProjectsTable(org.opencms.setup.CmsSetupDb)
   */
  @Override
  ...
  /**
   * @see
   *     org.opencms.setup.db.update6to7.CmsUpdateDBProjectId#createTempTable(org.opencms.setup.CmsSetupDb)
   */
  @Override
  ...
  /**
   * @see
   *     org.opencms.setup.db.update6to7.CmsUpdateDBProjectId#needsUpdating(org.opencms.setup.CmsSetupDb,
   *     java.lang.String)
   */
  @Override
