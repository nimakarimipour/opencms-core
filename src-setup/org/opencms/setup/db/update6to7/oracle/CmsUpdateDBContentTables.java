...
public class CmsUpdateDBContentTables
   ...
   * <p>
   */
  protected static final String QUERY_UPDATE_ONLINE_CONTENTS_PUBLISH_TAG_FROM =
   ...
   * <p>
   */
  protected static final String QUERY_UPDATE_ONLINE_CONTENTS_PUBLISH_TAG_FROM2 =
      "Q_UPDATE_ONLINE_CONTENTS_PUBLISH_TAG_FROM2";
   ...
   * <p>
   */
  protected static final String QUERY_UPDATE_ONLINE_CONTENTS_PUBLISH_TAG_TO =
  ...
  /**
   * @see
   *     org.opencms.setup.db.update6to7.CmsUpdateDBContentTables#createContentsTable(org.opencms.setup.CmsSetupDb)
   */
  @Override
  ...
  /**
   * @see
   *     org.opencms.setup.db.update6to7.CmsUpdateDBContentTables#transferOnlineContents(org.opencms.setup.CmsSetupDb,
   *     int)
   */
  @Override
