...
public class CmsSetupUI extends A_CmsUI implements I_SetupUiContext {
  ...
  public static Resource getSetupPage(I_SetupUiContext context, String name) {
    ...
    String path =
        CmsStringUtil.joinPaths(
            context.getSetupBean().getContextPath(), CmsSetupBean.FOLDER_SETUP, name);
   ...
   *
   * <p>The step number is only updated if no exceptions are thrown when instantiating/displaying
   * the given step
   *
