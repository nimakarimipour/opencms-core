...
/**
 * Logging Thread which collects the output from CmsSetupThread and stores it in a Vector that the
 * OpenCms setup wizard can read via the getMessages() method.
 *
 * <p>
 *
 * @since 6.0.0
...
public class CmsSetupLoggingThread extends Thread {
  ...
  /**
   * Returns <code>"true"</code> if the logging is finished.
   *
   * <p>
   *
