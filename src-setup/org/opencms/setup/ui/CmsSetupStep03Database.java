...
public class CmsSetupStep03Database extends A_CmsSetupStep {
  ...
  /**
   * Exception class for use during DB setup, where we get lists of strings as errors from
   * CmsSetupDb instead of the original exceptions.
   */
  ...
  /**
   * Array for storing the DB settings panel (need to wrap it in array because it's not part of the
   * declarative layout).
   */
  ...
  public CmsSetupStep03Database(I_SetupUiContext context) {
    ...
    m_dbSelect.addValueChangeListener(
        evt -> {
