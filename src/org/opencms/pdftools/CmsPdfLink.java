...
public class CmsPdfLink {
  ...
  public static final String PDF_LINK_REGEX =
      PDF_LINK_PREFIX
          + "/"
          + NOSLASH_GROUP
          + "/"
  ...
  /**
   * Creates a new PDF link object based on the formatter and content resources and the locale of
      ...
      if (id == null) {
        throw new CmsVfsResourceNotFoundException(
            org.opencms.db.generic.Messages.get()
                .container(org.opencms.db.generic.Messages.ERR_READ_RESOURCE_1, detailName));
      }
