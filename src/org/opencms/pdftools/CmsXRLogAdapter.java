 ...
 *
 * <p>The log channels to which the log messages are sent start with the prefix 'org.opencms.' so
 * that no change in the log configuration is needed to make error messages appear in the log.
 *
 * <p>
 */
public class CmsXRLogAdapter implements XRLogger {
  ...
  /**
   * @see org.xhtmlrenderer.util.XRLogger#log(java.lang.String, java.util.logging.Level,
   *     java.lang.String)
   */
  ...
  /**
   * Sends a log message to the commons-logging interface.
   *
   * <p>
   *
