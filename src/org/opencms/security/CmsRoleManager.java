...
public class CmsRoleManager {
     ...
     */
    public void checkRoleForResource(CmsObject cms, CmsRole role, @RUntainted String resourceName)
     ...
     * @throws CmsException if something goes wrong
     */
    public List<CmsRole> getRolesForResource(CmsObject cms, @RUntainted String userFqn, @RUntainted String resourceName) throws CmsException {
     ...
     * @return <code>true</code> if the given context user has the given role for the given resource
     */
    public boolean hasRoleForResource(CmsObject cms, CmsRole role, @RUntainted String resourceName) {
     ...
     * @return <code>true</code> if the given context user has the given role for the given resource
     */
    public boolean hasRoleForResource(CmsObject cms, @RUntainted String userName, CmsRole role, @RUntainted String resourceName) {
