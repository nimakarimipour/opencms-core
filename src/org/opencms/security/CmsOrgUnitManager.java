...
public class CmsOrgUnitManager {
   ...
   */
  public void addResourceToOrgUnit(CmsObject cms, String ouFqn, String resourceName)
      throws CmsException {
   ...
   *
   * <p>The parent structure must exist.
   *
   * <p>
   *
   * @param cms the opencms context
  ...
  public CmsOrganizationalUnit createOrganizationalUnit(
      CmsObject cms, String ouFqn, String description, int flags, String resourceName)
      throws CmsException {
    ...
    return m_securityManager.createOrganizationalUnit(
        cms.getRequestContext(), ouFqn, description, flags, resource);
  }

  /**
   * Deletes an organizational unit.
   *
   * <p>Only organizational units that contain no sub units can be deleted.
   *
   ...
   *
   * <p>That is all projects which are owned by the current user or which are accessible for the
   * group of the user.
   *
   * <p>
   *
  ...
  public List<CmsProject> getAllAccessibleProjects(
      CmsObject cms, String ouFqn, boolean includeSubOus) throws CmsException {

    CmsOrganizationalUnit orgUnit = readOrganizationalUnit(cms, ouFqn);
    return (m_securityManager.getAllAccessibleProjects(
        cms.getRequestContext(), orgUnit, includeSubOus));
  }

  /**
   * Returns all manageable projects of the given organizational unit.
   *
   * <p>That is all projects which are owned by the current user or which are manageable for the
   * group of the user.
   *
   * <p>
   *
  ...
  public List<CmsProject> getAllManageableProjects(
    ...
    CmsOrganizationalUnit orgUnit = readOrganizationalUnit(cms, ouFqn);
    return (m_securityManager.getAllManageableProjects(
        cms.getRequestContext(), orgUnit, includeSubOus));
  }
   ...
   * @throws CmsException if operation was not successful
   */
  public List<CmsGroup> getGroups(CmsObject cms, String ouFqn, boolean includeSubOus)
      throws CmsException {
  ...
  public List<CmsOrganizationalUnit> getOrganizationalUnits(
      CmsObject cms, String ouFqn, boolean includeChildren) throws CmsException {

    CmsOrganizationalUnit parent = readOrganizationalUnit(cms, ouFqn);
    return m_securityManager.getOrganizationalUnits(
        cms.getRequestContext(), parent, includeChildren);
  }
   ...
   * @throws CmsException if something goes wrong
   */
  public List<CmsOrganizationalUnit> getOrgUnitsForResource(CmsObject cms, String rootPath)
      throws CmsException {
   ...
   * @throws CmsException if operation was not successful
   */
  public List<CmsResource> getResourcesForOrganizationalUnit(CmsObject cms, String ouFqn)
      throws CmsException {
   ...
   * @throws CmsException if operation was not successful
   */
  public List<CmsUser> getUsers(CmsObject cms, String ouFqn, boolean recursive)
      throws CmsException {
  ...
  public List<CmsUser> getUsersWithoutAdditionalInfo(CmsObject cms, String ouFqn, boolean recursive)
    ...
    CmsOrganizationalUnit orgUnit = readOrganizationalUnit(cms, ouFqn);
    return m_securityManager.getUsersWithoutAdditionalInfo(
        cms.getRequestContext(), orgUnit, recursive);
  }
  ...
  public void initialize(CmsObject cms) throws CmsException {
    ...
    for (CmsOrganizationalUnit ou : ous) {
      try {
        ...
        LOG.error(
            "Error while initializing OU " + ou.getName() + ": " + e.getLocalizedMessage(), e);
      }
    }
  }
   ...
   * @throws CmsException if something goes wrong
   */
  public CmsOrganizationalUnit readOrganizationalUnit(CmsObject cms, String ouFqn)
      throws CmsException {
   ...
   * @throws CmsException if something goes wrong
   */
  public void removeResourceFromOrgUnit(CmsObject cms, String ouFqn, String resourceName)
      throws CmsException {
   ...
   * @throws CmsException if something goes wrong
   */
  public List<CmsUser> searchUsers(CmsObject cms, CmsUserSearchParameters params)
      throws CmsException {
   ...
   * @throws CmsException if something goes wrong
   */
  public void setUsersOrganizationalUnit(CmsObject cms, String ouFqn, String userName)
      throws CmsException {
   ...
   *
   * <p>The organizational unit has to be a valid OpenCms organizational unit.<br>
   ...
   * @throws CmsException if operation was not successful
   */
  public void writeOrganizationalUnit(CmsObject cms, CmsOrganizationalUnit organizationalUnit)
      throws CmsException {
  ...
  /**
   * Helper method for collecting all organizational units such that they and their ancestors all
   * contain a given resource.
   *
   * @param cms the CMS context
  ...
  void collectOrgUnitsForResource(
    ...
    List<CmsResource> resources =
        OpenCms.getOrgUnitManager().getResourcesForOrganizationalUnit(cms, parentOU.getName());
    ...
    if (insideOU) {
      for (CmsOrganizationalUnit ou :
          OpenCms.getOrgUnitManager().getOrganizationalUnits(cms, parentOU.getName(), false)) {
        try {
