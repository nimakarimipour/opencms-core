...
public class CmsOrgUnitManager {
     ...
     */
    public void addResourceToOrgUnit(CmsObject cms, @RUntainted String ouFqn, String resourceName) throws CmsException {
     ...
     * @throws CmsException if operation was not successful
     */
    public List<@RUntainted CmsProject> getAllAccessibleProjects(CmsObject cms, @RUntainted String ouFqn, boolean includeSubOus)
    throws CmsException {
     ...
     * @throws CmsException if operation was not successful
     */
    public @RUntainted List<CmsProject> getAllManageableProjects(CmsObject cms, @RUntainted String ouFqn, boolean includeSubOus)
    throws CmsException {
     ...
     * @throws CmsException if operation was not successful
     */
    public @RUntainted List<CmsGroup> getGroups(CmsObject cms, @RUntainted String ouFqn, boolean includeSubOus) throws CmsException {
     ...
     * @throws CmsException if operation was not successful
     */
    public @RUntainted List<CmsUser> getUsers(CmsObject cms, @RUntainted String ouFqn, boolean recursive) throws CmsException {
     ...
     * @throws CmsException if operation was not successful
     */
    public List<@RUntainted CmsUser> getUsersWithoutAdditionalInfo(CmsObject cms, @RUntainted String ouFqn, boolean recursive)
    throws CmsException {
     ...
     * @throws CmsException if something goes wrong
     */
    public void removeResourceFromOrgUnit(CmsObject cms, @RUntainted String ouFqn, String resourceName) throws CmsException {
