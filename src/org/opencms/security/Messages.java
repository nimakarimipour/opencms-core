...
public final class Messages extends A_CmsMessageBundle {
  ...
  /** Message constant for key in the resource bundle. */
  public static final String ERR_UNSUPPORTED_AUTHENTICATION_MECHANISM_1 =
  ...
  /** Message constant for key in the resource bundle. */
  public static final String ERR_USER_NOT_IN_ROLE_FOR_ORGUNIT_3 =
      "ERR_USER_NOT_IN_ROLE_FOR_ORGUNIT_3";

  /** Message constant for key in the resource bundle. */
  public static final String ERR_USER_NOT_IN_ROLE_FOR_RESOURCE_3 =
  ...
  /** Message constant for key in the resource bundle. */
  public static final String GUI_ROLE_DESCRIPTION_ACCOUNT_MANAGER_0 =
      "GUI_ROLE_DESCRIPTION_ACCOUNT_MANAGER_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_ROLE_DESCRIPTION_ADMINISTRATOR_0 =
      "GUI_ROLE_DESCRIPTION_ADMINISTRATOR_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_ROLE_DESCRIPTION_CATEGORY_EDITOR_0 =
      "GUI_ROLE_DESCRIPTION_CATEGORY_EDITOR_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_ROLE_DESCRIPTION_DATABASE_MANAGER_0 =
  ...
  /** Message constant for key in the resource bundle. */
  public static final String GUI_ROLE_DESCRIPTION_ELEMENT_AUTHOR_0 =
      "GUI_ROLE_DESCRIPTION_ELEMENT_AUTHOR_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_ROLE_DESCRIPTION_GALLERY_EDITOR_0 =
      "GUI_ROLE_DESCRIPTION_GALLERY_EDITOR_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_ROLE_DESCRIPTION_LIST_EDITOR_0 =
      "GUI_ROLE_DESCRIPTION_LIST_EDITOR_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_ROLE_DESCRIPTION_PROJECT_MANAGER_0 =
      "GUI_ROLE_DESCRIPTION_PROJECT_MANAGER_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_ROLE_DESCRIPTION_ROOT_ADMIN_0 =
      "GUI_ROLE_DESCRIPTION_ROOT_ADMIN_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_ROLE_DESCRIPTION_VFS_MANAGER_0 =
      "GUI_ROLE_DESCRIPTION_VFS_MANAGER_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_ROLE_DESCRIPTION_WORKPLACE_MANAGER_0 =
      "GUI_ROLE_DESCRIPTION_WORKPLACE_MANAGER_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_ROLE_DESCRIPTION_WORKPLACE_USER_0 =
  ...
  /** Message constant for key in the resource bundle. */
  public static final String LOG_NO_PERMISSION_RESOURCE_USER_4 =
