 ...
 *
 * <p>Be sure the flags does not conflict with the flags defined in {@link
...
public class CmsOrganizationalUnit {
   ...
   *
   * <p>This is <code>null</code> for the root ou, and the empty string for first level ous.
   *
   * <p>
   *
   ...
   *
   * <p>This could return also just a macro, so please use the {@link #getDescription(Locale)}
   * method.
   *
   * <p>
   *
   ...
   *
   * <p>The organizational unit flags are used to store special information about the organizational
   * unit state encoded bitwise. Usually the flags int value should not be directly accessed.
   *
   * <p>
   *
    ...
    if (CmsStringUtil.isEmptyOrWhitespaceOnly(description)) {
      throw new CmsIllegalArgumentException(
          org.opencms.db.Messages.get()
              .container(org.opencms.db.Messages.ERR_BAD_OU_DESCRIPTION_EMPTY_0));
    }
   ...
   *
   * <p>The organizational unit flags are used to store special information about the organizational
   * units state encoded bitwise. Usually the flags int value should not be directly accessed.
   *
   * <p>
   *
