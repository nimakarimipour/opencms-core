...
public class CmsOrganizationalUnit {
     ...
     */
    public CmsOrganizationalUnit(CmsUUID id, @RUntainted String fqn, @RUntainted String description, int flags, CmsUUID projectId) {
     ...
     */
    public @RUntainted String getDisplayName(Locale locale) {
