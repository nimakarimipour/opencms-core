...
public class CmsPersistentLoginAuthorizationHandler extends CmsDefaultAuthorizationHandler {
     ...
     */
    @Override
    public @RUntainted CmsObject initCmsObject(HttpServletRequest request, I_PrivilegedLoginAction loginAction) {
     ...
     */
    public @RUntainted CmsObject initCmsObjectFromToken(HttpServletRequest request, I_PrivilegedLoginAction loginAction) {
