...
public class CmsAccessControlEntry {
    ...
    public static final @RUntainted String PRINCIPAL_ALL_OTHERS_NAME = "ALL_OTHERS";
    ...
    public static final @RUntainted String PRINCIPAL_OVERWRITE_ALL_NAME = "OVERWRITE_ALL";
