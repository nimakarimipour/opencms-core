...
public interface I_CmsPrincipal extends Principal, Serializable {
  ...
  /**
   * Upper limit for core flags, any principal object with flags greater than this value will be
   * filtered out.
   */
  ...
  /**
   * Checks if the provided principal name is valid and can be used as an argument value for {@link
   * #setName(String)}.
   *
   * <p>
   *
   ...
   *
   * <p>The principal flags are used to store special information about the principals state encoded
   * bitwise. Usually the flags int value should not be directly accessed. Utility methods like
   * <code>{@link #isEnabled()}</code> provide a much easier way to access the information contained
   * in the flags.
   *
   * <p>
   *
   ...
   *
   * <p>The type prefix can either be <code>{@link I_CmsPrincipal#PRINCIPAL_GROUP}.</code> (for
   * groups) or <code>{@link I_CmsPrincipal#PRINCIPAL_USER}.</code> (for users).
   *
   * <p>
   *
  ...
  /**
   * Returns <code>true</code> if this principal is enabled.
   *
   * <p>A principal may be disabled in order to disable it, for example to prevent logins of a user.
   * If a principal is just disabled but not deleted, the credentials of the principal in the VFS
   * are still valid.
   *
   * <p>
   *
  ...
  /**
   * Returns <code>true</code> if this principal is of type <code>{@link org.opencms.file.CmsGroup}
   * </code>.
   *
   * <p>
   *
   * @return <code>true</code> if this principal is of type <code>{@link org.opencms.file.CmsGroup}
   *     </code>
   */
  boolean isGroup();

  /**
   * Returns <code>true</code> if this principal is of type <code>{@link org.opencms.file.CmsUser}
   * </code>.
   *
   * <p>
   *
   * @return <code>true</code> if this principal is of type <code>{@link org.opencms.file.CmsUser}
   *     </code>
   */
  boolean isUser();
   ...
   *
   * <p>The principal flags are used to store special information about the principals state encoded
   * bitwise. Usually the flags integer value should not be directly accessed. Utility methods like
   * <code>{@link #setEnabled(boolean)}</code> provide a much easier way to manipulate the
   * information contained in the flags.
   *
   * <p>
   *
