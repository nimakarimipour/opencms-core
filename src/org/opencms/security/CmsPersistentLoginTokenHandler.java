...
public class CmsPersistentLoginTokenHandler {
    ...
    public static class Token {
         ...
         */
        public Token(@RUntainted String token) {
     ...
     * @throws CmsException if something goes wrong
     */
    public void invalidateToken(CmsUser user, @RUntainted String token) throws CmsException {
     ...
     */
    public CmsUser validateToken(@RUntainted String tokenString) {
