...
public class CmsPasswordInfo {
  ...
  public void applyChanges() throws CmsException {
    ...
    if (m_userName == null) {
      throw new CmsIllegalStateException(
          Messages.get().container(Messages.ERR_INVALID_USER_CONTEXT_0));
    }
    validate();
  ...
  public void setNewPwd(String newPwd) {
    ...
    try {
      ...
      throw new CmsIllegalArgumentException(
          Messages.get().container(Messages.ERR_INVALID_NEWPWD_0), e);
    }
    m_newPwd = newPwd;
  }
  ...
  public void validate() {
    ...
    if (CmsStringUtil.isEmpty(getNewPwd())) {
      throw new CmsIllegalArgumentException(
          Messages.get().container(Messages.ERR_INVALID_NEWPWD_0));
    }
    if (!getNewPwd().equals(getConfirmation())) {
      throw new CmsIllegalArgumentException(
          Messages.get().container(Messages.ERR_NEWPWD_MISMATCH_0));
    }
  }
}
