 ...
 *
 * <p>Currently supported permissions are:
 *
 * <ul>
 *   <li><code>{@link CmsPermissionSet#PERMISSION_READ}</code> (r) the right to read the contents of
 *       a resource
 *   <li><code>{@link CmsPermissionSet#PERMISSION_WRITE}</code> (w) the right to write the contents
 *       of a resource
 *   <li><code>{@link CmsPermissionSet#PERMISSION_VIEW}</code> (v) the right to see a resource in
 *       listings (workplace)
 *   <li><code>{@link CmsPermissionSet#PERMISSION_CONTROL}</code> (c) the right to set permissions
 *       of a resource
 *   <li><code>{@link CmsPermissionSet#PERMISSION_DIRECT_PUBLISH}</code> (d) the right direct
 *       publish a resource even without publish project permissions
 * </ul>
 *
 * <p>
 *
...
public class CmsPermissionSet implements Serializable {
  ...
  private static Map<String, Integer> permissions() {
    ...
    if (m_permissions == null) {
      ...
      permissions.put(
          "GUI_PERMISSION_TYPE_WRITE_0", new Integer(CmsPermissionSet.PERMISSION_WRITE));
      permissions.put("GUI_PERMISSION_TYPE_VIEW_0", new Integer(CmsPermissionSet.PERMISSION_VIEW));
      permissions.put(
          "GUI_PERMISSION_TYPE_CONTROL_0", new Integer(CmsPermissionSet.PERMISSION_CONTROL));
      permissions.put(
   ...
   *
   * <p>These are all permissions allowed but not denied.
   *
