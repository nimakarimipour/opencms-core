...
public class CmsDefaultAuthorizationHandler extends A_CmsAuthorizationHandler {
     ...
     */
    public CmsObject initCmsObject(@RUntainted HttpServletRequest request) {
     ...
     */
    public CmsObject initCmsObject(@RUntainted HttpServletRequest request, @RUntainted String userName, String pwd) throws CmsException {
     ...
     */
    protected CmsObject checkBasicAuthorization(@RUntainted HttpServletRequest req) {
