...
public interface I_CmsPasswordHandler extends I_CmsConfigurationParameterHandler {
   ...
   *
   * <p>Use this to check salted passwords. If the password is salted, it needs to be checked with
   * the salt (and possible other parameters) stored in the digested password. Just digesting the
   * password again and comparing the result to a previous digest won't work because the salt will
   ...
   * @param useFallback if <code>true</code>, then use a fall back hashing algorithm in case first
   *     validation fails
   ...
   * a Class configured in the opencms.properties file.
   *
