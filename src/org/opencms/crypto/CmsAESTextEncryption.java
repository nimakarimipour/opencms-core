...
public class CmsAESTextEncryption implements I_CmsTextEncryption {
   ...
   *
   * <p>When using this constructor, it is not necessary to call initialize() to make the object
   * usable.
   *
  ...
  public static SecretKey generateAESKey(String secret) {
    ...
    HKDFParameters params =
        HKDFParameters.defaultParameters(secret.getBytes(StandardCharsets.UTF_8));
  ...
  public void initialize(CmsObject cms) {
    ...
    if (secret == null) {
      throw new IllegalArgumentException(
          "Parameter 'secret' must be set for CmsAESTextEncryption!");
    }
    m_key = generateAESKey(secret);
  }
