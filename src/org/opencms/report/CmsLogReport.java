 ...
 *
 * <p>This prints all messages in the logfile at INFO level.
 *
 * <p>
 *
 * @since 6.0.0
...
public class CmsLogReport extends A_CmsReport {
  ...
  /**
   * Constructs a new report using the provided locale for the output language, using the provided
   * Java class for the log channel.
   *
   * <p>
   *
