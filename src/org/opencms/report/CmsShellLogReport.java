...
public class CmsShellLogReport extends CmsShellReport {
     ...
     * @param locale locale
     */
    public CmsShellLogReport(@RUntainted Locale locale) {
     ...
     */
    @Override
    public void printMessageWithParam(@RUntainted int m, @RUntainted int n, CmsMessageContainer container, Object param) {
