...
public abstract class A_CmsReport implements I_CmsReport {
  ...
  private @RUntainted List<Object> m_errors = new ArrayList<Object>();
  ...
  private @RUntainted List<Object> m_warnings = new ArrayList<Object>();
  ...
  /**
   * @see
   *     org.opencms.report.I_CmsReport#getReportUpdate(org.opencms.report.I_CmsReportUpdateFormatter)
   */
  ...
  /**
   * @see
   *     org.opencms.report.I_CmsReport#printMessageWithParam(org.opencms.i18n.CmsMessageContainer,Object)
   */
  ...
  /**
   * @see
   *     org.opencms.report.I_CmsReport#printMessageWithParam(int,int,org.opencms.i18n.CmsMessageContainer,Object)
   */
   ...
   */
  protected void init(@RUntainted Locale locale, @RUntainted String siteRoot) {
   ...
   *
   * <p>Use the constants starting with <code>FORMAT</code> from this interface to indicate which
   * formatting to use.
   *
   * <p>
   *
   ...
   *
   * <p>Use the constants starting with <code>C_FORMAT</code> from this interface to indicate which
   * formatting to use.
   *
   * <p>
   *
