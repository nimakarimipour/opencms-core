...
public class CmsEditorFrameset extends CmsEditor {
   ...
   *
   * <p>This method is needed in the editor close help frame, which is called when the user presses
   * the "back" button or closes the browser window when editing a page.
   *
   * <p>
   *
