...
public class CmsEditorActionDefault implements I_CmsEditorActionHandler {
  ...
  /**
   * @see
   *     org.opencms.workplace.editors.I_CmsEditorActionHandler#editorAction(org.opencms.workplace.editors.CmsEditor,
   *     org.opencms.jsp.CmsJspActionElement)
   */
  public void editorAction(CmsEditor editor, CmsJspActionElement jsp)
    ...
    params
        .append("?")
        .append(CmsDialog.PARAM_RESOURCE)
        .append("=")
        .append(editor.getParamResource());
    params
        .append("&")
        .append(CmsDialog.PARAM_ACTION)
        .append("=")
        .append(CmsDialog.DIALOG_CONFIRMED);
    params
        .append("&")
        .append(CmsWorkplace.PARAM_DIRECTPUBLISH)
        .append("=")
        .append(CmsStringUtil.TRUE);
    params
        .append("&")
        .append(CmsWorkplace.PARAM_PUBLISHSIBLINGS)
        .append("=")
        .append(editor.getSettings().getUserSettings().getDialogPublishSiblings());
    ...
    params.append(
        CmsEncoder.escapeWBlanks(
            editor.key(Messages.GUI_MESSAGEBOX_TITLE_PUBLISHRESOURCE_0)
                + ": "
    ...
    if (Boolean.valueOf(editor.getParamDirectedit()).booleanValue()) {
      ...
      publishLink +=
          params.toString() + CmsEncoder.escapeWBlanks(linkTarget, CmsEncoder.ENCODING_UTF_8);
    } else {
      ...
      if (CmsLinkManager.isWorkplaceLink(editor.getParamBacklink())) {
        publishLink +=
            params.toString()
                + CmsEncoder.escapeWBlanks(
                    jsp.link(editor.getParamBacklink()), CmsEncoder.ENCODING_UTF_8);
      } else {
        publishLink +=
            params.toString()
                + CmsEncoder.escapeWBlanks(
  ...
  /**
   * @see org.opencms.workplace.editors.I_CmsEditorActionHandler#getButtonUrl(CmsJspActionElement,
   *     java.lang.String)
   */
  ...
  /**
   * @see org.opencms.workplace.editors.I_CmsEditorActionHandler#isButtonActive(CmsJspActionElement,
   *     java.lang.String)
   */
