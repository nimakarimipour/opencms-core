...
public class CmsEditorHandler implements I_CmsEditorHandler {
  ...
  /**
   * @see org.opencms.workplace.editors.I_CmsEditorHandler#getEditorUri(org.opencms.file.CmsObject,
    ...
    if (loadDefault) {
      ...
      editorUri =
          OpenCms.getWorkplaceManager()
              ...
              .getDefaultEditorUri(cms.getRequestContext(), resourceType, userAgent);
    } else {
      // get preferred editor
      editorUri =
          OpenCms.getWorkplaceManager()
              .getWorkplaceEditorManager()
              .getEditorUri(cms.getRequestContext(), resourceType, userAgent);
    }
  ...
  /**
   * @see org.opencms.workplace.editors.I_CmsEditorHandler#getEditorUri(java.lang.String,
   *     CmsJspActionElement)
   */
  public String getEditorUri(String resource, CmsJspActionElement jsp) throws CmsException {
    ...
    boolean editAsText =
        Boolean.valueOf(jsp.getRequest().getParameter(CmsEditor.PARAM_EDITASTEXT)).booleanValue();
    boolean loadDefault =
        Boolean.valueOf(jsp.getRequest().getParameter(CmsEditor.PARAM_LOADDEFAULT)).booleanValue();
