...
/**
 * This class is used to help constructing the TinyMCE toolbar configuration, both for client-side
...
public final class CmsTinyMceToolbarHelper {
  ...
  /**
   * The map containing the translation of the generic widget button names to TinyMCE specific
   * button names.
   */
  public static final Map<String, String> BUTTON_TRANSLATION_MAP =
      CmsStringUtil.splitAsMap(BUTTON_TRANSLATION, "|", ":");
  ...
  /**
   * Helper method to generate a TinyMCE-specific toolbar configuration string from a list of
   * generic toolbar button names.
   *
   * <p>
   *
  ...
  /**
   * Translates a generic button name to a TinyMCE-specific button name (or a comma-separated list
   * of button names).
   *
   * <p>
   *
