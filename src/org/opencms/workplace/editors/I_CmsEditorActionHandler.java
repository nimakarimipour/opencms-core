 ...
 * editor.
 *
 * <p>You can define the class of your own editor action method in the OpenCms XML configuration
 * files. The class you enter must implement this interface to perform the editor action.
 *
 * <p>
 *
 * @since 6.0.0
...
public interface I_CmsEditorActionHandler {
   ...
   */
  @Deprecated String DIRECT_EDIT_AREA_END = CmsDirectEditJspIncludeProvider.DIRECT_EDIT_AREA_END;
   ...
   */
  @Deprecated String DIRECT_EDIT_INCLUDE_FILE_URI = "__directEditIncludeFileUri";
   ...
   */
  @Deprecated
  String DIRECT_EDIT_INCLUDE_FILE_URI_DEFAULT =
   ...
   */
  @Deprecated String DIRECT_EDIT_INCLUDES = "directedit_includes";

  /**
   * Constant for: direct edit mode disabled.
   *
   * @deprecated use {@link CmsDirectEditPermissions#VALUE_DISABLED} or better {@link
   *     CmsDirectEditPermissions#DISABLED}
   */
  @Deprecated String DIRECT_EDIT_MODE_DISABLED = CmsDirectEditPermissions.VALUE_DISABLED;

  /**
   * Constant for: direct edit mode enabled.
   *
   * @deprecated use {@link CmsDirectEditPermissions#VALUE_ENABLED} or better {@link
   *     CmsDirectEditPermissions#ENABLED}
   */
  @Deprecated String DIRECT_EDIT_MODE_ENABLED = CmsDirectEditPermissions.VALUE_ENABLED;

  /**
   * Constant for: direct edit mode inactive.
   *
   * @deprecated use {@link CmsDirectEditPermissions#VALUE_INACTIVE} or better {@link
   *     CmsDirectEditPermissions#INACTIVE}
   */
  @Deprecated String DIRECT_EDIT_MODE_INACTIVE = CmsDirectEditPermissions.VALUE_INACTIVE;
   ...
   */
  @Deprecated String DIRECT_EDIT_OPTION_DELETE = CmsDirectEditButtonSelection.VALUE_DELETE;

  /**
   * Option value that indicates the "edit" button should be displayed.
   *
   * @deprecated use {@link CmsDirectEditButtonSelection#VALUE_EDIT} or better {@link
   *     CmsDirectEditButtonSelection#EDIT}
   */
  @Deprecated String DIRECT_EDIT_OPTION_EDIT = CmsDirectEditButtonSelection.VALUE_EDIT;
   ...
   */
  @Deprecated String DIRECT_EDIT_OPTION_NEW = CmsDirectEditButtonSelection.VALUE_NEW;
  ...
  /**
   * Performs an action which is configurable in the implementation of the interface, e.g. save,
   * exit, publish.
   *
   * <p>
   *
