...
public final class Messages extends A_CmsMessageBundle {
  ...
  /** Message constant for key in the resource bundle. */
  public static final String ERR_EDITOR_XMLCONTENT_VALIDATION_ERROR_LANG_1 =
      "ERR_EDITOR_XMLCONTENT_VALIDATION_ERROR_LANG_1";

  /** Message constant for key in the resource bundle. */
  public static final String ERR_EDITOR_XMLCONTENT_VALIDATION_ERROR_TITLE_0 =
      "ERR_EDITOR_XMLCONTENT_VALIDATION_ERROR_TITLE_0";
  ...
  /** Message constant for key in the resource bundle. */
  public static final String GUI_DIRECTEDIT_CAN_ONLY_BE_CREATED_0 =
      "GUI_DIRECTEDIT_CAN_ONLY_BE_CREATED_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_DIRECTEDIT_CANNOT_BE_CREATED_OR_EDITED_0 =
      "GUI_DIRECTEDIT_CANNOT_BE_CREATED_OR_EDITED_0";
  ...
  /** Message constant for key in the resource bundle. */
  public static final String GUI_EDITOR_DIALOG_CLEANUP_BUTTON_0 =
      "GUI_EDITOR_DIALOG_CLEANUP_BUTTON_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_EDITOR_DIALOG_COPYLANGUAGE_HEADLINE_1 =
      "GUI_EDITOR_DIALOG_COPYLANGUAGE_HEADLINE_1";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_EDITOR_DIALOG_COPYLANGUAGE_NEW_0 =
      "GUI_EDITOR_DIALOG_COPYLANGUAGE_NEW_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_EDITOR_DIALOG_COPYLANGUAGE_TITLE_0 =
      "GUI_EDITOR_DIALOG_COPYLANGUAGE_TITLE_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_EDITOR_DIALOG_COPYLANGUAGE_WARNING_0 =
      "GUI_EDITOR_DIALOG_COPYLANGUAGE_WARNING_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_EDITOR_DIALOG_ELEMENTS_BUTTON_0 =
      "GUI_EDITOR_DIALOG_ELEMENTS_BUTTON_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_EDITOR_DIALOG_ELEMENTS_CONFIRMDISABLE_0 =
      "GUI_EDITOR_DIALOG_ELEMENTS_CONFIRMDISABLE_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_EDITOR_DIALOG_ELEMENTS_ENABLED_0 =
      "GUI_EDITOR_DIALOG_ELEMENTS_ENABLED_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_EDITOR_DIALOG_ELEMENTS_PAGEELEMENT_0 =
      "GUI_EDITOR_DIALOG_ELEMENTS_PAGEELEMENT_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_EDITOR_DIALOG_ELEMENTS_TITLE_1 =
      "GUI_EDITOR_DIALOG_ELEMENTS_TITLE_1";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_EDITOR_DIALOG_PROPERTIES_BUTTON_0 =
      "GUI_EDITOR_DIALOG_PROPERTIES_BUTTON_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_EDITOR_DIALOG_TABLE_NOTSPECIFIED_0 =
      "GUI_EDITOR_DIALOG_TABLE_NOTSPECIFIED_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_EDITOR_FRONTEND_BUTTON_EDIT_0 =
      "GUI_EDITOR_FRONTEND_BUTTON_EDIT_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_EDITOR_FRONTEND_BUTTON_LOCKED_0 =
      "GUI_EDITOR_FRONTEND_BUTTON_LOCKED_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_EDITOR_MESSAGE_CONFIRMEMAIL_0 =
      "GUI_EDITOR_MESSAGE_CONFIRMEMAIL_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_EDITOR_MESSAGE_CONFIRMHTTP_0 = "GUI_EDITOR_MESSAGE_CONFIRMHTTP_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_EDITOR_MESSAGE_DELETELOCALE_0 =
      "GUI_EDITOR_MESSAGE_DELETELOCALE_0";
  ...
  /** Message constant for key in the resource bundle. */
  public static final String GUI_EDITOR_XMLCONTENT_CHOICE_ADD_HL_0 =
      "GUI_EDITOR_XMLCONTENT_CHOICE_ADD_HL_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_EDITOR_XMLCONTENT_CHOICE_SUB_ADD_HL_0 =
      "GUI_EDITOR_XMLCONTENT_CHOICE_SUB_ADD_HL_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_EDITOR_XMLCONTENT_CONFIRM_CORRECTION_0 =
      "GUI_EDITOR_XMLCONTENT_CONFIRM_CORRECTION_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_EDITOR_XMLCONTENT_ELEMENT_BUTTONS_0 =
      "GUI_EDITOR_XMLCONTENT_ELEMENT_BUTTONS_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_EDITOR_XMLCONTENT_MOVE_DOWN_0 =
      "GUI_EDITOR_XMLCONTENT_MOVE_DOWN_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_EDITOR_XMLCONTENT_MOVE_UP_0 = "GUI_EDITOR_XMLCONTENT_MOVE_UP_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_EDITOR_XMLCONTENT_OPTIONALELEMENT_0 =
      "GUI_EDITOR_XMLCONTENT_OPTIONALELEMENT_0";
