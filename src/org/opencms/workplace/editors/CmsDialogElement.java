...
public class CmsDialogElement implements Comparable<CmsDialogElement> {
  ...
  public CmsDialogElement(
      String name, String niceName, boolean mandantory, boolean templateElement, boolean existing) {
  ...
  /**
   * Returns true if the element is defined by the template, false if the element is just contained
   * in the xml page code.
   *
   * <p>
   *
