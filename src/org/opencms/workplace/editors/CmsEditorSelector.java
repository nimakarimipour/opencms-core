 ...
 *
 * <p>You can define the class of your editor selector in the OpenCms XML configuration files. The
...
public class CmsEditorSelector {
  ...
  private static void showErrorDialog(CmsJspActionElement jsp, Throwable t) {
    ...
    wp.setParamMessage(
        Messages.get().getBundle(wp.getLocale()).key(Messages.ERR_NO_EDITOR_FOUND_0));
