 ...
 *
 * <p>This provider support {@link CmsDirectEditMode#MANUAL} mode.
 *
 * <p>
 *
 * @since 6.2.3
...
public class CmsDirectEditTextButtonProvider extends CmsDirectEditDefaultProvider {
  ...
  /**
   * @see
   *     org.opencms.workplace.editors.directedit.CmsDirectEditDefaultProvider#endDirectEditDisabled()
   */
  @Override
  ...
  /**
   * @see
   *     org.opencms.workplace.editors.directedit.CmsDirectEditDefaultProvider#endDirectEditEnabled()
   */
  @Override
  ...
  public String startDirectEditEnabled(
    ...
    if (params.getButtonSelection().isShowEdit()) {
      result
          .append("[<a href=\"#\" class=\"ocms_txt\" onclick=\"javascript:submitOcms(\'")
          .append(editId)
          .append("\', \'")
    ...
    if (params.getButtonSelection().isShowDelete()) {
      result
          .append("\n[<a href=\"#\" class=\"ocms_txt\" onclick=\"javascript:submitOcms(\'")
          .append(editId)
          .append("\', \'")
    ...
    endHtml
        .append("<form class=\"ocms_nomargin\" name=\"form_")
        .append(editId)
        .append("\" id=\"form_")
        .append(editId)
    ...
    endHtml
        ...
        .append("\"/>\n");
    endHtml
        .append("<input type=\"hidden\" name=\"backlink\" value=\"")
        .append(uri)
        .append("\"/>\n");
