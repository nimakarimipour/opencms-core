...
/**
 * Constants to indicate which direct edit buttons should be displayed for a direct edit resource if
 * the user has the permissions.
 *
 * <p>The actual permission check is done later using {@link CmsDirectEditPermissions}.
 *
 * <p>This button selection is used internally to indicate the buttons that <i>may</i> be displayed.
 * Usually, for an XmlPage only the "edit" button is displayed, while for an XmlContent there may be
 * an "edit", "delete" or "new" button.
 *
 * <p>Currently there are only constants for thouse button combinations that are actually used in
 * practice. These are {@link #EDIT}, {@link #EDIT_DELETE} and {@link #EDIT_DELETE_NEW}.
 *
 * <p>
 *
 * @since 6.2.3
...
public final class CmsDirectEditButtonSelection {
  ...
  /**
   * Returns <code>true</code> if the "delete" button should be displayed.
   *
   * <p>
   *
  ...
  /**
   * Returns <code>true</code> if the "edit" button should be displayed.
   *
   * <p>
   *
  ...
  /**
   * Returns <code>true</code> if the "new" button should be displayed.
   *
   * <p>
   *
  ...
  /**
   * Returns the selected edit options as a String in the form <code>edit|delete|new</code>.
   *
   * <p>
   *
