 ...
 *
 * <p>Edit handlers may be used to enhance content editing within the container page editor. They
 * allow edit pre-processing, and specific delete operations.
 *
 * <p>
 */
public interface I_CmsEditHandler {
   ...
   *
   * <p>If this returns null, the default behavior for the 'New' operation will be used instead.
   *
   * @param cms the cms context
