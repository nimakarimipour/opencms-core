...
/**
 * Constants to indicate the direct edit permissions of a user for a VFS resource, used to describe
 * if and how to show the direct edit buttons for the resource.
 *
 * <p>
 *
 * @since 6.2.3
...
public final class CmsDirectEditPermissions {
   ...
   *
   * <p>User has general permissions to direct edit a resource, but this is currently not possible
   * because for example another user has locked the resource.
   *
   * <p>Direct edit buttons are displayed, but "grayed out".
   */
   ...
   *
   * <p>User has permissions to direct edit a resource, the resource is also available for direct
   * edit.
   *
   * <p>Direct edit buttons are displayed and active.
   */
   ...
   *
   * <p>User has no permissions to direct edit a resource. This may be because of write permissions,
   * or because the resource is not part of the current project, or for other reasons.
   *
   * <p>Direct edit buttons are not displayed at all.
   */
