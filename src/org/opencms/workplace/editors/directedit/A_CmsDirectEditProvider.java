...
public abstract class A_CmsDirectEditProvider implements I_CmsDirectEditProvider {
  ...
  protected static final String INCLUDE_FILE_DEFAULT =
      "/system/workplace/editors/direct_edit_include.txt";
   ...
   *
   * <p>This includes the direct edit permissions. If the permissions are not {@link
   * CmsDirectEditPermissions#INACTIVE}, then the resource and lock information is also included in
   * the result.
   *
   * <p>
   *
  ...
  public CmsDirectEditResourceInfo getResourceInfo(
    ...
    try {
      ...
      if (m_cms.hasPermissions(
          resource, CmsPermissionSet.ACCESS_WRITE, false, CmsResourceFilter.IGNORE_EXPIRATION)) {
  ...
  public void init(CmsObject cms, CmsDirectEditMode mode, @RUntainted String fileName) {
    ...
    m_messages =
        new CmsMessages(
            org.opencms.workplace.editors.Messages.get().getBundleName(), settings.getLocale());
  ...
  public void initConfiguration() throws CmsConfigurationException {
    ...
    m_configurationParameters =
        CmsParameterConfiguration.unmodifiableVersion(m_configurationParameters);
    if (m_configurationParameters == null) {
  ...
  /**
   * @see
   *     org.opencms.workplace.editors.directedit.I_CmsDirectEditProvider#insertDirectEditEmptyList(javax.servlet.jsp.PageContext,
   *     org.opencms.workplace.editors.directedit.CmsDirectEditParams)
   */
  public void insertDirectEditEmptyList(PageContext context, CmsDirectEditParams params)
      throws JspException {
    ...
    print(
        ...
        "<div style=\"minHeight:24px\">"
            + Messages.get()
                ...
                .key(Messages.GUI_CLICK_TO_ADD_ELEMENT_TO_EMPTY_LIST_0)
            + "</div>");
  ...
  /**
   * @see
   *     org.opencms.workplace.editors.directedit.I_CmsDirectEditProvider#insertDirectEditListMetadata(javax.servlet.jsp.PageContext,
   ...
   *
   * <p>Random edit id's are used because to separate multiple direct edit buttons on one page.
   *
   * <p>
   *
   ...
   *
   * <p>Does not print anything if the content is <code>null</code>.
   *
   * <p>
   *
