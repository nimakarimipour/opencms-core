...
public class CmsDateSeriesEditHandler implements I_CmsEditHandler {
  ...
  private static class InternalHandler {
    ...
    /**
     * Constructor for the internal handler, basically taking the information that is provided in
     * all methods of {@link I_CmsEditHandler} to do the common initialization.
     *
    ...
    public InternalHandler(
      ...
      try {
        ...
        m_value =
            m_contentValue != null
                ? new CmsSerialDateValue(m_contentValue.getStringValue(cms))
                : null;
        ...
        LOG.error(
            "Failed to determine all information to edit the instance of the date series.", e);
      }
    }

    /**
     * Returns the options for the delete dialog or <code>null</code> if no special options are
     * available.
     *
     * @return the options for the delete dialog or <code>null</code> if no special options are
     *     available.
     */
        ...
        if (!m_value.getPatternType().equals(PatternType.NONE)) {
          ...
          Option oInstance =
              new Option(
                  OPTION_INSTANCE,
                  messages.key(
                      Messages.GUI_DATE_SERIES_HANDLER_DELETE_OPTION_INSTANCE_1, instanceDate),
                  messages.key(
    ...
    /**
     * Returns the options for the edit dialog or <code>null</code> if no special options are
     * available.
     *
     * @param isListElement flag, indicating if the edited element is in a list.
     * @return the options for the edit dialog or <code>null</code> if no special options are
     *     available.
     */
          ...
          if (!isListElement && !isContainerPageLockable()) {
            oInstance =
                new Option(
                    OPTION_INSTANCE,
                    messages.key(
                        Messages.GUI_DATE_SERIES_HANDLER_EDIT_OPTION_INSTANCE_1, instanceDate),
                    messages.key(
    ...
    /**
     * Handles the preparation of the edit action, except for the series case, since in that case no
    ...
    private void addExceptionForInstance() throws CmsException {
      ...
      if (null != m_instanceDate) {
        try {
          ...
          throw new CmsException(
              new CmsMessageContainer(
                  Messages.get(), Messages.ERR_DATE_SERIES_HANDLER_ADD_EXCEPTION_FAILED_0),
              e);
        }
      } else {
        throw new CmsException(
    ...
    /**
     * Creates a copy of the series content and adjusts the dates in the copy. As well, adds an
     * exception to the original series content.
     *
        ...
        try {
          ...
          String newSitePath =
              OpenCms.getResourceManager()
                  .getNameGenerator()
                  .getNewFileName(
                      m_cms, CmsResource.getFolderPath(m_file.getRootPath()) + pattern, 5);
          ...
          if ((m_value.getEnd() != null) && (m_series.getEventDuration() != null)) {
            newValue.setEnd(
                new Date(m_instanceDate.getTime() + m_series.getEventDuration().longValue()));
          }
          ...
          throw new CmsException(
              new CmsMessageContainer(
                  Messages.get(), Messages.ERR_DATE_SERIES_HANDLER_EXTRACT_CONTENT_FAILED_0),
              e);
        }
      } else {
        throw new CmsException(
      ...
      try {
        result =
            CmsGallerySearch.searchById(
                m_cms, m_contentValue.getDocument().getFile().getStructureId(), l);
    ...
    /**
     * Checks, if the container page the edit operation takes place on can be locked by the current
     * user.
     *
    ...
    private boolean isContainerPageLockable() {
      ...
      try {
        return m_cms
            .getLock(m_cms.readResource(m_pageContextId))
    ...
    private void setInstanceDate() {
      ...
      if (sl != null) {
        try {
          ...
          LOG.error(
              "Could not read valid date from setting or request parameter \""
                  + PARAM_INSTANCEDATE
                  + "\".",
              e);
        }
      } else {
        // TODO: Handle possible other element settings that could determine the actual instance
        // date.
      }
    }
  }
  ...
  /**
   * The key of the parameter/setting the instance date of the instance that should be edited is
   * read from.
   */
  ...
  /**
   * @see
   *     org.opencms.workplace.editors.directedit.I_CmsEditHandler#getDeleteOptions(org.opencms.file.CmsObject,
   *     org.opencms.xml.containerpage.CmsContainerElementBean, org.opencms.util.CmsUUID,
   *     java.util.Map)
   */
  @Override
  public CmsDialogOptions getDeleteOptions(
    ...
    InternalHandler internalHandler =
        new InternalHandler(cms, elementBean, requestParams, pageContextId);
    return internalHandler.getDeleteOptions();
  }

  /**
   * @see
   *     org.opencms.workplace.editors.directedit.I_CmsEditHandler#getEditOptions(org.opencms.file.CmsObject,
   *     org.opencms.xml.containerpage.CmsContainerElementBean, org.opencms.util.CmsUUID,
  ...
  /**
   * @see
   *     org.opencms.workplace.editors.directedit.I_CmsEditHandler#getNewOptions(org.opencms.file.CmsObject,
   *     org.opencms.xml.containerpage.CmsContainerElementBean, org.opencms.util.CmsUUID,
   *     java.util.Map)
   */
  ...
  /**
   * @see
   *     org.opencms.workplace.editors.directedit.I_CmsEditHandler#handleDelete(org.opencms.file.CmsObject,
   *     org.opencms.xml.containerpage.CmsContainerElementBean, java.lang.String,
   *     org.opencms.util.CmsUUID, java.util.Map)
   */
  @Override
  ...
  /**
   * @see
   *     org.opencms.workplace.editors.directedit.I_CmsEditHandler#handleNew(org.opencms.file.CmsObject,
   *     java.lang.String, java.util.Locale, java.lang.String, java.lang.String, java.lang.String,
   *     org.opencms.xml.containerpage.CmsContainerElementBean, org.opencms.util.CmsUUID,
  ...
  /**
   * @see
   *     org.opencms.workplace.editors.directedit.I_CmsEditHandler#prepareForEdit(org.opencms.file.CmsObject,
   *     org.opencms.xml.containerpage.CmsContainerElementBean, java.lang.String,
   *     org.opencms.util.CmsUUID, java.util.Map)
   */
  @Override
