...
public final class Messages extends A_CmsMessageBundle {
  ...
  public static final String ERR_DEFAULT_TEMPLATE_ADE_WARNING_0 =
      "ERR_DEFAULT_TEMPLATE_ADE_WARNING_0";
  ...
  /** Message constant for key in the resource bundle. */
  public static final String ERR_WORKPLACE_SERVER_CHECK_FAILED_0 =
      "ERR_WORKPLACE_SERVER_CHECK_FAILED_0";
  ...
  /** Message constant for key in the resource bundle. */
  public static final String GUI_DIALOG_BUTTON_SAVE_AND_EXIT_0 =
      "GUI_DIALOG_BUTTON_SAVE_AND_EXIT_0";
  ...
  /** Message constant for key in the resource bundle. */
  public static final String GUI_EDITOR_WIDGET_OPTIONALELEMENT_0 =
      "GUI_EDITOR_WIDGET_OPTIONALELEMENT_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_EDITOR_WIDGET_VALIDATION_ERROR_2 =
      "GUI_EDITOR_WIDGET_VALIDATION_ERROR_2";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_EDITOR_WIDGET_VALIDATION_ERROR_TITLE_0 =
      "GUI_EDITOR_WIDGET_VALIDATION_ERROR_TITLE_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_EDITOR_WIDGET_VALIDATION_WARNING_2 =
      "GUI_EDITOR_WIDGET_VALIDATION_WARNING_2";
  ...
  /** Message constant for key in the resource bundle. */
  public static final String GUI_LABEL_BROADCAST_FROM_SYSTEM_0 =
      "GUI_LABEL_BROADCAST_FROM_SYSTEM_0";
  ...
  /** Message constant for key in the resource bundle. */
  public static final String GUI_LOGIN_FAILED_NO_TARGET_PERMISSIONS_1 =
      "GUI_LOGIN_FAILED_NO_TARGET_PERMISSIONS_1";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_LOGIN_FAILED_NO_WORKPLACE_PERMISSIONS_0 =
      "GUI_LOGIN_FAILED_NO_WORKPLACE_PERMISSIONS_0";
  ...
  /** Message constant for key in the resource bundle. */
  public static final String GUI_LOGIN_HEADLINE_SELECTED_ORGUNIT_1 =
      "GUI_LOGIN_HEADLINE_SELECTED_ORGUNIT_1";
  ...
  /** Message constant for key in the resource bundle. */
  public static final String GUI_LOGIN_OPENCMS_IS_FREE_SOFTWARE_0 =
      "GUI_LOGIN_OPENCMS_IS_FREE_SOFTWARE_0";
  ...
  /** Message constant for key in the resource bundle. */
  public static final String GUI_LOGIN_ORGUNIT_SEARCH_NORESULTS_0 =
      "GUI_LOGIN_ORGUNIT_SEARCH_NORESULTS_0";
  ...
  /** Message constant for key in the resource bundle. */
  public static final String GUI_LOGIN_SUCCESS_WITH_MESSAGE_WITHOUT_TIME_1 =
      "GUI_LOGIN_SUCCESS_WITH_MESSAGE_WITHOUT_TIME_1";
  ...
  /** Message constant for key in the resource bundle. */
  public static final String INIT_MAX_FILE_UPLOAD_SIZE_UNLIMITED_0 =
      "INIT_MAX_FILE_UPLOAD_SIZE_UNLIMITED_0";
  ...
  /** Message constant for key in the resource bundle. */
  public static final String INIT_REMOVE_EXPLORER_TYPE_SETTING_1 =
      "INIT_REMOVE_EXPLORER_TYPE_SETTING_1";

  /** Message constant for key in the resource bundle. */
  public static final String INIT_USER_MANAGEMENT_ICON_DISABLED_0 =
      "INIT_USER_MANAGEMENT_ICON_DISABLED_0";

  /** Message constant for key in the resource bundle. */
  public static final String INIT_USER_MANAGEMENT_ICON_ENABLED_0 =
      "INIT_USER_MANAGEMENT_ICON_ENABLED_0";

  /** Message constant for key in the resource bundle. */
  public static final String INIT_VFS_ACCESS_INITIALIZED_0 = "INIT_VFS_ACCESS_INITIALIZED_0";

  /** Message constant for key in the resource bundle. */
  public static final String INIT_WORKPLACE_INITIALIZE_START_0 =
      "INIT_WORKPLACE_INITIALIZE_START_0";
  ...
  /** Message constant for key in the resource bundle. */
  public static final String INIT_XMLCONTENT_AUTOCORRECT_DISABLED_0 =
      "INIT_XMLCONTENT_AUTOCORRECT_DISABLED_0";

  /** Message constant for key in the resource bundle. */
  public static final String INIT_XMLCONTENT_AUTOCORRECT_ENABLED_0 =
      "INIT_XMLCONTENT_AUTOCORRECT_ENABLED_0";
  ...
  /** Message constant for key in the resource bundle. */
  public static final String LOG_INVALID_SYNCHRONIZE_EXCLUDE_PATTERN_1 =
      "LOG_INVALID_SYNCHRONIZE_EXCLUDE_PATTERN_1";
  ...
  /** Message constant for key in the resource bundle. */
  public static final String LOG_USERAGREEMENT_WRONG_VERSION_2 =
      "LOG_USERAGREEMENT_WRONG_VERSION_2";
