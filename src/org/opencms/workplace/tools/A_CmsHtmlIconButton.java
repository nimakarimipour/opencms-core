...
public abstract class A_CmsHtmlIconButton implements I_CmsHtmlIconButton {
  ...
  public static final CmsMessageContainer EMPTY_MESSAGE =
      Messages.get().container(Messages.GUI_EMPTY_MESSAGE_0);
  ...
  public static String defaultButtonHtml(
    ...
    if ((style != CmsHtmlIconButtonStyleEnum.SMALL_ICON_ONLY)
        && CmsStringUtil.isNotEmptyOrWhitespaceOnly(name)) {
      if (CmsStringUtil.isNotEmptyOrWhitespaceOnly(iconPath)
  ...
  /**
   * @see
   *     org.opencms.workplace.tools.I_CmsHtmlIconButton#setHelpText(org.opencms.i18n.CmsMessageContainer)
   */
  ...
  /**
   * @see
   *     org.opencms.workplace.tools.I_CmsHtmlIconButton#setName(org.opencms.i18n.CmsMessageContainer)
   */
