...
public class CmsModuleDeleteThread extends A_CmsReportThread {
     ...
     */
    public CmsModuleDeleteThread(CmsObject cms, @RUntainted List<@RUntainted String> moduleNames, boolean replaceMode) {
    ...
    public void run() {
        ...
        try {
            ...
            @RUntainted Iterator<@RUntainted String> j = m_moduleNames.iterator();
            while (j.hasNext()) {
                @RUntainted String moduleName = j.next();
