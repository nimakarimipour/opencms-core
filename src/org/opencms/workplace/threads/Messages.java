...
public final class Messages extends A_CmsMessageBundle {
  ...
  /** Message constant for key in the resource bundle. */
  public static final String GUI_POINTER_VALIDATION_THREAD_NAME_0 =
      "GUI_POINTER_VALIDATION_THREAD_NAME_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_RELATION_DELETION_VALIDATOR_THREAD_NAME_1 =
  ...
  /** Message constant for key in the resource bundle. */
  public static final String GUI_XMLCONTENTREPAIR_THREAD_NAME_0 =
  ...
  /** Message constant for key in the resource bundle. */
  public static final String RPT_RELATIONS_DELETION_EXPANDFOLDER_1 =
      "RPT_RELATIONS_DELETION_EXPANDFOLDER_1";

  /** Message constant for key in the resource bundle. */
  public static final String RPT_RELATIONS_DELETION_EXPANDFOLDER_BEGIN_0 =
      "RPT_RELATIONS_DELETION_EXPANDFOLDER_BEGIN_0";

  /** Message constant for key in the resource bundle. */
  public static final String RPT_RELATIONS_DELETION_EXPANDFOLDER_END_0 =
      "RPT_RELATIONS_DELETION_EXPANDFOLDER_END_0";

  /** Message constant for key in the resource bundle. */
  public static final String RPT_RELATIONS_DELETION_EXPANDSIBLING_1 =
      "RPT_RELATIONS_DELETION_EXPANDSIBLING_1";

  /** Message constant for key in the resource bundle. */
  public static final String RPT_RELATIONS_DELETION_EXPANDSIBLINGS_BEGIN_0 =
      "RPT_RELATIONS_DELETION_EXPANDSIBLINGS_BEGIN_0";

  /** Message constant for key in the resource bundle. */
  public static final String RPT_RELATIONS_DELETION_EXPANDSIBLINGS_END_0 =
      "RPT_RELATIONS_DELETION_EXPANDSIBLINGS_END_0";

  /** Message constant for key in the resource bundle. */
  public static final String RPT_RELATIONS_DELETION_REFERENCING_1 =
      "RPT_RELATIONS_DELETION_REFERENCING_1";

  /** Message constant for key in the resource bundle. */
  public static final String RPT_RELATIONS_DELETION_VALIDATION_1 =
      "RPT_RELATIONS_DELETION_VALIDATION_1";

  /** Message constant for key in the resource bundle. */
  public static final String RPT_RELATIONS_DELETION_VALIDATION_BEGIN_0 =
      "RPT_RELATIONS_DELETION_VALIDATION_BEGIN_0";

  /** Message constant for key in the resource bundle. */
  public static final String RPT_RELATIONS_DELETION_VALIDATION_END_0 =
