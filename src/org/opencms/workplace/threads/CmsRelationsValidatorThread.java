...
public class CmsRelationsValidatorThread extends A_CmsReportThread {
  ...
  /**
   * A list of cms resources to be published directly.
   *
   * <p>
   */
  ...
  /**
   * Creates a thread that validates the relations in the list of unpublished file(s) of the current
   * (offline) project.
   *
   * <p>The publish list *IS* saved in the current user's workplace settings for further processing
   * by other threads. The last thread processing this publish list *MUST* ensure that the publish
   * list gets removed from the current user's workplace settings!
   *
   * <p>
   *
   * @param cms the current OpenCms context object
   ...
   */
  public CmsRelationsValidatorThread(
