...
public class CmsXmlDocumentComparison extends CmsResourceComparison {
  ...
  static class CmsXmlContentElementPathExtractor implements I_CmsXmlContentValueVisitor {
    ...
    /**
     * Creates a CmsXmlContentElementPathExtractor.
     *
     * <p>
     */
    ...
    public void visit(I_CmsXmlContentValue value) {
      ...
      if (value.isSimpleType()) {
        m_elementPaths.add(
            new CmsXmlContentElementComparison(
                value.getLocale(), value.getPath(), value.getTypeName()));
      }
    }

    /**
     * Returns the elementPaths.
     *
     * <p>
     *
  ...
  /**
   * Returs a list of all element names of a xml page.
   *
   * <p>
   *
