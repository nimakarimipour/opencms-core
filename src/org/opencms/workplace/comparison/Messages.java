...
public final class Messages extends A_CmsMessageBundle {
  ...
  /** Message constant for key in the resource bundle. */
  public static final String GUI_COMPARE_HIDE_IDENTICAL_ATTRIBUTES_0 =
      "GUI_COMPARE_HIDE_IDENTICAL_ATTRIBUTES_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_COMPARE_HIDE_IDENTICAL_ELEMENTS_0 =
      "GUI_COMPARE_HIDE_IDENTICAL_ELEMENTS_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_COMPARE_HIDE_IDENTICAL_PROPERTIES_0 =
      "GUI_COMPARE_HIDE_IDENTICAL_PROPERTIES_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_COMPARE_IDENTICAL_TEXT_DIFFERENT_HTML_0 =
      "GUI_COMPARE_IDENTICAL_TEXT_DIFFERENT_HTML_0";
  ...
  /** Message constant for key in the resource bundle. */
  public static final String GUI_COMPARE_SHOW_ALL_ATTRIBUTES_0 =
      "GUI_COMPARE_SHOW_ALL_ATTRIBUTES_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_COMPARE_SHOW_ALL_ELEMENTS_0 = "GUI_COMPARE_SHOW_ALL_ELEMENTS_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_COMPARE_SHOW_ALL_PROPERTIES_0 =
      "GUI_COMPARE_SHOW_ALL_PROPERTIES_0";
