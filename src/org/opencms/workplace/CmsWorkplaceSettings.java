...
/**
 * Object to conveniently access and modify the state of the workplace for a user, will be stored in
...
public class CmsWorkplaceSettings {
  ...
  private Map<String, @RUntainted String> m_lastUsedGalleries;
   ...
   *
   * <p>Use this mechanism for transferring a resource collector between several page instances of
   ...
   *
   * <p>Use this mechanism for transferring a complex object between several page instances of an
   * interactive dialog. This is usually required when editing a complex object in a dialog of the
   * "Administration" view.
   *
   * <p>
   *
   ...
   *
   * <p>This parameter is used in the administration to filter files belonging to a project.
   *
   ...
   *
   * <p>This parameter is used in the administration to filter files belonging to a selected
   * project.
   *
   ...
   *
   * <p>Use this mechanism for transfering a html list object between several page instances of an
   * interactive dialog. This is usually required when having several lists in a tool or when a list
   * action another list displays of the "Administration" view.
   *
   * <p>
   *
   * @return the dialog object
   ...
   *
   * <p>The view startup page can be used to directly load a specific workplace dialog or other
   * workplace resource in the OpenCms workplace base frameset after the user logs in.
   *
   * <p>
   *
   ...
   * <p>
   *
   * @return <code>true</code> if the user agreement has been accepted in the current workplace
   ...
   */
  public void setLastUsedGallery(String galleryKey, @RUntainted String gallerypath) {

    m_lastUsedGalleries.put(galleryKey, gallerypath);
    LOG.info(
        "user=" + m_user.getName() + ": setLastUsedGallery " + galleryKey + " -> " + gallerypath);
  }
   ...
   * @see org.opencms.workplace.list.A_CmsListDialog#setListObject(Class,
   ...
   * <p>
   *
   * @param userAgreementAccepted <code>true</code> if the user agreement has been accepted in the
   *     current workplace session, otherwise <code>false</code>
   */
