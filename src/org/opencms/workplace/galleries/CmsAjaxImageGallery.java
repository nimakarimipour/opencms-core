 ...
 * gallery dialog used in the XML content editors, WYSIWYG editors and context menu.
 *
 * <p>
 *
 * @since 7.5.0
...
public class CmsAjaxImageGallery extends A_CmsAjaxGallery {
   ...
   *
   * <ul>
   *   <li><code>scalepath</code>: scaling parameters.
   *   <li><code>width</code>: image width.
   *   <li><code>height</code>: image height.
   *   <li><code>id</code>: image ID.
   *   <li><code>type</code>: image type.
   *   <li><code>hash</code>: image structure id hash code.
   *   <li><code>copyright</code>: image copyright.
   * </ul>
   *
