...
/**
 * Provides the specific constants, members and helper methods to generate the content of the
 * external link gallery dialog used in the XML content editors, WYSIWYG editors and context menu.
 *
 * <p>
 *
 * @since 7.5.0
...
public class CmsAjaxLinkGallery extends A_CmsAjaxGallery {
   ...
   *
   * <ul>
   *   <li><code>pointer</code>: the content of the pointer resource. This could be an external or
   *       internal link.
   * </ul>
   *
   * @see org.opencms.workplace.galleries.A_CmsAjaxGallery#buildJsonItemSpecificPart(JSONObject
   *     jsonObj, CmsResource res, String sitePath)
   */
  @Override
