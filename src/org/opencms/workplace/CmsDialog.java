...
public class CmsDialog extends CmsToolDialog {
     ...
     */
    public String dialogContent(int segment, @RUntainted String title) {
     ...
     */
    public String dialogContentStart(@RUntainted String title) {
     ...
     */
    public String dialogHead(@RUntainted String title) {
