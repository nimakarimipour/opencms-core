...
/**
 * Holds all information to build the explorer context menu of a resource type and information for
 * the new resource dialog.
 *
 * <p>Objects of this type are sorted by their order value which specifies the order in the new
 * resource dialog.
 *
 * <p>
 *
...
public class CmsExplorerTypeSettings implements Comparable<CmsExplorerTypeSettings>, Serializable {
  ...
  /** Default view orders. */
  private static Map<String, Integer> m_defaultViewOrders =
  ...
  /**
   * The creatable flag, <code>false</code> for types that can not be created through the workplace
   * UI.
   */
  ...
  /**
   * Gets the default view order for the given type name (or null, if there is no default view
   * order).
   *
   * <p>
   *
   ...
   */
  public void addIconRule(
      String extension, String icon, String bigIcon, String smallIconStyle, String bigIconStyle) {
   ...
   * <p>
   *
   * @param useDefault true if a default should be returned in the case where the view order is not
   *     configured
   ...
   * <p>
   *
   * @return true if navigation properties should automatically be added on resource creation,
   *     otherwise false
   */
   ...
   * <p>
   *
   * @return true if the title property should automatically be added on resource creation,
   *     otherwise false
   */
  ...
  /**
   * Returns if this explorer type setting displays the navigation properties in the special
   * properties dialog.
   *
   * <p>
   *
   * @return true, if this explorer type setting displays the navigation properties in the special
   *     properties dialog
   */
   ...
   *
   * <p>This is determined by the presence of the &lt;editoptions&gt; node in the Cms workplace
   * configuration.
   *
   * <p>
   */
    ...
    try {
      ...
      if (LOG.isDebugEnabled()) {
        LOG.debug(
            Messages.get()
                .getBundle()
                .key(Messages.LOG_SET_NEW_RESOURCE_ORDER_1, newResourceOrder));
      }
    } catch (Exception e) {
   ...
   *
   * @param enabled true, if this explorer type setting uses a special properties dialog
   * @param showNavigation true, if this explorer type setting displays the navigation properties in
   *     the special properties dialog
   */
  public void setPropertyDefaults(String enabled, String showNavigation) {
    ...
    if (LOG.isDebugEnabled()) {
      LOG.debug(
          Messages.get()
              .getBundle()
              .key(Messages.LOG_SET_PROP_DEFAULTS_2, enabled, showNavigation));
    }
  }
  ...
  /**
   * Sets if this explorer type setting displays the navigation properties in the special properties
   * dialog.
   *
   * <p>
   *
   * @param navigation true, if this explorer type setting displays the navigation properties in the
