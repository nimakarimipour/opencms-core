 ...
 *
 * <p>If the time between the last write operation and a read operation is longer than the
 * expiration time, null will be returned from the read operation.
 *
 * <p>
 *
...
public class CmsExpiringValue<T> {
   ...
   *
   * <p>Returns null if the last update was longer ago than the expiration time.
   *
