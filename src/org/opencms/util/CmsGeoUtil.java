...
public final class CmsGeoUtil {
  ...
  /**
   * Parses coordinates, either from a lat,lon pair or from the JSON generated by the location
   * picker.
   *
  ...
  public static boolean validateLocationPickerCoordinates(JSONObject jsonObject) {
    ...
    try {
      ...
      if (CmsStringUtil.isEmptyOrWhitespaceOnly(latitude)
          || CmsStringUtil.isEmptyOrWhitespaceOnly(longitude)) {
        return false;
      }
