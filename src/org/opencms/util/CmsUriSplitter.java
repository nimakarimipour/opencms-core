 ...
 *
 * <p>An URI is splitted into a <code>prefix</code>, a <code>anchor</code> and a <code>query</code>
 * part.
 */
public class CmsUriSplitter {

  /** Empty (non null) StringBuffer constant. */
  private static final @RUntainted StringBuffer EMPTY_BUFFER = new StringBuffer(0);
   ...
   *
   * <p>Using 'strict' parsing mode, all requirements for an URI are checked. If 'strict' is set to
   * <code>false</code>, then only some simple parsing rules are applied, in which case the result
   * may not be 100% valid (but still usable). If 'strict' parsing generates an error, then simple
   * parsing is used as a fallback.
   *
   * <p>
   *
   * @param uri the URI to split
   * @param strict if <code>true</code>, then 'strict' parsing mode is used, otherwise a relaxed URI
   *     parsing is done
   */
  public CmsUriSplitter(@RUntainted String uri, boolean strict) {
    ...
    if (strict) {
      try {
        ...
        @RUntainted URI tempUri = new URIBuilder(u).setCustomQuery(null).setFragment(null).build();
    ...
    if (!strict && (uri != null)) {
      // use simple parsing
      @RUntainted StringBuffer prefix = new StringBuffer(uri.length());
      ...
      for (int i = 0; i < len; i++) {
        ...
        if ((c == '?')
            && (cur != 2)) { // only reset query buffer if we're not already in the anchor
          cur = 1;
  ...
  public boolean equals(Object obj) {
    ...
    if (obj instanceof CmsUriSplitter) {
      ...
      if (!((m_protocol == other.m_protocol)
          || ((m_protocol != null) && m_protocol.equals(other.m_protocol)))) {
        return false;
      }
      if (!((m_prefix == other.m_prefix)
          || ((m_prefix != null) && m_prefix.equals(other.m_prefix)))) {
        return false;
      }
      if (!((m_anchor == other.m_anchor)
          || ((m_anchor != null) && m_anchor.equals(other.m_anchor)))) {
        return false;
      }
  ...
  /**
   * Returns the anchor part of the uri, for example <code>someanchor</code>, or <code>null</code>
   ...
   * or <code>null</code> if no prefix is available.
   *
   * <p>
   *
  ...
  /**
   * Returns the URI protocol, for example <code>http</code> or <code>https</code>.
   *
   * <p>
   *
  ...
  /**
   * Returns the query part of the uri, for example <code>a=b&c=d</code>, or <code>null</code> if no
   * query is available.
   *
   * <p>
   *
  ...
  /**
   * Returns the suffix part of the uri, a combination of query and anchor, for example <code>
   * ?a=b&c=d#someanchor</code>, or the empty String if no suffix is available.
   *
   * <p>
   *
  ...
  /**
   * Returns <code>true</code> if the URI was parsed error free in 'strict' mode, or if the simple
   * mode was used.
   *
   * <p>
   *
   * @return <code>true</code> if the URI was parsed error free in 'strict' mode, or if the simple
   *     mode was used
   */
   ...
   *
   * <p>This method will do a "best effort" to convert the original input String to a legal URI.
   * Most notably, it will be able to handle original input Strings that contain a space " " and
   * other usually illegal characters.
   *
   * <p>
   *
   ...
   */
  public @RUntainted URI toURI() throws URISyntaxException {
