 ...
 *
 * <p>This is mostly useful when using paths as map keys, when you are not sure if the paths you are
 * processing have a trailing slash or not.
 *
 * <p>The paths are stored in the form '/foo/bar/baz', i.e. they include a leading but no trailing
 * slash, except in the case of the root path '/'.
 */
