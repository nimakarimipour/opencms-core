...
public final class CmsRequestUtil {
     ...
     */
    public static Map<String, String[]> createParameterMap(Map<@RUntainted String, ?> params) {
     ...
     */
    public static JSONObject getJsonParameterMap(Map<@RUntainted String, String[]> params) {

        JSONObject result = new JSONObject();
        for (Map.Entry<@RUntainted String, String[]> entry : params.entrySet()) {
            @RUntainted String paramKey = entry.getKey();
    ...
    public static void setCookieValue(CmsJspActionElement jsp, @RUntainted String name, @RUntainted String value) {
        ...
        @RUntainted Cookie cookie = new Cookie(name, value);
