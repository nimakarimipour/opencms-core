 ...
 *
 * <p>This can be used for writing large XML files where keeping a DOM structure in memory might
 * cause out-of-memory issues, like e.g. when writing the OpenCms export files.
 *
 * <p>It can also be used if a <code>{@link org.xml.sax.ContentHandler}</code> is needed that should
...
public class CmsXmlSaxWriter extends DefaultHandler implements LexicalHandler {
  ...
  /**
   * Indicates if characters that are not part of the selected encoding are to be replaced with the
   * XML <code>&amp;#123;</code> entity representation in the generated output (not in CDATA
   * elements).
   */
  ...
  /**
   * Creates a SAX event handler that generates XML / HTML Strings from the events caught using a
   * new <code>{@link StringWriter}</code> and the OpenCms default encoding.
   *
   * <p>
   */
  ...
  /**
   * Creates a SAX event handler that generates XML / HTML Strings from the events caught using a
   * new <code>{@link StringWriter}</code> and the given encoding.
   *
   * <p>
   *
  ...
  /**
   * A SAX event handler that generates XML / HTML Strings from the events caught and writes them to
   * the given Writer.
   *
   * <p>
   *
  ...
  public void characters(char[] buf, int offset, int len) throws SAXException {
    ...
    if (m_escapeXml && !m_isCdata) {
      ...
      if (m_escapeUnknownChars) {
        // escape all chars that can not be displayed in the selected encoding (using '&#123;'
        // entities)
  ...
  /**
   * Returns <code>true</code> if charactes that are not part of the selected encoding are to be
   * replaced with the HTML <code>&amp;#123;</code> entity representation in the generated output
   * (not in CDATA elements).
   *
   * <p>
   *
   * @return <code>true</code> if charactes that are not part of the selected encoding are to be
   *     replaced with the HTML entity representation
   */
  ...
  /**
   * Returns <code>true</code> if XML entities are to be encoded in the generated output (not in
   * CDATA elements).
   *
   * <p>
   *
   * @return <code>true</code> if XML entities are to be encoded in the generated output (not in
   *     CDATA elements)
   */
  ...
  /**
   * If set to <code>true</code>, then charactes that are not part of the selected encoding are to
   * be replaced with the XML <code>&amp;#123;</code> entity representation in the generated output
   * (not in CDATA elements).
   *
   * <p>
   *
  ...
  /**
   * If set to <code>true</code>, then XML entities are to be encoded in the generated output (not
   * in CDATA elements).
   *
   * <p>
   *
   ...
   *
   * <p>If the local name is the empty String "", the qualified name is used.
   *
   * <p>
   *
