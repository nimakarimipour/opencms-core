...
/**
 * Describes a macro mapper, which is used to efficiently resolve macros in the form of <code>%(key)
 * </code> or <code>${key}</code> in an input String.
 *
 ...
 *
 * <p>The macro replacement is pre-implemented in <code>
...
public interface I_CmsMacroResolver {
  ...
  /**
   * Resolves a single macro to the macro value, returns <code>null</code> if the macro could not be
   * resolved.
   *
   * <p>
   *
   ...
   */
  @RUntainted String getMacroValue(@RUntainted String macro);

  /**
   * Returns <code>true</code> if macros that could not be resolved are kept "as is" in the input
   * String, <code>false</code> if they are replaced by an empty String.
   *
   * <p>
   *
   * @return <code>true</code> if macros that could not be resolved are kept "as is" in the input
   *     String, <code>false</code> if they are replaced by an empty String
   */
   ...
   *
   * <p>The flag {@link #isKeepEmptyMacros()} controls how to deal with macros found in the input
