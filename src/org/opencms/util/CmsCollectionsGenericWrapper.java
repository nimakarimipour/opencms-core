...
public final class CmsCollectionsGenericWrapper {
  ...
  /**
   * Provides a wrapper to access the {@link LazyMap} functionality that avoids warnings with Java
   * 1.5 generic code.
   *
   * <p>
   *
  ...
  /**
   * Provides a wrapper to create a {@link LRUMap} that avoids warnings with Java 1.5 generic code.
   *
   * <p>
   *
   * @param <K> the type of keys maintained by the returned map
  ...
  /**
   * Provides a wrapper to create a {@link LRUMap} with the given size that avoids warnings with
   * Java 1.5 generic code.
   *
   * <p>
   *
   * @param <K> the type of keys maintained by the returned map
  ...
  /**
   * Provides a wrapper to convert an object into a list that avoids warnings with Java 1.5 generic
   * code.
   *
   * <p>
   *
  ...
  /**
   * Provides a wrapper to convert an object into a map that avoids warnings with Java 1.5 generic
   * code.
   *
   * <p>
   *
