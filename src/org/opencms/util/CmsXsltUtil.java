 ...
 *
 * <p>TODO: This class is apparently customer specific and should probably be removed from the core!
 *
 * @since 6.2.1
 */
public final class CmsXsltUtil {
  ...
  /**
   * Returns the delimiter that most often occures in the CSV content and is therefore best
   * applicable for the CSV data .
   *
   * <p>
   *
   ...
   *
   * <p>The method does not use DOM4J, because iso-8859-1 code ist not transformed correctly.
   *
   ...
   */
  public static String transformCsvContent(
      CmsObject cms, String xsltFile, String csvContent, String delimiter)
    ...
    try {
      ...
      throw new CmsXmlException(
          Messages.get().container(Messages.ERR_CSV_XML_TRANSFORMATION_FAILED_0));
    }
  ...
  /**
   * Converts a delimiter separated format string int o colgroup html fragment.
   *
   * <p>
   *
    ...
    while ((line = br.readLine()) != null) {
      ...
      while (t.hasMoreElements()) {
        ...
        if (!item.equals(delimiter)) {
          ...
          // in order to allow links, lines starting and ending with tag delimiters (< ...>) remains
          // unescaped
  ...
  /**
   * Tests if the given string is a <code>delimiter</code> separated list of formatting information.
   *
   * <p>
   *
