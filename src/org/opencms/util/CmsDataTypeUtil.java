...
public final class CmsDataTypeUtil {
     ...
     */
    public static @RPolyTainted Object dataDeserialize(@RPolyTainted byte[] data, String type) throws IOException, ClassNotFoundException {
     ...
     */
    public static @RPolyTainted Object parse(@RPolyTainted String data, Class<?> clazz) {
     ...
     * @return the converted data value
     */
    public static @RPolyTainted CmsUUID parseUUID(@RUntainted String data) {
