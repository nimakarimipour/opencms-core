...
public class CmsParameterEscaper {
    ...
    private Set<@RUntainted String> m_cleanHtml = new HashSet<@RUntainted String>();
    ...
    private Set<@RUntainted String> m_escapeInvalid = new HashSet<>();

    /** The names of parameters which shouldn't be escaped. */
    private Set<@RUntainted String> m_exceptions = new HashSet<@RUntainted String>();
