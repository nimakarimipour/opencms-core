 ...
 * of which parameters to escape (or not escape), and which parameters need to be processed by
 * AntiSamy.
 *
 * <p>
 */
public class CmsParameterEscaper {
  ...
  static {
    try {
      ...
      InputStream stream =
          CmsParameterEscaper.class.getClassLoader().getResourceAsStream(resourceName);
