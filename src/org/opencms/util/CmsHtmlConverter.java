...
public class CmsHtmlConverter {
    ...
    private @RUntainted String m_mode;
     ...
     */
    public CmsHtmlConverter(String encoding, @RUntainted String mode) {
     ...
     * @param mode the conversion mode to use
     */
    private void init(String encoding, @RUntainted String mode) {
