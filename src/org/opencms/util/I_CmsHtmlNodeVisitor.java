...
public interface I_CmsHtmlNodeVisitor {
   ...
   *
   * <p>This will most likely be done with data from an xsd, custom jsp tag, ...
   *
   * <p>
   *
  ...
  /**
   * Sets a list of upper case tag names for which parsing / visitng should not correct missing
   * closing tags.
   *
   * <p>This has to be used before <code>{@link #process(String, String)}</code> is invoked to take
   * an effect.
   *
   * <p>
   *
   * @param noAutoCloseTags a list of upper case tag names for which parsing / visiting should not
   *     correct missing closing tags to set.
   */
