...
public class CmsWidgetUtil {
  ...
  /**
   * Generates a pipe separated option string from the map, e.g., for {key1 -> value1, key2 -> null,
   * key3 -> value3} the string "key1=value1|key2|key3=value3" will be generated.
   *
  ...
  /**
   * Returns a flag, indicating if a boolean option is set, i.e., it is in the map and has value
   * null or (case-insensitive) "true".
   *
  ...
  /**
   * Returns the value of an option, or the default if the value is null or the key is not part of
   * the map.
   *
   * @param configOptions the map with the config options.
   * @param optionKey the option to get the value of
   * @param defaultValue the default value to return if the option is not set.
   * @return the value of an option, or the default if the value is null or the key is not part of
   *     the map.
   */
  public static String getStringOption(
      Map<String, String> configOptions, String optionKey, String defaultValue) {
   ...
   * E.g., for "Key1=Value1|KEY2|key3=value3" the map {key1 -> Value1, key2 -> null, key3 -> value3}
   * is returned
   *
