...
/**
 * The attribute configuration. Stating the attribute label, help, widget name and widget
 * configuration.
 *
 * <p>
 */
public class CmsAttributeConfiguration implements IsSerializable {
  ...
  /**
   * Returns <code>true</code> if the widget should be displayed in single line view.
   *
   * <p>
   *
  ...
  /**
   * Returns <code>true</code> if the attribute is set dynamically and not from the XML content.
   *
   * <p>
   *
