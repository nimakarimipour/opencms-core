...
public class CmsEntity implements HasValueChangeHandlers<CmsEntity>, Serializable {
  ...
  /**
   * Returns the value of a simple attribute for the given path or <code>null</code>, if the value
   * does not exist.
   *
   * <p>
   *
  ...
  /**
   * Gets the values reachable from a given object (an entity or a string) with a single XPath
   * component.
   *
   * <p>If entityOrString is a string, and pathComponent is "VALUE", a list containing only
   * entityOrString is returned. Otherwise, entityOrString is assumed to be an entity, and the
   * pathComponent is interpreted as a field of the entity (possibly with an index).
   *
   * @param entityOrString the entity or string from which to get the values for the given path
   *     component
   * @param pathComponent the path component
   * @return the list of reachable values
   */
  public static List<Object> getValuesForPathComponent(
      Object entityOrString, String pathComponent) {
    ...
    if (pathComponent.equals("VALUE")) {
      ...
      if (entityOrString instanceof CmsEntity) {
        ...
        String attributeName =
            entity.getTypeName() + "/" + CmsContentDefinition.removeIndex(pathComponent);
        CmsEntityAttribute attribute = entity.getAttribute(attributeName);
      ...
      if (m_simpleAttributes.keySet().equals(test.m_simpleAttributes.keySet())
        ...
        for (String attributeName : m_simpleAttributes.keySet()) {
          if (!m_simpleAttributes
              .get(attributeName)
              .equals(test.m_simpleAttributes.get(attributeName))) {
            result = false;
            break;
          }
        }
  ...
  public CmsEntityAttribute getAttribute(String attributeName) {
    ...
    if (m_simpleAttributes.containsKey(attributeName)) {
      return CmsEntityAttribute.createSimpleAttribute(
          attributeName, m_simpleAttributes.get(attributeName));
    }
    if (m_entityAttributes.containsKey(attributeName)) {
      return CmsEntityAttribute.createEntityAttribute(
          attributeName, m_entityAttributes.get(attributeName));
    }
    return null;
  }
   ...
   *
   * <p>Will return <code>null</code> if no entity with the given id is present.
   *
   * <p>
   *
  ...
  public boolean hasAttribute(String attributeName) {
    ...
    return m_simpleAttributes.containsKey(attributeName)
        || m_entityAttributes.containsKey(attributeName);
  }
  ...
  /**
   * Fires the change event for this entity.
   *
   * <p>
   *
  ...
  /**
   * Adds the value change handler to the given entity.
   *
   * <p>
   *
  ...
  /**
   * Removes the child entity change handler.
   *
   * <p>
   *
   * @param child the child entity
