...
public interface I_CmsSerialDateValue {
  ...
  public enum Month {
    ...
    /**
     * Returns the (maximal) number of days the month can have. I.e., for February 29 and for the
     * other months either 30 or 31 depending on the month.
     *
  ...
  public enum WeekDay {
    ...
    /**
     * Conversion of integers to weekdays. The conversion is NOT the inverse of the ordinals. The
     * enumeration here starts with 1, i.e., fromInt(i).ordinal() == i-1. The shift is added to get
     * the numbers as used in {@link java.util.Calendar}.
     *
    ...
    /**
     * Object Converts the {@link WeekDay} to it's corresponding number, i.e. it's ordinal plus 1.
  ...
  /**
   * Returns a flag, indicating if the events should be treated as "current" till they end (or only
   * till they start).
   *
   * @return <code>true</code> if the event is "current" till it ends, <code>false</code> if it is
   *     current till it starts.
   */
