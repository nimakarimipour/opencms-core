...
/**
 * An exception which indicates that the user tried to trigger a workflow action for a set of
 * resources for which some parent folder is not included in the set, but has the resource state
 * 'new'.
 */
