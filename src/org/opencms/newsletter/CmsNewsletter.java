...
public class CmsNewsletter implements I_CmsNewsletter {
  ...
  /**
   * @see org.opencms.newsletter.I_CmsNewsletter#addAttachment(org.opencms.file.CmsObject,
  ...
  /**
   * @see
   *     org.opencms.newsletter.I_CmsNewsletter#addContent(org.opencms.newsletter.I_CmsNewsletterContent)
   */
        ...
        while (attachments.hasNext()) {
          ...
          String propertyDescription =
              cms.readPropertyObject(
                      cms.getSitePath(resource), CmsPropertyDefinition.PROPERTY_DESCRIPTION, true)
                  .getValue();
          if (CmsStringUtil.isNotEmptyOrWhitespaceOnly(propertyDescription)) {
            ...
            String propertyTitle =
                cms.readPropertyObject(
                        cms.getSitePath(resource), CmsPropertyDefinition.PROPERTY_TITLE, true)
                    .getValue();
