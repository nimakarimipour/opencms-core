...
public class CmsFlexCacheConfiguration {
   ...
   *
   * <p>The amount of server memory available obviously is the critical factor here. The values
   * below are set in byte size. The default is 2mb memory for the cached pages _or_ a maximum of
   * 4000 cached page variations in total.
   */
  ...
  public void setDeviceSelectorConfiguration(@RUntainted String deviceSelector) {
    ...
    try {
      ...
      LOG.error(
          Messages.get()
              .getBundle()
              .key(Messages.LOG_CLASS_INIT_FAILURE_1, m_deviceSelectorConfiguration),
          t);
      return;
    }
