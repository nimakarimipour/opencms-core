...
public class CmsFlexResponse extends HttpServletResponseWrapper {
    ...
    private Map<@RUntainted String, List<@RUntainted String>> m_bufferHeaders;
    ...
    private Map<@RUntainted String, List<@RUntainted String>> m_headers;
     ...
     */
    public static void processHeaders(Map<@RUntainted String, List<@RUntainted String>> headers, HttpServletResponse res) {

        if (headers != null) {
            Iterator<Map.Entry<@RUntainted String, List<@RUntainted String>>> i = headers.entrySet().iterator();
            while (i.hasNext()) {
                Map.Entry<@RUntainted String, List<@RUntainted String>> entry = i.next();
     ...
     */
    public Map<@RUntainted String, List<@RUntainted String>> getHeaders() {
     ...
     * @param value the value to set
     */
    private void addHeaderList(Map<@RUntainted String, List<@RUntainted String>> headers, @RUntainted String name, @RUntainted String value) {

        List<@RUntainted String> values = headers.get(name);
        if (values == null) {
     ...
     * @param value the value to set
     */
    private void setHeaderList(Map<@RUntainted String, List<@RUntainted String>> headers, @RUntainted String name, @RUntainted String value) {
