...
public class CmsModuleLog {
  ...
  public enum Action {
    ...
    /**
     * Creates new action type with the given print name.
     *
     * <p>
     *
  ...
  public File getLogFile(String moduleName) {
    ...
    return new File(
        OpenCms.getSystemInfo()
            .getAbsoluteRfsPathRelativeToWebInf("packages/_modulelogs/" + moduleName + ".log"));
  }
  ...
  /**
   * Logs a message for the given module.
   *
   * <p>
   *
   * @param moduleName the module name
  ...
  private synchronized void log(String moduleName, String message) {
    ...
    // We re-open the file every time. This should be OK performance-wise, since modules are usually
    // not
