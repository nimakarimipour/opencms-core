 ...
 *
 * <p>A module version number has the form <code>n1.n2.n3.n4</code>. Only <code>n1</code> is
 * required, <code>n2 - n4</code> are optional.
 *
 * <p>The valid range for each <code>n</code> is 0 - 999. Examples for valid version numbers are
 * <code>0.9</code>, <code>1.0.0.5</code> or <code>5</code>. The maximum version number is <code>
 * 999.999.999.999</code>.
 *
 * <p>The comparison is started with <code>n1</code> being the most important value, followed by
 * <code>n2 - n4</code>. For example <code>5.0.0.1 > 4.999.999.999</code> since <code>5 > 4</code>.
 *
 * <p>For any <code>n1 - n4</code>, if <code>n > 0</code> leading zeros are ignored. So <code>
 * 001.002.004.004 = 1.2.3.4</code>. Unrequired leading zeros are automatically stripped from
 * version numbers.
 *
 * <p>
 *
    ...
    for (int i = numbers.length - 1; i >= 0; i--) {
      try {
        ...
        if ((number > 999) || (number < 0)) {
          throw new CmsIllegalArgumentException(
              Messages.get()
                  .container(Messages.ERR_INVALID_VERSION_SUBNUMBER_1, new Integer(number)));
        }
