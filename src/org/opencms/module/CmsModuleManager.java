...
public class CmsModuleManager {
     ...
     * @throws CmsConfigurationException if something goes wrong
     */
    public static @RUntainted List<@RUntainted String> topologicalSort(@RUntainted List<@RUntainted String> moduleNames, String rfsAbsPath)
    throws CmsConfigurationException {

        @RUntainted List<@RUntainted String> modules = new ArrayList<@RUntainted String>(moduleNames);
    ...
    throws CmsIllegalArgumentException, CmsConfigurationException {
        ...
        @RUntainted Map<@RUntainted String, @RUntainted List<@RUntainted String>> moduleDependencies = buildDepsForAllModules(rfsAbsPath, forDeletion);
        @RUntainted Iterator<@RUntainted String> itMods = moduleNames.iterator();
        while (itMods.hasNext()) {
            @RUntainted String moduleName = itMods.next();
            @RUntainted List<@RUntainted String> dependencies = moduleDependencies.get(moduleName);
            if (dependencies != null) {
                @RUntainted List<@RUntainted String> depModules = new ArrayList<@RUntainted String>(dependencies);
