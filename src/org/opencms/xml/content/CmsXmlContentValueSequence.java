...
public class CmsXmlContentValueSequence {
  ...
  public I_CmsXmlContentValue addValue(CmsObject cms, I_CmsXmlSchemaType type, int index) {
    ...
    String xpath =
        CmsXmlUtils.concatXpath(CmsXmlUtils.removeLastXpathElement(getPath()), type.getName());
    return addValue(cms, xpath, index);
  }

  /**
   * Adds a value element of the type the original xpath indicates at the selected index to the XML
   * content document.
   *
   * <p>The "original xpath" is the path used in the constructor when creating this value sequence.
   *
   * <p>
   *
   * @param cms the current users OpenCms context
  ...
  /**
   * Adds a value element of the type indicated by the given xpath at the selected index to the XML
   * content document.
   *
   * <p>
   *
  ...
  /**
   * Returns the count of XML content values for the selected schema type and locale in the XML
   * content.
   *
   * <p>
   *
   * @return the count of XML content values for the selected schema type and locale in the XML
   *     content
   */
  ...
  /**
   * Returns the (simplified) Xpath expression that identifies the root node of this content value
   * sequence.
   *
   * <p>
   *
  ...
  /**
   * Returns the list of XML content values for the selected schema type and locale in the XML
   * content.
   *
   * <p>
   *
   * @return the list of XML content values for the selected schema type and locale in the XML
   *     content
   * @see #getValue(int)
   */
  ...
  /**
   * Returns <code>true</code> if this sequence represents a choice sequence.
   *
   * <p>
   *
