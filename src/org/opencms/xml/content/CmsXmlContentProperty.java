 ...
 *
 * <p>Warning: This class is used by GWT client-side code (See GwtBase.gwt.xml for a list of classes
 * used by GWT client-side code). If you change this class, either make sure that your changes are
 * compatible with GWT, or write a separate client version of the class and put it into super_src.
 *
 * @since 8.0.0
 */
public class CmsXmlContentProperty implements Serializable {
  ...
  public enum PropType {
    ...
    /**
     * Checks if the given type is {@link #vfslist}.
     *
     * <p>
     *
  ...
  /**
   * The value which indicates whether the user can influence how this property is going to be
   * inherited.
   */
   ...
   *
   * <p>This is only used for element settings in formatters, where defaults from setting
   * configuration files can be imported. The returned value is used to look up the setting name to
   * look up for such an import in the setting configuration file.
   *
   ...
   *
   * <p>This flag determines whether a property entered in the sitemap entry editor should be stored
   * by default at the folder or at the default file of a sitemap entry. It only has an effect if
   * the sitemap entry being edited doesn't already have a value for that property at either
   * location.
   *
   * <p>
   *
   ...
   *
   * <p>This method does not modify this object or the object passed as a parameter. The resulting
   * object's fields will be filled with the values from the default if they're null in this object.
   *
