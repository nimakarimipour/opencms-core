...
public final class Messages extends A_CmsMessageBundle {
  ...
  /** Message constant for key in the resource bundle. */
  public static final String ERR_XML_SCHEMA_COULD_NOT_PARSE_PROPERTY_CONFIG_1 =
  ...
  /** Message constant for key in the resource bundle. */
  public static final String ERR_XML_SCHEMA_MAPPING_CLASS_NOT_EXIST_3 =
      "ERR_XML_SCHEMA_MAPPING_CLASS_NOT_EXIST_3";
  ...
  /** Message constant for key in the resource bundle. */
  public static final String ERR_XMLCONTENT_ADD_ELEM_INVALID_IDX_CHOICE_3 =
  ...
  /** Message constant for key in the resource bundle. */
  public static final String ERR_XMLCONTENT_CHECK_INVALID_ELEM_1 =
      "ERR_XMLCONTENT_CHECK_INVALID_ELEM_1";

  /** Message constant for key in the resource bundle. */
  public static final String ERR_XMLCONTENT_CHECK_INVALID_TYPE_1 =
      "ERR_XMLCONTENT_CHECK_INVALID_TYPE_1";

  /** Message constant for key in the resource bundle. */
  public static final String ERR_XMLCONTENT_CHECK_NOT_EMPTY_DOC_0 =
      "ERR_XMLCONTENT_CHECK_NOT_EMPTY_DOC_0";

  /** Message constant for key in the resource bundle. */
  public static final String ERR_XMLCONTENT_CHECK_NOT_OPTIONAL_1 =
  ...
  /** Message constant for key in the resource bundle. */
  public static final String ERR_XMLCONTENT_INVALID_ELEM_DEFAULT_1 =
  ...
  /** Message constant for key in the resource bundle. */
  public static final String ERR_XMLCONTENT_INVALID_ELEM_SEARCHSETTINGS_1 =
      "ERR_XMLCONTENT_INVALID_ELEM_SEARCHSETTINGS_1";

  public static final String ERR_XMLCONTENT_VERSION_TRANSFORMATION_ERROR_1 =
  ...
  /** Message constant for key in the resource bundle. */
  public static final String ERR_XMLCONTENT_MISSING_MODELFOLDER_URI_2 =
  ...
  /** Message constant for key in the resource bundle. */
  public static final String GUI_CATEGORY_CHECK_NOLEAF_ERROR_0 =
      "GUI_CATEGORY_CHECK_NOLEAF_ERROR_0";

  public static final String GUI_EDITOR_XMLCONTENT_CANNOT_VALIDATE_ERROR_3 =
      "GUI_EDITOR_XMLCONTENT_CANNOT_VALIDATE_ERROR_3";

  public static final String GUI_EDITOR_XMLCONTENT_INVALID_RULE_3 =
      "GUI_EDITOR_XMLCONTENT_INVALID_RULE_3";
  ...
  /** Message constant for key in the resource bundle. */
  public static final String GUI_XMLCONTENT_CHECK_WARNING_EXPIRED_0 =
      "GUI_XMLCONTENT_CHECK_WARNING_EXPIRED_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_XMLCONTENT_CHECK_WARNING_NOT_RELEASED_0 =
  ...
  /** Message constant for key in the resource bundle. */
  public static final String LOG_XMLCONTENT_CHECK_RULE_MATCH_1 =
