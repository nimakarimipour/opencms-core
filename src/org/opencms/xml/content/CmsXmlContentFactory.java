...
public final class CmsXmlContentFactory {
  ...
  public static CmsXmlContent createDocument(
      CmsObject cms, Locale locale, CmsResourceTypeXmlContent resourceType) throws CmsXmlException {
    ...
    CmsXmlContent xmlContent =
        CmsXmlContentFactory.createDocument(
            cms, locale, OpenCms.getSystemInfo().getDefaultEncoding(), contentDefinition);
    return xmlContent;
  }

  /**
   * Create a new instance of an XML content based on the given default content, hat will have all
   * language nodes of the default content and ensures the presence of the given locale.
   *
   ...
   * @return the created XML content
   */
  public static CmsXmlContent createDocument(CmsObject cms, Locale locale, String modelUri)
      throws CmsException {
  ...
  /**
   * Create a new instance of an XML content based on the given content definiton, that will have
   * one language node for the given locale all initialized with default values.
   *
   * <p>The given encoding is used when marshalling the XML again later.
   *
   * <p>
  ...
  /**
   * Factory method to unmarshal (generate) a XML content instance from a byte array that contains
   * XML data.
   *
   * <p>When unmarshalling, the encoding is read directly from the XML header of the byte array. The
   * given encoding is used only when marshalling the XML again later.
   *
   * <p><b>Warning:</b><br>
   * This method does not support requested historic versions, it always loads the most recent
   * version. Use <code>{@link #unmarshal(CmsObject, CmsResource, ServletRequest)}</code> for
   * history support.
   *
   * <p>
   *
   ...
   * @throws CmsXmlException if something goes wrong
   */
  public static CmsXmlContent unmarshal(
      CmsObject cms, byte[] xmlData, String encoding, EntityResolver resolver)
  ...
  /**
   * Factory method to unmarshal (read) a XML content instance from a OpenCms VFS file that contains
   * XML data.
   *
   * <p><b>Warning:</b><br>
   * This method does not support requested historic versions, it always loads the most recent
  ...
  /**
   * Factory method to unmarshal (read) a XML content instance from a OpenCms VFS file that contains
   * XML data, using wither the encoding set in the XML file header, or the encoding set in the VFS
   * file property.
   *
   * <p>If you are not sure about the implications of the encoding issues, use {@link
   * #unmarshal(CmsObject, CmsFile)} instead.
   *
   * <p><b>Warning:</b><br>
   * This method does not support requested historic versions, it always loads the most recent
   * version. Use <code>{@link #unmarshal(CmsObject, CmsResource, ServletRequest)}</code> for
   ...
   * @param cms the current cms object
   * @param file the file with the XML data to unmarshal
   * @param keepEncoding if true, the encoding spefified in the XML header is used, otherwise the
   *     encoding from the VFS file property is used
   * @return a XML content instance unmarshalled from the provided file
   * @throws CmsXmlException if something goes wrong
   */
  public static CmsXmlContent unmarshal(CmsObject cms, CmsFile file, boolean keepEncoding)
      throws CmsXmlException {
    ...
    if (OpenCms.getResourceManager().hasResourceType(file.getTypeId())) {
      if (OpenCms.getResourceManager().getResourceType(file)
          instanceof CmsResourceTypeXmlAdeConfiguration) {
        encoding = "UTF-8";
      }
    }
    if (encoding == null) {
    ...
    if (contentBytes.length > 0) {
      ...
      content =
          new CmsXmlContent(
              cms, DocumentHelper.createDocument(), encoding, new CmsXmlEntityResolver(cms));
    }
  ...
  /**
   * Factory method to unmarshal (read) a XML content instance from a resource, using the request
   * attributes as cache.
   *
   * <p>
   *
   ...
   * @return the unmarshaled xml content, or null if the given resource was not of type {@link
   *     org.opencms.file.types.CmsResourceTypeXmlContent}
   * @throws CmsException in something goes wrong
   * @throws CmsLoaderException if no loader for the given <code>resource</code> type ({@link
   *     CmsResource#getTypeId()}) is available
  ...
  public static CmsXmlContent unmarshal(CmsObject cms, CmsResource resource, ServletRequest req)
    ...
    if (!CmsResourceTypeXmlContent.isXmlContent(resource)) {
      ...
      throw new CmsXmlException(
          Messages.get()
              .container(Messages.ERR_XMLCONTENT_INVALID_TYPE_1, cms.getSitePath(resource)));
    }
  ...
  /**
   * Factory method to unmarshal (generate) a XML content instance from a String that contains XML
   * data.
   *
   * <p>The given encoding is used when marshalling the XML again later.
   *
   ...
   */
  public static CmsXmlContent unmarshal(
      CmsObject cms, String xmlData, String encoding, EntityResolver resolver)
      throws CmsXmlException {
   ...
   * <p>The given encoding is used when marshalling the XML again later.
   *
   * <p>Since no {@link CmsObject} is available, no link validation is performed!
   *
   * <p><b>Warning:</b><br>
   * This method does not support requested historic versions, it always loads the most recent
   * version. Use <code>{@link #unmarshal(CmsObject, CmsResource, ServletRequest)}</code> for
