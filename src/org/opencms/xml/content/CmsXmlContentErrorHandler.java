...
public class CmsXmlContentErrorHandler {
    ...
    private Map<@RUntainted Locale, Map<String, @RUntainted String>> m_errors;
    ...
    private Map<@RUntainted Locale, Map<String, @RUntainted String>> m_warnings;
    ...
    public void addError(I_CmsXmlContentValue value, @RUntainted String message) {
        ...
        Map<String, @RUntainted String> localeErrors = getLocalIssueMap(m_errors, locale);
    ...
    public void addWarning(I_CmsXmlContentValue value, @RUntainted String message) {
        ...
        m_hasWarnings = true;
        Locale locale = value.getLocale();
        Map<String, @RUntainted String> localeWarnings = getLocalIssueMap(m_warnings, locale);
     ...
     */
    public Map<@RUntainted Locale, Map<String, @RUntainted String>> getWarnings() {
     ...
     */
    private Map<String, @RUntainted String> getLocalIssueMap(Map<@RUntainted Locale, Map<String, @RUntainted String>> base, @RUntainted Locale locale) {
