...
public final class CmsXmlUtils {
     ...
     */
    public static @RPolyTainted String createXpath(@RUntainted String path, int index) {
     ...
     * @return the simplified Xpath for the given name
     */
    public static @RUntainted String createXpathElement(@RPolyTainted String path, int index) {
     ...
     */
    public static @RPolyTainted String getFirstXpathElement(@RPolyTainted String path) {
     ...
     */
    public static @RPolyTainted String getLastXpathElement(@RPolyTainted String path) {
     ...
     */
    public static @RPolyTainted int getXpathIndexInt(@RPolyTainted String path) {
     ...
     */
    public static @RPolyTainted String removeFirstXpathElement(@RPolyTainted String path) {
     ...
     */
    public static @RUntainted Document unmarshalHelper(@RPolyTainted byte[] xmlData, EntityResolver resolver) throws CmsXmlException {
