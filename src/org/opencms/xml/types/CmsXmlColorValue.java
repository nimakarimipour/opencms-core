...
public class CmsXmlColorValue extends A_CmsXmlValueTextBase {
     ...
     */
    public CmsXmlColorValue(I_CmsXmlDocument document, @RUntainted Element element, @RUntainted Locale locale, I_CmsXmlSchemaType type) {
     ...
     */
    public CmsXmlColorValue(@RUntainted String name, String minOccurs, String maxOccurs) {
