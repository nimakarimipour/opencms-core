...
public class CmsXmlVfsFileValue extends A_CmsXmlContentValue implements I_CmsJsonFormattableValue {
  ...
  /**
   * Fills the given element with a {@link CmsXmlVfsFileValue} for the given data.
   *
   * <p>
   *
   ...
   *     performed
   * @return the link object represented by this XML content value (will return null for an empty
   *     link)
   */
  ...
  /**
   * Creates the String value for this vfs file value element.
   *
   * <p>
   *
