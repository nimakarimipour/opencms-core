...
public class CmsXmlCategoryValue extends A_CmsXmlContentValue {
  ...
  /**
   * Fills the given element with a {@link CmsXmlCategoryValue} for the given data.
   *
   * <p>
   *
   ...
   * <p>
   *
   * @param cms the cms context, can be <code>null</code> but in this case no link check is
   *     performed
  ...
  /**
   * Creates the String value for this category value element.
   *
   * <p>
   *
