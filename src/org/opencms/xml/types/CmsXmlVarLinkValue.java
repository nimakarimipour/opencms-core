...
public class CmsXmlVarLinkValue extends A_CmsXmlContentValue implements I_CmsJsonFormattableValue {
     ...
     */
    public CmsXmlVarLinkValue(I_CmsXmlDocument document, @RUntainted Element element, @RUntainted Locale locale, I_CmsXmlSchemaType type) {
     ...
     */
    public static @RUntainted String getInternalPathAndQuery(CmsObject cms, @RUntainted String value) {
