 ...
 *
 * <p>This type allows a link to either an internal VFS resource, or to an external website.
 *
 * <p>
 *
 * @since 7.0.0
...
public class CmsXmlVarLinkValue extends A_CmsXmlContentValue implements I_CmsJsonFormattableValue {
   ...
   *     performed, and the target is marked as "external"
  ...
  /**
   * Creates the String value for this VarLink value element.
   *
   * <p>
   *
