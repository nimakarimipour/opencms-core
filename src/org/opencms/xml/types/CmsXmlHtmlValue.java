...
public class CmsXmlHtmlValue extends A_CmsXmlContentValue implements I_CmsJsonFormattableValue {
     ...
     */
    public CmsXmlHtmlValue(I_CmsXmlDocument document, @RUntainted Element element, Locale locale, I_CmsXmlSchemaType type) {
     ...
     */
    @Override
    public Element generateXml(CmsObject cms, I_CmsXmlDocument document, @RUntainted Element root, Locale locale) {
