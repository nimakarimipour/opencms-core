 ...
 *
 * <p>This type allows links to internal VFS resources only.
 *
 * <p>
 *
 * @since 7.0.0
...
public class CmsXmlDynamicCategoryValue extends A_CmsXmlContentValue
  ...
  /**
   * Temporary element used for storing the categories as a string in the XML for validation
   * purposes. This is thrown out before the file is actually saved to the database.
   */
  ...
  /**
   * Creates a new, empty schema type descriptor of type "OpenCmsCategoryValue".
   *
   * <p>
   */
  ...
  /**
   * Creates a new schema type descriptor for the type "OpenCmsCategoryValue".
   *
   * <p>
   *
  ...
  /**
   * @see org.opencms.xml.types.A_CmsXmlContentValue#createValue(I_CmsXmlDocument,
  ...
  public String getSchemaDefinition() {
    ...
    if (m_schemaDefinition == null) {
      m_schemaDefinition =
          readSchemaDefinition("org/opencms/xml/types/XmlDynamicCategoryValue.xsd");
    }
  ...
  /**
   * @see org.opencms.xml.types.A_CmsXmlContentValue#newInstance(java.lang.String, java.lang.String,
   *     java.lang.String)
   */
  ...
  /**
   * @see org.opencms.xml.types.A_CmsXmlContentValue#setStringValue(org.opencms.file.CmsObject,
   *     java.lang.String)
   */
   ...
   *
   * @param create if true, the category string element is created if it doesn't exist; if false,
  ...
  public Object toJson(CmsObject cms) {
    ...
    try {
      ...
      List<CmsCategory> categories =
          CmsCategoryService.getInstance().readResourceCategories(cms, file);
