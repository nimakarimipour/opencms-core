 ...
 *
 * <p>This type allows links to internal VFS images only.
 *
 * <p>
 *
 * @since 7.5.0
...
public class CmsXmlVfsImageValue extends CmsXmlVfsFileValue {
  ...
  /**
   * Returns the parameters as Map from the given url String.
   *
   * <p>
   *
  ...
  /**
   * Returns the value of the given parameter name from a parameter map.
   *
   * <p>
   *
   * @param cms the current users context
  ...
  /**
   * Returns the value of the given parameter name from the current parameter map.
   *
   * <p>
   *
   * @param cms the current users context
  ...
  /**
   * Sets a parameter for the image with the provided key as name and the value.
   *
   * <p>
   *
   * @param cms the current users context
