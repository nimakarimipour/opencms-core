...
implements I_CmsXmlValidateWithMessage, I_CmsJsonFormattableValue {
     ...
     */
    public CmsXmlSerialDateValue(I_CmsXmlDocument document, @RUntainted Element element, @RUntainted Locale locale, I_CmsXmlSchemaType type) {
     ...
     */
    public CmsXmlSerialDateValue(@RUntainted String name, String minOccurs, String maxOccurs) {
     ...
     */
    public CmsMessageContainer validateWithMessage(@RUntainted String value) {
