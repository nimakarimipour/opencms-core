...
public class CmsXmlEntityResolver implements EntityResolver, I_CmsEventListener {
     ...
     */
    protected static void initialize(@RUntainted CmsObject adminCms, byte[] typeSchemaBytes) {
     ...
     */
    public @RUntainted InputSource resolveEntity(String publicId, @RUntainted String systemId) throws IOException {
     ...
     */
    @RUntainted InputSource createInputSource(@RUntainted byte[] data, String systemId) {
