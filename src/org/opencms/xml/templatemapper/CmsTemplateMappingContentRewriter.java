...
public class CmsTemplateMappingContentRewriter extends A_CmsReportThread {
    ...
    public void run() {
        ...
        try {
            ...
            @RUntainted List<@RUntainted CmsResource> pages = resourcesForType(m_folder, CmsResourceTypeXmlContainerPage.getStaticTypeName());
            int j = 0;
            ...
            @RUntainted List<@RUntainted CmsResource> groups = resourcesForType(
                m_folder,
