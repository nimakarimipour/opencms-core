...
public final class CmsXmlContainerPageFactory {
  ...
  /**
   * Create a new instance of an container page based on the given default content, that will have
   * all language nodes of the default content and ensures the presence of the given locale.
   *
  ...
  /**
   * Create a new instance of a container page based on the given content definition, that will have
  ...
  /**
   * Factory method to unmarshal (generate) a container page instance from a byte array that
   * contains XML data.
   *
  ...
  /**
   * Factory method to unmarshal (read) a container page instance from a OpenCms VFS file that
   * contains XML data.
   *
   * <p><b>Warning:</b><br>
   * This method does not support requested historic versions, it always loads the most recent
  ...
  /**
   * Factory method to unmarshal (read) a container page instance from a OpenCms VFS file that
   * contains XML data, using wither the encoding set in the XML file header, or the encoding set in
   * the VFS file property.
   *
  ...
  public static CmsXmlContainerPage unmarshal(
    ...
    try {
      encoding =
          cms.readPropertyObject(filename, CmsPropertyDefinition.PROPERTY_CONTENT_ENCODING, true)
              .getValue();
    ...
    // Need to call initDocument again because it needs the file set to fix the nested formatter
    // settings
  ...
  /**
   * Factory method to unmarshal (read) a container page instance from a OpenCms VFS resource that
   * contains XML data.
   *
   * <p><b>Warning:</b><br>
   * This method does not support requested historic versions, it always loads the most recent
   ...
   */
  public static CmsXmlContainerPage unmarshal(CmsObject cms, CmsResource resource)
      throws CmsException {
  ...
  /**
   * Factory method to unmarshal (read) a container page instance from a resource, using the request
   * attributes as cache.
   *
   * <p>
   *
   ...
   */
  public static CmsXmlContainerPage unmarshal(
      CmsObject cms, CmsResource resource, ServletRequest req)
  ...
  /**
   * Factory method to unmarshal (generate) a container page instance from a String that contains
   * XML data.
   *
   * <p>The given encoding is used when marshalling the XML again later.
   *
