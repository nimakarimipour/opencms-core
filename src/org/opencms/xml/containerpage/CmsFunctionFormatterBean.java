...
public class CmsFunctionFormatterBean extends CmsFormatterBean {
   ...
   *     content editor
   * @param isStrictContainers <code>true</code> if this formatter will always render all nested
   *     containers
   ...
   *     <p>This is not the configured JSP, but the formatter JSP for the function_config type
   *     itself.
   */
  @Override
  ...
  /**
   * Gets the <em>actual</em> JSP id of the function.
   *
   * <p>
   *
