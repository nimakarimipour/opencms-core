 ...
 *
 * <p>A configuration item describes which file should be used as a template for new content
 * elements, and at which location in the VFS they should be created.
 *
 * <p>It does not contain a type, since the type is given by the type of the source file.
 *
 * <p>
 *
 * @since 7.6
