...
public final class CmsADECache extends CmsVfsCache {
    ...
    private @RUntainted Map<String, @RUntainted CmsXmlContainerPage> m_containerPagesOffline;

    /** Cache for online container pages. */
    private @RUntainted Map<String, @RUntainted CmsXmlContainerPage> m_containerPagesOnline;

    /** Cache for offline group containers. */
    private @RUntainted Map<String, @RUntainted CmsXmlGroupContainer> m_groupContainersOffline;

    /** Cache for online group containers. */
    private @RUntainted Map<String, @RUntainted CmsXmlGroupContainer> m_groupContainersOnline;
