...
public final class CmsXmlGroupContainerFactory {
  ...
  /**
   * Create a new instance of an group container based on the given default content, that will have
  ...
  /**
   * Create a new instance of a group container based on the given content definition, that will
   * have one language node for the given locale all initialized with default values.
   *
   * <p>The given encoding is used when marshalling the XML again later.
   *
   * <p>
  ...
  public static CmsXmlGroupContainer createDocument(
    ...
    // create the XML content
    CmsXmlGroupContainer content =
        new CmsXmlGroupContainer(cms, locale, encoding, contentDefinition);
    // call prepare for use content handler and return the result
    return (CmsXmlGroupContainer) content.getHandler().prepareForUse(cms, content);
  }

  /**
   * Factory method to unmarshal (generate) a group container instance from a byte array that
   * contains XML data.
   *
  ...
  /**
   * Factory method to unmarshal (read) a group container instance from a OpenCms VFS file that
   * contains XML data.
   *
   * <p><b>Warning:</b><br>
   * This method does not support requested historic versions, it always loads the most recent
  ...
  /**
   * Factory method to unmarshal (read) a group container instance from a OpenCms VFS resource that
   * contains XML data.
   *
   * <p><b>Warning:</b><br>
   * This method does not support requested historic versions, it always loads the most recent
   ...
   */
  public static CmsXmlGroupContainer unmarshal(CmsObject cms, CmsResource resource)
      throws CmsException {
  ...
  /**
   * Factory method to unmarshal (read) a group container instance from a resource, using the
   * request attributes as cache.
   *
   * <p>
   *
  ...
  /**
   * Factory method to unmarshal (generate) a group container instance from a String that contains
   * XML data.
   *
   * <p>The given encoding is used when marshalling the XML again later.
   *
