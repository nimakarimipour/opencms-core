...
public final class Messages extends A_CmsMessageBundle {
  ...
  /** Message constant for key in the resource bundle. */
  public static final String ERR_ELEMENT_GROUP_REFERENCES_ANOTHER_GROUP_2 =
  ...
  /** Message constant for key in the resource bundle. */
  public static final String ERR_READ_ELEMENT_PROPERTY_CONFIGURATION_1 =
      "ERR_READ_ELEMENT_PROPERTY_CONFIGURATION_1";

  /** Message constant for key in the resource bundle. */
  public static final String ERR_READING_ELEMENT_FROM_REQUEST_1 =
      "ERR_READING_ELEMENT_FROM_REQUEST_1";

  /** Message constant for key in the resource bundle. */
  public static final String ERR_READING_FORMATTER_INFO_FROM_REQUEST_0 =
  ...
  /** Message constant for key in the resource bundle. */
  public static final String LOG_CONTAINER_PAGE_LOCALE_NOT_FOUND_2 =
  ...
  /** Message constant for key in the resource bundle. */
  public static final String LOG_CONTENT_DEFINITION_DUPLICATE_FORMATTER_4 =
      "LOG_CONTENT_DEFINITION_DUPLICATE_FORMATTER_4";

  /** Message constant for key in the resource bundle. */
  public static final String LOG_DEBUG_CACHE_MATCHED_OFFLINE_2 =
  ...
  /** Message constant for key in the resource bundle. */
  public static final String LOG_WARN_ELEMENT_GROUP_INSIDE_ELEMENT_GROUP_0 =
