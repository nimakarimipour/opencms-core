...
public class CmsContainerElementBean implements Cloneable {
    ...
    private transient Map<@RUntainted String, @RUntainted String> m_settings;
     ...
     */
    private static @RPolyTainted String getSettingsHash(@RPolyTainted Map<@RPolyTainted String, @RPolyTainted String> individualSettings, @RPolyTainted boolean createNew) {
    ...
    public void initSettings(
        ...
        Map<@RUntainted String, @RUntainted String> presets) {
     ...
     * @param settings the settings
     */
    private void setSettings(Map<@RUntainted String, @RUntainted String> settings) {
