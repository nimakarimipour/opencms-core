...
public class CmsMutableContainer {
   ...
   *
   * <p>Because of nested containers, container names are not always just the values given to the
   * cms:container tag, but can also have a prefix consisting of the parent instance id of the
