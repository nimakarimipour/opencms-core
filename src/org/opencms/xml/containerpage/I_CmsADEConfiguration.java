...
public interface I_CmsADEConfiguration {
   ...
   */
  CmsResource createNewElement(
      CmsObject cms, String cntPageUri, ServletRequest request, String type, Locale locale)
      throws CmsException;
   ...
   * @throws CmsException if something goes wrong
   */
  Collection<CmsResource> getCreatableElements(
      CmsObject cms, String cntPageUri, ServletRequest request) throws CmsException;
   ...
   * @param containerPageRootPath the root path to the container page that includes the element
   *     resource
   * @param res the container page element resource
   * @return the formatter configuration for a given resource
   * @throws CmsException if something goes wrong
   */
  CmsFormatterConfiguration getFormattersForResource(
      CmsObject cms, String containerPageRootPath, CmsResource res) throws CmsException;
   ...
   * @throws CmsException if something goes wrong
   */
  Collection<CmsResource> getSearchableResourceTypes(
      CmsObject cms, String cntPageUri, ServletRequest request) throws CmsException;
