...
public class CmsResourceDataJsonHelper {
   ...
   * @param propertyFilter the property filter, which decides whether properties should be written
   *     to JSON or not
   */
  public CmsResourceDataJsonHelper(
      CmsObject cms, CmsResource resource, Predicate<String> propertyFilter) {
