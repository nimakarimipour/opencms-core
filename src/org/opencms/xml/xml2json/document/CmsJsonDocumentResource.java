...
public class CmsJsonDocumentResource extends A_CmsJsonDocument implements I_CmsJsonDocument {
  ...
  /**
   * If the request parameter "wrapper" is set, inserts information about this resource into the
   * JSON document.
   *
   * <p>
   *
  ...
  /**
   * Inserts the resource attributes into this JSON document.
   *
   * <p>
   *
  ...
  /**
   * Inserts file type information into this JSON document.
   *
   * <p>
   *
   * @throws JSONException if JSON rendering fails
  ...
  /**
   * Inserts information about the effective request parameters into this JSON document.
   *
   * <p>
   *
   * @throws JSONException if JSON rendering fails
  ...
  /**
   * Inserts path and link information about this resource into this JSON document.
   *
   * <p>
   *
   * @throws JSONException if JSON rendering fails
  ...
  /**
   * Initializes the resource data helper.
   *
   * <p>
   */
  private void initHelper() {
    ...
    m_helper =
        new CmsResourceDataJsonHelper(
            m_context.getCms(), m_resource, m_context.getAccessPolicy()::checkPropertyAccess);
  }
}
