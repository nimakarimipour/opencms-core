...
public class CmsJsonRequest {
  ...
  /**
   * Validates a boolean request parameter.
   *
   * <p>
   *
    ...
    if (paramValue != null) {
      ...
      if (!(paramValue.equals("true") || paramValue.equals("false"))) {
        errors.add(
            "<"
                + paramValue
                + "> is not a boolean. Boolean expected for parameter <"
                + paramName
                + ">.");
      }
    }
  ...
  /**
   * For two parameters depending on each other, validates whether the dependency is fulfilled for
   * the current request.
   *
  ...
  /**
   * Validates an integer request parameter.
   *
   * <p>
   *
   * @param paramName the name of the parameter to be validated
  ...
  /**
   * Validates a sort request parameter.
   *
   * <p>
   *
   * @param paramName the name of the parameter to be validated
  ...
  /**
   * For a given list of parameter names supported, validates whether the current parameters used in
   * this request are valid.
   *
  ...
  /**
   * Validates the container page request type.
   *
   * <p>
   */
  ...
  /**
   * Validates the folder request type.
   *
   * <p>
   */
  private void validateRequestFolder() {
    ...
    String[] supported = {
      PARAM_LEVELS, PARAM_CONTENT, PARAM_WRAPPER, PARAM_LOCALE, PARAM_FALLBACK_LOCALE
    };
    validateParamsSupported(supported);
  }

  /**
   * Validates the list request type.
   *
   * <p>
   */
  ...
  /**
   * Validates the resource request type.
   *
   * <p>
   */
  ...
  /**
   * Validates the XML content request type.
   *
   * <p>
   */
  private void validateRequestXmlContent() {
    ...
    String[] supported = {
      PARAM_CONTENT, PARAM_WRAPPER, PARAM_LOCALE, PARAM_FALLBACK_LOCALE, PARAM_PATH
    };
    validateParamsSupported(supported);
  }
}
