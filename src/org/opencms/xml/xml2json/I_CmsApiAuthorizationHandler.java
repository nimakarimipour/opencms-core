 ...
 *
 * <p>This does *not* handle authorization for normal OpenCms users (editors and website users), but
 * is meant for use in APIs implemented as request handlers or resource init handlers. Authorization
 * is supposed to be stateless, i.e. authorization information is passed with every HTTP request.
 */
