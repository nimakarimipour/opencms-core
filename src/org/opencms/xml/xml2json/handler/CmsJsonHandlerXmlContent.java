...
/**
 * Sub-handler for converting XML contents to JSON, either as a whole or just specific locales or
 * paths.
 */
public class CmsJsonHandlerXmlContent implements I_CmsJsonHandler {
  ...
  public static class PathNotFoundException extends Exception {
    ...
    /**
     * Creates a new exception for a given message.
     *
     * <p>
     *
  ...
  public CmsJsonResult renderJson(CmsJsonHandlerContext context, boolean throwError) {
    ...
    try {
      ...
      CmsJsonDocumentXmlContent jsonDocument =
          new CmsJsonDocumentXmlContent(jsonRequest, context.getContent());
