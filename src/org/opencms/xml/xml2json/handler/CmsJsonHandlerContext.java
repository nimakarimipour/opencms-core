 ...
 *
 * <p>Also lazily loads the resource or content to be rendered as JSON.
 */
public class CmsJsonHandlerContext {
   ...
   *
   * <p>This only works if the resource for the given path is actually an XML content.
   *
   ...
   *
   * <p>This will only work if the resource for the path is actually a file.
   *
