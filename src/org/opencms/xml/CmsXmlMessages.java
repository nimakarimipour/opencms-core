...
public class CmsXmlMessages extends CmsMessages {
    ...
    private @RUntainted String m_pathPrefix;
     ...
     */
    public CmsXmlMessages(CmsMessages messages, @RUntainted String configurationFileName, String pathPrefix, Locale locale) {
     ...
     * @param locale the locale to use for localization
     */
    public CmsXmlMessages(@RUntainted String bundleName, @RUntainted String configurationFileName, String pathPrefix, @RUntainted Locale locale) {
     ...
     */
    protected @RUntainted String getConfigValue(@RUntainted String key) {
