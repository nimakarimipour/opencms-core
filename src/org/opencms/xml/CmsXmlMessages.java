...
public class CmsXmlMessages extends CmsMessages {
     ...
     */
    protected @RUntainted String getConfigValue(@RUntainted String key, @RUntainted Object[] args) {
     ...
     */
    protected boolean hasConfigValue(@RUntainted String key) {
     ...
     * @param pathPrefix the (optional) xPath prefix to the element nodes
     */
    protected void initPathPrefix(@RUntainted String pathPrefix) {
