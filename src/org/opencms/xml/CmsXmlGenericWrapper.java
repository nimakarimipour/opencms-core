...
public final class CmsXmlGenericWrapper {
  ...
  /**
   * Provides a type safe / generic wrapper for {@link Element#content()}.
   *
   * <p>
   *
   * @param element the element to get the content for
   * @return type safe access to {@link Element#content()}.
   *     <p>
   */
  ...
  /**
   * Provides a type safe / generic wrapper for {@link Element#elementIterator(org.dom4j.QName)}.
   *
   * <p>
   *
   * @param element the element to iterate
   * @return type safe access to {@link Element#elementIterator(org.dom4j.QName)}.
   *     <p>
   */
  @SuppressWarnings("unchecked")
  ...
  /**
   * Provides a type safe / generic wrapper for {@link Element#elementIterator(String)}.
   *
   * <p>
   *
   * @param element the element to iterate
   * @param name the element name to match
   * @return type safe access to {@link Element#elementIterator(String)}.
   *     <p>
   */
  @SuppressWarnings("unchecked")
  ...
  /**
   * Provides a type safe / generic wrapper for {@link Element#elements()}.
   *
   * <p>
   *
   * @param element the element to iterate
   * @return type safe access to {@link Element#elements()}.
   *     <p>
   */
  @SuppressWarnings("unchecked")
  ...
  /**
   * Provides a type safe / generic wrapper for {@link Element#elements(org.dom4j.QName)}.
   *
   * <p>
   *
   * @param element the element to iterate
   * @param name the element name to match
   * @return type safe access to {@link Element#elements(org.dom4j.QName)}.
   *     <p>
   */
  @SuppressWarnings("unchecked")
  ...
  /**
   * Provides a type safe / generic wrapper for {@link Element#elements(String)}.
   *
   * <p>
   *
   * @param element the element to iterate
   * @param name the element name to match
   * @return type safe access to {@link Element#elements(String)}.
   *     <p>
   */
  @SuppressWarnings("unchecked")
  ...
  /**
   * Provides a type safe / generic wrapper for {@link Document#selectNodes(String)}.
   *
   * <p>
   *
