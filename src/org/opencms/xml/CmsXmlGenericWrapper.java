...
public final class CmsXmlGenericWrapper {
     ...
     */
    @SuppressWarnings("unchecked")
    public static @RPolyTainted List<@RPolyTainted Element> elements(@RPolyTainted Element element) {
     ...
     */
    @SuppressWarnings("unchecked")
    public static @RPolyTainted List<@RPolyTainted Element> elements(@RPolyTainted Element element, @RPolyTainted QName name) {
     ...
     */
    @SuppressWarnings("unchecked")
    public static @RPolyTainted List<@RPolyTainted Element> elements(@RPolyTainted Element element, @RPolyTainted String name) {
