...
public interface I_CmsXmlDocument {
     ...
     */
    void copyLocale(List<@RUntainted Locale> possibleSources, @RUntainted Locale destination) throws CmsXmlException;
     ...
     */
    @RUntainted String getConversion();
     ...
     */
    List<@RUntainted Locale> getLocales(@RUntainted String path);
     ...
     */
    List<@RUntainted I_CmsXmlContentValue> getSubValues(@RUntainted String path, Locale locale);
     ...
     */
    @RUntainted I_CmsXmlContentValue getValue(@RUntainted String path, Locale locale);
     ...
     *      available in this document for the given locale
     */
    List<@RUntainted I_CmsXmlContentValue> getValues(@RUntainted String path, Locale locale);
