...
public class CmsImportExportConfiguration extends A_CmsXmlConfiguration {
  ...
  public void addXmlDigesterRules(Digester digester) {
    ...
    // convert rule
    digester.addCallMethod(
        "*/" + N_IMPORTEXPORT + "/" + N_IMPORT + "/" + N_CONVERT, "setConvertToXmlPage", 0);

    // old webapp rule
    digester.addCallMethod(
        "*/" + N_IMPORTEXPORT + "/" + N_IMPORT + "/" + N_OLDWEBAPPURL, "setOldWebAppUrl", 0);
    ...
    digester.addCallParam(
        "*/" + N_IMPORTEXPORT + "/" + N_IMPORT + "/" + N_IMMUTABLES + "/" + N_RESOURCE, 0, A_URI);
    ...
    digester.addCallMethod(
        "*/" + N_IMPORTEXPORT + "/" + N_TEMP_EXPORTPONT_PATH, "addTempExportpointPath", 1);
    ...
    digester.addCallMethod(
        "*/" + N_STATICEXPORT + "/" + N_LINKSUBSTITUTION_HANDLER, "setLinkSubstitutionHandler", 0);
    // exportpath rule
    digester.addCallMethod(
        "*/" + N_STATICEXPORT + "/" + N_STATICEXPORT_EXPORTPATH, "setExportPath", 0);
    // exportworkpath rule
    digester.addCallMethod(
        "*/" + N_STATICEXPORT + "/" + N_STATICEXPORT_EXPORTWORKPATH, "setExportWorkPath", 0);
    // exportbackups rule
    digester.addCallMethod(
        "*/" + N_STATICEXPORT + "/" + N_STATICEXPORT_EXPORTBACKUPS, "setExportBackups", 0);
    ...
    digester.addCallMethod(
        ...
        1);
    digester.addCallParam(
        exportRulePath + "/" + N_STATICEXPORT_MODIFIED + "/" + N_STATICEXPORT_REGEX, 0);
    digester.addCallMethod(
        exportRulePath + "/" + N_STATICEXPORT_EXPORT + "/" + N_STATICEXPORT_URI,
        "addExportRuleUri",
        1);
    digester.addCallParam(
        exportRulePath + "/" + N_STATICEXPORT_EXPORT + "/" + N_STATICEXPORT_URI, 0);
    ...
    digester.addCallMethod(
        ...
        1);
    digester.addCallParam(
        rfsRulePath + "/" + N_STATICEXPORT_RELATED_SYSTEM_RES + "/" + N_STATICEXPORT_REGEX, 0);

    // adds protected export rules
    digester.addCallMethod(
        "*/" + N_PROTECTED_EXPORT + "/" + N_STATICEXPORT_EXPORTPATH, "setProtectedExportPath", 1);
    ...
    digester.addCallMethod(
        "*/" + N_USERCSVEXPORT + "/" + N_COLUMNS + "/" + N_COLUMN, "addColumn", 0);
    ...
    digester.addCallMethod(
        "*/" + N_REPOSITORIES, I_CmsConfigurationParameterHandler.INIT_CONFIGURATION_METHOD);
          ...
          new NodeCreateRule() {
            ...
            public void end(String namespace, String name) throws Exception {
              ...
              CmsResourceTranslator translator =
                  new CmsResourceTranslator(translationStrings, true);
    ...
    digester.addCallParam(
        "*/" + N_REPOSITORIES + "/" + N_REPOSITORY + "/" + N_PARAMS + "/" + N_PARAM, 1);

    // repository filter
    digester.addObjectCreate(
        "*/" + N_REPOSITORIES + "/" + N_REPOSITORY + "/" + N_FILTER, CmsRepositoryFilter.class);

    // repository filter type
    digester.addCallMethod(
        "*/" + N_REPOSITORIES + "/" + N_REPOSITORY + "/" + N_FILTER, "setType", 1);
    ...
    digester.addCallMethod(
        ...
        1);
    digester.addCallParam(
        "*/" + N_REPOSITORIES + "/" + N_REPOSITORY + "/" + N_FILTER + "/" + N_REGEX, 0);
    ...
    digester.addCallMethod(
        "*/" + N_EXTHTMLIMPORT + "/" + N_EXTHTMLIMPORT_DESTINATION, "setDestinationDir", 0);
  ...
  public Element generateXml(Element parent) {
    ...
    // <overwrite> node
    importElement
        .addElement(N_OVERWRITE)
        .setText(String.valueOf(m_importExportManager.overwriteCollidingResources()));

    // <convert> node
    importElement
        .addElement(N_CONVERT)
        .setText(String.valueOf(m_importExportManager.convertToXmlPage()));
    ...
    Iterator<I_CmsImport> importVersions =
        m_importExportManager.getImportVersionClasses().iterator();
    while (importVersions.hasNext()) {
      resourcetypesElement
          .addElement(N_IMPORTVERSION)
          .addAttribute(A_CLASS, importVersions.next().getClass().getName());
    }
    ...
    Iterator<String> userTranslationKeys =
        m_importExportManager.getImportUserTranslations().keySet().iterator();
    while (userTranslationKeys.hasNext()) {
      ...
      principalsElement
          .addElement(N_PRINCIPALTRANSLATION)
          .addAttribute(A_TYPE, I_CmsPrincipal.PRINCIPAL_USER)
          .addAttribute(A_FROM, from)
          .addAttribute(A_TO, to);
    }
    Iterator<String> groupTranslationKeys =
        m_importExportManager.getImportGroupTranslations().keySet().iterator();
    while (groupTranslationKeys.hasNext()) {
      ...
      principalsElement
          .addElement(N_PRINCIPALTRANSLATION)
          .addAttribute(A_TYPE, I_CmsPrincipal.PRINCIPAL_GROUP)
          .addAttribute(A_FROM, from)
          .addAttribute(A_TO, to);
    }
    ...
    Map<TimestampMode, List<String>> defaultTimestampModes =
        m_importExportManager.getDefaultTimestampModes();
    if (!defaultTimestampModes.isEmpty()) {

      // <defaulttimestampmodes>
      Element defaultTimestampModesElement =
          exportElement.addElement(N_EXPORT_DEFAULTTIMESTAMPMODES);
      for (TimestampMode mode : defaultTimestampModes.keySet()) {

        // <timestampmode>
        Element timestampModeElement =
            defaultTimestampModesElement.addElement(N_EXPORT_TIMESTAMPMODE);
    ...
    staticexportElement
        .addElement(N_STATICEXPORT_HANDLER)
        .addText(m_staticExportManager.getHandler().getClass().getName());

    // <linksubstitutionhandler> node
    staticexportElement
        .addElement(N_LINKSUBSTITUTION_HANDLER)
        .addText(m_staticExportManager.getLinkSubstitutionHandler().getClass().getName());
    ...
    if (exportWorkPathUnmodified != null) {
      ...
      if (exportWorkPathUnmodified.endsWith(File.separator)) {
        exportWorkPathUnmodified =
            exportWorkPathUnmodified.substring(0, exportWorkPathUnmodified.length() - 1);
      }
      staticexportElement
          .addElement(N_STATICEXPORT_EXPORTWORKPATH)
          .addText(exportWorkPathUnmodified);
    }
    ...
    staticexportElement
        .addElement(N_STATICEXPORT_DEFAULT)
        .addText(m_staticExportManager.getDefault());
    ...
    rendersettingsElement
        .addElement(N_STATICEXPORT_RFS_PREFIX)
        .addText(m_staticExportManager.getRfsPrefixForConfiguration());

    // <vfsPrefix> node
    rendersettingsElement
        .addElement(N_STATICEXPORT_VFS_PREFIX)
        .addText(m_staticExportManager.getVfsPrefixForConfiguration());

    // <userelativelinks> node
    rendersettingsElement
        .addElement(N_STATICEXPORT_RELATIVELINKS)
        .addText(m_staticExportManager.getRelativeLinks());

    // <exporturl> node
    rendersettingsElement
        .addElement(N_STATICEXPORT_EXPORTURL)
        .addText(m_staticExportManager.getExportUrlForConfiguration());

    // <plainoptimization> node
    rendersettingsElement
        .addElement(N_STATICEXPORT_PLAINOPTIMIZATION)
        .addText(m_staticExportManager.getPlainExportOptimization());
    ...
    Element resourcetorenderElement =
        rendersettingsElement.addElement(N_STATICEXPORT_RESOURCESTORENDER);

    Iterator<String> exportFolderPatterns =
        m_staticExportManager.getExportFolderPatterns().iterator();
    ...
    if (!m_staticExportManager.getExportRules().isEmpty()) {
      ...
      Iterator<CmsStaticExportExportRule> exportRules =
          m_staticExportManager.getExportRules().iterator();
    ...
    if (!m_staticExportManager.getRfsRules().isEmpty()) {
      ...
      while (rfsRules.hasNext()) {
        ...
        rfsRuleElement
            .addElement(N_STATICEXPORT_EXPORTPATH)
            .addText(rule.getExportPathConfigured());
        if (rule.getExportWorkPathConfigured() != null) {
          rfsRuleElement
              .addElement(N_STATICEXPORT_EXPORTWORKPATH)
              .addText(rule.getExportWorkPathConfigured());
        }
        if (rule.getExportBackups() != null) {
          rfsRuleElement
              .addElement(N_STATICEXPORT_EXPORTBACKUPS)
              .addText(String.valueOf(rule.getExportBackups()));
        }
        if (rule.getUseRelativeLinks() != null) {
          rfsRuleElement
              .addElement(N_STATICEXPORT_RELATIVELINKS)
              .addText(rule.getUseRelativeLinks().toString());
        }
    ...
    if (m_staticExportManager.getProtectedExportPath() != null) {
      ...
      streamingEl
          .addElement(N_STATICEXPORT_EXPORTPATH)
          .setText(m_staticExportManager.getProtectedExportPath());
      Element exportpoints = streamingEl.addElement(I_CmsXmlConfiguration.N_EXPORTPOINTS);
      for (Entry<String, String> entry :
          m_staticExportManager.getProtectedExportPoints().entrySet()) {
    ...
    if (m_importExportManager.getUserExportSettings() != null) {
      ...
      userExportElement
          .addElement(N_SEPARATOR)
          .setText(m_importExportManager.getUserExportSettings().getSeparator());
    ...
    CmsExtendedHtmlImportDefault htmlimport =
        m_importExportManager.getExtendedHtmlImportDefault(true);
    if (htmlimport != null) {
      // <extendedhtmlimport>
      ...
      if (!CmsStringUtil.isEmptyOrWhitespaceOnly(htmlimport.getDestinationDir())) {
        htmlImportElement
            .addElement(N_EXTHTMLIMPORT_DESTINATION)
            .setText(htmlimport.getDestinationDir());
      }
      // <input> node
      ...
      if (!CmsStringUtil.isEmptyOrWhitespaceOnly(htmlimport.getDownloadGallery())) {
        galleryElement
            .addElement(N_EXTHTMLIMPORT_DOWNLOAD)
            .setText(htmlimport.getDownloadGallery());
      }
      // <image> node
      ...
      if (!CmsStringUtil.isEmptyOrWhitespaceOnly(htmlimport.getLinkGallery())) {
        galleryElement
            .addElement(N_EXTHTMLIMPORT_EXTERNALLINK)
            .setText(htmlimport.getLinkGallery());
      }
      ...
      if (!CmsStringUtil.isEmptyOrWhitespaceOnly(htmlimport.getStartPattern())) {
        patternElement
            .addElement(N_EXTHTMLIMPORT_PATTERN_START)
            .setText(htmlimport.getStartPattern());
      }
      // <end> node
      ...
      settingElement
          ...
          .setText(htmlimport.getKeepBrokenLinks());
      // </extendedhtmlimport>
    }
  ...
  /**
   * Sets the user settings for export and import.
   *
   * <p>
   *
