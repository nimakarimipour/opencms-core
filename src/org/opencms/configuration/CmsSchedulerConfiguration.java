...
public class CmsSchedulerConfiguration extends A_CmsXmlConfiguration {
  ...
  public void addXmlDigesterRules(Digester digester) {
    ...
    digester.addBeanPropertySetter(
        "*/" + N_SCHEDULER + "/" + N_JOB + "/" + N_CRONEXPRESSION, "cronExpression");
    digester.addBeanPropertySetter(
        "*/" + N_SCHEDULER + "/" + N_JOB + "/" + N_REUSEINSTANCE, "reuseInstance");
    ...
    digester.addObjectCreate(
        "*/" + N_SCHEDULER + "/" + N_JOB + "/" + N_CONTEXT, CmsContextInfo.class);
    digester.addBeanPropertySetter(
        "*/" + N_SCHEDULER + "/" + N_JOB + "/" + N_CONTEXT + "/" + N_USERNAME, "userName");
    digester.addBeanPropertySetter(
        "*/" + N_SCHEDULER + "/" + N_JOB + "/" + N_CONTEXT + "/" + N_PROJECT, "projectName");
    digester.addBeanPropertySetter(
        "*/" + N_SCHEDULER + "/" + N_JOB + "/" + N_CONTEXT + "/" + N_SITEROOT, "siteRoot");
    digester.addBeanPropertySetter(
        "*/" + N_SCHEDULER + "/" + N_JOB + "/" + N_CONTEXT + "/" + N_REQUESTEDURI, "requestedUri");
    digester.addBeanPropertySetter(
        "*/" + N_SCHEDULER + "/" + N_JOB + "/" + N_CONTEXT + "/" + N_LOCALE, "localeName");
    digester.addBeanPropertySetter(
        "*/" + N_SCHEDULER + "/" + N_JOB + "/" + N_CONTEXT + "/" + N_ENCODING);
    digester.addBeanPropertySetter(
        "*/" + N_SCHEDULER + "/" + N_JOB + "/" + N_CONTEXT + "/" + N_REMOTEADDR, "remoteAddr");
