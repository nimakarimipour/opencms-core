...
public class CmsVariablesConfiguration extends A_CmsXmlConfiguration {
  ...
  public Element generateXml(Element parent) {
    ...
    if (m_loginMessage != null) {
      ...
      messageElement
          .addElement(N_LOGINFORBIDDEN)
          .addText(String.valueOf(m_loginMessage.isLoginForbidden()));
      if (m_loginMessage.getTimeStart() != CmsLoginMessage.DEFAULT_TIME_START) {
        messageElement
            .addElement(N_TIMESTART)
            .addText(String.valueOf(m_loginMessage.getTimeStart()));
      }
    ...
    if (m_beforeLoginMessage != null) {
      ...
      messageElement
          .addElement(N_ENABLED)
          .addText(String.valueOf(m_beforeLoginMessage.isEnabled()));
