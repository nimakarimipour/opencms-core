 ...
 * create an instance of this class as a member in the OpenCms configuration class
 * (e.g.CmsSystemConfiguration.. Add the rule returned by getDigesterRule in the config object's
 * addXmlDigesterRules, and call the appendToXml rule in the config object's generateXml method.
 *
