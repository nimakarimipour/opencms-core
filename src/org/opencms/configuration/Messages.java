...
public final class Messages extends A_CmsMessageBundle {
  ...
  /** Message constant for key in the resource bundle. */
  public static final String INIT_AUTHORIZATION_HANDLER_CLASS_INVALID_1 =
      "INIT_AUTHORIZATION_HANDLER_CLASS_INVALID_1";

  /** Message constant for key in the resource bundle. */
  public static final String INIT_AUTHORIZATION_HANDLER_CLASS_SUCCESS_1 =
      "INIT_AUTHORIZATION_HANDLER_CLASS_SUCCESS_1";

  /** Message constant for key in the resource bundle. */
  public static final String INIT_CHECKING_DEFAULT_USER_NAMES_0 =
      "INIT_CHECKING_DEFAULT_USER_NAMES_0";

  /** Message constant for key in the resource bundle. */
  public static final String INIT_CONFIG_I18N_FINISHED_0 = "INIT_CONFIG_I18N_FINISHED_0";

  /** Message constant for key in the resource bundle. */
  public static final String INIT_DEFAULT_USER_NAMES_INITIALIZED_0 =
      "INIT_DEFAULT_USER_NAMES_INITIALIZED_0";

  /** Message constant for key in the resource bundle. */
  public static final String INIT_DELETED_RESOURCE_USER_1 = "INIT_DELETED_RESOURCE_USER_1";

  /** Message constant for key in the resource bundle. */
  public static final String INIT_EVENTMANAGER_CLASS_INVALID_1 =
      "INIT_EVENTMANAGER_CLASS_INVALID_1";

  /** Message constant for key in the resource bundle. */
  public static final String INIT_EVENTMANAGER_CLASS_SUCCESS_1 =
      "INIT_EVENTMANAGER_CLASS_SUCCESS_1";
  ...
  /** Message constant for key in the resource bundle. */
  public static final String INIT_PUBLISH_RELATED_RESOURCES_MODE_1 =
      "INIT_PUBLISH_RELATED_RESOURCES_MODE_1";

  /** Message constant for key in the resource bundle. */
  public static final String INIT_PWD_HANDLER_SUCCESS_1 = "INIT_PWD_HANDLER_SUCCESS_1";

  /** Message constant for key in the resource bundle. */
  public static final String INIT_RELATION_DELETION_DISABLED_0 =
      "INIT_RELATION_DELETION_DISABLED_0";
  ...
  /** Message constant for key in the resource bundle. */
  public static final String INIT_SESSION_STORAGEPROVIDER_SUCCESS_1 =
  ...
  /** Message constant for key in the resource bundle. */
  public static final String INIT_VALIDATION_HANDLER_CLASS_INVALID_1 =
      "INIT_VALIDATION_HANDLER_CLASS_INVALID_1";

  /** Message constant for key in the resource bundle. */
  public static final String INIT_VALIDATION_HANDLER_CLASS_SUCCESS_1 =
      "INIT_VALIDATION_HANDLER_CLASS_SUCCESS_1";
  ...
  /** Message constant for key in the resource bundle. */
  public static final String INIT_VFS_XSD_TRANSLATION_DISABLE_0 =
      "INIT_VFS_XSD_TRANSLATION_DISABLE_0";

  /** Message constant for key in the resource bundle. */
  public static final String INIT_VFS_XSD_TRANSLATION_ENABLE_0 =
      "INIT_VFS_XSD_TRANSLATION_ENABLE_0";
  ...
  /** Message constant for key in the resource bundle. */
  public static final String LOG_INIT_SESSION_STORAGEPROVIDER_FAILURE_1 =
