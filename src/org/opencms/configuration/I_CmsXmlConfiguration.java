...
public interface I_CmsXmlConfiguration extends I_CmsConfigurationParameterHandler {
  ...
  /**
   * Returns the name of the DTD file for this XML configuration, e.g. <code>
   * opencms-configuration.dtd</code>.
   *
   * <p>
   *
  ...
  /**
   * Returns the internal system location of the DTD file for this XML configuration, e.g. <code>
   * org/opencms/configuration/</code>.
   *
   * <p>If this is not <code>null</code>, then the DTD is not read through the web URL, but an
   * internal name resolution is added that resolves the system id of the DTD to <code>
   * {@link #getDtdSystemLocation()} + {@link #getDtdUrlPrefix()}</code>.
   *
   * <p>
   *
  ...
  /**
   * Returns the external system id prefix of the DTD file for this XML configuration, e.g. <code>
   * http://www.opencms.org/dtd/6.0/</code>.
   *
   * <p>The full system id for the DTD is calculated like this: <code>
   * {@link #getDtdSystemLocation()} + {@link #getDtdUrlPrefix()}</code>.
   *
   * <p>
   *
  ...
  /**
   * Returns the name of the XML input file for this configuration, e.g. <code>opencms.xml</code>.
   *
   * <p>
   *
