...
public class CmsVfsConfiguration extends A_CmsXmlConfiguration {
  ...
  public static void addResourceTypeXmlRules(Digester digester) {
    ...
    digester.addFactoryCreate(
        "*/" + N_RESOURCETYPES + "/" + N_TYPE, CmsDigesterResourceTypeCreationFactory.class);
    digester.addSetNext(
        "*/" + N_RESOURCETYPES + "/" + N_TYPE, I_CmsResourceType.ADD_RESOURCE_TYPE_METHOD);
    ...
    // here we must make sure that the resource type is initialized first (with the "call method"
    // rule)
    // before it is actually added to the resource type container (with the "set next" rule)
    // otherwise there will be an empty resource type added to the container, and validation will
    // not work
    ...
    digester.addCallMethod(
        ...
        1);
    digester.addCallParam(
        "*/" + N_RESOURCETYPES + "/" + N_TYPE + "/" + N_MAPPINGS + "/" + N_MAPPING, 0, A_SUFFIX);

    digester.addCallMethod(
        "*/" + N_RESOURCETYPES + "/" + N_TYPE + "/" + N_COPY_RESOURCES, "setAdjustLinksFolder", 1);
    digester.addCallParam(
        "*/" + N_RESOURCETYPES + "/" + N_TYPE + "/" + N_COPY_RESOURCES, 0, A_ADJUST_LINKS_FOLDER);
  ...
  public static void generateResourceTypeXml(
      Element startNode, List<I_CmsResourceType> resourceTypes, boolean module) {
    ...
    for (int i = 0; i < resourceTypes.size(); i++) {
      ...
      if (resType.isAdditionalModuleResourceType() == module) {
        Element resourceType =
            startNode.addElement(N_TYPE).addAttribute(A_CLASS, resType.getClassName());
          ...
          if (properties.size() > 0) {
            ...
            while (p.hasNext()) {
              ...
              if (property.getResourceValue() != null) {
                propertyNode
                    .addElement(N_VALUE)
                    .addAttribute(A_TYPE, CmsProperty.TYPE_SHARED)
                    .addCDATA(property.getResourceValue());
              }
            }
          }
        }
  ...
  public void addFileTranslation(@RUntainted String translation) {
    ...
    if (CmsLog.INIT.isInfoEnabled()) {
      CmsLog.INIT.info(
          Messages.get().getBundle().key(Messages.INIT_VFS_ADD_FILE_TRANSLATION_1, translation));
    }
  }
  ...
  public void addFolderTranslation(@RUntainted String translation) {
    ...
    if (CmsLog.INIT.isInfoEnabled()) {
      CmsLog.INIT.info(
          Messages.get().getBundle().key(Messages.INIT_VFS_ADD_FOLDER_TRANSLATION_1, translation));
    }
  }
  ...
  public void addXmlDigesterRules(Digester digester) {
    ...
    digester.addCallMethod(
        ...
        I_CmsConfigurationParameterHandler.INIT_CONFIGURATION_METHOD);
    digester.addSetNext(
        "*/" + N_VFS + "/" + N_RESOURCES + "/" + N_RESOURCELOADERS + "/" + N_LOADER, "addLoader");
    ...
    digester.addCallMethod(
        ...
        2);
    digester.addCallParam(
        "*/" + N_VFS + "/" + N_RESOURCES + "/" + N_COLLECTORS + "/" + N_COLLECTOR, 0, A_CLASS);
    digester.addCallParam(
        "*/" + N_VFS + "/" + N_RESOURCES + "/" + N_COLLECTORS + "/" + N_COLLECTOR, 1, A_ORDER);
    ...
    digester.addObjectCreate(
        ...
        A_CLASS);
    digester.addSetNext(
        "*/" + N_VFS + "/" + N_RESOURCES + "/" + N_NAMEGENERATOR, "setNameGenerator");

    // add MIME type rules
    digester.addCallMethod(
        "*/" + N_VFS + "/" + N_RESOURCES + "/" + N_MIMETYPES + "/" + N_MIMETYPE, "addMimeType", 2);
    digester.addCallParam(
        "*/" + N_VFS + "/" + N_RESOURCES + "/" + N_MIMETYPES + "/" + N_MIMETYPE, 0, A_EXTENSION);
    digester.addCallParam(
        "*/" + N_VFS + "/" + N_RESOURCES + "/" + N_MIMETYPES + "/" + N_MIMETYPE, 1, A_TYPE);
    ...
    digester.addCallMethod(
        ...
        2);
    digester.addCallParam(
        "*/" + N_VFS + "/" + N_RESOURCES + "/" + N_RELATIONTYPES + "/" + N_RELATIONTYPE, 0, A_NAME);
    digester.addCallParam(
        "*/" + N_VFS + "/" + N_RESOURCES + "/" + N_RELATIONTYPES + "/" + N_RELATIONTYPE, 1, A_TYPE);
    ...
    digester.addCallMethod(
        "*/" + N_VFS + "/" + N_DEFAULTFILES + "/" + N_DEFAULTFILE, "addDefaultFile", 1);
    ...
    digester.addCallMethod(
        ...
        1);
    digester.addCallParam(
        "*/" + N_VFS + "/" + N_TRANSLATIONS + "/" + N_FILETRANSLATIONS, 0, A_ENABLED);
    ...
    digester.addCallMethod(
        ...
        1);
    digester.addCallParam(
        "*/" + N_VFS + "/" + N_TRANSLATIONS + "/" + N_FOLDERTRANSLATIONS, 0, A_ENABLED);
    ...
    digester.addCallMethod(
        ...
        1);
    digester.addCallParam(
        "*/" + N_VFS + "/" + N_TRANSLATIONS + "/" + N_XSDTRANSLATIONS, 0, A_ENABLED);
    ...
    digester.addCallMethod(
        ...
        2);
    digester.addCallParam(
        "*/" + N_VFS + "/" + N_XMLCONTENT + "/" + N_SCHEMATYPES + "/" + N_SCHEMATYPE, 0, A_CLASS);
    digester.addCallParam(
        "*/" + N_VFS + "/" + N_XMLCONTENT + "/" + N_SCHEMATYPES + "/" + N_SCHEMATYPE,
        1,
        A_DEFAULTWIDGET);
  ...
  public void addXsdTranslation(@RUntainted String translation) {
    ...
    if (CmsLog.INIT.isInfoEnabled()) {
      CmsLog.INIT.info(
          Messages.get().getBundle().key(Messages.INIT_VFS_ADD_XSD_TRANSLATION_1, translation));
    }
  }
  ...
  public Element generateXml(Element parent) {
    ...
    for (CmsMimeType type : m_resourceManager.getMimeTypes()) {
      mimeTypesElement
          .addElement(N_MIMETYPE)
          .addAttribute(A_EXTENSION, type.getExtension())
          .addAttribute(A_TYPE, type.getType());
    }
    ...
    for (CmsRelationType type : m_resourceManager.getRelationTypes()) {
      relationTypesElement
          .addElement(N_RELATIONTYPE)
          .addAttribute(A_NAME, type.getName())
          .addAttribute(A_TYPE, type.getType());
    }
    ...
    if (writeConfig) {
      ...
      for (CmsHtmlConverterOption converter : m_resourceManager.getHtmlConverters()) {
        Element converterElement =
            htmlConvertersElement
                .addElement(N_HTML_CONVERTER)
                .addAttribute(A_NAME, converter.getName());
    ...
    Element fileTransElement =
        translationsElement
            .addElement(N_FILETRANSLATIONS)
            .addAttribute(A_ENABLED, String.valueOf(m_fileTranslationEnabled));
    ...
    Element folderTransElement =
        translationsElement
            .addElement(N_FOLDERTRANSLATIONS)
            .addAttribute(A_ENABLED, String.valueOf(m_folderTranslationEnabled));
    ...
    Element xsdTransElement =
        translationsElement
            .addElement(N_XSDTRANSLATIONS)
            .addAttribute(A_ENABLED, String.valueOf(m_xsdTranslationEnabled));
   ...
   */
  public @RUntainted List<String> getDefaultFiles() {
  ...
  /**
   * Returns the file resource translator that has been initialized with the configured file
   * translation rules.
   *
   * <p>
   *
  ...
  /**
   * Returns the folder resource translator that has been initialized with the configured folder
   * translation rules.
   *
   * <p>
   *
  ...
  public void setFileTranslationEnabled(String value) {
    ...
    if (CmsLog.INIT.isInfoEnabled()) {
      if (m_fileTranslationEnabled) {
        CmsLog.INIT.info(
            Messages.get().getBundle().key(Messages.INIT_VFS_FILE_TRANSLATION_ENABLE_0));
      } else {
        CmsLog.INIT.info(
            Messages.get().getBundle().key(Messages.INIT_VFS_FILE_TRANSLATION_DISABLE_0));
      }
    }
  }
  ...
  public void setFolderTranslationEnabled(String value) {
    ...
    if (CmsLog.INIT.isInfoEnabled()) {
      if (m_folderTranslationEnabled) {
        CmsLog.INIT.info(
            Messages.get().getBundle().key(Messages.INIT_VFS_FOLDER_TRANSLATION_ENABLE_0));
      } else {
        CmsLog.INIT.info(
            Messages.get().getBundle().key(Messages.INIT_VFS_FOLDER_TRANSLATION_DISABLE_0));
      }
    }
  }
  ...
  public void setXsdTranslationEnabled(String value) {
    ...
    if (CmsLog.INIT.isInfoEnabled()) {
      if (m_xsdTranslationEnabled) {
        CmsLog.INIT.info(
            Messages.get().getBundle().key(Messages.INIT_VFS_XSD_TRANSLATION_ENABLE_0));
      } else {
        CmsLog.INIT.info(
            Messages.get().getBundle().key(Messages.INIT_VFS_XSD_TRANSLATION_DISABLE_0));
      }
    }
  }
