...
public class CmsParameterConfiguration extends AbstractMap<String, String> implements @RUntainted Serializable {
     ...
     */
    private CmsParameterConfiguration(Map<String, @RUntainted String> strings, Map<String, @RUntainted Serializable> objects) {
    ...
    public Element appendToXml(Element parentNode, List<String> parametersToIgnore) {
        ...
        for (Map.Entry<String, @RUntainted Serializable> entry : m_configurationObjects.entrySet()) {
     ...
     */
    public @RUntainted List<@RUntainted String> getList(String key, @RUntainted List<@RUntainted String> defaultValue) {
