 ...
 *
 * <p>Usually the parameters are configured in some sort of String based file, either in an XML
 * configuration, or in a .property file. This wrapper allows accessing such String values directly
 * as <code>int</code>, <code>boolean</code> or other data types, without worrying about the type
 * conversion.
 *
 * <p>It can also read a configuration from a special property file format, which is explained here:
 *
 * <ul>
 *   <li>Each parameter in the file has the syntax <code>key = value</code>
 ...
 *   <li>Backslashes are escaped by using two consecutive backslashes i.e. \\. Note: Unlike in
 *       regular Java properties files, you don't need to escape Backslashes.
...
public class CmsParameterConfiguration extends AbstractMap<String, String> implements Serializable {
   ...
   *
   * <p>The lines do not terminate with new-line chars but rather when there is no backslash sign a
   * the end of the line. This is used to concatenate multiple lines for readability in the input
   * file.
   *
   * <p>
   */
   ...
   *
   * <p>Commas in the property value that are wanted can be escaped using the backslash in front
   * like this "\,".
   */
  protected static class ParameterTokenizer extends StringTokenizer {

    /** The property delimiter used while parsing (a comma). */
    static final @RUntainted String COMMA = ",";
  ...
  public static final CmsParameterConfiguration EMPTY_PARAMETERS =
      new CmsParameterConfiguration(
          Collections.<String, String>emptyMap(), Collections.<String, Serializable>emptyMap());
  ...
  private transient @RUntainted Map<String, @RUntainted Serializable> m_configurationObjects;
   ...
   */
  private CmsParameterConfiguration(
      Map<String, @RUntainted String> strings, @RUntainted Map<String, @RUntainted Serializable> objects) {
   ...
   * @return the number of successive times 'ch' appears in the 'line' before the position indicated
   *     by the 'index'
   */
   ...
   */
  protected static @RUntainted String unescape(@RUntainted String value) {
   ...
   *
   * <p>If the parameter already exists then the value will be added to the existing configuration
   * entry and a List will be created for the values.
   *
   * <p>String values separated by a comma "," will NOT be tokenized when this method is used. To
   * create a List of String values for a parameter, call this method multiple times with the same
   * parameter name.
   *
   * <p>
   *
   ...
   *
   * <p>For each parameter, a XML node like this<br>
   * <code>
   ...
   *
   * @param parentNode the parent node where the parameter nodes are appended to
   * @param parametersToIgnore if not <code>null</code>, all parameters in this list are not written
   *     to the XML
   * @return the parent node
   */
  ...
  public boolean containsValue(Object value) {
    ...
    return m_configurationStrings.containsValue(value)
        || m_configurationObjects.containsValue(value);
  }
  ...
  /**
   * Returns the boolean associated with the given parameter, or the default value in case there is
   * no boolean value for this parameter.
   *
   * <p>
   *
   * @param key the parameter to look up the value for
   * @param defaultValue the default value
   * @return the boolean associated with the given parameter, or the default value in case there is
   *     no boolean value for this parameter
   */
  public @RUntainted boolean getBoolean(String key, @RUntainted boolean defaultValue) {

    @RUntainted Object value = m_configurationObjects.get(key);

    if (value instanceof Boolean) {
      return ((Boolean) value).booleanValue();

    } else if (value instanceof String) {
      @RUntainted Boolean b = Boolean.valueOf((String) value);
  ...
  /**
   * Returns the integer associated with the given parameter, or the default value in case there is
   * no integer value for this parameter.
   *
   * <p>
   *
   * @param key the parameter to look up the value for
   * @param defaultValue the default value
   * @return the integer associated with the given parameter, or the default value in case there is
   *     no integer value for this parameter
   */
  public @RUntainted int getInteger(String key, @RUntainted int defaultValue) {
    ...
    if (value instanceof Integer) {
      ...
      @RUntainted Integer i = new Integer((String) value);
  ...
  /**
   * Returns the List of Strings associated with the given parameter, or an empty List in case there
   * is no List of Strings for this parameter.
   *
   * <p>The list returned is a copy of the internal data of this object, and as such you may alter
   * it freely.
   *
   * <p>
   *
   * @param key the parameter to look up the value for
   * @return the List of Strings associated with the given parameter, or an empty List in case there
   *     is no List of Strings for this parameter
   */
  public @RUntainted List<@RUntainted String> getList(String key) {

    return getList(key, null);
  }

  /**
   * Returns the List of Strings associated with the given parameter, or the default value in case
   * there is no List of Strings for this parameter.
   *
   * <p>The list returned is a copy of the internal data of this object, and as such you may alter
   * it freely.
   *
   ...
   * @param key the parameter to look up the value for
   * @param defaultValue the default value
   * @return the List of Strings associated with the given parameter, or the default value in case
   *     there is no List of Strings for this parameter
   */
  public @RUntainted List<@RUntainted String> getList(String key, List<@RUntainted String> defaultValue) {

    Object value = m_configurationObjects.get(key);

    if (value instanceof List) {
      @SuppressWarnings("unchecked")
      List<@RUntainted String> result = (List<String>) value;
      return new ArrayList<String>(result);

    } else if (value instanceof String) {
      ArrayList<@RUntainted String> values = new ArrayList<@RUntainted String>(1);
  ...
  /**
   * Returns the raw Object associated with the given parameter, or <code>null</code> in case there
   * is no Object for this parameter.
   *
   * <p>
   *
   * @param key the parameter to look up the value for
   * @return the raw Object associated with the given parameter, or <code>null</code> in case there
   *     is no Object for this parameter.
   *     <p>
   */
  ...
  /**
   * Creates a new <tt>Properties</tt> object from the existing configuration extracting all
   * key-value pars whose key are prefixed with <tt>keyPrefix</tt>.
   *
   * <p>For this example config:
   *
   * <pre>
   *      # lines starting with # are comments
   ...
   * </pre>
   *
   * <tt>getPrefixedProperties("db.pool.default.connectionProperties")</tt> will return a
   * <tt>Properties</tt> object with one single entry:
   *
   * <pre>
   *      key:"driver", value:"com.mysql.cj.jdbc.Driver"
   * </pre>
   *
   * @param keyPrefix prefix to match. If it isn't already, it will be terminated with a dot. If
   *     <tt>null</tt>, it will return an empty <tt>Properties</tt> instance
   * @return a new <tt>Properties</tt> object with all the entries from this configuration whose
   *     keys math the prefix
   */
  ...
  /**
   * Returns the String associated with the given parameter, or the given default value in case
   ...
   * @param key the parameter to look up the value for
   * @param defaultValue the default value
   * @return the String associated with the given parameter, or the given default value in case
   *     there is no value for this parameter.
   *     <p>
   */
  ...
  public void load(InputStream input) throws IOException {
    ...
    while (true) {
      ...
      if (equalSign > 0) {
        ...
        @RUntainted String value = line.substring(equalSign + 1).trim();
   ...
   *
   * <p>If the parameter already exists then the existing value will be replaced.
   *
   * <p>
   *
   ...
   *
   * <p>The difference form a simple <code>Map&lt;String, String&gt;</code> is that for the
   * parameter configuration, the values of the keys in both maps are merged and kept in the Object
   * store as a List.
   *
   * <p>As result, <code>this</code> configuration will be altered, the other configuration will
   * stay unchanged.
   *
   * <p>
   *
  ...
  private void add(String key, @RUntainted String value, boolean tokenize) {
    ...
    if (tokenize && (value.indexOf(ParameterTokenizer.COMMA) > 0)) {
      ...
      while (tokenizer.hasMoreTokens()) {
        @RUntainted String token = tokenizer.nextToken();
