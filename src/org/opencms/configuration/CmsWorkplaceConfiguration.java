...
public class CmsWorkplaceConfiguration extends A_CmsXmlConfiguration {
  ...
  /**
   * Configuration node name for setting the default value for the 'use formatter keys' in sitemap
   * configurations created with new subsitemap folders.
   */
  private static final String N_USE_FORMATTER_KEYS_FOR_NEW_SITES =
  ...
  public static void addExplorerTypeXmlRules(Digester digester) {
    ...
    digester.addCallMethod(
        "*/" + N_EXPLORERTYPE + "/" + N_ICONRULES + "/" + N_ICONRULE, "addIconRule", 5);
    digester.addCallParam(
        "*/" + N_EXPLORERTYPE + "/" + N_ICONRULES + "/" + N_ICONRULE, 0, A_EXTENSION);
    digester.addCallParam("*/" + N_EXPLORERTYPE + "/" + N_ICONRULES + "/" + N_ICONRULE, 1, A_ICON);
    digester.addCallParam(
        "*/" + N_EXPLORERTYPE + "/" + N_ICONRULES + "/" + N_ICONRULE, 2, A_BIGICON);
    digester.addCallParam(
        "*/" + N_EXPLORERTYPE + "/" + N_ICONRULES + "/" + N_ICONRULE, 3, A_SMALLICONSTYLE);
    digester.addCallParam(
        "*/" + N_EXPLORERTYPE + "/" + N_ICONRULES + "/" + N_ICONRULE, 4, A_BIGICONSTYLE);
    ...
    digester.addObjectCreate(
        "*/" + N_EXPLORERTYPE + "/" + N_ACCESSCONTROL, CmsExplorerTypeAccess.class);
    digester.addSetNext("*/" + N_EXPLORERTYPE + "/" + N_ACCESSCONTROL, "setAccess");

    digester.addCallMethod(
        "*/" + N_EXPLORERTYPE + "/" + N_ACCESSCONTROL + "/" + N_ACCESSENTRY, "addAccessEntry", 2);
    digester.addCallParam(
        "*/" + N_EXPLORERTYPE + "/" + N_ACCESSCONTROL + "/" + N_ACCESSENTRY, 0, A_PRINCIPAL);
    digester.addCallParam(
        "*/" + N_EXPLORERTYPE + "/" + N_ACCESSCONTROL + "/" + N_ACCESSENTRY, 1, A_PERMISSIONS);
    ...
    digester.addCallMethod(
        ...
        2);
    digester.addCallParam(
        "*/" + N_EXPLORERTYPE + "/" + N_EDITOPTIONS + "/" + N_DEFAULTPROPERTIES, 0, A_ENABLED);
    digester.addCallParam(
        "*/" + N_EXPLORERTYPE + "/" + N_EDITOPTIONS + "/" + N_DEFAULTPROPERTIES,
        1,
        A_SHOWNAVIGATION);
  ...
  public static void generateExplorerTypesXml(
      Element startNode, List<CmsExplorerTypeSettings> explorerTypes, boolean module) {
    ...
    while (i.hasNext()) {
      ...
      if (settings.isAddititionalModuleExplorerType() == module) {
        ...
        newResElement.addAttribute(
            A_AUTOSETNAVIGATION, String.valueOf(settings.isAutoSetNavigation()));
        ...
        if (settings.hasEditOptions()) {
          ...
          defaultPropertiesElement.addAttribute(
              A_ENABLED, String.valueOf(settings.isPropertiesEnabled()));
          defaultPropertiesElement.addAttribute(
              A_SHOWNAVIGATION, String.valueOf(settings.isShowNavigation()));
  ...
  public void addXmlDigesterRules(Digester digester) {
    ...
    digester.addCallMethod(
        "*/" + N_WORKPLACE + "/" + N_GALLERY_DEFAULT_SCOPE, "setGalleryDefaultScope", 0);

    digester.addCallMethod(
        "*/" + N_WORKPLACE + "/" + N_ELEMENT_DELETE_MODE, "setElementDeleteMode", 0);
    ...
    digester.addCallMethod(
        "*/" + N_WORKPLACE + "/" + N_CATEGORYDISPLAYOPTIONS, "setCategoryDisplayOptions", 2);
    digester.addCallParam(
        "*/" + N_WORKPLACE + "/" + N_CATEGORYDISPLAYOPTIONS, 0, A_DISPLAY_BY_REPOSITORY);
    digester.addCallParam(
        "*/" + N_WORKPLACE + "/" + N_CATEGORYDISPLAYOPTIONS, 1, A_DISPLAY_COLLAPSED);

    digester.addCallMethod(
        "*/" + N_WORKPLACE + "/" + N_GROUP_TRANSLATION, "setGroupTranslationClass", 1);
    ...
    digester.addObjectCreate(
        ...
        A_CLASS);
    digester.addSetNext(
        "*/" + N_WORKPLACE + "/" + N_DIALOGHANDLERS + "/" + N_DIALOGHANDLER, "addDialogHandler");
    digester.addCallMethod(
        "*/" + N_WORKPLACE + "/" + N_DIALOGHANDLERS + "/" + N_DIALOGHANDLER,
    ...
    // add rules for editor handler
    digester.addObjectCreate(
        "*/" + N_WORKPLACE + "/" + N_POSTUPLOADHANDLER, A_CLASS, CmsConfigurationException.class);
    ...
    digester.addCallMethod(
        ...
        1);
    digester.addCallParam(
        "*/" + N_WORKPLACE + "/" + N_EDITORCSSHANDLERS + "/" + N_EDITORCSSHANDLER, 0, A_CLASS);
    ...
    digester.addCallMethod(
        ...
        1);
    digester.addCallParam(
        "*/" + N_WORKPLACE + "/" + N_EDITORPRECONDITIONS + "/" + N_EDITORPRECONDITION, 0, A_NAME);
    ...
    digester.addCallMethod(
        "*/" + N_WORKPLACE + "/" + N_EXPORTPOINTS + "/" + N_EXPORTPOINT, "addExportPoint", 2);
    digester.addCallParam(
        "*/" + N_WORKPLACE + "/" + N_EXPORTPOINTS + "/" + N_EXPORTPOINT, 0, A_URI);
    digester.addCallParam(
        "*/" + N_WORKPLACE + "/" + N_EXPORTPOINTS + "/" + N_EXPORTPOINT, 1, A_DESTINATION);
    ...
    digester.addCallMethod(
        "*/" + N_WORKPLACE + "/" + N_XMLCONTENTAUTOCORRECTION, "setXmlContentAutoCorrect", 0);

    // add user management enabled rule
    digester.addCallMethod(
        "*/" + N_WORKPLACE + "/" + N_ENABLEUSERMGMT, "setUserManagementEnabled", 0);
    ...
    digester.addCallMethod(
        "*/" + N_WORKPLACE + "/" + N_LABELEDFOLDERS + "/" + N_RESOURCE, "addLabeledFolder", 1);
    ...
    digester.addObjectCreate(
        ...
        A_CLASS);
    digester.addSetNext(
        "*/" + N_WORKPLACE + "/" + N_REPOSITORY_FOLDER, "setRepositoryFolderHandler");

    // add localized folders rule
    digester.addCallMethod(
        "*/" + N_WORKPLACE + "/" + N_LOCALIZEDFOLDERS + "/" + N_RESOURCE, "addLocalizedFolder", 1);
    digester.addCallParam(
        "*/" + N_WORKPLACE + "/" + N_LOCALIZEDFOLDERS + "/" + N_RESOURCE, 0, A_URI);
    ...
    // Cms specific rule similar to SetNextRule with implicit first CmsObject argument (remains
    // null).
    digester.addRule(
        xPathPrefix, new CmsSetNextRule("setFileViewSettings", CmsRfsFileViewer.class));
    ...
    digester.addRule(
        ...
        new Rule() {
          ...
          public void begin(String namespace, String name, Attributes attributes) throws Exception {
            ...
            Class<? extends I_CmsUploadRestriction> cls =
                Class.forName(className, false, getClass().getClassLoader())
                    .asSubclass(I_CmsUploadRestriction.class);
    ...
    digester.addRule(
        ...
        new Rule() {
          ...
          public void body(String namespace, String name, String text) throws Exception {
            ...
            CmsResourceTypeSubsitemapContentFolder.setEnableNewPageFormatByDefault(
                Boolean.parseBoolean(text));
          }
        });

    digester.addRule(
        "*/" + N_WORKPLACE + "/" + N_SITEMAP_CONFIG_EDIT_ROLE,
        new Rule() {
  ...
  public Element generateXml(Element parent) {
    ...
    for (int j = 0; j < keys.length; j++) {
      ...
      Element dialogHandler =
          dialogElement
              .addElement(N_DIALOGHANDLER)
    ...
    if (m_workplaceManager.getPostUploadHandler() != null) {
      workplaceElement
          .addElement(N_POSTUPLOADHANDLER)
          .addAttribute(A_CLASS, m_workplaceManager.getPostUploadHandler().getClass().getName());
    }
    ...
    if (m_workplaceManager.getPreEditorConditionDefinitions().size() > 0) {
      ...
      Iterator<I_CmsPreEditorActionDefinition> it =
          m_workplaceManager.getPreEditorConditionDefinitions().iterator();
      while (it.hasNext()) {
    ...
    Element deProviderNode =
        workplaceElement
            .addElement(N_DIRECTEDITPROVIDER)
            .addAttribute(A_CLASS, deProvider.getClass().getName());
    ...
    while (exportPoints.hasNext()) {
      ...
      resourceloadersElement
          .addElement(N_EXPORTPOINT)
    ...
    workplaceElement
        .addElement(N_AUTOLOCK)
        .setText(String.valueOf(m_workplaceManager.autoLockResources()));
    ...
    if (CmsStringUtil.isNotEmptyOrWhitespaceOnly(m_workplaceManager.getCategoryFolder())
        && !CmsCategoryService.REPOSITORY_BASE_FOLDER.equals(
            m_workplaceManager.getCategoryFolder())) {
      workplaceElement
          .addElement(N_CATEGORYFOLDER)
    ...
    workplaceElement
        .addElement(N_REPOSITORY_FOLDER)
        .addAttribute(
            A_CLASS, m_workplaceManager.getRepositoryFolderHandler().getClass().getName());
    ...
    List<CmsExplorerTypeSettings> explorerTypes =
        m_workplaceManager.getWorkplaceExplorerTypeSettings();
    ...
    if (m_workplaceManager.getUserInfoManager() != null) {
      ...
      Iterator<CmsWorkplaceUserInfoBlock> infoBlocks =
          m_workplaceManager.getUserInfoManager().getBlocks().iterator();
    ...
    Multimap<String, I_CmsPreference> prefsByTab =
        Multimaps.index(
    ...
    for (String tabName :
        new String[] {
          CmsGwtConstants.TAB_BASIC, CmsGwtConstants.TAB_EXTENDED, CmsGwtConstants.TAB_HIDDEN
        }) {
      Element preferenceTab =
          defaultPreferences.addElement(N_PREFERENCE_TAB).addAttribute("name", tabName);
    ...
    CmsAdditionalLogFolderConfig.ADD_LOG_FOLDER_HELPER.generateXml(
        workplaceElement, m_workplaceManager.getAdditionalLogFolderConfiguration());

    boolean useKeysForNewSites =
        CmsResourceTypeSubsitemapContentFolder.isEnableNewPageFormatByDefault();
    workplaceElement
        .addElement(N_USE_FORMATTER_KEYS_FOR_NEW_SITES)
        .setText("" + useKeysForNewSites);
  ...
  protected void addDefaultPreferencesRules(Digester digester) {
    ...
    digester.addObjectCreate(
        "*/" + N_WORKPLACE + "/" + N_DEFAULTPREFERENCES, CmsDefaultUserSettings.class);
    digester.addSetNext("*/" + N_WORKPLACE + "/" + N_DEFAULTPREFERENCES, "setDefaultUserSettings");

    // TODO: most of these settings are not user dependent, so they should not be stored in the
    // CmsDefaultUserSettings class
    ...
    digester.addCallMethod(
        xPathPrefix + "/" + N_PUBLISHNOTIFICATION, "setShowPublishNotification", 0);
    digester.addCallMethod(
        xPathPrefix + "/" + N_PUBLISHBUTTONAPPEARANCE, "setPublishButtonAppearance", 0);
    digester.addCallMethod(
        xPathPrefix + "/" + N_SHOWFILEUPLOADBUTTON, "setShowFileUploadButton", 0);

    // add allow broken relations rule
    digester.addCallMethod(
        xPathPrefix + "/" + N_ALLOWBROKENRELATIONS, "setAllowBrokenRelations", 0);

    // add publish related resources rule
    digester.addCallMethod(
        xPathPrefix + "/" + N_PUBLISHRELATEDRESOURCES, "setPublishRelatedResourcesMode", 0);

    // add rules for the new folder dialog settings
    digester.addCallMethod(
        xPathPrefix + "/" + N_NEWFOLDEREDITPROPERTIES, "setNewFolderEditProperties", 0);
    digester.addCallMethod(
        xPathPrefix + "/" + N_NEWFOLDERCREATEINDEXPAGE, "setNewFolderCreateIndexPage", 0);
    digester.addCallMethod(
        xPathPrefix + "/" + N_SHOWUPLOADTYPEDIALOG, "setShowUploadTypeDialog", 0);
    digester.addCallMethod(
        xPathPrefix + "/" + N_SUBSITEMAP_CREATION_MODE, "setSubsitemapCreationMode", 0);
    ...
    digester.addCallMethod(
        xPathPrefix + "/" + N_RESTRICTEXPLORERVIEW, "setRestrictExplorerView", 0);
    ...
    digester.addCallMethod(
        xPathPrefix + "/" + N_DATELASTMODIFIED, "setShowExplorerFileDateLastModified", 0);
    ...
    digester.addCallMethod(
        xPathPrefix + "/" + N_USERLASTMODIFIED, "setShowExplorerFileUserLastModified", 0);
    digester.addCallMethod(xPathPrefix + "/" + N_USERCREATED, "setShowExplorerFileUserCreated", 0);
    digester.addCallMethod(
        xPathPrefix + "/" + N_DATERELEASED, "setShowExplorerFileDateReleased", 0);
    ...
    digester.addCallMethod(
        xPathPrefix + "/" + N_SHOWEXPORTSETTINGS, "setShowExportSettingsDialog", 0);
    digester.addCallMethod(
        xPathPrefix + "/" + N_PERMISSIONSINHERITONFOLDER, "setDialogPermissionsInheritOnFolder", 0);
    digester.addCallMethod(
        xPathPrefix + "/" + N_EXPANDPERMISSIONSINHERITED, "setDialogExpandInheritedPermissions", 0);
    digester.addCallMethod(
        xPathPrefix + "/" + N_EXPANDPERMISSIONSUSER, "setDialogExpandUserPermissions", 0);
    ...
    digester.addRule(
        "*/" + N_WORKPLACE + "/" + N_DEFAULTPREFERENCES + "/preference-tab",
        new Rule() {
    ...
    String prefPath =
        "*/" + N_WORKPLACE + "/" + N_DEFAULTPREFERENCES + "/preference-tab/" + N_PREFERENCE;
