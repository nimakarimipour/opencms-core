...
public class CmsStartViewPreference extends CmsBuiltinPreference {
  ...
  private static final String NICE_NAME =
      "%(key." + org.opencms.workplace.commons.Messages.GUI_PREF_STARTUP_VIEW_0 + ")";
  ...
  public static SelectOptions getViewSelectOptions(CmsObject cms, String value) {
    ...
    for (I_CmsWorkplaceAppConfiguration app : apps) {
      if (OpenCms.getRoleManager()
          .hasRole(
              cms, cms.getRequestContext().getCurrentUser().getName(), app.getRequiredRole())) {
  ...
  /**
   * @see
   *     org.opencms.configuration.preferences.A_CmsPreference#isDisabled(org.opencms.file.CmsObject)
   */
  @Override
