...
public class CmsBuiltinPreference extends A_CmsPreference {
  ...
  public String getDefaultValue() {
    ...
    CmsUserSettingsStringPropertyWrapper wrapper =
        new CmsUserSettingsStringPropertyWrapper(CmsDefaultUserSettings.CURRENT_DEFAULT_SETTINGS);
    try {
  ...
  public String getValue(CmsDefaultUserSettings userSettings) {
    ...
    CmsUserSettingsStringPropertyWrapper wrapper =
        new CmsUserSettingsStringPropertyWrapper(userSettings);
    try {
      return (BeanUtils.getProperty(wrapper, m_propName));
    } catch (Exception e) {
      LOG.error(e.getLocalizedMessage(), e);
  ...
  public void setValue(CmsDefaultUserSettings settings, String value) {
    ...
    CmsUserSettingsStringPropertyWrapper wrapper =
        new CmsUserSettingsStringPropertyWrapper(settings);
    try {
