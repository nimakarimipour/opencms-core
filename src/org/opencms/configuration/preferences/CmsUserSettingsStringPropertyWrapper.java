 ...
 *
 * <p>All getter/setter pairs in this class are assumed to correspond to user settings, and the
 * corresponding property names can be used as keys in the new preference configuration format, so
 * the method names should not be changed.
 */
public class CmsUserSettingsStringPropertyWrapper {
  ...
  public String getExplorerElementView() {
    ...
    return m_settings.getAdditionalPreference(
        CmsElementViewPreference.EXPLORER_PREFERENCE_NAME, false);
  }
  ...
  public String getGalleryShowInvalidDefault() {
    ...
    return m_settings.getAdditionalPreference(
        CmsGalleryService.PREF_GALLERY_SHOW_INVALID_DEFAULT, false);
  }
  ...
  /**
   * Sets the default value for the checkbox which enables/disables showing invalid results in the
   * gallery result tab.
   *
   * <p>
   *
