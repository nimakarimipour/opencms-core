 ...
 *
 * <p>This job has a single parameter named 'max-age', whose value consists of a number, followed by
 * one or more spaces and finall a unit which is either 'hours', 'days', or 'weeks', which controls
 * how old values have to be before they are deleted by the job.
 *
 * <p>To delete the CMS_LOG entries, this scheduled job needs to be executed as a user who has the
...
public class CmsRemoveOldDbLogEntriesJob implements I_CmsScheduledJob {
  ...
  /**
   * Shows an error with the format of the 'max-age' parameter value.
   *
   * <p>
   *
