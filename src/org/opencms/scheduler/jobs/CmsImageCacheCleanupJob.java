...
public class CmsImageCacheCleanupJob implements I_CmsScheduledJob {
     ...
     * @return the total number of deleted resources
     */
    private static int cleanImageCache(long maxAge, @RUntainted File directory) {
     ...
     */
    public String launch(CmsObject cms, Map<String, @RUntainted String> parameters) throws Exception {
