 ...
 * role.
 *
 * <p>If there is an Uri set for the scheduled job, which should only be folders, it will be used
 ...
 *
 * <dl>
 *   <dt><code>keepVersions={Number/Integer}</code>
 *   <dd>Number/Integer to control how many versions will be kept.
 *   <dt><code>clearDeleted=true|false</code>
 *   <dd>Boolean to configure if the versions of deleted resources should be cleared. The default is
 *       false.
 *   <dt><code>keepTimeRange</code>
 *   <dd>Number/Integer to configure the number of days the versions of deleted resources will be
 *       kept. That means that all versions wich are older than the specified number will be
 *       deleted. This parameter is optional and only makes sense if the clearDeleted parameter is
 *       set to true.
 * </dl>
 *
 * @since 7.0.0
...
public class CmsHistoryClearJob implements I_CmsScheduledJob {
  ...
  public String launch(CmsObject cms, Map<String, String> parameters) throws Exception {
    ...
    // create a new report
    CmsLogReport report =
        new CmsLogReport(cms.getRequestContext().getLocale(), CmsHistoryClearJob.class);
