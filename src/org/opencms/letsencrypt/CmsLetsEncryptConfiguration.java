...
public class CmsLetsEncryptConfiguration implements I_CmsConfigurationParameterHandler {
  ...
  /**
   * Enum which represents different modes that control which domains OpenCms puts into the
  ...
  /**
   * Enum which represents the different types of events that LetsEncrypt updates should be
   * triggered by.
   */
  ...
  public static final CmsElementWithAttrsParamConfigHelper CONFIG_HELPER =
      new CmsElementWithAttrsParamConfigHelper(
          "*/system",
          N_LETSENCRYPT,
   ...
   *
   * <p>The host name is used to signal to the LetsEncrypt container that the configuration has been
   * updated.
   *
   ...
   *
   * <p>The port is used to signal to the LetsEncrypt docker container that the certificate
