...
public class CmsImportVersion2 extends A_CmsImport {
    ...
    private void importAllResources() throws CmsImportExportException {
        ...
        @RUntainted String source = null, destination = null, resourceTypeName = null, timestamp = null, uuid = null,
        uuidresource = null;
        long lastmodified = 0;
    ...
    private CmsResource importResource(
        ...
        try {
            ...
            @RUntainted CmsUUID newUuidresource = new CmsUUID();
            if (uuid != null) {
    ...
    private void mergePageFile(@RUntainted String resourcename) throws CmsXmlException, CmsImportExportException {
        ...
        try {
            ...
            @RUntainted Node masterTemplateNode = contentXml.selectSingleNode(masterTemplateNodeName);
            ...
            if (bodyNode != null) {
                ...
                for (int i = 0, n = nodes.size(); i < n; i++) {
                    ...
                    @RUntainted Node node = nodes.get(i);
