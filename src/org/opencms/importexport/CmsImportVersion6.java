 ...
 *
 * <p>This import format is used in OpenCms since 6.5.6.
 *
 * <p>
 *
 * @since 6.5.6
  ...
  protected void importUsers() throws CmsImportExportException {
    ...
    try {
      ...
      for (int i = 0; i < userNodes.size(); i++) {
        ...
        long dateCreated =
            Long.parseLong(getChildElementTextValue(currentElement, A_CmsImport.N_DATECREATED));

        // get the userinfo and put it into the additional info map
        Map<String, Object> userInfo = new HashMap<String, Object>();
        Iterator<Node> itInfoNodes =
            currentElement
                .selectNodes("./" + A_CmsImport.N_USERINFO + "/" + A_CmsImport.N_USERINFO_ENTRY)
                .iterator();
