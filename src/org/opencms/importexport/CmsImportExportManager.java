...
public class CmsImportExportManager {
  ...
  public static enum TimestampMode {
    ...
    /**
     * More robust version of {@link java.lang.Enum#valueOf(java.lang.Class, String)} that is case
     * insensitive and defaults for all "unreadable" arguments to the default timestamp mode.
     *
     * @param value the TimeMode value as String
     * @return <code>value</code> as TimeMode object, or the default time mode, if <code>value
     *     </code> can't be converted to a TimeMode object.
     */
  ...
  /**
   * Tag in the {@link #EXPORT_MANIFEST} for the "userinfo/entry@name" attribute, contains the
   * additional user info entry name.
   *
   * @deprecated Use the appropriate tag from latest import class instead
   */
  @Deprecated public static final String A_NAME = A_CmsImport.A_NAME;

  /**
   * Tag in the {@link #EXPORT_MANIFEST} for the "userinfo/entry@type" attribute, contains the
   * additional user info entry data type name.
   *
   * @deprecated Use the appropriate tag from latest import class instead
   */
  @Deprecated public static final String A_TYPE = A_CmsImport.A_TYPE;
   ...
   */
  @Deprecated public static final String EXPORT_XMLFILENAME = EXPORT_MANIFEST;
   ...
   * @deprecated Use the appropriate tag from latest import class instead
   */
  @Deprecated public static final String N_ACCESS = A_CmsImport.N_ACCESS;

  /**
   * Tag in the {@link #EXPORT_MANIFEST} for the "allowed" node, to identify allowed user
   * permissions.
   *
   * @deprecated Use the appropriate tag from latest import class instead
   */
  ...
  /**
   * Tag in the {@link #EXPORT_MANIFEST} for the "accesscontrol" node, to identify access control
   * entries.
   *
   * @deprecated Use the appropriate tag from latest import class instead
   */
  ...
  /**
   * Tag in the {@link #EXPORT_MANIFEST} for the "accessentry" node, to identify a single access
   * control entry.
   *
   * @deprecated Use the appropriate tag from latest import class instead
   */
  @Deprecated public static final String N_ACCESSCONTROL_ENTRY = A_CmsImport.N_ACCESSCONTROL_ENTRY;
  ...
  /**
   * Tag in the {@link #EXPORT_MANIFEST} for the "datecreated" node, contains the date created VFS
   * file attribute.
   *
   * @deprecated Use the appropriate tag from latest import class instead
   */
  @Deprecated public static final String N_DATECREATED = A_CmsImport.N_DATECREATED;

  /**
   * Tag in the {@link #EXPORT_MANIFEST} for the "dateexpired" node, contains the expiration date
   * VFS file attribute.
   *
   * @deprecated Use the appropriate tag from latest import class instead
   */
  @Deprecated public static final String N_DATEEXPIRED = A_CmsImport.N_DATEEXPIRED;

  /**
   * Tag in the {@link #EXPORT_MANIFEST} for the "datelastmodified" node, contains the date last
   * modified VFS file attribute.
   *
   * @deprecated Use the appropriate tag from latest import class instead
   */
  @Deprecated public static final String N_DATELASTMODIFIED = A_CmsImport.N_DATELASTMODIFIED;

  /**
   * Tag in the {@link #EXPORT_MANIFEST} for the "datereleased" node, contains the release date VFS
   * file attribute.
   *
   * @deprecated Use the appropriate tag from latest import class instead
   */
  @Deprecated public static final String N_DATERELEASED = A_CmsImport.N_DATERELEASED;

  /**
   * Tag in the {@link #EXPORT_MANIFEST} for the "defaultgroup" node, for backward compatibility
   * with OpenCms 5.x.
   *
   * @deprecated Use the appropriate tag from latest import class instead
   */
  @Deprecated public static final String N_DEFAULTGROUP = A_CmsImport.N_DEFAULTGROUP;

  /**
   * Tag in the {@link #EXPORT_MANIFEST} for the "description" node, contains a users description
   * test.
   *
   * @deprecated Use the appropriate tag from latest import class instead
   */
  @Deprecated public static final String N_DESCRIPTION = A_CmsImport.N_DESCRIPTION;
   ...
   * @deprecated Use the appropriate tag from latest import class instead
   */
  @Deprecated public static final String N_DESTINATION = A_CmsImport.N_DESTINATION;
   ...
   * @deprecated Use the appropriate tag from latest import class instead
   */
  @Deprecated public static final String N_EMAIL = A_CmsImport.N_EMAIL;
   ...
   * @deprecated Use the appropriate tag from latest import class instead
   */
  @Deprecated public static final String N_FILE = A_CmsImport.N_FILE;
   ...
   * @deprecated Use the appropriate tag from latest import class instead
   */
  @Deprecated public static final String N_FIRSTNAME = A_CmsImport.N_FIRSTNAME;
   ...
   * @deprecated Use the appropriate tag from latest import class instead
   */
  @Deprecated public static final String N_FLAGS = A_CmsImport.N_FLAGS;
   ...
   * @deprecated Use the appropriate tag from latest import class instead
   */
  @Deprecated public static final String N_GROUPDATA = A_CmsImport.N_GROUPDATA;
   ...
   * @deprecated Use the appropriate tag from latest import class instead
   */
  @Deprecated public static final String N_GROUPNAME = A_CmsImport.N_GROUPNAME;

  /**
   * Tag in the {@link #EXPORT_MANIFEST} for the "id" node, only required for backward compatibility
   * with import version 2.
   *
   * @deprecated Use the appropriate tag from latest import class instead
   */
  @Deprecated public static final String N_ID = A_CmsImport.N_ID;

  /** Tag in the {@link #EXPORT_MANIFEST}, starts the manifest info header. */
  public static final String N_INFO = "info";

  /**
   * Tag in the {@link #EXPORT_MANIFEST} for the "infoproject" node, appears in the manifest info
   * header.
   */
  public static final String N_INFO_PROJECT = "infoproject";

  /**
   * Tag in the {@link #EXPORT_MANIFEST} for the "lastmodified" node, only required for backward
   * compatibility with import version 2.
   *
   * @deprecated Use the appropriate tag from latest import class instead
   */
  @Deprecated public static final String N_LASTMODIFIED = A_CmsImport.N_LASTMODIFIED;
   ...
   * @deprecated Use the appropriate tag from latest import class instead
   */
  @Deprecated public static final String N_LASTNAME = A_CmsImport.N_LASTNAME;
   ...
   * @deprecated Use the appropriate tag from latest import class instead
   */
  @Deprecated public static final String N_NAME = A_CmsImport.N_NAME;

  /**
   * Tag in the {@link #EXPORT_MANIFEST} for the "opencms_version" node, appears in the manifest
   * info header.
   */
  public static final String N_OC_VERSION = "opencms_version";

  /**
   * Tag in the {@link #EXPORT_MANIFEST} for the "orgunitdatas" node, starts the organizational unit
   * data.
   *
   * @deprecated Use the appropriate tag from latest import class instead
   */
  @Deprecated public static final String N_ORGUNITDATA = A_CmsImport.N_ORGUNITDATA;

  /**
   * Tag in the {@link #EXPORT_MANIFEST} for the "parentgroup" node, contains a groups parent group
   * name.
   *
   * @deprecated Use the appropriate tag from latest import class instead
   */
  @Deprecated public static final String N_PARENTGROUP = A_CmsImport.N_PARENTGROUP;

  /**
   * Tag in the {@link #EXPORT_MANIFEST} for the "password" node, contains a users encrypted
   * password.
   *
   * @deprecated Use the appropriate tag from latest import class instead
   */
  @Deprecated public static final String N_PASSWORD = A_CmsImport.N_PASSWORD;

  /**
   * Tag in the {@link #EXPORT_MANIFEST} for the "properties" node, starts the list of properties of
   * a VFS resource.
   *
   * @deprecated Use the appropriate tag from latest import class instead
   */
  @Deprecated public static final String N_PROPERTIES = A_CmsImport.N_PROPERTIES;

  /**
   * Tag in the {@link #EXPORT_MANIFEST} for the "property" node, starts a property for a VFS
   * resource.
   *
   * @deprecated Use the appropriate tag from latest import class instead
   */
  @Deprecated public static final String N_PROPERTY = A_CmsImport.N_PROPERTY;

  /**
   * Tag in the {@link #EXPORT_MANIFEST} for the "type" property attribute, contains a property
   * type.
   *
   * @deprecated Use the appropriate tag from latest import class instead
   */
  ...
  public static final String N_PROPERTY_ATTRIB_TYPE_SHARED =
      A_CmsImport.N_PROPERTY_ATTRIB_TYPE_SHARED;

  /**
   * Tag in the {@link #EXPORT_MANIFEST} for the "relation" node, starts a relation for a VFS
   * resource.
   *
   * @deprecated Use the appropriate tag from latest import class instead
   */
  @Deprecated public static final String N_RELATION = A_CmsImport.N_RELATION;

  /**
   * Tag in the {@link #EXPORT_MANIFEST} for the "id" relation attribute, contains the structure id
   * of the target resource of the relation.
   *
   * @deprecated Use the appropriate tag from latest import class instead
   */
  @Deprecated
  ...
  /**
   * Tag in the {@link #EXPORT_MANIFEST} for the "path" relation attribute, contains the path to the
  ...
  /**
   * Tag in the {@link #EXPORT_MANIFEST} for the "type" relation attribute, contains the type of
   * relation.
   *
   * @deprecated Use the appropriate tag from latest import class instead
   */
  ...
  /**
   * Tag in the {@link #EXPORT_MANIFEST} for the "relations" node, starts the list of relations of a
   * VFS resources.
   *
   * @deprecated Use the appropriate tag from latest import class instead
   */
  @Deprecated public static final String N_RELATIONS = A_CmsImport.N_RELATIONS;

  /**
   * Tag in the {@link #EXPORT_MANIFEST} for the "source" node, contains the source path of a VFS
   * resource in the import zip (or folder).
   *
   * @deprecated Use the appropriate tag from latest import class instead
   */
  @Deprecated public static final String N_SOURCE = A_CmsImport.N_SOURCE;
   ...
   * @deprecated Use the appropriate tag from latest import class instead
   */
  @Deprecated public static final String N_TAG_ADDRESS = A_CmsImport.N_TAG_ADDRESS;

  /**
   * Tag in the {@link #EXPORT_MANIFEST} for the "type" node, the resource type name of a VFS
   * resource.
   *
   * @deprecated Use the appropriate tag from latest import class instead
   */
  @Deprecated public static final String N_TYPE = A_CmsImport.N_TYPE;
   ...
   * @deprecated Use the appropriate tag from latest import class instead
   */
  @Deprecated public static final String N_USER = A_CmsImport.N_USER;

  /**
   * Tag in the {@link #EXPORT_MANIFEST} for the "usercreated" node, contains the name of the user
   * who created the VFS resource.
   *
   * @deprecated Use the appropriate tag from latest import class instead
   */
  @Deprecated public static final String N_USERCREATED = A_CmsImport.N_USERCREATED;
   ...
   * @deprecated Use the appropriate tag from latest import class instead
   */
  @Deprecated public static final String N_USERDATA = A_CmsImport.N_USERDATA;
   ...
   * @deprecated Use the appropriate tag from latest import class instead
   */
  @Deprecated public static final String N_USERGROUPDATA = A_CmsImport.N_USERGROUPDATA;
   ...
   * @deprecated Use the appropriate tag from latest import class instead
   */
  @Deprecated public static final String N_USERGROUPS = A_CmsImport.N_USERGROUPS;
   ...
   * @deprecated Use the appropriate tag from latest import class instead
   */
  @Deprecated public static final String N_USERINFO = A_CmsImport.N_USERINFO;

  /**
   * Tag in the {@link #EXPORT_MANIFEST} for the "userinfo/entry" node, contains the additional user
   * info entry value.
   *
   * @deprecated Use the appropriate tag from latest import class instead
   */
  @Deprecated public static final String N_USERINFO_ENTRY = A_CmsImport.N_USERINFO_ENTRY;

  /**
   * Tag in the {@link #EXPORT_MANIFEST} for the "userlastmodified" node, contains the name of the
   * user who last modified the VFS resource.
   *
   * @deprecated Use the appropriate tag from latest import class instead
   */
  @Deprecated public static final String N_USERLASTMODIFIED = A_CmsImport.N_USERLASTMODIFIED;

  /**
   * Tag in the {@link #EXPORT_MANIFEST} for the "uuidresource" node, contains a the resource UUID
   * of a VFS resource.
   *
   * @deprecated Use the appropriate tag from latest import class instead
   */
  @Deprecated public static final String N_UUIDRESOURCE = A_CmsImport.N_UUIDRESOURCE;

  /**
   * Tag in the {@link #EXPORT_MANIFEST} for the "uuidstructure" node, only required for backward
   * compatibility with import version 2.
   *
   * @deprecated Use the appropriate tag from latest import class instead
   */
  @Deprecated public static final String N_UUIDSTRUCTURE = A_CmsImport.N_UUIDSTRUCTURE;
   ...
   * @deprecated Use the appropriate tag from latest import class instead
   */
  @Deprecated public static final String N_VALUE = A_CmsImport.N_VALUE;

  /**
   * Tag in the {@link #EXPORT_MANIFEST} for the "export_version" node, appears in the manifest info
   * header.
   */
  ...
  private @RUntainted List<String> m_immutableResources;
  ...
  private @RUntainted Map<String, @RUntainted String> m_importUserTranslations;
  ...
  private @RUntainted boolean m_overwriteCollidingResources;
  ...
  /**
   * Creates a new instance for the import/export manager, will be called by the import/export
  ...
  /**
   * Adds the provided default timestamp mode for the resourcetypes in list {@link
   * #m_resourcetypes}. The method is called by the digester.
   *
  ...
  public void addDefaultTimestampMode(@RUntainted String timestampMode) {
    ...
    if (null != timestampMode) {
      try {
        ...
        for (@RUntainted String resourcetype : m_resourcetypes) {
  ...
  public void addIgnoredProperty(@RUntainted String propertyName) {
    ...
    if (LOG.isDebugEnabled()) {
      LOG.debug(
          Messages.get()
              .getBundle()
              .key(Messages.LOG_IMPORTEXPORT_IGNORING_PROPERTY_1, propertyName));
    }
    m_ignoredProperties.add(propertyName);
  }

  /**
   * Adds a resource to the list of immutable resources that should remain unchanged when resources
   * are imported.
   *
   * <p>
   *
  ...
  public void addImmutableResource(@RUntainted String immutableResource) {
    ...
    if (LOG.isDebugEnabled()) {
      LOG.debug(
          Messages.get()
              .getBundle()
              .key(Messages.LOG_IMPORTEXPORT_ADDED_IMMUTABLE_RESOURCE_1, immutableResource));
    }
  ...
  public void addImportExportHandler(@RUntainted I_CmsImportExportHandler handler) {
    ...
    if (LOG.isDebugEnabled()) {
      LOG.debug(
          Messages.get()
              .getBundle()
              .key(Messages.LOG_IMPORTEXPORT_ADDED_IMPORTEXPORT_HANDLER_1, handler));
    }
  ...
  public void addImportPrincipalTranslation(@RUntainted String type, @RUntainted String from, @RUntainted String to) {
    ...
    if (LOG.isDebugEnabled()) {
      LOG.debug(
          Messages.get()
              .getBundle()
              .key(Messages.LOG_IMPORTEXPORT_ADDED_PRINCIPAL_TRANSLATION_3, type, from, to));
    }
    if (I_CmsPrincipal.PRINCIPAL_GROUP.equalsIgnoreCase(type)) {
      ...
      if (LOG.isInfoEnabled()) {
        LOG.info(
            Messages.get()
                .getBundle()
                .key(Messages.INIT_IMPORTEXPORT_ADDED_GROUP_TRANSLATION_2, from, to));
      }
      ...
      if (LOG.isInfoEnabled()) {
        LOG.info(
            Messages.get()
                .getBundle()
                .key(Messages.INIT_IMPORTEXPORT_ADDED_USER_TRANSLATION_2, from, to));
      }
    }
  }
  ...
  public void addImportVersionClass(@RUntainted I_CmsImport importVersionClass) {
    ...
    if (LOG.isDebugEnabled()) {
      LOG.debug(
          Messages.get()
              .getBundle()
              .key(Messages.LOG_IMPORTEXPORT_ADDED_IMPORT_VERSION_1, importVersionClass));
    }
   ...
   * {@link #addDefaultTimestampMode(String)}. The method is called only by the digester.
   *
   ...
   * @throws CmsRoleViolationException if the current user is not a allowed to export the OpenCms
   *     database
  ...
  /**
   * Returns the default timestamp mode for the resourcetype - or <code>null</code> if no default
   * mode is set.
   *
   ...
   * <p>
   *
   * @param withNull returns the extendenHtmlImport as null if its null, otherwise a new
   *     CmsExtendedHtmlImportDefault Object is generated
   * @return the extendedHtmlImportDefault
   */
   ...
   * <p>
   *
   * @return the list of property keys that should be removed from imported resources, or
   ...
   * imported.
   *
   * <p>Certain system resources should not be changed during import. This is the case for the main
  ...
  /**
   * Returns an instance of an import/export handler implementation that is able to import a
   * specified resource.
   *
   * <p>
   *
  ...
  public I_CmsImportExportHandler getImportExportHandler(CmsImportParameters parameters)
    ...
    try {
      ...
      throw new CmsImportExportException(
          Messages.get().container(Messages.ERR_IMPORTEXPORT_FILE_NOT_FOUND_1, EXPORT_MANIFEST), e);
    } finally {
      try {
        if (stream != null) {
          stream.close();
    ...
    CmsMessageContainer message =
        Messages.get()
            .container(Messages.ERR_IMPORTEXPORT_ERROR_NO_HANDLER_FOUND_1, EXPORT_MANIFEST);
    if (LOG.isDebugEnabled()) {
  ...
  /**
   * Returns the URL of a 4.x OpenCms app. (e.g. http://localhost:8080/opencms/opencms/) from which
   * content was exported.
   *
   * <p>This setting is required to import content of 4.x OpenCms apps. correct into 5.x OpenCms
   * apps.
   *
   * <p>
   *
   ...
   *
   * <p>If any temporary export point paths are configured, then export points writing to these
   * paths will write to a temporary folder instead.
   *
  ...
  /**
   * Checks if the current user has permissions to import data into the Cms, and if so, creates a
   * new import handler instance that imports the data.
   *
   * <p>
   *
   ...
   * @param parameters the import parameters
   * @throws CmsRoleViolationException if the current user is not allowed to import the OpenCms
   *     database
   * @throws CmsImportExportException if operation was not successful
   ...
   * @param importPath the name (absolute path) of the destination folder in the Cms if required, or
   *     null
   * @param report a Cms report to print log messages
   * @throws CmsRoleViolationException if the current user is not allowed to import the OpenCms
   *     database
   ...
   */
  public @RUntainted boolean overwriteCollidingResources() {
   ...
   * <p>
   *
   * @param convertToXmlPage <code>"true"</code>, if imported pages should be converted into XML
   *     pages.
   */
  public void setConvertToXmlPage(@RUntainted String convertToXmlPage) {
  ...
  /**
   * Sets the URL of a 4.x OpenCms app. (e.g. http://localhost:8080/opencms/opencms/) from which
   * content was exported.
   *
   * <p>This setting is required to import content of 4.x OpenCms apps. correct into 5.x OpenCms
   * apps.
  ...
  public void setOldWebAppUrl(@RUntainted String webAppUrl) {
    ...
    if (LOG.isDebugEnabled()) {
      LOG.debug(
          Messages.get()
              .getBundle()
              .key(Messages.LOG_IMPORTEXPORT_SET_OLD_WEBAPP_URL_1, webAppUrl));
    }
    m_webAppUrl = webAppUrl;
  }

  /**
   * Sets whether colliding resources should be overwritten during the import for a specified import
   * implementation.
   *
   * <p>v1 and v2 imports (without resource UUIDs in the manifest) *MUST* overwrite colliding
   * resources. Don't forget to set this flag back to it's original value in v1 and v2 import
   * implementations!
   *
   * <p>This flag must be set to false to force imports > v2 to move colliding resources to
   * /system/lost-found/.
   *
   * <p>The import implementation has to take care to set this flag correct!
   *
   * <p>
   *
   * @param overwriteCollidingResources true if colliding resources should be overwritten during the
   *     import
   */
   ...
   * @param overwriteCollidingResources <code>"true"</code> if colliding resources should be
   *     overwritten during the import
   */
  public void setOverwriteCollidingResources(@RUntainted String overwriteCollidingResources) {
   ...
   *
   * <p>If no matching name is found, the given group name is returned.
   *
   * <p>
   *
   ...
   *
   * <p>If no matching name is found, the given user name is returned.
   *
   * <p>
   *
