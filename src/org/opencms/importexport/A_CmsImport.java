...
public abstract class A_CmsImport implements I_CmsImport {
    ...
    protected @RUntainted Map<String, List<CmsProperty>> m_linkPropertyStorage;
     ...
     */
    protected void importGroup(@RUntainted String name, @RUntainted String description, @RUntainted String flags, @RUntainted String parentgroupName)
    throws CmsImportExportException {
        ...
        try {
            ...
            if (CmsStringUtil.isNotEmpty(parentgroupName) && (parentGroup == null)) {
                ...
                Map<String, @RUntainted String> groupData = new HashMap<String, @RUntainted String>();
