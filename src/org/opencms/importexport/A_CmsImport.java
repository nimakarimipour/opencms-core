 ...
 *
 * <p>This class does not implement a real OpenCms import, real import implementation should be
...
public abstract class A_CmsImport implements I_CmsImport {
  ...
  /**
   * Tag in the {@link CmsImportExportManager#EXPORT_MANIFEST} for the "userinfo/entry@name"
   * attribute, contains the additional user info entry name.
   */
  public static final String A_NAME = "name";

  /**
   * Tag in the {@link CmsImportExportManager#EXPORT_MANIFEST} for the "userinfo/entry@type"
   * attribute, contains the additional user info entry data type name.
   */
  ...
  /**
   * Tag in the {@link CmsImportExportManager#EXPORT_MANIFEST} for the "allowed" node, to identify
   * allowed user permissions.
   */
  public static final String N_ACCESSCONTROL_ALLOWEDPERMISSIONS = "allowed";

  /**
   * Tag in the {@link CmsImportExportManager#EXPORT_MANIFEST} for the "denied" node, to identify
   * denied user permissions.
   */
  public static final String N_ACCESSCONTROL_DENIEDPERMISSIONS = "denied";

  /**
   * Tag in the {@link CmsImportExportManager#EXPORT_MANIFEST} for the "accesscontrol" node, to
   * identify access control entries.
   */
  public static final String N_ACCESSCONTROL_ENTRIES = "accesscontrol";

  /**
   * Tag in the {@link CmsImportExportManager#EXPORT_MANIFEST} for the "accessentry" node, to
   * identify a single access control entry.
   */
  public static final String N_ACCESSCONTROL_ENTRY = "accessentry";

  /**
   * Tag in the {@link CmsImportExportManager#EXPORT_MANIFEST} for the "permissionset" node, to
   * identify a permission set.
   */
  public static final String N_ACCESSCONTROL_PERMISSIONSET = "permissionset";

  /**
   * Tag in the {@link CmsImportExportManager#EXPORT_MANIFEST} for the "uuidprincipal" node, to
   * identify a principal UUID.
   */
  public static final String N_ACCESSCONTROL_PRINCIPAL = "uuidprincipal";

  /**
   * Tag in the {@link CmsImportExportManager#EXPORT_MANIFEST} for the "datecreated" node, contains
   * the date created VFS file attribute.
   */
  public static final String N_DATECREATED = "datecreated";

  /**
   * Tag in the {@link CmsImportExportManager#EXPORT_MANIFEST} for the "dateexpired" node, contains
   * the expiration date VFS file attribute.
   */
  public static final String N_DATEEXPIRED = "dateexpired";

  /**
   * Tag in the {@link CmsImportExportManager#EXPORT_MANIFEST} for the "datelastmodified" node,
   * contains the date last modified VFS file attribute.
   */
  public static final String N_DATELASTMODIFIED = "datelastmodified";

  /**
   * Tag in the {@link CmsImportExportManager#EXPORT_MANIFEST} for the "datereleased" node, contains
   * the release date VFS file attribute.
   */
  public static final String N_DATERELEASED = "datereleased";

  /**
   * Tag in the {@link CmsImportExportManager#EXPORT_MANIFEST} for the "defaultgroup" node, for
   * backward compatibility with OpenCms 5.x.
   */
  public static final String N_DEFAULTGROUP = "defaultgroup";

  /**
   * Tag in the {@link CmsImportExportManager#EXPORT_MANIFEST} for the "description" node, contains
   * a users description test.
   */
  public static final String N_DESCRIPTION = "description";

  /**
   * Tag in the {@link CmsImportExportManager#EXPORT_MANIFEST} for the "destination" node, contains
   * target VFS file name.
   */
  public static final String N_DESTINATION = "destination";

  /**
   * Tag in the {@link CmsImportExportManager#EXPORT_MANIFEST} for the "email" node, contains a
   * users email.
   */
  public static final String N_EMAIL = "email";

  /**
   * Tag in the {@link CmsImportExportManager#EXPORT_MANIFEST} for the "file" node, container node
   * for all VFS resources.
   */
  public static final String N_FILE = "file";

  /**
   * Tag in the {@link CmsImportExportManager#EXPORT_MANIFEST} for the "firstname" node, contains a
   * users first name.
   */
  public static final String N_FIRSTNAME = "firstname";

  /**
   * Tag in the {@link CmsImportExportManager#EXPORT_MANIFEST} for the "flags" node, contains the
   * flags of a VFS resource.
   */
  public static final String N_FLAGS = "flags";

  /**
   * Tag in the {@link CmsImportExportManager#EXPORT_MANIFEST} for the "groupdata" node, contains a
   * users group data.
   */
  public static final String N_GROUPDATA = "groupdata";

  /**
   * Tag in the {@link CmsImportExportManager#EXPORT_MANIFEST} for the "groupname" node, contains a
   * groups name.
   */
  public static final String N_GROUPNAME = "groupname";

  /**
   * Tag in the {@link CmsImportExportManager#EXPORT_MANIFEST} for the "id" node, only required for
   * backward compatibility with import version 2.
   */
  public static final String N_ID = "id";

  /**
   * Tag in the {@link CmsImportExportManager#EXPORT_MANIFEST} for the "lastmodified" node, only
   * required for backward compatibility with import version 2.
   */
  public static final String N_LASTMODIFIED = "lastmodified";

  /**
   * Tag in the {@link CmsImportExportManager#EXPORT_MANIFEST} for the "lastname" node, contains a
   * users last name.
   */
  public static final String N_LASTNAME = "lastname";

  /**
   * Tag in the {@link CmsImportExportManager#EXPORT_MANIFEST} for the "name" node, contains a users
   * login name.
   */
  public static final String N_NAME = "name";

  /**
   * Tag in the {@link CmsImportExportManager#EXPORT_MANIFEST} for the "orgunitdatas" node, starts
   * the organizational unit data.
   */
  public static final String N_ORGUNITDATA = "orgunitdata";

  /**
   * Tag in the {@link CmsImportExportManager#EXPORT_MANIFEST} for the "parentgroup" node, contains
   * a groups parent group name.
   */
  public static final String N_PARENTGROUP = "parentgroup";

  /**
   * Tag in the {@link CmsImportExportManager#EXPORT_MANIFEST} for the "password" node, contains a
   * users encrypted password.
   */
  public static final String N_PASSWORD = "password";

  /**
   * Tag in the {@link CmsImportExportManager#EXPORT_MANIFEST} for the "properties" node, starts the
   * list of properties of a VFS resource.
   */
  public static final String N_PROPERTIES = "properties";

  /**
   * Tag in the {@link CmsImportExportManager#EXPORT_MANIFEST} for the "property" node, starts a
   * property for a VFS resource.
   */
  public static final String N_PROPERTY = "property";

  /**
   * Tag in the {@link CmsImportExportManager#EXPORT_MANIFEST} for the "type" property attribute,
   * contains a property type.
   */
  public static final String N_PROPERTY_ATTRIB_TYPE = "type";

  /**
   * Tag in the {@link CmsImportExportManager#EXPORT_MANIFEST} for the "shared" property type
   * attribute value.
   */
  public static final String N_PROPERTY_ATTRIB_TYPE_SHARED = "shared";

  /**
   * Tag in the {@link CmsImportExportManager#EXPORT_MANIFEST} for the "relation" node, starts a
   * relation for a VFS resource.
   */
  public static final String N_RELATION = "relation";

  /**
   * Tag in the {@link CmsImportExportManager#EXPORT_MANIFEST} for the "id" relation attribute,
   * contains the structure id of the target resource of the relation.
   */
  public static final String N_RELATION_ATTRIBUTE_ID = "id";

  /**
   * Tag in the {@link CmsImportExportManager#EXPORT_MANIFEST} for the "path" relation attribute,
   * contains the path to the target resource of the relation.
   */
  public static final String N_RELATION_ATTRIBUTE_PATH = "path";

  /**
   * Tag in the {@link CmsImportExportManager#EXPORT_MANIFEST} for the "type" relation attribute,
   * contains the type of relation.
   */
  public static final String N_RELATION_ATTRIBUTE_TYPE = "type";

  /**
   * Tag in the {@link CmsImportExportManager#EXPORT_MANIFEST} for the "relations" node, starts the
   * list of relations of a VFS resources.
   */
  public static final String N_RELATIONS = "relations";

  /**
   * Tag in the {@link CmsImportExportManager#EXPORT_MANIFEST} for the "source" node, contains the
   * source path of a VFS resource in the import zip (or folder).
   */
  public static final String N_SOURCE = "source";

  /**
   * Tag in the {@link CmsImportExportManager#EXPORT_MANIFEST} for the "address" node, contains a
   * users address.
   */
  public static final String N_TAG_ADDRESS = "address";

  /**
   * Tag in the {@link CmsImportExportManager#EXPORT_MANIFEST} for the "type" node, the resource
   * type name of a VFS resource.
   */
  public static final String N_TYPE = "type";

  /**
   * Tag in the {@link CmsImportExportManager#EXPORT_MANIFEST} for the "user" node, starts the user
   * data.
   */
  public static final String N_USER = "user";

  /**
   * Tag in the {@link CmsImportExportManager#EXPORT_MANIFEST} for the "usercreated" node, contains
   * the name of the user who created the VFS resource.
   */
  public static final String N_USERCREATED = "usercreated";

  /**
   * Tag in the {@link CmsImportExportManager#EXPORT_MANIFEST} for the "userdata" node, starts the
   * list of users.
   */
  public static final String N_USERDATA = "userdata";

  /**
   * Tag in the {@link CmsImportExportManager#EXPORT_MANIFEST} for the "usergroupdatas" node, starts
   * the users group data.
   */
  public static final String N_USERGROUPDATA = "usergroupdata";

  /**
   * Tag in the {@link CmsImportExportManager#EXPORT_MANIFEST} for the "usergroups" node, starts the
   * users group data.
   */
  public static final String N_USERGROUPS = "usergroups";

  /**
   * Tag in the {@link CmsImportExportManager#EXPORT_MANIFEST} for the "userinfo" node, contains the
   * additional user info.
   */
  public static final String N_USERINFO = "userinfo";

  /**
   * Tag in the {@link CmsImportExportManager#EXPORT_MANIFEST} for the "userinfo/entry" node,
   * contains the additional user info entry value.
   */
  public static final String N_USERINFO_ENTRY = "entry";

  /**
   * Tag in the {@link CmsImportExportManager#EXPORT_MANIFEST} for the "userlastmodified" node,
   * contains the name of the user who last modified the VFS resource.
   */
  public static final String N_USERLASTMODIFIED = "userlastmodified";

  /**
   * Tag in the {@link CmsImportExportManager#EXPORT_MANIFEST} for the "uuidresource" node, contains
   * a the resource UUID of a VFS resource.
   */
  public static final String N_UUIDRESOURCE = "uuidresource";

  /**
   * Tag in the {@link CmsImportExportManager#EXPORT_MANIFEST} for the "uuidstructure" node, only
   * required for backward compatibility with import version 2.
   */
  public static final String N_UUIDSTRUCTURE = "uuidstructure";

  /**
   * Tag in the {@link CmsImportExportManager#EXPORT_MANIFEST} for the "value" node, contains the
   * value of a property.
   */
    ...
    try {
      ...
      Document docXml =
          CmsXmlUtils.unmarshalHelper(
              helper.getFileBytes(CmsImportExportManager.EXPORT_MANIFEST), null, false);

      return getVersion()
          == Integer.parseInt(
              ((Element) docXml.selectNodes("//" + CmsImportExportManager.N_VERSION).get(0))
                  .getTextTrim());
    } catch (IOException e) {
      CmsMessageContainer message =
          Messages.get()
              .container(
                  Messages.ERR_IMPORTEXPORT_ERROR_OPENING_ZIP_ARCHIVE_1, parameters.getPath());
    ...
    if (immutableResources.contains(translatedName)) {
      if (LOG.isDebugEnabled()) {
        LOG.debug(
            Messages.get()
                .getBundle()
                .key(Messages.LOG_IMPORTEXPORT_RESOURCENAME_IMMUTABLE_1, translatedName));
      }
      ...
      try {
        ...
        if (LOG.isDebugEnabled()) {
          LOG.debug(
              Messages.get()
                  .getBundle()
                  .key(Messages.LOG_IMPORTEXPORT_IMMUTABLE_FLAG_SET_1, translatedName));
        }
        ...
        if (LOG.isDebugEnabled()) {
          LOG.debug(
              Messages.get()
                  .getBundle()
                  .key(Messages.LOG_IMPORTEXPORT_ERROR_ON_TEST_IMMUTABLE_1, translatedName),
              e);
        }
      } finally {
   ...
   *
   * <p>This is required since there is only one instance for each import version that is kept in
   * memory and reused.
   *
   * <p>
   */
  ...
  protected void convertPointerToSiblings() {
    ...
    try {
      ...
      while (itEntries.hasNext()) {
        ...
        m_report.print(
            Messages.get().container(Messages.RPT_CONVERT_LINK_0), I_CmsReport.FORMAT_NOTE);
        m_report.print(
            org.opencms.report.Messages.get()
                .container(org.opencms.report.Messages.RPT_ARGUMENT_1, key + " "));
        m_report.print(
        ...
        try {
          ...
          if (link.startsWith("/")) {
            ...
            CmsResource resource =
                new CmsResource(
                    ...
                    m_cms
                        .getRequestContext()
                        .getCurrentProject()
                        .getUuid(), // TODO: pass flags from import
            ...
            int pointerId =
                OpenCms.getResourceManager()
                    .getResourceType(CmsResourceTypePointer.getStaticTypeName())
                    .getTypeId();
          ...
          if (LOG.isErrorEnabled()) {
            LOG.error(
                Messages.get()
                    .getBundle()
                    .key(Messages.ERR_IMPORTEXPORT_LINK_CONVERSION_FAILED_2, key, link),
                e);
          }
        }
      }
  ...
  protected byte[] getFileBytes(@RUntainted String filename) {
    ...
    try {
      ...
      if (LOG.isErrorEnabled()) {
        LOG.error(
            Messages.get().getBundle().key(Messages.ERR_IMPORTEXPORT_FILE_NOT_FOUND_1, filename),
            fnfe);
      }
      ...
      if (LOG.isErrorEnabled()) {
        LOG.error(
            Messages.get()
                .getBundle()
                .key(Messages.ERR_IMPORTEXPORT_ERROR_READING_FILE_1, filename),
            ioe);
      }
  ...
  protected Locale getLocale(@RUntainted String destination, List<CmsProperty> properties) {
    ...
    return OpenCms.getLocaleManager()
        .getDefaultLocales(m_cms, CmsResource.getParentFolder(destination))
        .get(0);
  }
  ...
  protected void importAccessControlEntries(
      CmsResource resource, List<CmsAccessControlEntry> aceList) {
  ...
  protected void importGroup(String name, String description, String flags, String parentgroupName)
    ...
    try {
      ...
      if (CmsStringUtil.isNotEmpty(parentgroupName) && (parentGroup == null)) {
        ...
        try {
          m_report.print(
              Messages.get().container(Messages.RPT_IMPORT_GROUP_0), I_CmsReport.FORMAT_NOTE);
          m_report.print(
              org.opencms.report.Messages.get()
          ...
          m_report.println(
              Messages.get().container(Messages.RPT_NOT_CREATED_0), I_CmsReport.FORMAT_OK);
        }
      }
      ...
      CmsMessageContainer message =
          Messages.get().container(Messages.ERR_IMPORTEXPORT_ERROR_IMPORTING_GROUP_1, name);
      if (LOG.isDebugEnabled()) {
        LOG.debug(message.key(), e);
      }
      throw new CmsImportExportException(message, e);
  ...
  protected void importGroups() throws CmsImportExportException {
    ...
    try {
      ...
      CmsMessageContainer message =
          Messages.get().container(Messages.ERR_IMPORTEXPORT_ERROR_IMPORTING_GROUPS_0);
      if (LOG.isDebugEnabled()) {
        LOG.debug(message.key(), e);
      }
  ...
  protected void importUser(
    ...
    try {
      try {
        m_report.print(
            Messages.get().container(Messages.RPT_IMPORT_USER_0), I_CmsReport.FORMAT_NOTE);
        m_report.print(
            org.opencms.report.Messages.get()
                .container(org.opencms.report.Messages.RPT_ARGUMENT_1, name));
        m_report.print(
        ...
        for (int i = 0; i < userGroups.size(); i++) {
          ...
          try {
            ...
            m_report.println(
                Messages.get()
                    .container(Messages.RPT_USER_COULDNT_BE_ADDED_TO_GROUP_2, name, groupName),
                I_CmsReport.FORMAT_WARNING);
            if (LOG.isDebugEnabled()) {
      ...
      CmsMessageContainer message =
          Messages.get().container(Messages.ERR_IMPORTEXPORT_ERROR_IMPORTING_USER_1, name);
      if (LOG.isDebugEnabled()) {
        LOG.debug(message.key(), e);
      }
      throw new CmsImportExportException(message, e);
  ...
  protected void importUsers() throws CmsImportExportException {
    ...
    try {
      ...
      m_report.println(e);
      CmsMessageContainer message =
          Messages.get().container(Messages.ERR_IMPORTEXPORT_ERROR_IMPORTING_USERS_0);
      if (LOG.isDebugEnabled()) {
        LOG.debug(message.key(), e);
      }
      throw new CmsImportExportException(message, e);
  ...
  /**
   * Reads all properties below a specified parent element from the <code>manifest.xml</code>.
   *
   * <p>
   *
   ...
   */
  protected List<CmsProperty> readPropertiesFromManifest(
      Element parentElement, List<String> ignoredPropertyKeys) {
    ...
    List<Node> propertyElements =
        parentElement.selectNodes("./" + A_CmsImport.N_PROPERTIES + "/" + A_CmsImport.N_PROPERTY);
