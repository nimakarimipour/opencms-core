 ...
 *
 * <p>OpenCms supports different import versions, for each version a own import class must be
 * implemented.
 *
 * <p>
 *
...
public interface I_CmsImport {
   ...
   *
   * <ul>
   *   <li>0 indicates an export file without a version number, that is before version 4.3.23 of
   *       OpenCms
   *   <li>1 indicates an export file of OpenCms with a version before 5.0.0
   *   <li>2 indicates an export file of OpenCms with a version before 5.1.2
   *   <li>3 indicates an export file of OpenCms with a version before 5.1.6
   *   <li>4 indicates an export file of OpenCms with a version before 6.3.0
   *   <li>5 indicates an export file of OpenCms with a version before 6.5.6
   *   <li>6 indicates an export file of OpenCms with a version before 7.0.4
   *   <li>7 indicates an export file of OpenCms with a version after 7.0.3
   * </ul>
   *
   ...
   * @param docXml the <code>manifest.xml</code> file which contains the meta information of the
   *     imported files
   * @throws CmsImportExportException if something goes wrong
