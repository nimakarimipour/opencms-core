...
public class CmsCoreService extends CmsGwtService implements I_CmsCoreService {
    ...
    public static List<CmsContextMenuEntryBean> getContextMenuEntries(
        ...
        try {
            final List<@RUntainted CmsResource> resources;
     ...
     */
    public static <T> T instantiate(Class<T> anInterface, @RUntainted String className) throws CmsException {
     ...
     */
    public void saveUserSettings(Map<String, @RUntainted String> userSettings, Set<String> edited) throws CmsRpcException {
     ...
     */
    public void setResourceCategories(@RUntainted CmsUUID structureId, List<@RUntainted String> categories) throws CmsRpcException {
     ...
     */
    private CmsValidationResult validate(@RUntainted String validator, @RUntainted String value, @RUntainted String config) throws Exception {
