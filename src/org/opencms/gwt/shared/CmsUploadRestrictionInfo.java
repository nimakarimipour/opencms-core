...
public class CmsUploadRestrictionInfo implements IsSerializable {
  ...
  public static class Builder {
     ...
     * Adds a new entry.
     *
     * <p>The info string has the format 'key1:value1|key2:value2|....'. Currently the keys 'types'
     * and 'enabled' are supported; 'enabled' (format: 'enabled:true') enables/disables uploads, and
     * 'types' (format: 'types:jpg,png' sets the allowed file extensions.
     *
     * @param path the path
