...
public class CmsListInfoBean extends CmsIconBean implements I_CmsHasTitle, I_CmsHasType {
  ...
  /**
   * Flag to control whether a resource state of 'changed' should be visualized with an overlay
   * icon.
   */
  ...
  /**
   * The state icon information: for the type of state icon which should be displayed. The state
   * icon indicates if a resource is exported, secure etc.
   */
   ...
   *
   * <p>This may not be set (i.e. null).
   *
