 ...
 *
 * <p>This is mainly to simplify the implementation, so we can use the GWT AutoBean mechanism for
 * future additions to the editable data (as long as they're convertible to JSON) and don't have to
 * individually write the attributes to JSON.
 */
