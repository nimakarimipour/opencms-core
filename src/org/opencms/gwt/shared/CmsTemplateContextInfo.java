...
public class CmsTemplateContextInfo implements IsSerializable {
  ...
  private Map<String, Map<String, CmsClientVariantInfo>> m_clientVariantInfo =
      new LinkedHashMap<String, Map<String, CmsClientVariantInfo>>();
  ...
  /**
   * Gets the client variant information for a specific context.
   *
   * <p>
   *
  ...
  /**
   * Checks if client variants for the given context are present.
   *
   * <p>
   *
  ...
  public void setClientVariant(String context, String variant, CmsClientVariantInfo info) {
    ...
    if (!m_clientVariantInfo.containsKey(context)) {
      Map<String, CmsClientVariantInfo> variants =
          new LinkedHashMap<String, CmsClientVariantInfo>();
  ...
  /**
   * Returns true if there is more than one template context to choose from.
   *
   * <p>
   *
