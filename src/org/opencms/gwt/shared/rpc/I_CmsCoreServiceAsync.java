...
public interface I_CmsCoreServiceAsync {
   ...
   * @param callback the async callback
   */
  void getCategoriesForSitePath(
      String sitePath, AsyncCallback<List<CmsCategoryTreeEntry>> callback);
   ...
   *
   * <p>This is executed in a synchronized request.
   *
   * <p>
   *
  ...
  void saveUserSettings(
      Map<String, String> userSettings, Set<String> edited, AsyncCallback<Void> resultCallback);
   ...
   * @param callback the callback which receives the result
   */
  void setResourceCategories(
      CmsUUID structureId, List<String> categories, AsyncCallback<Void> callback);
