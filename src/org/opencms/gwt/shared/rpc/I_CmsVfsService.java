...
public interface I_CmsVfsService extends RemoteService {
  ...
  /**
   * Returns a {@link CmsListInfoBean} for a given resource.
   *
   * <p>
   *
   ...
   * @param context additional context-dependent parameters used for providing additional
   *     information
   ...
   * @throws CmsRpcException if something goes wrong
   */
  Map<String, String> validateAliases(CmsUUID uuid, Map<String, String> aliasPaths)
      throws CmsRpcException;
}
