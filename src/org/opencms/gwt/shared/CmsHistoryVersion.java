 ...
 *
 * <p>Since the history dialog can also display offline resources, or resources read from the Online
 * project without a historical version id, this class is needed rather than a single integer to
 * represent a version.
 *
 * <p>
 */
public class CmsHistoryVersion implements IsSerializable {
   ...
   *
   * <p>This is the inverse of toString().
   *
  ...
  public static CmsHistoryVersion fromString(String s) {
    ...
    if (l.size() == 2) {
      ...
      OfflineOnline onlineStatus =
          "null".equals("" + l.get(1)) ? null : OfflineOnline.valueOf(l.get(1));
