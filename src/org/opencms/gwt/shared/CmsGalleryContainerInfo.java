...
/**
 * Holds information about current container types/sizes for the purpose of filtering gallery search
 * results (currently only for functions).
 */
  ...
  public static class Item implements IsSerializable, Comparable<Item> {
    ...
    public int compareTo(Item other) {
      ...
      return ComparisonChain.start()
          .compare(m_type, other.m_type)
          .compare(m_width, other.m_width)
          .result();
    }
