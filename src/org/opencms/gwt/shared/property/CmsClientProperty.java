...
public class CmsClientProperty implements IsSerializable {
   ...
   * <p>
   */
  public static final Function<String, CmsClientProperty> CREATE_PROPERTY =
      new Function<String, CmsClientProperty>() {
   ...
   */
  public static Map<String, CmsClientProperty> copyProperties(
  ...
  /**
   * Makes a "lazy copy" of a map of properties, which will create properties on lookup if they
   * don't already exist.
   *
   * <p>
   *
   ...
   */
  public static Map<String, CmsClientProperty> makeLazyCopy(
      Map<String, CmsClientProperty> properties) {
   ...
   */
  public static Map<String, CmsClientProperty> toLazyMap(
      Map<String, CmsClientProperty> properties) {
