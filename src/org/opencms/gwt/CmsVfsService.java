...
public class CmsVfsService extends CmsGwtService implements I_CmsVfsService {
   ...
   */
  public static CmsListInfoBean addLockInfo(
      CmsObject cms, CmsResource resource, CmsListInfoBean resourceInfo) throws CmsException {
    ...
    if (!lock.isOwnedBy(cms.getRequestContext().getCurrentUser())) {
      ...
      } else if ((lockType == CmsLockType.SHARED_EXCLUSIVE)
          || (lockType == CmsLockType.SHARED_INHERITED)) {
  ...
  public static @RUntainted String formatDateTime(CmsObject cms, long date) {
    ...
    return CmsDateUtil.getDateTime(
        new Date(date), DateFormat.MEDIUM, OpenCms.getWorkplaceManager().getWorkplaceLocale(cms));
  }
  ...
  public static String getNoPreviewReason(CmsObject cms, CmsResource resource) {
    ...
    if (resource.getState().isDeleted() && !(resource instanceof I_CmsHistoryResource)) {
      ...
      if ((siteRoot != null) && !siteRoot.equals(cms.getRequestContext().getSiteRoot())) {
        noPreviewReason =
            Messages.get().getBundle(locale).key(Messages.GUI_NO_PREVIEW_OTHER_SITE_0);
      } else if (resource.getTypeId() == CmsResourceTypeBinary.getStaticTypeId()) {
        String mimeType =
            OpenCms.getResourceManager().getMimeType(resource.getName(), null, "empty");
        if (!m_previewMimeTypes.contains(mimeType)) {
          noPreviewReason =
              Messages.get().getBundle(locale).key(Messages.GUI_NO_PREVIEW_WRONG_MIME_TYPE_0);
        }
      }
    }
  ...
  /**
   * Returns a bean to display the {@link org.opencms.gwt.client.ui.CmsListItemWidget} including the
   * lock state.
   *
   * <p>
   *
  ...
  /**
   * Processes a file path, which may have macros in it, so it can be opened by the XML content
   * editor.
   *
   * <p>
   *
   ...
   */
  public static @RUntainted String prepareFileNameForEditor(
      CmsObject cms, CmsResource res, @RUntainted String pathWithMacros) {
   ...
   * @throws CmsException if the resource info can not be read
   */
  protected static CmsListInfoBean addPageInfo(
      CmsObject cms, CmsResource resource, CmsListInfoBean listInfo) throws CmsException {
    ...
    listInfo.setBigIconClasses(
        CmsIconUtil.getIconClasses(
            CmsIconUtil.getDisplayType(cms, resource), resource.getName(), false));
  ...
  /**
   * @see org.opencms.gwt.shared.rpc.I_CmsVfsService#createNewExternalLink(java.lang.String,
   *     java.lang.String, java.lang.String, java.lang.String)
   */
  public void createNewExternalLink(
      @RUntainted String title, String link, String resourceName, String parentFolderPath)
  ...
  /**
   * @see org.opencms.gwt.shared.rpc.I_CmsVfsService#getDataViewThumbnail(java.lang.String,
   *     java.lang.String)
   */
  ...
  public Map<CmsUUID, Map<String, CmsXmlContentProperty>> getDefaultProperties(
      List<CmsUUID> structureIds) throws CmsRpcException {
  ...
  /**
   * @see org.opencms.gwt.shared.rpc.I_CmsVfsService#getDetailName(org.opencms.util.CmsUUID,
   *     java.lang.String)
   */
  public String getDetailName(CmsUUID id, @RUntainted String localeStr) throws CmsRpcException {
  ...
  /**
   * @see org.opencms.gwt.shared.rpc.I_CmsVfsService#getHistoryPreviewInfo(org.opencms.util.CmsUUID,
   *     java.lang.String, org.opencms.gwt.shared.CmsHistoryVersion)
   */
  public CmsPreviewInfo getHistoryPreviewInfo(
      CmsUUID structureId, @RUntainted String locale, CmsHistoryVersion versionBean) throws CmsRpcException {
    ...
    try {
      ...
      if (versionBean.getVersionNumber() != null) {
        previewResource =
            (CmsResource)
                (cms.readResource(structureId, versionBean.getVersionNumber().intValue()));
  ...
  /**
   * @see org.opencms.gwt.shared.rpc.I_CmsVfsService#getPreviewInfo(org.opencms.util.CmsUUID,
   *     java.lang.String)
   */
  ...
  /**
   * @see org.opencms.gwt.shared.rpc.I_CmsVfsService#getPreviewInfo(java.lang.String,
   *     java.lang.String)
   */
   ...
   */
  public CmsHistoryResourceCollection getResourceHistory(CmsUUID structureId)
      throws CmsRpcException {
   ...
   */
  public CmsHistoryResourceCollection getResourceHistoryInternal(CmsUUID structureId)
      throws CmsException {
    ...
    if (versions.isEmpty()) {
      try {
        ...
        CmsHistoryResourceBean onlineResBean =
            createHistoryResourceBean(onlineCms, onlineResource, false, 0);
      ...
      for (I_CmsHistoryResource historyRes : versions) {
        CmsHistoryResourceBean historyBean =
            createHistoryResourceBean(cms, (CmsResource) historyRes, false, maxVersion);
   ...
   *     java.lang.String, boolean, org.opencms.util.CmsUUID, java.util.Map)
   */
  ...
  public CmsRestoreInfoBean getRestoreInfo(CmsUUID structureId) throws CmsRpcException {
    ...
    try {
      ...
      CmsResource onlineResource =
          onlineCms.readResource(structureId, CmsResourceFilter.IGNORE_EXPIRATION);
      ...
      boolean canUndoMove =
          offlineRootCms.existsResource(parent, CmsResourceFilter.IGNORE_EXPIRATION);
  ...
  public CmsExternalLinkInfoBean loadLinkInfo(CmsUUID structureId) throws CmsRpcException {
    ...
    try {
      ...
      String link =
          new String(
              linkFile.getContents(), CmsLocaleManager.getResourceEncoding(cms, linkResource));
      info.setLink(link);
  ...
  /**
   * @see
   *     org.opencms.gwt.shared.rpc.I_CmsVfsService#loadQuickLaunchItems(org.opencms.gwt.shared.CmsQuickLaunchParams)
   */
  public List<CmsQuickLaunchData> loadQuickLaunchItems(CmsQuickLaunchParams params)
      throws CmsRpcException {

    try {
      return CmsQuickLaunchProvider.getQuickLaunchData(
          getCmsObject(), getRequest().getSession(), params);
    } catch (Exception e) {
      error(e);
      return null;
    }
  ...
  /**
   * @see org.opencms.gwt.shared.rpc.I_CmsVfsService#prepareEdit(org.opencms.util.CmsUUID,
   *     java.lang.String)
   */
  public CmsPrepareEditResponse prepareEdit(CmsUUID currentPageId, @RUntainted String pathWithMacros)
      throws CmsRpcException {
    ...
    try {
      ...
      if (cms.existsResource(pathWithMacros, CmsResourceFilter.ONLY_VISIBLE_NO_DELETED)) {
        ...
        CmsResource currentPage =
            cms.readResource(currentPageId, CmsResourceFilter.IGNORE_EXPIRATION);
  ...
  /**
   * @see org.opencms.gwt.shared.rpc.I_CmsVfsService#renameResource(org.opencms.util.CmsUUID,
   *     java.lang.String)
   */
  ...
  /**
   * @see org.opencms.gwt.shared.rpc.I_CmsVfsService#saveAliases(org.opencms.util.CmsUUID,
   *     java.util.List)
   */
  public void saveAliases(CmsUUID structureId, List<CmsAliasBean> aliasBeans)
      throws CmsRpcException {
  ...
  /**
   * @see org.opencms.gwt.shared.rpc.I_CmsVfsService#saveExternalLink(org.opencms.util.CmsUUID,
   *     java.lang.String, java.lang.String, java.lang.String)
   */
  public void saveExternalLink(CmsUUID structureId, @RUntainted String title, String link, String fileName)
    ...
    try {
      ...
      String oldLink =
          new String(file.getContents(), CmsLocaleManager.getResourceEncoding(cms, res));
      if (!oldLink.equals(link)) {
        file.setContents(link.getBytes(CmsLocaleManager.getResourceEncoding(cms, res)));
        cms.writeFile(file);
      }
      CmsProperty titleProp =
          cms.readPropertyObject(res, CmsPropertyDefinition.PROPERTY_TITLE, false);
  ...
  /**
   * @see
   *     org.opencms.gwt.shared.rpc.I_CmsVfsService#saveProperties(org.opencms.gwt.shared.property.CmsPropertyChangeSet,
   *     boolean)
   */
  public void saveProperties(CmsPropertyChangeSet changes, boolean updateIndex)
      throws CmsRpcException {
  ...
  /**
   * @see org.opencms.gwt.shared.rpc.I_CmsVfsService#substituteLinkForRootPath(java.lang.String,
   *     java.lang.String)
   */
  public String substituteLinkForRootPath(@RUntainted String currentSiteRoot, String rootPath)
      throws CmsRpcException {
  ...
  public void undoChanges(CmsUUID structureId, boolean undoMove) throws CmsRpcException {
    ...
    try {
      ...
      CmsResourceUndoMode mode =
          undoMove ? CmsResource.UNDO_MOVE_CONTENT : CmsResource.UNDO_CONTENT;
  ...
  /**
   * @see org.opencms.gwt.shared.rpc.I_CmsVfsService#validateAliases(org.opencms.util.CmsUUID,
   *     java.util.Map)
   */
  public Map<String, String> validateAliases(CmsUUID uuid, Map<String, String> aliasPaths)
      throws CmsRpcException {
  ...
  protected CmsBrokenLinkBean createSitemapBrokenLinkBean(CmsResource resource)
    ...
    CmsBrokenLinkBean result =
        new CmsBrokenLinkBean(resource.getStructureId(), title, subtitle, typeName, icon);
  ...
  protected CmsVfsEntryBean makeEntryBean(CmsResource resource, boolean root) throws CmsException {
    ...
    if (isFolder) {
      List<CmsResource> children =
          cms.getResourcesInFolder(
              cms.getRequestContext().getSitePath(resource), CmsResourceFilter.DEFAULT);
      if (!children.isEmpty()) {
        hasChildren = true;
      }
    }
  ...
  /**
   * Helper method for creating a list of VFS entry beans from a list of the corresponding
   * resources.
   *
   * <p>
   *
   ...
   */
  private void addBrokenLinkAdditionalInfo(
      CmsObject cms, CmsResource resource, CmsBrokenLinkBean result) {

    String dateLastModifiedLabel =
        org.opencms.workplace.commons.Messages.get()
            .getBundle(OpenCms.getWorkplaceManager().getWorkplaceLocale(cms))
            .key(org.opencms.workplace.commons.Messages.GUI_LABEL_DATE_LAST_MODIFIED_0);
    String dateLastModified = CmsVfsService.formatDateTime(cms, resource.getDateLastModified());

    String userLastModifiedLabel =
        org.opencms.workplace.commons.Messages.get()
            .getBundle(OpenCms.getWorkplaceManager().getWorkplaceLocale(cms))
            .key(org.opencms.workplace.commons.Messages.GUI_LABEL_USER_LAST_MODIFIED_0);
  ...
  private CmsHistoryResourceBean createHistoryResourceBean(
      CmsObject cms, CmsResource historyRes, boolean offline, int maxVersion) throws CmsException {
    ...
    if (historyRes instanceof I_CmsHistoryResource) {
      ...
      List<CmsProperty> historyProperties =
          cms.readHistoryPropertyObjects((I_CmsHistoryResource) historyRes);
      Map<String, CmsProperty> historyPropertyMap = CmsProperty.toObjectMap(historyProperties);
      CmsProperty titleProp =
          CmsProperty.wrapIfNull(historyPropertyMap.get(CmsPropertyDefinition.PROPERTY_TITLE));
      CmsProperty descProp =
  ...
  private void deleteResource(CmsResource resource) throws CmsException {
    ...
    try {
      ...
      List<CmsResource> detailContainers =
          CmsDetailOnlyContainerUtil.getDetailOnlyResources(cms, resource);
  ...
  /**
   * Returns the available locales mapped to there display name for the given resource or <code>null
   * </code> in case of non xml-content/xml-page resources.
   *
   * <p>
   *
   * @param resource the resource
  ...
  private LinkedHashMap<String, String> getAvailableLocales(CmsResource resource) {
    ...
    try {
      if (CmsResourceTypeXmlPage.isXmlPage(resource)) {
        ...
        locales =
            CmsXmlContentFactory.unmarshal(getCmsObject(), resource, getRequest()).getLocales();
  ...
  /**
   * Helper method for converting a map which maps resources to resources to a list of "broken link"
   * beans, which have beans representing the source of the corresponding link as children.
   *
   * <p>
   *
   ...
   * @throws CmsException if something goes wrong
   */
  private List<CmsBrokenLinkBean> getBrokenLinkBeans(Multimap<CmsResource, CmsResource> linkMap)
      throws CmsException {
    ...
    for (CmsResource source : linkMap.keySet()) {
      ...
      for (CmsResource target : linkMap.get(source)) {
        ...
        List<CmsBrokenLinkBean> brokenLinkBeans =
            brokenLinkRenderer.renderBrokenLink(target, source);
  ...
  private CmsDeleteResourceBean getBrokenLinks(CmsResource entryResource) throws CmsException {
    ...
    for (CmsResource resource : descendants) {
      List<CmsRelation> relations =
          cms.getRelationsForResource(resource, CmsRelationFilter.SOURCES);
  ...
  private List<CmsResource> getLinkSources(
      CmsObject cms, CmsResource resource, HashSet<CmsUUID> deleteIds) throws CmsException {
  ...
  private CmsPreviewInfo getPreviewInfo(CmsObject cms, CmsResource resource, Locale locale) {
    ...
    try {
      CmsProperty titleProperty =
          cms.readPropertyObject(resource, CmsPropertyDefinition.PROPERTY_TITLE, false);
    ...
    if (noPreviewReason != null) {
      ...
      return new CmsPreviewInfo(
          ...
          locale.toString());
    } else if (OpenCms.getResourceManager()
        .matchResourceType(CmsResourceTypeImage.getStaticTypeName(), resource.getTypeId())) {
            ...
            OpenCms.getLinkManager()
                .substituteLinkForUnknownTarget(
                    ...
                    CmsHistoryListUtil.getHistoryLink(
                        cms, resource.getStructureId(), "" + version));
      } else {
        imageLink =
      ...
      previewContent =
          "<img src=\"" + imageLink + "\" title=\"" + title + "\" style=\"display:block\" />";
      ...
      return new CmsPreviewInfo(
          null, link, true, null, cms.getSitePath(resource), locale.toString());
      ...
      previewContent =
          CmsPreviewService.getPreviewContent(getRequest(), getResponse(), cms, resource, locale);

    } else if (CmsResourceTypePlain.getStaticTypeId() == resource.getTypeId()) {
      try {
        previewContent =
            "<pre><code>" + new String(cms.readFile(resource).getContents()) + "</code></pre>";
      } catch (CmsException e) {
        LOG.warn(e.getLocalizedMessage(), e);
        previewContent =
            "<div>"
                + Messages.get()
                    .getBundle(OpenCms.getWorkplaceManager().getWorkplaceLocale(cms))
                    .key(Messages.GUI_NO_PREVIEW_CAN_T_READ_CONTENT_0)
                + "</div>";
      }
    }
    if (CmsStringUtil.isNotEmptyOrWhitespaceOnly(previewContent)) {
      CmsPreviewInfo result =
          new CmsPreviewInfo(
              previewContent, null, false, title, cms.getSitePath(resource), locale.toString());
  ...
  private boolean isBinary(CmsResource resource) {
    ...
    return OpenCms.getResourceManager()
        .matchResourceType(CmsResourceTypeBinary.getStaticTypeName(), resource.getTypeId());
  }
  ...
  private boolean isContainerOrXmlPage(CmsResource resource) {
    ...
    return CmsResourceTypeXmlContainerPage.isContainerPage(resource)
