...
public class CmsClientUserSettingConverter {
     ...
     */
    public void saveSettings(Map<String, @RUntainted String> settings) throws Exception {
     ...
     * @throws Exception if something goes wrong
     */
    private void saveSetting(String key, @RUntainted String value) throws Exception {
