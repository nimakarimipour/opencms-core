...
public class CmsGwtService extends RemoteServiceServlet {
   ...
   *
   * <p>Note that the current request and response are not available yet.
   *
  ...
  /**
   * @see
   *     com.google.gwt.user.server.rpc.AbstractRemoteServiceServlet#doUnexpectedFailure(java.lang.Throwable)
   */
  @Override
