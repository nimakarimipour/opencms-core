 ...
 *
 * <p>These settings control whether a browser-based pop-up dialog should be used for
 * authentication, or of the user should be redirected to an OpenCms URI for a form-based
 * authentication.
 *
 * <p>Since the URI for the form-based authentication is a system wide setting, users are able to
 * specify different authentication forms in a property "login-form" on resources that require
 * authentication.
 *
 * <p>
 *
...
public class CmsHttpAuthenticationSettings {
  ...
  public static final String DEFAULT_AUTHENTICATION_URI =
      CmsWorkplace.VFS_PATH_WORKPLACE + "action/authenticate.html";
   ...
   *
   * @return "BASIC" in case of browser based basic authentication, "FORM" in case of form based
   *     authentication or the alternative mechanism or <code>null</code> if unused.
   */
  ...
  /**
   * Returns the URI of the system wide login form if browser-based HTTP basic authentication is
   * disabled.
   *
   * <p>
   *
   * @return the URI of the system wide login form if browser-based HTTP basic authentication is
   *     disabled
   */
  ...
  /**
   * Sets the URI of the system wide login form if browser-based HTTP basic authentication is
   * disabled.
   *
   * <p>
   *
   * @param uri the URI of the system wide login form if browser-based HTTP basic authentication is
   *     disabled to set
   */
   ...
   * <p>
   *
   * @param value a boolean value to specifiy if browser-based HTTP basic authentication should be
   *     enabled
   */
   ...
   * <p>
   *
   * @param value a string {<code>"true"</code>|<code>"false"</code>} to specify if browser-based
   *     HTTP basic authentication should be enabled; if another string is provided, the flag for
   *     browser based basic authentication is disabled and the value is stored as authentication
   *     mechanism.
   */
