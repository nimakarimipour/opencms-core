...
public interface I_CmsShellCommands {
   ...
   *
   * <p>Please note: This method is not guaranteed to be called. For a shell that has more then one
   * shell command object initialized, only the exit method of one of thouse will be called.
   *
   * <p>
   */
  void shellExit();
   ...
   *
   * <p>Please note: This method is not guaranteed to be called. For a shell that has more then one
   * shell command object initialized, only the start method of one of thouse will be called.
   *
   * <p>
   */
  void shellStart();
