...
public abstract class A_CmsAuthorizationHandler implements I_CmsAuthorizationHandler {
     ...
     */
    protected @RUntainted CmsObject initCmsObjectFromSession(HttpServletRequest request) throws CmsException {
     ...
     * @throws CmsException if something goes wrong
     */
    protected @RUntainted CmsObject registerSession(HttpServletRequest request, @RUntainted CmsObject cms) throws CmsException {
