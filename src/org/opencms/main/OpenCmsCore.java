...
public final class OpenCmsCore {
     ...
     */
    protected @RUntainted CmsObject initCmsObject(HttpServletRequest req, HttpServletResponse res, boolean allowPrivilegedLogin)
    throws IOException, CmsException {
        ...
        if (allowPrivilegedLogin) {
            ...
            I_CmsAuthorizationHandler.I_PrivilegedLoginAction loginAction = new I_CmsAuthorizationHandler.I_PrivilegedLoginAction() {
                 ...
                 */
                public @RUntainted CmsObject doLogin(HttpServletRequest request, String principal) throws CmsException {
     ...
     */
    protected @RUntainted CmsObject initCmsObject(String user) throws CmsException {
     ...
     * @throws CmsException if something goes wrong
     */
    protected @RUntainted CmsObject initCmsObjectFromSession(HttpServletRequest req) throws CmsException {
     ...
     * @throws CmsException if something goes wrong
     */
    protected @RUntainted CmsObject updateContext(HttpServletRequest request, CmsObject cms) throws CmsException {
