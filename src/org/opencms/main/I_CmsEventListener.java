 ...
 *
 * <p>In order to receive system events, your class must register with the OpenCms event mechanism.
 * This can be done in the constructor of a class like this:
 *
 * <pre>
...
public interface I_CmsEventListener {
   ...
   *
   * <ul>
   *   <li><code>{@link #KEY_REPORT}</code>: a <code>{@link org.opencms.report.I_CmsReport}</code>
   *       to print output messages to
   *   <li><code>{@link #KEY_PUBLISHLIST}</code>: a <code>{@link org.opencms.db.CmsPublishList}
   *       </code> that contains the resources that are to be published
   *   <li><code>{@link #KEY_PROJECTID}</code>: the ID of the project that is to be published
   *   <li><code>{@link #KEY_DBCONTEXT}</code>: the current users database context
   * </ul>
   *
   ...
   *
   * <p>Not thrown by the core classes, but might be used in modules.
   */
   ...
   *
   * <p>This is thrown on the "FlexCache Administration" page if you press one ot the "Clear cache"
   * buttons, or if you use the <code>_flex=clearcache</code> request parameter.
   */
  int EVENT_FLEX_CACHE_CLEAR = 9;

  /**
   * Event "delete all JSP pages in the "real" file system (so they will be rebuild next time the
   * JSP is requested)".
   *
   * <p>This is thrown on the "FlexCache Administration" page if you press the button "Purge JSP
   * repository", or if you use the <code>_flex=purge</code> request parameter.
   */
   ...
   *
   * <p>This is thrown in {@link org.opencms.staticexport.CmsStaticExportManager}.
   *
   * <p>Event data:
   *
   * <ul>
   *   <li>key "purge": the boolean value to purge the export folders first
   *   <li><code>{@link #KEY_REPORT}</code>: a <code>{@link org.opencms.report.I_CmsReport}</code>
   *       to print output messages to
   * </ul>
   */
   ...
   *
   * <p>Includes create, write and delete group.
   *
   * <p>Event data:
   *
   * <ul>
   *   <li>key "id": the uuid of the modified group
   *   <li>key "groupname": the name of the modified group
   *   <li>key "useraction": the name of the action to do on the replicated server
   *       <ul>
   *         <li>createGroup
   *         <li>writeGroup
   *         <li>deleteGroup
   ...
   *
   * <ul>
   *   <li>key "data" (mandatory): the user who was logged in
   * </ul>
   *
   ...
   * Event "ou modified".
   *
   * <p>Includes create OU and delete OU.
   *
   * <p>Event data:
   *
   * <ul>
   *   <li>key "id": the uuid of the modified ou
   *   <li>key "ouname": the name of the modified ou
   *   <li>key "useraction": the name of the action to do on the replicated server
   *       <ul>
   *         <li>createOu
   *         <li>deleteOu
  ...
  /**
   * Event "a project was modified" (e.g. a project has been deleted, or the project resources have
   * been changed).
   *
   * <p>Event data:
   *
   * <ul>
   *   <li>key "project" (mandatory): the deleted CmsProject
   * </ul>
   */
   ...
   *
   * <ul>
   *   <li>key "propertyDefinition" (mandatory): the modified property definition
   * </ul>
   */
   ...
   *
   * <ul>
   *   <li>key "resource" (mandatory): the CmsResource that has the modified property attached
   *   <li>key "property" (mandatory): the modified property
   * </ul>
   */
   ...
   *   <li><code>{@link #KEY_REPORT}</code>: a <code>{@link org.opencms.report.I_CmsReport}</code>
   *       to print output messages to
   *   <li><code>{@link #KEY_PUBLISHID}</code>: the ID of the publish task in the publish history
   *   <li><code>{@link #KEY_PROJECTID}</code>: the ID of the project that has been published
   *   <li><code>{@link #KEY_DBCONTEXT}</code>: the current users database context
   * </ul>
   *
   * @see org.opencms.publish.CmsPublishManager#publishProject(org.opencms.file.CmsObject)
   ...
   *   <li><code>{@link #KEY_REPORT}</code>: a <code>{@link org.opencms.report.I_CmsReport}</code>
   *       to print output messages to
   *   <li><code>{@link #KEY_INDEX_NAMES}</code>: a comma separated list of names of the search
   *       indexes to rebuild, empty for all indexes
   * </ul>
   */
  int EVENT_REBUILD_SEARCHINDEXES = 32;

  /**
   * Event "reindex" in the online project.
   *
   * <p>Note we split offline/online in two events since only for the online project, the event has
   * to be forwarded in a cluster.
   *
   * <p>Event data:
   *
   * <ul>
   *   <li><code>{@link #KEY_RESOURCES}</code>: a list of {@link org.opencms.file.CmsResource}.
   *   <li><code>{@link #KEY_REPORT}</code>: a <code>{@link org.opencms.report.I_CmsReport}</code>
   *       to print output messages to
   *   <li><code>{@link #KEY_USER_ID}</code>: id of the user triggering the action. Used to show a
   *       message on success/failure.
   *   <li><code>{@link #KEY_REINDEX_RELATED}</code>: flag, indicating if related resources should
   *       be reindexed as well.
   * </ul>
   */
  int EVENT_REINDEX_ONLINE = 34;

  /**
   * Event "reindex" in an offline project.
   *
   * <p>Note we split offline/online in two events since only for the online project, the event has
   * to be forwarded in a cluster.
   *
   ...
   * <ul>
   *   <li><code>{@link #KEY_RESOURCES}</code>: a list of {@link org.opencms.file.CmsResource}.
   *   <li><code>{@link #KEY_PROJECTID}</code>: the id of the project re-indexing is triggered in.
   *   <li><code>{@link #KEY_REPORT}</code>: a <code>{@link org.opencms.report.I_CmsReport}</code>
   *       to print output messages to
   *   <li><code>{@link #KEY_USER_ID}</code>: id of the user triggering the action. Used to show a
   *       message on success/failure.
   ...
   *
   * <ul>
   *   <li>key "resource" (mandatory): the CmsResource that has the modified properties attached
   * </ul>
   */
   ...
   *
   * <ul>
   *   <li>key "resource" (mandatory): the modified CmsResource
   * </ul>
   */
   ...
   *
   * <ul>
   *   <li>key "resources" (mandatory): a List of modified CmsResources
   * </ul>
   */
   ...
   *
   * <ul>
   *   <li>key "resources" (mandatory): a List of modified sitemap entries identified by their root
   *       path
   * </ul>
   */
   ...
   *
   * <p>This event updates all export points, deletes the content of the "export" folder, purges the
   * JSP repository, and clears all caches.
   *
   * <p>This event is for internal use.
   *
   * <p>
   */
   ...
   *
   * <ul>
   *   <li>key "id": the uuid of the modified user
   *   <li>key "username": the name of the modified user
   *   <li>key "groupname": the name of the group which is effected
   *   <li>key "useraction": the name of the action to do on the replicated server
   *       <ul>
   *         <li>createUser
   *         <li>writeUser
  ...
  /**
   * Key name for passing a change int in the data map - see the <code>CHANGED_XXX</code> constants
   * in {@link org.opencms.db.CmsDriverManager}.
   */
  ...
  /**
   * Key name for passing a flag, indicating if related resources should be taken into account in
   * the data map.
   */
  ...
  /**
   * Acknowledge the occurrence of the specified event, implement this method to check for CmsEvents
   * in your class.
   *
