 ...
 * exeption is thrown, all other implementations of I_CmsResourceInit will not be executed.
 *
 * <p>
 *
 * @since 6.0.0
...
public class CmsResourceInitException extends CmsException {
  ...
  /**
   * If this method returns true, the {@link OpenCmsCore#initResource(org.opencms.file.CmsObject,
   * String, javax.servlet.http.HttpServletRequest, javax.servlet.http.HttpServletResponse)} method
   * should just return null instead of throwing an exception.
   *
   * <p>
   *
  ...
  /**
   * Sets the 'clear errors' flag, which causes the resource init method catching this exception to
   * return null of throwing an exception. This can be useful if you want to redirect inside a
   * resource init handler.
   *
   * <p>
   *
