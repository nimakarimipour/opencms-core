...
public interface I_CmsResourceInit {
     ...
     */
    @RUntainted CmsResource initResource(@RUntainted CmsResource resource, @RUntainted CmsObject cms, @RUntainted HttpServletRequest req, @RUntainted HttpServletResponse res)
