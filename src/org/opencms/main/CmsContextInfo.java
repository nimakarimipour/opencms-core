...
public class CmsContextInfo implements Serializable {
  ...
  public static final String ATTRIBUTE_REQUEST_TIME =
      "__org.opencms.main.CmsContextInfo#m_requestTime";
   ...
   * <dl>
   *   <dt>User name
   *   <dd>(configured default guest user)
   *   <dt>Project name
   *   <dd>Online
   *   <dt>Requested URI
   *   <dd>/
   ...
   *   <dd>/
   *   <dt>Locale name
   *   <dd>(configured default locale name)
   *   <dt>Encoding
   *   <dd>(configured default system encoding)
   *   <dt>Remote address
   *   <dd>127.0.0.1
   *   <dt>Organizational unit
   *   <dd>/
   * </dl>
   *
   * <p>
   ...
   * @param isForceAbsoluteLinks a flag indicating whether links to the current site should be
   *     generated with a server prefix
   */
  public CmsContextInfo(
      CmsUser user,
      CmsProject project,
  ...
  /**
   * Creates a new instance, initializing the user name as provided and all other vaiables with the
   * same default values as in {@link #CmsContextInfo()}.
   *
   * <p>
   *
   ...
   *
   * <p>After this entry has been frozen, any attempt to change the configuration of this context
   * info with one of the "set..." methods will lead to a <code>RuntimeException</code>.
   *
   * <p>
   */
  public void freeze() {
  ...
  /**
   * Returns the project, or <code>null</code> if the project has not been configured.
   *
   * <p>If the project has not been configured, at last the project name will be available.
   *
   * <p>
   *
   * @return the project
  ...
  /**
   * Returns the user, or <code>null</code> if the user has not been configured.
   *
   * <p>If the user has not been configured, at last the user name will be available.
   *
   * <p>
   *
   * @return the user
   ...
   *
   * @param isForceAbsoluteLinks true if links to the current site should be generated with a server
   *     prefix
   */
   ...
   * Sets the locale.
   *
   * <p>Setting the locale name will override the currently selected locale and vice-versa. The
   * locale name and the locale will always match.
   *
   * <p>
   *
  ...
  /**
   * Sets the matcher for the current request, that is the host part of the URI from the original
   * http request.
   *
   * <p>
   *
