...
public class CmsEvent {
    ...
    private @RUntainted Map<@RUntainted String, @RUntainted Object> m_data;
     ...
     * @see I_CmsEventListener
     */
    public CmsEvent(@RUntainted int type, @RUntainted Map<@RUntainted String, @RUntainted Object> data) {
