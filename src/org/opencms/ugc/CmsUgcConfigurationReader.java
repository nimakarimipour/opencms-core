...
public class CmsUgcConfigurationReader {
    ...
    if (stringValue == null) {
      ...
      try {
        ...
        throw new NumberFormatException(
            "Could not read a number from " + path + " ,value= " + stringValue);
      }
    }
  }

  /**
   * Reads the XML content value for a given xpath.
   *
   * <p>Returns null if no value was found at that path.
   *
   * <p>
   *
  ...
  /**
   * Converts an optional long value to an optional integer value.
   *
   * <p>
   *
