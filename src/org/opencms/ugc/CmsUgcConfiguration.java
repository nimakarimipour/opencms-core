...
public class CmsUgcConfiguration {
   ...
   * @param userForGuests the user to use for VFS operations caused by guests who submit the XML
   *     content form
   * @param projectGroup the group to be used as the manager group for projects based on this
   *     configuration
   ...
   * Gets the id.
   *
   * <p>The id is a UUID that should uniquely identify this configuration.
   *
   * <p>
   *
  ...
  /**
   * Returns the group which should be used as the manager groups for projects based on this
   * configuration.
   *
   * <p>
   *
  ...
  /**
   * Returns the user which should be used for VFS operations when guests submit the XML content
   * form.
   *
   * <p>
   *
