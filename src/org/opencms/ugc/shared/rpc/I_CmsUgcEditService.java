...
public interface I_CmsUgcEditService extends RemoteService {
   ...
   * @throws CmsRpcException if something goes wrong
   */
  Map<String, String> saveContent(CmsUUID sessionId, Map<String, String> contentValues)
   ...
   */
  Map<String, String> validateContent(CmsUUID sessionId, Map<String, String> contentValues)
