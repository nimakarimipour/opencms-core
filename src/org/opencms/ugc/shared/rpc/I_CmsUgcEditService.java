...
public interface I_CmsUgcEditService extends RemoteService {
     ...
     * @throws CmsRpcException if something goes wrong
     */
    Map<String, @RUntainted String> saveContent(CmsUUID sessionId, Map<String, @RUntainted String> contentValues) throws CmsRpcException;
     ...
     */
    Map<String, @RUntainted String> validateContent(CmsUUID sessionId, Map<String, @RUntainted String> contentValues) throws CmsUgcException;
