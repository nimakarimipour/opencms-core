...
public class CmsUgcEditService extends CmsGwtService implements I_CmsUgcEditService {
     ...
     */
    public Map<String, @RUntainted String> saveContent(CmsUUID sessionId, Map<String, @RUntainted String> contentValues)
     ...
     */
    public Map<String, @RUntainted String> validateContent(CmsUUID sessionId, Map<String, @RUntainted String> contentValues)
    throws CmsUgcException {
