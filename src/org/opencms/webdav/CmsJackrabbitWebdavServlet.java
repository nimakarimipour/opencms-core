...
public class CmsJackrabbitWebdavServlet extends AbstractWebdavServlet {
  ...
  public void init(ServletConfig config) throws ServletException {
    ...
    A_CmsRepository repository =
        OpenCms.getRepositoryManager().getRepository(repName, A_CmsRepository.class);
  ...
  /**
   * @see
   *     org.apache.jackrabbit.webdav.server.AbstractWebdavServlet#setDavSessionProvider(org.apache.jackrabbit.webdav.DavSessionProvider)
   */
  @Override
  ...
  /**
   * @see
   *     org.apache.jackrabbit.webdav.server.AbstractWebdavServlet#setLocatorFactory(org.apache.jackrabbit.webdav.DavLocatorFactory)
   */
  @Override
  ...
  /**
   * @see
   *     org.apache.jackrabbit.webdav.server.AbstractWebdavServlet#setResourceFactory(org.apache.jackrabbit.webdav.DavResourceFactory)
   */
  @Override
  ...
  /**
   * @see
   *     org.apache.jackrabbit.webdav.server.AbstractWebdavServlet#getInputContext(org.apache.jackrabbit.webdav.DavServletRequest,
   *     java.io.InputStream)
   */
  @Override
  ...
  /**
   * @see
   *     org.apache.jackrabbit.webdav.server.AbstractWebdavServlet#isPreconditionValid(org.apache.jackrabbit.webdav.WebdavRequest,
  ...
  /**
   * @see
   *     org.apache.jackrabbit.webdav.server.AbstractWebdavServlet#service(javax.servlet.http.HttpServletRequest,
  ...
  protected void service(HttpServletRequest request, HttpServletResponse response)
    ...
    if (Boolean.parseBoolean(
        m_repository.getConfiguration().getString("failOnRangeHeader", "false"))) {
      // The MacOS WebDav client uses range requests and seems to assume they work even if the
      // server sends a HTTP status of 200
      // in response (rather than 206 Partial Content). This can cause big files to be corrupted. To
      // prevent this,
