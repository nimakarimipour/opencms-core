 ...
 *
 * <p>The memory monitor also provides all kind of caches used in the OpenCms core.
 *
 * <p>
 *
 * @since 6.0.0
...
public class CmsMemoryMonitor implements I_CmsScheduledJob {
  ...
  public CmsMemoryMonitor() {
    ...
    LoadingCache<ResourceOUCacheKey, ResourceOUMap> resourceOUCache =
        CacheBuilder.newBuilder()
            .expireAfterWrite(60, TimeUnit.SECONDS)
            .build(
                new CacheLoader<ResourceOUCacheKey, ResourceOUMap>() {
   ...
   *
   * <p>Use this instead of synchronized maps for better performance.
   *
   * <p>
   *
  ...
  public static <T, V> Map<T, V> createLRUCacheMap(int capacity) {
    ...
    CacheBuilder<?, ?> builder =
        CacheBuilder.newBuilder().concurrencyLevel(CONCURRENCY_LEVEL).maximumSize(capacity);
    return (Map<T, V>) (builder.build().asMap());
  }

  /**
   * Returns the size of objects that are instances of <code>byte[]</code>, <code>String</code>,
   * <code>CmsFile</code>,<code>I_CmsLruCacheObject</code>.
   *
   * <p>For other objects, a size of 0 is returned.
   *
   * @param obj the object
   * @return the size of the object
   */
  public static @RUntainted int getMemorySize(@RUntainted Object obj) {
  ...
  public static @RUntainted long getValueSize(List<?> listValue, int depth) {
    ...
    try {
      ...
      for (int i = 0, s = values.length; i < s; i++) {
        ...
        @RUntainted Object obj = values[i];
   ...
   */
  public static @RUntainted long getValueSize(@RUntainted Object obj) {
   ...
   *
   * <p>The lock is cached by it resource's root path.
   *
   * <p>
   *
  ...
  public void cachePermission(
      String key, I_CmsPermissionHandler.CmsPermissionCheckResult permission) {
   ...
   */
  public void cachePublishedResources(
      String cacheKey, List<CmsPublishedResource> publishedResources) {
  ...
  /**
   * Returns the ACL cached with the given cache key or <code>null</code> if not found.
   *
   * <p>
   *
  ...
  /**
   * Returns the xml content definition cached with the given cache key or <code>null</code> if not
   * found.
   *
   * <p>
   *
  ...
  /**
   * Returns the locale cached with the given cache key or <code>null</code> if not found.
   *
   * <p>
   *
   * @param key the cache key to look for
  ...
  /**
   * Returns the lock cached with the given root path or <code>null</code> if not found.
   *
   * <p>
   *
  ...
  /**
   * Returns the memory object cached with the given cache key or <code>null</code> if not found.
   *
   * <p>
   *
   * @param key the cache key to look for
  ...
  /**
   * Returns the organizational unit cached with the given cache key or <code>null</code> if not
   * found.
   *
   * <p>
   *
  ...
  /**
   * Returns the permission check result cached with the given cache key or <code>null</code> if not
   * found.
   *
   * <p>
   *
  ...
  /**
   * Returns the project cached with the given cache key or <code>null</code> if not found.
   *
   * <p>
   *
  ...
  /**
   * Returns the project resources list cached with the given cache key or <code>null</code> if not
   * found.
   *
   * <p>
   *
  ...
  /**
   * Returns the published resources list cached with the given cache key or <code>null</code> if
   * not found.
   *
   * <p>
   *
  ...
  /**
   * Returns the publish job with the given cache key or <code>null</code> if not found.
   *
   * <p>
   *
   * @param key the cache key to look for
  ...
  /**
   * Returns the publish job from the history with the given cache key or <code>null</code> if not
   * found.
   *
   * <p>
   *
  ...
  /**
   * Returns the resource cached with the given cache key or <code>null</code> if not found.
   *
   * <p>
   *
   * @param key the cache key to look for
  ...
  /**
   * Returns the resource list cached with the given cache key or <code>null</code> if not found.
   *
   * <p>
   *
   * @param key the cache key to look for
  ...
  /**
   * Returns the value cached with the given cache key or <code>null</code> if not found.
   *
   * <p>
   *
   * @param key the cache key to look for
  ...
  /**
   * Returns the user cached with the given cache key or <code>null</code> if not found.
   *
   * <p>
   *
  ...
  /**
   * Returns the user groups list cached with the given cache key or <code>null</code> if not found.
   *
   * <p>
   *
  ...
  /**
   * Returns the user list cached with the given cache key or <code>null</code> if not found.
   *
   * <p>
   *
   * @param key the cache key to look for
  ...
  /**
   * Returns the vfs object cached with the given cache key or <code>null</code> if not found.
   *
   * <p>
   *
   * @param key the cache key to look for
  ...
  /**
   * Returns the xml permanent entity content cached with the given systemId or <code>null</code> if
   * not found.
   *
   * <p>
   *
  ...
  /**
   * Returns the xml temporary entity content cached with the given cache key or <code>null</code>
   * if not found.
   *
   * <p>
   *
  ...
  public void initialize(CmsSystemConfiguration configuration) {
    ...
    if (CmsLog.INIT.isInfoEnabled()) {
      CmsLog.INIT.info(
          Messages.get()
              .getBundle()
              .key(Messages.LOG_MM_INTERVAL_LOG_1, new Integer(m_intervalLog / 1000)));
      CmsLog.INIT.info(
          Messages.get()
              .getBundle()
              .key(Messages.LOG_MM_INTERVAL_EMAIL_1, new Integer(m_intervalEmail / 1000)));
      CmsLog.INIT.info(
          Messages.get()
              .getBundle()
              .key(Messages.LOG_MM_INTERVAL_WARNING_1, new Integer(m_intervalWarning / 1000)));
      CmsLog.INIT.info(
          Messages.get()
              .getBundle()
              .key(Messages.LOG_MM_INTERVAL_MAX_USAGE_1, new Integer(m_maxUsagePercent)));

      if ((m_configuration.getEmailReceiver() == null)
          || (m_configuration.getEmailSender() == null)) {
        CmsLog.INIT.info(Messages.get().getBundle().key(Messages.LOG_MM_EMAIL_DISABLED_0));
      } else {
        CmsLog.INIT.info(
            Messages.get()
                .getBundle()
                .key(Messages.LOG_MM_EMAIL_SENDER_1, m_configuration.getEmailSender()));
        ...
        while (i.hasNext()) {
          CmsLog.INIT.info(
              Messages.get()
                  .getBundle()
                  .key(Messages.LOG_MM_EMAIL_RECEIVER_2, new Integer(n + 1), i.next()));
          n++;
        }
      }
    }
    ...
    register(
        CmsXmlEntityResolver.class.getName() + ".xmlEntityTemporaryCache",
        m_cacheXmlTemporaryEntity);

    // permanent xml entities cache
    m_cacheXmlPermanentEntity = new ConcurrentHashMap<String, byte[]>(32);
    register(
        CmsXmlEntityResolver.class.getName() + ".xmlEntityPermanentCache",
        m_cacheXmlPermanentEntity);

    // xml content definitions cache
    m_cacheContentDefinitions = createLRUCacheMap(64);
    register(
        CmsXmlEntityResolver.class.getName() + ".contentDefinitionsCache",
    ...
    // publish history
    @RUntainted int size = configuration.getPublishManager().getPublishHistorySize();
    ...
    register(
        CmsDriverManager.class.getName() + ".publishedResourcesCache", m_cachePublishedResources);

    // acl cache
    m_cacheAccessControlList = createLRUCacheMap(cacheSettings.getAclCacheSize());
    register(
        CmsDriverManager.class.getName() + ".accessControlListCache", m_cacheAccessControlList);
    ...
    if (LOG.isDebugEnabled()) {
      ...
      LOG.debug(
          Messages.get()
              .getBundle()
              .key(Messages.LOG_MM_CREATED_1, new Date(System.currentTimeMillis())));
    }
  }
   ...
   *
   * <p>This could be overwritten in a distributed environment.
   *
   * <p>
   *
   ...
   *
   * <p>The group is removed by name AND also by uuid.
   *
   * <p>
   *
   ...
   *
   * <p>The organizational unit is removed by name AND also by uuid.
   *
   * <p>
   *
   ...
   *
   * <p>The project is removed by name AND also by uuid.
   *
   * <p>
   *
   ...
   *
   * <p>The user is removed by name AND also by uuid.
   *
   * <p>
   *
   ...
   *
   * <p><code>obj</code> must be of type {@link CmsLruCache}.
   *
   * <p>
   *
   * @param obj the object
   ...
   *
   * <p><code>obj</code> must be of type {@link CmsLruCache} or {@link Map}.
   *
   * <p>
   *
   * @param obj the object
   ...
   *
   * <p>The keys must be of type {@link String}.
   *
   * <p>
   *
   * @param map the map
   ...
   */
  protected @RUntainted long getKeySize(Map<?, ?> map, int depth) {

    @RUntainted long keySize = 0;
    try {
      ...
      for (int i = 0, s = keys.length; i < s; i++) {
        ...
        @RUntainted Object obj = keys[i];

        if (obj instanceof String) {
          @RUntainted String st = (String) obj;
          keySize += (st.length() * 2);
        }
      }
    } catch (ConcurrentModificationException e) {
   ...
   *
   * <p><code>obj</code> must be of type {@link Map}, the keys must be of type {@link String}.
   *
   * <p>
   *
   * @param obj the object
   ...
   *
   * <p><code>obj</code> must be of type {@link CmsLruCache} or {@link LRUMap}.
   *
   * <p>
   *
   * @param obj the object
  ...
  protected void monitorSendEmail(boolean warning) {
    ...
    if ((m_configuration.getEmailSender() == null)
        || (m_configuration.getEmailReceiver() == null)) {
    ...
    content +=
        "Memory usage report of OpenCms server "
            + OpenCms.getSystemInfo().getServerName().toUpperCase()
            + " at "
            + date
            + "\n\n"
    ...
    for (Iterator<String> keys = keyList.iterator(); keys.hasNext(); ) {
      ...
      @RUntainted Object obj = m_monitoredObjects.get(key);

      long size = getKeySize(obj) + getValueSize(obj) + getCosts(obj);
      totalSize += size;

      content +=
          new PrintfFormat("%-42.42s").sprintf(shortKey)
              + "  "
              + "Entries: "
  ...
  protected void monitorWriteLog(boolean warning) {
    ...
    if (warning) {
      ...
      List<String> keyList = new ArrayList<String>(m_monitoredObjects.keySet());
      Collections.sort(keyList);
      @RUntainted long totalSize = 0;
      for (Iterator<String> keys = keyList.iterator(); keys.hasNext(); ) {
        String key = keys.next();
        @RUntainted Object obj = m_monitoredObjects.get(key);

        @RUntainted long size = getKeySize(obj) + getValueSize(obj) + getCosts(obj);
        totalSize += size;
