...
public class CmsLuceneIndexWriter implements I_CmsIndexWriter {
  ...
  public CmsLuceneIndexWriter(IndexWriter indexWriter, CmsSearchIndex index) {
    ...
    if ((m_index != null) && LOG.isInfoEnabled()) {
      LOG.info(
          Messages.get()
              .getBundle()
              .key(Messages.LOG_INDEX_WRITER_MSG_CREATE_2, m_index.getName(), m_index.getPath()));
    }
  }
  ...
  public void close() throws IOException {
    ...
    if ((m_index != null) && LOG.isInfoEnabled()) {
      LOG.info(
          Messages.get()
              .getBundle()
              .key(Messages.LOG_INDEX_WRITER_MSG_CLOSE_2, m_index.getName(), m_index.getPath()));
    }
    m_indexWriter.close();
  }
  ...
  public void commit() throws IOException {
    ...
    if ((m_index != null) && LOG.isInfoEnabled()) {
      LOG.info(
          Messages.get()
              .getBundle()
              .key(Messages.LOG_INDEX_WRITER_MSG_COMMIT_2, m_index.getName(), m_index.getPath()));
    }
   ...
   *     <p>As optimize is deprecated with Lucene 3.5, this implementation actually calls {@link
  ...
  public void optimize() throws IOException {
    ...
    if ((m_index != null) && LOG.isInfoEnabled()) {
      LOG.info(
          Messages.get()
              .getBundle()
              .key(Messages.LOG_INDEX_WRITER_MSG_OPTIMIZE_2, m_index.getName(), m_index.getPath()));
    }
