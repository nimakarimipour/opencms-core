 ...
 *
 * <ul>
 *   <li>reads a field's (source) value,
 *   <li>applies a regex replacement,
 *   <li>adds a field (target) with the modified value.
 * </ul>
 *
...
public class CmsSolrCopyModifiedUpateProcessor extends UpdateRequestProcessor {
  ...
  /**
   * @see
   *     org.apache.solr.update.processor.UpdateRequestProcessor#processAdd(org.apache.solr.update.AddUpdateCommand)
   */
  @Override
