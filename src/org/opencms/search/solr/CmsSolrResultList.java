...
public class CmsSolrResultList extends ArrayList<CmsSearchResource> {
    ...
    private @RUntainted QueryResponse m_queryResponse;
    ...
    public CmsSolrResultList(
        SolrQuery query,
        @RUntainted QueryResponse queryResponse,
     ...
     * @return the facet field
     */
    public @RUntainted FacetField getFacetField(@RUntainted String name) {
