...
/**
 * Encapsulates a list of 'OpenCms resource documents' ({@link CmsSearchResource}).
 *
 * <p>This list can be accessed exactly like an {@link ArrayList} which entries are {@link
 * CmsSearchResource} that extend {@link org.opencms.file.CmsResource} and holds the Solr
 * implementation of {@link org.opencms.search.I_CmsSearchDocument} as member. <b>This enables you
 * to deal with the resulting list as you do with well known {@link List} and work on it's entries
 * like you do on {@link org.opencms.file.CmsResource}.</b>
 *
 * <p>
 *
 * @since 8.5.0
...
public class CmsSolrResultList extends ArrayList<CmsSearchResource> {
  ...
  public CmsSolrResultList(
      ...
      Float maxScore,
      long startTime,
      @RUntainted long highlightEndTime) {
  ...
  /**
   * Transforms / corrects the highlighting.
   *
   * <p>
   *
