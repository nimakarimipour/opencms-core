...
public class CmsGallerySearchResult implements Comparable<CmsGallerySearchResult>, Cloneable {
  ...
  public CmsGallerySearchResult(I_CmsSearchDocument doc, CmsObject cms, int score, Locale locale) {
    ...
    String mainTitleField =
        CmsSearchFieldConfiguration.getLocaleExtendedName(
                CmsSearchField.FIELD_TITLE_UNSTORED, locale.toString())
            + "_s";
    String localizedTitlePropertyField =
        CmsSearchFieldConfiguration.getLocaleExtendedName(
                CmsPropertyDefinition.PROPERTY_TITLE, locale.toString())
            + CmsSearchField.FIELD_DYNAMIC_PROPERTIES_DIRECT
            + "_s";
    String titlePropertyField =
        CmsPropertyDefinition.PROPERTY_TITLE
            + CmsSearchField.FIELD_DYNAMIC_PROPERTIES_DIRECT
            + "_s";

    for (String fieldName :
        Arrays.asList(mainTitleField, localizedTitlePropertyField, titlePropertyField)) {
    ...
    String mainDescField =
        CmsSearchFieldConfiguration.getLocaleExtendedName(
                CmsSearchField.FIELD_DESCRIPTION, locale.toString())
            + "_s";
    String localizedDescPropertyField =
        CmsSearchFieldConfiguration.getLocaleExtendedName(
                CmsPropertyDefinition.PROPERTY_DESCRIPTION, locale.toString())
            + CmsSearchField.FIELD_DYNAMIC_PROPERTIES
            + "_s";
    String descPropertyField =
        CmsPropertyDefinition.PROPERTY_DESCRIPTION + CmsSearchField.FIELD_DYNAMIC_PROPERTIES + "_s";

    for (String fieldName :
        Arrays.asList(mainDescField, localizedDescPropertyField, descPropertyField)) {
  ...
  /**
   * Returns the list of Solr fields a search result must have to initialize the gallery search
   * result correctly.
   *
