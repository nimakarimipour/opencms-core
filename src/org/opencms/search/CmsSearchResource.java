...
public class CmsSearchResource extends CmsResource {
   ...
   * Delegator.
   *
   * <p>{@link I_CmsSearchDocument#getFieldValueAsDate(String)}
   *
   ...
   * Delegator.
   *
   * <p>{@link I_CmsSearchDocument#getFieldValueAsString(String)}
   *
   * @param fieldName the field name to get the value for
   * @return the value
   */
   ...
   * Delegator.
   *
   * <p>{@link I_CmsSearchDocument#getScore()}
   *
   * <p>Returns the score of this document.
   *
   * <p>
   *
