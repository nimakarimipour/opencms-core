...
public class CmsSearchResource extends CmsResource {
     ...
     * @return the value
     */
    public Date getDateField(@RUntainted String fieldName) {
     ...
     * @return the value
     */
    public @RUntainted String getField(@RUntainted String fieldName) {
     ...
     * @return the value
     */
    public List<@RUntainted String> getMultivaluedField(@RUntainted String fieldName) {
