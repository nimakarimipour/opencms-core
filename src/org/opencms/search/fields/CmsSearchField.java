...
public class CmsSearchField implements Serializable {
  ...
  /**
   * Name of the field that contains the complete extracted content of the document as serialized
   * object (hardcoded).
   */
  ...
  /**
   * Name of the field that contains the document last modification date for fast lookup
   * (hardcoded).
   */
  ...
  /**
   * Name of the field that usually contains the value of the "Description" property of the document
   * (optional).
   */
  ...
  public static final @RUntainted String FIELD_DYNAMIC_PROPERTIES = "_prop";

  /** Name of the dynamic property field (non-searched properties). */
  public static final @RUntainted String FIELD_DYNAMIC_PROPERTIES_DIRECT = "_dprop";

  /**
   * The name of the dynamic field that stores the shortened value of the content field in order to
   * save performance.
   */
  ...
  /**
   * Name of the field that usually contains the value of the "Keywords" property of the document
   * (optional).
   */
  ...
  /**
   * Name of the field that usually combines all document "meta" information, that is the values of
   * the "Title", "Keywords" and "Description" properties (optional).
   */
  ...
  /**
   * Name of the field that contains the (optional) document priority, which can be used to boost
   * the document in the result list (hardcoded).
   */
  ...
  /**
   * Name of the field that usually contains the value of the "Title" property of the document as a
   * keyword used for sorting and also for retrieving the title text (optional).
   *
   * <p>Please note: This field should NOT be used for searching. Use {@link #FIELD_TITLE_UNSTORED}
   * instead.
   *
   * <p>
   */
  ...
  /**
   * Name of the field that usually contains the value of the "Title" property of the document in an
   * analyzed form used for searching in the title (optional).
   */
  ...
  // TODO: concat those field names; "text" + locale, where needed like content fields or exceprt
  // fields
  ...
  /**
   * The field PREFIX of the fields that contain the display title (without locale and postfix
   * "_s").
   */
  public static final @RUntainted String FIELD_DISPTITLE = "disptitle";

  /**
   * The field PREFIX of the fields that contain the display order (without locale and postfix
   * "_i").
   */
  ...
  /**
   * The field PREFIX where the start date for the single entry of a serial date entry set is
   * stored.
   */
  ...
  /**
   * The field PREFIX where the date until which the single entry of a serial date entry should be
   * treated as "current" is stored.
   */
  public static final @RUntainted String FIELD_INSTANCEDATE_CURRENT_TILL = "instancedatecurrenttill";

  /**
   * The field PREFIX where the start date and the end date of the single entry of a serial date
   * entry is stored as a date range.
   */
  ...
  /**
   * The field where the end dates for a serial date are stored. NOTE: The field is only used during
   * indexing and not stored in the content itself.
   */
  public static final String FIELD_SERIESDATES_END = "seriesdatesend" + FIELD_POSTFIX_DATES;

  /**
   * The field where the dates until when the single serial dates are treated as "current" are
   * stored. NOTE: The field is only used during indexing and not stored in the content itself.
   */
  public static final String FIELD_SERIESDATES_CURRENT_TILL =
      "seriesdatescurrenttill" + FIELD_POSTFIX_DATES;
  ...
  /**
   * To allow sorting on a field the field must be added to the map given to {@link
   * org.apache.solr.uninverting.UninvertingReader#wrap(org.apache.lucene.index.DirectoryReader,
   * Map)}. The method adds all default fields.
   *
   ...
   *
   * <p>In case no default is configured, <code>null</code> is returned.
   *
   * <p>
   *
  ...
  /**
   * Returns the String value state of this field if it is indexed (and possibly tokenized) in the
   * index.
   *
   * <p><b>IMPORTANT:</b> Not supported by Solr
   *
   * @return the String value state of this field if it is indexed (and possibly tokenized) in the
   *     index
   */
  ...
  /**
   * Returns <code>true</code> if this fields content is used in the search result excerpt.
   *
   * <p>
   *
  ...
  /**
   * Returns <code>true</code> if the content of this field is stored in the Lucene index.
   *
   * <p>Please refer to the Lucene documentation about {@link
   * org.apache.lucene.document.Field.Store} for the concept behind stored and unstored fields.
   *
   * <p>
   *
