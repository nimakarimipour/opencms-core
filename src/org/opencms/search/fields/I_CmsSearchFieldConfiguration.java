 ...
 * configured in the opencms-search.xml (see {@link
...
public interface I_CmsSearchFieldConfiguration
   ...
   *
   * <p>The structure of the document depends on the concrete field configuration, the provided VFS
   * resource, search index and extracted content.
   *
   * <p>The method is typically triggered by {@link I_CmsDocumentFactory#createDocument(CmsObject,
   * CmsResource, I_CmsSearchIndex)} to create the document.
   *
   * <p>
   *
   ...
   * @param extractionResult the plain text content and additional information extracted from the
   *     document
