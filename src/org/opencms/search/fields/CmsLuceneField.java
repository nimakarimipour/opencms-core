...
public class CmsLuceneField extends CmsSearchField {
   ...
   * Creates a new search field configuration.
   *
   * <p>The field will be tokenized if it is indexed. The field will not be in the excerpt. There is
   * no default value.
   *
   * <p>
   *
   ...
   * @param isStored controls if the field is stored and in the excerpt, see {@link
   *     #setStored(boolean)}
   * @param isIndexed controls if the field is indexed and tokenized, see {@link
   *     #setIndexed(boolean)}
   */
   ...
   *
   * <p>The configured name of the field as provided by {@link #getName()} is used.
   *
   * <p>If no valid content is provided (that is the content is either <code>null</code> or only
   * whitespace), then no field is created and <code>null</code> is returned.
   *
   * <p>
   *
  ...
  /**
   * Returns <code>true</code> if the content of this field is compressed.
   *
   * <p>If the field is compressed, it must also be stored, this means {@link #isStored()} will
   * always return <code>true</code> for compressed fields.
   *
   * <p>
   *
   ...
   *
   * <p>A field can only be used in the excerpt if it is stored, see {@link #isStored()}.
   *
   * <p>
   *
  ...
  /**
   * Returns <code>true</code> if the content of this field is tokenized in the Lucene index.
   *
   * <p>Please refer to the Lucene documentation about the concept behind tokenized and untokenized
   * fields.
   *
   * <p>
   *
   ...
   * Returns <code>true</code> if the content of this field is tokenized in the Lucene index.
   *
   * <p>A field can only be tokenized if it is also indexed, see {@link #isIndexed()}.
   *
   * <p>Please refer to the Lucene documentation about the concept behind tokenized and untokenized
   * fields.
   *
   ...
   * Sets the analyzer used for this field.
   *
   * <p>The parameter must be a name of a class the implements the Lucene {@link Analyzer}
   * interface.
   *
   ...
   *
   * <p>If this is set to <code>true</code>, the value for {@link #isStored()} will also be set to
   * <code>true</code>, since compressed fields are always stored.
   *
   * <p>
   *
   ...
   *
   * <p>This sets the values for {@link #isIndexed()} as well as {@link #isTokenizedAndIndexed()}.
   *
   * <p>The parameter can have the following values:
   *
   * <ul>
