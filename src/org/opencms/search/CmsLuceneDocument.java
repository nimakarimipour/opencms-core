...
public class CmsLuceneDocument implements I_CmsSearchDocument {
  ...
  public void addPathField(@RUntainted String rootPath) {
    ...
    Field field =
        new Field(CmsSearchField.FIELD_PARENT_FOLDERS, parentFolders, NOT_STORED_ANALYSED_TYPE);
    add(field);
  }
  ...
  public void addSearchField(@RUntainted CmsSearchField field, String value) {
    ...
    if (field instanceof CmsLuceneField) {
      ...
      throw (new CmsRuntimeException(
          Messages.get()
              .container(Messages.LOG_INVALID_FIELD_CLASS_1, field.getClass().getName())));
    }
  }
