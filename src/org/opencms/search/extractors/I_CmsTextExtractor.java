...
public interface I_CmsTextExtractor {
   ...
   *
   * <p>The encoding of the input stream is either not required (the document type may have one
   * common default encoding) or the extractor is able to divine the encoding from the provided
   * binary array automatically.
   *
   * <p>Delivers is the same result as calling <code>{@link #extractText(byte[], String)}</code>
   * when <code>String == null</code>.
   *
   * <p>
   *
  ...
  /**
   * Extracts the text and meta information from the given binary document, using the specified
   * content encoding.
   *
   * <p>The encoding is a hint for the text extractor, if the value given is <code>null</code> then
   ...
   *
   * <p>Delivers is the same result as calling <code>{@link #extractText(InputStream, String)}
   * </code> when <code>String == null</code>.
   *
   * <p>
   *
  ...
  /**
   * Extracts the text and meta information from the document on the input stream, using the
