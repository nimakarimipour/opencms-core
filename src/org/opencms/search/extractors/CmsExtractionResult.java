...
public class CmsExtractionResult implements I_CmsExtractionResult, Serializable {
  ...
  public I_CmsExtractionResult merge(List<I_CmsExtractionResult> extractionResults) {
    ...
    // prepare copy
    Map<Locale, LinkedHashMap<String, String>> contentItems =
        new HashMap<Locale, LinkedHashMap<String, String>>(m_locales.size());
    for (Locale locale : m_locales) {
      LinkedHashMap<String, String> originalLocalValues = m_contentItems.get(locale);
      LinkedHashMap<String, String> localeValues =
          new LinkedHashMap<String, String>(originalLocalValues);
  ...
  private Map<String, String> mergeItem(
      String item, Map<String, String> localeValues, Map<String, String> resultLocaleValues) {
