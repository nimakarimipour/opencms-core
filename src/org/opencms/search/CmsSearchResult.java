...
public class CmsSearchResult implements I_CmsMemoryMonitorable, Comparable<CmsSearchResult> {
   ...
   * @param doc the Lucene document to extract fields from such as description, title, key words
   *     etc. pp.
   ...
   * @deprecated use {@link #getField(String)} instead with the name of the field, for example use
   *     {@link org.opencms.search.fields.CmsLuceneField#FIELD_DESCRIPTION} to get the description
   *     (if available)
   */
  @Deprecated
   ...
   *
   * <p>Usually this will be a VFS resource type String that can be used in the resource type
   * manager with {@link org.opencms.loader.CmsResourceManager#getResourceType(String)}. However,
   * what is stored in the document type field depends only on the indexer used, and therefore it
   * may also be some String not referring a VFS resource type but some external type or
   * application. It may also be <code>null</code> in case it has not been set by a non-standard
   * indexer.
   *
   * <p>
   *
   ...
   * @deprecated use {@link #getField(String)} instead with the name of the field, for example use
   *     {@link org.opencms.search.fields.CmsLuceneField#FIELD_KEYWORDS} to get the keywords (if
   *     available)
   */
  @Deprecated
   ...
   * @return the title
   * @deprecated use {@link #getField(String)} instead with the name of the field, for example use
   *     {@link org.opencms.search.fields.CmsLuceneField#FIELD_TITLE} to get the title (if
   *     available)
   */
  @Deprecated
