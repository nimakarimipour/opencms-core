...
/**
 * Lucene document factory class to extract index data from an OpenCms VFS resource of type <code>
 * CmsResourceTypeXmlContent</code>.
 *
 * <p>All XML nodes from the content for all locales will be stored separately in the item map which
 * you can access using {@link CmsExtractionResult#getContentItems()}. The XML elements will be
 * accessible using their xpath. The xpath will have the form like for example <code>Text[1]</code>
 * or <code>Nested[1]/Text[1]</code>.
 *
 * <p>
 *
 * @since 6.0.0
...
public class CmsDocumentXmlContent extends A_CmsVfsDocument {
  ...
  /**
   * @see org.opencms.search.documents.A_CmsVfsDocument#createDocument(org.opencms.file.CmsObject,
  ...
  /**
   * Returns the raw text content of a given VFS resource of type <code>CmsResourceTypeXmlContent
   * </code>.
   *
   * <p>All XML nodes from the content for all locales will be stored separately in the item map
   * which you can access using {@link CmsExtractionResult#getContentItems()}. The XML elements will
   * be accessible using their xpath. The xpath will have the form like for example <code>Text[1]
   * </code> or <code>Nested[1]/Text[1]</code>.
   *
   * <p>
   *
