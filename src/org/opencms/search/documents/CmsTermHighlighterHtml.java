...
public class CmsTermHighlighterHtml implements I_CmsTermHighlighter {
  ...
  /**
   * @see
   *     org.opencms.search.documents.I_CmsTermHighlighter#getExcerpt(org.apache.lucene.document.Document,
   *     org.opencms.search.CmsSearchIndex, org.opencms.search.CmsSearchParameters,
  ...
  public String getExcerpt(
    ...
    while (excerptFieldNames.hasNext()) {
      ...
      boolean createExcerpt =
          !params.isExcerptOnlySearchedFields() || params.getFields().contains(fieldName);
      if (createExcerpt && (doc.getField(fieldName) != null)) {
        ...
        String fragment =
            highlighter.getBestFragments(
                stream, text, EXCERPT_REQUIRED_FRAGMENTS, EXCERPT_FRAGMENT_SEPARATOR);
