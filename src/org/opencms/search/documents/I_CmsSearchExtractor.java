 ...
 *
 * <p>The job of a search extractor is to extract indexable plain text from a resource in the
 * OpenCms VFS. This may be from the resource content, for example from a PDF file, or from the
 * resource properties, for example the Title, Keywords and Description properties.
 *
 * <p>
 *
 * @since 6.0.0
