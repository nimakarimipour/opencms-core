 ...
 *
 * <p>It stores nothing. It just prints everything to a temporary file.
 *
 * <p>
 *
 * @since 6.5.5
...
public class CmsPublishReport extends CmsPrintStreamReport {
  ...
  /**
   * Constructs a new publish report decorating the provided report.
   *
   * <p>
   *
  ...
  /**
   * Returns a publish report instance that writes to the given report as well as to the given
   * temporary file.
   *
   * <p>
   *
