 ...
 * matches a set of prefixes or not.
 *
 * <p>The path prefixes must be non-trivial, they can't just be the empty string or '/' - these
...
public class CmsAlternativeSiteRootMapping implements Serializable {
  ...
  public CmsAlternativeSiteRootMapping(String siteRoot, List<String> prefixes, String titleSuffix) {
    ...
    m_prefixes =
        prefixes.stream()
            ...
            .filter(prefix -> !prefix.equals("/") && !CmsStringUtil.isEmptyOrWhitespaceOnly(prefix))
            .map(CmsPath::new)
  ...
  public int hashCode() {
    ...
    return ((((m_prefixes.hashCode()) * 31) + m_siteRoot.hashCode()) * 31)
        + m_titleSuffix.hashCode();
  }
