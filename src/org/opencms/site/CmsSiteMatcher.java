...
public final class CmsSiteMatcher implements Cloneable, Serializable {
    ...
    public CmsSiteMatcher(@RUntainted String serverString, long timeOffset) {
        ...
        int serverPort;
        @RUntainted String serverProtocol, serverName;
        // check for protocol
        pos = serverString.indexOf("://");
        if (pos >= 0) {
     ...
     */
    public CmsSiteMatcher(@RUntainted String serverProtocol, @RUntainted String serverName, int serverPort) {
     ...
     * @param timeOffset the time offset
     */
    public CmsSiteMatcher(@RUntainted String serverProtocol, @RUntainted String serverName, int serverPort, long timeOffset) {
     ...
     */
    public CmsSiteMatcher forDifferentScheme(@RUntainted String scheme) {

        try {
            URI uri = new URI(getUrl());
            @RUntainted URI changedUri = new URI(scheme, uri.getAuthority(), uri.getPath(), uri.getQuery(), uri.getFragment());
     ...
     * @param timeOffset the time offset
     */
    private void init(@RUntainted String serverProtocol, @RUntainted String serverName, int serverPort, long timeOffset) {
