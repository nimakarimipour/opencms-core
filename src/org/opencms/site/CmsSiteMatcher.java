...
public final class CmsSiteMatcher implements Cloneable, Serializable {
   ...
   *
   * <p>If no port is provided, the default port 80 or 443 will be used for http or https
   * respectively. If no protocol is provided, the default protocol "http" will be used.
   *
   ...
   *
   * <p>Setting the hostname to "*" is a wildcard that matches all hostnames
   *
   ...
   *
   * <p>Setting the port to 0 (zero) is a wildcard that matches all ports
   *
   ...
   *
   * <p>Setting the protocol to "*" is a wildcard that matches all protocols.
   *
   * <p>
   *
