 ...
 * {@link org.opencms.xml.I_CmsXmlDocument}</code>.
 *
 * <p>
 *
 * @since 6.2.0
...
abstract class A_CmsXmlDocumentLoader
    implements I_CmsResourceLoader, I_CmsResourceStringDumpLoader {
  ...
  public byte[] dump(
    ...
    if ((element == null) || (selectedLocale == null)) {
      ...
      throw new CmsLoaderException(
          Messages.get()
              .container(Messages.ERR_LOADER_XML_NEED_ELEMENT_LOCALE_1, resource.getRootPath()));
    }
  ...
  /**
   * @see org.opencms.loader.I_CmsResourceStringDumpLoader#dumpAsString(org.opencms.file.CmsObject,
   *     org.opencms.file.CmsResource, java.lang.String, java.util.Locale,
              ...
              .container(
                  ...
                  new Object[] {
                    ...
                    CmsLocaleManager.getLocaleNames(
                        OpenCms.getLocaleManager()
                            .getDefaultLocales(cms, cms.getSitePath(resource)))
                  }));
    }
  ...
  /**
   * Returns <code>null</code> since XML document loaders does usually not need to be configured.
   *
   * <p>
   *
  ...
  public void service(CmsObject cms, CmsResource resource, ServletRequest req, ServletResponse res)
    ...
    // get the value as a String
    String value =
        dumpAsString(cms, resource, element, cms.getRequestContext().getLocale(), req, res);
  ...
  /**
   * Returns the property definition name used to selecte the template for this XML document
   * resource loader.
   *
   * <p>
   *
   * @return the property definition name used to selecte the template for this XML document
   *     resource loader
   */
  ...
  protected void setTemplateRequestAttributes(
      CmsTemplateLoaderFacade loaderFacade, HttpServletRequest req) {
   ...
   */
  protected abstract I_CmsXmlDocument unmarshalXmlDocument(
