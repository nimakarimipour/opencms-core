...
public final class Messages extends A_CmsMessageBundle {
  ...
  public static final String ERR_CONFLICTING_MODULE_RESOURCE_TYPES_5 =
      "ERR_CONFLICTING_MODULE_RESOURCE_TYPES_5";

  /** Message constant for key in the resource bundle. */
  public static final String ERR_CONFLICTING_RESOURCE_TYPES_4 = "ERR_CONFLICTING_RESOURCE_TYPES_4";

  /** Message constant for key in the resource bundle. */
  public static final String ERR_CONFLICTING_RESTYPES_IN_MODULE_5 =
      "ERR_CONFLICTING_RESTYPES_IN_MODULE_5";

  /** Message constant for key in the resource bundle. */
  public static final String ERR_EXPORT_UNSUPPORTED_1 = "ERR_EXPORT_UNSUPPORTED_1";

  /** Message constant for key in the resource bundle. */
  public static final String ERR_FILE_NAME_PATTERN_WITHOUT_NUMBER_MACRO_1 =
      "ERR_FILE_NAME_PATTERN_WITHOUT_NUMBER_MACRO_1";
  ...
  /** Message constant for key in the resource bundle. */
  public static final String ERR_LOADER_XML_NEED_ELEMENT_LOCALE_1 =
      "ERR_LOADER_XML_NEED_ELEMENT_LOCALE_1";

  /** Message constant for key in the resource bundle. */
  public static final String ERR_NO_CONFIG_AFTER_STARTUP_0 = "ERR_NO_CONFIG_AFTER_STARTUP_0";

  /** Message constant for key in the resource bundle. */
  public static final String ERR_NO_FILE_NAME_AVAILABLE_FOR_PATTERN_1 =
      "ERR_NO_FILE_NAME_AVAILABLE_FOR_PATTERN_1";
  ...
  /** Message constant for key in the resource bundle. */
  public static final String ERR_TEMPLATE_PROTERTY_UNSUPPORTED_1 =
      "ERR_TEMPLATE_PROTERTY_UNSUPPORTED_1";

  /** Message constant for key in the resource bundle. */
  public static final String ERR_UNABLE_TO_EXTRACT_IMAGE_SIZE_1 =
      "ERR_UNABLE_TO_EXTRACT_IMAGE_SIZE_1";
  ...
  /** Message constant for key in the resource bundle. */
  public static final String GUI_LOADER_CONTAINERPAGE_DEFAULT_DESC_0 =
      "GUI_LOADER_CONTAINERPAGE_DEFAULT_DESC_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_LOADER_DUMB_DEFAULT_DESC_0 = "GUI_LOADER_DUMB_DEFAULT_DESC_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_LOADER_HTMLREDIRECT_DEFAULT_DESC_0 =
      "GUI_LOADER_HTMLREDIRECT_DEFAULT_DESC_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_LOADER_JSP_DEFAULT_DESC_0 = "GUI_LOADER_JSP_DEFAULT_DESC_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_LOADER_MACRO_FORMATTER_DEFAULT_DESC_0 =
      "GUI_LOADER_MACRO_FORMATTER_DEFAULT_DESC_0";
  ...
  /** Message constant for key in the resource bundle. */
  public static final String GUI_LOADER_SEOFILE_DEFAULT_DESC_0 =
      "GUI_LOADER_SEOFILE_DEFAULT_DESC_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_LOADER_SITEMAP_DEFAULT_DESC_0 =
      "GUI_LOADER_SITEMAP_DEFAULT_DESC_0";
  ...
  /** Message constant for key in the resource bundle. */
  public static final String LOG_HTML_CONVERTER_CLASS_NOT_FOUND_1 =
      "LOG_HTML_CONVERTER_CLASS_NOT_FOUND_1";
