...
public class CmsPointerLoader extends CmsDumpLoader {
  ...
  /**
   * The configuration parameter for the OpenCms XML configuration to enable that the parameters in
   * requests to pointer resources are appended to the pointer target link.
   */
  public static final String CONFIGURATION_REQUEST_PARAM_SUPPORT_ENABLED =
      "pointer.requestparamsupport.enabled";

  /** The id of this loader. */
  public static final int RESOURCE_POINTER_LOADER_ID = 4;

  /**
   * Flag that controls if parameters in requests to pointer resources are appended to the target
   * link when redirecting.
   */
  ...
  /**
   * Returns <code>true</code> if parameters in requests to pointer resources are appended to the
   * target link when redirecting.
   *
   * <p>This is controlled by the configuration of this loader in <code>opencms-system.xml</code>.
   *
   * <p>
   *
   * @return <code>true</code> if parameters in requests to pointer resources are appended to the
   *     target link when redirecting.
   */
  ...
  /**
   * Internal helper that is used by <code>
   * {@link #load(CmsObject, CmsResource, HttpServletRequest, HttpServletResponse)}</code> and
   * <code>{@link #export(CmsObject, CmsResource, HttpServletRequest, HttpServletResponse)}</code>
   * to handle conditional request parameter support for links to pointer resources.
   *
   * <p>
   *
   * @param pointerLink the link to append request parameters to
   * @param req the original request to the pointer
  ...
  /**
   * Will always return <code>null</code> since this loader does not need to be cnofigured.
   *
   * <p>
   *
  ...
  public CmsParameterConfiguration getConfiguration() {
    ...
    result.put(
        CONFIGURATION_REQUEST_PARAM_SUPPORT_ENABLED, String.valueOf(m_requestParamSupportEnabled));
    return result;
  }
   ...
   * locale) <code>"The OpenCms default resource loader for pointers"</code>.
   *
   * <p>
   *
   ...
   * <p>
   *
   * @return true if request parameter support is disabled
