...
public class CmsDefaultFileNameGenerator implements I_CmsFileNameGenerator {
    ...
    public class CmsNumberFactory implements Factory {
         ...
         */
        public CmsNumberFactory(@RUntainted int digits) {
     ...
     */
    public @RUntainted String getNewFileName(CmsObject cms, String namePattern, int defaultDigits) throws CmsException {
     ...
     */
    public @RUntainted String getNewFileName(CmsObject userCms, String namePattern, @RUntainted int defaultDigits, boolean explorerMode)
    throws CmsException {
        ...
        @RUntainted String checkPattern = cms.getRequestContext().removeSiteRoot(namePattern);
     ...
     */
    public @RUntainted Iterator<@RUntainted String> getUrlNameSequence(@RUntainted String baseName) {
    ...
    protected @RUntainted String getNewFileNameFromList(
        ...
        String macro = I_CmsFileNameGenerator.MACRO_NUMBER;
        @RUntainted int useDigits = defaultDigits;
        String macroStart = ""
