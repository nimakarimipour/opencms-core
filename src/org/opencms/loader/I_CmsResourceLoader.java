...
public interface I_CmsResourceLoader extends I_CmsConfigurationParameterHandler {
     ...
     */
    byte[] export(@RUntainted CmsObject cms, @RUntainted CmsResource resource, @RUntainted HttpServletRequest req, @RUntainted HttpServletResponse res)
     ...
     * @see org.opencms.flex.CmsFlexRequestDispatcher
     */
    void service(@RUntainted CmsObject cms, @RUntainted CmsResource resource, @RUntainted ServletRequest req, @RUntainted ServletResponse res)
    throws ServletException, IOException, CmsException;
}
