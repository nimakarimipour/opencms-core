...
public interface I_CmsResourceLoader extends I_CmsConfigurationParameterHandler {
     ...
     */
    byte[] export(@RUntainted CmsObject cms, CmsResource resource, HttpServletRequest req, HttpServletResponse res)
     ...
     */
    void load(@RUntainted CmsObject cms, CmsResource resource, HttpServletRequest req, HttpServletResponse res)
    throws ServletException, IOException, CmsException;
