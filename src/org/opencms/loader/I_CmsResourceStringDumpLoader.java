...
public interface I_CmsResourceStringDumpLoader {
   ...
   *
   * <p>This is a special form of <code>
   * {@link I_CmsResourceLoader#dump(CmsObject, CmsResource, String, Locale, javax.servlet.http.HttpServletRequest, javax.servlet.http.HttpServletResponse)}
   * </code> where the result is required in a String, for example for printing it to a writer.
   *
   * <p>
   *
