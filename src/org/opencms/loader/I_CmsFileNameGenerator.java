...
public interface I_CmsFileNameGenerator {
     ...
     */
    @RUntainted String getNewFileName(CmsObject cms, String namePattern, int defaultDigits) throws CmsException;
     ...
     * @throws CmsException in case something goes wrong
     */
    @RUntainted String getNewFileName(CmsObject cms, String namePattern, int defaultDigits, boolean explorerMode)
    throws CmsException;
     ...
     */
    @RUntainted Iterator<@RUntainted String> getUrlNameSequence(@RUntainted String baseName) throws CmsException;
