...
public class CmsMacroFormatterLoader implements I_CmsResourceLoader {
  ...
  private static final String RENDER_MACRO_JSP =
      "/system/modules/org.opencms.base/pages/render-macro.jsp";

  /** The JSP rendering the macro. */
  private static final String RENDER_STRING_TEMPLATE_JSP =
      "/system/modules/org.opencms.base/pages/render-string-template.jsp";
  ...
  /**
   * Ensure the element formatter id is set in the element bean.
   *
   * <p>
   *
