...
public class CmsPrincipalWidget extends A_CmsWidget implements I_CmsADEWidget {
  ...
  /**
   * Creates a new principals selection widget with the parameters to configure the popup window
   * behaviour.
   *
   * <p>
   *
  ...
  public String getConfiguration(
    ...
    return CmsPrincipalSelectDialog.PARAM_TYPE
        + "="
        + CmsPrincipalSelect.WidgetType.principalwidget.name();
  }
  ...
  public String getDialogIncludes(CmsObject cms, I_CmsWidgetDialog widgetDialog) {
    ...
    result.append(
        getJSIncludeFile(CmsWorkplace.getSkinUri() + "components/widgets/principalselector.js"));
    return result.toString();
  }
