...
/**
 * This class represents the definition of a column for the table widget used to select data items
 * provided by an I_CmsDataView implementation.
 *
 * <p>
 */
public class CmsDataViewColumn {
  ...
  public static enum Type {
     ...
     *
     * <p>When calling getColumnData on an implementation of I_CmsDataViewItem for a given column,
     * the returned object's class should match the value class of the column's type.
     *
   ...
   * <p>
   *
   * @param id the column id (should be unique among the list of columns for an I_CmsDataView
   *     implementation)
   ...
   */
  public CmsDataViewColumn(
      String id, Type type, String niceName, boolean sortable, int preferredWidth) {
    m_type = type;
    m_id = id;
    m_sortable = sortable;
    m_niceName = niceName;
   ...
   * Gets the column id.
   *
   * <p>The column id is not directly shown to the user; it is used as an internal identifier for
   * the column and should be unique.
   *
