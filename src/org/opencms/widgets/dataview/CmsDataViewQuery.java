...
/**
 * Represents a search query which can be submitted to an implementation of I_CmsDataView to
...
public class CmsDataViewQuery {
   ...
   *
   * <p>If no full text query is provided, this will return the empty string.
   *
   ...
   *
   * <p>If this method returns null, unsorted results should be returned.
   *
