...
public class CmsColorpickerWidget extends A_CmsWidget implements I_CmsADEWidget {
  ...
  public String getDialogInitMethod(CmsObject cms, I_CmsWidgetDialog widgetDialog) {
    ...
    result.append(
        Messages.get().getBundle(widgetDialog.getLocale()).key(Messages.GUI_DIALOG_COLOR_TITLE_0));
    result.append("\";\n");
  ...
  /**
   * Check the stored color value to prevent display issues in the generated HTML ouput.
   *
   * <p>
   *
  ...
  /**
   * Returns the font color of the input field depending on the selected color value.
   *
   * <p>
   *
   * @param backgroundColor the selected color value which is displayed as the input field
   *     background
