...
public abstract class A_CmsWidget implements I_CmsWidget {
  ...
  public class CmsDummyWidgetDialog implements I_CmsWidgetDialog {
    ...
    /**
     * @see org.opencms.widgets.I_CmsWidgetDialog#button(java.lang.String, java.lang.String,
  ...
  public static final @RUntainted String HELP_POSTFIX = ".help";
  ...
  /**
   * @see org.opencms.widgets.I_CmsWidget#getDialogHtmlEnd(org.opencms.file.CmsObject,
   *     I_CmsWidgetDialog, I_CmsWidgetParameter)
   */
  public String getDialogHtmlEnd(
      CmsObject cms, I_CmsWidgetDialog widgetDialog, I_CmsWidgetParameter value) {
  ...
  /**
   * @see org.opencms.widgets.I_CmsWidget#getHelpBubble(org.opencms.file.CmsObject,
   *     I_CmsWidgetDialog, I_CmsWidgetParameter)
   */
  public String getHelpBubble(
    ...
    if (locValue == null) {
      ...
      result.append(
          OpenCms.getLinkManager()
              .substituteLink(cms, "/system/workplace/resources/commons/help.png"));
      ...
      if (widgetDialog.useNewStyle()) {
        ...
        result.append(
            getJsHelpMouseHandler(widgetDialog, locKey, CmsStringUtil.escapeJavaScript(locValue)));
      }
      result.append("></td>");
      return result.toString();
    }
  ...
  /**
   * @see org.opencms.widgets.I_CmsWidget#getWidgetStringValue(org.opencms.file.CmsObject,
   ...
   *
   * <p>This is required since the handler differs between the "Dialog" and the "Administration"
   * mode.
   *
   * <p>
   *
   ...
   * @param value the localized help text, has to be an escaped String for JS usage, is only used in
   *     XML content editor
