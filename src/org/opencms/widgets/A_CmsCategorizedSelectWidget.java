 ...
 *
 * <p>A categorized select widget consists of two select boxes, one for selecting the actual value
 * and one for filtering the choices available in the first select box. All data for the choices is
 * loaded initially, when the widget is initialized.
 */
public abstract class A_CmsCategorizedSelectWidget extends A_CmsWidget implements I_CmsADEWidget {
  ...
  public static final I_CmsCategorizedSelectDataFactory DATA_FACTORY =
      AutoBeanFactorySource.create(I_CmsCategorizedSelectDataFactory.class);
  ...
  public String getConfiguration(
    ...
    AutoBean<I_CmsCategorizedSelectData> autoBean =
        getData(cms, contentValue, messages, resource, contentLocale);
   ...
   *
   * <p>This uses the GWT AutoBean mechanism for serialization. Use the DATA_FACTORY member for
   * creating the relevant AutoBeans.
   *
   * @param cms the cms
   * @param contentValue the content value
   * @param messages the messages
