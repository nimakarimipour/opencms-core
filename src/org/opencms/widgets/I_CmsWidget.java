...
public interface I_CmsWidget {
   ...
   *
   * <p>This can be used to enable / disable certain widget features that should not always be
   * available, or to pass specific initialization information to the widget. It depends on the
   * widget implementation on how this information is used.
   *
   * <p>
   *
   ...
   *
   * <p>The "help bubble" text div's are added using this method.
   *
   * <p>
   *
  ...
  /**
   * Returns the <code>{@link I_CmsWidgetParameter#getStringValue(CmsObject)}</code> processed
   * according to the output rules of this widget and the given widget dialog.
   *
   * <p>
   *
   * @param cms the current users OpenCms context
   * @param widgetDialog the dialog where the widget is used on
   * @param param the widget parameter to generate the widget for
   * @return the <code>{@link I_CmsWidgetParameter#getStringValue(CmsObject)}</code> processed
   *     according to the output rules of this widget
  ...
  /**
   * Sets the value of in the given widget parameter by reading the "right" value from the offered
   * map of parameters.
   *
   * <p>
   *
