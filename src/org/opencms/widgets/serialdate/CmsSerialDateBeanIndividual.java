...
public class CmsSerialDateBeanIndividual extends A_CmsSerialDateBean {
  ...
  public CmsSerialDateBeanIndividual(
    ...
    m_individualDates =
        null == individualDates ? new TreeSet<Date>() : new TreeSet<Date>(individualDates);
  }
  ...
  /**
   * @see org.opencms.widgets.serialdate.A_CmsSerialDateBean#showMoreEntries(java.util.Calendar,
   *     int)
   */
  @Override
