...
public class CmsSerialDateBeanYearly extends A_CmsSerialDateBean {
   ...
   * @param dayOfMonth if <code>weekDay</code> is <code>null</code> the day of the month the event
   ...
   * @return <code>true</code> if the month has less days than the day searched for, <code>false
   *     </code> otherwise.
   */
