...
public final class Messages extends A_CmsMessageBundle {
    ...
    public static final @RUntainted String ERR_SERIALDATE_INVALID_VALUE_0 = "ERR_SERIALDATE_INVALID_VALUE_0";

    /** Message constant for key in the resource bundle. */
    public static final @RUntainted String ERR_SERIALDATE_START_MISSING_0 = "ERR_SERIALDATE_START_MISSING_0";

    /** Message constant for key in the resource bundle. */
    public static final @RUntainted String ERR_SERIALDATE_END_BEFORE_START_0 = "ERR_SERIALDATE_END_BEFORE_START_0";
    ...
    /** Message constant for key in the resource bundle. */
    public static final @RUntainted String ERR_SERIALDATE_TOO_MANY_EVENTS_1 = "ERR_SERIALDATE_TOO_MANY_EVENTS_1";
