...
public class CmsSerialDateBeanMonthly extends A_CmsSerialDateBean {
   ...
   * @param dayOfMonth the day of the month the event should occur, if the month does not have that
   *     particular day the event takes place at the last day of the month.
   */
