...
public class CmsAdeImageGalleryWidget extends A_CmsAdeGalleryWidget {
  ...
  protected JSONObject getAdditionalGalleryInfo(
    ...
    result.put(
        ...
        new JSONArray(config.getFormatValues()));
  ...
  /**
   * @see
   *     org.opencms.widgets.A_CmsAdeGalleryWidget#getOpenPreviewCall(org.opencms.widgets.I_CmsWidgetDialog,
   *     java.lang.String)
   */
  @Override
  protected String getOpenPreviewCall(I_CmsWidgetDialog widgetDialog, String id) {
    ...
    // using the 'cmsOpenImagePreview' function instead of 'cmsOpenPreview'
    sb.append("javascript:cmsOpenImagePreview('")
  ...
  /**
   * @see
   *     org.opencms.widgets.A_CmsAdeGalleryWidget#getWidgetConfiguration(org.opencms.file.CmsObject,
  ...
  protected CmsVfsImageWidgetConfiguration getWidgetConfiguration(
    ...
    if (m_widgetConfiguration == null) {
      m_widgetConfiguration =
          new CmsVfsImageWidgetConfiguration(cms, messages, param, getConfiguration());
    }
