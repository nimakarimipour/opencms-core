...
public abstract class A_CmsGalleryWidget extends A_CmsWidget implements I_CmsADEWidget {
  ...
  public String getConfiguration(
    ...
    CmsGalleryWidgetConfiguration config =
        new CmsGalleryWidgetConfiguration(cms, messages, schemaType, getConfiguration());
  ...
  public String getDialogWidget(
    ...
    if (getNameLower().equals("image")) {
      ...
      CmsVfsImageWidgetConfiguration configuration =
          new CmsVfsImageWidgetConfiguration(
              cms, widgetDialog.getMessages(), param, getConfiguration());
      ...
      CmsGalleryWidgetConfiguration configuration =
          new CmsGalleryWidgetConfiguration(
              cms, widgetDialog.getMessages(), param, getConfiguration());
  ...
  /**
   * Returns the upper case name of the gallery, for example <code>"Html"</code>.
   *
   * <p>
   *
  ...
  /**
   * Returns <code>true</code> if the preview button should be shown.
   *
   * <p>
   *
