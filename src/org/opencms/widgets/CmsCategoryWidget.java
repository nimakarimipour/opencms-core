...
public class CmsCategoryWidget extends A_CmsWidget implements I_CmsADEWidget {
    ...
    private @RUntainted String m_category;
    ...
    public void setConfiguration(@RUntainted String configuration) {
        ...
        Map<String, @RUntainted String> configOptions = CmsWidgetUtil.parsePipeSeparatedConfigString(configuration);
    ...
    public void setEditorValue(
        CmsObject cms,
        @RUntainted Map<String, @RUntainted String[]> formParameters,
