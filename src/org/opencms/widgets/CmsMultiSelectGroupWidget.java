...
public class CmsMultiSelectGroupWidget extends CmsSelectGroupWidget {
     ...
     */
    public CmsMultiSelectGroupWidget(@RUntainted String configuration) {
     ...
     */
    public CmsMultiSelectGroupWidget(@RUntainted String configuration, boolean asCheckboxes) {
    ...
    protected List<CmsSelectWidgetOption> parseSelectOptions(
        ...
        if (getSelectOptions() == null) {
            ...
            if (isUseGroupNames()) {
                ...
                for (Iterator<@RUntainted String> i = getGroupNames().iterator(); i.hasNext();) {
     ...
     */
    private List<@RUntainted String> getGroupNames() {
