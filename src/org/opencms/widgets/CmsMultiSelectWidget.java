 ...
 *
 * <p>The multi select widget does use the following select options:
 *
 * <ul>
 *   <li><code>{@link org.opencms.widgets.CmsSelectWidgetOption#getValue()}</code> for the value of
 *       the option
 *   <li><code>{@link org.opencms.widgets.CmsSelectWidgetOption#isDefault()}</code> for
 *       pre-selecting a specific value
 *   <li><code>{@link org.opencms.widgets.CmsSelectWidgetOption#getOption()}</code> for the display
 *       name of the option
 * </ul>
 *
 * <p>
  ...
  public void setConfiguration(String configuration) {
    ...
    if (CmsStringUtil.isNotEmptyOrWhitespaceOnly(configuration)) {
      ...
      if (asCheckBoxesIndex != -1) {
        // the height is set
        String asCheckBoxes =
            configuration.substring(asCheckBoxesIndex + CONFIGURATION_ASCHECKBOXES.length() + 1);
