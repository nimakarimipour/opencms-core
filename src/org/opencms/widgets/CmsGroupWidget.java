...
public class CmsGroupWidget extends A_CmsWidget implements I_CmsADEWidget {
  ...
  /**
   * Creates a new group selection widget with the parameters to configure the popup window
   * behaviour.
   *
   * <p>
   *
  ...
  public String getConfiguration(
    ...
    return CmsPrincipalSelectDialog.PARAM_TYPE
        + "="
        + CmsPrincipalSelect.WidgetType.groupwidget.name();
  }
  ...
  public String getDialogIncludes(CmsObject cms, I_CmsWidgetDialog widgetDialog) {
    ...
    result.append(
        getJSIncludeFile(CmsWorkplace.getSkinUri() + "components/widgets/groupselector.js"));
    return result.toString();
  }
  ...
  /**
   * Returns the organizational unit fqn, or <code>null</code> if all.
   *
   * <p>
   *
  ...
  /**
   * Returns the user name, or <code>null</code> if all.
   *
   * <p>
   *
