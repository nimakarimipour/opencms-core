...
public class CmsHtmlWidget extends A_CmsHtmlWidget implements I_CmsADEWidget {
    ...
    throws JSONException {
        ...
        @RUntainted String embeddedImageGalleryOptions = widgetOption.getEmbeddedConfigurations().get("imagegallery");
        @RUntainted String embeddedDownloadGalleryOptions = widgetOption.getEmbeddedConfigurations().get("downloadgallery");
