...
public interface I_CmsWidgetDialog {
   ...
   *
   * <p>This is used to prevent the occurence of multiple html <code>div</code> id's with the same
  ...
  /**
   * Returns the "user-agent" of the current request, or <code>null</code> in case no request is
   * available.
   *
   * <p>
   *
   ...
   *
   * <p>This param is not intended for external use.
   *
   * <p>
   *
