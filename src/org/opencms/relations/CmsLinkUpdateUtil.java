...
public final class CmsLinkUpdateUtil {
  ...
  /**
   * Prevents the instanciation of this utility class.
   *
   * <p>
   */
   ...
   * @param updateOnly if set and the element has no {@link CmsLink#NODE_TARGET} subelement, so no
   *     action if executed at all
   */
  ...
  /**
   * Updates the given xml node with the given value.
   *
   * <p>
   *
