 ...
 *
 * <p>The category can be centralized under <code>/system/categories/</code>, or decentralized in
 * every folder.
 *
 * <p>For instance, you can have a category folder under <code>/sites/default/</code> so, any file
 * under <code>/sites/default/</code> could be assigned to any category defined under <code>
 * /system/categories/</code> or <code>/sites/default/categories</code>.
 *
 * <p>But a file under <code>/sites/othersite/</code> will only be assignable to categories defined
 * in <code>/system/categories/</code>.
 *
 * <p>
 *
 * @since 6.9.2
...
public class CmsCategory implements Comparable<CmsCategory>, Serializable {
  ...
  /**
   * Creates a new category based on another one, keeping everything except title and description,
   ...
   */
  public CmsCategory(
      CmsUUID structureId, @RUntainted String rootPath, String title, String description, String baseFolder)
      throws CmsException {
   ...
   * @throws CmsException if the root path does not match the given base folder
   */
  public static @RUntainted String getCategoryPath(@RUntainted String rootPath, @RUntainted String baseFolder) throws CmsException {

    @RUntainted String base;
  ...
  /**
   * Returns the mere category name without it's complete path and without the trailing folder -
   * slash.
   *
   * <p>
   *
   * @return the mere category name without it's complete path and without the trailing folder -
   *     slash
   */
  ...
  public String toString() {
    ...
    return "["
        + CmsCategory.class.getSimpleName()
        + "/"
