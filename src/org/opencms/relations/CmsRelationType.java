 ...
 * <ul>
 *   <li>{@link #HYPERLINK}
 *   <li>{@link #EMBEDDED_IMAGE}
 *   <li>{@link #EMBEDDED_OBJECT}
 *   <li>{@link #XML_STRONG}
 *   <li>{@link #XML_WEAK}
 *   <li>{@link #JSP_STRONG}
 *   <li>{@link #JSP_WEAK}
 ...
 * </ul>
 *
 * <p>User defined relation types are also available.
 *
 * <p>
 *
 * @since 6.3.0
...
public final class CmsRelationType implements Serializable {
  ...
  public static final CmsRelationType CATEGORY =
      new CmsRelationType(9, "CATEGORY", false, false, CopyBehavior.copy);

  /** Constant for the <code>&lt;img src=''&gt;</code> tag in a html page/element. */
  public static final CmsRelationType EMBEDDED_IMAGE =
      new CmsRelationType(2, "IMG", true, true, CopyBehavior.copy);

  /** Constant for the <code>&lt;embed src=''&gt;</code> tag in a html page/element. */
  public static final CmsRelationType EMBEDDED_OBJECT =
      new CmsRelationType(7, "OBJECT", true, true, CopyBehavior.copy);

  /** Constant for the <code>&lt;a href=''&gt;</code> tag in a html page/element. */
  public static final CmsRelationType HYPERLINK =
      new CmsRelationType(1, "A", false, true, CopyBehavior.copy);

  /**
   * Constant for the index content relation, telling the content of a linked resource should be
   * merged into the content of the linking XML.
   */
  public static final CmsRelationType INDEX_CONTENT =
      new CmsRelationType(13, "INDEX_CONTENT", true, true, CopyBehavior.copy);
  ...
  public static final CmsRelationType JSP_STRONG =
      new CmsRelationType(5, PREFIX_JSP + VALUE_STRONG, true, true, CopyBehavior.copy);
  ...
  public static final CmsRelationType JSP_WEAK =
      new CmsRelationType(6, PREFIX_JSP + VALUE_WEAK, false, true, CopyBehavior.copy);

  /** Constant for the organizational units resource associations. */
  public static final CmsRelationType OU_RESOURCE =
      new CmsRelationType(8, "OU", false, false, CopyBehavior.copy);

  /**
   * Constant for the <code>OpenCmsVfsFile</code> values in xml content that were defined as
   * 'strong' links.
   */
  public static final CmsRelationType XML_STRONG =
      new CmsRelationType(3, PREFIX_XML + VALUE_STRONG, true, true, CopyBehavior.copy);

  /**
   * Constant for the <code>OpenCmsVfsFile</code> values in xml content that were defined as 'weak'
   * links.
   */
  public static final CmsRelationType XML_WEAK =
      new CmsRelationType(4, PREFIX_XML + VALUE_WEAK, false, true, CopyBehavior.copy);
  ...
  public static final CmsRelationType LOCALE_VARIANT =
      new CmsRelationType(11, "LOCALE_VARIANT", false, false, CopyBehavior.ignore);

  /**
   * Constant for the type of relations between a detail content and its detail-only container
   * pages.
   */
  public static final CmsRelationType DETAIL_ONLY =
      new CmsRelationType(12, "DETAIL_ONLY", true, false, CopyBehavior.ignore);

  /** Constant for the weak links from xmlcontent to the used xsd. */
  public static final CmsRelationType XSD =
      new CmsRelationType(10, "XSD", true, true, CopyBehavior.copy);
  ...
  public CmsRelationType(int id, @RUntainted String name, String type) {
    ...
    if (OpenCms.getRunLevel() > OpenCms.RUNLEVEL_2_INITIALIZING) {
      ...
      throw new CmsInitException(
          Messages.get().container(Messages.ERR_RELATION_TYPE_INIT_1, m_name));
    }
   ...
   */
  public static List<CmsRelationType> filterDefinedInContent(
      Collection<CmsRelationType> relationTypes) {
   ...
   * @return a list of {@link CmsRelationType} objects
   */
  public static List<CmsRelationType> filterNotDefinedInContent(
      Collection<CmsRelationType> relationTypes) {
  ...
  /**
   * Parses an <code>int</code> into a relation type.
   *
   * <p>
   *
  ...
  /**
   * Parses an <code>String</code> into a relation type.
   *
   * <p>
   *
   ...
   * descriptors for JSP pages like "JSP_WEAK" or "JSP_STRONG".
   *
   * <p>
   *
   ...
   *
   * <p>This should be used to extend Strings like "weak" or "strong" to full relation type
   * descriptors for XML documents like "XML_WEAK" or "XML_STRONG".
   *
   * <p>
   *
  ...
  /**
   * Gets the 'copy behavior' of the relation type, which is how relations of a resource should be
   * handled when copying that resource.
   *
   * <p>
   *
   ...
   *
   * <p>The short type name of XML or JSP types is only <code>"WEAK"</code> or <code>"STRONG"</code>
   * . For other types the short name is equal to the name.
   *
   * <p>In case you need the full type name, use {@link #getName()}.
   *
   * <p>
   *
