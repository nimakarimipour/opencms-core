...
public final class CmsRelationFilter implements Cloneable {
  ...
  public CmsRelationFilter filterDefinedInContent() {
    ...
    if (filter.m_types.isEmpty()) {
      ...
      filter.m_types =
          new HashSet<CmsRelationType>(CmsRelationType.filterDefinedInContent(filter.m_types));
    }
    return filter;
  }

  /**
   * Returns an extended filter that will extend the result to the given path and all its
   * subresources.
   *
   * <p>
   *
  ...
  public CmsRelationFilter filterNotDefinedInContent() {
    ...
    if (filter.m_types.isEmpty()) {
      ...
      filter.m_types =
          new HashSet<CmsRelationType>(CmsRelationType.filterNotDefinedInContent(filter.m_types));
    }
    return filter;
  }
  ...
  public CmsRelationFilter filterUserDefined() {
    ...
    if (filter.m_types.isEmpty()) {
      ...
      filter.m_types =
          new HashSet<CmsRelationType>(CmsRelationType.filterUserDefined(filter.m_types));
    }
    return filter;
  }
  ...
  /**
   * Returns <code>true</code> if the given relation type matches this filter.
   *
   * <p>
   *
