...
public final class Messages extends A_CmsMessageBundle {
  ...
  /** Message constant for key in the resource bundle. */
  public static final String GUI_RELATIONS_VALIDATION_DEFAULT_SUBJECT_0 =
      "GUI_RELATIONS_VALIDATION_DEFAULT_SUBJECT_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_RELATIONS_VALIDATION_PROJECT_1 =
  ...
  /** Message constant for key in the resource bundle. */
  public static final String LOG_LINK_VALIDATION_READBYID_FAILED_2 =
      "LOG_LINK_VALIDATION_READBYID_FAILED_2";

  /** Message constant for key in the resource bundle. */
  public static final String LOG_LINK_VALIDATION_READBYPATH_FAILED_2 =
      "LOG_LINK_VALIDATION_READBYPATH_FAILED_2";

  /** Message constant for key in the resource bundle. */
  public static final String LOG_LINK_VALIDATION_RESOURCEDELETED_1 =
      "LOG_LINK_VALIDATION_RESOURCEDELETED_1";

  /** Message constant for key in the resource bundle. */
  public static final String LOG_LINK_VALIDATION_RESOURCENOTINLOOKUP_1 =
