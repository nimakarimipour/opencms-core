...
public class CmsRepositorySession extends A_CmsRepositorySession {
     ...
     */
    public Map<CmsPropertyName, String> getProperties(@RUntainted String path) throws CmsException {
     ...
     */
    public void updateProperties(@RUntainted String path, Map<CmsPropertyName, String> properties) throws CmsException {
     ...
     */
    private String validatePath(@RUntainted String path) throws CmsSecurityException {
