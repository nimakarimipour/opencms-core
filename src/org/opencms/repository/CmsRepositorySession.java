...
public class CmsRepositorySession extends A_CmsRepositorySession {
     ...
     */
    public static @RPolyTainted String decodeNamespace(@RPolyTainted String code) throws Exception {
     ...
     */
    public boolean exists(@RUntainted String path) {
     ...
     */
    public CmsRepositoryLockInfo getLock(@RUntainted String path) {
    ...
    public Map<CmsPropertyName, String> getProperties(String path) throws CmsException {
        ...
        Map<@RUntainted String, CmsProperty> props = m_cms.readProperties(path);
        Map<CmsPropertyName, String> out = new HashMap<>();
        for (Map.Entry<@RUntainted String, CmsProperty> entry : props.entrySet()) {
     ...
     */
    public void updateProperties(@RUntainted String path, Map<CmsPropertyName, @RUntainted String> properties) throws CmsException {
     ...
     */
    private @RUntainted String validatePath(@RUntainted String path) throws CmsSecurityException {
