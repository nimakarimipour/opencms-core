 ...
 *
 * <p>Since different types of repositories have very different methods, this interface only
 * provides the bare minimum of methods which are necessary for configuration.
 *
 * <p>
 *
 * @since 6.2.4
...
public interface I_CmsRepository extends I_CmsConfigurationParameterHandler {
  ...
  /**
   * Returns true if the repository specific file translations are enabled (they may also be set
