 ...
 *
 * <p>The configuration of the used {@link I_CmsResourceWrapper} is done here. This is the main
 * class to get access to the resources in the VFS of OpenCms. The method {@link #login(String,
 * String)} logs in to OpenCms and returns a {@link CmsRepositorySession} to use for basic file and
 * folder operations.
 *
 * <p>The project and the site to use for the access to OpenCms is read out of the user settings.
 *
 * <p>
 *
...
public class CmsRepository extends A_CmsRepository {
  ...
  public CmsRepository() {
    ...
    CacheBuilder<?, ?> builder =
        CacheBuilder.newBuilder().concurrencyLevel(4).expireAfterWrite(30, TimeUnit.SECONDS);
  ...
  public void initConfiguration() throws CmsConfigurationException {
    ...
    List<I_CmsResourceWrapper> wrapperObjects =
        CmsRepositoryManager.createResourceWrappersFromConfiguration(config, PARAM_WRAPPER, LOG);
  ...
  public I_CmsRepositorySession login(String userName, String password) throws CmsException {
    ...
    return new CmsRepositorySession(
        objWrapper, getFilter(), isTranslationEnabled() ? getTranslation() : null);
  }
}
