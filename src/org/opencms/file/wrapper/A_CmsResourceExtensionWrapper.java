 ...
 * and remove file extensions to resources.
 *
 * <p>
 *
 * @since 6.5.6
...
public abstract class A_CmsResourceExtensionWrapper extends A_CmsResourceWrapper {
  ...
  public CmsLock getLock(CmsObject cms, CmsResource resource) throws CmsException {
    ...
    if (checkTypeId(resource.getTypeId())) {
      ...
      wrap.setRootPath(
          CmsResourceWrapperUtils.removeFileExtension(cms, resource.getRootPath(), getExtension()));
  ...
  public CmsFile readFile(CmsObject cms, String resourcename, CmsResourceFilter filter)
    ...
    if (res != null) {
      ...
      wrap.setRootPath(
          CmsResourceWrapperUtils.addFileExtension(cms, res.getRootPath(), getExtension()));
  ...
  /**
   * Trys to read the resourcename after removing the file extension and return the resource if the
   * type id is correct.
   *
   * <p>
   *
