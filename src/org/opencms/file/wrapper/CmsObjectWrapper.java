...
public class CmsObjectWrapper {
     ...
     */
    public CmsResource createResource(@RUntainted String resourcename, @RUntainted int type, byte[] content, List<CmsProperty> properties)
    throws CmsException, CmsIllegalArgumentException {
    ...
    public List<CmsResource> getResourcesInFolder(@RUntainted String resourcename, CmsResourceFilter filter) throws CmsException {
        ...
        while (iter2.hasNext()) {
            @RUntainted CmsResource res = iter2.next();
    ...
    public CmsResource readResource(@RUntainted String resourcename, CmsResourceFilter filter) throws CmsException {
        ...
        @RUntainted CmsResource res = null;
     ...
     * @throws CmsException if something goes wrong
     */
    public CmsUser readUser(@RUntainted CmsUUID userId) throws CmsException {
