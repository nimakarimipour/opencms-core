...
/**
 * Default abstract implementation of the interface {@link I_CmsResourceWrapper}.
 *
 * <p>This class returns for all methods that the action is not handled by the resource wrapper.
 *
 * <p>Subclasses can only implement those methods where they want to change the default behaviour.
 *
 * <p>
 *
 * @since 6.5.6
...
public abstract class A_CmsResourceWrapper implements I_CmsResourceWrapper {
  ...
  /**
   * @see
   *     org.opencms.file.wrapper.I_CmsResourceWrapper#addResourcesToFolder(org.opencms.file.CmsObject,
  ...
  /**
   * @see org.opencms.file.wrapper.I_CmsResourceWrapper#copyResource(org.opencms.file.CmsObject,
  ...
  /**
   * @see org.opencms.file.wrapper.I_CmsResourceWrapper#createResource(org.opencms.file.CmsObject,
  ...
  /**
   * @see org.opencms.file.wrapper.I_CmsResourceWrapper#deleteResource(org.opencms.file.CmsObject,
  ...
  /**
   * @see org.opencms.file.wrapper.I_CmsResourceWrapper#getLock(org.opencms.file.CmsObject,
  ...
  /**
   * @see org.opencms.file.wrapper.I_CmsResourceWrapper#lockResource(org.opencms.file.CmsObject,
  ...
  /**
   * @see org.opencms.file.wrapper.I_CmsResourceWrapper#moveResource(org.opencms.file.CmsObject,
  ...
  /**
   * @see org.opencms.file.wrapper.I_CmsResourceWrapper#readFile(org.opencms.file.CmsObject,
   *     java.lang.String, org.opencms.file.CmsResourceFilter)
   */
  ...
  /**
   * @see org.opencms.file.wrapper.I_CmsResourceWrapper#readResource(org.opencms.file.CmsObject,
   *     java.lang.String, org.opencms.file.CmsResourceFilter)
   */
  ...
  /**
   * @see org.opencms.file.wrapper.I_CmsResourceWrapper#restoreLink(org.opencms.file.CmsObject,
   *     java.lang.String)
   */
  ...
  /**
   * @see org.opencms.file.wrapper.I_CmsResourceWrapper#wrapResource(org.opencms.file.CmsObject,
   *     org.opencms.file.CmsResource)
   */
  ...
  /**
   * @see org.opencms.file.wrapper.I_CmsResourceWrapper#writeFile(org.opencms.file.CmsObject,
