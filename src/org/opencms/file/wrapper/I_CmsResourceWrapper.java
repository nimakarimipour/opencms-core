...
public interface I_CmsResourceWrapper {
     ...
     */
    void configure(@RUntainted String configuration);
     ...
     */
    CmsFile readFile(CmsObject cms, @RUntainted String resourcename, CmsResourceFilter filter) throws CmsException;
     ...
     */
    @RUntainted CmsResource readResource(CmsObject cms, @RUntainted String resourcename, CmsResourceFilter filter) throws CmsException;
     ...
     */
    @RUntainted String restoreLink(CmsObject cms, @RUntainted String uri);
     ...
     * @throws CmsException if something goes wrong
     */
    boolean unlockResource(CmsObject cms, @RUntainted String resourcename) throws CmsException;
