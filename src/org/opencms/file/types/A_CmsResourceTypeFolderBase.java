...
public abstract class A_CmsResourceTypeFolderBase extends A_CmsResourceType {
  ...
  @Override
  public void chtype(
      CmsObject cms, CmsSecurityManager securityManager, CmsResource filename, int newType)
  ...
  public void copyResource(
    ...
    List<CmsResource> resources =
        securityManager.readChildResources(
            cms.getRequestContext(), source, CmsResourceFilter.IGNORE_EXPIRATION, true, true);
  ...
  public void replaceResource(
    ...
    if (type != getTypeId()) {
      ...
      throw new CmsDataNotImplementedException(
          Messages.get()
              .container(Messages.ERR_REPLACE_RESOURCE_FOLDER_1, cms.getSitePath(resource)));
    }
  ...
  public void setDateExpired(
    ...
    if (recursive) {
      ...
      List<CmsResource> resources =
          securityManager.readChildResources(
              cms.getRequestContext(), resource, CmsResourceFilter.IGNORE_EXPIRATION, true, true);
  ...
  /**
   * @see org.opencms.file.types.A_CmsResourceType#undelete(org.opencms.file.CmsObject,
   *     org.opencms.db.CmsSecurityManager, org.opencms.file.CmsResource, boolean)
   */
  @Override
  public void undelete(
    ...
    if (recursive) {
      ...
      List<CmsResource> resources =
          securityManager.readChildResources(
              cms.getRequestContext(), resource, CmsResourceFilter.ALL, true, true);
      ...
      for (int i = 0; i < resources.size(); i++) {
        ...
        if (isMoved) {
          securityManager.lockResource(
              cms.getRequestContext(), childResource, CmsLockType.EXCLUSIVE);
        }
