...
/**
 * Resource type descriptor used in case the given resource type class in the XML configuration
 * could not be instantiated.
 *
 * <p>Using this class usually indicates that the class name given in the XML configuration is
 * unavailable. This can be the case if a module with a new resource type is imported, where the
 * resource type class comes as part of the module and OpenCms must be restarted after the module
 * import.
 *
 * <p>
 *
...
public class CmsResourceTypeUnknown extends A_CmsResourceType {
  ...
  /**
   * Unknown resource types are always loaded with the <code>{@link CmsDumpLoader}</code>.
   *
   * <p>
   *
