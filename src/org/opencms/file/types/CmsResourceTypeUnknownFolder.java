 ...
 *
 * <p>This will be used for folder corpses when the resource type is not configured.
 *
 * <p>The most common use case is when deleting a module with the resource type definition, but not
 * the content that uses that resource type definition.
 *
 * <p>
 *
 * @since 7.0.0
