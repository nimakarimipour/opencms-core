 ...
 *
 * <p>Ensures that some required file properties are attached to new JSPs.
 *
 * <p>The value for the encoding properties of a new JSP usually is the system default encoding, but
 * this can be overwritten by a configuration parameters set in <code>opencms-vfs.xml</code>.
 *
 * <p>
 *
 * @since 6.0.0
...
public class CmsResourceTypeJsp extends A_CmsResourceTypeLinkParseable {
  ...
  /**
   * Returns <code>true</code> in case the given resource is a JSP.
   *
   * <p>Internally this checks if the given resource type has an id that is registered as a JSP
   * resource type.
   *
   * <p>
   *
  ...
  /**
   * Returns <code>true</code> in case the given resource type id is a JSP type.
   *
   * <p>Internally this checks if the given resource type id is registered as a JSP resource type.
   *
   * <p>
   *
  ...
  /**
   * @see org.opencms.file.types.A_CmsResourceType#chtype(org.opencms.file.CmsObject,
   *     org.opencms.db.CmsSecurityManager, org.opencms.file.CmsResource, int)
   */
  @Override
  public void chtype(
  ...
  /**
   * @see org.opencms.file.types.A_CmsResourceType#deleteResource(org.opencms.file.CmsObject,
  ...
  /**
   * @see
   *     org.opencms.file.types.A_CmsResourceType#getFormattersForResource(org.opencms.file.CmsObject,
  ...
  public CmsFormatterConfiguration getFormattersForResource(CmsObject cms, CmsResource res) {
    ...
    try {
      ...
      String formatterSetting =
          cms.readPropertyObject(res, CmsPropertyDefinition.PROPERTY_TEMPLATE, false).getValue();
    ...
    CmsFormatterBean selfFormatter =
    ...
    return CmsFormatterConfiguration.create(
        cms, Collections.<I_CmsFormatterBean>singletonList(selfFormatter));
  }
  ...
  /**
   * @see org.opencms.file.types.A_CmsResourceType#moveResource(org.opencms.file.CmsObject,
  ...
  /**
   * @see org.opencms.relations.I_CmsLinkParseable#parseLinks(org.opencms.file.CmsObject,
  ...
  /**
   * @see org.opencms.file.types.A_CmsResourceType#replaceResource(org.opencms.file.CmsObject,
  ...
  /**
   * @see org.opencms.file.types.A_CmsResourceType#restoreResource(org.opencms.file.CmsObject,
   *     org.opencms.db.CmsSecurityManager, org.opencms.file.CmsResource, int)
   */
  @Override
  ...
  /**
   * @see org.opencms.file.types.A_CmsResourceType#setDateExpired(org.opencms.file.CmsObject,
   *     org.opencms.db.CmsSecurityManager, org.opencms.file.CmsResource, long, boolean)
   */
  @Override
  ...
  /**
   * @see org.opencms.file.types.A_CmsResourceType#setDateLastModified(org.opencms.file.CmsObject,
   *     org.opencms.db.CmsSecurityManager, org.opencms.file.CmsResource, long, boolean)
   */
  @Override
  ...
  /**
   * @see org.opencms.file.types.A_CmsResourceType#setDateReleased(org.opencms.file.CmsObject,
   *     org.opencms.db.CmsSecurityManager, org.opencms.file.CmsResource, long, boolean)
   */
  @Override
  ...
  /**
   * @see org.opencms.file.types.A_CmsResourceType#undoChanges(org.opencms.file.CmsObject,
   *     org.opencms.db.CmsSecurityManager, org.opencms.file.CmsResource,
  ...
  /**
   * @see org.opencms.file.types.A_CmsResourceType#writeFile(org.opencms.file.CmsObject,
   ...
   */
  protected Set<String> getReferencingStrongLinks(CmsObject cms, CmsResource resource)
      throws CmsException {
  ...
  /**
   * Adds another resource type id to the registered JSP resource type id's.
   *
   * <p>
   *
