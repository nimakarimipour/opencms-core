...
public abstract class A_CmsResourceType implements I_CmsResourceType {
  ...
  public static final String DEFAULT_GALLERY_PREVIEW_PROVIDER =
      "org.opencms.ade.galleries.preview.CmsBinaryPreviewProvider";
   ...
   *
   * <p>The "copy resources" are copied to the specified location after a new resource of this type
   * is created. Usually this feature is used to populate a newly created folder with some default
   * resources.
   *
   * <p>If target is <code>null</code>, the macro {@link #MACRO_RESOURCE_FOLDER_PATH} is used as
   * default. If type is <code>null</code>, the copy type {@link CmsResource#COPY_AS_NEW} is used as
   * default.
   *
   * <p>
   *
   ...
   */
  public void addCopyResource(String source, String target, String type)
    ...
    if (LOG.isDebugEnabled()) {
      LOG.debug(
          Messages.get()
              .getBundle()
              .key(Messages.LOG_ADD_COPY_RESOURCE_4, new Object[] {this, source, target, type}));
    }
    ...
    CmsConfigurationCopyResource copyResource =
        new CmsConfigurationCopyResource(source, target, type);
  ...
  /**
   * @see org.opencms.file.types.I_CmsResourceType#changeLock(org.opencms.file.CmsObject,
  ...
  /**
   * @see org.opencms.file.types.I_CmsResourceType#chflags(org.opencms.file.CmsObject,
   *     CmsSecurityManager, CmsResource, int)
   */
  public void chflags(
      CmsObject cms, CmsSecurityManager securityManager, CmsResource resource, int flags)
      throws CmsException {
  ...
  /**
   * @see org.opencms.file.types.I_CmsResourceType#chtype(org.opencms.file.CmsObject,
   *     org.opencms.db.CmsSecurityManager, org.opencms.file.CmsResource,
   ...
   *     instead. Resource types should always be referenced either by its type class (preferred) or
   *     by type name. Use of int based resource type references will be discontinued in a future
   *     OpenCms release.
   */
  @Deprecated
  public void chtype(
      CmsObject cms, CmsSecurityManager securityManager, CmsResource resource, int type)
      throws CmsException {
  ...
  /**
   * @see org.opencms.file.types.I_CmsResourceType#copyResource(org.opencms.file.CmsObject,
   *     CmsSecurityManager, CmsResource, java.lang.String, CmsResource.CmsResourceCopyMode)
   */
  public void copyResource(
    ...
    securityManager.copyResource(
        ...
        siblingMode);
    // create the relations for the new resource, this could be improved by an sql query for copying
    // relations
    createRelations(cms, securityManager, cms.getRequestContext().addSiteRoot(destination));
  }

  /**
   * @see org.opencms.file.types.I_CmsResourceType#copyResourceToProject(org.opencms.file.CmsObject,
   *     CmsSecurityManager, CmsResource)
   */
  public void copyResourceToProject(
      CmsObject cms, CmsSecurityManager securityManager, CmsResource resource) throws CmsException {

    securityManager.copyResourceToProject(cms.getRequestContext(), resource);
  }

  /**
   * @see org.opencms.file.types.I_CmsResourceType#createResource(org.opencms.file.CmsObject,
   *     CmsSecurityManager, java.lang.String, byte[], List)
   */
  public CmsResource createResource(
    ...
    CmsResource result =
        securityManager.createResource(
            cms.getRequestContext(),
    ...
    if ((m_internal != null) && m_internal.booleanValue()) {
      securityManager.chflags(
          cms.getRequestContext(), result, result.getFlags() ^ CmsResource.FLAG_INTERNAL);
    }
  ...
  /**
   * @see org.opencms.file.types.I_CmsResourceType#createSibling(org.opencms.file.CmsObject,
   *     org.opencms.db.CmsSecurityManager, CmsResource, java.lang.String, java.util.List)
   */
  ...
  /**
   * @see org.opencms.file.types.I_CmsResourceType#deleteResource(org.opencms.file.CmsObject,
   *     CmsSecurityManager, CmsResource, CmsResource.CmsResourceDeleteMode)
   */
  ...
  /**
   * Returns <code>true</code>, if this resource type is equal to the given Object.
   *
   * <p>Please note: A resource type is identified by it's id {@link #getTypeId()} and it's name
   * {@link #getTypeName()}. Two resource types are considered equal, if either their id or their
   * name is equal. This is to prevent issues in the configuration with multiple occurrences of the
   * same name or id.
   *
   * <p>
   *
  ...
  /**
   * @see
   *     org.opencms.file.types.I_CmsResourceType#getFormattersForResource(org.opencms.file.CmsObject,
  ...
  public String getGalleryPreviewProvider() {
    ...
    if (m_galleryPreviewProvider == null) {
      m_galleryPreviewProvider =
          getConfiguration().getString(CONFIGURATION_GALLERY_PREVIEW_PROVIDER, null);
    }
  ...
  public List<I_CmsResourceType> getGalleryTypes() {
    ...
    if (m_galleryTypes == null) {
      ...
      if (!CmsStringUtil.isEmptyOrWhitespaceOnly(m_galleryTypeNames)) {
        ...
        Iterator<String> iTypeNames =
            CmsStringUtil.splitAsList(m_galleryTypeNames, CmsProperty.VALUE_LIST_DELIMITER)
                .iterator();
        while (iTypeNames.hasNext()) {
          ...
          try {
            ...
            if (LOG.isWarnEnabled()) {
              LOG.warn(
                  Messages.get().container(Messages.ERR_COULD_NOT_READ_RESOURCE_TYPE_1, typeName));
            }
          }
        }
      }
   ...
   *     referenced either by its type class (preferred) or by type name. Use of int based resource
  ...
  /**
   * @see org.opencms.file.types.I_CmsResourceType#importResource(org.opencms.file.CmsObject,
   *     org.opencms.db.CmsSecurityManager, org.opencms.report.I_CmsReport, java.lang.String,
   *     org.opencms.file.CmsResource, byte[], java.util.List)
   */
  ...
  public final void initConfiguration() {
    ...
    // final since subclasses should NOT implement this, but rather the version with 3 String
  ...
  /**
   * @see org.opencms.file.types.I_CmsResourceType#initConfiguration(java.lang.String,
  ...
  /**
   * @see
   *     org.opencms.file.types.I_CmsResourceType#isIdentical(org.opencms.file.types.I_CmsResourceType)
   */
  ...
  /**
   * @see org.opencms.file.types.I_CmsResourceType#lockResource(org.opencms.file.CmsObject,
   *     org.opencms.db.CmsSecurityManager, org.opencms.file.CmsResource,
  ...
  /**
   * @see org.opencms.file.types.I_CmsResourceType#moveResource(org.opencms.file.CmsObject,
   *     org.opencms.db.CmsSecurityManager, org.opencms.file.CmsResource, java.lang.String)
   */
    ...
    if (resource.getRootPath().equals(dest)) {
      ...
      throw new CmsVfsException(
          org.opencms.file.Messages.get()
              .container(org.opencms.file.Messages.ERR_MOVE_SAME_NAME_1, destination));
    }
  ...
  /**
   * @see
   *     org.opencms.file.types.I_CmsResourceType#removeResourceFromProject(org.opencms.file.CmsObject,
   *     org.opencms.db.CmsSecurityManager, org.opencms.file.CmsResource)
   */
  ...
  /**
   * @see org.opencms.file.types.I_CmsResourceType#replaceResource(org.opencms.file.CmsObject,
   *     org.opencms.db.CmsSecurityManager, org.opencms.file.CmsResource,
   *     org.opencms.file.types.I_CmsResourceType, byte[], java.util.List)
   */
  ...
  /**
   * @see org.opencms.file.types.I_CmsResourceType#replaceResource(org.opencms.file.CmsObject,
   *     CmsSecurityManager, CmsResource, int, byte[], List)
   ...
   *     either by its type class (preferred) or by type name. Use of int based resource type
  ...
  /**
   * @see org.opencms.file.types.I_CmsResourceType#restoreResource(org.opencms.file.CmsObject,
   *     CmsSecurityManager, CmsResource, int)
   */
  ...
  /**
   * @see org.opencms.file.types.I_CmsResourceType#setDateExpired(org.opencms.file.CmsObject,
  ...
  /**
   * @see org.opencms.file.types.I_CmsResourceType#setDateLastModified(org.opencms.file.CmsObject,
   *     CmsSecurityManager, CmsResource, long, boolean)
   */
  ...
  /**
   * @see org.opencms.file.types.I_CmsResourceType#setDateReleased(org.opencms.file.CmsObject,
   *     CmsSecurityManager, CmsResource, long, boolean)
   */
  ...
  /**
   * @see org.opencms.file.types.I_CmsResourceType#undelete(org.opencms.file.CmsObject,
   *     CmsSecurityManager, CmsResource, boolean)
   */
  ...
  /**
   * @see org.opencms.file.types.I_CmsResourceType#undoChanges(org.opencms.file.CmsObject,
   *     CmsSecurityManager, CmsResource, CmsResource.CmsResourceUndoMode)
   */
  ...
  /**
   * @see org.opencms.file.types.I_CmsResourceType#unlockResource(org.opencms.file.CmsObject,
   *     CmsSecurityManager, CmsResource)
   */
  ...
  /**
   * @see org.opencms.file.types.I_CmsResourceType#writeFile(org.opencms.file.CmsObject,
   *     CmsSecurityManager, CmsFile)
   */
  ...
  /**
   * @see org.opencms.file.types.I_CmsResourceType#writePropertyObject(org.opencms.file.CmsObject,
   *     org.opencms.db.CmsSecurityManager, CmsResource, org.opencms.file.CmsProperty)
   */
  ...
  /**
   * @see org.opencms.file.types.I_CmsResourceType#writePropertyObjects(org.opencms.file.CmsObject,
   *     org.opencms.db.CmsSecurityManager, CmsResource, java.util.List)
   */
  ...
  protected CmsResource createRelations(
      CmsObject cms, CmsSecurityManager securityManager, String resourceName) throws CmsException {

    CmsResource resource =
        securityManager.readResource(cms.getRequestContext(), resourceName, CmsResourceFilter.ALL);
  ...
  /**
   * Creates a macro resolver based on the current users OpenCms context and the provided resource
   * name.
   *
   * <p>
   *
   * @param cms the current OpenCms user context
   * @param resourcename the resource name for macros like {@link
   *     A_CmsResourceType#MACRO_RESOURCE_FOLDER_PATH}
   * @return a macro resolver based on the current users OpenCms context and the provided resource
   *     name
   */
   ...
   */
  protected void processCopyResources(
      CmsObject cms, String resourcename, CmsMacroResolver resolver) {

    Map<String, String> copiedResources = new HashMap<String, String>();
    for (CmsConfigurationCopyResource oriCopyResource :
        getCopyResources(cms, resourcename, resolver)) {

      // store original copy target
      String oriTarget = oriCopyResource.getTarget();
      String target = oriTarget;

      List<CmsConfigurationCopyResource> copyResources =
          new ArrayList<CmsConfigurationCopyResource>();
      try {
        ...
        if (oriCopyResource.getSource().endsWith("*")) {
          ...
          String source =
              oriCopyResource.getSource().substring(0, oriCopyResource.getSource().length() - 1);
          List<CmsResource> sources =
              cms.readResources(source, CmsResourceFilter.IGNORE_EXPIRATION, false);
        ...
        for (CmsConfigurationCopyResource copyResource : copyResources) {
          ...
          target =
              CmsFileUtil.normalizePath(CmsLinkManager.getAbsoluteUri(target, resourcename), '/');
          ...
          if (CmsMacroResolver.isMacro(oriTarget, MACRO_RESOURCE_FOLDER_PATH_TOUCH)) {
            ...
            if (res.isFile()) {
              ...
              Iterator<CmsResource> it =
                  cms.readResources(target, CmsResourceFilter.DEFAULT_FILES, true).iterator();
              while (it.hasNext()) {
        ...
        if (LOG.isDebugEnabled()) {
          ...
          LOG.debug(
              Messages.get()
                  .getBundle()
                  .key(
                      Messages.LOG_PROCESS_COPY_RESOURCES_3, resourcename, oriCopyResource, target),
              e);
        } else {
          LOG.error(
              Messages.get()
    ...
    try {
      if (!CmsStringUtil.isEmptyOrWhitespaceOnly(m_adjustLinksFolder)
          && !copiedResources.isEmpty()) {
   ...
   *
   * <p>It's possible to use OpenCms macros for the property values. Please see {@link
   * CmsMacroResolver} for allowed macro values.
   *
   * <p>
   *
   ...
   */
  protected List<CmsProperty> processDefaultProperties(
      List<CmsProperty> properties, CmsMacroResolver resolver) {
   ...
   * @throws CmsException if something goes wrong
   */
  protected void updateRelationForUndo(
      CmsObject cms, CmsSecurityManager securityManager, CmsResource resource) throws CmsException {
    ...
    CmsResource undoneResource2 =
        securityManager.readResource(
            cms.getRequestContext(), resource.getStructureId(), CmsResourceFilter.ALL);
    if (!undoneResource2.equals(undoneResource1)) {
      I_CmsResourceType resourceType = getResourceType(resource);
      List<CmsLink> links = null;
      if (resourceType instanceof I_CmsLinkParseable) {
        I_CmsLinkParseable linkParseable = (I_CmsLinkParseable) resourceType;
        if ((undoneResource1 == null)
            || !undoneResource2.getRootPath().equals(undoneResource1.getRootPath())) {
          try {
