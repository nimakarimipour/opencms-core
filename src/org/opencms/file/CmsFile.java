 ...
 *
 * <p>A file resource is a CmsResource that contains an additional byte array of binary data, which
 * is the file content.
 *
 * <p>A file object is not allowed to have sub-resources.
 *
 * <p>
 *
 * @since 6.0.0
...
public class CmsFile extends CmsResource {
   ...
   * content, if the resource does not implement a file.
   *
   * <p>
   *
   ...
   *
   * <p>This will also set the date content, but only if the content is already set.
   *
   * <p>
   *
