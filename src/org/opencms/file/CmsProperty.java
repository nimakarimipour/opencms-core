 ...
 *
 * <p>A property is an object that contains three string values: a name, a property value which is
 * mapped to the structure record of a resource, and a property value which is mapped to the
 * resource record of a resource. A property object is valid if it has both values or just one value
 * set. Each property needs at least a name and one value set.
 *
 * <p>A property value mapped to the structure record of a resource is significant for a single
 * resource (sibling). A property value mapped to the resource record of a resource is significant
 * for all siblings of a resource record. This is possible by getting the "compound value" (see
 * {@link #getValue()}) of a property in case a property object has both values set. The compound
 ...
 *
 * <p>The ID of the structure or resource record where a property value is mapped to is represented
 * by the "PROPERTY_MAPPING_ID" table attribute in the database. The "PROPERTY_MAPPING_TYPE" table
 * attribute (see {@link #STRUCTURE_RECORD_MAPPING} and {@link #RESOURCE_RECORD_MAPPING}) determines
 * whether the value of the "PROPERTY_MAPPING_ID" attribute of the current row is a structure or
 * resource record ID.
 *
 * <p>Property objects are written to the database using {@link
 * org.opencms.file.CmsObject#writePropertyObject(String, CmsProperty)} or {@link
 * org.opencms.file.CmsObject#writePropertyObjects(String, List)}, no matter whether you want to
 * save a new (non-existing) property, update an existing property, or delete an existing property.
 * To delete a property you would write a property object with either the structure and/or resource
 * record values set to {@link #DELETE_VALUE} to indicate that a property value should be deleted in
 * the database. Set property values to null if they should remain unchanged in the database when a
 * property object is written. As for example you want to update just the structure value of a
 * property, you would set the structure value to the new string, and the resource value to null
 * (which is already the case by default).
 *
 * <p>Use {@link #setAutoCreatePropertyDefinition(boolean)} to set a boolean flag whether a missing
 * property definition should be created implicitly for a resource type when a property is written
 * to the database. The default value for this flag is <code>false</code>. Thus, you receive a
 * CmsException if you try to write a property of a resource with a resource type which lacks a
 * property definition for this resource type. It is not a good style to set {@link
 * #setAutoCreatePropertyDefinition(boolean)} on true to make writing properties to the database
 * work in any case, because then you will loose control about which resource types support which
...
public class CmsProperty implements Serializable, Cloneable, Comparable<CmsProperty> {
  ...
  /**
   * Signals that the resource property values of a resource should be deleted using
   * deleteAllProperties.
   *
   * <p>
   */
  ...
  /**
   * Signals that both the structure and resource property values of a resource should be deleted
   * using deleteAllProperties.
   *
   * <p>
   */
  ...
  /**
   * Signals that the structure property values of a resource should be deleted using
   * deleteAllProperties.
   *
   * <p>
   */
  ...
  /**
   * An empty string to decide that a property value should be deleted when this property object is
  ...
  /**
   * Value of the "mapping-type" database attribute to indicate that a property value is mapped to a
   * resource record.
   *
   * <p>
   */
  ...
  /**
   * The delimiter value for separating values in a list, per default this is the <code>|</code>
   * char.
   */
  public static final char VALUE_LIST_DELIMITER = '|';

  /**
   * The list delimiter replacement String used if the delimiter itself is contained in a String
   * value.
   */
  public static final String VALUE_LIST_DELIMITER_REPLACEMENT = "%(ld)";

  /**
   * The delimiter value for separating values in a map, per default this is the <code>=</code>
   * char.
   */
  public static final char VALUE_MAP_DELIMITER = '=';

  /**
   * The map delimiter replacement String used if the delimiter itself is contained in a String
   * value.
   */
  ...
  /**
   * Static initializer required for freezing the <code>{@link #NULL_PROPERTY}</code>.
   *
   * <p>
   */
  static {
   ...
   *
   * <p>The structure and resource property values are initialized to null. The structure and
  ...
  public CmsProperty() {
    ...
    // nothing to do, all values will be initialized with <code>null</code> or <code>false</code> by
    // default
  }
   ...
   *
   * <p>If the property definition does not exist for the resource type it is automatically created
   * when this property is written.
   *
   ...
   */
  public CmsProperty(String name, @RUntainted String structureValue, @RUntainted String resourceValue) {
   ...
   * Creates a new CmsProperty object using the provided values.
   *
   * <p>If <code>null</code> is supplied for the resource or structure value, this value will not be
   ...
   * @param autoCreatePropertyDefinition if <code>true</code>, the property definition for this
   *     property will be created implicitly on any write operation if it doesn't exist already
   */
  public CmsProperty(
      String name,
      @RUntainted String structureValue,
      @RUntainted String resourceValue,
  ...
  /**
   * Searches in a list for the first occurrence of a {@link CmsProperty} object with the given
   * name.
   *
   * <p>To check if the "null property" has been returned if a property was not found, use {@link
   * #isNullProperty()} on the result.
   *
   * <p>
   *
   * @param name a property name
   * @param list a list of {@link CmsProperty} objects
   * @return the index of the first occurrence of the name in they specified list, or {@link
   *     CmsProperty#getNullProperty()} if the name is not found
   */
  ...
  /**
   * Calls <code>{@link #setAutoCreatePropertyDefinition(boolean)}</code> for each property object
   * in the given List with the given <code>value</code> parameter.
   *
   * <p>This method will modify the objects in the input list directly.
   *
   * <p>
   *
   ...
   */
  public static final List<CmsProperty> setAutoCreatePropertyDefinitions(
      List<CmsProperty> list, boolean value) {
  ...
  /**
   * Calls <code>{@link #setFrozen(boolean)}</code> for each {@link CmsProperty} object in the given
   * List if it is not already frozen.
   *
   * <p>This method will modify the objects in the input list directly.
   *
   * <p>
  ...
  /**
   * Transforms a Map of String values into a list of {@link CmsProperty} objects with the property
   * name set from the Map key, and the structure value set from the Map value.
   *
   * <p>
   *
  ...
  public static List<CmsProperty> toList(Map<String, String> map) {
    ...
    while (i.hasNext()) {
      Map.Entry<String, @RUntainted String> e = i.next();
  ...
  /**
   * Transforms a list of {@link CmsProperty} objects into a Map which uses the property name as Map
   * key (String), and the property value as Map value (String).
   *
   * <p>
   *
   * @param list a list of {@link CmsProperty} objects
   * @return a Map which uses the property names as Map keys (String), and the property values as
   *     Map values (String)
   */
  public static @RUntainted Map<String, @RUntainted String> toMap(List<CmsProperty> list) {
  ...
  /**
   * Checks if the property definition for this property will be created implicitly on any write
   * operation if doesn't already exist.
   *
   * <p>
   *
   * @return <code>true</code>, if the property definition for this property will be created
   *     implicitly on any write operation
   */
  ...
  /**
   * Creates a clone of this property that already is of type <code>{@link CmsProperty}</code>.
   *
   * <p>The cloned property will not be frozen.
   *
   * <p>
   *
   ...
   * @return if the argument is a property object, returns zero if the name of the argument is equal
   *     to the name of this property object, a value less than zero if the name of this property is
   *     lexicographically less than the name of the argument, or a value greater than zero if the
   *     name of this property is lexicographically greater than the name of the argument
   */
   ...
   *
   * <p>Two property objects are equal if their names are equal.
   *
   * <p>In case you want to compare the values as well as the name, use {@link
   * #isIdentical(CmsProperty)} instead.
   *
   * <p>
   *
   ...
   *
   * <p>This list is build form the resource value, which is split into separate values using the
   * <code>|</code> char as delimiter. If the delimiter is not found, then the list will contain one
   * entry which is equal to <code>{@link #getResourceValue()}</code>.
   *
   * <p>
   *
   * @return the value of this property attached to the resource record, split as a (unmodifiable)
   *     list of Strings
   */
   ...
   *
   * <p>This map is build from the used value, which is split into separate key/value pairs using
   * the <code>|</code> char as delimiter. If the delimiter is not found, then the map will contain
   * one entry.
   *
   * <p>The key/value pairs are separated with the <code>=</code>.
   *
   * <p>
   *
   * @return the value of this property attached to the resource record, as an (unmodifiable) map of
   *     Strings
   */
   ...
   *
   * <p>This list is build form the structure value, which is split into separate values using the
   * <code>|</code> char as delimiter. If the delimiter is not found, then the list will contain one
   * entry which is equal to <code>{@link #getStructureValue()}</code>.
   *
   * <p>
   *
   * @return the value of this property attached to the structure record, split as a (unmodifiable)
   *     list of Strings
   */
   ...
   * <p>
   *
   * @return the value of this property attached to the structure record, as an (unmodifiable) map
   *     of Strings
   */
   ...
   *
   * <p>The value returned is the value of {@link #getStructureValue()}, if it is not <code>null
   * </code>. Otherwise the value if {@link #getResourceValue()} is returned (which may also be
   * <code>null</code>).
   *
   * <p>
   *
  ...
  /**
   * Returns the compound value of this property, or a specified default value, if both the
   * structure and resource values are null.
   *
   * <p>In other words, this method returns the defaultValue if this property object is the null
   * property (see {@link CmsProperty#getNullProperty()}).
   *
   * <p>
   *
   * @param defaultValue a default value which is returned if both the structure and resource values
   *     are <code>null</code>
   ...
   *
   * <p>This list is build form the used value, which is split into separate values using the <code>
   * |</code> char as delimiter. If the delimiter is not found, then the list will contain one
   * entry.
   *
   * <p>The value returned is the value of {@link #getStructureValueList()}, if it is not <code>null
   * </code>. Otherwise the value of {@link #getResourceValueList()} is returned (which may also be
   * <code>null</code>).
   *
   * <p>
   *
  ...
  /**
   * Returns the compound value of this property, split as a list, or a specified default value
   * list, if both the structure and resource values are null.
   *
   * <p>In other words, this method returns the defaultValue if this property object is the null
   * property (see {@link CmsProperty#getNullProperty()}).
   *
   * <p>
   *
   * @param defaultValue a default value list which is returned if both the structure and resource
   ...
   * <p>The key/value pairs are separated with the <code>=</code>.
   *
   * <p>The value returned is the value of {@link #getStructureValueMap()}, if it is not <code>null
   * </code>. Otherwise the value of {@link #getResourceValueMap()} is returned (which may also be
   * <code>null</code>).
   *
   * <p>
   *
  ...
  /**
   * Returns the compound value of this property as a map, or a specified default value map, if both
   * the structure and resource values are null.
   *
   * <p>In other words, this method returns the defaultValue if this property object is the null
   * property (see {@link CmsProperty#getNullProperty()}).
   *
   * <p>
   *
   * @param defaultValue a default value map which is returned if both the structure and resource
   *     values are <code>null</code>
   * @return the compound value of this property as a (unmodifiable) map of Strings
   */
  ...
  /**
   * Returns the hash code of the property, which is based only on the property name, not on the
   * values.
   *
   * <p>The resource and structure values are not taken into consideration for the hashcode
   * generation because the {@link #equals(Object)} implementation also does not take these into
   * consideration.
   *
   * <p>
   *
  ...
  /**
   * Checks if the resource value of this property should be deleted when this property object is
   * written to the database.
   *
   * <p>
   *
  ...
  public boolean isDeleteResourceValue() {
    ...
    return (m_resourceValue == DELETE_VALUE)
        || ((m_resourceValue != null) && (m_resourceValue.length() == 0));
  }

  /**
   * Checks if the structure value of this property should be deleted when this property object is
   * written to the database.
   *
   * <p>
   *
  ...
  public boolean isDeleteStructureValue() {
    ...
    return (m_structureValue == DELETE_VALUE)
        || ((m_structureValue != null) && (m_structureValue.length() == 0));
  }

  /**
   * Returns <code>true</code> if this property is frozen, that is read only.
   *
   * <p>
   *
   ...
   *
   * <p>The property object are identical if their name, structure and resource values are all
   * equals.
   *
   * <p>
   *
  ...
  /**
   * Sets the boolean flag to decide if the property definition for this property should be created
   * implicitly on any write operation if doesn't exist already.
   *
   * <p>
   *
   * @param value true, if the property definition for this property should be created implicitly on
   *     any write operation
   */
  ...
  /**
   * Sets the frozen state of the property, if set to <code>true</code> then this property is read
   * only.
   *
   * <p>If the property is already frozen, then setting the frozen state to <code>true</code> again
   * is allowed, but setting the value to <code>false</code> causes a <code>
   * {@link CmsRuntimeException}</code>.
   *
   * <p>
   *
   ...
   *
   * <p>The value will be created from the individual values of the given list, which are appended
   * using the <code>|</code> char as delimiter.
   *
   * <p>
   *
   ...
   *
   * <p>The value will be created from the individual values of the given map, which are appended
   * using the <code>|</code> char as delimiter, the map keys and values are separated by a <code>=
   * </code>.
   *
   * <p>
   *
  ...
  /**
   * Sets the value of this property attached to the structure record from the given list of
   * Strings.
   *
   * <p>The value will be created from the individual values of the given list, which are appended
   * using the <code>|</code> char as delimiter.
   ...
   *
   * <p>If the given type equals {@link CmsProperty#TYPE_SHARED} then the value is set as a shared
   * (resource) value, otherwise it is set as individual (structure) value.
   *
   * <p>
   *
  ...
  private void checkFrozen() {
    ...
    if (m_frozen) {
      throw new CmsRuntimeException(
          Messages.get().container(Messages.ERR_PROPERTY_FROZEN_1, toString()));
    }
  }
   ...
   *
   * <p>The given value is split along the <code>|</code> char.
   *
   * <p>
   *
  ...
  private List<String> createListFromValue(String value) {
    ...
    if (value.indexOf(VALUE_LIST_DELIMITER_REPLACEMENT) != -1) {
      ...
      Iterator<@RUntainted String> i = result.iterator();
      while (i.hasNext()) {
        @RUntainted String item = i.next();
        tempList.add(
            rebuildDelimiter(item, VALUE_LIST_DELIMITER, VALUE_LIST_DELIMITER_REPLACEMENT));
      }
      result = tempList;
    }
   ...
   *
   * <p>The given value is split along the <code>|</code> char, the map keys and values are
  ...
  private Map<String, String> createMapFromValue(String value) {
    ...
    while (i.hasNext()) {
      ...
      @RUntainted int index = entry.indexOf(VALUE_MAP_DELIMITER);
      if (index != -1) {
        @RUntainted String key = entry.substring(0, index);
        @RUntainted String val = "";
   ...
   */
  private @RUntainted String createValueFromList(@RUntainted List<@RUntainted String> valueList) {

    if (valueList == null) {
      return null;
    }
    @RUntainted StringBuffer result = new StringBuffer(valueList.size() * 32);
    Iterator<@RUntainted String> i = valueList.iterator();
    while (i.hasNext()) {
      result.append(
          replaceDelimiter(
              i.next().toString(), VALUE_LIST_DELIMITER, VALUE_LIST_DELIMITER_REPLACEMENT));
      if (i.hasNext()) {
  ...
  private @RUntainted String createValueFromMap(@RUntainted Map<String, String> valueMap) {
    ...
    @RUntainted StringBuffer result = new StringBuffer(valueMap.size() * 32);
    Iterator<Map.Entry<String, String>> i = valueMap.entrySet().iterator();
    while (i.hasNext()) {
      Map.Entry<@RUntainted String, @RUntainted String> entry = i.next();
   ...
   */
  private @RUntainted String rebuildDelimiter(@RUntainted String value, char delimiter, String delimiterReplacement) {
   ...
   * @return the substituted string
   */
  private @RUntainted String replaceDelimiter(@RUntainted String value, char delimiter, String delimiterReplacement) {
