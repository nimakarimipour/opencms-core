...
public class CmsProperty implements Serializable, Cloneable, Comparable<CmsProperty> {
    ...
    public static class CmsPropertyLocaleTransformer implements Transformer {
         ...
         */
        public CmsPropertyLocaleTransformer(Map<String, @RUntainted String> properties, @RUntainted Locale locale) {
         ...
         */
        public Object transform(@RUntainted Object propertyName) {
     ...
     */
    public static final @RUntainted CmsProperty getNullProperty() {
     ...
     */
    public static Map<@RUntainted String, CmsProperty> getPropertyMap(List<CmsProperty> list) {

        Map<@RUntainted String, CmsProperty> result = null;
        String key = null;
        CmsProperty property = null;
     ...
     */
    public static List<CmsProperty> toList(Map<@RUntainted String, @RUntainted String> map) {
        ...
        Iterator<Map.Entry<@RUntainted String, @RUntainted String>> i = map.entrySet().iterator();
        while (i.hasNext()) {
     ...
     */
    public @RUntainted CmsProperty cloneAsProperty() {
     ...
     */
    public @RUntainted List<String> getResourceValueList() {
     ...
     */
    public @RUntainted List<String> getStructureValueList() {
     ...
     */
    public List<@RUntainted String> getValueList() {
     ...
     */
    private @RUntainted List<@RUntainted String> createListFromValue(@RUntainted String value) {
     ...
     */
    private @RUntainted Map<String, String> createMapFromValue(@RUntainted String value) {
