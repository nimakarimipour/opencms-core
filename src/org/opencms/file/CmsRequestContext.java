...
public final class CmsRequestContext {
    ...
    private Map<String, @RUntainted Object> m_attributeMap;

    /** The current project. */
    private @RUntainted CmsProject m_currentProject;
    ...
    public CmsRequestContext(
        ...
        @RUntainted boolean forceAbsoluteLinks) {
     ...
     */
    public static @RPolyTainted String getAdjustedSiteRoot(@RPolyTainted String siteRoot, String resourcename) {
     ...
     */
    public @RUntainted CmsResourceTranslator getDirectoryTranslator() {
     ...
     */
    public void setAttribute(String key, @RUntainted Object value) {
     ...
     */
    public CmsProject setCurrentProject(@RUntainted CmsProject project) {
     ...
     */
    public void setForceAbsoluteLinks(@RUntainted boolean forceAbsoluteLinks) {
     ...
     */
    public void setSecureRequest(@RUntainted boolean secureRequest) {
     ...
     */
    protected void switchUser(@RUntainted CmsUser user, @RUntainted CmsProject project, @RUntainted String ouFqn) {
