...
/**
 * Describes an OpenCms project, which contains a set of VFS resources that are being worked on at
 * the same time.
 *
 * <p>
 *
...
public class CmsProject implements Cloneable, Comparable<CmsProject>, Serializable {
  ...
  /**
   * Indicates that a project should be hidden from the workplace project selector, but should
   * otherwise behave the same as normal projects.
   */
  ...
  public static void checkProjectName(String name) {
    ...
    if (CmsStringUtil.isEmptyOrWhitespaceOnly(name)) {
      throw new CmsIllegalArgumentException(
          Messages.get().container(Messages.ERR_PROJECTNAME_VALIDATION_0));
    }
  }

  /**
   * Checks if the full resource name (including the site root) of a resource matches any of the
   * project resources of a project.
   *
   * <p>
   *
  ...
  /**
   * Returns <code>true</code> if this project is the Online project.
   *
   * <p>
   *
  ...
  public void setDeleteAfterPublishing(boolean deleteAfterPublishing) {
    ...
    m_type =
        deleteAfterPublishing ? CmsProject.PROJECT_TYPE_TEMPORARY : CmsProject.PROJECT_TYPE_NORMAL;
  }
