...
public class CmsProject implements Cloneable, Comparable<CmsProject>, Serializable {
    ...
    public static final class CmsProjectType extends A_CmsModeIntEnumeration {
         ...
         */
        private CmsProjectType(@RUntainted int mode) {
     ...
     */
    public static boolean isInsideProject(List<@RUntainted String> projectResources, CmsResource resource) {
     ...
     * @return true, if the resource is "inside" the project resources
     */
    public static boolean isInsideProject(List<@RUntainted String> projectResources, String resourcename) {
     ...
     */
    public @RUntainted boolean isOnlineProject() {
