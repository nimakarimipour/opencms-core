 ...
 *
 * <p>A folder resource is a CmsResource object that can contain sub-resources.
 *
 * <p>
 *
 * @since 6.0.0
...
public class CmsFolder extends CmsResource {
  ...
  /**
   * Returns <code>true</code> if the given resource size describes a folder type.
   *
   * <p>This is <code>true</code> in case <code>size &lt; 0</code>.
   *
   * <p>
   *
  ...
  /**
   * Returns <code>true</code> if the given resource type id describes a folder type.
   *
   * <p>
   *
    ...
    try {
      ...
      if (LOG.isWarnEnabled()) {
        LOG.warn(
            Messages.get()
                .getBundle()
                .key(Messages.ERR_UNKNOWN_RESOURCE_TYPE_1, new Integer(typeId)),
            e);
      }
    }
    return false;
  ...
  /**
   * Returns <code>true</code> if the given resource type name describes a folder type.
   *
   * <p>
   *
  ...
  public static final boolean isFolderType(String typeName) {
    ...
    try {
      ...
      throw new CmsIllegalArgumentException(
          Messages.get().container(Messages.ERR_UNKNOWN_RESOURCE_TYPE_1, typeName), e);
    }
  }
  ...
  /**
   * A folder does always have the content date <code>-1</code>.
   *
   * <p>
   *
  ...
  /**
   * A folder does always have length <code>-1</code>.
   *
   * <p>
   *
  ...
  /**
   * Since this is a folder, not a file, <code>false</code> is always returned.
   *
   * <p>
   *
  ...
  /**
   * Since this is a folder, <code>true</code> is always returned.
   *
   * <p>
   *
