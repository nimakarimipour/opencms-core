 ...
 *
 * <p>Post create handlers can also be specified when using the tags {@link
 * org.opencms.jsp.CmsJspTagDisplay} or {@link org.opencms.jsp.CmsJspTagEdit}.
 *
 * <p>
 */
public interface I_CmsCollectorPostCreateHandler {
  ...
  /**
   * Splits the string that configures the handler into the handler class and the configuration
   * part.
   *
  ...
  /**
   * This is called after the new content has been created (and possibly already been filled with
   * content).
   *
   * <p>
   *
   ...
   * @param createdResource the resource which has been created
   * @param copyMode true if the user chose one of the elements in the collector list as a model
   * @param config an optional configuration string that can be handled specific by each
   *     implementation
   */
