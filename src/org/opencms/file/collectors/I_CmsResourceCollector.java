...
public interface I_CmsResourceCollector extends Comparable<I_CmsResourceCollector>, I_CmsCollectorPublishListProvider {
     ...
     * @see #getCreateLink(CmsObject, String, String)
     */
    @RUntainted String getCreateParam(CmsObject cms, @RUntainted String collectorName, @RUntainted String param) throws CmsDataAccessException;
     ...
     * @throws CmsException if something goes wrong
     */
    int getCreateTypeId(CmsObject cms, String collectorName, @RUntainted String param) throws CmsException;
     ...
     * @throws CmsDataAccessException if the parameter attribute of the corresponding collector tag is invalid
     */
    List<CmsResource> getResults(@RUntainted CmsObject cms) throws CmsDataAccessException, CmsException;
     ...
     * @throws CmsDataAccessException if the parameter attribute of the corresponding collector tag is invalid
     */
    List<CmsResource> getResults(@RUntainted CmsObject cms, @RUntainted String collectorName, @RUntainted String param)
     ...
     * @throws CmsDataAccessException if the parameter attribute of the corresponding collector tag is invalid
     */
    List<CmsResource> getResults(@RUntainted CmsObject cms, @RUntainted String collectorName, @RUntainted String params, int numResults)
    throws CmsException;
