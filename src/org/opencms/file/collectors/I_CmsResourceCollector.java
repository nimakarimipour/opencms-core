...
public interface I_CmsResourceCollector
    extends Comparable<I_CmsResourceCollector>, I_CmsCollectorPublishListProvider {
   ...
   * list created by the default collector.
   *
   * <p>If this method returns <code>null</code>, it indicated that the selected collector
   * implementation does not support a "create link", and so no "new" button will should shown on
   * lists generated with this collector.
   *
   * <p>
   *
   ...
   * @throws CmsDataAccessException if the parameter attribute of the corresponding collector tag is
   *     invalid
  ...
  /**
   * Returns the link that must be executed when a user clicks on the direct edit "new" button on a
   * list created by the named collector.
   *
   * <p>If this method returns <code>null</code>, it indicated that the selected collector
   * implementation does not support a "create link", and so no "new" button will should shown on
   * lists generated with this collector.
  ...
  /**
   * Returns the default parameter that must be passed to the {@link #getCreateLink(CmsObject,
   * String, String)} method.
   *
   * <p>If this method returns <code>null</code>, it indicates that the selected collector
   * implementation does not support a "create link", and so no "new" button will should shown on
   * lists generated with this collector.
   *
   * <p>
   *
   * @param cms the current CmsObject
   * @return the parameter that will be passed to the {@link #getCreateLink(CmsObject, String,
   *     String)} method, or null
   * @throws CmsDataAccessException if the param attrib of the corresponding collector tag is
   *     invalid
  ...
  /**
   * Returns the parameter that must be passed to the {@link #getCreateLink(CmsObject, String,
   * String)} method.
   *
   * <p>If this method returns <code>null</code>, it indicates that the selected collector
   * implementation does not support a "create link", and so no "new" button will should shown on
   ...
   *
   * <p>Returns -1 if creation of new items is not supported.
   *
   * <p>
   *
   * @param cms the current CmsObject
   ...
   *
   * <p>The "order weight" is important because two collector classes may provide a collector with
   * the same name. If this is the case, the collector implementation with the higher order number
   * "overrules" the lower order number class.
   *
   * <p>
   *
  ...
  /**
   * Returns a list of {@link org.opencms.file.CmsResource} Objects that are gathered in the VFS
   * using the default collector name and parameter.
   *
   * <p>
   *
   * @param cms the current CmsObject
   ...
   * using the named collector.
   *
   * <p>This method takes as a parameter the desired number of results. If this number is -1, the
   * number of results will only depend on the collector parameters. If it is positive, any given
   * result number in the collector parameter string will not be used.
   *
   * @param cms the current CmsObject
   * @param collectorName the name of the collector to use
