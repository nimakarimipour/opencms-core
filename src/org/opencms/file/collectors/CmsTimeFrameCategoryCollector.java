 ...
 * property that contains a time stamp.
 *
 * <p>Additionally a property may be specified that contains a comma separated list of category
 * Strings that have to match the specified list of categories to allow.
 *
 * <p><b>Demo usage:</b><br>
 *
 * <pre>
 ...
 * </pre>
 *
 * <p><b>The param attribute</b>
 *
 * <p>supports a key - value syntax for collector params.
 *
 * <p>All parameters are specified as follows:
 *
 * <pre>
 * key=value
 * </pre>
 *
 * <p>Many key - value pairs may exist:
 *
 * <pre>
 * key=value|key2=value2|key3=value3
 * </pre>
 *
 * <p>The following keys are reserved:
 *
 * <ul>
 *   <li><b>resource</b><br>
 *       The value defines the folder / single file for collection of results.
 *   <li><b>resourceType</b><br>
 ...
 *   <li><b>resultLimit</b><br>
 *       The value defines the maximum amount of results to return.
 *   <li><b>sortDescending</b><br>
 *       The value defines if the result is sorted in descending ("true") or ascending (anything
 *       else than "true") order.
 *   <li><b>excludeTimeRange</b><br>
 *       The value defines if the result should exclude the time range in an offline project.
 *   <li><b>timeStart</b><br>
 *       The value defines the start time in the format <code>yyyy-MM-dd HH:mm:ss</code> as known by
 *       the description of <code>{@link SimpleDateFormat}</code> that will be used for the validity
 *       time frame of result candidates.
 *   <li><b>timeEnd</b><br>
 *       The value defines the end time in the format <code>yyyy-MM-dd HH:mm:ss</code> as known by
 *       the description of <code>{@link SimpleDateFormat}</code> that will be used for the validity
 *       time frame of result candidates.
 *   <li><b>propertyTime</b><br>
 *       The value defines the name of the property that is inspected for a time stamp in <code>
 *        {@link System#currentTimeMillis()}</code> syntax for the validity time frame check.
 *   <li><b>propertyCategories</b><br>
 *       The value defines the name of the property that is inspected for a pipe separated list of
 *       category strings.
 *   <li><b>categories</b><br>
 *       The value defines a list of comma separated category Strings used to filter result
 *       candidates by. If this parameter is missing completely no category filtering will be done
 *       and also resources with empty category property will be accepted.
 * </ul>
 *
 * <p>All other key - value pairs are ignored.
 *
 * <p>
 *
 * @since 7.0.3
...
public class CmsTimeFrameCategoryCollector extends A_CmsResourceCollector {
  ...
  /**
   * Supports a key - value syntax for collector params.
   *
   * <p>All parameters are specified as follows:
   *
   * <pre>
   ...
   *       The value defines if the result should exclude the time range in an offline project.
   *   <li><b>timeStart</b><br>
   *       The value defines the start time in the format <code>yyyy-MM-dd HH:mm:ss</code> as known
   *       by the description of <code>{@link SimpleDateFormat}</code> that will be used for the
   *       validity time frame of result candidates.
   *   <li><b>timeEnd</b><br>
   *       The value defines the end time in the format <code>yyyy-MM-dd HH:mm:ss</code> as known by
   *       the description of <code>{@link SimpleDateFormat}</code> that will be used for the
   *       validity time frame of result candidates.
   *   <li><b>propertyTime</b><br>
   *       The value defines the name of the property that is inspected for a time stamp in <code>
   *        {@link System#currentTimeMillis()}</code> syntax for the validity time frame check.
  ...
  private class CollectorDataPropertyBased extends CmsCollectorData {
    ...
    /**
     * The collector parameter key for the name of the categoires property used to filter resources
     * by.
     */
    public static final String PARAM_KEY_PPROPERTY_CATEGORIES = "propertyCategories";

    /**
     * The collector parameter key for the name of the property to use for the validity time frame
     * check.
     */
    ...
    /**
     * Constructor with the collector param of the tag.
     *
     * <p>
     *
    ...
    /**
     * Returns The List &lt;String&gt; containing the categories to allow.
     *
     * <p>
     *
    ...
    /**
     * Returns the property to look for a pipe separated list of category strings in.
     *
     * <p>Never write this property to VFS as it is "invented in RAM" and not read from VFS!
     *
     * <p>
     *
    ...
    /**
     * Returns The property to look up for a time stamp on result candidates for validity time frame
     * check.
     *
     * <p>Never write this property to VFS as it is "invented in RAM" and not read from VFS!
     *
     * <p>
     *
     * @return The property to look up for a time stamp on result candidates for validity time frame
     *     check.
     */
     ...
     * <p>
     *
     * @return true if results should be sorted in descending order, false if results should be
    ...
    /**
     * Internally parses the constructor-given param into the data model of this instance.
     *
     * <p>
     *
  ...
  private static final List<String> COLLECTORS_LIST =
      Collections.unmodifiableList(Arrays.asList(new String[] {COLLECTOR_NAME}));
  ...
  /**
   * @see
   *     org.opencms.file.collectors.A_CmsResourceCollector#getCreateTypeId(org.opencms.file.CmsObject,
   *     java.lang.String, java.lang.String)
   */
  @Override
  ...
  /**
   * Returns a list of resources according to the given parameter.
   *
   * <p>
   *
  ...
  private List<CmsResource> getTimeFrameAndCategories(CmsObject cms, String param, int numResults)
    ...
    CmsResourceFilter filter =
        CmsResourceFilter.DEFAULT
            .addRequireType(data.getType())
            .addExcludeFlags(CmsResource.FLAG_TEMPFILE);
    if (data.isExcludeTimerange()
