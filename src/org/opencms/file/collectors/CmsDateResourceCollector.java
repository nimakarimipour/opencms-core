...
public class CmsDateResourceCollector extends A_CmsResourceCollector {
  ...
  private static final String[] COLLECTORS = {
    "allInFolderDateDesc", "allInFolderDateAsc", "allInSubTreeDateDesc", "allInSubTreeDateAsc"
  };
  ...
  /**
   * Returns a List of all resources in the folder pointed to by the parameter sorted by the
   * selected dates.
   *
   * <p>
   *
   ...
   */
  protected List<CmsResource> allInFolderDate(
