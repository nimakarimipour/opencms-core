...
/**
 * A collector to fetch XML contents in a folder or the current site filtered by one or more given
 * category types.
 *
 * <p>The return list will also be filtered by given key value pairs which are given as a collector
 * parameter.
 *
 * <p>Usage: <code>
...
public class CmsCategoryResourceCollector extends A_CmsResourceCollector {
   ...
   *
   * <p>In addition to the superclass this implementation accepts parameters that build key value
   * pairs separated by pipes '|', which allows arbitrary order of parameters and free numbers of
   * parameters.
   *
   * <p>Usage: <code>
  ...
  private static final class CmsCategoryCollectorData extends CmsCollectorData {
    ...
    /**
     * Indicates if the sub tree of the given resource will be searched for appropriate resources
     * too.
     */
    ...
    /**
     * Returns the list of requested categories.
     *
     * <p>
     *
    ...
    /**
     * Returns the sort by string (only 'date', 'category' or 'property' excepted).
     *
     * <p>
     *
    ...
    /**
     * Returns the sort by this property value.
     *
     * <p>
     *
     * @return the sort by string
    ...
    /**
     * Returns the sort order. <code>true=asc</code> or <code>false=desc</code>
     *
     * <p>
     *
    ...
    /**
     * Returns <code>true</code> if the list has to be sorted in ascending order.
     *
     * <p>
     *
    ...
    /**
     * Returns <code>true</code> if the sub tree of the given resource will be searched too.
     *
     * <p>
     *
    ...
    /**
     * Parses the additional configuration data from the collector param.
     *
     * <p>
     *
  ...
  public static final Comparator<CmsResource> COMPARE_DATE_RELEASED_DESC =
  ...
  /**
   * Collects all resources for the given categories filtered and sorted by the given collector
   * parameter.
   *
   * <p>
   *
  ...
  protected List<CmsResource> allKeyValuePairFiltered(CmsObject cms, String param, int numResults)
    ...
    if ((data.getCategoryTypes() != null) && (data.getCategoryTypes().size() > 0)) {
      ...
      CmsResourceFilter filter =
          CmsResourceFilter.DEFAULT.addExcludeFlags(CmsResource.FLAG_TEMPFILE);
      if (data.getType() != -1) {
      ...
      while (itResources.hasNext()) {
        ...
        Iterator<CmsCategory> itCategories =
            service.readResourceCategories(cms, resource).iterator();
      ...
      if ((data.getSortBy() != null) && data.getSortBy().equals("date")) {
        ...
        Comparator<CmsResource> comp =
            new CmsPropertyResourceComparator(
                cms, data.getSortByPropertyName(), data.getSortOrder());
