...
/**
 * A collector to fetch sorted XML contents in a folder or subtree based on their priority and date
 * or title values.
 *
 * <p>The date or title information has to be stored as property for each resource.
 *
 * <p>
 *
 * @since 6.0.0
...
public class CmsPriorityResourceCollector extends A_CmsResourceCollector {
  ...
  public String getCreateLink(CmsObject cms, String collectorName, String param)
    ...
    switch (COLLECTORS_LIST.indexOf(collectorName)) {
      ...
      case 2:
      case 4:
        // "allInFolderPriorityDateAsc", "allInFolderPriorityDateDesc" or
        // "allInFolderPriorityTitleDesc"
      ...
      case 6:
      case 7:
        // "allInSubTreePriorityDateAsc", "allInSubTreePriorityDateDesc" or
        // "allInSubTreePriorityTitleDesc"
  ...
  /**
   * Returns a list of all resource in a specified folder sorted by priority, then date ascending or
   * descending.
   *
   * <p>
   *
  ...
  /**
   * Returns a list of all resource in a specified folder sorted by priority descending, then Title
   * ascending.
   *
   * <p>
   *
   ...
   * @throws CmsException if something goes wrong
   */
  protected List<CmsResource> allInFolderPriorityTitle(
      CmsObject cms, String param, boolean tree, int numResults) throws CmsException {
  ...
  /**
   * Returns a list of all resource from specified folder that have been mapped to the currently
   * requested uri, sorted by priority, then date ascending or descending.
   *
   * <p>
   *
   * @param cms the current OpenCms user context
   ...
   * @throws CmsException if something goes wrong
   */
  protected List<CmsResource> allMappedToUriPriorityDate(
      CmsObject cms, String param, boolean asc, int numResults) throws CmsException {
    ...
    while (i.hasNext()) {
      ...
      // read all properties - reason: comparator will do this later anyway, so we just prefill the
      // cache
