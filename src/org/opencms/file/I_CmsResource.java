 ...
 * org.opencms.file.history.CmsHistoryFile} and {@link org.opencms.file.history.CmsHistoryFolder}.
 *
 * <p>
 *
 * @since 8.0.0
...
public interface I_CmsResource {
   ...
   * <p>
   */
  Comparator<I_CmsResource> COMPARE_DATE_LAST_MODIFIED =
      new Comparator<I_CmsResource>() {
   ...
   *
   * <p>If the release date of a resource is not set, the creation date is used instead.
   *
   * <p>
   */
  Comparator<I_CmsResource> COMPARE_DATE_RELEASED =
      new Comparator<I_CmsResource>() {
   ...
   * <p>
   */
  Comparator<I_CmsResource> COMPARE_ROOT_PATH =
      new Comparator<I_CmsResource>() {
   ...
   * <p>
   */
  Comparator<I_CmsResource> COMPARE_ROOT_PATH_IGNORE_CASE =
      new Comparator<I_CmsResource>() {
  ...
  /**
   * A comparator for the root path of two resources ignoring case differences, putting folders
   * before files.
   *
   * <p>
   */
  Comparator<I_CmsResource> COMPARE_ROOT_PATH_IGNORE_CASE_FOLDERS_FIRST =
      new Comparator<I_CmsResource>() {
  ...
  /**
   * Returns <code>true</code> if the resource is a file, i.e. can have no sub-resources.
   *
   * <p>
   *
  ...
  /**
   * Returns <code>true</code> if the resource is a folder, i.e. can have sub-resources.
   *
   * <p>
   *
