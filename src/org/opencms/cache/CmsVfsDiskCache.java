...
public class CmsVfsDiskCache {
   ...
   *
   * <p>If the required parent folders do not exists, they are also created.
   *
   * <p>
   *
   ...
   * @throws IOException in case of disk access errors
   */
  public void saveCacheFile(String rfsName, byte[] content, long dateLastModified)
      throws IOException {
  ...
  /**
   * Simplifies the "date last modified" from the OpenCms VFS based milliseconds to just seconds, to
   * support file systems that don't use milliseconds.
   *
   * <p>
   *
