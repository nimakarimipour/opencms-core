 ...
 * files.
 *
 * <p>This RFS cache operates on file names, plus a hash code calculated from {@link
 * org.opencms.file.CmsResource#getDateLastModified()}, {@link
 * org.opencms.file.CmsResource#getDateCreated()} and {@link
 * org.opencms.file.CmsResource#getLength()}. Optional parameters can be appended to this name,
 * which will be added as a second hash code. This way a file can have multiple versions based on
...
public class CmsVfsNameBasedDiskCache {
  ...
  /**
   * Returns the content of the requested file in the disk cache, or <code>null</code> if the file
   * is not found in the cache, or is found but outdated.
   *
   * <p>
   *
