...
public abstract class A_CmsMessageBundle implements I_CmsMessageBundle {
     ...
     */
    public @RUntainted CmsMessageContainer container(@RUntainted String key) {
     ...
     */
    public @RUntainted CmsMessageContainer container(@RUntainted String key, @RUntainted Object arg0) {
     ...
     * @see org.opencms.i18n.I_CmsMessageBundle#container(java.lang.String, java.lang.Object[])
     */
    public @RUntainted CmsMessageContainer container(@RUntainted String message, @RUntainted Object[] args) {
