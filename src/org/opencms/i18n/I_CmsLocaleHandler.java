 ...
 *
 * <p>By implementing this interface, and configuring OpenCms accordingly, the behaviour for the
 * m_locale selection can be fine-tuned to the exact need of the OpenCms installation.
 *
 * <p>
 *
 * @since 6.0.0
...
public interface I_CmsLocaleHandler {
   ...
   */
  CmsI18nInfo getI18nInfo(
      HttpServletRequest req, CmsUser user, CmsProject project, @RUntainted String resource);
