...
public class CmsSingleTreeLocaleHandler extends CmsDefaultLocaleHandler {
     ...
     */
    public static @RPolyTainted Locale getLocaleFromPath(@RUntainted String sitePath) {
     ...
     */
    @Override
    public CmsI18nInfo getI18nInfo(@RUntainted HttpServletRequest req, CmsUser user, @RUntainted CmsProject project, @RUntainted String resourceName) {
