...
public class CmsListResourceBundle extends ListResourceBundle implements I_CmsResourceBundle {
  ...
  /**
   * Create a new list resource bundle as copy of an existing one.
   *
   * <p>
   *
   ...
   *
   * <p>Please note: All additions after the initial call to {@link #getContents()} are ignored.
   *
   * <p>
   *
   ...
   *
   * <p>This is required in order to make sure the objects in the permanent cache of the list based
   * resource bundles which are usually read from the XML are never changed.
   *
   * <p>
   *
