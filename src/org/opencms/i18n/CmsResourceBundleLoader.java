...
public final class CmsResourceBundleLoader {
    ...
    // handled.
    public static @RPolyTainted ResourceBundle getBundle(@RUntainted String baseName, @RPolyTainted Locale locale) {
     ...
     */
    private static @RPolyTainted I_CmsResourceBundle tryBundle(@RPolyTainted String localizedName) {
