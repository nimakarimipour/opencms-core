...
public class CmsLocaleManager implements I_CmsEventListener {
    ...
    private List<@RUntainted Locale> m_availableLocales;
     ...
     */
    public static String getLocaleNames(List<@RUntainted Locale> locales) {
     ...
     * @return a List of locales derived from the given locale names
     */
    public static @RUntainted List<@RUntainted Locale> getLocales(String localeNames) {
     ...
     * @see #getAvailableLocales()
     */
    public List<@RUntainted Locale> getAvailableLocales(String names) {
     ...
     */
    private List<@RUntainted Locale> checkLocaleNames(List<@RUntainted Locale> locales) {
