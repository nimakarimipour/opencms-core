 ...
 * convenience methods to access the Strings from a template.
 *
 * <p>This class is frequently used from JSP templates. Because of that, throwing of exceptions
 * related to the access of the resource bundle are suppressed so that a template always execute.
 * The class provides an {@link #isInitialized()} method that can be checked to see if the instance
...
public class CmsMessages {
   ...
   *
   * <p>The <code>language</code> is a 2 letter language ISO code, e.g. <code>"EN"</code>.
   *
   * <p>The Locale for the messages will be created like this:<br>
   * <code>new Locale(language, "", "")</code>.
   *
   * <p>
   *
   * @param bundleName the base ResourceBundle name
   ...
   *
   * <p>The <code>language</code> is a 2 letter language ISO code, e.g. <code>"EN"</code>. The
   * <code>country</code> is a 2 letter country ISO code, e.g. <code>"us"</code>.
   *
   * <p>The Locale for the messages will be created like this:<br>
   ...
   *
   * <p>The <code>language</code> is a 2 letter language ISO code, e.g. <code>"EN"</code>. The
   * <code>country</code> is a 2 letter country ISO code, e.g. <code>"us"</code>. The <code>variant
   * </code> is a vendor or browser-specific code, e.g. <code>"POSIX"</code>.
   *
   * <p>The Locale for the messages will be created like this:<br>
  ...
  /**
   * Returns <code>true</code> if the provided value matches the scheme <code>
   * "??? " + keyName + " ???"</code>, that is the value appears to be an unknown key.
   *
   * <p>Also returns <code>true</code> if the given value is <code>null</code>.
   *
   * <p>
   *
  ...
  /**
   * Returns a formated date String from a Date value, the format being {@link DateFormat#SHORT} and
   * the locale based on this instance.
   *
   * <p>
   *
  ...
  /**
   * Returns a formated date String from a Date value, the formatting based on the provided option
   * and the locale based on this instance.
   *
   * <p>
   *
   * @param date the Date object to format as String
  ...
  /**
   * Returns a formated date String from a timestamp value, the format being {@link
   * DateFormat#SHORT} and the locale based on this instance.
   *
   * <p>
   *
  ...
  /**
   * Returns a formated date and time String from a Date value, the format being {@link
   * DateFormat#SHORT} and the locale based on this instance.
   *
   * <p>
   *
  ...
  /**
   * Returns a formated date and time String from a Date value, the formatting based on the provided
   * option and the locale based on this instance.
   *
   * <p>
   *
   * @param date the Date object to format as String
  ...
  /**
   * Returns a formated date and time String from a timestamp value, the format being {@link
   * DateFormat#SHORT} and the locale based on this instance.
   *
   * <p>
   *
   ...
   * <p>
   *
   * @return the resource bundle this message object was initialized with or null if initialization
   *     was not successful
   */
   ...
   *
   * <p>If you use this this class on a template, you should consider using the {@link #key(String)}
   * method to get the value from the ResourceBundle because it handles the exception for you in a
   * convenient way.
   *
    ...
    if (m_resourceBundle != null) {
      try {
        ...
        throw new CmsMessageException(
            Messages.get()
                .container(Messages.ERR_CANT_FIND_RESOURCE_FOR_BUNDLE_2, keyName, m_bundleName));
      }
    } else {
      throw new CmsMessageException(
   ...
   * Returns the localized resource string for a given message key.
   *
   * <p>If the key was not found in the bundle, the return value depends on the setting of the
   * allowNull parameter. If set to false, the return value is always a String in the format <code>
   * "??? " + keyName + " ???"</code>. If set to true, null is returned if the key is not found.
   * This will also be returned if the bundle was not properly initialized first.
   *
   * @param keyName the key for the desired string
   ...
   *
   * <p>Convenience method for messages with one argument.
   *
   * <p>
   *
   ...
   * Returns the selected localized message for the initialized resource bundle and locale.
   *
   * <p>Convenience method for messages with two arguments.
   *
   * <p>
   *
   * @param key the message key
   ...
   * Returns the selected localized message for the initialized resource bundle and locale.
   *
   * <p>Convenience method for messages with three arguments.
   *
   * <p>
   *
   * @param key the message key
   ...
   * Returns the selected localized message for the initialized resource bundle and locale.
   *
   * <p>If the key was found in the bundle, it will be formatted using a <code>{@link MessageFormat}
   * </code> using the provided parameters.
   *
   * <p>If the key was not found in the bundle, the return value is <code>"??? " + keyName + " ???"
   * </code>. This will also be returned if the bundle was not properly initialized first.
   *
   ...
   * Returns the localized resource string for a given message key.
   *
   * <p>If the key was not found in the bundle, the provided default value is returned.
   *
   * <p>
   *
   * @param keyName the key for the desired string
  ...
  /**
   * Returns the localized resource string for a given message key, treating all values appended
   * with "|" as replacement parameters.
   *
   * <p>If the key was found in the bundle, it will be formatted using a <code>{@link MessageFormat}
   * </code> using the provided parameters. The parameters have to be appended to the key separated
   * by a "|". For example, the keyName <code>error.message|First|Second</code> would use the key
   * <code>error.message</code> with the parameters <code>First</code> and <code>Second</code>. This
   * would be the same as calling <code>{@link CmsMessages#key(String, Object[])}</code>.
   *
   * <p>If no parameters are appended with "|", this is the same as calling <code>
   * {@link CmsMessages#key(String)}</code>.
   *
   * <p>If the key was not found in the bundle, the return value is <code>"??? " + keyName + " ???"
   * </code>. This will also be returned if the bundle was not properly initialized first.
   *
