 ...
 *
 * <p>This handler, when given a key of the form label.foo.bar (starting with 'label' and containing
 * at least three dot-separated components), removes the second component (in the example, this
 * results in the key label.bar).
 *
 * <p>This can be useful if you want to reuse the same key for fields of multiple content types.
 */
public class CmsRemoveInnerNameFallback implements I_KeyFallbackHandler, I_CmsRegexSubstitution {
  ...
  /**
   * @see org.opencms.util.I_CmsRegexSubstitution#substituteMatch(java.lang.String,
