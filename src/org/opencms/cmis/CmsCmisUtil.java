...
public final class CmsCmisUtil {
  ...
  public static boolean addPropertyDefault(PropertiesImpl props, PropertyDefinition<?> propDef) {
    ...
    if ((defaultValue != null) && (!defaultValue.isEmpty())) {
      switch (propDef.getPropertyType()) {
        ...
        case DECIMAL:
          props.addProperty(
              new PropertyDecimalImpl(propDef.getId(), (List<BigDecimal>) defaultValue));
          break;
        case HTML:
        ...
        case INTEGER:
          props.addProperty(
              new PropertyIntegerImpl(propDef.getId(), (List<BigInteger>) defaultValue));
          break;
        case STRING:
   ...
   *
   * <p>Returns true only if the resource wasn't already locked before.
   *
   * <p>
   *
  ...
  /**
   * Converts an OpenCms access control entry to a list of CMIS permissions which represent native
   * OpenCms permissions.
   *
   * <p>
   *
  ...
  /**
   * Converts an OpenCms access control bitset to a list of CMIS permissions representing native
   * OpenCms permissions.
   *
   * <p>
   *
   * @param permissionBits the permission bits
   * @param denied if the permission bitset refers to a list of denied rather than allowed
   *     permissions
  ...
  /**
   * Splits a filter statement into a collection of properties. If <code>filter</code> is <code>null
   * </code>, empty or one of the properties is '*' , an empty collection will be returned.
   *
