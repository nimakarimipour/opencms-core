...
/**
 * This class keeps track of all the types which should be available for a {@link
 * I_CmsCmisRepository}.
 */
public class CmsCmisTypeManager {
  ...
  /**
   * Adds the base CMIS property definitions common to folders and documents.
   *
   * <p>
   *
  ...
  /**
   * Adds CMIS property definitions for documents.
   *
   * <p>
   *
  ...
  /**
   * Adds folder specific CMIS property definitions.
   *
   * <p>
   *
  ...
  /**
   * Helper method to add the property definitions specific to relationship types.
   *
   * <p>
   *
   * @param type the type definition to which the property definitions should be added
  ...
  /**
   * Helper method to make a property definition queryable and orderable.
   *
   * <p>
   *
   ...
   */
  private static AbstractPropertyDefinition<?> queryableAndOrderable(
      AbstractPropertyDefinition<?> propDef) {
  ...
  public TypeDefinitionList getTypeChildren(
    ...
    if (typeId == null) {
      ...
      result.setHasMoreItems(
          Boolean.valueOf((result.getList().size() + skip) < tc.getChildren().size()));
  ...
  public List<TypeDefinitionContainer> getTypeDescendants(
    ...
    if (typeId == null) {
      ...
      result.add(
          getTypeDescendants(d, m_types.get(RELATIONSHIP_TYPE_ID), includePropertyDefinitions));
    } else {
      TypeDefinitionContainer tc = m_types.get(typeId);
      if (tc != null) {
  ...
  /**
   * Creates the CMIS property definition for an OpenCms resource property definition.
   *
   * <p>
   *
  ...
  /**
   * Adds the CMIS property definitions corresponding to the OpenCms property definitions to a CMIS
   * type definition.
   *
   * <p>
   *
  ...
  /**
   * Helper method for adding property definitions for the dynamic properties.
   *
   * <p>
   *
  ...
  /**
   * Internal method which adds a new type, without adding any property definitions automatically.
   *
   * <p>
   *
  ...
  /**
   * Collects the descendants of a type.
   *
   * <p>
   *
  ...
  private TypeDefinitionContainer getTypeDescendants(
      int depth, TypeDefinitionContainer tc, boolean includePropertyDefinitions) {
    ...
    if (depth != 0) {
      if (tc.getChildren() != null) {
        ...
        for (TypeDefinitionContainer tdc : tc.getChildren()) {
          result
              .getChildren()
              .add(getTypeDescendants(depth < 0 ? -1 : depth - 1, tdc, includePropertyDefinitions));
        }
      }
    }
  ...
  /**
   * Refreshes the internal data if the last update was longer ago than the udpate interval.
   *
   * <p>
   */
