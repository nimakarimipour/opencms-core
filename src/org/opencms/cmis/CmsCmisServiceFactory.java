...
public class CmsCmisServiceFactory extends AbstractServiceFactory {
  ...
  /**
   * An invocation handler which wraps a service and is used for debugging/logging CMIS service
   * calls.
   *
   * <p>
   */
  static class LoggingServiceProxy implements InvocationHandler {
    ...
    public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
      ...
      try {
        // CmisService defines some methods in addition to its base interfaces which don't
        // correspond to CMIS service calls
        ...
        if (isServiceCall && LOG.isDebugEnabled()) {
          // This can generate a *VERY LARGE AMOUNT* of data in the log file, don't activate the
          // debug channel
    ...
    /**
     * Creates a string representation of a given method call, which is used for logging.
     *
     * <p>
     *
  ...
  /**
   * @see
   *     org.apache.chemistry.opencmis.commons.impl.server.AbstractServiceFactory#getService(org.apache.chemistry.opencmis.commons.server.CallContext)
   */
  @Override
  public CmisService getService(CallContext context) {

    CmsCmisService service = new CmsCmisService(context);
    CmisService proxyService =
        (CmisService)
  ...
  /**
   * @see
   *     org.apache.chemistry.opencmis.commons.impl.server.AbstractServiceFactory#init(java.util.Map)
   */
  @Override
