...
public class CmsCmisRepository extends A_CmsCmisRepository {
  ...
  /**
   * Simple helper class to simplify creating a permission mapping.
   *
   * <p>
   */
  ...
  /**
   * Readonly flag to prevent write operations on the repository.
   *
   * <p>
   */
  ...
  private Map<String, I_CmsCmisRenditionProvider> m_renditionProviders =
      new HashMap<String, I_CmsCmisRenditionProvider>();
  ...
  /**
   * @see org.opencms.cmis.I_CmsCmisRepository#addConfigurationParameter(java.lang.String,
   *     java.lang.String)
   */
  ...
  /**
   * @see org.opencms.cmis.I_CmsCmisRepository#createDocument(org.opencms.cmis.CmsCmisCallContext,
  ...
  public synchronized String createDocument(
    ...
    try {
      ...
      try {
        CmsResource newDocument =
            cms.createResource(newFolderPath, cmsResourceType.getTypeId(), content, cmsProperties);
  ...
  /**
   * @see
   *     org.opencms.cmis.I_CmsCmisRepository#createDocumentFromSource(org.opencms.cmis.CmsCmisCallContext,
   *     java.lang.String, org.apache.chemistry.opencmis.commons.data.Properties, java.lang.String,
   *     org.apache.chemistry.opencmis.commons.enums.VersioningState, java.util.List,
   *     org.apache.chemistry.opencmis.commons.data.Acl,
   *     org.apache.chemistry.opencmis.commons.data.Acl)
   */
  ...
  /**
   * @see org.opencms.cmis.I_CmsCmisRepository#createFolder(org.opencms.cmis.CmsCmisCallContext,
   *     org.apache.chemistry.opencmis.commons.data.Properties, java.lang.String, java.util.List,
   *     org.apache.chemistry.opencmis.commons.data.Acl,
   *     org.apache.chemistry.opencmis.commons.data.Acl)
   */
  public synchronized String createFolder(
    ...
    try {
      ...
      Map<String, PropertyData<?>> properties = propertiesObj.getProperties();
      String resTypeName =
          getResourceTypeFromProperties(properties, CmsResourceTypeFolder.getStaticTypeName());
      I_CmsResourceType cmsResourceType = OpenCms.getResourceManager().getResourceType(resTypeName);
      if (!cmsResourceType.isFolder()) {
      ...
      try {
        CmsResource newFolder =
            cms.createResource(newFolderPath, cmsResourceType.getTypeId(), null, cmsProperties);
  ...
  /**
   * @see
   *     org.opencms.cmis.I_CmsCmisRepository#createRelationship(org.opencms.cmis.CmsCmisCallContext,
  ...
  public synchronized String createRelationship(
    ...
    try {
      ...
      try {
        ...
        return "REL_"
            + sourceRes.getStructureId()
            + "_"
            + targetRes.getStructureId()
            + "_"
            + cmsTypeName;
      } finally {
        if (wasLocked) {
  ...
  /**
   * @see
   *     org.opencms.cmis.I_CmsCmisRepository#deleteContentStream(org.opencms.cmis.CmsCmisCallContext,
   *     org.apache.chemistry.opencmis.commons.spi.Holder,
   *     org.apache.chemistry.opencmis.commons.spi.Holder)
   */
  public synchronized void deleteContentStream(
      CmsCmisCallContext context, Holder<String> objectId, Holder<String> changeToken) {

    throw new CmisConstraintException("Content streams may not be deleted.");
  }

  /**
   * @see org.opencms.cmis.I_CmsCmisRepository#deleteObject(org.opencms.cmis.CmsCmisCallContext,
  ...
  /**
   * @see org.opencms.cmis.I_CmsCmisRepository#deleteTree(org.opencms.cmis.CmsCmisCallContext,
   *     java.lang.String, boolean, org.apache.chemistry.opencmis.commons.enums.UnfileObject,
   *     boolean)
   */
  ...
  /**
   * @see org.opencms.cmis.I_CmsCmisRepository#getAcl(org.opencms.cmis.CmsCmisCallContext,
   *     java.lang.String, boolean)
   */
  ...
  /**
   * @see
   *     org.opencms.cmis.I_CmsCmisRepository#getAllowableActions(org.opencms.cmis.CmsCmisCallContext,
   *     java.lang.String)
   */
  ...
  /**
   * @see
   *     org.opencms.cmis.I_CmsCmisRepository#getCheckedOutDocs(org.opencms.cmis.CmsCmisCallContext,
   *     java.lang.String, java.lang.String, java.lang.String, boolean,
   *     org.apache.chemistry.opencmis.commons.enums.IncludeRelationships, java.lang.String,
  ...
  /**
   * @see org.opencms.cmis.I_CmsCmisRepository#getChildren(org.opencms.cmis.CmsCmisCallContext,
   *     java.lang.String, java.lang.String, java.lang.String, boolean,
   *     org.apache.chemistry.opencmis.commons.enums.IncludeRelationships, java.lang.String,
   *     boolean, java.math.BigInteger, java.math.BigInteger)
   */
    ...
    try {
      ...
      if (context.isObjectInfoRequired()) {
        helper.collectObjectData(
            context, cms, folder, null, renditionFilter, false, false, includeRelationships);
      }
      ...
      List<CmsResource> children =
          cms.getResourcesInFolder(folderSitePath, CmsResourceFilter.DEFAULT);
      CmsObjectListLimiter<CmsResource> limiter =
          new CmsObjectListLimiter<CmsResource>(children, maxItems, skipCount);
  ...
  /**
   * @see org.opencms.cmis.I_CmsCmisRepository#getContentStream(org.opencms.cmis.CmsCmisCallContext,
  ...
  public synchronized ContentStream getContentStream(
    ...
    try {
      ...
      result.setMimeType(
          OpenCms.getResourceManager().getMimeType(resource.getRootPath(), null, "text/plain"));
  ...
  /**
   * @see org.opencms.cmis.I_CmsCmisRepository#getDescendants(org.opencms.cmis.CmsCmisCallContext,
   *     java.lang.String, java.math.BigInteger, java.lang.String, boolean, boolean, boolean)
   */
  public synchronized List<ObjectInFolderContainer> getDescendants(
    ...
    try {
      ...
      if (context.isObjectInfoRequired()) {
        helper.collectObjectData(
            context, cms, folder, null, "cmis:none", false, false, IncludeRelationships.NONE);
      }
  ...
  /**
   * @see org.opencms.cmis.I_CmsCmisRepository#getFolderParent(org.opencms.cmis.CmsCmisCallContext,
  ...
  /**
   * @see org.opencms.cmis.I_CmsCmisRepository#getObject(org.opencms.cmis.CmsCmisCallContext,
  ...
  /**
   * @see org.opencms.cmis.I_CmsCmisRepository#getObjectByPath(org.opencms.cmis.CmsCmisCallContext,
   *     java.lang.String, java.lang.String, boolean,
   *     org.apache.chemistry.opencmis.commons.enums.IncludeRelationships, java.lang.String,
   *     boolean, boolean)
   */
  ...
  /**
   * @see org.opencms.cmis.I_CmsCmisRepository#getObjectParents(org.opencms.cmis.CmsCmisCallContext,
  ...
  public synchronized List<ObjectParentData> getObjectParents(
    ...
    try {
      ...
      if (context.isObjectInfoRequired()) {
        helper.collectObjectData(
            context, cms, file, null, "cmis:none", false, false, IncludeRelationships.NONE);
      }
  ...
  /**
   * @see
   *     org.opencms.cmis.I_CmsCmisRepository#getObjectRelationships(org.opencms.cmis.CmsCmisCallContext,
   *     java.lang.String, boolean,
   *     org.apache.chemistry.opencmis.commons.enums.RelationshipDirection, java.lang.String,
   *     java.lang.String, boolean, java.math.BigInteger, java.math.BigInteger)
   */
    ...
    try {
      ...
      List<ObjectData> resultObjects =
          getRelationshipObjectData(
              ...
              includeAllowableActions);
      CmsObjectListLimiter<ObjectData> limiter =
          new CmsObjectListLimiter<ObjectData>(resultObjects, maxItems, skipCount);
  ...
  /**
   * @see org.opencms.cmis.I_CmsCmisRepository#getProperties(org.opencms.cmis.CmsCmisCallContext,
   *     java.lang.String, java.lang.String)
   */
  public synchronized Properties getProperties(
      CmsCmisCallContext context, String objectId, String filter) {
  ...
  /**
   * @see org.opencms.cmis.I_CmsCmisRepository#getRenditions(org.opencms.cmis.CmsCmisCallContext,
   *     java.lang.String, java.lang.String, java.math.BigInteger, java.math.BigInteger)
   */
  ...
  public synchronized RepositoryInfo getRepositoryInfo() {
    ...
    capabilities.setCapabilityQuery(
        getIndex() != null ? CapabilityQuery.FULLTEXTONLY : CapabilityQuery.NONE);
  ...
  /**
   * @see org.opencms.cmis.I_CmsCmisRepository#getTypeChildren(org.opencms.cmis.CmsCmisCallContext,
   *     java.lang.String, boolean, java.math.BigInteger, java.math.BigInteger)
   */
  ...
  /**
   * @see
   *     org.opencms.cmis.I_CmsCmisRepository#getTypeDefinition(org.opencms.cmis.CmsCmisCallContext,
   *     java.lang.String)
   */
  ...
  /**
   * @see
   *     org.opencms.cmis.I_CmsCmisRepository#getTypeDescendants(org.opencms.cmis.CmsCmisCallContext,
   *     java.lang.String, java.math.BigInteger, boolean)
   */
  ...
  public void initConfiguration() throws CmsConfigurationException {
    ...
    List<String> renditionProviderClasses =
        m_parameterConfiguration.getList(PARAM_RENDITION, Collections.<String>emptyList());
    for (String className : renditionProviderClasses) {
      try {
        I_CmsCmisRenditionProvider provider =
            (I_CmsCmisRenditionProvider) (Class.forName(className).newInstance());
    ...
    List<String> propertyProviderClasses =
        m_parameterConfiguration.getList(PARAM_PROPERTY, Collections.<String>emptyList());
    for (String className : propertyProviderClasses) {
      try {
        I_CmsPropertyProvider provider =
            (I_CmsPropertyProvider) (Class.forName(className).newInstance());
  ...
  public void initializeCms(CmsObject cms) throws CmsException {
    ...
    String projectName =
        m_parameterConfiguration.getString(PARAM_PROJECT, CmsProject.ONLINE_PROJECT_NAME);
  ...
  /**
   * @see org.opencms.cmis.I_CmsCmisRepository#moveObject(org.opencms.cmis.CmsCmisCallContext,
   *     org.apache.chemistry.opencmis.commons.spi.Holder, java.lang.String, java.lang.String)
   */
  ...
  /**
   * @see org.opencms.cmis.I_CmsCmisRepository#query(org.opencms.cmis.CmsCmisCallContext,
  ...
  /**
   * @see org.opencms.cmis.I_CmsCmisRepository#setContentStream(org.opencms.cmis.CmsCmisCallContext,
   *     org.apache.chemistry.opencmis.commons.spi.Holder, boolean,
   *     org.apache.chemistry.opencmis.commons.spi.Holder,
   *     org.apache.chemistry.opencmis.commons.data.ContentStream)
   */
  ...
  /**
   * @see org.opencms.cmis.I_CmsCmisRepository#updateProperties(org.opencms.cmis.CmsCmisCallContext,
   *     org.apache.chemistry.opencmis.commons.spi.Holder,
   *     org.apache.chemistry.opencmis.commons.spi.Holder,
  ...
  protected void checkWriteAccess() {
    ...
    if (m_isReadOnly) {
      throw new CmisNotSupportedException(
          "Readonly repository '" + m_id + "' does not allow write operations.");
    }
  }
    ...
    try {
      if (context.getUsername() == null) {
        ...
        cms.getRequestContext()
            .setCurrentProject(m_adminCms.getRequestContext().getCurrentProject());
        return cms;
      } else {
  ...
  protected List<ObjectData> getRelationshipObjectData(
    ...
    List<CmsRelation> unfilteredRelations =
        cms.getRelationsForResource(resource.getRootPath(), relationFilter);
    ...
    for (CmsRelation relation : relations) {
      ObjectData objData =
          helper.collectObjectData(
              context, cms, resource, relation, filterSet, includeAllowableActions, false);
   ...
   */
  protected String getResourceTypeFromProperties(
      Map<String, PropertyData<?>> properties, String defaultValue) {
  ...
  /**
   * Gets the correct helper object for a given object id to perform operations on the corresponding
   * object.
   *
   * <p>
   *
  ...
  /**
   * Helper method to collect the descendants of a given folder.
   *
   * <p>
   *
   * @param context the call context
  ...
  private void gatherDescendants(
    ...
    try {
      CmsCmisResourceHelper helper = getResourceHelper();
      List<CmsResource> children =
          cms.getResourcesInFolder(cms.getSitePath(folder), CmsResourceFilter.DEFAULT);
      Collections.sort(
          children,
          new Comparator<CmsResource>() {
  ...
  /**
   * Gets the index to use for queries.
   *
   * <p>
   *
  ...
  /**
   * Gets the relation object helper.
   *
   * <p>
   *
  ...
  /**
   * Gets the resource object helper.
   *
   * <p>
   *
