 ...
 *
 * <p>This class was introduced to separate the CMIS methods which are not supported from those
 * which are, so only unsupported operations and utility should go into this class.
 *
 * <p>
 */
public abstract class A_CmsCmisRepository implements I_CmsCmisRepository {
  ...
  /**
   * @see
   *     org.opencms.cmis.I_CmsCmisRepository#addObjectToFolder(org.opencms.cmis.CmsCmisCallContext,
   *     java.lang.String, java.lang.String, boolean)
   */
  public synchronized void addObjectToFolder(
      CmsCmisCallContext context, String objectId, String folderId, boolean allVersions) {

    throw notSupported();
  }

  /**
   * @see org.opencms.cmis.I_CmsCmisRepository#applyAcl(org.opencms.cmis.CmsCmisCallContext,
   *     java.lang.String, org.apache.chemistry.opencmis.commons.data.Acl,
   ...
   */
  public synchronized Acl applyAcl(
      CmsCmisCallContext context, String objectId, Acl aces, AclPropagation aclPropagation) {

    throw notSupported();
  }

  /**
   * @see org.opencms.cmis.I_CmsCmisRepository#applyPolicy(org.opencms.cmis.CmsCmisCallContext,
   *     java.lang.String, java.lang.String)
   */
  public synchronized void applyPolicy(
      CmsCmisCallContext context, String policyId, String objectId) {

    throw notSupported();
  }

  /**
   * @see org.opencms.cmis.I_CmsCmisRepository#cancelCheckOut(org.opencms.cmis.CmsCmisCallContext,
   *     java.lang.String)
   */
  ...
  /**
   * @see org.opencms.cmis.I_CmsCmisRepository#checkIn(org.opencms.cmis.CmsCmisCallContext,
   *     org.apache.chemistry.opencmis.commons.spi.Holder, boolean,
   *     org.apache.chemistry.opencmis.commons.data.Properties,
   *     org.apache.chemistry.opencmis.commons.data.ContentStream, java.lang.String, java.util.List,
   *     org.apache.chemistry.opencmis.commons.data.Acl,
   *     org.apache.chemistry.opencmis.commons.data.Acl)
   */
  ...
  /**
   * @see org.opencms.cmis.I_CmsCmisRepository#checkOut(org.opencms.cmis.CmsCmisCallContext,
   *     org.apache.chemistry.opencmis.commons.spi.Holder,
   *     org.apache.chemistry.opencmis.commons.spi.Holder)
   */
  public synchronized void checkOut(
      CmsCmisCallContext context, Holder<String> objectId, Holder<Boolean> contentCopied) {

    throw notSupported();
  }

  /**
   * @see org.opencms.cmis.I_CmsCmisRepository#createPolicy(org.opencms.cmis.CmsCmisCallContext,
  ...
  /**
   * @see org.opencms.cmis.I_CmsCmisRepository#getAllVersions(org.opencms.cmis.CmsCmisCallContext,
  ...
  /**
   * @see
   *     org.opencms.cmis.I_CmsCmisRepository#getAppliedPolicies(org.opencms.cmis.CmsCmisCallContext,
   *     java.lang.String, java.lang.String)
   */
  ...
  /**
   * @see
   *     org.opencms.cmis.I_CmsCmisRepository#getContentChanges(org.opencms.cmis.CmsCmisCallContext,
   *     org.apache.chemistry.opencmis.commons.spi.Holder, boolean, java.lang.String, boolean,
   *     boolean, java.math.BigInteger)
   */
  ...
  /**
   * @see
   *     org.opencms.cmis.I_CmsCmisRepository#getObjectOfLatestVersion(org.opencms.cmis.CmsCmisCallContext,
   *     java.lang.String, java.lang.String, boolean, java.lang.String, boolean,
  ...
  /**
   * @see
   *     org.opencms.cmis.I_CmsCmisRepository#getPropertiesOfLatestVersion(org.opencms.cmis.CmsCmisCallContext,
  ...
  /**
   * @see
   *     org.opencms.cmis.I_CmsCmisRepository#removeObjectFromFolder(org.opencms.cmis.CmsCmisCallContext,
   *     java.lang.String, java.lang.String)
   */
  public synchronized void removeObjectFromFolder(
      CmsCmisCallContext context, String objectId, String folderId) {

    throw notSupported();
  }

  /**
   * @see org.opencms.cmis.I_CmsCmisRepository#removePolicy(org.opencms.cmis.CmsCmisCallContext,
   *     java.lang.String, java.lang.String)
   */
  public synchronized void removePolicy(
      CmsCmisCallContext context, String policyId, String objectId) {
  ...
  protected byte[] extractRange(byte[] content, BigInteger offset, BigInteger length) {
    ...
    return Arrays.copyOfRange(
        content, (int) offsetLong, Math.min(content.length, (int) (offsetLong + lengthLong)));
  }
