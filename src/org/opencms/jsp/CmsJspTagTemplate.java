...
public class CmsJspTagTemplate extends BodyTagSupport {
  ...
  public static boolean templateTagAction(
      String element, String elementlist, boolean checkall, boolean checknone, ServletRequest req) {
    ...
    if (elementlist != null) {
      ...
      try {
        ...
        LOG.error(
            Messages.get().getBundle().key(Messages.ERR_XML_DOCUMENT_UNMARSHAL_1, filename), e);
      }
            ...
            locale =
                OpenCms.getLocaleManager()
                    .getBestMatchingLocale(
                        ...
                        OpenCms.getLocaleManager()
                            .getDefaultLocales(controller.getCmsObject(), absolutePath),
                        locales);
          }
  ...
  public int doStartTag() {
    ...
    if (templateTagAction(
        m_element, m_elementlist, m_checkall, m_checknone, pageContext.getRequest())) {
