 ...
 *
 * <p>This tag can be used to mark OpenCms files as visited or subscribe/unsubscribe them to/from
 * users or groups.
 *
 * <p>It is also possible to check if single resources are visited/subscribed by the current user.
 *
 * <p>See also the {@link org.opencms.db.CmsSubscriptionManager} for more information about
 * subscription or visitation.
 *
 * <p>
 *
 * @since 8.0
...
public class CmsJspTagUserTracking extends TagSupport {
    ...
    try {
      ...
      switch (actionIndex) {
        ...
        case 4: // checksubscribed
          ...
          result =
              String.valueOf(isResourceSubscribed(cms, fileName, subFolder, user, groups, req));
          break;
        case 0: // visit
        default: // default action is visit
          OpenCms.getSubscriptionManager().markResourceAsVisitedBy(cms, fileName, user);
          removeSessionAttributes(
              new String[] {SESSION_PREFIX_SUBSCRIBED, SESSION_PREFIX_VISITED}, req);
      }
   ...
   * @param req the current request
   * @return <code>true</code> if the given resource is subscribed to the user or groups, otherwise
   *     <code>false</code>
   ...
   * @param user the user that should be used for the check
   * @param req the current request
   * @return <code>true</code> if the given resource was visited by the user, otherwise <code>false
   *     </code>
   * @throws CmsException if something goes wrong
   */
   ...
   *
   * <p>Current user is <code>false</code> by default.
   *
   * <p>
   *
   ...
   *
   * <p>Include groups is <code>false</code> by default.
   *
   * <p>
   *
   ...
   *
   * <p>Online is <code>false</code> by default.
   *
   * <p>
   *
