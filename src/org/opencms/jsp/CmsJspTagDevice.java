 ...
 * type</code> to specify the device.
 *
 * <p>
 *
 * @since 8.0.0
...
public class CmsJspTagDevice extends BodyTagSupport {
  ...
  /**
   * Decides on the base of the device selector interface whether the user's device is in the
   * selected device types or not.
   *
   * <p>If the user's device is in the list of possible devices the content inside the tag is
   * printed out and otherwise the content won't be printed out.
   *
   * <p>
   *
   * @return {@link #EVAL_BODY_INCLUDE}<br>
   *     {@link #SKIP_BODY}
   */
  @Override
