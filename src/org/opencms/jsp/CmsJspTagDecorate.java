 ...
 * content with configurated decoration maps.
 *
 * <p>
 *
 * @since 6.1.3
...
public class CmsJspTagDecorate extends BodyTagSupport {
  ...
  public static final String DEFAULT_DECORATOR_CONFIGURATION =
   ...
   *
   * <p>DEcorates a HTMl content block.
   *
   * <p>
   *
  ...
  public String decorateTagAction(
      String content, String configFile, String locale, ServletRequest req) {
    ...
    try {
      ...
      CmsProperty decoratorClass =
          controller.getCmsObject().readPropertyObject(configFile, PROPERTY_CATEGORY, false);
      ...
      I_CmsDecoratorConfiguration config =
          (I_CmsDecoratorConfiguration) Class.forName(decoratorClassName).newInstance();
  ...
  public int doEndTag() throws JspException {
    ...
    if (m_allowInlineEdit && CmsJspTagEditable.isEditableRequest(req)) {
      ...
      if (CmsFlexController.isCmsRequest(req)) {
        try {
          String content =
              decorateTagAction(getBodyContent().getString(), getFile(), getLocale(), req);
