...
public class CmsJspNavElement implements Comparable<CmsJspNavElement> {
     ...
     */
    public CmsJspNavElement(String sitePath, CmsResource resource, Map<String, @RUntainted String> properties, int navTreeLevel) {
     ...
     */
    @Deprecated
    public CmsJspNavElement(String sitePath, Map<String, @RUntainted String> properties) {
     ...
     */
    @Deprecated
    public CmsJspNavElement(String sitePath, Map<String, @RUntainted String> properties, int navTreeLevel) {
     ...
     */
    public void init(String resource, Map<String, @RUntainted String> properties) {
     ...
     * @see CmsJspNavBuilder#getNavigationForResource()
     */
    public void init(String resource, Map<String, @RUntainted String> properties, int navTreeLevel) {
     ...
     * @see CmsJspNavBuilder#getNavigationForResource()
     */
    public void init(String resource, Map<String, @RUntainted String> properties, int navTreeLevel, Locale locale) {
