 ...
 *
 * <p>Each navigation element contains a number of information about a VFS resource, obtained either
 * from the resources properties or attributes. You can use this information to generate a HTML
 * navigation for files in the VFS in your template.
 *
...
public class CmsJspNavElement implements Comparable<CmsJspNavElement> {
   ...
   *
   * <p>Call one of the init methods after you have created an instance of the bean. Instead of
   * using the constructor you should use the static factory methods provided by this class to
   ...
   */
  public CmsJspNavElement(
      String sitePath, CmsResource resource, Map<String, String> properties, int navTreeLevel) {
  ...
  /**
   * Returns the value of the property PROPERTY_DESCRIPTION of this navigation element, or <code>
   * null</code> if this property is not set.
   *
   * <p>
   *
   * @return the value of the property PROPERTY_DESCRIPTION of this navigation element or <code>null
   *     </code> if this property is not set
   */
  ...
  /**
   * Returns the filename of the navigation element, i.e. the name of the navigation resource
   * without any path information.
   *
   * <p>
   *
   * @return the filename of the navigation element, i.e. the name of the navigation resource
   *     without any path information
   */
  ...
  /**
   * Returns the value of the property <code>{@link CmsPropertyDefinition#PROPERTY_NAVINFO}</code>
   * of this navigation element, or <code>null</code> if this property is not set.
   *
   * <p>
   *
  ...
  /**
   * Returns the value of the property <code>{@link CmsPropertyDefinition#PROPERTY_LOCALE}</code> of
   * this navigation element, or <code>null</code> if this property is not set.
   *
   * <p>
   *
   * @return the value of the property or <code>null</code> if this property is not set
  ...
  /**
   * Returns the value of the property <code>{@link CmsPropertyDefinition#PROPERTY_NAVIMAGE}</code>
   * of this navigation element, or <code>null</code> if this property is not set.
   *
   * <p>
   *
  ...
  /**
   * Returns the value of the property C_PROPERTY_NAVPOS converted to a <code>float</code>, or a
   * value of <code>Float.MAX_VALUE</code> if the navigation position property is not set (or not a
   * valid number) for this resource.
   *
   * <p>
   *
   * @return float the value of the property C_PROPERTY_NAVPOS converted to a <code>float</code>, or
   *     a value of <code>Float.MAX_VALUE</code> if the navigation position property is not set (or
   *     not a valid number) for this resource
   */
  ...
  /**
   * Returns the value of the property PROPERTY_NAVTEXT of this navigation element, or a warning
   * message if this property is not set (this method will never return <code>null</code>).
   *
   * <p>
   *
   * @return the value of the property PROPERTY_NAVTEXT of this navigation element, or a warning
   *     message if this property is not set (this method will never return <code>null</code>)
   */
  ...
  /**
   * Returns the original map of all file properties of the resource that the navigation element
   * belongs to.
   *
   * <p>Please note that the original reference is returned, so be careful when making changes to
   * the map.
   *
   * <p>
   *
   * @return the original map of all file properties of the resource that the navigation element
   *     belongs to
   */
   ...
   *
   * <p>The navigation element contains a hash of all file properties of the resource that the
   * navigation element belongs to.
   *
   * <p>
   *
  ...
  /**
   * Returns the value of the property PROPERTY_TITLE of this navigation element, or <code>null
   * </code> if this property is not set.
   *
   * <p>
   *
   * @return the value of the property PROPERTY_TITLE of this navigation element or <code>null
   *     </code> if this property is not set
   */
  ...
  /**
   * Same as calling {@link #init(String, Map, int, Locale) init(String, Hashtable, -1, null)}.
   *
   * <p>
   *
   * @param resource the name of the resource to extract the navigation information from
   ...
   *
   * <p>A resource will be in the navigation if at least one of the two properties <code>
   * I_CmsConstants.PROPERTY_NAVTEXT</code> or <code>I_CmsConstants.PROPERTY_NAVPOS</code> is set.
   * Otherwise it will be ignored.
   *
   * <p>This bean does provides static methods to create a new instance from the context of a
   * current CmsObject. Call these static methods in order to get a properly initialized bean.
   *
   * <p>
   *
   * @param resource the name of the resource to extract the navigation information from
   * @param properties the properties of the resource read from the vfs
   * @param navTreeLevel tree level of this resource, for building navigation trees
   * @see CmsJspNavBuilder#getNavigationForResource()
   */
   ...
   */
  public void init(
      @RUntainted String resource, Map<String, String> properties, int navTreeLevel, Locale locale) {
  ...
  /**
   * Returns <code>true</code> if this navigation element describes a folder, <code>false</code>
   * otherwise.
   *
   * <p>
   *
   * @return <code>true</code> if this navigation element describes a folder, <code>false</code>
   *     otherwise.
   *     <p>
   */
  ...
  public boolean isHiddenNavigationEntry() {
    ...
    if (m_isHiddenNavigationEntry == null) {
      ...
      m_isHiddenNavigationEntry =
          Boolean.valueOf(CmsClientSitemapEntry.HIDDEN_NAVIGATION_ENTRY.equals(navInfo));
    }
    return m_isHiddenNavigationEntry.booleanValue();
  }

  /**
   * Returns <code>true</code> if this navigation element is in the navigation, <code>false</code>
   * otherwise.
   *
   * <p>A resource is considered to be in the navigation, if
   *
   * <ol>
   *   <li>it has the property PROPERTY_NAVTEXT set
   *   <li><em>or</em> it has the property PROPERTY_NAVPOS set
   *   <li><em>and</em> it is not a temporary file as defined by {@link
   *       CmsResource#isTemporaryFileName(String)}.
   * </ol>
   *
   * @return <code>true</code> if this navigation element is in the navigation, <code>false</code>
   *     otherwise
   */
  public boolean isInNavigation() {
    ...
    if (m_hasNav == null) {
      ...
      m_hasNav =
          Boolean.valueOf(
              ((o1 != null) || (o2 != null)) && !CmsResource.isTemporaryFileName(m_sitePath));
    }
    return m_hasNav.booleanValue();
  }

  /**
   * Returns if the navigation element represents a navigation level, linking to it's first
   * sub-element.
   *
   * <p>
   *
  ...
  /**
   * Sets the value that will be returned by the {@link #getNavPosition()} method of this class.
   *
   * <p>
   *
   ...
   *
   * <p>This may not be the same as the navigation resource.
   *
   * <p>
   *
