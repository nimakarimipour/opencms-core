...
public class CmsJspTagEdit extends CmsJspScopedVarBodyTagSuport {
     ...
     * @return the resource type name
     */
    public static @RPolyTainted String getTypeFromNewLink(@RPolyTainted String newLink) {
     ...
     */
    private static I_CmsResourceType getResourceType(CmsResource resource, @RUntainted String createType) {
