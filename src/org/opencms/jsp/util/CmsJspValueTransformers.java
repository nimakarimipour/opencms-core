...
public final class CmsJspValueTransformers {
      ...
      if (m_localeProperties.get(locale) == null) {
        Map<String, String> lazyMap =
            CmsCollectionsGenericWrapper.createLazyMap(
                new CmsJspValueTransformers.CmsPropertyLoaderTransformer(
                    m_cms, m_res, m_search, locale));
  ...
  /**
   * Transformer that reads a resource property, the input is used as String for the property name
   * to read.
   *
   * <p>
   */
  public static final class CmsPropertyLoaderTransformer implements Transformer {
     ...
     * @param search flag, indicating if property should be searched or not.
     */
    public CmsPropertyLoaderTransformer(
        CmsObject cms, CmsResource resource, boolean search, Locale locale) {
    ...
    public Object transform(Object input) {
      ...
      try {
        ...
        result =
            m_cms.readPropertyObject(m_res, String.valueOf(input), m_search, m_locale).getValue();
      } catch (
