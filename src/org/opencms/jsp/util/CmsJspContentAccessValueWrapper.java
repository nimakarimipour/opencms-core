...
public final class CmsJspContentAccessValueWrapper extends A_CmsJspValueWrapper {
  ...
  /**
   * Provides a Map with Booleans that indicate if a nested sub value (xpath) for the current value
  ...
  public class CmsHasValueTransformer implements Transformer {
    ...
    public Object transform(Object input) {
      ...
      return Boolean.valueOf(
          getContentValue()
              .getDocument()
              .hasValue(createPath(input), getContentValue().getLocale()));
    }
  }

  /**
   * Provides a Map which lets the user a nested sub value from the current value, the input is
  ...
  /**
   * Provides a Map which lets the user access nested sub value Lists directly below the current
   * value, the input is assumed to be a String that represents an xpath in the XML content.
   *
   * <p>
   */
  public class CmsSubValueListTransformer implements Transformer {
    ...
    public Object transform(Object input) {
      ...
      List<I_CmsXmlContentValue> values =
          getContentValue()
              .getDocument()
              .getSubValues(createPath(input), getContentValue().getLocale());
  ...
  /**
   * Provides a Map which lets the user access nested sub value Lists from the current value, the
   * input is assumed to be a String that represents an xpath in the XML content.
   *
   * <p>
   */
  public class CmsValueListTransformer implements Transformer {
    ...
    public Object transform(Object input) {
      ...
      List<I_CmsXmlContentValue> values =
          getContentValue()
              .getDocument()
              .getValues(createPath(input), getContentValue().getLocale());
      List<CmsJspContentAccessValueWrapper> result =
          new ArrayList<CmsJspContentAccessValueWrapper>();
      Iterator<I_CmsXmlContentValue> i = values.iterator();
      while (i.hasNext()) {
   ...
   *
   * <p>The input is assumed to be a String that represents an xpath in the XML content.
   *
   * <p>
   */
  public class CmsValueTransformer implements Transformer {
    ...
    public Object transform(Object input) {
      ...
      I_CmsXmlContentValue value =
          getContentValue()
              .getDocument()
              .getValue(createPath(input), getContentValue().getLocale());
      return createWrapper(obtainCmsObject(), value, getContentValue(), (String) input);
    }
  }

  /**
   * Provides a Map which lets the user directly access sub-nodes of the XML represented by the
   * current value, the input is assumed to be a String that represents an xpath in the XML content.
   *
   * <p>
   */
  ...
  protected static final CmsJspContentAccessValueWrapper NULL_VALUE_WRAPPER =
      new CmsJspContentAccessValueWrapper();
   ...
   *
   * <p>Used to create a copy with macro resolving enabled.
   *
   * <p>
   *
   ...
   */
  private CmsJspContentAccessValueWrapper(
      CmsJspContentAccessValueWrapper base, CmsMacroResolver macroResolver) {
   ...
   *
   * <p>In case either parameter is <code>null</code>, the {@link #NULL_VALUE_WRAPPER} is returned.
   *
   * <p>
   *
   * @param cms the current users OpenCms context
  ...
  /**
   * Returns if direct edit is enabled.
   *
   * <p>
   *
  ...
  static boolean isDirectEditEnabled(CmsObject cms) {
    ...
    return !cms.getRequestContext().getCurrentProject().isOnlineProject()
        && (cms.getRequestContext().getAttribute(CmsGwtConstants.PARAM_DISABLE_DIRECT_EDIT)
            == null);
  }
   ...
   *
   * <p>Note that this will return <code>null</code> when {@link #getExists()} returns <code>false
   * </code>
   *
   * <p>.
   *
  ...
  /**
   * Returns <code>true</code> in case this value actually exists in the XML content it was
   * requested from.
   *
   ...
   * &lt;/cms:contentload&gt;</pre>
   *
   * @return <code>true</code> in case this value actually exists in the XML content it was
   *     requested from
   */
  @Override
  ...
  /**
   * Returns a lazy initialized Map that provides Booleans that indicate if a nested sub value
   * (xpath) for the current value is available in the XML content.
   *
   * <p>The provided Map key is assumed to be a String that represents the relative xpath to the
   * value.
   *
   * <p>In case the current value is not a nested XML content value, or the XML content value does
   * not exist, the {@link CmsConstantMap#CONSTANT_BOOLEAN_FALSE_MAP} is returned.
   *
   * <p>Usage example on a JSP with the JSTL:
   *
   * <pre>
   ...
   * </pre>
   *
   * @return a lazy initialized Map that provides Booleans that indicate if a sub value (xpath) for
   *     the current value is available in the XML content
   */
   ...
   *
   * <p>Use to insert the annotation attributes into a HTML tag.
   *
   * <p>Only makes sense in case this node actually contains the path to an image.
   *
   * <p>Example using EL: &lt;span ${value.Image.imageDndAttr}&gt; ... &lt;/span&gt; will result in
   * &lt;span data-imagednd="..."&gt; ... &lt;/span&gt;
   *
   * <p>
   *
   ...
   *
   * <p>In case the XML content value does not exist, <code>-1</code> is returned.
   *
   * <p>Usage example on a JSP with the JSTL:
   *
   * <pre>
  ...
  /**
   * Returns <code>true</code> in case the value is empty, that is either <code>null</code> or an
   * empty String.
   *
   * <p>In case the XML content value does not exist, <code>true</code> is returned.
   *
   * <p>Usage example on a JSP with the JSTL:
   *
   * <pre>
  ...
  /**
   * Returns <code>true</code> in case the value is empty or whitespace only, that is either <code>
   * null</code> or String that contains only whitespace chars.
   *
   * <p>In case the XML content value does not exist, <code>true</code> is returned.
   *
   * <p>Usage example on a JSP with the JSTL:
   ...
   *
   * <p>In case the XML content value does not exist, the OpenCms system default Locale is returned.
   *
   * <p>Usage example on a JSP with the JSTL:
   *
   * <pre>
  ...
  /**
   * Returns a list that provides the names of all nested sub values directly below the current
   * value from the XML content, including the index.
   *
   * <p>Usage example on a JSP with the JSTL:
   *
   * <pre>
   ...
   * &lt;/cms:contentload&gt;</pre>
   *
   * @return a list with all available elements paths (Strings) available directly below this
   *     element
   */
  public List<String> getNames() {
    ...
    if ((m_names == null)) {
      ...
      if (!m_contentValue.isSimpleType()) {
        for (I_CmsXmlContentValue value :
            m_contentValue.getDocument().getSubValues(getPath(), getLocale())) {
   ...
   *
   * <p>In case the XML content value does not exist, an empty String <code>""</code> is returned.
   *
   * <p>Usage example on a JSP with the JSTL:
   *
   * <pre>
   ...
   * <p>Use to insert the annotation attributes into a HTML tag.
   *
   * <p>Example using EL: &lt;h1 ${value.Title.rdfaAttr}&gt;${value.Title}&lt;/h1&gt; will result in
   * &lt;h1 data-oc-id="..." data-oc-field="..."&gt;My title&lt;/h1&gt;
   *
   * <p>
   *
   * @return the RDFA
          ...
          if (m_nullValueInfo.getParentValue() != null) {
            result =
                CmsContentService.getRdfaAttributes(
                    m_nullValueInfo.getParentValue(), m_nullValueInfo.getValueName());
  ...
  /**
   * Short form of {@link #getResolveMacros()}.
   *
   * <p>
   *
   ...
   *
   * <p>Macro resolving is turned off by default. When turned on, a macro resolver is initialized
   * with the current OpenCms user context and the URI of the current resource. This means known
   * macros contained in the wrapped value will be resolved when the output String is generated. For
   * example, a <code>%(property.Title)</code> in the value would be replaced with the value of the
   * title property. Macros that can not be resolved will be kept.
   *
   * <p>Usage example on a JSP with the JSTL:
   *
   * <pre>
  ...
  /**
   * Returns a lazy initialized Map that provides the Lists of sub values directly below the current
   * value from the XML content.
   *
   * <p>The provided Map key is assumed to be a String that represents the relative xpath to the
   * value. Use this method in case you want to iterate over a List of sub values from the XML
   * content.
   *
   * <p>In case the current value is not a nested XML content value, or the XML content value does
   * not exist, the {@link CmsConstantMap#CONSTANT_EMPTY_LIST_MAP} is returned.
   *
   * <p>Usage example on a JSP with the JSTL:
   *
   * <pre>
   ...
   * &lt;/cms:contentload&gt;</pre>
   *
   * @return a lazy initialized Map that provides a Lists of direct sub values of the current value
   ...
   *
   * <p>The current value must be a nested content with sub-values that have exactly 2 values each,
   ...
   * </pre>
   *
   * Please note that the result Map is a simple String map, NOT a map with {@link
   * CmsJspContentAccessValueWrapper} classes.
   *
   * <p>
   *
    ...
    if (m_parameters == null) {
      ...
      if (xmlvalue != null) {
        if (!getContentValue().isSimpleType()) {
          ...
          List<I_CmsXmlContentValue> parameters =
              xmlvalue.getDocument().getValues(xmlvalue.getPath(), xmlvalue.getLocale());
  ...
  /**
   * Returns a lazy initialized Map that provides the nested sub values for the current value from
   * the XML content.
   *
   * <p>The provided Map key is assumed to be a String that represents the relative xpath to the
   * value.
   *
   * <p>In case the current value is not a nested XML content value, or the XML content value does
   * not exist, the {@link CmsJspContentAccessBean#CONSTANT_NULL_VALUE_WRAPPER_MAP} is returned.
   *
   * <p>Usage example on a JSP with the JSTL:
   *
   * <pre>
   ...
   * &lt;/cms:contentload&gt;</pre>
   *
   * Please note that this example will only work if the 'Link' element is mandatory in the schema
   * definition of the XML content.
   *
   * <p>
   *
   * @return a lazy initialized Map that provides a sub value for the current value from the XML
   *     content
   */
  ...
  /**
   * Returns a lazy initialized Map that provides the Lists of nested sub values for the current
   * value from the XML content.
   *
   * <p>The provided Map key is assumed to be a String that represents the relative xpath to the
   * value. Use this method in case you want to iterate over a List of values form the XML content.
   *
   * <p>In case the current value is not a nested XML content value, or the XML content value does
   * not exist, the {@link CmsConstantMap#CONSTANT_EMPTY_LIST_MAP} is returned.
   *
   ...
   * &lt;/cms:contentload&gt;</pre>
   *
   * @return a lazy initialized Map that provides a Lists of sub values for the current value from
   *     the XML content
   */
  ...
  /**
   * Returns a lazy initialized Map that provides direct access to the XML element for the current
   * value from the XML content.
   *
   * <p>
   *
   * @return a lazy initialized Map that provides direct access to the XML element for the current
   *     value from the XML content
   */
  ...
  /**
   * The hash code is created from the file structure id of the underlying XML content, the selected
   * locale and the path to the node in the XML content.
   *
   ...
   * <p>.
   *
   * <p>Method name does not start with "get" to prevent using it in the expression language.
   *
   * <p>
   *
   * @return the wrapped content value
   ...
   *
   * <p>This is used to create xpath information for sub-elements in the transformers.
   *
   * <p>
   *
