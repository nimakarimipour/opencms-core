...
public final class CmsJspObjectValueWrapper extends A_CmsJspValueWrapper {
  ...
  /**
   * Returns <code>true</code> in case there was an object wrapped.
   *
   * <p>
   *
  ...
  /**
   * Returns <code>true</code> in case the object is empty, that is either <code>null</code> or an
   * empty String.
   *
   * <p>In case the object does not exist, <code>true</code> is returned.
   *
   * <p>
   *
  ...
  /**
   * Returns <code>true</code> in case the object is empty or whitespace only, that is either <code>
   * null</code> or an empty String.
   *
   * <p>In case the object does not exist, <code>true</code> is returned.
   *
   * <p>
  ...
  /**
   * Converts the wrapped value to a date. Keeps it as date, if it already is one.
   *
   * <p>
   *
   * @return the date
