...
public class CmsStringTemplateRenderer {
  ...
  public static final String ERROR_DISPLAY =
      "<div class='oc-fomatter-error'>\n"
  ...
  public static final String ERROR_DISPLAY_WITH_DETAILS =
      "<div class='oc-fomatter-error'>\n"
          + "<div class='oc-formatter-error-head'>%1$s</div>\n"
          + "<div class='oc-formatter-error-body'>\n"
          + "<div class='oc-formatter-error-source'>%2$s</div>\n"
   ...
   */
  public static String renderTemplate(
      CmsObject cms, String template, CmsResource content, Map<String, Object> contextObjects) {
   ...
   * @param content the content
   * @param contextObjects additional context objects made available to the template
   * @param pathPrefix the path to the content part that should be accessible as content to the
   *     string template.
   * @return the rendering result
   */
  public static String renderTemplate(
   ...
   */
  public static Map<String, CmsJspObjectValueWrapper> wrapSettings(
      CmsObject cms, Map<String, String> settings) {
    ...
    if (settings != null) {
      ...
      for (Entry<String, String> setting : settings.entrySet()) {
        wrappedSettings.put(
            setting.getKey(), CmsJspObjectValueWrapper.createWrapper(cms, setting.getValue()));
      }
    }
  ...
  private static String renderTemplateInternal(
      CmsObject cms, String template, Object content, Map<String, Object> contextObjects) {
          ...
          if (!validator.isBalanced()) {
            ...
            output =
                String.format(
                    ...
                    Messages.get()
                        .getBundle(locale)
                        .key(Messages.GUI_FORMATTER_RENDERING_NOT_WELL_FORMED_0),
                    messages);
            ...
            output =
                String.format(
                    ...
                    Messages.get()
                        .getBundle(locale)
                        .key(Messages.GUI_FORMATTER_RENDERING_MULTIPLE_ROOT_ELEMENTS_0));
          }
        }
          ...
          m_context
              ...
              .println(
                  String.format(
                      ...
                      Messages.get()
                          .getBundle(locale)
                          .key(Messages.GUI_FORMATTER_RENDERING_ERROR_0),
                      formatterConfig.getJspRootPath(),
                      t.getMessage(),
                      stackTrace));
        }
