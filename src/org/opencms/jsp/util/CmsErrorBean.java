...
public class CmsErrorBean {
  ...
  /**
   * Returns the html code for the buttons, when the errorpage is included from outside the
   * workplace.
   *
   * <p>
   *
  ...
  public String getDefaultButtonsHtml() {
    ...
    result
        .append("<input name=\"close\" type=\"button\" value=\"")
        .append(closeLabel)
        .append("\" onclick=\"closeDialog();\" class=\"dialogbutton\">");
    result
        .append("<input name=\"details\" type=\"button\" value=\"")
        .append(detailsLabel)
        .append("\" class=\"dialogbutton\" onclick=\"toggleElement('errordetails');\">");
    result.append("</div>");
   ...
   * @return returns the localized Message, if the argument is a CmsException, or the message
   *     otherwise
   */
  ...
  public String toHtml() {
    ...
    resolver.addMacro(
        ...
        OpenCms.getLinkManager()
            .substituteLink(m_cms, "/system/workplace/commons/style/workplace.css"));
    ...
    resolver.addMacro(
        "erroricon",
        OpenCms.getLinkManager()
            .substituteLink(m_cms, "/system/workplace/resources/commons/error.png"));
    ...
    try {
      ...
      CmsLog.INIT.error(
          org.opencms.main.Messages.get()
              .getBundle()
              .key(org.opencms.main.Messages.INIT_ERR_LOAD_HTML_PROPERTY_FILE_1, ERRORPAGE),
          th);
    }
