 ...
 *
 * <p>Wrappers that extend this are usually used for the values in lazy initialized transformer
 * maps.
 *
 * <p>
 */
abstract class A_CmsJspValueWrapper extends AbstractCollection<String> {
  ...
  /**
   * Provides a Map with Booleans that indicate if a given String is contained in the wrapped
    ...
    public Object transform(Object input) {
      ...
      if ((o instanceof A_CmsJspValueWrapper) && (input != null)) {
        return Boolean.valueOf(
            ((A_CmsJspValueWrapper) o).getToString().indexOf(input.toString()) > -1);
      }
  ...
  /**
   * Provides a Map with Booleans that indicate if a given Object is equal to the wrapped object.
   *
   * <p>
   */
  ...
  /**
   * Provides trimmed to size string values.
   *
   * <p>
   */
  ...
  /**
   * The lazy initialized Map that checks if the String representation of this wrapper contains
   * specific words.
   */
      ...
      return OpenCms.getLinkManager()
          .substituteLinkForUnknownTarget(
              ...
              CmsLinkManager.getAbsoluteUri(
                  String.valueOf(target), cms.getRequestContext().getUri()));
    } else {
      return "";
    }
  }
  ...
  /**
   * Returns a lazy initialized Map that provides Booleans which indicate if if the wrapped values
   * String representation contains a specific String.
   *
   * <p>The Object parameter is transformed to it's String representation to perform this check.
   *
   * @return a lazy initialized Map that provides Booleans which indicate if if the wrapped values
   *     String representation contains a specific String
   */
  ...
  /**
   * Returns <code>true</code> if the wrapped value has been somehow initialized.
   *
   * <p>
   *
  ...
  /**
   * Returns <code>true</code> in case the wrapped value is empty, that is either <code>null</code>
   * or an empty String.
   *
   * <p>
   *
  ...
  /**
   * Returns <code>true</code> in case the wrapped value is empty or whitespace only, that is either
   * <code>null</code> or String that contains only whitespace chars.
   *
   * <p>
   *
  ...
  /**
   * Returns a lazy initialized Map that provides Booleans which indicate if an Object is equal to
   * the wrapped object.
   *
   * <p>
   *
   * @return a lazy initialized Map that provides Booleans which indicate if an Object is equal to
   *     the wrapped object
   */
  ...
  /**
   * Returns <code>true</code> in case the wrapped value exists and is not empty or whitespace only.
   *
   * <p>
   *
  ...
  /**
   * Returns <code>true</code> in case the wrapped value exists, is not empty or whitespace only and
   * is also not equal to the String <code>'none'</code>.
   *
   * <p>
   *
   * @return <code>true</code> in case the wrapped value exists, is not empty or whitespace only and
   *     is also not equal to the String <code>'none'</code>
   */
   ...
   *
   * <p>Note that the result is an Object of type {@link java.lang.Long}, so in case the wrapped
   * value can not be converted to a number, <code>null</code> is returned. This means you can check
   * for an <code>empty</code> result in the EL.
   *
   * <p>
   *
   ...
   *
   * <p>This will return the empty String <code>""</code> when {@link #getExists()} returns <code>
   * false</code>
   *
   * <p>.
   *
    ...
    try {
      CmsXmlContainerPage page =
          CmsXmlContainerPageFactory.unmarshal(
              ...
              m_cms.readFile(res),
              true,
              /*nocache=*/ true); // container page caching causes problems with the EL container
                                  // rendering feature, don't use it here
   ...
   *
   * <p>Note that the result is an Object of type {@link java.lang.Double}, so in case the wrapped
   * value can not be converted to a number, <code>null</code> is returned. This means you can check
   * for an <code>empty</code> result in the EL.
   *
   * <p>
   ...
   *
   * <p>In case the value does not point to an image resource, <code>null</code> is returned.
   *
  ...
  public CmsJspInstanceDateBean getToInstanceDate() {
    ...
    if (m_instanceDate == null) {
      m_instanceDate =
          new CmsJspInstanceDateBean(getToDate(), m_cms.getRequestContext().getLocale());
    }
   ...
   *
   * <p>In case no link can be substituted from the wrapped value, an empty String <code>""</code>
   * is returned.
   *
   * @return the substituted link
   */
   ...
   *
   * <p>It is assumed the value holds a valid resource UIR in the OpenCms VFS. In case the value
   * cannot be converted to a resource, an error is logged but no exception is thrown.
   *
   * <p>
   *
  ...
  /**
   * Returns a lazy initialized map that provides trimmed to size strings of the wrapped object
   * string value. The size being the integer value of the key object.
   *
   * <p>
   *
  ...
  /**
   * Supports the use of the <code>empty</code> operator in the JSP EL by implementing the
   * Collection interface.
   *
   * <p>
   *
   * @return the value from {@link #getIsEmptyOrWhitespaceOnly()} which is the inverse of {@link
   *     #getIsSet()}.
   *     <p>
  ...
  /**
   * Compares this value against a list of Strings and returns <code>true</code> in case the list
   * contains the toString representation of this value, or a <code>false</code> otherwise.
   *
   * <p>
   *
   * @param allowedValues the list of allowed String values
   * @return returns <code>true</code> in case the list contains the toString representation of this
   *     value, or a <code>false</code> otherwise
   * @see #validate(List)
  ...
  public boolean isValid(List<String> allowedValues) {
    ...
    return (allowedValues != null)
        ...
        && allowedValues.contains(toString());
  }
   ...
   * <p>
   *
   * @return an empty Iterator in case {@link #isEmpty()} is <code>true</code>, otherwise an
   *     Iterator that will return the String value of this wrapper exactly once.
   *     <p>
  ...
  /**
   * Parses the wrapped value to a Double precision float, returning the default in case the number
   * can not be parsed.
   *
   * <p>
   *
  ...
  /**
   * Parses the wrapped value to a Long integer, returning the default in case the number can not be
   * parsed.
   *
   * <p>
   *
   ...
   *
   * <p>If this value is empty, the object returned will be of type {@link
   * CmsJspObjectValueWrapper}. This means you can only use simple "get me the value as type X"
   * operations on the result safely.
   *
   * <p>
   *
  ...
  /**
   * Compares this value against a list of Strings and returns this value in case the list contains
   * the toString representation of this value, or a {@link
   * CmsJspObjectValueWrapper#NULL_VALUE_WRAPPER} otherwise.
   *
   * <p>
   *
   * @param allowedValues the list of allowed String values
  ...
  /**
   * Checks this value against a list of Strings and returns this value in case the list contains
   * the toString representation of this value, or a {@link CmsJspObjectValueWrapper} based on the
   * given default object otherwise.
   *
   * <p>
   *
   * @param allowedValues the list of allowed String values
  ...
  public A_CmsJspValueWrapper validate(List<String> allowedValues, Object defaultValue) {
    ...
    return isValid(allowedValues)
        ? this
        : CmsJspObjectValueWrapper.createWrapper(getCmsObject(), defaultValue);
  }
}
