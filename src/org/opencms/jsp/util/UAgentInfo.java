 ...
 */
@SuppressWarnings("all") // keeps the external code as unchanged as possible
public class UAgentInfo {
  ...
  public static final String engineSilk =
      "silk-accelerated"; // Amazon's accelerated Silk browser for Kindle Fire
  ...
  public static final String mobile =
      "mobile"; // Some mobile browsers put "mobile" in their user agent strings.
  public static final String mobi =
      "mobi"; // Some mobile browsers put "mobi" in their user agent strings.
  ...
  /**
   * Detects if the current Amazon device is using the Silk Browser. Note: Typically used by the the
   * Kindle Fire.
   *
  ...
  /**
   * Detects if the current device is a (small-ish) Android OS-based device used for calling and/or
   * multi-media (like a Samsung Galaxy Player). Google says these devices will have 'Android' AND
   * 'mobile' in user agent. Ignores tablets (Honeycomb and later).
   *
   ...
   * Excludes the Playbook. Examples, Storm, Bold, Tour, Curve2 Excludes the new BlackBerry OS 6 and
   * 7 browser!!
   *
  ...
  /**
   * Detects if the current browser is a BlackBerry Touch device, such as the Storm, Torch, and Bold
   * Touch. Excludes the Playbook.
   *
  ...
  /**
   * Detects if the current device is an Internet-capable game console. Includes many handheld
   * consoles.
   *
  ...
  /**
   * Detects if the current device is a handheld gaming device with a touchscreen and modern
   * iPhone-class browser. Includes the Playstation Vita.
   *
  ...
  public boolean detectIphoneOrIpod() {
    ...
    // We repeat the searches here because some iPods may report themselves as an iPhone, which
    // would be okay.
   ...
   * display iPhone-optimized web content. Includes iPhone, iPod Touch, Android, Windows Phone 7 and
   * 8, BB10, WebOS, Playstation Vita, etc.
   *
  ...
  /**
   * The quick way to detect for a tier of devices. This method detects for devices which are likely
   * to be capable of viewing CSS content optimized for the iPhone, but may not necessarily support
   * JavaScript. Excludes all iPhone Tier devices.
   *
   ...
   * HTML 5 capable, larger screen tablets. Includes iPad, Android (e.g., Xoom), BB Playbook, WebOS,
   * etc.
   *
  ...
  /**
   * Detects if the current browser is a Windows Mobile device. Excludes Windows Phone 7.x and 8
   * devices. Focuses on Windows Mobile 6.xx and earlier.
   *
