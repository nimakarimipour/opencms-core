...
public class CmsJspDeviceSelectorDesktopMobileTablet implements I_CmsJspDeviceSelector {
  ...
  public static final List<String> TYPES =
      Arrays.asList(new String[] {C_MOBILE, C_DESKTOP, C_TABLET});
  ...
  public String getDeviceType(HttpServletRequest req) {
    ...
    CmsTemplateContext templateContext =
        (CmsTemplateContext) (req.getAttribute(CmsTemplateContextManager.ATTR_TEMPLATE_CONTEXT));
  ...
  protected boolean isTemplateContextCompatible(CmsTemplateContext templateContext) {
    ...
    Set<String> contextKeys =
        new HashSet<String>(templateContext.getProvider().getAllContexts().keySet());
