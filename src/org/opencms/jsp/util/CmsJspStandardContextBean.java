 ...
 * used from a JSP with the JSTL or EL.
 *
 * <p>This bean is available by default in the context of an OpenCms managed JSP.
 *
 * <p>
 *
 * @since 8.0
...
public final class CmsJspStandardContextBean {
  ...
  public class CmsContainerElementWrapper extends CmsContainerElementBean {
    ...
    public CmsContainerElementWrapper getParent() {
      ...
      if (m_parent == null) {
        ...
        m_parent =
            (parent != null)
                ? new CmsContainerElementWrapper(getParentElement(m_wrappedElement))
                : null;
      }
      return m_parent;
    }
        ...
        try {
          m_resourceTypeName =
              OpenCms.getResourceManager()
                  .getResourceType(m_wrappedElement.getResource())
                  .getTypeName();
        } catch (Exception e) {
     ...
     *
     * <p>The values returned in the map are instances of {@link A_CmsJspValueWrapper}.
     *
    ...
    public Map<String, CmsJspElementSettingValueWrapper> getSetting() {
      ...
      if (m_wrappedSettings == null) {
        m_wrappedSettings =
            CmsCollectionsGenericWrapper.createLazyMap(new SettingsTransformer(m_wrappedElement));
      }
    ...
    /**
     * @see
     *     org.opencms.xml.containerpage.CmsContainerElementBean#initResource(org.opencms.file.CmsObject)
     */
    @Override
    ...
    /**
     * @see
     *     org.opencms.xml.containerpage.CmsContainerElementBean#initSettings(org.opencms.file.CmsObject,
     *     org.opencms.ade.configuration.CmsADEConfigData,
     *     org.opencms.xml.containerpage.I_CmsFormatterBean, java.util.Locale,
     *     javax.servlet.ServletRequest, java.util.Map)
     */
    @Override
    ...
    /**
     * @see
     *     org.opencms.xml.containerpage.CmsContainerElementBean#isGroupContainer(org.opencms.file.CmsObject)
     */
    @Override
    ...
    /**
     * @see
     *     org.opencms.xml.containerpage.CmsContainerElementBean#isInheritedContainer(org.opencms.file.CmsObject)
     */
    @Override
    ...
    /**
     * @see
     *     org.opencms.xml.containerpage.CmsContainerElementBean#setFormatterId(org.opencms.util.CmsUUID)
     */
    @Override
    ...
    /**
     * @see
     *     org.opencms.xml.containerpage.CmsContainerElementBean#setHistoryFile(org.opencms.file.CmsFile)
     */
    @Override
    ...
    /**
     * @see
     *     org.opencms.xml.containerpage.CmsContainerElementBean#setInheritanceInfo(org.opencms.ade.containerpage.shared.CmsInheritanceInfo)
     */
    @Override
    ...
    /**
     * @see
     *     org.opencms.xml.containerpage.CmsContainerElementBean#setTemporaryFile(org.opencms.file.CmsFile)
     */
    @Override
  ...
  /**
   * Provides a lazy initialized Map that provides the detail page link as a value when given the
   * name of a (named) dynamic function or resource type as a key.
   *
   * <p>
   */
  public class CmsDetailLookupTransformer implements Transformer {
     ...
     *
     * <p>The prefix is used to distinguish between type detail pages and function detail pages.
     *
     * <p>
     *
      ...
      if ((m_metaMappings != null) && m_metaMappings.containsKey(arg0)) {
        ...
        try {
          CmsResourceFilter filter =
              getIsEditMode() ? CmsResourceFilter.IGNORE_EXPIRATION : CmsResourceFilter.DEFAULT;
  ...
  /**
   * Lazily initialized nested map for reading either attributes or properties (first key: file
   * name, second key: attribute / property name).
   */
  ...
  /**
   * Lazily initialized map from the root path of a resource to all categories assigned to the
   * resource.
   */
  ...
  private CmsJspStandardContextBean(ServletRequest req) {
    ...
    if (cms == null) {
      ...
      throw new CmsRuntimeException(
          Messages.get()
              .container(Messages.ERR_MISSING_CMS_CONTROLLER_1, CmsJspBean.class.getName()));
    }
    updateCmsObject(cms);
   ...
   * @return the link
   */
  public static String getFunctionDetailLink(
      CmsObject cms, String prefix, String functionName, boolean fullLink) {

    String type = prefix + functionName;

    CmsADEConfigData config =
        OpenCms.getADEManager()
            .lookupConfiguration(cms, cms.addSiteRoot(cms.getRequestContext().getUri()));
   ...
   * Gets the link to a function detail page.
   *
   * <p>This just returns null if no function detail page is defined, it does not use the default
  ...
  public static String getFunctionDetailLinkExact(CmsObject cms, String functionName) {
    ...
    CmsADEConfigData config =
        OpenCms.getADEManager()
            .lookupConfigurationWithCache(cms, cms.addSiteRoot(cms.getRequestContext().getUri()));
    List<CmsDetailPageInfo> detailPages = config.getDetailPagesForType(type);
   ...
   *
   * <p>To prevent multiple creations of the bean during a request, the OpenCms request context
  ...
  /**
   * Returns a caching hash specific to the element, it's properties and the current container
   * width.
   *
   * <p>
   *
  ...
  /**
   * Helper for easy instantiation and initialization of custom context beans that returns an
   * instance of the class specified via <code>className</code>, with the current context already
   * set.
   *
   * @param className name of the class to instantiate. Must be a subclass of {@link
  ...
  /**
   * Finds the folder to use for binary uploads, based on the list configuration given as an
   * argument or the current sitemap configuration.
   *
    ...
    if (content != null) {
      ...
      if (baseValue == null) {
        List<CmsJspContentAccessValueWrapper> folderEntries =
            content.getValueList().get(CmsConfigParserUtils.N_SEARCH_FOLDER);
        if (folderEntries.size() == 1) {
          CmsResource resource = folderEntries.get(0).getToResource();
          List<String> galleryTypes =
              Arrays.asList(
                  CmsAjaxDownloadGallery.GALLERYTYPE_NAME, CmsAjaxImageGallery.GALLERYTYPE_NAME);
          if ((resource != null)
              && (null
                  != findAncestor(
                      m_cms,
                      resource,
                      (ancestor) -> {
                        return galleryTypes.stream()
                            .anyMatch(
                                type ->
                                    OpenCms.getResourceManager()
                                        .matchResourceType(type, ancestor.getTypeId()));
                      }))) {
  ...
  /**
   * Generates a link to the bundle editor to edit the provided message key. The back link for the
   * editor is the current uri.
   *
   * <p>If the bundle for the key could not be found, <code>null</code> is returned.
   *
   * @param messageKey the message key to open the bundle editor for.
   * @return a link to the bundle editor for editing the provided key, or <code>null</code> if the
  ...
  /**
   * Generates a link to the bundle editor to edit the provided message key. The back link for the
   * editor is the current uri with the provided backLinkAnchor added as anchor..
   *
   * <p>If the bundle for the key could not be found, <code>null</code> is returned.
   *
   * @param messageKey the message key to open the bundle editor for.
   * @param backLinkAnchor the anchor id to add to the backlink to the page. If <code>null</code> no
   *     anchor is added to the backlink.
   * @return a link to the bundle editor for editing the provided key, or <code>null</code> if the
   *     bundle for the key could not be found.
   */
   ...
   * editor is the current uri with the provided backLinkAnchor added as anchor.
   *
   * <p>If the bundle resource for the key could not be found, <code>null</code> is returned.
   *
   * @param messageKey the message key to open the bundle editor for.
   * @param backLinkAnchor the anchor id to add to the backlink to the page. If <code>null</code> no
   *     anchor is added to the backlink.
   * @param backLinkParams request parameters to add to the backlink without leading '?', e.g.
   *     "param1=a&param2=b".
   * @return a link to the bundle editor for editing the provided key, or <code>null</code> if the
   *     bundle for the key could not be found.
   */
  public String getBundleEditorLink(
      String messageKey, String backLinkAnchor, String backLinkParams) {
   ...
   * @param backLinkParams request parameters to add to the backlink without leading '?', e.g.
   *     "param1=a&param2=b".
   * @param bundleName the name of the bundle to search the key in. If <code>null</code> the bundle
    ...
    if (!m_cms.getRequestContext().getCurrentProject().isOnlineProject()) {
      ...
      if (null == bundleName) {
        ...
        ResourceBundle bundle =
            CmsResourceBundleLoader.getBundle(bundleName, m_cms.getRequestContext().getLocale());
      ...
      try {
        ...
        String backLink =
            OpenCms.getLinkManager().getServerLink(m_cms, m_cms.getRequestContext().getUri());
        ...
        if (null != messageKey) {
          appState =
              A_CmsWorkplaceApp.addParamToState(
                  appState, CmsMessageBundleEditor.PARAM_KEYFILTER, messageKey);
        }
        ...
        if (LOG.isWarnEnabled()) {
          String message =
              "Failed to open bundle editor for key '"
                  + messageKey
   ...
   *
   * <p>If no VFS-based message bundle contains the given key, null is returned. If multiple message
   * bundles contain it, one of them is arbitrarily chosen (but a warning is logged).
   *
   * <p>Note: This uses the online (published) state of message bundles, so if you have unpublished
   * bundle changes, they will not be reflected in the result.
   *
        ...
        bundleIndex =
            (CmsMessageToBundleIndex)
                context.getAttribute(
                    CmsMessageToBundleIndex.class.getName()
                        + "_"
                        + cms.getRequestContext().getLocale(),
                    k -> {
                      try {
                        CmsMessageToBundleIndex result =
                            CmsMessageToBundleIndex.read(getCmsObject());
                        return result;
                      } catch (Exception e) {
  ...
  /**
   * Returns the current detail content, or <code>null</code> if no detail content is requested.
   *
   * <p>
   *
   * @return the current detail content, or <code>null</code> if no detail content is requested.
   *     <p>
   */
   ...
   * <p>
   *
   * @return the structure id of the current detail content, or <code>null</code> if no detail
   *     content is requested.
   *     <p>
   */
  ...
  /**
   * Returns the detail content site path, or <code>null</code> if not available.
   *
   * <p>
   *
  ...
  public CmsContainerPageBean getDetailOnlyPage() {
    ...
    if ((null == m_detailOnlyPage) && (null != m_detailContentResource)) {
      ...
      m_detailOnlyPage =
          CmsDetailOnlyContainerUtil.getDetailOnlyPage(m_cms, m_request, pageRootPath, false);
    }
   ...
   *
   * <p>So in case there is more than one container where the name end with the given suffix, a
   * joined list of container elements beans is returned.
   *
   * <p>
   *
   ...
   *
   * <p>So in case there is more than one container where the name end with the given suffix, a
   * joined list of elements is returned.
   *
   * <p>
   *
   * @return the lazy map of element resource wrappers
  ...
  /**
   * Returns a lazy initialized Map which allows access to the dynamic function beans using the JSP
   * EL.
   *
   * <p>When given a key, the returned map will look up the corresponding dynamic function bean in
   * the module configuration.
   *
   * <p>
   *
   * @return a lazy initialized Map which allows access to the dynamic function beans using the JSP
   *     EL
   */
          ...
          new Transformer() {
            ...
            public Object transform(Object input) {
              ...
              try {
                ...
                CmsDynamicFunctionBeanWrapper wrapper =
                    new CmsDynamicFunctionBeanWrapper(m_cms, dynamicFunction);
                return wrapper;
   ...
   * <p>
   *
   * @return a lazy initialized Map that provides the detail page link as a value when given the
   *     name of a (named) dynamic function as a key
  ...
  /**
   * Returns a lazy initialized Map that provides the detail page link as a value when given the
   * name of a (named) dynamic function as a key.
   *
   * <p>The provided Map key is assumed to be a String that represents a named dynamic function.
   *
   * <p>Usage example on a JSP with the JSTL:
   *
   * <pre>
  ...
  /**
   * Returns a lazy map which creates a wrapper object for a dynamic function format when given an
   * XML content as a key.
   *
   * <p>
   *
   * @return a lazy map for accessing function formats for a content
   */
  public Map<CmsJspContentAccessBean, CmsDynamicFunctionFormatWrapper>
        ...
        new Transformer() {
          ...
          public Object transform(Object contentAccess) {
            ...
            CmsXmlContent content =
                (CmsXmlContent) (((CmsJspContentAccessBean) contentAccess).getRawContent());
            ...
            CmsDynamicFunctionBean.Format format =
                functionBean.getFormatForContainer(m_cms, type, widthNum);
  ...
  /**
   * Returns <code>true</code> if the current page is a detail page.
   *
   * <p>
   *
  ...
  /**
   * Returns <code>true</code> if the current request is direct edit enabled.
   *
   * <p>Online-, history-requests, previews and temporary files will not be editable.
   *
   * <p>
   *
  ...
  /**
   * Returns <code>true</code> if the current request is a JSON request.
   *
   * <p>
   *
  ...
  /**
   * Returns <code>true</code> if the current project is the online project.
   *
   * <p>
   *
   ...
   *
   * <p>This is the case if the request is not in edit mode and in the online project.
   *
   * <p>
   *
   ...
   *
   * <p>Note that all available locales for the site / subsite are used as keys, not just the ones
   * for which a locale variant actually exists.
   *
   * <p>Usage in JSPs: ${cms.localeResource['de']]
   *
          ...
          for (CmsContainerBean container : result.getContainers().values()) {
            for (CmsContainerElementBean element : container.getElements()) {
              ...
              if (!isGroupContainer && !isInheritedContainer) {
                element.initResource(m_cms);
                // ensure that the formatter configuration id is added to the element settings, so
                // it will be persisted on save
                formatterConfig =
                    CmsJspTagContainer.getFormatterConfigurationForElement(
                        m_cms, element, adeConfig, container.getName(), "", 0);
      ...
      if (m_pageResource == null) {
        ...
        m_pageResource =
            CmsJspResourceWrapper.wrap(
                m_cms, (CmsResource) CmsHistoryResourceHandler.getHistoryResource(m_request));
        if (m_pageResource == null) {
          m_pageResource =
              CmsJspResourceWrapper.wrap(
                  m_cms,
  ...
  public Map<String, List<CmsTemplatePluginWrapper>> getPlugins() {
    ...
    if (m_templatePlugins == null) {
      final Multimap<String, CmsTemplatePlugin> templatePluginsMultimap =
          new CmsTemplatePluginFinder(this).getTemplatePlugins();
          ...
          public Object transform(Object uri) {
            ...
            try {
              ...
              String formatterSitePath =
                  m_cms.getRequestContext().removeSiteRoot(formatterResource.getRootPath());
   ...
   *
   * @return The map from the provided category to it's sub-categories in a {@link
                    ...
                    List<CmsCategory> categories =
                        CmsCategoryService.getInstance()
                            .readCategories(
                                ...
                                true,
                                m_cms.getRequestContext().getUri());
                    CmsJspCategoryAccessBean result =
                        new CmsJspCategoryAccessBean(m_cms, categories, (String) categoryPath);
                    return result;
                  } catch (CmsException e) {
                    LOG.warn(e.getLocalizedMessage(), e);
                    return null;
  ...
  /**
   * Lazily reads the given attribute from the current sitemap or a property of the same name from
   * the given resource.
   *
                  ...
                  try {
                    ...
                    return catService.localizeCategory(
                        ...
                        catService.readCategory(
                            m_cms, (String) categoryPath, getRequestContext().getUri()),
   ...
   *
   * <p>Example: For path <code>"location/europe/"</code> the list <code>
   * [getReadCategory.get("location/"),getReadCategory.get("location/europe/")]</code> is returned.
   *
          ...
          CmsCollectionsGenericWrapper.createLazyMap(
              new Transformer() {
                ...
                public Object transform(Object categoryPath) {
                  ...
                  return CmsCategoryService.getInstance()
                      .localizeCategories(m_cms, result, m_cms.getRequestContext().getLocale());
                }
              });
    }
  ...
  /**
   * Returns a HTML comment string that will cause the container page editor to reload the page if
   * the element or its settings were edited.
   *
   * <p>
   *
   * @return the reload marker
  ...
  /**
   * Returns the title of a page delivered from OpenCms, usually used for the <code>&lt;title&gt;
   * </code> tag of a HTML page.
   *
   * <p>If no title information has been found, the empty String "" is returned.
   *
   * <p>
   *
  ...
  /**
   * Returns a lazy initialized Map that provides the detail page link as a value when given the
   * name of a resource type as a key.
   *
   * <p>The provided Map key is assumed to be the name of a resource type that has a detail page
   * configured.
   *
   * <p>Usage example on a JSP with the JSTL:
   *
  ...
  public Map<String, String> getTypeDetailPage() {
    ...
    if (m_typeDetailPage == null) {
      m_typeDetailPage =
          CmsCollectionsGenericWrapper.createLazyMap(new CmsDetailLookupTransformer(""));
    }
   ...
   *
   * <p>If the object is a {@link CmsResource}, then a {@link CmsJspResourceWrapper} is returned.
   * Otherwise the object is wrapped in a {@link CmsJspObjectValueWrapper}.
   *
   * <p>If the object is already is a wrapper, it is returned unchanged.
   *
   * <p>
   *
  ...
  public void initPage() throws CmsException {
    ...
    if ((m_page == null) && (m_cms != null)) {
      ...
      if (pageResource == null) {
        pageResource =
            m_cms.readResource(requestUri, CmsResourceFilter.ignoreExpirationOffline(m_cms));
      }
      m_config =
          OpenCms.getADEManager().lookupConfigurationWithCache(m_cms, pageResource.getRootPath());
      m_page = getPage(pageResource);
      m_page =
          CmsTemplateMapper.get(m_request)
              .transformContainerpageBean(m_cms, m_page, pageResource.getRootPath());
    }
  }
  ...
  /**
   * Returns <code>true</code> if this is a request to a detail resource, <code>false</code>
   * otherwise.
   *
   * <p>Same as to check if {@link #getDetailContent()} is <code>null</code>.
   *
   * <p>
   *
   * @return <code>true</code> if this is a request to a detail resource, <code>false</code>
   *     otherwise
   */
  ...
  /**
   * Renders the elements of container in a container page wrapper as HTML (without a surrounding
   * element).
   *
  ...
  /**
   * In edit mode, creates a meta tag that tells the form-based content editor to use the stylesheet
   * with the given path as a default.
   *
  ...
  public void updateCmsObject(CmsObject cms) {
    ...
    try {
      m_config =
          OpenCms.getADEManager()
              .lookupConfigurationWithCache(cms, cms.getRequestContext().getRootUri());
    } catch (Exception e) {
      LOG.error(e.getLocalizedMessage(), e);
    }
  }
    ...
    if (container != null) {
      ...
      if (formatter == null) {
        try {
          ...
          CmsADEConfigData config =
              OpenCms.getADEManager().lookupConfiguration(m_cms, resource.getRootPath());
    ...
    try {
      ...
      if (isDetailRequest()) {
        ...
        result =
            content
                .getHandler()
                .getTitleMapping(m_cms, content, m_cms.getRequestContext().getLocale());
        if (result == null) {
          // title not found, maybe no mapping OR not available in the current locale
          // read the title of the detail resource as fall back (may contain mapping from another
          // locale)
          result =
              m_cms
                  .readPropertyObject(res, CmsPropertyDefinition.PROPERTY_TITLE, false, locale)
                  .getValue();
        }
      }
      if (result == null) {
  ...
  protected CmsDynamicFunctionBean readDynamicFunctionBean(String configuredName)
    ...
    CmsADEConfigData config =
        OpenCms.getADEManager()
            .lookupConfiguration(m_cms, m_cms.addSiteRoot(m_cms.getRequestContext().getUri()));
  ...
  /**
   * Adds the mappings of the given formatter configuration.
   *
   * <p>
   *
   ...
   * @return the first ancestor matching the predicate (which may possibly be the given resource
   *     itself), or null if no matching ancestor is found
   * @throws CmsException
   */
  private CmsResource findAncestor(
      CmsObject cms, CmsResource resource, Predicate<CmsResource> predicate) {
  ...
  /**
   * Returns the container page bean for the give resource.
   *
   * <p>
   *
  ...
  private CmsContainerPageBean getPage(CmsResource pageResource) throws CmsException {
    ...
    if ((pageResource != null) && CmsResourceTypeXmlContainerPage.isContainerPage(pageResource)) {
      CmsXmlContainerPage xmlContainerPage =
          CmsXmlContainerPageFactory.unmarshal(m_cms, pageResource, m_request);
      result = xmlContainerPage.getContainerPage(m_cms);
      CmsModelGroupHelper modelHelper =
          new CmsModelGroupHelper(
              m_cms,
              OpenCms.getADEManager().lookupConfiguration(m_cms, pageResource.getRootPath()),
              CmsJspTagEditable.isEditableRequest(m_request)
                      && (m_request instanceof HttpServletRequest)
  ...
  /**
   * Convenience method for getting a request attribute without an explicit cast.
   *
   * <p>
   *
        ...
        if (getDetailContentId() != null) {
          try {
            CmsResource detailContent =
                m_cms.readResource(
                    getDetailContentId(), CmsResourceFilter.ignoreExpirationOffline(m_cms));
            CmsFormatterConfiguration config =
                OpenCms.getADEManager()
                    .lookupConfiguration(m_cms, m_cms.getRequestContext().getRootUri())
                    .getFormatters(m_cms, detailContent);
            ...
            LOG.error(
                Messages.get()
                    .getBundle()
                    .key(Messages.ERR_READING_REQUIRED_RESOURCE_1, getDetailContentId()),
                e);
          }
        }
      } catch (Exception e) {
  ...
  /**
   * Initializes the page element data.
   *
   * <p>
   */
              ...
              if (element.isGroupContainer(m_cms)) {
                children =
                    CmsJspTagContainer.getGroupContainerElements(
                        m_cms, element, m_request, container.getType());
              } else {
