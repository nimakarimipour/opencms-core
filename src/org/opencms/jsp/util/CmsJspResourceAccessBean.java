 ...
 * <code>&lt;cms:resourceload&gt;</code> tag.
 *
...
public class CmsJspResourceAccessBean {
  ...
  /**
   * Transformer that reads a history resource property, the input is used as String for the history
  ...
  private class CmsHistoryPropertyLoaderTransformer implements Transformer {
    ...
    public Object transform(Object input) {
      ...
      try {
        ...
        result =
            CmsProperty.get(String.valueOf(input), getCmsObject().readHistoryPropertyObjects(m_res))
                .getValue();
      } catch (
  ...
  /**
   * The properties of the resource according to the provided locale. The map goes from locale ->
   * property -> value.
   */
   ...
   *
   * <p>You must call {@link #init(CmsObject, CmsResource)} and provide the required values when you
    ...
    if (m_file == null) {
      try {
        ...
        throw new CmsRuntimeException(
            Messages.get().container(Messages.ERR_FILE_READ_1, m_resource.getRootPath()), e);
      }
    }
    return m_file;
  }
  ...
  /**
   * Short form for {@link #getReadHistoryProperties()}.
   *
   * <p>This works only if the current resource is implementing {@link I_CmsHistoryResource}.
   *
   * <p>Usage example on a JSP with the <code>&lt;cms:resourceaccess&gt;</code> tag:
   *
   * <pre>
   * &lt;cms:resourceload ... &gt;
   *     &lt;cms:resourceaccess var="res" /&gt;
   ...
   * &lt;/cms:resourceload&gt;</pre>
   *
   * @return a map that lazily reads properties of the resource and accesses them wrt. to the
   *     specified locale.
  ...
  /**
   * Returns a map that lazily reads properties of the resource and makes the accessible according
   ...
   * &lt;/cms:resourceload&gt;</pre>
   *
   * @return a map that lazily reads properties of the resource and makes the accessible according
   *     to the specified locale.
  ...
  public Map<String, Map<String, String>> getReadPropertiesLocale() {
    ...
    if (m_localeProperties == null) {
      m_localeProperties =
          CmsCollectionsGenericWrapper.createLazyMap(
              new CmsJspValueTransformers.CmsLocalePropertyLoaderTransformer(
                  m_cms, m_resource, false));
    }
