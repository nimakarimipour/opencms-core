...
public class CmsUserDataHeader implements I_CmsUserDataDomain {
    ...
    element
        ...
        .text(
            Messages.get()
                ...
                .key(Messages.GUI_USER_INFORMATION_FOR_1, username));
  }
  ...
  /**
   * @see
   *     org.opencms.jsp.userdata.I_CmsUserDataDomain#isAvailableForMode(org.opencms.jsp.userdata.I_CmsUserDataDomain.Mode)
   */
