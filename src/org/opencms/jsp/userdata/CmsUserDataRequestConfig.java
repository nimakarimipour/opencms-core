 ...
 *
 * <p>Mostly used to access texts to show to the user. Currently, a thin wrapper around an XML
 * content.
 */
  ...
  public CmsUserDataRequestConfig(CmsObject cms, CmsXmlContent content, Locale locale) {
    ...
    m_locale =
        OpenCms.getLocaleManager()
            .getBestMatchingLocale(locale, content.getLocales(), content.getLocales());
  }
