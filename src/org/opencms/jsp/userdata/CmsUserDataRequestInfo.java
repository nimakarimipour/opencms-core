 ...
 *
 * <p>This contains both the user data itself, as well as authentication information, for making
 * sure the information can not just be automatically downloaded by someone intercepting the email
 * sent to the user.
 */
public class CmsUserDataRequestInfo {
   ...
   *
   * <p>This is not set in case of email-only user data requests.
   *
