 ...
 *
 * <p>Produces HTML for standard OpenCms user information like name, description, address,
 * institution etc.
 */
public class CmsDefaultUserDataDomain implements I_CmsUserDataDomain {
  ...
  /**
   * @see org.opencms.jsp.userdata.I_CmsUserDataDomain#appendInfoHtml(org.opencms.file.CmsObject,
   *     org.opencms.jsp.userdata.CmsUserDataRequestType, java.util.List, org.jsoup.nodes.Element)
   */
  public void appendInfoHtml(
      CmsObject cms, CmsUserDataRequestType reqType, List<CmsUser> users, Element element) {

    Element main = element.appendElement("div");
    String headerText =
        org.opencms.jsp.userdata.Messages.get()
            .getBundle(cms.getRequestContext().getLocale())
            .key(org.opencms.jsp.userdata.Messages.GUI_DEFAULT_USERDATA_SECTION_0);
    ...
    for (CmsUser user : users) {
      ...
      addField(
          cms,
          dl,
          org.opencms.ui.apps.Messages.GUI_USERMANAGEMENT_USER_LOGIN_NAME_0,
          user.getSimpleName());
      addField(
          cms,
          dl,
  ...
  /**
   * @see org.opencms.jsp.userdata.I_CmsUserDataDomain#matchesUser(org.opencms.file.CmsObject,
   *     org.opencms.jsp.userdata.CmsUserDataRequestType, org.opencms.file.CmsUser)
   */
