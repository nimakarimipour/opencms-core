 ...
 *
 * <p>Each of these tags constructs a JSON value, adds it to the surrounding JSON context object if
 * one exists, and optionally stores the result in a page context variable, either as a JSON object
 * or as formatted JSON text, depending on the value of the mode attribute.
 */
public abstract class A_CmsJspJsonTag extends BodyTagSupport {
  ...
  public int doEndTag() throws JspException {
    ...
    if (m_var != null) {
      ...
      I_CmsJspJsonContext context =
          (I_CmsJspJsonContext) findAncestorWithClass(this, I_CmsJspJsonContext.class);
      if (context != null) {
  ...
  /**
   * Returns the JSON value that should be added to the surrounding context and/or stored in the
   * variable given by the var attribute.
   *
   ...
   *     <p>This must be another JSON object or a JSON wrapper.
   */
