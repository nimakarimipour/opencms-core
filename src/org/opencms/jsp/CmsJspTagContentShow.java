  ...
  public int doStartTag() throws JspException {
    ...
    if (ancestor == null) {
      CmsMessageContainer errMsgContainer =
          Messages.get().container(Messages.ERR_PARENTLESS_TAG_1, "contentshow");
    ...
    // now get the content element value to display
    String content =
        contentShowTagAction(contentContainer, pageContext, getElement(), m_locale, m_escapeHtml);
