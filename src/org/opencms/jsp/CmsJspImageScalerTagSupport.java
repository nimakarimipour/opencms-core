...
public abstract class CmsJspImageScalerTagSupport extends BodyTagSupport {
  ...
  /**
   * Returns the source of the image to scale, which will have the OpenCms webapp / servlet prefix
   * added.
   *
   * <p>
   *
   ...
   *
   * <p>If no valid integer is given, then "0" is used as value.
   *
   * <p>
   *
   ...
   *
   * <p>If no valid integer is given, then the value of {@link #getHeight()} is used as value.
   *
   * <p>
   *
   ...
   *
   * <p>If no valid integer is given, then the value of {@link #getWidth()} is used as value.
   *
   * <p>
   *
   ...
   *
   * <p>The source must be an absolute path in the current users OpenCms site, without any webapp or
   * servlet prefix.
   *
   * <p>
   *
