...
public class CmsJspScopedVarBodyTagSuport extends BodyTagSupport {
  ...
  private static final List<String> SCOPES_LIST =
      Collections.unmodifiableList(Arrays.asList(SCOPES));
   ...
   *
   * <p>The default value is {@link PageContext#PAGE_SCOPE}.
   *
   * <p>
   *
   ...
   *
   * <p>Valid values for the scope int parameter are 1 to 4 only.
   *
   * <p>
   *
   * @param scope integer that describes the scope according to {@link #getScopeInt()}.
   *     <p>
  ...
  /**
   * Returns the name of the variable under which the content access bean is saved in the page
   * context.
   *
   * <p>
   *
   * @return the name of the variable under which the content access bean is saved in the page
   *     context
   */
   ...
   * <p>
   *
   * @param var the name of the variable under which the content access bean is saved in the page
   *     context
   */
  ...
  /**
   * Returns the scope as int usable for setting the JSP page context with {@link
  ...
  /**
   * Returns <code>true</code> in case the scoped variable has been set for this Tag.
   *
   * <p>
   *
   ...
   *
   * <p>The values of {@link #getVar()} and {@link #getScope()} are used to determine how the Object
   * is stored.
   *
   * <p>
   *
   ...
   *
   * <p>The value of {@link #getScope()} is used to determine how the Object is stored.
   *
   * <p>
   *
