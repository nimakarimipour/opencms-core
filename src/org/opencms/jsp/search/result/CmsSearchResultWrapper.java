...
public class CmsSearchResultWrapper implements I_CmsSearchResultWrapper {
  ...
  /**
   * The collection of found resources/documents, already wrapped as {@code
  ...
  /**
   * @see
   *     org.opencms.jsp.search.result.I_CmsSearchResultWrapper#getMissingSelectedFieldFacetEntries()
   */
  @Override
  public Map<String, List<String>> getMissingSelectedFieldFacetEntries() {

    if (m_missingFieldFacetEntryMap == null) {
      m_missingFieldFacetEntryMap =
          CmsCollectionsGenericWrapper.createLazyMap(
              new Transformer() {
                ...
                public Object transform(final Object fieldName) {
                  ...
                  FacetField facetResult =
                      m_solrResultList == null
                          ? null
                          : m_solrResultList.getFacetField(fieldName.toString());
                  ...
                  if (null != facetController) {
                    ...
                    if (null != facetResult) {
                      List<String> returnedValues =
                          new ArrayList<String>(facetResult.getValues().size());
  ...
  /**
   * @see
   *     org.opencms.jsp.search.result.I_CmsSearchResultWrapper#getMissingSelectedQueryFacetEntries()
   */
  ...
  /**
   * @see
   *     org.opencms.jsp.search.result.I_CmsSearchResultWrapper#getMissingSelectedRangeFacetEntries()
   */
  public Map<String, List<String>> getMissingSelectedRangeFacetEntries() {

    if (m_missingRangeFacetEntryMap == null) {
      m_missingRangeFacetEntryMap =
          CmsCollectionsGenericWrapper.createLazyMap(
              new Transformer() {
                ...
                public Object transform(final Object fieldName) {
                  ...
                  if (null != facetController) {
                    ...
                    if (null != facetResult) {
                      List<String> returnedValues =
                          new ArrayList<String>(facetResult.getCounts().size());
  ...
  public long getNumMaxReturned() {
    ...
    long maxReturnedResults =
        Integer.valueOf(m_controller.getCommon().getConfig().getMaxReturnedResults()).longValue();
    return (maxReturnedResults < 0) || (maxReturnedResults > getNumFound())
        ? getNumFound()
        : maxReturnedResults;
  }
  ...
  public int getNumPages() {
    ...
    return m_solrResultList == null
        ? 1
        : m_controller.getPagination().getConfig().getNumPages(getNumMaxReturned());
  }
  ...
  public int getPageNavFirst() {
    ...
    final int page =
        m_controller.getPagination().getState().getCurrentPage()
