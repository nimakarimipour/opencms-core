 ...
 * Extends @see{org.opencms.jsp.search.config.CmsSearchConfigurationFacet}.
 */
public class CmsSearchConfigurationFacetField extends CmsSearchConfigurationFacet
   ...
   * @param name The name of the facet. If <code>null</code> it defaults to the name of the index
   *     field.
   ...
   * @param order The sorting of the facet entries (either "count", which is default, or "index",
   *     which causes alphabetical sorting).
   * @param filterQueryModifier Modifier for the filter queries when a facet entry is checked. Can
   *     contain "%(value)" - what is replaced by the facet entry's value.
  ...
  /**
   * @see
   *     org.opencms.jsp.search.config.I_CmsSearchConfigurationFacetField#modifyFilterQuery(java.lang.String)
   */
  @Override
