...
public class CmsSearchConfigurationPagination implements I_CmsSearchConfigurationPagination {
  ...
  public static final List<Integer> DEFAULT_PAGE_SIZE =
      Collections.singletonList(Integer.valueOf(10));
  ...
  /**
   * The page sizes for the (i+1)th page. The last provided page size is the size of all following
   * pages.
   */
  ...
  public CmsSearchConfigurationPagination(
      final String pageParam, final Integer pageSize, final Integer pageNavLength) {
   ...
   *
   * @param pageParam The request parameter used to send the current page number.
   * @param pageSizes The page sizes for the first pages. The last provided size is the size of all
   *     following pages.
   * @param pageNavLength The length of the "Google"-like page navigation. Should be an odd number.
   */
  public CmsSearchConfigurationPagination(
      final String pageParam, final List<Integer> pageSizes, final Integer pageNavLength) {
   ...
   *     following pages.
   * @param pageNavLength The length of the "Google"-like page navigation. Should be an odd number.
   * @return the pagination configuration, or <code>null</code> if none of the provided parameters
   *     is not null.
   */
  public static I_CmsSearchConfigurationPagination create(
      String pageParam, List<Integer> pageSizes, Integer pageNavLength) {
