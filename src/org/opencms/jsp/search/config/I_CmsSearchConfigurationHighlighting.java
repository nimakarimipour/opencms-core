...
public interface I_CmsSearchConfigurationHighlighting {
   ...
   *
   * @return The index field whose content should be used if no highlighting snippet is available.
   *     (Solr: hl.alternateField)
   */
  ...
  /**
   * Returns the maximal length of the snippet that should be shown from the alternative field, if
   * no highlighting snippet was found.
   *
   * @return The maximal length of the snippet that should be shown from the alternative field, if
   *     no highlighting snippet was found. (Solr: hl.maxAlternateFieldLength)
   */
   ...
   *
   * @return The String that should be inserted directly after the term that should be highlighted.
   *     (Solr: hl.simple.post)
   */
  String getSimplePost();

  /**
   * Returns the String that should be inserted directly in front of the term that should be
   * highlighted.
   *
   * @return The String that should be inserted directly in front the term that should be
   *     highlighted. (Solr: hl.simple.pre)
   */
  String getSimplePre();
   ...
   *
   * @return The flag, that indicates if fast vector highlighting should be used. (Solr:
