...
public class CmsConfigurationBean {
    ...
    /** The folders. */
    private @RUntainted List<@RUntainted String> m_folders;
     ...
     * @return the folders
     */
    public @RUntainted List<@RUntainted String> getFolders() {
     ...
     */
    public void setFolders(@RUntainted List<@RUntainted String> folders) {
