...
public class CmsDateRestrictionParser {
  ...
  /**
   * Parses a date restriction of type 'FromToday'.
   *
   * <p>
   *
   * @param dateRestriction the location of the date restriction
  ...
  /**
   * Parses a date restriction of type 'Past/Future'.
   *
   * <p>
   *
   * @param dateRestriction the location of the date restriction
  ...
  /**
   * Parses a date restriction of 'range' type.
   *
   * <p>
   *
   * @param dateRestriction the location of the date restriction
