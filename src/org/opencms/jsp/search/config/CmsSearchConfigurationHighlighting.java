...
public class CmsSearchConfigurationHighlighting implements I_CmsSearchConfigurationHighlighting {
   ...
   * @param alternateField A field that should be displayed if no highlighting snippet is found.
   *     (Solr: hl.alternateField)
   * @param maxAlternateFieldLength The maximal length of the snippet shown from the alternative
   *     field (in letters). (Solr: hl.maxAlternateFieldLength)
   ...
   * @param useFastVectorHighlighting Flag, indicating if fast vector highlighting should be used.
   *     (Solr: hl.useFastVectorHighlighting)
   */
  ...
  /**
   * @see
   *     org.opencms.jsp.search.config.I_CmsSearchConfigurationHighlighting#getAlternateHighlightField()
   */
  @Override
  ...
  /**
   * @see
   *     org.opencms.jsp.search.config.I_CmsSearchConfigurationHighlighting#getMaxAlternateHighlightFieldLength()
   */
  @Override
  ...
  /**
   * @see
   *     org.opencms.jsp.search.config.I_CmsSearchConfigurationHighlighting#getUseFastVectorHighlighting()
   */
  @Override
