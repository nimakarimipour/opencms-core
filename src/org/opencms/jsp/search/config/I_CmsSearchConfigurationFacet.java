...
public interface I_CmsSearchConfigurationFacet {
  ...
  /**
   * Returns the facet specific request parameter used to send the information if the maximum number
   * of facet entries should be ignored.
   *
   * @return The facet specific request parameter used to send the information if the maximum number
   *     of facet entries should be ignored.
   */
  ...
  /**
   * Returns true if the facet filters, such that only documents with all checked facet entries
   * appear, otherwise false.
   *
  ...
  /**
   * A list of facet-entries that should be preselected, if the search form is rendered the first
   * time.
   *
   * @return The list of facet-entries that should be preselected, if the search form is rendered
   *     the first time.
   */
