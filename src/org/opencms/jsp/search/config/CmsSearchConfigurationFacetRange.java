...
public class CmsSearchConfigurationFacetRange extends CmsSearchConfigurationFacet
   ...
   * @param hardEnd Flag, indicating if the last facet item range should end at <code>end</code>
   *     (use <code>true</code>) or extend to the full size of <code>gap</code> (use <code>false
   *     </code>).
   ...
   * @param ignoreFilterFromAllFacets A flag, indicating if filters from all facets should be
   *     ignored or not.
