 ...
 * <p>
 */
public class CmsJspTagSimpleSearch extends CmsJspScopedVarBodyTagSuport
    ...
    try {
      ...
      config =
          new CmsSearchConfiguration(
              new CmsSimpleSearchConfigurationParser(cms, configBean, m_configString), cms);
  ...
  /**
   * Returns the value of the specified configuration file (given via the tag's "configFile"
   * attribute).
   *
   * <p>
   *
