...
public class CmsJspTagImage extends CmsJspImageScalerTagSupport implements I_CmsJspTagParamParent {
   ...
   */
  public static CmsImageScaler getScaler(
      CmsImageScaler scaler, CmsImageScaler original, String scaleParam) {
   ...
   *      /&gt;</code> is omitted
   * @param noDim if <code>true</code>, the <code>height</code> and <code>width</code> attributes
   *     are omitted
  ...
  /**
   * Returns <code>"true"</code> if the created HTML image tag does not contain height and width
   * attributes.
   *
   * <p>
   *
   * @return <code>"true"</code> if the created HTML image tag does not contain height and width
   *     attributes
   */
  ...
  /**
   * Returns <code>"true"</code> if the HTML tag should only be created as partial tag.
   *
   * <p>
   *
  ...
  /**
   * Returns the given keys attribute value from the attribute map.
   *
   * <p>
   *
  ...
  /**
   * Sets the given key with the given value in the attribute map.
   *
   * <p>
   *
   ...
   * @param key the key to set
   * @param value the value to set
   * @param allowEmptyValue flag to determine if an empty value (not <code>null</code>!) should be
   *     set
   */
