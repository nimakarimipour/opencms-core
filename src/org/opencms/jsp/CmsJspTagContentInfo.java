 ...
 * @since 6.0.0
 */
public class CmsJspTagContentInfo extends CmsJspScopedVarBodyTagSuport
  ...
  public int doStartTag() throws JspException {
    ...
    if (ancestor == null) {
      ...
      CmsMessageContainer container =
          Messages.get().container(Messages.ERR_PARENTLESS_TAG_1, "contentinfo");
    ...
    try {
      ...
      CmsMessageContainer message =
          Messages.get().container(Messages.ERR_PROCESS_TAG_1, "contentinfo");
