...
public class CmsJspTagLink extends BodyTagSupport {
    ...
    public static class Parameters {
        ...
        /** The base uri. */
        public @RUntainted String m_baseUri;

        /** The detail page. */
        public String m_detailPage;

        /** The locale. */
        public @RUntainted Locale m_locale;
         ...
         * @param type the type
         */
        public Parameters(String target, @RUntainted String baseUri, String detailPage, @RUntainted Locale locale, Type type) {
         ...
         */
        public void setBaseUri(@RUntainted String baseUri) {
     ...
     * @return the locale
     */
    public static @RUntainted Locale getBaseUriLocale(CmsObject cms, String baseUri) {
     ...
     * @since 8.0.3
     */
    public static @RUntainted String linkTagAction(Parameters params, ServletRequest req) {
     ...
     * @since 8.0.3
     */
    public static @RUntainted String linkTagAction(String target, ServletRequest req, @RUntainted String baseUri) {
     ...
     * @since 8.0.3
     */
    public static @RUntainted String linkTagAction(String target, ServletRequest req, @RUntainted String baseUri, @RUntainted Locale locale) {
