...
public class CmsJspXmlContentBean extends CmsJspActionElement {
     ...
     */
    public CmsJspXmlContentBean(@RUntainted PageContext context, @RUntainted HttpServletRequest req, @RUntainted HttpServletResponse res) {
     ...
     */
    public I_CmsXmlContentContainer contentload(@RUntainted String collectorName, @RUntainted String collectorParam, boolean editable)
    throws JspException {
