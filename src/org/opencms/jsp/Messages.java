...
public final class Messages extends A_CmsMessageBundle {
  ...
  /** Message constant for key in the resource bundle. */
  public static final String ERR_CONTAINER_PAGE_ELEMENT_RENDER_ERROR_2 =
  ...
  /** Message constant for key in the resource bundle. */
  public static final String ERR_RESOURCE_IS_NOT_RELEASE_OR_EXPIRED_1 =
      "ERR_RESOURCE_IS_NOT_RELEASE_OR_EXPIRED_1";
  ...
  /** Message constant for key in the resource bundle. */
  public static final String ERR_TAG_RESOURCELOAD_INDEX_SIZE_0 =
      "ERR_TAG_RESOURCELOAD_INDEX_SIZE_0";

  /** Message constant for key in the resource bundle. */
  public static final String ERR_TAG_RESOURCELOAD_MISSING_COLLECTOR_0 =
      "ERR_TAG_RESOURCELOAD_MISSING_COLLECTOR_0";

  /** Message constant for key in the resource bundle. */
  public static final String ERR_TAG_RESOURCELOAD_MISSING_PARAM_0 =
  ...
  /** Message constant for key in the resource bundle. */
  public static final String LOG_WRONG_CONTAINER_MAXELEMENTS_3 =
   ...
   * available or to the default locale else.
   *
   * <p>This method allows a static method ({@link CmsJspTagInfo#infoTagAction(String,
   * javax.servlet.http.HttpServletRequest)}) that has no <code>pageContext</code> in scope to
   * lookup the locale at request time.
   *
   * <p>
   *
