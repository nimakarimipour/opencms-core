...
public class CmsJspTagPdf extends BodyTagSupport implements I_CmsJspTagParamParent {
  ...
  /**
   * The path of the JSP used to generate the XHTML for the content (which is used to generate the
   * PDF).
   */
  ...
  public static String pdfTagAction(
    ...
    CmsResource contentRes =
        cms.readResource(content, CmsResourceFilter.ignoreExpirationOffline(cms));
