 ...
 *
 * <p>It uses the information of a <code>{@link CmsDecorationDefintion}</code> to create the pre-
 * and postfix for a text decoration.
 *
 * @since 6.1.3
 */
public class CmsDecorationObject {
   ...
   */
  public CmsDecorationObject(
      String decorationKey, String decoration, CmsDecorationDefintion decDef, Locale locale) {
