...
public final class Messages extends A_CmsMessageBundle {
  ...
  public static final String LOG_DECORATION_DEFINITION_CREATE_BUNDLE_2 =
      "LOG_DECORATION_DEFINITION_CREATE_BUNDLE_2";

  /** Message constant for key in the resource bundle. */
  public static final String LOG_DECORATION_DEFINITION_CREATE_MAP_2 =
      "LOG_DECORATION_DEFINITION_CREATE_MAP_2";

  /** Message constant for key in the resource bundle. */
  public static final String LOG_DECORATION_DEFINITION_MAP_FILES_2 =
  ...
  /** Message constant for key in the resource bundle. */
  public static final String LOG_DECORATION_MAP_ADD_DECORATION_OBJECT_2 =
  ...
  /** Message constant for key in the resource bundle. */
  public static final String LOG_HTML_DECORATOR_DECODED_WORD_1 =
      "LOG_HTML_DECORATOR_DECODED_WORD_1";

  /** Message constant for key in the resource bundle. */
  public static final String LOG_HTML_DECORATOR_DECORATION_APPEND_DECORATION_1 =
      "LOG_HTML_DECORATOR_DECORATION_APPEND_DECORATION_1";

  /** Message constant for key in the resource bundle. */
  public static final String LOG_HTML_DECORATOR_DECORATION_APPEND_ORIGINALTEXT_1 =
      "LOG_HTML_DECORATOR_DECORATION_APPEND_ORIGINALTEXT_1";

  /** Message constant for key in the resource bundle. */
  public static final String LOG_HTML_DECORATOR_DECORATION_APPEND_WORD_1 =
      "LOG_HTML_DECORATOR_DECORATION_APPEND_WORD_1";

  /** Message constant for key in the resource bundle. */
  public static final String LOG_HTML_DECORATOR_DECORATION_FOUND_2 =
      "LOG_HTML_DECORATOR_DECORATION_FOUND_2";

  /** Message constant for key in the resource bundle. */
  public static final String LOG_HTML_DECORATOR_DECORATION_FOUND_FWL_3 =
      "LOG_HTML_DECORATOR_DECORATION_FOUND_FWL_3";

  /** Message constant for key in the resource bundle. */
  public static final String LOG_HTML_DECORATOR_PROCESS_WORD_2 =
      "LOG_HTML_DECORATOR_PROCESS_WORD_2";

  /** Message constant for key in the resource bundle. */
  public static final String LOG_DECORATION_MAP_FILL_MAP_DELIMITER_2 =
      "LOG_DECORATION_MAP_FILL_MAP_DELIMITER_2";

  /** Message constant for key in the resource bundle. */
  public static final String LOG_DECORATION_MAP_FILL_MAP_SPLIT_LIST_2 =
