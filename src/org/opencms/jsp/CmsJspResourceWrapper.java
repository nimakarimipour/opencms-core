...
public class CmsJspResourceWrapper extends CmsResource {
  ...
  /**
   * Factory method to create a new {@link CmsJspResourceWrapper} instance from a {@link
   * CmsResource}.
   *
   * <p>In case the parameter resource already is a wrapped resource AND the OpenCms request context
   * is the same as the provided context, the parameter object is returned.
   *
   * <p>
   *
   * @param cms the current CMS context
  ...
  public static CmsJspResourceWrapper wrap(CmsObject cms, CmsResource res) {
    ...
    if ((cms != null) && (res != null)) {
      if (res instanceof CmsJspResourceWrapper) {
        ...
        if (cms.getRequestContext()
            .getSiteRoot()
            .equals(wrapper.getRequestContext().getSiteRoot())) {
          result = wrapper;
        } else {
   ...
   *
   * <p>The extension will always be lower case.
   *
   * <p>
   *
   ...
   *
   * <p>In case this resource already is a {@link CmsFolder}, it is returned without modification.
   * In case it is a {@link CmsFile}, the parent folder of the file is returned.
   *
   * <p>
   *
  ...
  /**
   * Gets a list of resource wrappers for resources with relations pointing to this resource, for a
   * specific type.
   *
  ...
  public List<CmsJspResourceWrapper> getIncomingRelations(String typeName) {
    ...
    return getIncomingRelations().stream()
        .filter(res -> res.getTypeName().equals(typeName))
        .collect(Collectors.toList());
  }

  /**
   * Returns <code>true</code> in case this resource is an image in the VFS.
   *
   * <p>
   *
  ...
  /**
   * Returns <code>true</code> in case this resource is an XML content.
   *
   * <p>
   *
  ...
  public boolean getIsXml() {
    ...
    if (m_isXml == null) {
      m_isXml =
          Boolean.valueOf(
              CmsResourceTypeXmlPage.isXmlPage(this)
                  || CmsResourceTypeXmlContent.isXmlContent(this));
    }
  ...
  public String getLink() {
    ...
    return OpenCms.getLinkManager()
        .substituteLinkForUnknownTarget(m_cms, m_cms.getRequestContext().getSitePath(this));
  }
   ...
   * <p>
   *
   * @return a map with locale strings as keys and resource wrappers for the corresponding locale
   *     variants
   */
   ...
   *
   * <p>In case no valid mime type can be determined from the file extension, <code>text/plain
   * </code> is returned.
   *
   * <p>
   *
   ...
   *
   * <p>This will be initialized with this resource as default URI.
   *
   * <p>
   *
   ...
   *
   * <p>If this resource is a file, then this file is returned.
   *
   * <p>Otherwise, in case this resource is a folder:<br>
   *
   * <ol>
      ...
      if (isFolder()) {
        try {
          m_navigationDefaultFile =
              wrap(m_cms, m_cms.readDefaultFile(this, CmsResourceFilter.DEFAULT));
  ...
  public String getOnlineLink() {
    ...
    return OpenCms.getLinkManager()
        .getOnlineLink(m_cms, m_cms.getRequestContext().getSitePath(this));
  }

  /**
   * Gets a list of resources with relations pointing to them from this resources, as resource
   * wrappers.
   *
   * @return the list of resource wrappers
   */
   ...
   * wrappers.
   *
   * <p>Only gets resources with the given type.
   *
  ...
  public List<CmsJspResourceWrapper> getOutgoingRelations(String typeName) {
    ...
    return getOutgoingRelations().stream()
        .filter(res -> res.getTypeName().equals(typeName))
        .collect(Collectors.toList());
  }
   ...
   *
   * <p>The parent folder of a file is the folder of the file. The parent folder of a folder is the
   * parent folder of the folder. The parent folder of the root folder is <code>null</code>.
   *
   * <p>
   *
   ...
   *
   * <p>First resource in the list will be the direct parent folder of this resource, the last
   * element will be the site root folder.
   *
   * <p>
   *
   ...
   *
   * <p>This is without "search", so it will not include inherited properties from the parent
   * folders.
   *
   * <p>
   *
   ...
   *
   * <p>This is with "search", so it will include inherited properties from the parent folders.
   *
   * <p>
   *
   * @return the direct properties of this resource in a map for a given locale
   ...
   *
   * <p>In case this resource already is a {@link CmsFolder}, the folder path is returned without
   * modification. In case it is a {@link CmsFile}, the parent folder name of the file is returned.
   *
   * <p>
   *
   ...
   *
   * <p>The root folder "/" has level 0, a folder "/foo/" would have level 1, a folder "/foo/bar/"
   * level 2 etc.
   *
   * <p>
   *
   ...
   *
   * <p>This is included because in case {@link
   * org.opencms.jsp.util.CmsJspStandardContextBean#getWrap()} is used, the result may be either a
   * {@link org.opencms.jsp.util.CmsJspObjectValueWrapper} or a {@link CmsJspResourceWrapper}. Using
   * {@link #getToResource()} on the result will always return a resource wrapper this way.
   *
   * <p>
   *
   ...
   *
   * <p>In case this resource is not an XML content, <code>null</code> is returned.
   *
   * <p>
   *
  ...
  /**
   * Returns <code>true</code> in case this resource is child resource of the provided resource
   * which is assumed to be a folder.
   *
   * <p>
   *
   * @param resource the resource to check
   * @return <code>true</code> in case this resource is child resource of the provided resource
   *     which is assumed to be a folder
   */
  ...
  /**
   * Returns <code>true</code> in case this resource is child resource of the provided resource path
   * which is assumed to be a folder in the current site.
   *
   * <p>No check is performed to see if the provided site path resource actually exists.
   *
   * <p>
   *
   * @param sitePath the resource to check
   * @return <code>true</code> in case this resource is child resource of the provided resource path
   *     which is assumed to be a folder in the current site
   */
  ...
  /**
   * Returns <code>true</code> in case this resource is a parent folder of the provided resource.
   *
   * <p>
   *
   * @param resource the resource to check
  ...
  /**
   * Helper method for getting the related resources for this resource, with a given resource
   * filter.
   *
  ...
  /**
   * Reads a resource, suppressing possible exceptions.
   *
   * <p>
   *
