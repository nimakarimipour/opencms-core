 ...
 *
 * <p>Entry point for the tag implementation ({@link org.opencms.jsp.CmsJspTagParse}). The tag will
 * provide a valid {@link org.opencms.file.CmsObject} and it's configuration parameter String to
 * subclasses of this instances. Implementations just choose the type of {@link
 * org.opencms.util.I_CmsHtmlNodeVisitor} they will use for visiting the content to be parsed.
 *
 * <p>To implement a custom class that may be used with the <nobr>&lt;cms:parse parserClass="name"
 * param="config" /&gt;</nobr> tag the only thing that has to be done is to implement the method
 * {@link #createVisitorInstance()} and return the desired {@link
 * org.opencms.util.I_CmsHtmlNodeVisitor} implementation.
 *
 * <p>
 *
 * @since 6.1.7
...
public abstract class A_CmsConfiguredHtmlParser {
   ...
   *
   * <p>You have access to {@link #getCmsObject()} and {@link #getParam()} already here and may pass
   * those to the visitor to return.
   *
   * <p>
   *
   ...
   * @param noAutoCloseTags a list of upper case tag names for which parsing / visiting should not
   ...
   *
   * <p>This value will be initialized by the &lt;cms:parse&gt; tag.
   *
   * <p>
   *
   ...
   *
   * <p>This will be invokde by the &tl;cms:parse&gt; tag implementation.
   *
   * <p>
   *
   ...
   * The attribute value of the attribute param of the &lt;cms:parse&gt; tag.
   *
   * <p>Will be set by the &lt;cms:parse&gt; implementation.
   *
   * <p>
   *
