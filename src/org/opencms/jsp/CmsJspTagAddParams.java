...
/**
 * This tag is used to dynamically add request parameters which are available during the execution
 * of its body.
 *
 * <p>Request parameters are added with the &lt;cms:param&gt; tag.
 */
public class CmsJspTagAddParams extends TagSupport
    implements I_CmsJspTagParamParent, TryCatchFinally {
  ...
  public static class ParamState {
    ...
    /**
     * Initializes the tag state and sets a new parameter map on the request for which it was
     * instantiated.
     *
     * <p>
     */
  ...
  /**
   * Clears the tag state if it is set, and restores the previous set of parameters.
   *
   * <p>
   */
