...
/**
 * This servlet filter post-processes the response output for requests with the parameter
 * '__json=true'.
 *
 * <p>It converts the encoded JSON parts generated by the &lt;cms:jsonpart&gt; tag, converts them to
 * JSON, writes them to the response, and throws everything else away.
 */
public class CmsJsonPartFilter implements Filter {

  /**
   * Request wrapper used to disable direct edit functionality.
   *
   * <p>
   */
  ...
  /**
   * A response wrapper used to capture output so we can post-process it.
   *
   * <p>
   */
  class ResponseWrapper extends HttpServletResponseWrapper {
    ...
    /**
     * Creates a new wrapper instance for the given response.
     *
     * <p>
     *
    ...
    /**
     * This method does nothing, we want to ignore calls to setContentLength because we want to
     * postprocess the output, resulting in a different length.
     *
  ...
  /**
   * Transforms the response content as a string.
   *
   * <p>
   *
