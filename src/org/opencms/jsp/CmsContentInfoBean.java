...
public class CmsContentInfoBean {
  ...
  /**
   * Gets an id which is common to all items in a collector list.
   *
   * <p>
   *
  ...
  /**
   * Gets the javascript: link for creating and editing a new content.
   *
   * <p>
   *
  ...
  /**
   * Gets the Javascript for creating and editing a new content.
   *
   * <p>
   *
  ...
  /**
   * Increments the index of the current resource that gets iterated in the result list.
   *
   * <p>
   */
  void incResultIndex() {
  ...
  /**
   * Initializes the start and end indexes to build a Google-like page navigation.
   *
   * <p>
   */
  ...
  /**
   * Initializes the index of the current resource that gets iterated in the result list.
   *
   * <p>
   */
  ...
  /**
   * Sets the number of pages of browse through the result list.
   *
   * <p>
   *
  ...
  /**
   * Sets the index of the current page that gets displayed as an int.
   *
   * <p>
   *
  ...
  /**
   * Sets the index of the current page that gets displayed as a string.
   *
   * <p>The specified string gets parsed into an int.
   *
   * <p>
   *
  ...
  /**
   * Sets the page index of the last element in the Google-like page navigation.
   *
   * <p>
   *
  ...
  /**
   * Sets number of page links in the Google-like page navigation as a string.
   *
   * <p>
   *
  ...
  /**
   * Sets the page index of the first element in the Google-like page navigation.
   *
   * <p>
   *
  ...
  /**
   * Sets the size of a page as an int.
   *
   * <p>
   *
  ...
  /**
   * Sets the size of a page as a string.
   *
   * <p>The specified string gets parsed into an int.
   *
   * <p>
  ...
  /**
   * Sets the total size of the collector's result list.
   *
   * <p>
   *
