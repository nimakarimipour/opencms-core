...
public class CmsJspNavBuilder {
  ...
  public static List<CmsJspNavElement> getNavigationForFolder(
      CmsObject cms, String folder, int level) {
  ...
  public static List<CmsJspNavElement> getNavigationTreeForFolder(
      CmsObject cms, String folder, int startlevel, int endlevel) {
   ...
   */
  public List<CmsJspNavElement> getNavigationBreadCrumb(
      String folder, int startlevel, int endlevel, boolean currentFolder) {
   ...
   */
  public List<CmsJspNavElement> getNavigationForFolder(
      String folder, Visibility visibility, CmsResourceFilter resourceFilter) {
   ...
   */
  public CmsJspNavElement getNavigationForResource(
      String sitePath, CmsResourceFilter reourceFilter) {
  ...
  public List<CmsJspNavElement> getNavigationTreeForFolder(
      String folder, int startlevel, int endlevel) {
   ...
   */
  public List<CmsJspNavElement> getSiteNavigation(
      String folder, Visibility visibility, int endLevel) {
  ...
  private List<CmsJspNavElement> getNavigationForFolder(
      String folder, boolean includeInvisible, CmsResourceFilter resourceFilter, boolean shallow) {
  ...
  private CmsJspNavElement getNavigationForResource(
      String sitePath, CmsResourceFilter resourceFilter, boolean shallow) {
