 ...
 * the OpenCms taglib.
 *
 * <p>By instantiating a bean of this type and accessing the methods provided by the instance, all
 * functionality of the OpenCms JSP taglib can be easily used from within JSP scriptlet code.
 *
 * <p>Initialize this bean at the beginning of your JSP like this:
 *
 * <pre>
 ...
 * </pre>
 *
 * You can also access the current users <code>{@link org.opencms.file.CmsObject}</code> by using
 * <code>{@link org.opencms.jsp.CmsJspBean#getCmsObject()}</code>.
 *
 * <p>All exceptions that occur when calling any method of this class are caught and written to the
 * log output only, so that a template still has a chance of working at least in some elements.
 *
 * <p>
 *
 * @since 6.0.0
...
public class CmsJspActionElement extends CmsJspBean {
  ...
  public static final CmsMessageContainer NOT_INITIALIZED =
      Messages.get().container(Messages.GUI_ERR_ACTIONELEM_NOT_INIT_0);
  ...
  /**
   * Includes the direct edit scriptlet, same as using the <code>&lt;cms:editable /&gt;</code> tag.
   *
   * <p>The configured default direct edit provider is used.
   *
   * <p>
   *
  ...
  /**
   * Includes the direct edit scriptlet, same as using the <code>&lt;cms:editable file="..." /&gt;
   * </code>tag.
   *
   * <p>For backward compatibility, this always uses the JSP include based direct edit provider
   *
   * <p>.
   *
   * @param isEditable include scriptlet only if true
  ...
  /**
   * Includes the direct edit scriptlet, same as using the <code>
   * &lt;cms:editable provider="..." mode="..." file="..." /&gt;</code>tag.
   *
   * <p>
   *
   ...
   *
   * <p>Same as closing the <code>&lt;/cms:editable</code> tag after opening one in manual mode.
   *
   * <p>
   *
   * @param needsClose result of {@link #editableManualOpen()} should be the value for this
   *     parameter
   * @throws JspException if something goes wrong
   */
   ...
   *
   * <p>Same as opening the <code>&lt;cms:editable mode="manual"&gt;</code> tag.
   *
   * <p>
   *
    ...
    if (!CmsFlexController.isCmsOnlineRequest(getJspContext().getRequest())) {
      ...
      if ((eb != null)) {
        ...
        if (eb.isManual(CmsDirectEditMode.MANUAL)) {
          ...
          result = true;
          CmsJspTagEditable.editableTagAction(
              getJspContext(), null, CmsDirectEditMode.MANUAL, null);
        }
      }
    }
    return result;
  ...
  public String getContent(String target, String element, Locale locale) {
    ...
    try {
      byte[] result =
          loader.dump(getCmsObject(), file, element, locale, getRequest(), getResponse());
  ...
  /**
   * Generates an initialized instance of {@link CmsMessages} for convenient access to localized
   * resource bundles.
   *
   * <p>
   *
   ...
   * @param bundleName the name of the ResourceBundle to use
   * @param language language identifier for the locale of the bundle
   * @param defaultLanguage default for the language, will be used if language is null or empty
  ...
  /**
   * Returns an initialized {@link CmsJspNavBuilder} instance.
   *
   * <p>
   *
  ...
  /**
   * Returns the HTML for an <code>&lt;img src="..." /&gt;</code> tag that includes the given image
   * scaling parameters.
   *
   * <p>
   *
   ...
   * @param scaler the image scaler to use for scaling the image
   * @param attributes a map of additional HTML attributes that are added to the output
   * @param partialTag if <code>true</code>, the opening <code>&lt;img</code> and closing <code>
   *      /&gt;</code> is omitted
   * @return the HTML for an <code>&lt;img src&gt;</code> tag that includes the given image scaling
   *     parameters
   */
  public String img(
    ...
    CmsMessageContainer msgContainer =
        Messages.get()
            .container(
                Messages.GUI_ERR_IMG_SCALE_2, target, scaler == null ? "null" : scaler.toString());
    return getMessage(msgContainer);
  }

  /**
   * Include a sub-element without parameters from the OpenCms VFS, same as using the <code>
   * &lt;cms:include file="***" /&gt;</code> tag.
   *
   * <p>
   *
  ...
  /**
   * Include a named sub-element without parameters from the OpenCms VFS, same as using the <code>
   * &lt;cms:include file="***" element="***" /&gt;</code> tag.
   *
   * <p>
   *
   * @param target the target URI of the file in the OpenCms VFS (can be relative or absolute)
  ...
  /**
   * Include a named sub-element with parameters from the OpenCms VFS, same as using the <code>
   * &lt;cms:include file="***" element="***" /&gt;</code> tag with parameters in the tag body.
   *
   * <p>The parameter map should be a map where the keys are Strings (the parameter names) and the
   * values are of type String[]. However, as a convenience feature, in case you provide just a
   * String for the parameter value, it will automatically be translated to a String[1].
   *
   * <p>The handling of the <code>element</code> parameter depends on the included file type. Most
   * often it is used as template selector.
   *
   * <p><b>Important:</b> Exceptions that occur in the include process are NOT handled even if
   * {@link #setSupressingExceptions(boolean)} was set to <code>true</code>.
   *
   * @param target the target URI of the file in the OpenCms VFS (can be relative or absolute)
   * @param element the element (template selector) to display from the target
   * @param editable flag to indicate if direct edit should be enabled for the element
   ...
   * otherwise the same as using {@link #include(String, String, Map)}.
   *
   * <p>This is a convenience method that allows to include elements on a page without checking if
   * they exist or not. If the target element does not exist, nothing is printed to the JSP output.
   *
   * <p>
   *
   * @param target the target URI of the file in the OpenCms VFS (can be relative or absolute)
  ...
  /**
   * Returns an OpenCms or JVM system info property value, same as using the <code>
   * &lt;cms:info property="***" /&gt;</code> tag.
   *
   * <p>See the description of the class {@link CmsJspTagInfo} for a detailed list of available
   * options for the property value.
   *
   * <p>
   *
  ...
  public String info(String property) {
    ...
    CmsMessageContainer msgContainer =
        Messages.get().container(Messages.GUI_ERR_INFO_PROP_READ_1, property);
    return getMessage(msgContainer);
  }
   ...
   *
   * <p>You should consider using a standard {@link java.util.ResourceBundle
   * java.util.ResourceBundle} instead of the OpenCms workplace language files.
   *
   * <p>
   *
  ...
  public String label(String label) {
    ...
    CmsMessageContainer msgContainer =
        Messages.get().container(Messages.GUI_ERR_WORKPL_LABEL_READ_1, label);
    return getMessage(msgContainer);
  }

  /**
   * Returns a link to a file in the OpenCms VFS that has been adjusted according to the web
   * application path and the OpenCms static export rules.
   *
   * <p>Please note that the target is always assumed to be in the OpenCms VFS, so you can't use
   * this method for links external to OpenCms.
   *
   * <p>Relative links are converted to absolute links, using the current element URI as base.
   *
   * <p>This is the same as using the <code>&lt;cms:link&gt;***&lt;/cms:link&gt;</code> tag.
   *
   * <p>
   *
   ...
   * <p>Relative links are converted to absolute links, using the current element URI as base.
   *
   * <p>This is the same as using the <code>
   * &lt;cms:link baseUri=&quot;...&quot; &gt;***&lt;/cms:link&gt;</code> tag.
   *
   * <p>
   *
   * @param target the URI in the OpenCms VFS to link to
  ...
  public String link(String target, String baseUri) {
    ...
    CmsMessageContainer msgContainer =
        Messages.get().container(Messages.GUI_ERR_GEN_LINK_1, target);
    return getMessage(msgContainer);
  }
   ...
   *
   * <p>Please see the description of the class {@link org.opencms.jsp.CmsJspTagProperty} for valid
   * options of the <code>file</code> parameter.
   *
   * <p>
   *
   * @param file the file (or folder) to look at for the properties
   * @return Map all properties of the current file (and optional of the folders containing the
   *     file)
  ...
  /**
   * Returns a selected file property value, same as using the <code>
   * &lt;cms:property name="***" /&gt;</code> tag or calling {@link #property(String, String,
   * String, boolean)}.
   *
   * <p>
   *
  ...
  /**
   * Returns a selected file property value, same as using the <code>
   * &lt;cms:property name="***" file="***" /&gt;</code> tag or calling {@link #property(String,
  ...
  /**
   * Returns a selected file property value, same as using the <code>
   * &lt;cms:property name="***" file="***" default="***" /&gt;</code> tag or calling {@link
   ...
   * @return the value of the property found, or the value of defaultValue if the property could not
   *     be found
   * @see #property(String, String, String, boolean)
   * @see org.opencms.jsp.CmsJspTagProperty
   */
  ...
  /**
   * Returns a selected file property value with optional HTML escaping, same as using the <code>
   * &lt;cms:property name="***" file="***" default="***" /&gt;</code> tag.
   *
   * <p>Please see the description of the class {@link org.opencms.jsp.CmsJspTagProperty} for valid
   * options of the <code>file</code> parameter.
   *
   ...
   * @param file the file (or folder) to look at for the property
   * @param defaultValue a default value in case the property was not found
   * @param escapeHtml if <code>true</code>, special HTML characters in the return value are escaped
   *     with their number representations (e.g. &amp; becomes &amp;#38;)
   * @return the value of the property found, or the value of defaultValue if the property could not
   *     be found
   * @see org.opencms.jsp.CmsJspTagProperty
   */
  public String property(String name, String file, String defaultValue, boolean escapeHtml) {
    ...
    try {
      ...
      return CmsJspTagProperty.propertyTagAction(
          name, file, defaultValue, escapeHtml, getRequest());
    ...
    if (defaultValue == null) {
      CmsMessageContainer msgContainer =
          Messages.get().container(Messages.GUI_ERR_FILE_PROP_MISSING_2, name, file);
      return getMessage(msgContainer);
    } else {
      return defaultValue;
    }
  ...
  /**
   * Checks if a template part should be used or not, same as using the <code>
   * &lt;cms:template element="***" /&gt;</code> tag.
   *
   * <p>
   *
  ...
  /**
   * Checks if a template part should be used or not, same as using the <code>
   * &lt;cms:template ifexists="***" /&gt;</code> tag.
   *
   * <p>
   *
  ...
  /**
   * Checks if a template part should be used or not, same as using the <code>
   * &lt;cms:template element="***" ifexists="***" /&gt;</code> tag.
   *
   * <p>
   *
   * @param element the template element to check
  ...
  public boolean template(String element, String elementlist, boolean checkall) {
    ...
    try {
      return CmsJspTagTemplate.templateTagAction(
          element, elementlist, checkall, false, getRequest());
    } catch (Throwable t) {
      handleException(t);
    }
    return true;
  ...
  /**
   * Converts a relative URI in the OpenCms VFS to an absolute one based on the location of the
   * currently processed OpenCms URI.
   *
   * <p>
   *
  ...
  public String toAbsolute(String target) {
    ...
    return CmsLinkManager.getAbsoluteUri(
        target, getController().getCurrentRequest().getElementUri());
  }

  /**
   * Returns a selected user property, i.e. information about the currently logged in user, same as
   * using the <code>&lt;cms:user property="***" /&gt;</code> tag.
   *
   * <p>
   *
   * @param property the user property to display, please see the tag documentation for valid
   *     options
  ...
  public String user(String property) {
    ...
    CmsMessageContainer msgContainer =
        Messages.get().container(Messages.GUI_ERR_USER_PROP_READ_1, property);
    return getMessage(msgContainer);
  }
}
