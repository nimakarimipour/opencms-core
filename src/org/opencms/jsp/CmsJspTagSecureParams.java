...
public class CmsJspTagSecureParams extends TagSupport {
   ...
   * @param allowXml the comma-separated list of parameters for which XML characters will not be
   *     escaped
   * @param allowHtml the comma-separated list of parameters for which HTML will be allowed, but be
   *     escaped
   * @param policy the site path of an AntiSamy policy file
   */
  public static void secureParamsTagAction(
      ServletRequest request, String allowXml, String allowHtml, String policy) {
