...
public class CmsDefaultLinkSubstitutionHandler implements I_CmsLinkSubstitutionHandler {
     ...
     */
    public @RUntainted String getLink(CmsObject cms, @RUntainted String link, String siteRoot, String targetDetailPage, boolean forceSecure) {
     ...
     */
    protected CmsPair<String, @RUntainted String> addVfsPrefix(
        CmsObject cms,
        String vfsName,
        CmsSite targetSite,
        String parameters) {
     ...
     */
    protected @RUntainted String getRootPathForSite(CmsObject cms, String path, String siteRoot, boolean isRootPath) {
     ...
     * @return the root path
     */
    protected @RUntainted String prepareExportParameters(CmsObject cms, String vfsName, String parameters) {
     ...
     */
    @RUntainted String getSuffix(URI uri) {
