...
public class CmsAfterPublishStaticExportHandler extends A_CmsStaticExportHandler {
     ...
     */
    @Override
    public void performEventPublishProject(@RUntainted CmsUUID publishHistoryId, @RUntainted I_CmsReport report) {
     ...
     * @throws ServletException in case of errors accessing the servlet
     */
    protected void exportAfterPublish(@RUntainted CmsUUID publishHistoryId, @RUntainted I_CmsReport report)
    throws CmsException, IOException, ServletException {
     ...
     */
    protected @RUntainted int exportTemplateResource(CmsStaticExportData data, @RUntainted StringBuffer cookies) throws IOException {
    ...
    protected boolean readNonTemplateResourcesToExport(
        CmsObject cms,
        List<CmsPublishedResource> publishedResources,
        List<@RUntainted CmsStaticExportData> resourcesToExport)
    throws CmsException {
