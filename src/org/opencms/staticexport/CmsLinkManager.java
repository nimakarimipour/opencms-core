...
public class CmsLinkManager {
     ...
     * @see #getServerLink(CmsObject, String)
     */
    public String getOnlineLink(CmsObject cms, @RUntainted String resourceName, String targetDetailPage, boolean forceSecure) {
     ...
     */
    public @RUntainted String getServerLink(CmsObject cms, @RUntainted String resourceName) {
     ...
     * @see #getOnlineLink(CmsObject, String)
     */
    public @RUntainted String getServerLink(CmsObject cms, @RUntainted String resourceName, boolean forceSecure) {
     ...
     */
    public @RUntainted String getWorkplaceLink(CmsObject cms, @RUntainted String resourceName, boolean forceSecure) {
     ...
     */
    public @RUntainted String substituteLink(CmsObject cms, @RUntainted String link, String siteRoot) {
