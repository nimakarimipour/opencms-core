...
public class CmsLinkManager {
     ...
     */
    public @RUntainted String getPermalink(CmsObject cms, String resourceName) {
     ...
     * @return the perma link
     */
    public @RUntainted String getPermalink(CmsObject cms, String resourceName, CmsUUID detailContentId) {
     ...
     * @since 7.0.2
     */
    public @RUntainted String getRootPath(CmsObject cms, String targetUri) {
     ...
     * @since 7.0.2
     */
    public @RUntainted String getRootPath(CmsObject cms, String targetUri, String basePath) {
     ...
     */
    public @RUntainted String substituteLink(CmsObject cms, String link, String siteRoot) {
