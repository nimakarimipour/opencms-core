...
public interface I_CmsLinkSubstitutionHandler {
     ...
     */
    @RUntainted String getLink(CmsObject cms, @RUntainted String link, @RUntainted String siteRoot, boolean forceSecure);
     ...
     * @see #getRootPath(CmsObject, String, String) for the reverse function, which creates a VFS
     */
    @RUntainted String getLink(CmsObject cms, @RUntainted String link, @RUntainted String siteRoot, @RUntainted String targetDetailPage, boolean forceSecure);
     ...
     */
    @RUntainted String getRootPath(CmsObject cms, @RUntainted String targetUri, @RUntainted String basePath);
}
