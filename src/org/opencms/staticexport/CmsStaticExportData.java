...
public class CmsStaticExportData {
     ...
     */
    public CmsStaticExportData(@RUntainted String vfsName, @RUntainted String rfsName, CmsResource resource, String parameters) {
     ...
     */
    public @RUntainted String getParameters() {
