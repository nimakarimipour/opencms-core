...
public class CmsUploadActionElement extends CmsGwtActionElement {
  ...
  /**
   * A CMS dialog that makes the {@link Dialog#computeCurrentFolder} method visible.
   *
   * <p>
   */
  ...
  /**
   * Returns a javascript tag that contains a variable deceleration that has the target folder as
   * value.
   *
   * <p>
   *
   * @return a javascript tag that contains a variable deceleration that has the target folder as
   *     value
   */
  private String exportTargetFolder() {
    ...
    sb.append(
        wrapScript("var ", I_CmsUploadConstants.VAR_TARGET_FOLDER, " = \'", targetFolder, "\';"));
    return sb.toString();
  }
}
