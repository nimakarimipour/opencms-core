 ...
 *
 * <p>Disregards the 'exclude external detail contents' option, allows all combinations of detail
 * page / detail content on the same site.
 */
public class CmsPermissiveDetailPageHandler implements I_CmsDetailPageHandler {
  ...
  public static @RUntainted String getDetailPage(
    ...
    if ((targetDetailPage != null)
        && manager.getDetailPages(cms, resType).contains(targetDetailPage)) {
