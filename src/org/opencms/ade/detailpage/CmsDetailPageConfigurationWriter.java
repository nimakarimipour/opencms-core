...
public class CmsDetailPageConfigurationWriter {
  ...
  /**
   * Helper method for loading the XML content from the configuration file.
   *
   * <p>
   *
  ...
  /**
   * Removes the old detail page information from the XML content.
   *
   * <p>
   *
   * @throws CmsException if something goes wrong
  ...
  /**
   * Writes the detail page information to the XML content.
   *
   * <p>
   *
  ...
  /**
   * Writes a single item of detail page information to the XML content.
   *
   * <p>
   *
