...
public class CmsDetailPageInfo implements Serializable {
  ...
  /**
   * Flag used to distinguish inherited detail pages from ones defined in the current sitemap
   * config.
   */
  ...
  public CmsDetailPageInfo(
      CmsUUID id, String uri, String type, String qualifier, String iconClasses) {
  ...
  public CmsDetailPageInfo copyAsInherited() {
    ...
    CmsDetailPageInfo result =
        new CmsDetailPageInfo(m_id, m_uri, m_type, m_qualifier, m_iconClasses);
   ...
   *
   * <p>The qualifier is an optional (i.e. possibly null) string that indicates when this detail
   * page should be used.
   *
