...
public interface I_CmsDetailPageHandler extends I_CmsConfigurationParameterHandler {
     ...
     */
    Collection<@RUntainted String> getAllDetailPages(CmsObject cms, @RUntainted int restype) throws CmsException;
     ...
     */
    @RUntainted String getDetailPage(CmsObject cms, String rootPath, String linkSource, String targetDetailPage);
