...
/**
 * Interface for classes which can find the detail page for a given resource, and determine whether
 * a given detail page / detail content combination is valid.
 *
 * @since 8.0.0
 */
public interface I_CmsDetailPageHandler extends I_CmsConfigurationParameterHandler {
  ...
  /**
   * Returns the detail page link for the given resource, or null if there is no detail page for the
   * resource.
   *
   * <p>
   *
