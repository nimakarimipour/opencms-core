 ...
 * resources which include the URL names of the resources themselves.
 *
 * <p>
 *
...
public final class CmsDetailPageUtil {
   ...
   */
  public static List<String> getAllDetailPagesWithUrlName(CmsObject cms, CmsResource res)
      throws CmsException {

    List<String> result = new ArrayList<String>();
    Collection<String> detailPages =
        OpenCms.getADEManager().getDetailPageHandler().getAllDetailPages(cms, res.getTypeId());
  ...
  /**
   * Returns either the newest URL name for a structure id, or the structure id as a string if there
   * is no URL name.
   *
   * <p>
   *
    ...
    try {
      ...
      throw new CmsVfsResourceNotFoundException(
          org.opencms.db.generic.Messages.get()
              .container(org.opencms.db.generic.Messages.ERR_READ_RESOURCE_1, uri));
    }
  }
}
