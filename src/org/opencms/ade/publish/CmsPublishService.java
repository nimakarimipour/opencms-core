...
public class CmsPublishService extends CmsGwtService implements I_CmsPublishService {
    ...
    public static CmsPublishData prefetch(HttpServletRequest request) throws CmsRpcException {
        ...
        HashMap<String, @RUntainted String> params = Maps.newHashMap();
     ...
     */
    public CmsPublishData getInitData(HashMap<String, @RUntainted String> params) throws CmsRpcException {
    ...
    public CmsPublishData getPublishData(
        CmsObject cms,
        HashMap<String, @RUntainted String> params,
     ...
     */
    private List<CmsResource> idsToResources(CmsObject cms, List<@RUntainted CmsUUID> ids) {
