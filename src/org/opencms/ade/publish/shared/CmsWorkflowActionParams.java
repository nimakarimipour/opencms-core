...
public class CmsWorkflowActionParams implements IsSerializable {
   ...
   *
   * <p>The publish list token is a bean which can be used to reconstruct a publish list on the
   * server side. It is used instead of sending the list of resources when that list is deemed to
