...
public interface I_CmsVirtualProject {
     ...
     */
    CmsProjectBean getProjectBean(CmsObject cms, Map<@RUntainted String, @RUntainted String> params);
     ...
     */
    List<CmsResource> getResources(CmsObject cms, Map<@RUntainted String, @RUntainted String> params, String workflowId) throws CmsException;
