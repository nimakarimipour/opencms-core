...
public interface I_CmsVirtualProject {
     ...
     */
    @RUntainted List<CmsResource> getResources(CmsObject cms, @RUntainted Map<@RUntainted String, @RUntainted String> params, String workflowId) throws CmsException;
