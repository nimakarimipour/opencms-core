 ...
 *
 * <p>Instead of reading the resources from a real project, the resource lists will be generated by
...
public interface I_CmsVirtualProject {
   ...
   *
   * <p>Should return null if the virtual project is not available or applicable for the given
   * parameters.
   *
   * <p>
   *
   ...
   */
  I_CmsPublishRelatedResourceProvider getRelatedResourceProvider(
   ...
   */
  List<CmsResource> getResources(CmsObject cms, Map<String, String> params, String workflowId)
      throws CmsException;

  /**
   * Returns true if in this virtual project, resource groups should be able to be automatically
   * selected by the GUI.
   *
   * <p>
   *
