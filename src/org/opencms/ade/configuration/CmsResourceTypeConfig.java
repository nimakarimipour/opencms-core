...
public class CmsResourceTypeConfig implements I_CmsConfigurationObject<CmsResourceTypeConfig> {
     ...
     */
    public CmsResourceTypeConfig(@RUntainted String typeName, boolean disabled, CmsContentFolderDescriptor folder, String pattern) {
    ...
    public boolean checkCreatable(CmsObject cms, @RUntainted String pageFolderRootPath) throws CmsException {
        ...
        @RUntainted String folderPath = getFolderPath(cms, pageFolderRootPath);
        String oldSiteRoot = cms.getRequestContext().getSiteRoot();
        cms.getRequestContext().setSiteRoot("");
        //tryToUnlock(cms, folderPath);
        CmsResource permissionCheckFolder = null;
        for (@RUntainted String currentPath = folderPath; currentPath != null; currentPath = CmsResource.getParentFolder(
            currentPath)) {
            try {
