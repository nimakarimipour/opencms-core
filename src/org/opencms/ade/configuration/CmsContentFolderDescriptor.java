...
/**
 * A bean which represents the location configured for content elements of a specific type in a
...
public class CmsContentFolderDescriptor {
  ...
  /**
   * The 'isPageRelative' flag. If true, elements of this type will be stored with the pages on
  ...
  public String getFolderPath(CmsObject cms, String pageFolderPath) {
    ...
    if (m_folder != null) {
      ...
      return CmsStringUtil.joinPaths(
          cms.getRequestContext().getSiteRoot(), CmsADEManager.CONTENT_FOLDER_NAME, m_folderName);
    }
  }
