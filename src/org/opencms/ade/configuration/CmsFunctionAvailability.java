...
public class CmsFunctionAvailability {
  ...
  /**
   * The map of states for dynamic functions - true for explicitly added functions, false for
   * explicitly removed functions (unless there is a whitelist and they are not in it.
   */
  ...
  /**
   * Gets the blacklist of explicitly removed functions that are not already covered by not being in
   * a whitelist.
   *
   ...
   *
   * <p>If no functions have been explicitly added, and no "remove all" option has been used, this
   * will return null.
   *
