...
public final class Messages extends A_CmsMessageBundle {
  ...
  /** Message constant for key in the resource bundle. */
  public static final String GUI_CONTAINERPAGE_EDIT_DISABLED_BY_SITEMAP_CONFIG_0 =
      "GUI_CONTAINERPAGE_EDIT_DISABLED_BY_SITEMAP_CONFIG_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_CONTAINERPAGE_TYPE_NOT_CREATABLE_1 =
      "GUI_CONTAINERPAGE_TYPE_NOT_CREATABLE_1";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_DESCRIPTION_DEFAULT_RESOURCE_CONTENT_0 =
  ...
  /** Message constant for key in the resource bundle. */
  public static final String GUI_ELEMENT_RESOURCE_CAN_NOT_BE_EDITED_0 =
  ...
  /** Message constant for key in the resource bundle. */
  public static final String GUI_SETTING_TEMPLATE_CONTEXTS_DESCRIPTION_0 =
      "GUI_SETTING_TEMPLATE_CONTEXTS_DESCRIPTION_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_SETTING_TEMPLATE_CONTEXTS_NAME_0 =
  ...
  /** Message constant for key in the resource bundle. */
  public static final String GUI_TITLE_DEFAULT_RESOURCE_CONTENT_0 =
