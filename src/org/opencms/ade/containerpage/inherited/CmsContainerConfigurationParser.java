...
public class CmsContainerConfigurationParser {
  ...
  protected void parseSingleConfiguration(I_CmsXmlContentValueLocation location) {
    ...
    Map<String, CmsContainerElementBean> newElementBeans =
    ...
    for (I_CmsXmlContentValueLocation elementLoc : newElementLocs) {
      ...
      if (structureId != null) {
        ...
        CmsContainerElementBean newElementBean =
            new CmsContainerElementBean(structureId, CmsUUID.getNullUUID(), settings, false);
        newElementBeans.put(key, newElementBean);
      }
    }
    CmsContainerConfiguration config =
        new CmsContainerConfiguration(ordering, visibilities, newElementBeans);
