...
public class CmsContainerConfigurationCacheState {
  ...
  private Map<CmsUUID, CmsContainerConfigurationGroup> m_configurationsById =
      new HashMap<CmsUUID, CmsContainerConfigurationGroup>();

  /** The map of cached configurations, with the base paths as keys. */
  private Map<String, CmsContainerConfigurationGroup> m_configurationsByPath =
      new HashMap<String, CmsContainerConfigurationGroup>();
   ...
   * <p>
   *
   * @param groups the inheritance group configurations.
   *     <p>
   */
  ...
  /**
   * Creates a new inheritance container cache state, which is based on this instance, but with some
