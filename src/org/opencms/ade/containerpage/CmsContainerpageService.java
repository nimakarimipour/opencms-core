...
public class CmsContainerpageService extends CmsGwtService implements I_CmsContainerpageService {
     ...
     */
    public CmsUUID copyElement(CmsUUID pageId, CmsUUID originalElementId, @RUntainted String locale) throws CmsRpcException {
     ...
     */
    public CmsDialogOptionsAndInfo getDeleteOptions(@RUntainted String clientId, CmsUUID pageId, String requestParams)
    throws CmsRpcException {
     ...
     */
    public CmsDialogOptionsAndInfo getNewOptions(@RUntainted String clientId, CmsUUID pageStructureId, String requestParams)
    throws CmsRpcException {
     ...
     */
    public void handleDelete(@RUntainted String clientId, String deleteOption, CmsUUID pageId, String requestParams)
    throws CmsRpcException {
     ...
     */
    public CmsUUID prepareForEdit(@RUntainted String clientId, String editOption, CmsUUID pageId, String requestParams)
    throws CmsRpcException {
     ...
     */
    Map<String, @RUntainted String> getSettingsToChangeForDnd(
     ...
     */
    private @RUntainted Map<@RUntainted String, @RUntainted String> convertSettingValues(CmsResource resource, Map<String, @RUntainted String> settings, @RUntainted Locale locale)
    throws CmsException {
    ...
    throws CmsException {
        ...
        for (Entry<String, CmsContainerElementBean> entry : idMapping.entrySet()) {
            ...
            if ((dndOriginContainer != null) && !CmsContainerElement.MENU_CONTAINER_ID.equals(dndOriginContainer)) {
                ...
                Map<String, @RUntainted String> dndSettings = getSettingsToChangeForDnd(
                    config,
