...
public class CmsModelGroupHelper {
     ...
     */
    public static boolean updateModelGroupResource(@RUntainted CmsObject cms, @RUntainted CmsResource group, @RUntainted String baseContainerName) {
    ...
    public static void updateModelGroupResources(
        ...
        String basePath,
        @RUntainted String baseContainerName)
    throws IOException {
     ...
     */
    private static void ensureLock(CmsObject cms, @RUntainted CmsResource resource) throws CmsException {
     ...
     */
    private static void tryUnlock(CmsObject cms, @RUntainted CmsResource resource) {
     ...
     */
    public CmsContainerPageBean saveModelGroups(CmsContainerPageBean page, @RUntainted CmsResource pageResource)
    throws CmsException {
