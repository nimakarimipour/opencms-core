...
public final class CmsCntPageData implements IsSerializable {
  ...
  private static final String BACKLINK_URI =
      "/system/modules/org.opencms.ade.containerpage/editor-backlink.html";
   ...
   * @param noEditReason the reason why the current user is not allowed to edit the current
   *     container page
   ...
   * @param showSmallElementsInitially flag which controls whether small elements should be shown
   *     initially
  ...
  /**
   * Gets the structure id of the detail container page (or null if we are not on on a detail page,
   * or there is no detail container page).
   *
   ...
   *
   * <p>The beans represent links to different locale variants of this page.
   *
   ...
   * <p>
   *
   * @param allowSettingsInEditor <code>true</code> to set editing settings in the content editor is
   *     allowed
   */
