...
public class CmsContainer implements IsSerializable {
  ...
  /**
   * Indicates whether this container not nested, or in case of a detail only container page the
   * starting point of a detail only container hierarchy.
   */
  ...
  /**
   * Returns the container name, also used as HTML-id for the container DOM-element. Has to be
  ...
  /**
   * Returns the container type. Used to determine the formatter used to render the contained
   * elements.
   *
   * <p>
   *
  ...
  /**
   * Returns <code>true</code> if the container is displayed in detail view only.
   *
   * <p>
   *
  ...
  /**
   * Returns if this container not nested, or in case of a detail only container page the starting
   * point of a detail only container hierarchy.
   *
   * <p>
   *
  ...
  /**
   * Sets the if this container not nested, or in case of a detail only container page the starting
   * point of a detail only container hierarchy.
   *
   * <p>
   *
