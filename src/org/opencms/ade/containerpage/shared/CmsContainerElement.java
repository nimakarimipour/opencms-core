...
public class CmsContainerElement implements IsSerializable, I_CmsHasIconClasses {
  ...
  /**
   * The resource type for new elements. If this field is not empty, the element is regarded as new
   * and not created yet.
   */
  ...
  public CmsContainerElement copy() {
    ...
    result.m_permissionInfo =
        new CmsPermissionInfo(
   ...
   *
   * <p>When the page containing the element is used a model page, this flag determines whether a
   * copy of the element is created when creating a new page from that model page.
   *
   * <p>
   *
   ...
   * <p>
   *
   * @return <code>true</code> if all instances of this element should be replaced within a model
   *     group
   */
   ...
   * <p>
   *
   * @param releasedAndNotExpired <code>true</code> if the given resource is released and not
   *     expired
   */
