...
public interface I_CmsContainerpageService extends RemoteService {
   ...
   */
  boolean checkContainerpageOrElementsChanged(
   ...
   * @throws CmsRpcException if something goes wrong
   */
  CmsUUID copyElement(CmsUUID pageId, CmsUUID originalElementId, @RUntainted String locale)
      throws CmsRpcException;
   ...
   */
  CmsDialogOptionsAndInfo getDeleteOptions(
  ...
  CmsDialogOptionsAndInfo getEditOptions(
      String clientId, CmsUUID pageStructureId, String requestParams, boolean isListElement)
      throws CmsRpcException;
   ...
   *     group
   * @param dndSource the drag and drop source container (if we are getting the data for the drag
   *     and drop case)
   * @param locale the content locale
  ...
  CmsContainerPageGalleryData getGalleryDataForPage(
      List<CmsContainer> containers, CmsUUID elementView, String uri, String locale)
      throws CmsRpcException;
   ...
   * @throws CmsRpcException if something goes wrong
   */
  CmsListElementCreationDialogData getListElementCreationOptions(
   ...
   * @throws CmsRpcException if something goes wrong
   */
  CmsDialogOptionsAndInfo getNewOptions(
      String clientId, CmsUUID pageStructureId, String requestParams) throws CmsRpcException;
   ...
   * @param containerpageId the id of the page which should be excluded from the relation check, or
   *     null if no page should be excluded
   * @return the status of the removed element
   * @throws CmsRpcException if something goes wrong
   */
  CmsRemovedElementStatus getRemovedElementStatus(String id, CmsUUID containerpageId)
      throws CmsRpcException;
   ...
   */
  void handleDelete(
      String clientId, String deleteOption, CmsUUID pageStructureId, String requestParams)
      throws CmsRpcException;
  ...
  CmsUUID prepareForEdit(
      String clientId, String editOption, CmsUUID pageStructureId, String requestParams)
      throws CmsRpcException;
   ...
   * @throws CmsRpcException if something goes wrong processing the request
   */
  long saveContainerpage(CmsUUID pageStructureId, List<CmsContainer> containers)
      throws CmsRpcException;
  ...
  void updateServerElementFormatter(
      String clientId, String containerId, Map<String, String> settings) throws CmsRpcException;
}
