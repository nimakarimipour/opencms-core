...
public interface I_CmsGalleryConfiguration {
   ...
   * Gets the tree token.
   *
   * <p>The tree token is used to save/load tree opening states for tree tabs in the gallery dialog.
   * If two widget instances use different tree tokens, opening or closing tree entries in one will
   * not effect the tree opening state of the other.
   *
