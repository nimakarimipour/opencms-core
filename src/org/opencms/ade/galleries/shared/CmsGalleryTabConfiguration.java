...
public class CmsGalleryTabConfiguration implements IsSerializable {
    ...
    static {
        @RUntainted Map<@RUntainted String, @RUntainted CmsGalleryTabConfiguration> defaultConfigs = new HashMap<@RUntainted String, @RUntainted CmsGalleryTabConfiguration>();
    ...
    public static @RUntainted CmsGalleryTabConfiguration parse(String configStr) {
        ...
        @RUntainted List<@RUntainted GalleryTabId> tabsList = new ArrayList<@RUntainted GalleryTabId>();
        for (@RUntainted GalleryTabId tab : tabs.keySet()) {
            tabsList.add(tab);
        }
     ...
     */
    public static @RUntainted CmsGalleryTabConfiguration resolve(@RUntainted String configStr) {
