...
/**
 * This bean holding the gallery dialog information required for displaying the content of the
 * gallery tabs.
 *
 * <p>
 *
...
public class CmsGalleryDataBean implements IsSerializable {
  ...
  /**
   * The gallery reference site-path. In widget, editor and containerpage mode this will be the
   * edited resource, otherwise the opened gallery folder.
   */
   ...
   *
   * <p>These are additional parameters to store information about the context from which the
   * gallery dialog was opened.
   *
   ...
   *
   * <p>In widget, editor and containerpage mode this will be the edited resource, otherwise the
   * opened gallery folder.
   *
   * <p>
   *
