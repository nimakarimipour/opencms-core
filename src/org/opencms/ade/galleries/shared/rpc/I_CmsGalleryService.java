...
public interface I_CmsGalleryService extends RemoteService {
   ...
   * @return the gallery upload action information for that folder (may be null if no folder is
   *     found)
   * @throws CmsRpcException if something goes wrong
   */
  ...
  /**
   * Performs an initial search based on the given data bean and the available parameters of the
   * request.
   *
   * <p>
   *
