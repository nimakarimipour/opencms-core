...
public interface I_CmsPreviewService extends RemoteService {
     ...
     * @throws CmsRpcException if something goes wrong
     */
    CmsImageInfoBean updateImageProperties(String resourcePath, @RUntainted String locale, Map<@RUntainted String, @RUntainted String> properties)
     ...
     * @throws CmsRpcException if something goes wrong
     */
    CmsResourceInfoBean updateResourceProperties(String resourcePath, @RUntainted String locale, Map<@RUntainted String, @RUntainted String> properties)
    throws CmsRpcException;
