 ...
 *
 * <p>Objects of this class are single-use, which means they should only be used for a single
 * navigation tree filtering operation.
 */
public class CmsGalleryFilteredNavTreeBuilder {
  ...
  public class NavigationNode {
    ...
    /**
     * Creates children for this node by loading child navigation entries for this node's navigation
     * entry.<p<
     */
    ...
    void expand() {
      ...
      for (CmsJspNavElement navElement :
          m_navBuilder.getNavigationForFolder(
    ...
    /**
     * Recursively loads children for all nodes.
     *
     * <p>
     */
    void expandAll() {
    ...
    /**
     * Marks the node to not be removed during the pruning step.
     *
     * <p>
     */
    void markAsKeep() {
    ...
    /**
     * Matches all nodes of the tree against the filter.
     *
     * <p>
     *
    ...
    /**
     * Checks if the node matches the given filter string.
     *
     * <p>
     *
    ...
    boolean matches(String filter) {
      ...
      for (String matchText :
          new String[] {
            m_navElement.getNavText(), m_navElement.getTitle(), m_navElement.getDescription()
          }) {
        if (matchText != null) {
    ...
    /**
     * Prunes nodes which should not be kept after filtering.
     *
     * <p>
     */
  ...
  public CmsGalleryFilteredNavTreeBuilder(CmsObject cms, String rootPath) {
    ...
    CmsJspNavElement rootNav =
        navBuilder.getNavigationForResource(rootPath, CmsResourceFilter.ONLY_VISIBLE_NO_DELETED);
