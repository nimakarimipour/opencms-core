...
public class CmsPreviewService extends CmsGwtService implements I_CmsPreviewService {
      ...
      if (CmsResourceTypeXmlContent.isXmlContent(resource)) {
        ...
        if (formatter != null) {
          ...
          CmsJspStandardContextBean standardContext =
              CmsJspStandardContextBean.getInstance(request);

          Map<String, String> settings = new HashMap<>();
          for (Map.Entry<String, CmsXmlContentProperty> entry :
              formatter.getSettings(adeConfig).entrySet()) {
          ...
          CmsContainerElementBean element =
              new CmsContainerElementBean(
                  resource.getStructureId(), formatter.getJspStructureId(), settings, false);
          ...
          CmsContainerBean containerBean =
          ...
          return (new String(
                  OpenCms.getResourceManager()
                      .getLoader(formatterResource)
                      .dump(tempCms, formatterResource, null, locale, request, response),
                  encoding))
              .trim();
        }
      }
   ...
   * @param resource the resource
   * @return the focal point (or null, if the focal point property is not set or contains an invalid
   *     value)
   * @throws CmsException if something goes wrong
   */
  public static CmsPoint readFocalPoint(CmsObject cms, CmsResource resource) throws CmsException {

    CmsProperty focalPointProp =
        cms.readPropertyObject(resource, CmsPropertyDefinition.PROPERTY_IMAGE_FOCAL_POINT, false);
  ...
  public CmsImageInfoBean getImageInfo(String resourcePath, String locale) throws CmsRpcException {
    ...
    try {
      ...
      CmsProperty property =
          cms.readPropertyObject(resource, CmsPropertyDefinition.PROPERTY_COPYRIGHT, false);
   ...
   *     java.lang.String)
   */
  public CmsResourceInfoBean getResourceInfo(String resourcePath, String locale)
  ...
  public void readResourceInfo(
      CmsObject cms, CmsResource resource, CmsResourceInfoBean resInfo, String locale)
      throws CmsException {
    ...
    CmsExplorerTypeSettings setting =
  ...
  /**
   * @see
   *     org.opencms.ade.galleries.shared.rpc.I_CmsPreviewService#updateImageProperties(java.lang.String,
   *     java.lang.String, java.util.Map)
   */
  public CmsImageInfoBean updateImageProperties(
  ...
  /**
   * @see
   *     org.opencms.ade.galleries.shared.rpc.I_CmsPreviewService#updateResourceProperties(java.lang.String,
   *     java.lang.String, java.util.Map)
   */
  ...
  /**
   * Tries to read a resource either from the current site or from the root site.
   *
   * <p>
   *
   * @param cms the CMS context to use
   ...
   * @throws CmsException if something goes wrong
   */
  private CmsResource readResourceFromCurrentOrRootSite(CmsObject cms, String name)
      throws CmsException {
  ...
  /**
   * Saves the given properties to the resource.
   *
   * <p>
   *
   ...
   * @throws CmsException if something goes wrong
   */
  private void saveProperties(String resourcePath, Map<String, String> properties)
      throws CmsException {
