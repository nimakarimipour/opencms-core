...
public class CmsEditHandlerData implements IsSerializable {
     ...
     */
    public CmsEditHandlerData(@RUntainted String clientId, String option, @RUntainted CmsUUID pageContextId, @RUntainted String requestParams) {
     ...
     */
    public @RUntainted CmsUUID getPageContextId() {
