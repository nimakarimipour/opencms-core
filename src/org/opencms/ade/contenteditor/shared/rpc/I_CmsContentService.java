...
public interface I_CmsContentService extends org.opencms.acacia.shared.rpc.I_CmsContentService {
    ...
    CmsSaveResult saveAndDeleteEntities(
        ...
        String clientId,
        @RUntainted List<String> deletedEntities,
        Collection<String> skipPaths,
     ...
     * @throws CmsRpcException if something goes wrong
     */
    String saveValue(@RUntainted String contentId, String contentPath, String locale, @RUntainted String value) throws CmsRpcException;
}
