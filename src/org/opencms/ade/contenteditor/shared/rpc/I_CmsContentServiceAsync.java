...
public interface I_CmsContentServiceAsync
    extends org.opencms.acacia.shared.rpc.I_CmsContentServiceAsync {
  ...
  /**
   * Loads the content definition for a given type creating a new resource according to the new link
   * and model file parameter.
   *
   * <p>
   *
   * @param entityId the entity id/URI
   ...
   * @param editHandlerData the edit handler data, if an edit handler is used for creating a new
   ...
   *
   * <p>This will load the entity representation of a new locale node.
   *
   * <p>
   *
   * @param entityId the entity id/URI
