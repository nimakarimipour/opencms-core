...
public class CmsVfsSitemapService extends CmsGwtService implements I_CmsSitemapService {
  ...
  public static final List<String> FILTER_PROPERTIES =
      Arrays.asList(
          new String[] {
  ...
  private static CmsAliasImportResponseTable aliasImportResponseTable =
      new CmsAliasImportResponseTable();
  ...
  private static final String SUB_LEVEL_REDIRECT_COPY_PAGE =
      "/system/modules/org.opencms.base/copyresources/sub-level-redirect.html";
  ...
  public static CmsClientProperty createClientProperty(CmsProperty prop, boolean preserveOrigin) {
    ...
    CmsClientProperty result =
        new CmsClientProperty(prop.getName(), prop.getStructureValue(), prop.getResourceValue());
    if (preserveOrigin) {
   ...
   */
  public static CmsSitemapData prefetch(HttpServletRequest request, String sitemapUri)
  ...
  /**
   * Converts a sequence of properties to a map of client-side property beans.
   *
   * <p>
   *
   * @param props the sequence of properties
   * @param preserveOrigin if true, the origin of the properties should be copied to the client
   *     properties
   * @return the map of client properties
   */
  static Map<String, CmsClientProperty> createClientProperties(
      Iterable<CmsProperty> props, boolean preserveOrigin) {
  ...
  /**
   * @see org.opencms.ade.sitemap.shared.rpc.I_CmsSitemapService#changeCategory(java.lang.String,
   *     org.opencms.util.CmsUUID, java.lang.String, java.lang.String)
   */
  public void changeCategory(String entryPoint, CmsUUID id, @RUntainted String title, @RUntainted String name)
      throws CmsRpcException {
    ...
    try {
      name =
          OpenCms.getResourceManager()
              .getFileTranslator()
              .translateResource(name.trim().replace('/', '-'));
      ...
      cms.writePropertyObject(
          sitePath, new CmsProperty(CmsPropertyDefinition.PROPERTY_TITLE, title, null));
      if (!CmsStringUtil.joinPaths("/", newPath, "/")
          .equals(CmsStringUtil.joinPaths("/", sitePath, "/"))) {
  ...
  /**
   * @see org.opencms.ade.sitemap.shared.rpc.I_CmsSitemapService#createCategory(java.lang.String,
   *     org.opencms.util.CmsUUID, java.lang.String, java.lang.String)
   */
  public void createCategory(String entryPoint, CmsUUID id, @RUntainted String title, @RUntainted String name)
      throws CmsRpcException {
  ...
  /**
   * @see
   *     org.opencms.ade.sitemap.shared.rpc.I_CmsSitemapService#createNewGalleryFolder(java.lang.String,
   *     java.lang.String, int)
   */
  public CmsGalleryFolderEntry createNewGalleryFolder(
      @RUntainted String parentFolder, @RUntainted String title, int folderTypeId) throws CmsRpcException {
    ...
    try {
      ...
      folderName =
          OpenCms.getResourceManager()
              .getNameGenerator()
              .getUniqueFileName(cms, parentFolder, folderName);
      String folderPath = CmsStringUtil.joinPaths(parentFolder, folderName);

      @SuppressWarnings("deprecation")
      CmsResource galleryFolder =
          cms.createResource(
              folderPath,
              folderTypeId,
              null,
              Collections.singletonList(
                  new CmsProperty(CmsPropertyDefinition.PROPERTY_TITLE, title, null)));
      folderEntry =
  ...
  /**
   * @see
   *     org.opencms.ade.sitemap.shared.rpc.I_CmsSitemapService#createNewModelPage(java.lang.String,
   *     java.lang.String, java.lang.String, org.opencms.util.CmsUUID, boolean)
   */
  public CmsModelPageEntry createNewModelPage(
      String entryPointUri, String title, String description, CmsUUID copyId, boolean isModelGroup)
      throws CmsRpcException {
    ...
    try {
      ...
      CmsModelPageEntry result =
          helper.createModelPageEntry(page, false, false, getWorkplaceLocale());
  ...
  /**
   * @see
   *     org.opencms.ade.sitemap.shared.rpc.I_CmsSitemapService#createSubSitemap(org.opencms.util.CmsUUID)
   */
  public CmsSitemapChange createSubSitemap(CmsUUID entryId) throws CmsRpcException {
    ...
    try {
      ...
      CmsClientSitemapEntry entry =
          toClientEntry(
              getNavBuilder()
                  .getNavigationForResource(sitePath, CmsResourceFilter.ONLY_VISIBLE_NO_DELETED),
              false);
      clipboard.addModified(entry);
      setClipboardData(clipboard);
      CmsSitemapChange result =
          new CmsSitemapChange(entry.getId(), entry.getSitePath(), ChangeType.modify);
  ...
  /**
   * @see org.opencms.ade.sitemap.shared.rpc.I_CmsSitemapService#disableModelPage(java.lang.String,
   *     org.opencms.util.CmsUUID, boolean)
   */
  public void disableModelPage(String baseUri, CmsUUID modelPageId, @RUntainted boolean disabled)
      throws CmsRpcException {
  ...
  /**
   * @see
   *     org.opencms.ade.sitemap.shared.rpc.I_CmsSitemapService#editAttributeData(org.opencms.util.CmsUUID)
   */
  public CmsSitemapAttributeData editAttributeData(CmsUUID rootId) throws CmsRpcException {
    ...
    try {
      ...
      CmsADEConfigData config =
          OpenCms.getADEManager().lookupConfiguration(cms, root.getRootPath());
      ...
      Map<String, CmsXmlContentProperty> definitions =
          config.getAttributeEditorConfiguration().getAttributeDefinitions();
      cms.getRequestContext()
          .setAttribute(CmsRequestContext.ATTRIBUTE_ADE_CONTEXT_PATH, configResource.getRootPath());
      definitions =
          CmsXmlContentPropertyHelper.resolveMacrosInProperties(
              definitions, CmsMacroResolver.newWorkplaceLocaleResolver(cms));
      ...
      CmsSitemapAttributeData result =
          new CmsSitemapAttributeData(configInfo, definitions, values, unlockUrl);
      return result;
    } catch (Exception e) {
      error(e);
      return null;
  ...
  /**
   * @see
   *     org.opencms.ade.sitemap.shared.rpc.I_CmsSitemapService#getAliasImportResult(java.lang.String)
   */
  ...
  public CmsAliasInitialFetchResult getAliasTable() throws CmsRpcException {
    ...
    try {
      ...
      List<CmsAlias> aliases =
          aliasManager.getAliasesForSite(cms, cms.getRequestContext().getSiteRoot());
      ...
      List<CmsRewriteAlias> rewriteAliases =
          aliasManager.getRewriteAliases(cms, cms.getRequestContext().getSiteRoot());
      ...
      for (CmsRewriteAlias rewriteAlias : rewriteAliases) {
        CmsRewriteAliasTableRow rewriteRow =
            new CmsRewriteAliasTableRow(
                rewriteAlias.getId(),
      ...
      result.setDownloadUrl(
          OpenCms.getLinkManager().substituteLinkForRootPath(cms, ALIAS_DOWNLOAD_PATH));
      return result;
    } catch (Throwable e) {
      error(e);
      return null;
    ...
    try {
      ...
      List<CmsCategoryTreeEntry> entries =
          CmsCoreService.getCategoriesForSitePathStatic(
              cms, entryPoint, cms.getRequestContext().removeSiteRoot(basePath));
  ...
  public CmsClientSitemapEntry getChildren(String entryPointUri, CmsUUID entryId, int levels)
    ...
    try {
      ...
      CmsJspNavElement navElement =
          getNavBuilder().getNavigationForResource(root, CmsResourceFilter.ONLY_VISIBLE_NO_DELETED);
  ...
  public Map<CmsGalleryType, List<CmsGalleryFolderEntry>> getGalleryData(String entryPointUri) {
    ...
    List<String> subSitePaths =
        OpenCms.getADEManager()
            .getSubSitePaths(
                getCmsObject(), getCmsObject().getRequestContext().addSiteRoot(entryPointUri));
    List<CmsGalleryType> galleryTypes = collectGalleryTypes();
    Map<CmsGalleryType, List<CmsGalleryFolderEntry>> result =
        new HashMap<CmsGalleryType, List<CmsGalleryFolderEntry>>();
  ...
  /**
   * @see
   *     org.opencms.ade.sitemap.shared.rpc.I_CmsSitemapService#getModelInfos(org.opencms.util.CmsUUID)
   */
  ...
  /**
   * @see
   *     org.opencms.ade.sitemap.shared.rpc.I_CmsSitemapService#getResourceLink(org.opencms.util.CmsUUID,
   *     java.lang.String)
   */
  public String getResourceLink(CmsUUID baseId, String sitePath) throws CmsRpcException {
    ...
    try {
      ...
      @RUntainted Locale locale = CmsJspTagLink.getBaseUriLocale(cms, contextPath);
      if (locale != null) {
  ...
  /**
   * @see
   *     org.opencms.ade.sitemap.shared.rpc.I_CmsSitemapService#loadPropertyDataForLocaleCompareView(org.opencms.util.CmsUUID,
   *     org.opencms.util.CmsUUID)
   */
  public CmsLocaleComparePropertyData loadPropertyDataForLocaleCompareView(
      CmsUUID id, CmsUUID rootId) throws CmsRpcException {
    ...
    try {
      ...
      Map<String, CmsClientProperty> clientDefaultFileProps =
          createClientProperties(defaultFileProps, true);
      ...
      List<CmsResource> resourcesInSameFolder =
          cms.readResources(parent, CmsResourceFilter.ALL, false);
      ...
      result.setInheritedProperties(
          createClientProperties(cms.readPropertyObjects(parent, true), true));
      result.setPath(resource.getRootPath());
      String name =
          CmsFileUtil.removeTrailingSeparator(CmsResource.getName(resource.getRootPath()));
      result.setName(name);
      result.setHasEditableName(
          !CmsStringUtil.isEmptyOrWhitespaceOnly(name) && blockingLocked.isEmpty());
      return result;
    } catch (Exception e) {
      error(e);
      return null;
  ...
  /**
   * @see org.opencms.ade.sitemap.shared.rpc.I_CmsSitemapService#mergeSubSitemap(java.lang.String,
   *     org.opencms.util.CmsUUID)
   */
  @SuppressWarnings("deprecation")
  public CmsSitemapChange mergeSubSitemap(String entryPoint, CmsUUID subSitemapId)
      throws CmsRpcException {

    CmsObject cms = getCmsObject();
    try {
      ensureSession();
      CmsResource subSitemapFolder =
          cms.readResource(subSitemapId, CmsResourceFilter.ONLY_VISIBLE_NO_DELETED);
      ensureLock(subSitemapFolder);
      ...
      cms.writeResource(subSitemapFolder);
      String sitePath = cms.getSitePath(subSitemapFolder);
      String sitemapConfigName =
          CmsStringUtil.joinPaths(
              sitePath, CmsADEManager.CONTENT_FOLDER_NAME, CmsADEManager.CONFIG_FILE_NAME);
          ...
          toClientEntry(
              getNavBuilder()
                  .getNavigationForResource(
                      cms.getSitePath(subSitemapFolder), CmsResourceFilter.ONLY_VISIBLE_NO_DELETED),
              false);
      clipboard.addModified(entry);
      setClipboardData(clipboard);
  ...
  public CmsSitemapData prefetch(String sitemapUri) throws CmsRpcException {
    ...
    try {
      ...
      CmsQuickLaunchLocationCache.getLocationCache(getRequest().getSession())
          .setSitemapEditorLocation(cms.getRequestContext().getSiteRoot(), openPath);
      CmsADEConfigData configData =
          OpenCms.getADEManager()
              .lookupConfiguration(cms, cms.getRequestContext().addSiteRoot(openPath));
      ...
      propertyConfig =
          CmsXmlContentPropertyHelper.resolveMacrosInProperties(
              propertyConfig, CmsMacroResolver.newWorkplaceLocaleResolver(getCmsObject()));

      Map<String, CmsClientProperty> parentProperties =
          generateParentProperties(configData.getBasePath());
      ...
      @RUntainted String parentSitemap = null;

      if (configData.getBasePath() != null) {
        CmsADEConfigData parentConfigData =
            OpenCms.getADEManager()
                .lookupConfiguration(cms, CmsResource.getParentFolder(configData.getBasePath()));
      ...
      boolean isOnlineProject =
          CmsProject.isOnlineProject(cms.getRequestContext().getCurrentProject().getUuid());
      ...
      try {
        ...
        CmsResource baseDir =
            rootCms.readResource(
                configData.getBasePath(), CmsResourceFilter.ONLY_VISIBLE_NO_DELETED);
        CmsProperty galleryFolderProp =
            cms.readPropertyObject(baseDir, CmsPropertyDefinition.PROPERTY_GALLERIES_FOLDER, true);
      ...
      if (!isOnlineProject) {
        ...
        CmsFormatterConfigurationCacheState formatterState =
            OpenCms.getADEManager()
                .getCachedFormatters(cms.getRequestContext().getCurrentProject().isOnlineProject());
      ...
      if (isOnlineProject) {
        noEdit =
            Messages.get()
                ...
                .key(Messages.GUI_SITEMAP_NO_EDIT_ONLINE_0);
      }
      ...
      String aliasImportUrl =
          OpenCms.getLinkManager().substituteLinkForRootPath(cms, ALIAS_IMPORT_PATH);
      ...
      EditorMode editorMode =
          CmsADESessionCache.getCache(getRequest(), getCmsObject()).getSitemapEditorMode();
      if ((editorMode == null) || (editorMode == EditorMode.compareLocales)) {
        editorMode = EditorMode.navigation;
      }

      @RUntainted String basePath = configData.getBasePath();
      ...
      Boolean showModelEditConfirm =
          (Boolean) getRequest().getSession().getAttribute(ATTR_SHOW_MODEL_EDIT_CONFIRM);
      if (showModelEditConfirm == null) {
        showModelEditConfirm = Boolean.TRUE;
      }
      boolean showLocaleComparison =
      ...
      result =
          new CmsSitemapData(
              ...
              CmsCoreService.getContextMenuEntries(
                  cms, configData.getResource().getStructureId(), AdeContext.sitemapeditor),
              parentProperties,
              allPropNames,
              exportRfsPrefix,
              isSecure,
              ...
              aliasImportUrl,
              canEditAliases,
              OpenCms.getWorkplaceManager().getDefaultUserSettings().getSubsitemapCreationMode()
                  == CmsDefaultUserSettings.SubsitemapCreationMode.createfolder,
  ...
  /**
   * @see
   *     org.opencms.ade.sitemap.shared.rpc.I_CmsSitemapService#prepareReloadSitemap(org.opencms.util.CmsUUID,
  ...
  public String prepareReloadSitemap(CmsUUID rootId, EditorMode mode) throws CmsRpcException {
    ...
    try {
      ...
      @RUntainted String targetRootPath = OpenCms.getADEManager().getSubSiteRoot(cms, target.getRootPath());
  ...
  /**
   * @see org.opencms.ade.sitemap.shared.rpc.I_CmsSitemapService#removeModelPage(java.lang.String,
   *     org.opencms.util.CmsUUID)
   */
  ...
  /**
   * @see org.opencms.ade.sitemap.shared.rpc.I_CmsSitemapService#save(java.lang.String,
  ...
  /**
   * @see
   *     org.opencms.ade.sitemap.shared.rpc.I_CmsSitemapService#saveAliases(org.opencms.gwt.shared.alias.CmsAliasSaveValidationRequest)
   */
  ...
  /**
   * @see
   *     org.opencms.ade.sitemap.shared.rpc.I_CmsSitemapService#savePropertiesForLocaleCompareMode(org.opencms.util.CmsUUID,
  ...
  public void savePropertiesForLocaleCompareMode(
    ...
    try {
      ...
      try (AutoCloseable c =
          CmsLockUtil.withLockedResources(cms, shallow, ownRes, defaultFileRes)) {
  ...
  /**
   * @see
   *     org.opencms.ade.sitemap.shared.rpc.I_CmsSitemapService#saveSitemapAttributes(org.opencms.util.CmsUUID,
   *     java.util.Map)
   */
  public void saveSitemapAttributes(CmsUUID rootId, Map<String, String> attributes)
      throws CmsRpcException {
    ...
    try {
      ...
      CmsXmlContent configContent =
          CmsXmlContentFactory.unmarshal(cms, cms.readFile(configResource));
  ...
  /**
   * @see
   *     org.opencms.ade.sitemap.shared.rpc.I_CmsSitemapService#setDefaultModel(org.opencms.util.CmsUUID,
   *     org.opencms.util.CmsUUID)
   */
  public CmsModelInfo setDefaultModel(CmsUUID rootId, CmsUUID modelId) throws CmsRpcException {
    ...
    try {
      ...
      CmsResource rootResource = cms.readResource(rootId);
      CmsModelPageHelper modelPageHelper = new CmsModelPageHelper(getCmsObject(), rootResource);
      CmsResource configFile =
          OpenCms.getADEManager()
              .lookupConfiguration(cms, rootResource.getRootPath())
              .getResource();
  ...
  /**
   * @see
   *     org.opencms.ade.sitemap.shared.rpc.I_CmsSitemapService#setEditorMode(org.opencms.ade.sitemap.shared.CmsSitemapData.EditorMode)
   */
  ...
  /**
   * @see
   *     org.opencms.ade.sitemap.shared.rpc.I_CmsSitemapService#validateAliases(org.opencms.gwt.shared.alias.CmsAliasEditValidationRequest)
   */
  public CmsAliasEditValidationReply validateAliases(
  ...
  /**
   * @see
   *     org.opencms.ade.sitemap.shared.rpc.I_CmsSitemapService#validateRewriteAliases(org.opencms.gwt.shared.alias.CmsRewriteAliasValidationRequest)
   */
  public CmsRewriteAliasValidationReply validateRewriteAliases(
  ...
  /**
   * Locks the given resource with a temporary, if not already locked by the current user. Will
   * throw an exception if the resource could not be locked for the current user.
   *
   * <p>
   *
   ...
   */
  protected CmsSitemapChange saveInternal(String entryPoint, CmsSitemapChange change)
      throws CmsException {
  ...
  /**
   * Removes unnecessary locales from a container page.
   *
   * <p>
   *
   ...
   * @throws CmsException if something goes wrong
   */
  void ensureSingleLocale(CmsXmlContainerPage containerPage, CmsResource localeRes)
      throws CmsException {
  ...
  /**
   * Gets the properties of a resource as a map of client properties.
   *
   * <p>
   *
  ...
  /**
   * Adds a function detail element to a container page.
   *
   * <p>
   *
   * @param cms the current CMS context
   * @param page the container page which should be changed
   * @param containerName the name of the container which should be used for function detail
   *     elements
  ...
  private void addFunctionDetailElement(
      ...
      if (isDetailTarget && !foundContainer) {
        ...
        CmsContainerElementBean newElement =
            new CmsContainerElementBean(
                elementId, formatterId, new HashMap<String, String>(), false);
    ...
    if (!foundContainer) {
      throw new CmsException(
          Messages.get()
              .container(
                  Messages.ERR_NO_FUNCTION_DETAIL_CONTAINER_1, page.getFile().getRootPath()));
    }
    CmsContainerPageBean bean2 =
        new CmsContainerPageBean(new ArrayList<CmsContainerBean>(containerBeans));
    page.writeContainerPage(cms, bean2);
  }

  /**
   * Applys the given change to the VFS.
   *
   * <p>
   *
   ...
   * @throws CmsException if something goes wrong
   */
  private CmsSitemapChange applyChange(String entryPoint, CmsSitemapChange change)
      throws CmsException {
    ...
    if (change.hasDetailPageInfos()) {
      CmsADEConfigData configData =
          OpenCms.getADEManager()
              .lookupConfiguration(cms, cms.getRequestContext().addSiteRoot(entryPoint));
    ...
    if (change.hasDetailPageInfos() && (configFile != null)) {
      saveDetailPages(
          change.getDetailPageInfos(), configFile, change.getEntryId(), change.getUpdatedEntry());
      tryUnlock(configFile);
    }
  ...
  /**
   * Changes the navigation for a moved entry and its neighbors.
   *
   * <p>
   *
   ...
   * @throws CmsException if something goes wrong
   */
  private void applyNavigationChanges(CmsSitemapChange change, CmsResource entryFolder)
      throws CmsException {
    ...
    List<CmsJspNavElement> navElements =
        getNavBuilder()
            .getNavigationForFolder(
                parentPath, Visibility.all, CmsResourceFilter.ONLY_VISIBLE_NO_DELETED);
    CmsSitemapNavPosCalculator npc =
        new CmsSitemapNavPosCalculator(navElements, entryFolder, change.getPosition());
    ...
    try {
      ...
      for (CmsJspNavElement nav : navs) {
        CmsProperty property =
            new CmsProperty(CmsPropertyDefinition.PROPERTY_NAVPOS, "" + nav.getNavPosition(), null);
  ...
  /**
   * Builds the list info bean for a resource type which can be used as a sub-sitemap folder.
   *
   * <p>
   *
  ...
  /**
   * Returns all available gallery folder resource types.
   *
   * <p>
   *
            ...
            if (A_CmsAjaxGallery.class.isAssignableFrom(Class.forName(folderClassName))) {
              ...
              gallery.setSubTitle(
                  CmsWorkplaceMessages.getResourceTypeDescription(
                      wpLocale, resourceType.getTypeName()));
  ...
  /**
   * Gets the information for the available sitemap folder types.
   *
   * <p>
   *
   * @param cms the current CMS context
   ...
   */
  private List<CmsListInfoBean> collectSitemapTypeInfos(
      CmsObject cms, CmsADEConfigData configData) {
    ...
    @RUntainted String checkPath = configData.getBasePath();
    if (checkPath != null) {
    ...
    for (Integer typeId : sitemapTypeIds) {
      try {
        I_CmsResourceType sitemapType =
            OpenCms.getResourceManager().getResourceType(typeId.intValue());
        String typeName = sitemapType.getTypeName();
        ...
        LOG.warn(
            "Could not read sitemap folder type " + typeId + ": " + e.getLocalizedMessage(), e);
      }
    }
  ...
  /**
   * Creates a client alias bean from a server-side alias.
   *
   * <p>
   *
   * @param cms the current CMS context
   ...
   * @throws CmsException if something goes wrong
   */
  private CmsAliasTableRow createAliasTableEntry(CmsObject cms, CmsAlias alias)
      throws CmsException {
  ...
  /**
   * Creates a navigation level type info.
   *
   * <p>
   *
  ...
  private CmsNewResourceInfo createNavigationLevelTypeInfo() throws CmsException {
    ...
    @RUntainted String name = CmsResourceTypeFolder.getStaticTypeName();
    Locale locale = getWorkplaceLocale();
    String subtitle =
        Messages.get()
            .getBundle(getWorkplaceLocale())
            .key(Messages.GUI_NAVIGATION_LEVEL_SUBTITLE_0);
    if (CmsStringUtil.isEmptyOrWhitespaceOnly(subtitle)) {
      subtitle = CmsWorkplaceMessages.getResourceTypeName(locale, name);
    }
    CmsNewResourceInfo result =
        new CmsNewResourceInfo(
            CmsResourceTypeFolder.getStaticTypeId(),
            name,
            Messages.get()
                .getBundle(getWorkplaceLocale())
                .key(Messages.GUI_NAVIGATION_LEVEL_TITLE_0),
            subtitle,
  ...
  /**
   * Creates new content elements if required by the model page.
   *
   * <p>
   *
   ...
   */
  private boolean createNewContainerElements(
      CmsObject cms, CmsMutableContainerPage page, @RUntainted String sitePath) throws CmsException {

    boolean needsChanges = false;
    CmsADEConfigData configData =
        OpenCms.getADEManager().lookupConfiguration(cms, cms.addSiteRoot(sitePath));
    @RUntainted Locale contentLocale =
        OpenCms.getLocaleManager().getDefaultLocale(cms, CmsResource.getFolderPath(sitePath));
    ...
    for (CmsMutableContainer container : page.containers()) {
      ...
      while (iter.hasNext()) {
        ...
        if (elem.isCreateNew() && !elem.isGroupContainer(cms) && !elem.isInheritedContainer(cms)) {
          String typeName =
              OpenCms.getResourceManager().getResourceType(elem.getResource()).getTypeName();
    ...
    for (CmsContainerBean container : pageBean.getContainers().values()) {
      ...
      for (CmsContainerElementBean element : container.getElements()) {
        if (element.isCreateNew()
            && !element.isGroupContainer(cms)
            && !element.isInheritedContainer(cms)) {
          needsChanges = true;
          String typeName =
  ...
  /**
   * Creates a new page in navigation.
   *
   * <p>
   *
   ...
   */
  @SuppressWarnings("deprecation")
  private CmsClientSitemapEntry createNewEntry(String entryPoint, CmsSitemapChange change)
      throws CmsException {
    ...
    if (change.getParentId() != null) {
      CmsResource parentFolder =
          cms.readResource(change.getParentId(), CmsResourceFilter.ONLY_VISIBLE_NO_DELETED);
      String entryPath = "";
      ...
      if (change.getNewCopyResourceId() != null) {
        copyPage =
            cms.readResource(
                change.getNewCopyResourceId(), CmsResourceFilter.ONLY_VISIBLE_NO_DELETED);
      ...
      if (isRedirectType(change.getNewResourceTypeId())) {
        ...
        String entryFolderPath =
            CmsStringUtil.joinPaths(cms.getSitePath(parentFolder), change.getName() + "/");
        ...
        if (isContainerPage && (copyPage != null)) {
          ...
          // do *NOT* get this from the cache, because we perform some destructive operation on the
          // XML content
          CmsXmlContainerPage page =
              CmsXmlContainerPageFactory.unmarshal(cms, cms.readFile(copyPage), true, true);
          ...
          if (isFunctionDetail) {
            ...
            if (functionDetailContainer != null) {
              @RUntainted CmsUUID functionStructureId = new CmsUUID(change.getCreateParameter());
              CmsResource functionRes =
                  cms.readResource(functionStructureId, CmsResourceFilter.IGNORE_EXPIRATION);
              CmsResource functionFormatter;
              if (OpenCms.getResourceManager()
                  .matchResourceType(
                      CmsResourceTypeFunctionConfig.TYPE_NAME, functionRes.getTypeId())) {
      ...
      if (newEntry == null) {
        newEntry =
            toClientEntry(
                getNavBuilder()
                    .getNavigationForResource(
                        cms.getSitePath(newRes), CmsResourceFilter.ONLY_VISIBLE_NO_DELETED),
                false);
      }
  ...
  /**
   * Creates a new resource info to a given model page resource.
   *
   * <p>
   *
   * @param cms the current CMS context
   ...
   * @throws CmsException if something goes wrong
   */
  private CmsNewResourceInfo createNewResourceInfo(
      CmsObject cms, CmsResource modelResource, Locale locale) throws CmsException {
    ...
    if (!cms.existsResource(
      ...
      modelResource =
          cms.readResource(
              cms.getSitePath(modelResource), CmsResourceFilter.ONLY_VISIBLE_NO_DELETED);
    }
    int typeId = modelResource.getTypeId();
    String name = OpenCms.getResourceManager().getResourceType(typeId).getTypeName();
    String title =
        cms.readPropertyObject(modelResource, CmsPropertyDefinition.PROPERTY_TITLE, false, locale)
            .getValue();
    String description =
        cms.readPropertyObject(
                modelResource, CmsPropertyDefinition.PROPERTY_DESCRIPTION, false, locale)
            .getValue();

    boolean editable = false;
    try {
      CmsResource freshModelResource =
          cms.readResource(
              modelResource.getStructureId(), CmsResourceFilter.ONLY_VISIBLE_NO_DELETED);
      editable =
          cms.hasPermissions(
              freshModelResource, CmsPermissionSet.ACCESS_WRITE, false, CmsResourceFilter.DEFAULT);
    } catch (CmsException e) {
      LOG.warn(e.getLocalizedMessage(), e);
    }
    CmsNewResourceInfo info =
        new CmsNewResourceInfo(
            typeId,
            name,
            title,
    ...
    Float navpos = null;
    try {
      CmsProperty navposProp =
          cms.readPropertyObject(modelResource, CmsPropertyDefinition.PROPERTY_NAVPOS, true);
    ...
    info.setDate(
        CmsDateUtil.getDate(
            new Date(modelResource.getDateLastModified()), DateFormat.LONG, getWorkplaceLocale()));
    info.setVfsPath(modelResource.getRootPath());
    return info;
  }

  /**
   * Creates a resource type info bean for a given resource type.
   *
   * <p>
   *
   ...
   */
  @SuppressWarnings("deprecation")
  private CmsNewResourceInfo createResourceTypeInfo(
      I_CmsResourceType resType, CmsResource copyResource) {
  ...
  /**
   * Helper method for creating the .content folder of a sub-sitemap.
   *
   * <p>
   *
   * @param cms the current CMS context
  ...
  /**
   * Deletes a resource according to the change data.
   *
   * <p>
   *
  ...
  /**
   * Generates a client side lock info object representing the current lock state of the given
   * resource.
   *
   * <p>
   *
  ...
  private CmsClientLock generateClientLock(CmsResource resource) throws CmsException {
    ...
    if (!lock.isUnlocked() && (ownerId != null)) {
      clientLock.setLockOwner(
          cms.readUser(ownerId).getDisplayName(cms, cms.getRequestContext().getLocale()));
  ...
  /**
   * Generates a list of property object to save to the sitemap entry folder to apply the given
   * change.
   *
   * <p>
   *
   ...
   */
  private List<CmsProperty> generateInheritProperties(
      CmsSitemapChange change, CmsResource entryFolder) {
  ...
  /**
   * Generates a list of property object to save to the sitemap entry resource to apply the given
   * change.
   *
   * <p>
   *
  ...
  /**
   * Generates a list of property values inherited to the site-map root entry.
   *
   * <p>
   *
   ...
   */
  private Map<String, CmsClientProperty> generateParentProperties(@RUntainted String rootPath)
      throws CmsException {
  ...
  /**
   * Returns the sitemap children for the given path with all descendants up to the given level or
   * to the given target path, ie.
   *
   * <dl>
   *   <dt>levels=1
   *   <dd>only children
   *   <dt>levels=2
   *   <dd>children and great children
   * </dl>
   *
   * and so on.
   *
   ...
   */
  private List<CmsClientSitemapEntry> getChildren(@RUntainted String root, int levels, String targetPath) {
    ...
    for (CmsJspNavElement navElement :
        getNavBuilder()
            .getNavigationForFolder(
                root, Visibility.all, CmsResourceFilter.ONLY_VISIBLE_NO_DELETED)) {
      try {
        ...
        if (child != null) {
          ...
          if ((nextLevels == 2)
              && (targetPath != null)
              && targetPath.startsWith(child.getSitePath())) {
            nextLevels = 3;
          }
          if (child.isFolderType()
              && ((nextLevels > 1) || (nextLevels == -1))
              && !isSubSitemap(navElement)) {
  ...
  /**
   * Returns the clipboard data from the current user.
   *
   * <p>
   *
  ...
  /**
   * Returns the deleted list from the current user.
   *
   * <p>
   *
  ...
  private LinkedHashMap<CmsUUID, CmsClientSitemapEntry> getDeletedList() {
    ...
    LinkedHashMap<CmsUUID, CmsClientSitemapEntry> result =
        new LinkedHashMap<CmsUUID, CmsClientSitemapEntry>();
            ...
            if (res.getState().isDeleted()) {
              ...
              delEntry.setNavModeIcon(
                  CmsIconUtil.getIconClasses(
                      delEntry.getResourceTypeName(), delEntry.getVfsPath(), false));
  ...
  private String getFunctionDetailContainerName(CmsResource parent) {
    ...
    String containerInfo =
        OpenCms.getTemplateContextManager()
            .readPropertyFromTemplate(
                cms, parent, CmsPropertyDefinition.PROPERTY_CONTAINER_INFO, notFound);
  ...
  /**
   * Returns the galleries of the given sub site for the requested gallery type.
   *
   * <p>
   *
  ...
  private List<CmsGalleryFolderEntry> getGalleriesForType(
      String entryPointUri, CmsGalleryType galleryType, List<String> subSitePaths)
      throws CmsException {

    List<CmsGalleryFolderEntry> galleries = new ArrayList<CmsGalleryFolderEntry>();
    @SuppressWarnings("deprecation")
    List<CmsResource> galleryFolders =
        getCmsObject()
            .readResources(
                entryPointUri,
    ...
    Collections.sort(
        galleries,
        new Comparator<CmsGalleryFolderEntry>() {
  ...
  /**
   * Returns the modified list from the current user.
   *
   * <p>
   *
  ...
  /**
   * Returns a navigation builder reference.
   *
   * <p>
   *
  ...
  /**
   * Returns the new resource infos.
   *
   * <p>
   *
   * @param cms the current CMS context
   ...
   */
  private List<CmsNewResourceInfo> getNewResourceInfos(
      CmsObject cms, CmsADEConfigData configData, Locale locale) {
    ...
    Collections.sort(
        result,
        new Comparator<CmsNewResourceInfo>() {

          public int compare(CmsNewResourceInfo a, CmsNewResourceInfo b) {

            return ComparisonChain.start()
                .compareTrueFirst(a.isDefault(), b.isDefault())
                .compare(a.getNavPos(), b.getNavPos(), Ordering.natural().nullsLast())
                .result();
          }
        });
    return result;
  ...
  /**
   * Gets the resource type info beans for types for which new detail pages can be created.
   *
   * <p>
   *
   * @param cms the current CMS context
  ...
  private List<CmsNewResourceInfo> getResourceTypeInfos(
    ...
    if (modelResource != null) {
      defaultPageInfo =
          new CmsNewResourceInfo(
              ...
              Messages.get()
                  .getBundle(getWorkplaceLocale())
                  .key(Messages.GUI_DEFAULT_DETAIL_PAGE_TITLE_0),
              Messages.get()
                  .getBundle(getWorkplaceLocale())
                  .key(Messages.GUI_DEFAULT_DETAIL_PAGE_DESCRIPTION_0),
              modelResource.getStructureId(),
              false,
              Messages.get()
                  .getBundle(getWorkplaceLocale())
    ...
    defaultPageInfo.setBigIconClasses(
        CmsIconUtil.getIconClasses(
            CmsResourceTypeXmlContainerPage.getStaticTypeName(), null, false));
    ...
    for (CmsFunctionReference functionRef : functionReferences) {
      ...
      try {
        ...
        String description =
            cms.readPropertyObject(functionRes, CmsPropertyDefinition.PROPERTY_DESCRIPTION, false)
                .getValue();
        String subtitle = description;
        try {
          CmsGallerySearchResult searchResult =
              CmsGallerySearch.searchById(cms, functionRef.getStructureId(), getWorkplaceLocale());
  ...
  /**
   * Returns the sitemap info for the given base path.
   *
   * <p>
   *
  ...
  private CmsSitemapInfo getSitemapInfo(@RUntainted String basePath) throws CmsException {
    ...
    String title =
        cms.readPropertyObject(baseFolder, CmsPropertyDefinition.PROPERTY_TITLE, false).getValue();
    if (CmsStringUtil.isEmptyOrWhitespaceOnly(title) && (defaultFile != null)) {
      title =
          cms.readPropertyObject(defaultFile, CmsPropertyDefinition.PROPERTY_TITLE, false)
              .getValue();
    }
    String description =
        cms.readPropertyObject(baseFolder, CmsPropertyDefinition.PROPERTY_DESCRIPTION, false)
            .getValue();
    if (CmsStringUtil.isEmptyOrWhitespaceOnly(description) && (defaultFile != null)) {
      description =
          cms.readPropertyObject(defaultFile, CmsPropertyDefinition.PROPERTY_DESCRIPTION, false)
              .getValue();
    }
  ...
  private @RUntainted int getSubsitemapType() throws CmsRpcException {
    ...
    try {
      return OpenCms.getResourceManager()
          .getResourceType(CmsResourceTypeFolderSubSitemap.TYPE_SUBSITEMAP)
          .getTypeId();
    } catch (CmsLoaderException e) {
      error(e);
    }
  ...
  /**
   * Checks whether the sitemap change has default file changes.
   *
   * <p>
   *
  ...
  /**
   * Checks whether the sitemap change has changes for the sitemap entry resource.
   *
   * <p>
   *
   * @param change the sitemap change
  ...
  /**
   * Checks whether a resource is a default file of a folder.
   *
   * <p>
   *
  ...
  /**
   * Checks if the toolbar should be displayed.
   *
   * <p>
   *
  ...
  /**
   * Returns if the given type id matches the xml-redirect resource type.
   *
   * <p>
   *
  ...
  private boolean isRedirectType(int typeId) {
    ...
    try {
      return typeId
          == OpenCms.getResourceManager().getResourceType(RECOURCE_TYPE_NAME_REDIRECT).getTypeId();
    } catch (Exception e) {
      return false;
    }
  }
  ...
  /**
   * Returns if the given nav-element resembles a sub-sitemap entry-point.
   *
   * <p>
   *
   * @param navElement the nav-element
   * @return <code>true</code> if the given nav-element resembles a sub-sitemap entry-point.
   *     <p>
   */
  ...
  /**
   * Checks if the given open path is valid.
   *
   * <p>
   *
   * @param cms the cms context
   ...
   */
  private boolean isValidOpenPath(CmsObject cms, @RUntainted String openPath) {
  ...
  /**
   * Returns if the given return code is valid.
   *
   * <p>
   *
  ...
  /**
   * Applys the given changes to the entry.
   *
   * <p>
   *
  ...
  private void modifyEntry(CmsSitemapChange change) throws CmsException {
    ...
    try {
      ...
      if (hasOwnChanges(change)) {
        ...
        boolean shallow =
            !change.hasChangedName() && !change.hasChangedPosition() && !change.hasNewParent();
      ...
      if (hasDefaultFileChanges(change)) {
        defaultFileRes =
            cms.readResource(change.getDefaultFileId(), CmsResourceFilter.ONLY_VISIBLE_NO_DELETED);
      ...
      if (entryFolder != null) {
        if (change.hasNewParent() || change.hasChangedName()) {
          ...
          if (change.hasNewParent()) {
            CmsResource futureParent =
                cms.readResource(change.getParentId(), CmsResourceFilter.ONLY_VISIBLE_NO_DELETED);
            destinationPath =
                CmsStringUtil.joinPaths(cms.getSitePath(futureParent), change.getName());
          } else {
            destinationPath =
                CmsStringUtil.joinPaths(
          ...
          if (!CmsFileUtil.removeTrailingSeparator(cms.getSitePath(entryFolder))
              .equals(CmsFileUtil.removeTrailingSeparator(destinationPath))) {
            cms.moveResource(cms.getSitePath(entryFolder), destinationPath);
          }
          entryFolder =
              cms.readResource(
                  entryFolder.getStructureId(), CmsResourceFilter.ONLY_VISIBLE_NO_DELETED);
        }
      }
    } finally {
      if (entryPage != null) {
  ...
  /**
   * Reads the gallery folder properties.
   *
   * <p>
   *
   ...
   */
  private CmsGalleryFolderEntry readGalleryFolderEntry(CmsResource folder, String typeName)
      throws CmsException {
  ...
  /**
   * Helper method for removing all locales except one from a container page.
   *
   * <p>
   *
   ...
   */
  private void removeAllLocalesExcept(CmsXmlContainerPage page, Locale localeToKeep)
  ...
  /**
   * Applys the given remove change.
   *
   * <p>
   *
   * @param change the change to apply
  ...
  /**
   * Saves the detail page information of a sitemap to the sitemap's configuration file.
   *
   * <p>
   *
  ...
  /**
   * Saves the given clipboard data to the session.
   *
   * <p>
   *
  ...
  /**
   * Determines if the title property of the default file should be changed.
   *
   * <p>
   *
   ...
   */
  private boolean shouldChangeDefaultFileTitle(
      Map<String, CmsProperty> properties, CmsProperty folderNavtext) {
    ...
    return (properties == null)
        ...
        || ((folderNavtext != null)
            && properties
                .get(CmsPropertyDefinition.PROPERTY_TITLE)
                .getValue()
  ...
  /**
   * Converts a jsp navigation element into a client sitemap entry.
   *
   * <p>
   *
   ...
   * @throws CmsException if something goes wrong
   */
  private CmsClientSitemapEntry toClientEntry(CmsJspNavElement navElement, boolean isRoot)
      throws CmsException {
    ...
    if (defaultFileResource != null) {
      ...
      clientEntry.setDefaultFileType(
          OpenCms.getResourceManager()
              .getResourceType(defaultFileResource.getTypeId())
              .getTypeName());
      clientEntry.setDefaultFileReleased(
          defaultFileResource.isReleasedAndNotExpired(System.currentTimeMillis()));
    } else {
    ...
    if (navElement.getResource().isFolder()) {
      ...
      if (!cms.getRequestContext().getCurrentProject().isOnlineProject()) {
        ...
        clientEntry.setBlockingLockedChildren(
            (blockingChildren != null) && !blockingChildren.isEmpty());
      }
    } else {
      ...
      if (isRedirectType(entryPage.getTypeId())) {
        ...
        I_CmsXmlContentValue linkValue =
            content.getValue(
                REDIRECT_LINK_TARGET_XPATH, getCmsObject().getRequestContext().getLocale());
        String link =
            linkValue != null
                ? linkValue.getStringValue(getCmsObject())
                : Messages.get()
                    .getBundle(getWorkplaceLocale())
                    .key(Messages.GUI_REDIRECT_SUB_LEVEL_0);
    ...
    if (entryPage.isFile()) {
      List<CmsAlias> aliases =
          OpenCms.getAliasManager()
              .getAliasesForStructureId(getCmsObject(), entryPage.getStructureId());
      if (!aliases.isEmpty()) {
    ...
    if (!clientEntry.isSubSitemapType()) {
      if (clientEntry.isNavigationLevelType()) {
        ...
        clientEntry.setNavModeIcon(
            CmsIconUtil.getIconClasses(
                clientEntry.getDefaultFileType(), defaultFileResource.getName(), false));
      }
    }
    clientEntry.setPermissionInfo(
        OpenCms.getADEManager().getPermissionInfo(cms, ownResource, null));
    return clientEntry;
  }

  /**
   * Un-deletes a resource according to the change data.
   *
   * <p>
   *
   * @param change the change data
  ...
  private CmsSitemapChange undelete(CmsSitemapChange change) throws CmsException {
    ...
    CmsJspNavElement navElement =
        getNavBuilder()
            .getNavigationForResource(parentPath, CmsResourceFilter.ONLY_VISIBLE_NO_DELETED);
  ...
  /**
   * Updates the navigation position for a resource.
   *
   * <p>
   *
  ...
  private void updateProperties(
    ...
    if (defaultFileRes != null) {
      ...
      changeDefaultFileTitle =
          shouldChangeDefaultFileTitle(
              defaultFileProps, ownProps.get(CmsPropertyDefinition.PROPERTY_NAVTEXT));
    }
