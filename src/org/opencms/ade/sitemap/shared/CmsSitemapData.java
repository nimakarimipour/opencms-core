...
public class CmsSitemapData implements IsSerializable {
   ...
   * @param isSecure true if there is a secure server configuration for the site which contains the
   *     sitemap
   ...
   * @param createNewFoldersForSubsitemaps flag to control whether new folders should be created for
   *     subsitemaps
  ...
  /**
   * Returns the path to the parent sitemap or <code>null</code>.
   *
   * <p>
   *
