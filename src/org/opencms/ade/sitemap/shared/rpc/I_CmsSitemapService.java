...
public interface I_CmsSitemapService extends RemoteService {
   ...
   * @throws CmsRpcException if something goes wrong
   */
  CmsClientSitemapEntry getChildren(String entryPointUri, CmsUUID entryId, int levels)
      throws CmsRpcException;
   ...
   * @throws CmsRpcException if something goes wrong
   */
  Map<CmsGalleryType, List<CmsGalleryFolderEntry>> getGalleryData(String entryPointUri)
      throws CmsRpcException;
   ...
   *
   * <p>This method may change the currently set site root. If the given root id is not in a valid
   * site, null will be returned, otherwise the URL which the client should use to reload the
   ...
   * @throws CmsRpcException if something goes wrong
   */
  CmsRewriteAliasValidationReply validateRewriteAliases(
      CmsRewriteAliasValidationRequest validationRequest) throws CmsRpcException;
}
