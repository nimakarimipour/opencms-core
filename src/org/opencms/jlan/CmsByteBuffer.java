...
public class CmsByteBuffer {
   ...
   *
   * <p>If the size is larger than the current size, the new space will be filled with 0s. Note that
   * the internal byte buffer will not be shrunk if the size is smaller than the current size.
   *
   * <p>
   *
  ...
  /**
   * Make sure that the internal byte buffer can store at least requestedCapacity of bytes by
  ...
  /**
   * Reallocates the internal byte buffer with a new capacity.
   *
   * <p>
   *
