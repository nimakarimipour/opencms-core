...
public class CmsJlanRepository implements I_CmsRepository {
   ...
   */
  public CmsObjectWrapper getCms(SrvSession session, TreeConnection connection)
      throws CmsException {
    ...
    result
        .getRequestContext()
        .setAttribute(JLAN_IGNORE_WRITE_ERRORS, Boolean.valueOf(m_ignoreWriteErrors));
    return result;
  }
  ...
  public void initConfiguration() throws CmsConfigurationException {
    ...
    List<I_CmsResourceWrapper> wrapperObjects =
        CmsRepositoryManager.createResourceWrappersFromConfiguration(
            getConfiguration(), PARAM_WRAPPER, LOG);
    ...
    m_ignoreWriteErrors =
        Boolean.parseBoolean(getConfiguration().getString(PARAM_IGNORE_WRITE_ERRORS, "false"));
  }
  ...
  /**
   * @see
   *     org.opencms.repository.I_CmsRepository#setFilter(org.opencms.repository.CmsRepositoryFilter)
   */
  ...
  public void setTranslation(CmsResourceTranslator translator, boolean enabled) {
    ...
    throw new UnsupportedOperationException(
        "file translations not supported for JLAN repositories");
  }

  /**
   * Gets the shared device for this repository.
   *
   * <p>
   *
