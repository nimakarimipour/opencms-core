 ...
 *
 * <p>This class, together with the CmsJlanNetworkFile class, contains the main repository access
 * functionality.
 *
 * <p>
 */
public class CmsJlanDiskInterface implements DiskInterface {
  ...
  /**
   * Converts a CIFS path to an OpenCms path by converting backslashes to slashes and translating
  ...
  protected static @RUntainted String getCmsPath(String path) {
    ...
    // split path into components, translate each of them separately, then combine them again at the
    // end
  ...
  /**
   * @see
   *     org.alfresco.jlan.server.filesys.DiskInterface#closeFile(org.alfresco.jlan.server.SrvSession,
   *     org.alfresco.jlan.server.filesys.TreeConnection,
   *     org.alfresco.jlan.server.filesys.NetworkFile)
   */
  public void closeFile(SrvSession session, TreeConnection connection, NetworkFile file)
      throws IOException {
  ...
  /**
   * @see org.alfresco.jlan.server.core.DeviceInterface#createContext(java.lang.String,
  ...
  /**
   * @see
   *     org.alfresco.jlan.server.filesys.DiskInterface#createDirectory(org.alfresco.jlan.server.SrvSession,
   *     org.alfresco.jlan.server.filesys.TreeConnection,
  ...
  /**
   * @see
   *     org.alfresco.jlan.server.filesys.DiskInterface#createFile(org.alfresco.jlan.server.SrvSession,
   *     org.alfresco.jlan.server.filesys.TreeConnection,
   *     org.alfresco.jlan.server.filesys.FileOpenParams)
   */
  public NetworkFile createFile(
      SrvSession session, TreeConnection connection, FileOpenParams params) throws IOException {
  ...
  /**
   * @see
   *     org.alfresco.jlan.server.filesys.DiskInterface#deleteDirectory(org.alfresco.jlan.server.SrvSession,
   *     org.alfresco.jlan.server.filesys.TreeConnection, java.lang.String)
   */
  public void deleteDirectory(SrvSession session, TreeConnection connection, String path)
      throws IOException {
  ...
  /**
   * @see
   *     org.alfresco.jlan.server.filesys.DiskInterface#deleteFile(org.alfresco.jlan.server.SrvSession,
   *     org.alfresco.jlan.server.filesys.TreeConnection, java.lang.String)
   */
  public void deleteFile(SrvSession session, TreeConnection connection, String path)
      throws IOException {

    // note: deletion of a file may not necessarily go through this method, instead the client
    // program may open the
    // file, set a "delete on close" flag, and then close it.
    try {
      CmsJlanNetworkFile file = getFileForPath(session, connection, path);
      if (file == null) {
        // Only log a warning, since if the file doesn't exist, it doesn't really need to be deleted
        // anymore
  ...
  /**
   * @see
   *     org.alfresco.jlan.server.filesys.DiskInterface#flushFile(org.alfresco.jlan.server.SrvSession,
   *     org.alfresco.jlan.server.filesys.TreeConnection,
   *     org.alfresco.jlan.server.filesys.NetworkFile)
   */
  public void flushFile(SrvSession session, TreeConnection connection, NetworkFile file)
      throws IOException {
  ...
  /**
   * @see
   *     org.alfresco.jlan.server.filesys.DiskInterface#getFileInformation(org.alfresco.jlan.server.SrvSession,
   *     org.alfresco.jlan.server.filesys.TreeConnection, java.lang.String)
   */
  ...
  /**
   * @see
   *     org.alfresco.jlan.server.filesys.DiskInterface#openFile(org.alfresco.jlan.server.SrvSession,
   *     org.alfresco.jlan.server.filesys.TreeConnection,
   *     org.alfresco.jlan.server.filesys.FileOpenParams)
   */
  ...
  /**
   * @see
   *     org.alfresco.jlan.server.filesys.DiskInterface#readFile(org.alfresco.jlan.server.SrvSession,
   *     org.alfresco.jlan.server.filesys.TreeConnection,
   *     org.alfresco.jlan.server.filesys.NetworkFile, byte[], int, int, long)
   */
  public int readFile(
      SrvSession sess,
      TreeConnection tree,
  ...
  /**
   * @see
   *     org.alfresco.jlan.server.filesys.DiskInterface#renameFile(org.alfresco.jlan.server.SrvSession,
   *     org.alfresco.jlan.server.filesys.TreeConnection, java.lang.String, java.lang.String)
   */
  public void renameFile(
      SrvSession session, TreeConnection connection, String oldName, String newName)
      throws IOException {
  ...
  /**
   * @see
   *     org.alfresco.jlan.server.filesys.DiskInterface#seekFile(org.alfresco.jlan.server.SrvSession,
   *     org.alfresco.jlan.server.filesys.TreeConnection,
   *     org.alfresco.jlan.server.filesys.NetworkFile, long, int)
   */
  public long seekFile(
      SrvSession session, TreeConnection connection, NetworkFile file, long pos, int seekMode)
      throws IOException {
  ...
  /**
   * @see
   *     org.alfresco.jlan.server.filesys.DiskInterface#setFileInformation(org.alfresco.jlan.server.SrvSession,
   *     org.alfresco.jlan.server.filesys.TreeConnection, java.lang.String,
  ...
  /**
   * @see
   *     org.alfresco.jlan.server.filesys.DiskInterface#startSearch(org.alfresco.jlan.server.SrvSession,
   *     org.alfresco.jlan.server.filesys.TreeConnection, java.lang.String, int)
   */
  public SearchContext startSearch(
      SrvSession session, TreeConnection connection, String searchPath, int searchAttributes) {
  ...
  /**
   * @see
   *     org.alfresco.jlan.server.core.DeviceInterface#treeClosed(org.alfresco.jlan.server.SrvSession,
   *     org.alfresco.jlan.server.filesys.TreeConnection)
   */
  ...
  /**
   * @see
   *     org.alfresco.jlan.server.core.DeviceInterface#treeOpened(org.alfresco.jlan.server.SrvSession,
   *     org.alfresco.jlan.server.filesys.TreeConnection)
   */
   ...
   *     org.alfresco.jlan.server.filesys.TreeConnection,
   *     org.alfresco.jlan.server.filesys.NetworkFile, long)
   */
  public void truncateFile(
      SrvSession session, TreeConnection connection, NetworkFile file, long size)
      throws IOException {
  ...
  /**
   * @see
   *     org.alfresco.jlan.server.filesys.DiskInterface#writeFile(org.alfresco.jlan.server.SrvSession,
   *     org.alfresco.jlan.server.filesys.TreeConnection,
   *     org.alfresco.jlan.server.filesys.NetworkFile, byte[], int, int, long)
   */
  ...
  protected CmsJlanNetworkFile getFileForPath(
      CmsObjectWrapper cms, SrvSession session, TreeConnection connection, String path)
      throws CmsException {
  ...
  protected NetworkFile internalCreateFile(
    ...
    try {
      ...
      CmsResource createdResource =
          cms.createResource(
              cmsPath, OpenCms.getResourceManager().getResourceType(typeName).getTypeId());
  ...
  /**
   * Tries to unlock the file at the given path.
   *
   * <p>
   *
   * @param cms the CMS context wrapper
