...
public class CmsJlanDiskInterface implements DiskInterface {
     ...
     */
    protected static String getCmsPath(@RUntainted String path) {
     ...
     */
    public void createDirectory(SrvSession session, TreeConnection connection, @RUntainted FileOpenParams params)
    throws IOException {
     ...
     */
    public NetworkFile createFile(SrvSession session, TreeConnection connection, @RUntainted FileOpenParams params)
    throws IOException {
     ...
     */
    public int fileExists(SrvSession session, TreeConnection connection, @RUntainted String path) {
     ...
     */
    public NetworkFile openFile(SrvSession session, TreeConnection connection, @RUntainted FileOpenParams params)
    throws IOException {
     ...
     */
    public void renameFile(SrvSession session, TreeConnection connection, String oldName, @RUntainted String newName)
    throws IOException {
     ...
     */
    public void setFileInformation(SrvSession session, TreeConnection connection, @RUntainted String path, FileInfo info)
    throws IOException {
     ...
     * @throws CmsException if something goes wrong
     */
    protected CmsJlanNetworkFile getFileForPath(SrvSession session, TreeConnection connection, @RUntainted String path)
    throws CmsException {
