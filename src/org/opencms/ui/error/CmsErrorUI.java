...
public class CmsErrorUI extends A_CmsUI {
   ...
   */
  public static String getBootstrapPage(
      CmsObject cms, Throwable throwable, HttpServletRequest request) {
    ...
    try {
      ...
      String vaadinServlet =
          CmsStringUtil.joinPaths(context, "workplace/", ERROR_PAGE_PATH_FRAQUMENT);
  ...
  /**
   * Sets the error attributes to the current session.
   *
   * <p>
   *
   * @param cms the cms context
    ...
    result
        .append(
            CmsVaadinUtils.getMessageText(
                org.opencms.ui.components.Messages.GUI_ERROR_DIALOG_MESSAGE_0))
        .append("<br />");
  ...
  /**
   * Reads the error attributes from current session.
   *
   * <p>
   */
