...
public final class Messages extends A_CmsMessageBundle {
  ...
  public static final String ERR_LOADING_BUNDLE_CMS_OBJECT_NULL_0 =
  ...
  /** Message constant for key in the resource bundle. */
  public static final String ERR_LOADING_BUNDLE_FILENAME_NULL_0 =
      "ERR_LOADING_BUNDLE_FILENAME_NULL_0";
  /** Message constant for key in the resource bundle. */
  ...
  /** Message constant for key in the resource bundle. */
  public static final String ERR_BUNDLE_DESCRIPTOR_NOT_UNIQUE_1 =
  ...
  /** Message constant for key in the resource bundle. */
  public static final String GUI_VIEW_SWITCHER_EDITMODE_DEFAULT_0 =
      "GUI_VIEW_SWITCHER_EDITMODE_DEFAULT_0";
  /** Message constant for key in the resource bundle. */
  public static final String GUI_VIEW_SWITCHER_EDITMODE_MASTER_0 =
  ...
  /** Message constant for key in the resource bundle. */
  public static final String GUI_KEYSET_SWITCHER_MODE_ONLY_USED_0 =
  ...
  /** Message constant for key in the resource bundle. */
  public static final String ERR_BUNDLE_DESCRIPTOR_SEARCH_ERROR_0 =
      "ERR_BUNDLE_DESCRIPTOR_SEARCH_ERROR_0";
  /** Message constant for key in the resource bundle. */
  public static final String ERR_READING_PROPERTY_FOR_DEFAULT_LOCALE_2 =
      "ERR_READING_PROPERTY_FOR_DEFAULT_LOCALE_2";
  /** Message constant for key in the resource bundle. */
  public static final String GUI_NOTIFICATION_MESSAGEBUNDLEEDITOR_SWITCHED_LOCALE_CAPTION_0 =
      "GUI_NOTIFICATION_MESSAGEBUNDLEEDITOR_SWITCHED_LOCALE_CAPTION_0";
  /** Message constant for key in the resource bundle. */
  public static final String GUI_NOTIFICATION_MESSAGEBUNDLEEDITOR_SWITCHED_LOCALE_DESCRIPTION_0 =
  ...
  /** Message constant for key in the resource bundle. */
  protected static final String ERR_BUNDLE_DESCRIPTOR_CREATION_FAILED_0 =
      "ERR_BUNDLE_DESCRIPTOR_CREATION_FAILED_0";
  /** Message constant for key in the resource bundle. */
  protected static final String ERR_BUNDLE_DESCRIPTOR_CREATION_FAILED_DESCRIPTION_0 =
      "ERR_BUNDLE_DESCRIPTOR_CREATION_FAILED_DESCRIPTION_0";
  /** Message constant for key in the resource bundle. */
  public static final String ERR_READING_FILE_UNSUPPORTED_ENCODING_2 =
  ...
  /** Message constant for key in the resource bundle. */
  public static final String GUI_NOTIFICATION_MESSAGEBUNDLEEDITOR_KEY_ALREADY_EXISTS_CAPTION_0 =
      "GUI_NOTIFICATION_MESSAGEBUNDLEEDITOR_KEY_ALREADY_EXISTS_CAPTION_0";
  /** Message constant for key in the resource bundle. */
  public static final String GUI_NOTIFICATION_MESSAGEBUNDLEEDITOR_KEY_ALREADY_EXISTS_DESCRIPTION_0 =
      "GUI_NOTIFICATION_MESSAGEBUNDLEEDITOR_KEY_ALREADY_EXISTS_DESCRIPTION_0";
  /** Message constant for key in the resource bundle. */
  public static final String GUI_NOTIFICATION_MESSAGEBUNDLEEDITOR_KEY_RENAMING_FAILED_CAPTION_0 =
      "GUI_NOTIFICATION_MESSAGEBUNDLEEDITOR_KEY_RENAMING_FAILED_CAPTION_0";
  /** Message constant for key in the resource bundle. */
  public static final String
      GUI_NOTIFICATION_MESSAGEBUNDLEEDITOR_KEY_RENAMING_FAILED_DESCRIPTION_0 =
          "GUI_NOTIFICATION_MESSAGEBUNDLEEDITOR_KEY_RENAMING_FAILED_DESCRIPTION_0";
  /** Message constant for key in the resource bundle. */
  public static final String
      GUI_NOTIFICATION_MESSAGEBUNDLEEDITOR_LOCALE_SWITCHING_FAILED_CAPTION_0 =
          "GUI_NOTIFICATION_MESSAGEBUNDLEEDITOR_LOCALE_SWITCHING_FAILED_CAPTION_0";
  /** Message constant for key in the resource bundle. */
  public static final String
      GUI_NOTIFICATION_MESSAGEBUNDLEEDITOR_LOCALE_SWITCHING_FAILED_DESCRIPTION_0 =
          "GUI_NOTIFICATION_MESSAGEBUNDLEEDITOR_LOCALE_SWITCHING_FAILED_DESCRIPTION_0";
  /** Message constant for key in the resource bundle. */
  public static final String GUI_NOTIFICATION_MESSAGEBUNDLEEDITOR_REMOVE_ENTRY_FAILED_CAPTION_0 =
      "GUI_NOTIFICATION_MESSAGEBUNDLEEDITOR_REMOVE_ENTRY_FAILED_CAPTION_0";
  /** Message constant for key in the resource bundle. */
  public static final String
      GUI_NOTIFICATION_MESSAGEBUNDLEEDITOR_REMOVE_ENTRY_FAILED_DESCRIPTION_0 =
          "GUI_NOTIFICATION_MESSAGEBUNDLEEDITOR_REMOVE_ENTRY_FAILED_DESCRIPTION_0";
  /** Message constant for key in the resource bundle. */
  public static final String GUI_NOTIFICATION_MESSAGEBUNDLEEDITOR_KEY_ALREADEY_EXISTS_CAPTION_0 =
  ...
  /** Message constant for key in the resource bundle. */
  public static final String GUI_NOTIFICATION_MESSAGEBUNDLEEDITOR_KEY_SUCCESSFULLY_ADDED_1 =
      "GUI_NOTIFICATION_MESSAGEBUNDLEEDITOR_KEY_SUCCESSFULLY_ADDED_1";
  /** Message constant for key in the resource bundle. */
  public static final String GUI_NOTIFICATION_MESSAGEBUNDLEEDITOR_EMPTY_KEY_SUCCESSFULLY_ADDED_0 =
  ...
  /** Message constant for key in the resource bundle. */
  public static final String GUI_BUNDLE_EDITOR_CONTEXT_COPY_LOCALE_0 =
      "GUI_BUNDLE_EDITOR_CONTEXT_COPY_LOCALE_0";
  /** Message constant for key in the resource bundle. */
  public static final String GUI_BUTTON_PUBLISH_0 = "GUI_BUTTON_PUBLISH_0";
  /** Message constant for key in the resource bundle. */
  public static final String GUI_NOTIFICATION_MESSAGEBUNDLEEDITOR_EDITING_NOT_POSSIBLE_0 =
      "GUI_NOTIFICATION_MESSAGEBUNDLEEDITOR_EDITING_NOT_POSSIBLE_0";
  /** Message constant for key in the resource bundle. */
  public static final String
