...
public class CmsMessageBundleEditor
  ...
  /** Exit shortcut. */
  private static final Action ACTION_EXIT =
      new ShortcutAction(
          "Ctrl+Shift+X",
  ...
  private static final Action ACTION_EXIT_CMD =
      new ShortcutAction(
          "CMD+Shift+X",
          ShortcutAction.KeyCode.X,
  ...
  /** Save shortcut. */
  private static final Action ACTION_SAVE =
      new ShortcutAction(
          "Ctrl+S", ShortcutAction.KeyCode.S, new int[] {ShortcutAction.ModifierKey.CTRL});

  /** Save shortcut, (using Apple CMD as modifier). */
  private static final Action ACTION_SAVE_CMD =
      new ShortcutAction(
          "CMD+S", ShortcutAction.KeyCode.S, new int[] {ShortcutAction.ModifierKey.META});

  /** Save & Exit shortcut. */
  private static final Action ACTION_SAVE_AND_EXIT =
      new ShortcutAction(
          "Ctrl+Shift+S",
  ...
  private static final Action ACTION_SAVE_AND_EXIT_CMD =
      new ShortcutAction(
          "CMD+Shift+S",
          ShortcutAction.KeyCode.S,
          new int[] {ShortcutAction.ModifierKey.META, ShortcutAction.ModifierKey.SHIFT});
  ...
  private final Map<
          CmsMessageBundleEditorTypes.EditMode,
          CmsMessageBundleEditorTypes.TranslateTableFieldFactory>
      m_fieldFactories =
          new HashMap<
              CmsMessageBundleEditorTypes.EditMode,
              CmsMessageBundleEditorTypes.TranslateTableFieldFactory>(2);
  /** The cell style generators for the different modes. */
  private final Map<
          CmsMessageBundleEditorTypes.EditMode,
          CmsMessageBundleEditorTypes.TranslateTableCellStyleGenerator>
      m_styleGenerators =
          new HashMap<
              CmsMessageBundleEditorTypes.EditMode,
              CmsMessageBundleEditorTypes.TranslateTableCellStyleGenerator>(2);
  ...
  /**
   * @see
   *     org.opencms.ui.editors.messagebundle.CmsMessageBundleEditorTypes.I_OptionListener#handleAddKey(java.lang.String)
   */
  ...
  /**
   * @see
   *     org.opencms.ui.editors.messagebundle.CmsMessageBundleEditorTypes.I_EntryChangeListener#handleEntryChange(org.opencms.ui.editors.messagebundle.CmsMessageBundleEditorTypes.EntryChangeEvent)
   */
  public void handleEntryChange(EntryChangeEvent event) {
    ...
    if (event.getPropertyId().equals(TableProperty.KEY)) {
      ...
      CmsMessageBundleEditorTypes.showWarning(
          m_messages.key(captionKey), m_messages.key(descriptionKey));
  ...
  /**
   * @see
   *     org.opencms.ui.editors.messagebundle.CmsMessageBundleEditorTypes.I_ItemDeletionListener#handleItemDeletion(org.opencms.ui.editors.messagebundle.CmsMessageBundleEditorTypes.ItemDeletionEvent)
   */
  ...
  /**
   * @see
   *     org.opencms.ui.editors.messagebundle.CmsMessageBundleEditorTypes.I_OptionListener#handleLanguageChange(java.util.Locale)
   */
  ...
  /**
   * @see
   *     org.opencms.ui.editors.messagebundle.CmsMessageBundleEditorTypes.I_OptionListener#handleModeChange(org.opencms.ui.editors.messagebundle.CmsMessageBundleEditorTypes.EditMode)
   */
  ...
  /**
   * @see org.opencms.ui.editors.I_CmsEditor#initUI(org.opencms.ui.apps.I_CmsAppUIContext,
   *     org.opencms.file.CmsResource, java.lang.String, java.util.Map)
   */
  public void initUI(
    ...
    try {
      ...
      m_options =
          new CmsMessageBundleEditorOptions(
              m_model.getLocales(), m_model.getLocale(), m_model.getEditMode(), this);
      m_options.setEditedFilePath(m_model.getEditedFilePath());
      m_configurableMessages =
          m_model.getConfigurableMessages(m_messages, UI.getCurrent().getLocale());
  ...
  /**
   * @see org.opencms.ui.editors.I_CmsEditor#matchesResource(org.opencms.file.CmsObject,
  ...
  public boolean matchesType(I_CmsResourceType type, boolean plainText) {
    ...
    return !plainText
        && (CmsMessageBundleEditorTypes.BundleType.toBundleType(type.getTypeName()) != null);
  }
  ...
  boolean setEditMode(CmsMessageBundleEditorTypes.EditMode newMode) {
    ...
    if (!newMode.equals(oldMode)) {
      ...
      if (m_model.setEditMode(newMode)) {
        ...
        Notification.show(
            m_messages.key(Messages.ERR_MODE_CHANGE_NOT_POSSIBLE_0), Type.ERROR_MESSAGE);
      }
      setFilters(filters);
      adjustFocus();
    }
  ...
  void setFilters(Map<Object, Object> filters) {
    ...
    for (Object column : filters.keySet()) {
      ...
      if ((filterValue != null)
          ...
          && !m_table.isColumnCollapsed(column)) {
  ...
  /**
   * Sets the focus to the first editable field of the table. If entries can be added, it is set to
   * the first field of the "Add entries" row.
   */
  ...
  private void adjustOptionsColumn(
      CmsMessageBundleEditorTypes.EditMode oldMode, CmsMessageBundleEditorTypes.EditMode newMode) {
  ...
  private Component createAddDescriptorButton() {
    ...
    Button addDescriptorButton =
        CmsToolBar.createButton(
            FontOpenCms.COPY_LOCALE, m_messages.key(Messages.GUI_ADD_DESCRIPTOR_0));

    addDescriptorButton.setDisableOnClick(true);

    addDescriptorButton.addClickListener(
        new ClickListener() {
  ...
  private Component createCloseButton() {
    ...
    Button closeBtn =
        CmsToolBar.createButton(
            FontOpenCms.CIRCLE_INV_CANCEL, m_messages.key(Messages.GUI_BUTTON_CANCEL_0));
  ...
  private Component createConvertToPropertyBundleButton() {
    ...
    Button addDescriptorButton =
        CmsToolBar.createButton(
            FontOpenCms.SETTINGS, m_messages.key(Messages.GUI_CONVERT_TO_PROPERTY_BUNDLE_0));
  ...
  private Component createPublishButton() {
    ...
    Button publishBtn =
        CmsToolBar.createButton(FontOpenCms.PUBLISH, m_messages.key(Messages.GUI_BUTTON_PUBLISH_0));
    publishBtn.addClickListener(
        new ClickListener() {
  ...
  private Button createSaveButton() {
    ...
    Button saveBtn =
        CmsToolBar.createButton(FontOpenCms.SAVE, m_messages.key(Messages.GUI_BUTTON_SAVE_0));
  ...
  private Button createSaveExitButton() {
    ...
    Button saveExitBtn =
        CmsToolBar.createButton(
            FontOpenCms.SAVE_EXIT, m_messages.key(Messages.GUI_BUTTON_SAVE_AND_EXIT_0));
    saveExitBtn.addClickListener(
        new ClickListener() {
  ...
  private FilterTable createTable() throws IOException, CmsException {
    ...
    table.setColumnHeader(
        TableProperty.KEY, m_configurableMessages.getColumnHeader(TableProperty.KEY));
    table.setColumnCollapsible(TableProperty.KEY, false);

    table.setColumnHeader(
        TableProperty.DEFAULT, m_configurableMessages.getColumnHeader(TableProperty.DEFAULT));
    ...
    table.setColumnHeader(
        TableProperty.OPTIONS, m_configurableMessages.getColumnHeader(TableProperty.OPTIONS));
   ...
   */
  private CmsMessageBundleEditorTypes.OptionColumnGenerator generateOptionsColumn(
      FilterTable table) {
  ...
  private void initFieldFactories() {
    ...
    if (m_model.hasMasterMode()) {
      TranslateTableFieldFactory masterFieldFactory =
          new CmsMessageBundleEditorTypes.TranslateTableFieldFactory(
              m_table, m_model.getEditableColumns(CmsMessageBundleEditorTypes.EditMode.MASTER));
    ...
    TranslateTableFieldFactory defaultFieldFactory =
        new CmsMessageBundleEditorTypes.TranslateTableFieldFactory(
            m_table, m_model.getEditableColumns(CmsMessageBundleEditorTypes.EditMode.DEFAULT));
