...
public final class Messages extends A_CmsMessageBundle {
  ...
  /** Message constant for key in the resource bundle. */
  public static final String GUI_BUTTON_TOBBLE_BRACKET_AUTOCLOSE_0 =
      "GUI_BUTTON_TOBBLE_BRACKET_AUTOCLOSE_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_BUTTON_TOGGLE_HIGHLIGHTING_0 = "GUI_BUTTON_TOGGLE_HIGHLIGHTING_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_BUTTON_TOGGLE_LINE_WRAPPING_0 =
      "GUI_BUTTON_TOGGLE_LINE_WRAPPING_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_BUTTON_TOGGLE_TAB_VISIBILITY_0 =
      "GUI_BUTTON_TOGGLE_TAB_VISIBILITY_0";
