 ...
 */
public class CmsEditSmallElementsAction extends A_CmsWorkplaceAction implements I_CmsADEAction {

    /** The action id. */
    public static final String ACTION_ID = "editsmallelements";
