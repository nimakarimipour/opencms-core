...
public class CmsReportWidget extends AbstractComponent implements I_CmsReportServerRpc {
   ...
   *
   * <p>Use in declarative layouts, remember to call .
   *
   * <p>This does not start the report thread.
   *
   * <p>
   */
   ...
   * Creates a new instance.
   *
   * <p>Use this constructor in case no report thread is available.
   *
   * <p>
   *
   ...
   *
   * <p>Note that this action will only be called if the report is finished while the report widget
   * is actually displayed. For example, if the user closes the browser window before the report is
   * finished, this will not be executed.
   *
