...
/**
 * Widget that can be used to view a running report that is not generated specifically by an OpenCms
 * report thread, but from the text written to the stream provided by this widget.
 */
public class CmsStreamReportWidget extends CmsReportWidget {
  ...
  /**
   * Flag which signals that no further output will be written to the stream and that the report is
   * finished.
   */
   ...
   *
   * <p>This does not directly call the 'report finished' handlers, they will be only called after
   * the next RPC call from the client which fetches the report updates.
   */
  public void finish() {
