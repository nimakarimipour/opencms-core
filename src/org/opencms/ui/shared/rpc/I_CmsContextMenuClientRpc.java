...
public interface I_CmsContextMenuClientRpc extends ClientRpc {
  ...
  /**
   * Sends request to client widget to open context menu relative to component identified by given
   * connectorId. (Method is on purpose with different name from showContextMenu as overloading does
   * not work properly in javascript environment.)
   *
   * <p>
   *
