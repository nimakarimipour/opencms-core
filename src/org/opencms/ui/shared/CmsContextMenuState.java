...
public class CmsContextMenuState extends AbstractComponentState {
   ...
   * context menu will always be opened when it's host component is right clicked. If automatic
   * opening is turned off, context menu will only open when server side open(x, y) is called.
   *
   * <p>
   *
