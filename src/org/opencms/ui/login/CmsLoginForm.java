...
public class CmsLoginForm extends VerticalLayout {
  ...
  public CmsLoginForm(CmsLoginController controller, Locale locale) {
    ...
    m_securityField.setItemCaption(
        PC_TYPE_PRIVATE, messages.key(org.opencms.workplace.Messages.GUI_LOGIN_PCTYPE_PRIVATE_0));
    m_securityField.setItemCaption(
        PC_TYPE_PUBLIC, messages.key(org.opencms.workplace.Messages.GUI_LOGIN_PCTYPE_PUBLIC_0));
    setWidth("600px");
    m_loginButton.setClickShortcut(KeyCode.ENTER);
    m_loginButton.addClickListener(
        new ClickListener() {
    ...
    ClickListener forgotPasswordListener =
        new ClickListener() {
  ...
  /**
   * Displays the given login error.
   *
   * <p>
   *
