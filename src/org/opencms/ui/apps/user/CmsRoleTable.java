...
public class CmsRoleTable extends Table implements I_CmsFilterableTable {
  ...
  enum TableProperty {
    ...
    /** Description. */
    Description(
        CmsVaadinUtils.getMessageText(Messages.GUI_USERMANAGEMENT_USER_DESCRIPTION_0),
        String.class,
        ""),
    /** OU. */
  ...
  private void init(List<CmsRole> roles) {
    ...
    for (CmsRole role : roles) {
      ...
      item.getItemProperty(TableProperty.Description)
          .setValue(role.getDescription(A_CmsUI.get().getLocale()));
        ...
        new ItemClickListener() {
          ...
          public void itemClick(ItemClickEvent event) {
            ...
            if (event.getButton().equals(MouseButton.RIGHT) || (event.getPropertyId() == null)) {
              ...
              m_menu.openForTable(
                  event, event.getItemId(), event.getPropertyId(), CmsRoleTable.this);
