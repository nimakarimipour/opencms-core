...
public abstract class A_CmsImportExportUserDialog extends CmsBasicDialog {
  ...
  private static final List<String> NON_TECHNICAL_VALUES =
      Arrays.asList(
          "description", "lastname", "firstname", "email", "address", "zipcode", "city", "country");
  ...
  /**
   * Export including technical fields.
   *
   * <p>
   *
   * @return boolean
  ...
  /**
   * Get download resource for export.
   *
   * <p>
   *
   * @return Resource
  ...
  /**
   * Checks if given column is to be exported.
   *
   * <p>
   *
