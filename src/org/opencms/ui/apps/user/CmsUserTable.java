...
public class CmsUserTable extends Table implements I_CmsFilterableTable, I_CmsToggleTable {
    ...
    class EntryKillSession implements I_CmsSimpleContextMenuEntry<Set<String>> {
        ...
        public void executeAction(Set<@RUntainted String> context) {
            ...
            Set<@RUntainted String> sessionIds = new HashSet<@RUntainted String>();
    ...
    /**List of user. */
    private List<@RUntainted CmsUser> m_users;
    ...
    public CmsUserTable(
        ...
        try {
            ...
            if (m_type.isRole()) {
                ...
                List<@RUntainted CmsUser> directs = OpenCms.getRoleManager().getUsersOfRole(
                    m_cms,
    ...
    public CmsUserTable(@RUntainted String ou, I_CmsOuTreeType type, CmsAccountsApp app, boolean showAll) {
        ...
        try {
            m_cms = getCmsObject();
            m_type = type;
            List<@RUntainted CmsUser> directs = m_app.getUsersWithoutAdditionalInfo(m_cms, type, ou, false);
            m_indirects = new ArrayList<CmsUser>();
            if (showAll) {
                setAllUsers(directs);
            } else {
     ...
     * @return List of user
     */
    public List<@RUntainted CmsUser> getVisibleUser() {
        ...
        List<@RUntainted CmsUser> directs = new ArrayList<@RUntainted CmsUser>();
     ...
     * @return CmsMenuItemVisibilityMode
     */
    protected CmsMenuItemVisibilityMode onlyVisibleForOU(Set<@RUntainted String> context) {
     ...
     */
    private List<CmsUser> getAllowedIndirects(List<@RUntainted CmsUser> allUsers, List<@RUntainted CmsUser> directUsers) {
     ...
     * @throws CmsException exception
     */
    private void setAllUsers(List<@RUntainted CmsUser> directs) throws CmsException {
