...
public class CmsOUEditDialog extends CmsBasicDialog {
     ...
     * @param app
     */
    public CmsOUEditDialog(@RUntainted CmsObject cms, String ou, final Window window, final CmsAccountsApp app) {
     ...
     */
    public CmsOUEditDialog(@RUntainted CmsObject cms, Window window, String ou, CmsAccountsApp app) {
