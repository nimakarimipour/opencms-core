...
public class CmsGroupTable extends Table implements I_CmsFilterableTable, I_CmsToggleTable {
  ...
  class EntryDelete implements I_CmsSimpleContextMenuEntry<Set<String>> {
    ...
    public void executeAction(final Set<String> context) {
      ...
      CmsDeleteMultiplePrincipalDialog dialog =
          new CmsDeleteMultiplePrincipalDialog(m_cms, context, window, m_app);
  ...
  class EntryEdit implements I_CmsSimpleContextMenuEntry<Set<String>> {
    ...
    public void executeAction(Set<@RUntainted String> context) {
      ...
      window.setContent(
          new CmsGroupEditDialog(m_cms, new CmsUUID(context.iterator().next()), window, m_app));
  ...
  /**
   * Show resources context menu entry.
   *
   * <p>
   */
  ...
  class ImExport implements I_CmsSimpleContextMenuEntry<Set<String>> {
    ...
    public void executeAction(Set<@RUntainted String> context) {
      ...
      Window window = CmsBasicDialog.prepareWindow(DialogWidth.wide);
      window.setCaption(
          CmsVaadinUtils.getMessageText(Messages.GUI_USERMANAGEMENT_USER_IMEXPORT_DIALOGNAME_0));
      window.setContent(
          CmsImportExportUserDialog.getExportUserDialogForGroup(
              new CmsUUID(context.iterator().next()), m_ou, window, includeTechnicalFields));
    ...
    public String getTitle(Locale locale) {
      ...
      return CmsVaadinUtils.getMessageText(
          Messages.GUI_USERMANAGEMENT_USER_IMEXPORT_CONTEXTMENUNAME_0);
    }
        ...
        new ItemClickListener() {
          ...
          public void itemClick(ItemClickEvent event) {
            ...
            if (event.getButton().equals(MouseButton.RIGHT) || (event.getPropertyId() == null)) {
              ...
              m_menu.openForTable(
                  event, event.getItemId(), event.getPropertyId(), CmsGroupTable.this);
              return;
            }
