...
public class CmsCurrentRoleOrPrincipalTable extends Table {
   ...
   */
  public CmsCurrentRoleOrPrincipalTable(
      A_CmsEditUserGroupRoleDialog dialog, CmsObject cms, CmsPrincipal principal) {
    ...
    addItemClickListener(
        new ItemClickListener() {
          ...
          public void itemClick(ItemClickEvent event) {
            ...
            if (!event.isCtrlKey()
                && !event.isShiftKey()
                && ((Boolean) getItem(event.getItemId()).getItemProperty(PROP_STATUS).getValue())
                    .booleanValue()) {
              ...
              if (event.getButton().equals(MouseButton.RIGHT) || (event.getPropertyId() == null)) {
                m_menu.setEntries(
                    getMenuEntries(), m_dialog.getStringSetValue((Set<Object>) getValue()));
                m_menu.openForTable(
                    event,
                    event.getItemId(),
                    event.getPropertyId(),
    ...
    setCellStyleGenerator(
        new CellStyleGenerator() {
          ...
          public String getStyle(Table source, Object itemId, Object propertyId) {
            ...
            if (!((Boolean) source.getItem(itemId).getItemProperty(PROP_STATUS).getValue())
                .booleanValue()) {
              ...
              button.addClickListener(
                  new Button.ClickListener() {
                    ...
                    public void buttonClick(ClickEvent event) {
                      ...
                      m_dialog.removeItem(
                          m_dialog.getStringSetValue(Collections.singleton(itemId)));
                      m_dialog.init();
                    }
                  });
              // button.set
