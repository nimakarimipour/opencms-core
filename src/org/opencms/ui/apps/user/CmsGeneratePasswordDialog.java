...
public class CmsGeneratePasswordDialog extends CmsBasicDialog {
   ...
   */
  public CmsGeneratePasswordDialog(
      final I_CmsPasswordFetcher passwordFetcher, final Runnable close) {
    ...
    CmsButtonFormRow<TextField> row =
        new CmsButtonFormRow<TextField>(
            passwordField,
            VaadinIcons.REFRESH,
            new Runnable() {
    ...
    Label label =
        new Label(CmsVaadinUtils.getMessageText(Messages.GUI_USERMANAGEMENT_GEN_PASSWORD_TEXT_0));
    label.setWidth("100%");
  ...
  /**
   * Gets random password from password handler.
   *
   * <p>
   *
   * @return String
