...
public class CmsAdditionalInfosDialog extends CmsBasicDialog {
   ...
   * @param app
   */
  public CmsAdditionalInfosDialog(
  ...
  /**
   * Submit additional info to user.
   *
   * <p>
   */
  protected void submit() {
    ...
    for (I_CmsEditableGroupRow row : m_userinfoGroup.getRows()) {
      String key =
          ((TextField) (((HorizontalLayout) row.getComponent()).getComponent(0))).getValue();
      String value =
          ((TextField) (((HorizontalLayout) row.getComponent()).getComponent(1))).getValue();
  ...
  /**
   * Get horizontal layout with key, value from additional info.
   *
   * <p>
   *
   * @param key key
  ...
  /**
   * Add key value pair as component to ui.
   *
   * <p>
   *
   * @param key string
  ...
  /**
   * Adds additional info to user.
   *
   * <p>(Doesn't write the user)
   *
   * <p>
   *
   * @param key string
