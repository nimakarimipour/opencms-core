 ...
 */
public class CmsDbPropertiesAppConfiguration extends A_CmsWorkplaceAppConfiguration {

    /** The app id. */
    public static final String APP_ID = "db-admin-properties";
    ...
    public String getButtonStyle() {
        ...
        return FontOpenCms.SETTINGS.getButtonOverlayStyle() + " " + OpenCmsTheme.BUTTON_OVERLAY_CYAN;
    }
    ...
    public String getName(Locale locale) {
        ...
        return CmsVaadinUtils.getMessageText(Messages.GUI_DATABASEAPP_PROPERTY_TOOL_NAME_0);
    }
