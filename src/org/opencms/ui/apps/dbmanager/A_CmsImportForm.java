...
public abstract class A_CmsImportForm extends VerticalLayout {
  ...
  public A_CmsImportForm(I_CmsReportApp app) {
    ...
    final IndexedContainer availableSites =
        CmsVaadinUtils.getAvailableSitesContainer(cms, "caption");
    ...
    getProjectSelector()
        .select(A_CmsUI.getCmsObject().getRequestContext().getCurrentProject().getUuid());
  ...
  /**
   * Gets a button for a cancel function.
   *
   * <p>
   *
  ...
  /**
   * Returns a cms object set to the site corresponding to siteselector.
   *
   * <p>
   *
   * @return a cms object
  ...
  protected CmsObject getCmsObject() {
    ...
    try {
      ...
      cms.getRequestContext()
          .setCurrentProject(cms.readProject((CmsUUID) getProjectSelector().getValue()));
      return cms;
  ...
  /**
   * Gets a button for a ok function.
   *
   * <p>
   *
   * @return a vaadin button
  ...
  /**
   * Gets a combobox used for the site selector.
   *
   * <p>
   *
  ...
  /**
   * Get the path (state) for the app to show the report for the import thread.
   *
   * <p>
   *
  ...
  /**
   * Gets the title of the report to show.
   *
   * <p>
   *
   * @return title name
