...
public class CmsDbExportConfiguration extends A_CmsWorkplaceAppConfiguration {
  ...
  public String getButtonStyle() {
    ...
    return FontOpenCms.DOWNLOAD.getButtonOverlayStyle()
        + " "
        + OpenCmsTheme.BUTTON_OVERLAY_BLUE_LIGHT;
  }
  ...
  public String getHelpText(@RUntainted Locale locale) {
    ...
    return Messages.get()
        .getBundle(locale)
        .key(Messages.GUI_DATABASEAPP_EXPORTSERVER_ADMIN_TOOL_HELP_0);
  }
  ...
  public String getName(@RUntainted Locale locale) {
    ...
    return Messages.get()
        .getBundle(locale)
        .key(Messages.GUI_DATABASEAPP_EXPORTSERVER_ADMIN_TOOL_NAME_0);
  }
