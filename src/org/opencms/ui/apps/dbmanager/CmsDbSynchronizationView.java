...
public class CmsDbSynchronizationView extends VerticalLayout {
  ...
  /**
   * Validator for the resource fields.
   *
   * <p>
   */
  class ResourceValidator implements Validator {
    ...
    public void validate(Object value) throws InvalidValueException {
      ...
      if (synchroEnabled() & (resourceName == null)) {
        throw new InvalidValueException(
            CmsVaadinUtils.getMessageText(
                Messages.GUI_DATABASEAPP_SYNC_VALIDATION_EMPTY_RESOURCES_0));
      }
      ...
      try {
        ...
        throw new InvalidValueException(
            CmsVaadinUtils.getMessageText(
                Messages.GUI_DATABASEAPP_SYNC_VALIDATION_RESOURCE_NOT_FOUND_1, resourceName));
      }
    }
  }

  /**
   * Validator for the target.
   *
   * <p>
   */
    ...
    public void validate(Object value) throws InvalidValueException {
      ...
      if (synchroEnabled()) {
        try {
          ...
          throw new InvalidValueException(
              CmsVaadinUtils.getMessageText(
                  Messages.GUI_DATABASEAPP_SYNC_VALIDATION_EMPTY_TARGET_0));
        }
      }
    }
  }
  ...
  public CmsDbSynchronizationView(CmsDbSynchronizationApp app) {
    ...
    m_target.addValueChangeListener(
    ...
    m_enabled.addValueChangeListener(
        new ValueChangeListener() {
  ...
  protected void addResource(String path) {
    ...
    CmsRemovableFormRow<CmsPathSelectField> row =
        new CmsRemovableFormRow<CmsPathSelectField>(
            field, CmsVaadinUtils.getMessageText(Messages.GUI_DATABASEAPP_SYNC_REMOVE_RESOURCE_0));
    row.setCaption(CmsVaadinUtils.getMessageText(Messages.GUI_DATABASEAPP_SYNC_RESOURCE_0));
    row.setRemoveRunnable(
        new Runnable() {
  ...
  /**
   * Reads entered resources from form.
   *
   * <p>
   *
  ...
  /**
   * Clones given CmsObject and switches to root site.
   *
   * <p>
   *
