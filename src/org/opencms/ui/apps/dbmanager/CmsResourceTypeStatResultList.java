...
public class CmsResourceTypeStatResultList {
  ...
  private HorizontalLayout getLayoutFromResult(final CmsResourceTypeStatResult statResult) {
    ...
    Button showList =
        new Button(CmsVaadinUtils.getMessageText(Messages.GUI_DATABASEAPP_STATS_LIST_0));
    showList.setWidth("100px");

    showList.addClickListener(
  ...
  /**
   * Checks if given results is to old.
   *
   * <p>
   *
  ...
  /**
   * Removes result row representing given results.
   *
   * <p>
   *
