...
public class CmsEditLoginView extends CmsBasicDialog {
  ...
  /**
   * Checks whether the entered start end end times are valid.
   *
   * <p>
   *
  ...
  private void bindFields() {
    ...
    m_formBinderAfter.bind(
        m_messageAfter, CmsLoginMessage::getMessage, CmsLoginMessage::setMessage);
    ...
    m_formBinderBefore.bind(
        m_messageBefore, CmsLoginMessage::getMessage, CmsLoginMessage::setMessage);
