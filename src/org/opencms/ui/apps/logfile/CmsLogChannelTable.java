...
public class CmsLogChannelTable extends Table {
  ...
  /**
   * Table column generator for Level-buttons.
   *
   * <p>
   */
  class LevelIcon implements Table.ColumnGenerator {
    ...
    public Object generateCell(Table source, final Object itemId, Object columnId) {
      ...
      return ((LoggerLevel) (source.getItem(itemId).getItemProperty(columnId).getValue()))
          .getLevelString();
    }
  }
  ...
  /**
   * Enumeration of Logger Level and corresponging icon paths.
   *
   * <p>
   */
  private enum LoggerLevel {
    ...
    /**
     * Returns LoggerLevel object from given logger.
     *
     * <p>
     *
    ...
    /**
     * Returns the string representation for level.
     *
     * <p>
     *
     * @return string
    ...
    /**
     * Returns an extenden string representation with log level name added in case of having caption
     * set.
     *
     * <p>
     *
  ...
  protected CmsLogChannelTable(CmsLogFileApp app) {
    ...
    setVisibleColumns(
        TableColumn.Level, TableColumn.Channel, TableColumn.ParentChannel, TableColumn.File);
        ...
        new CellStyleGenerator() {
          ...
          public String getStyle(Table source, Object itemId, Object propertyId) {
            ...
            if (TableColumn.Level.equals(propertyId)) {
              return ((LoggerLevel) source.getItem(itemId).getItemProperty(propertyId).getValue())
                  .getCssClass();
            }
  ...
  public void addItemForLogger(Logger logger) {
    ...
    if (item != null) {
      ...
      item.getItemProperty(TableColumn.ParentChannel)
          .setValue(parentChannelName != null ? parentChannelName : "none");
  ...
  /**
   * Sets a given Level to a Set of Loggers.
   *
   * <p>
   *
