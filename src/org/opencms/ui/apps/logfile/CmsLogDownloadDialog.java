...
public class CmsLogDownloadDialog extends CmsBasicDialog {
  ...
  public static class ZipGenerator {
    ...
    /**
     * Generates the name of the parent directory in the zip file for a non-standard log file
     * location.
     *
     * <p>
     *
   ...
   */
  public CmsLogDownloadDialog(
      final Window window, String filePath, I_CmsLogDownloadProvider logProvider) {
  ...
  protected Resource getDownloadResource() {
    ...
    if (m_donwloadAll.getValue().booleanValue()) {
      ...
      return new StreamResource(
          () -> m_logProvider.readAllLogs(), m_logProvider.getDownloadPrefix() + "logs.zip");
    }
