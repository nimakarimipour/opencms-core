...
public class CmsModuleApp extends A_CmsAttributeAwareApp implements I_CmsCachableApp {
  ...
  /**
   * Context menu entry for deleting a module.
   *
   * <p>
   */
        ...
        Runnable okAction =
            new Runnable() {
              ...
              public void run() {
                ...
                final A_CmsReportThread thread =
                    new A_CmsReportThread(cms, "Delete module " + context) {
                      ...
                      public void run() {
                        ...
                        try {
                          OpenCms.getModuleManager()
                              .deleteModule(cms, moduleName, false, getReport());
                        } catch (Exception e) {
                          getReport().println(e);
                ...
                if (module.hasModuleResourcesWithUndefinedSite()) {
                  CmsSiteSelectDialog.openDialogInWindow(
                      new CmsSiteSelectDialog.I_Callback() {
                        ...
                        public void onSiteSelect(String site) {
                          ...
                          openReport(
                              ...
                              CmsVaadinUtils.getMessageText(
                                  Messages.GUI_MODULES_REPORT_DELETE_MODULE_1, context));
                        }
                      },
    ...
    public void executeAction(final Set<String> context) {
      ...
      final CmsModuleImportExportHandler handler =
          CmsModuleImportExportHandler.getExportHandler(
              cms, OpenCms.getModuleManager().getModule(moduleName), handlerDesc);

      final A_CmsReportThread thread =
          new A_CmsReportThread(cms, "Export module " + moduleName) {
      ...
      if (module.hasModuleResourcesWithUndefinedSite()) {
        ...
        //                    CmsModuleApp.States.EXPORT_REPORT,
        //                    thread,
        //                    CmsVaadinUtils.getMessageText(Messages.GUI_MODULES_REPORT_EXPORT_1,
        // context));
      }
    }
  ...
  /**
   * Context menu entry for displaying the type list.
   *
   * <p>
   */
  class ModuleInfoEntry
    ...
    public void executeAction(Set<String> module) {
      ...
      CmsModuleInfoDialog typeList =
          new CmsModuleInfoDialog(module.iterator().next(), CmsModuleApp.this::editModule);
  ...
  private IdentityHashMap<A_CmsReportThread, String> m_labels =
      new IdentityHashMap<A_CmsReportThread, String>();
  ...
  public static void editModule(
      CmsModule module, boolean isNew, String caption, Runnable callback) {
  ...
  /**
   * Returns VISIBILITY_ACTIVE if a module with the given name exists, and VISIBILITY_INVISIBLE
   * otherwise.
   *
   * <p>
   *
  ...
  public void editNewModule(Runnable callback) {
    ...
    editModule(
        module,
        true,
        CmsVaadinUtils.getMessageText(Messages.GUI_MODULES_TITLE_NEW_MODULE_0),
        callback);
  }
  ...
  protected Component getComponentForState(String state) {
    ...
    if (state.equals(States.IMPORT)) {
      ...
      CmsBasicReportPage reportForm =
          new CmsBasicReportPage(
              label,
              m_reports.get(state),
              new Runnable() {
  ...
  protected Component getModuleTable() {
    ...
    CmsModuleTable<CmsModuleRow> table =
        new CmsModuleTable<CmsModuleRow>(this, CmsModuleRow.class, rows);
    return table;
  }
