...
public class CmsModuleInfoDialog extends CmsBasicDialog {
  ...
  public CmsModuleInfoDialog(String moduleName, Consumer<String> editAction) {
    ...
    CmsResourceInfo resInfo =
        new CmsResourceInfo(
            module.getName(), module.getNiceName(), CmsModuleApp.Icons.RESINFO_ICON);
  ...
  /**
   * Creates the resource info box for an explorer type.
   *
   * <p>
   *
  ...
  /**
   * Creates the resource info box for a resource type.
   *
   * <p>
   *
    ...
    if (settings != null) {
      ...
      icon =
          CmsResourceUtil.getBigIconResource(
              OpenCms.getWorkplaceManager().getExplorerTypeSetting("unknown"), null);
      title = type.getTypeName();
