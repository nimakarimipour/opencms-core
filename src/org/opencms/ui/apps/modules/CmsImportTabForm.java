...
/**
 * Module import dialog with two tabs, one for importing via HTTP and one for importing from the
 * server.
 *
 * <p>
 */
public class CmsImportTabForm extends CmsBasicDialog {
  ...
  public CmsImportTabForm(CmsModuleApp app, Runnable run) {
    ...
    m_tabs.addTab(
        ...
        CmsVaadinUtils.getMessageText(
            org.opencms.ui.apps.Messages.GUI_MODULES_TAB_IMPORT_SERVER_0));
    updateButtons();
  ...
  /**
   * Updates the button bar with the buttons provided by the currently selected tab.
   *
   * <p>
   */
