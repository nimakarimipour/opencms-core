...
public class CmsResultTable extends CmsFileTable {
        ...
        new StringToDateConverter() {
          ...
          protected DateFormat getFormat(Locale locale) {
            ...
            return new SimpleDateFormat(
                CmsVaadinUtils.getMessageText(Messages.GUI_LISTMANAGER_DATE_FORMAT_0));
          }
        });
  }

  /**
   * Returns the first visible item id.
   *
   * <p>
   *
  ...
  /**
   * Sets the first visible item id.
   *
   * <p>
   *
  ...
  /**
   * @see org.opencms.ui.components.CmsResourceTable#fillItem(org.opencms.file.CmsObject,
