...
public class CmsResultFacets extends VerticalLayout {
  ...
  public void displayFacetResult(
      CmsSolrResultList solrResultList, CmsSearchResultWrapper resultWrapper) {
  ...
  /**
   * Returns whether the given component is selected.
   *
   * <p>
   *
  ...
  /**
   * Resets the selected facets and triggers a new search.
   *
   * <p>
   */
  ...
  /**
   * Filters the available folder facets.
   *
   * <p>
   *
  ...
  /**
   * Returns the label for the given category.
   *
   * <p>
   *
  ...
  private String getCategoryLabel(String categoryPath) {
    ...
    try {
      if (m_useFullPathCategories) {
        ...
        for (String part : categoryPath.split("/")) {
          ...
          CmsCategory cat =
              catService.localizeCategory(
                  cms, catService.readCategory(cms, currentPath, "/"), locale);
          if (!isFirst) {
            result += "  /  ";
          } else {
            isFirst = false;
        ...
        CmsCategory cat =
            catService.localizeCategory(
                cms, catService.readCategory(cms, categoryPath, "/"), locale);
        result = cat.getTitle();
      }
    } catch (Exception e) {
  ...
  /**
   * Prepares the category facets for the given search result.
   *
   * <p>
   *
  ...
  private Component prepareCategoryFacets(
    ...
    FacetField categoryFacets =
        solrResultList.getFacetField(CmsSimpleSearchConfigurationParser.FIELD_CATEGORIES);
    ...
    if ((categoryFacets != null) && (categoryFacets.getValueCount() > 0)) {
            ...
            new ClickListener() {
              ...
              public void buttonClick(ClickEvent event) {
                ...
                if (isSelected(event.getComponent())) {
                  ...
                  selectFieldFacet(
                      CmsSimpleSearchConfigurationParser.FIELD_CATEGORIES, value.getName());
                }
              }
            });
      ...
      Panel catPanel =
          new Panel(CmsVaadinUtils.getMessageText(Messages.GUI_LISTMANAGER_FACET_CATEGORIES_0));
  ...
  /**
   * Prepares the date facets for the given search result.
   *
   * <p>
   *
   * @param solrResultList the search result list
   ...
   */
  private Component prepareDateFacets(
      CmsSolrResultList solrResultList, CmsSearchResultWrapper resultWrapper) {

    RangeFacet<?, ?> dateFacets =
        resultWrapper.getRangeFacet().get(CmsSimpleSearchConfigurationParser.FIELD_DATE_FACET_NAME);
    I_CmsSearchControllerFacetRange facetController =
        resultWrapper
            .getController()
            .getRangeFacets()
            .getRangeFacetController()
            .get(CmsSimpleSearchConfigurationParser.FIELD_DATE_FACET_NAME);
    ...
    if ((dateFacets != null) && (dateFacets.getCounts().size() > 0)) {
            ...
            new ClickListener() {
              ...
              public void buttonClick(ClickEvent event) {
                ...
                if (isSelected(event.getComponent())) {
                  ...
                  selectRangeFacet(
                      CmsSimpleSearchConfigurationParser.FIELD_DATE_FACET_NAME, value.getValue());
                }
              }
            });
        int targetColumn;
      ...
      Panel datePanel =
          new Panel(CmsVaadinUtils.getMessageText(Messages.GUI_LISTMANAGER_FACET_DATE_0));
  ...
  /**
   * Prepares the folder facets for the given search result.
   *
   * <p>
   *
   * @param solrResultList the search result list
  ...
  private Component prepareFolderFacets(
    ...
    FacetField folderFacets =
        solrResultList.getFacetField(CmsSimpleSearchConfigurationParser.FIELD_PARENT_FOLDERS);
    I_CmsSearchControllerFacetField facetController =
        resultWrapper
            .getController()
            .getFieldFacets()
    ...
    if ((folderFacets != null) && (folderFacets.getValueCount() > 0)) {
            ...
            new ClickListener() {
              ...
              public void buttonClick(ClickEvent event) {
                ...
                if (isSelected(event.getComponent())) {
                  ...
                  selectFieldFacet(
                      CmsSimpleSearchConfigurationParser.FIELD_PARENT_FOLDERS, value.getName());
                }
              }
            });
      ...
      Panel folderPanel =
          new Panel(CmsVaadinUtils.getMessageText(Messages.GUI_LISTMANAGER_FACET_FOLDERS_0));
