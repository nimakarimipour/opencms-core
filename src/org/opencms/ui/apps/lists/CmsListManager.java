...
public class CmsListManager extends A_CmsWorkplaceApp
    implements I_ResourcePropertyProvider,
  ...
  /**
   * Overrides the standard delete action to enable use of edit handlers.
   *
   * <p>
   */
  class DeleteAction extends CmsDeleteDialogAction {
    ...
    /**
     * @see
     *     org.opencms.ui.actions.CmsDeleteDialogAction#executeAction(org.opencms.ui.I_CmsDialogContext)
     */
    @Override
    public void executeAction(final I_CmsDialogContext context) {
      ...
      if ((resourceType instanceof CmsResourceTypeXmlContent)
          && (((CmsResourceTypeXmlContent) resourceType).getEditHandler(context.getCms())
              != null)) {
        final I_CmsEditHandler handler =
            ((CmsResourceTypeXmlContent) resourceType).getEditHandler(context.getCms());
        final CmsContainerElementBean elementBean =
            getElementForEditHandler((DialogContext) context);
        CmsDialogOptions options =
            handler.getDeleteOptions(
                context.getCms(), elementBean, null, Collections.<String, String[]>emptyMap());
        if (options == null) {
          super.executeAction(context);
        } else if (options.getOptions().size() == 1) {
          deleteForOption(
              resource, elementBean, options.getOptions().get(0).getValue(), handler, context);
        } else {
          Window window = CmsBasicDialog.prepareWindow();
          window.setCaption(options.getTitle());
          CmsOptionDialog dialog =
              new CmsOptionDialog(
                  resource,
                  options,
                  new I_OptionHandler() {
  ...
  /**
   * Overrides the standard edit action to enable use of edit handlers.
   *
   * <p>
   */
  class EditAction extends CmsEditDialogAction {
    ...
    /**
     * @see
     *     org.opencms.ui.actions.CmsEditDialogAction#executeAction(org.opencms.ui.I_CmsDialogContext)
     */
    @Override
    public void executeAction(final I_CmsDialogContext context) {
    ...
    /**
     * Calls the editor with the given option.
     *
     * <p>
     *
     * @param resource the resource to delete
    ...
    void editForOption(
      ...
      try {
        ...
        if (resource.getStructureId().equals(id)) {
          ...
          CmsFileTableDialogContext changedContext =
  ...
  protected static final CmsResourceTableProperty INFO_PROPERTY =
      new CmsResourceTableProperty("INFO_PROPERTY", String.class, null, null, true, 1, 0);
  ...
  private static final I_CmsSearchConfigurationPagination PAGINATION =
      new CmsSearchConfigurationPagination(null, Integer.valueOf(10000), Integer.valueOf(1));
  ...
  public void addItemProperties(
    ...
    if ((m_currentConfig != null)
        && (resourceItem.getItemProperty(CmsListManager.BLACKLISTED_PROPERTY) != null)) {
      resourceItem
          .getItemProperty(CmsListManager.BLACKLISTED_PROPERTY)
          .setValue(
      ...
      resourceItem
          ...
          .setValue(
              CmsVaadinUtils.getMessageText(
                  "GUI_LISTMANAGER_SERIES_TYPE_"
                      + (seriesType == null ? "DEFAULT" : seriesType)
                      + "_0"));
  ...
  public I_CmsDialogContext getDialogContext() {
    ...
    DialogContext context =
        new DialogContext(
            CmsProjectManagerConfiguration.APP_ID, ContextType.fileTable, table, resources);
    if (!isOverView()) {
  ...
  public void initUI(I_CmsAppUIContext uiContext) {
    ...
    m_publishButton.addClickListener(
        new ClickListener() {
    ...
    m_editCurrentButton =
        CmsToolBar.createButton(
            FontOpenCms.PEN, CmsVaadinUtils.getMessageText(Messages.GUI_LISTMANAGER_EDIT_CONFIG_0));
    m_editCurrentButton.addClickListener(
        new ClickListener() {
    ...
    m_toggleSeriesButton.addClickListener(
        new ClickListener() {
    ...
    m_createNewButton =
        CmsToolBar.createButton(
            FontOpenCms.WAND, CmsVaadinUtils.getMessageText(Messages.GUI_LISTMANAGER_CREATE_NEW_0));
    m_createNewButton.addClickListener(
        new ClickListener() {
    ...
    LinkedHashMap<CmsResourceTableProperty, Integer> tableColumns =
        new LinkedHashMap<CmsResourceTableProperty, Integer>();
    // insert columns a specific positions
    for (Map.Entry<CmsResourceTableProperty, Integer> columnsEntry :
        CmsFileTable.DEFAULT_TABLE_PROPERTIES.entrySet()) {
    ...
    menuBuilderOverView.addMenuItemProvider(
    ...
    menuBuilder.addMenuItemProvider(
        new I_CmsContextMenuItemProvider() {
                    ...
                    new A_CmsWorkplaceAction() {
                      ...
                      public CmsMenuItemVisibilityMode getVisibility(
                        ...
                        if ((m_currentConfig != null)
                            ...
                            && !m_currentConfig
                                .getBlacklist()
                                .contains(resources.get(0).getStructureId())) {
                          return CmsEditDialogAction.VISIBILITY.getVisibility(
                              cms, Collections.singletonList(m_currentResource));
                        } else {
    ...
    m_resultTable.addAdditionalStyleGenerator(
          ...
          public String getStyle(Table source, Object itemId, Object propertyId) {
            ...
            if (blacklisted.booleanValue()) {
              style += OpenCmsTheme.PROJECT_OTHER + " ";
                ...
                && ((item.getItemProperty(CmsResourceTableProperty.PROPERTY_RELEASED_NOT_EXPIRED)
                        == null)
                    || ((Boolean)
            ...
            if (INFO_PROPERTY_LABEL.equals(propertyId)) {
              if (blacklisted.booleanValue()) {
                ...
                if (value == null) {
                  ...
                  I_CmsSerialDateValue.DateType type =
                      I_CmsSerialDateValue.DateType.valueOf((String) value);
                  switch (type) {
                    case SERIES:
    ...
    final ItemDescriptionGenerator defaultDescriptionGenerator =
        new CmsResourceTable.DefaultItemDescriptionGenerator();
    m_resultTable.setsetItemDescriptionGenerator(
        new ItemDescriptionGenerator() {
          ...
          public String generateDescription(Component source, Object itemId, Object propertyId) {
            ...
            if (INFO_PROPERTY_LABEL.equals(propertyId)
                && ((Boolean) item.getItemProperty(BLACKLISTED_PROPERTY).getValue())
                    .booleanValue()) {
    ...
    m_tableFilter.addTextChangeListener(
    ...
    m_localeSelect.addValueChangeListener(
    ...
    for (int i = 0; i < SORT_OPTIONS[0].length; i++) {
      ...
      m_resultSorter.setItemCaption(
          SORT_OPTIONS[0][i], CmsVaadinUtils.getMessageText(SORT_OPTIONS[1][i]));
    }
    m_resultSorter.addValueChangeListener(
        new ValueChangeListener() {
    ...
    m_textSearch.addValueChangeListener(
        new ValueChangeListener() {
  ...
  public void search(CmsSimpleSearchConfigurationParser configParser, CmsResource resource) {
    ...
    m_resetting = true;
    m_resultSorter.setValue(
        m_currentConfig.getParameterValue(CmsConfigurationBean.PARAM_SORT_ORDER));
    m_resetting = false;
  ...
  public void search(
    ...
    if (fieldFacets != null) {
      Map<String, I_CmsSearchControllerFacetField> fieldFacetControllers =
          controller.getFieldFacets().getFieldFacetController();
    ...
    if (rangeFacets != null) {
      Map<String, I_CmsSearchControllerFacetRange> rangeFacetControllers =
          controller.getRangeFacets().getRangeFacetController();
      ...
      try {
        title =
            A_CmsUI.getCmsObject()
                .readPropertyObject(m_currentResource, CmsPropertyDefinition.PROPERTY_TITLE, false)
                .getValue();
      } catch (Exception e) {
        // ignore
      }
  ...
  protected Component getComponentForState(String state) {
    ...
    if (CmsStringUtil.isNotEmptyOrWhitespaceOnly(
      ...
      try {
        ...
        // SearchConfigParser configParser = new SearchConfigParser(m_currentConfig,
        // m_collapseItemSeries, locale);
        CmsSimpleSearchConfigurationParser configParser =
            new CmsSimpleSearchConfigurationParser(cms, m_currentConfig, null);
  ...
  /**
   * Changes the search content locale, reissuing a search.
   *
   * <p>
   *
  ...
  /**
   * Displays the search result in the result table.
   *
   * <p>
   *
  ...
  void displayResult(CmsSolrResultList resultList) {
    ...
    String state =
        A_CmsWorkplaceApp.addParamToState(
            "", CmsEditor.RESOURCE_ID_PREFIX, m_currentResource.getStructureId().toString());
    state =
        A_CmsWorkplaceApp.addParamToState(
            state, PARAM_LOCALE, m_currentConfigParser.getSearchLocale().toString());
    m_currentState = state;
  ...
  /**
   * Edits the given list configuration resource.
   *
   * <p>
   *
  ...
  void enableOverviewMode(boolean enabled) {
    ...
    boolean isOffline =
        !A_CmsUI.getCmsObject().getRequestContext().getCurrentProject().isOnlineProject();
    ...
    if (enabled) {
      if (!isOffline) {
        ...
        CmsObject cms = A_CmsUI.getCmsObject();
        CmsADEConfigData data =
            OpenCms.getADEManager().lookupConfiguration(cms, cms.getRequestContext().getSiteRoot());
  ...
  /**
   * Evaluates if date series types are present and if more than one instance of a series is in the
   * search result.
   *
   * <p>
   *
  ...
  /**
   * Creates an element bean of the selected table item to be used with edit handlers.
   *
   * <p>
   *
   * @param context the dialog context
    ...
    if (selected.size() == 1) {
      ...
      return new CmsContainerElementBean(
          ...
          Collections.singletonMap(
              CmsDateSeriesEditHandler.PARAM_INSTANCEDATE, String.valueOf(instanceDate.getTime())),
          false);
    }
    return null;
  }
  ...
  /**
   * Returns the resources to publish for the current list.
   *
   * <p>
   *
  ...
  /**
   * Returns whether the overview mode is active.
   *
   * <p>
   *
  ...
  /**
   * Opens the publish dialog to publish all resources related to the current search configuration.
   *
   * <p>
   */
  void publish() {

    I_CmsUpdateListener<String> updateListener =
  ...
  /**
   * Refreshes the search result maintaining the current scroll position.
   *
   * <p>
   */
  void refreshResult() {
  ...
  /**
   * Sets the date series hidden flag.
   *
   * <p>
   *
  ...
  /**
   * Toggles the date series filter.
   *
   * <p>
   */
  ...
  /**
   * Tries to unlocks the current resource if available.
   *
   * <p>
   */
  void tryUnlockCurrent() {
    ...
    if ((m_lockAction != null)
        && m_lockAction.getChange().equals(CmsLockActionRecord.LockChange.locked)) {
      try {
  ...
  /**
   * Unlocks the current resource in case it has been locked by previous actions.
   *
   * <p>
   */
  void unlockCurrent() {
  ...
  /**
   * Updates the given items in the result table.
   *
   * <p>
   *
  ...
  /**
   * Displays the list config resources.
   *
   * <p>
   */
  ...
  private void executeSearch(CmsSearchController controller, CmsSolrQuery query) {
    ...
    try {
      ...
      m_resultFacets.displayFacetResult(
          solrResultList, new CmsSearchResultWrapper(controller, solrResultList, query, cms, null));
    } catch (CmsSearchException e) {
      CmsErrorDialog.showErrorDialog(e);
  ...
  /**
   * Returns the content locale configured for the first search root folder of the search
   * configuration.
   *
   * <p>
   *
  ...
  /**
   * Resets the locale select according to the current configuration data.
   *
   * <p>
   *
  ...
  private void resetContentLocale(Locale defaultLocale) {
    ...
    if (m_currentConfig.getFolders().isEmpty()) {
      ...
      m_localeSelect.setItemCaption(
          defaultLocale, defaultLocale.getDisplayLanguage(UI.getCurrent().getLocale()));
    } else {
      for (String folder : m_currentConfig.getFolders()) {
        for (Locale locale :
            OpenCms.getLocaleManager().getAvailableLocales(A_CmsUI.getCmsObject(), folder)) {
          if (!m_localeSelect.containsId(locale)) {
            m_localeSelect.addItem(locale);
            m_localeSelect.setItemCaption(
                locale, locale.getDisplayLanguage(UI.getCurrent().getLocale()));
          }
        }
      }
    }
  ...
  /**
   * Sets options which are specific to the backend list manager on the cnofiguration parser.
   *
   * <p>
   *
   ...
   */
  private void setBackendSpecificOptions(
      CmsSimpleSearchConfigurationParser configParser, Locale locale) {
