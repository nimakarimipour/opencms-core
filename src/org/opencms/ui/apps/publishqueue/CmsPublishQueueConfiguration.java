...
public class CmsPublishQueueConfiguration extends A_CmsWorkplaceAppConfiguration {
  ...
  public String getHelpText(Locale locale) {
    ...
    return Messages.get().getBundle(locale).key(Messages.GUI_PQUEUE_HELP_0);
  }
  ...
  public String getName(Locale locale) {
    ...
    return Messages.get().getBundle(locale).key(Messages.GUI_PQUEUE_TITLE_0);
  }
  ...
  public CmsAppVisibilityStatus getVisibility(CmsObject cms) {
    ...
    CmsAppVisibilityStatus status =
        OpenCms.getRoleManager().hasRole(cms, CmsRole.EDITOR)
