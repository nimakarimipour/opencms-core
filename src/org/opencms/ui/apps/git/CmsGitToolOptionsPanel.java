...
public class CmsGitToolOptionsPanel extends VerticalLayout {
    ...
    Map<@RUntainted String, CheckBox> m_moduleCheckboxes = Maps.newHashMap();
     ...
     */
    public void addSelectableModule(final @RUntainted String moduleName) {
     ...
     */
    public Collection<@RUntainted String> getSelectedModules() {

        List<@RUntainted String> result = Lists.newArrayList();
        for (Map.Entry<@RUntainted String, CheckBox> entry : m_moduleCheckboxes.entrySet()) {
