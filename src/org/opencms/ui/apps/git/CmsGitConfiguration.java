...
public class CmsGitConfiguration {
  ...
  private static final String SYSTEM_MODULE_EXPORTPATH =
  ...
  /**
   * Returns the configured default git user email, or <code>null</code> if the email is by default
   * not adjusted at all.
   *
   * @return the configured default git user email, or <code>null</code> if the email is by default
   *     not adjusted at all.
   */
  ...
  /**
   * Returns the configured default git user name, or <code>null</code> if the name is by default
   * not adjusted at all.
   *
   * @return the configured default git user name, or <code>null</code> if the name is by default
   *     not adjusted at all.
   */
  ...
  public String getModuleExportPath() {
    ...
    return m_defaultModuleExportPath.isEmpty()
        ? SYSTEM_MODULE_EXPORTPATH
        : m_defaultModuleExportPath;
  }
  ...
  /**
   * Returns the subfolder where module resources are placed inside the modules main folder in the
   * repository.
   *
   * @return the subfolder where module resources are placed inside the modules main folder in the
   *     repository.
   */
