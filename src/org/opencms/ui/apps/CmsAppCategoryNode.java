 ...
 *
 * <p>Contains a list of child nodes and a list of apps, which are the leaves of the tree. Note that
 * the list of children is not initialized after construction, it has to be filled manually.
 */
public class CmsAppCategoryNode implements I_CmsHasOrder {
  ...
  public void sort() {
    ...
    Collections.sort(
        m_appConfigurations, new ConfigurationComparator<I_CmsWorkplaceAppConfiguration>());
  ...
  /**
   * Recursively computes the app count for each descendant of this tree node.
   *
   * <p>
   */
  ...
  /**
   * Internal helper method used to remove subtrees containing no app configurations.
   *
   * <p>
   *
