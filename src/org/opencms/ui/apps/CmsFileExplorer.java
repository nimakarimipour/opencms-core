...
public class CmsFileExplorer
  ...
  public class ExplorerDropHandler implements DropHandler {
    ...
    public void drop(@RUntainted DragAndDropEvent dragEvent) {
      ...
      try {
        ...
        if (m_copyMoveAction.isActive(context)) {
          CmsCopyMoveDialog dialog =
              new CmsCopyMoveDialog(context, CmsCopyMoveDialog.DialogMode.copy_and_move);
    ...
    CmsExplorerDialogContext getContext(@RUntainted DragAndDropEvent dragEvent) throws CmsException {
      ...
      if ((dragEvent.getTransferable().getSourceComponent() instanceof Table)
        ...
        CmsObject cms = A_CmsUI.getCmsObject();
        CmsUUID sourceId =
            m_fileTable.getUUIDFromItemID((String) dragEvent.getTransferable().getData("itemId"));
      ...
      CmsExplorerDialogContext context =
          new CmsExplorerDialogContext(
  ...
  public class TreeExpandListener implements ExpandListener {
    ...
    private static final long serialVersionUID = 1L;
    /**
     * The path fragment being opened. Will override folder visibility in case the the target path
  ...
  static class StateBean {
    ...
    /**
     * Returns the resource to select, empty if no one was set.
     *
     * <p>
     *
    ...
    /**
     * Sets a resource to be selected.
     *
     * <p>
     *
  ...
  public static final Collection<CmsResourceTableProperty> INLINE_EDIT_PROPERTIES =
      Arrays.asList(
  ...
  /** The delete shortcut. */
  private static final Action ACTION_DELETE =
      new ShortcutAction("Del", ShortcutAction.KeyCode.DELETE, null);

  /** The open parent folder shortcut. */
  private static final Action ACTION_FOLDER_UP =
      new ShortcutAction(
          "Alt+ArrowUp",
  ...
  private static final Action ACTION_PROPERTIES =
      new ShortcutAction(
          "Alt+Enter", ShortcutAction.KeyCode.ENTER, new int[] {ShortcutAction.ModifierKey.ALT});

  /** The rename shortcut. */
  private static final Action ACTION_RENAME =
      new ShortcutAction("F2", ShortcutAction.KeyCode.F2, null);

  /** The select all shortcut. */
  private static final Action ACTION_SELECT_ALL =
      new ShortcutAction(
          "Ctrl+A", ShortcutAction.KeyCode.A, new int[] {ShortcutAction.ModifierKey.CTRL});

  /** The select all shortcut, (using Apple CMD as modifier). */
  private static final Action ACTION_SELECT_ALL_CMD =
      new ShortcutAction(
          "CMD+A", ShortcutAction.KeyCode.A, new int[] {ShortcutAction.ModifierKey.META});

  /** The switch online shortcut. */
  private static final Action ACTION_SWITCH_ONLINE =
      new ShortcutAction(
          "Ctrl+O", ShortcutAction.KeyCode.O, new int[] {ShortcutAction.ModifierKey.CTRL});

  /** The switch online shortcut, (using Apple CMD as modifier). */
  private static final Action ACTION_SWITCH_ONLINE_CMD =
      new ShortcutAction(
          "CMD+O", ShortcutAction.KeyCode.O, new int[] {ShortcutAction.ModifierKey.META});
  ...
  private static final CmsResourceFilter FOLDERS =
  ...
  public CmsFileExplorer() {
    ...
    m_uploadArea.addUploadListener(
    ...
    m_fileTree.addCollapseListener(
    ...
    m_fileTree.addItemClickListener(
    ...
    m_fileTree.setItemStyleGenerator(
        new ItemStyleGenerator() {
    ...
    m_fileTree.addValueChangeListener(
    ...
    A_CmsFocusShortcutListener shortcutListener =
        new A_CmsFocusShortcutListener("Open path", KeyCode.ENTER, null) {
    ...
    m_searchField.addTextChangeListener(
    ...
    m_locationCache =
        CmsQuickLaunchLocationCache.getLocationCache(CmsAppWorkplaceUi.get().getHttpSession());
    String startSite =
        CmsWorkplace.getStartSiteRoot(
            A_CmsUI.getCmsObject(), CmsAppWorkplaceUi.get().getWorkplaceSettings());
  ...
  public boolean beforeViewChange(ViewChangeEvent event) {
    ...
    OpenCms.getWorkplaceAppManager()
        .storeAppSettings(
            A_CmsUI.getCmsObject(), CmsFileExplorerSettings.class, m_fileTable.getTableSettings());
    return true;
  }
  ...
  public void changeSite(@RUntainted String siteRoot, @RUntainted String path, boolean force) {
    ...
    if (force || !currentSiteRoot.equals(siteRoot) || (path != null)) {
      ...
      for (Object id : container.getItemIds()) {
        CmsExtendedSiteSelector.SiteSelectorOption option =
            (CmsExtendedSiteSelector.SiteSelectorOption) id;
  ...
  public CmsExplorerDialogContext getDialogContext() {
    ...
    CmsExplorerDialogContext context =
        new CmsExplorerDialogContext(ContextType.fileTable, m_fileTable, this, resources);
  ...
  public void initUI(I_CmsAppUIContext context) {
    ...
    try {
      settings =
          OpenCms.getWorkplaceAppManager()
              .getAppSettings(A_CmsUI.getCmsObject(), CmsFileExplorerSettings.class);
    ...
    m_fileTable.updateColumnWidths(
        A_CmsUI.get().getPage().getBrowserWindowWidth() - LAYOUT_SPLIT_POSITION);
  }
  ...
  public void onFolderSelect(@RUntainted CmsUUID itemId) {
    ...
    try {
      ...
      CmsErrorDialog.showErrorDialog(
          CmsVaadinUtils.getMessageText(Messages.ERR_EXPLORER_CAN_NOT_READ_RESOURCE_1, itemId), e);
  ...
  public void onStateChange(String state) {
    ...
    if ((m_currentState == null) || !m_currentState.equals(state)) {
      ...
      if ((projectId != null)
          && !cms.getRequestContext().getCurrentProject().getUuid().equals(projectId)) {
        try {
  ...
  public void update(Collection<CmsUUID> ids) {
    ...
    try {
      CmsResource currentFolderRes =
          A_CmsUI.getCmsObject().readResource(m_currentFolder, CmsResourceFilter.ALL);
        ...
        try {
          ...
          remove =
              !CmsResource.getParentFolder(resource.getRootPath())
                  .equals(currentFolderRes.getRootPath());
    ...
    try {
      ...
      CmsErrorDialog.showErrorDialog(
          CmsVaadinUtils.getMessageText(
              Messages.ERR_EXPLORER_CAN_NOT_READ_RESOURCE_1, m_currentFolder),
          e);
      LOG.error(e.getLocalizedMessage(), e);
    }
  }
  ...
  public void updateResourceInTree(CmsObject cms, CmsUUID id) {
    ...
    try {
      ...
      if (resourceItem != null) {
        ...
        resourceItem
            .getItemProperty(CmsResourceTableProperty.PROPERTY_TREE_CAPTION)
            .setValue(iconHTML);
        resourceItem
            .getItemProperty(CmsResourceTableProperty.PROPERTY_STATE)
            .setValue(resource.getState());
        if (parentId != null) {
  ...
  protected void readFolder(@RUntainted CmsUUID folderId, boolean clearFilter) throws CmsException {
    ...
    String sitePath =
        folder.getRootPath().equals(cms.getRequestContext().getSiteRoot() + "/") ? "" : folderPath;
    String state =
        new StateBean(
  ...
  protected void updateCurrentFolder(Collection<CmsUUID> removeIds) {
    ...
    try {
      ...
      List<CmsResource> childResources =
          cms.readResources(cms.getSitePath(folder), FILES_N_FOLDERS, false);
  ...
  /**
   * Expands the currently viewed folder in the tree.
   *
   * <p>
   */
  ...
  /**
   * Handles the file tree click events.
   *
   * <p>
   *
  ...
  void handleFileTreeClick(@RUntainted ItemClickEvent event) {
    ...
    if ((resourceItem.getItemProperty(CmsResourceTableProperty.PROPERTY_DISABLED).getValue()
            == null)
        || !((Boolean)
                resourceItem.getItemProperty(CmsResourceTableProperty.PROPERTY_DISABLED).getValue())
            .booleanValue()) {
      ...
      try {
        ...
        CmsErrorDialog.showErrorDialog(
            CmsVaadinUtils.getMessageText(
                Messages.ERR_EXPLORER_CAN_NOT_READ_RESOURCE_1, event.getItemId()),
            e);
        LOG.error(e.getLocalizedMessage(), e);
      }
    }
  ...
  /**
   * Handles the file tree value changes.
   *
   * <p>
   */
  void handleFileTreeValueChange() {
    ...
    if (resourceItem != null) {
      if ((resourceItem.getItemProperty(CmsResourceTableProperty.PROPERTY_DISABLED).getValue()
          ...
          && ((Boolean)
                  resourceItem
                      .getItemProperty(CmsResourceTableProperty.PROPERTY_DISABLED)
                      .getValue())
              .booleanValue()) {
        // in case the folder is disabled due to missing visibility, reset the value to the previous
        // one
  ...
  void onClickNew() {
    ...
    try {
      ...
      CmsResource folderRes =
          cms.readResource(m_currentFolder, CmsResourceFilter.IGNORE_EXPIRATION);
  ...
  void openPath(@RUntainted String path, boolean initTree) {
    ...
    if (siteManager.isSharedFolder(cms.getRequestContext().getSiteRoot())
        && siteManager.startsWithShared(path)) {
      // siteManager.getSharedFolder() has a trailing slash - we want to cut off the shared folder,
      // but keep a leading slash in path
    ...
    boolean existsPath =
        CmsStringUtil.isNotEmptyOrWhitespaceOnly(path) && cms.existsResource(path, FILES_N_FOLDERS);
    ...
    if (initTree) {
      try {
        ...
        CmsErrorDialog.showErrorDialog(
            CmsVaadinUtils.getMessageText(Messages.ERR_EXPLORER_CAN_NOT_OPEN_PATH_1, path), e);
        LOG.error(e.getLocalizedMessage(), e);
        return;
      }
    }
  ...
  /**
   * Shows and hides the path bread crumb.
   *
   * <p>
   *
  ...
  /**
   * Shows the parent folder, if available.
   *
   * <p>
   */
    ...
    if (parentId != null) {
      ...
      if ((resourceItem.getItemProperty(CmsResourceTableProperty.PROPERTY_DISABLED).getValue()
        ...
        try {
          ...
          CmsErrorDialog.showErrorDialog(
              CmsVaadinUtils.getMessageText(
                  Messages.ERR_EXPLORER_CAN_NOT_READ_RESOURCE_1, parentId),
              e);
          LOG.error(e.getLocalizedMessage(), e);
        }
      }
  ...
  /**
   * Toggles between the online and the offline project.
   *
   * <p>
   */
  void toggleOnlineOffline() {
        ...
        try {
          ...
          if (!project.isOnlineProject()
              && OpenCms.getOrgUnitManager()
                  .getAllAccessibleProjects(cms, project.getOuFqn(), false)
                  .contains(project)) {
    ...
    if (targetProject != null) {
      ...
      Notification.show(
          CmsVaadinUtils.getMessageText(
              Messages.GUI_SWITCHED_TO_PROJECT_1, targetProject.getName()));
    }
  }

  /**
   * Adds the given properties to the tree container.
   *
   * <p>
   *
  ...
  private void addTreeContainerProperties(CmsResourceTableProperty... properties) {
    ...
    for (CmsResourceTableProperty property : properties) {
      m_treeContainer.addContainerProperty(
          property, property.getColumnType(), property.getDefaultValue());
    }
  }
  ...
  private void addTreeItem(
    ...
    resourceItem
        .getItemProperty(CmsResourceTableProperty.PROPERTY_INSIDE_PROJECT)
        .setValue(Boolean.valueOf(resUtil.isInsideProject()));
    resourceItem
        .getItemProperty(CmsResourceTableProperty.PROPERTY_RELEASED_NOT_EXPIRED)
  ...
  /**
   * Creates the site selector combo box.
   *
   * <p>
   *
  ...
  private ComboBox createSiteSelect(CmsObject cms) {
    ...
    final List<CmsExtendedSiteSelector.SiteSelectorOption> sites =
        CmsExtendedSiteSelector.getExplorerSiteSelectorOptions(cms, true);
    final BeanItemContainer<CmsExtendedSiteSelector.SiteSelectorOption> container =
        new BeanItemContainer<>(CmsExtendedSiteSelector.SiteSelectorOption.class);
    ...
    combo.setInputPrompt(
        Messages.get()
            ...
            .key(Messages.GUI_EXPLORER_CLICK_TO_EDIT_0));
    combo.setItemCaptionPropertyId("label");
    combo.select(
        new CmsExtendedSiteSelector.SiteSelectorOption(
            cms.getRequestContext().getSiteRoot(), null, null));
    ...
    combo.addValueChangeListener(
        new ValueChangeListener() {
          ...
          /**
           * Flag used to temporarily disable the standard listener behavior, used when we change
           * the combo box's value programatically.
           */
          ...
          public void valueChange(ValueChangeEvent event) {
            ...
            CmsExtendedSiteSelector.SiteSelectorOption option =
                (CmsExtendedSiteSelector.SiteSelectorOption) (event.getProperty().getValue());
            if (container.containsId(option)) {
              ...
              if (option.getPath() != null) {
                try {
                  m_disabled = true;
                  combo.select(
                      new CmsExtendedSiteSelector.SiteSelectorOption(option.getSite(), null, null));
                } finally {
                  m_disabled = false;
                }
              }
  ...
  /**
   * Returns the site path from the current state.
   *
   * <p>
   *
  ...
  /**
   * Returns the project id from the current state.
   *
   * <p>
   *
  ...
  /**
   * Returns selected resource UUID from state (empty if not set).
   *
   * <p>
   *
  ...
  /**
   * Returns the site root from the current state.
   *
   * <p>
   *
  ...
  /**
   * Initializes the app specific toolbar buttons.
   *
   * <p>
   *
  ...
  private void initToolbarButtons(I_CmsAppUIContext context) {
    ...
    m_newButton =
        CmsToolBar.createButton(
            FontOpenCms.WAND, CmsVaadinUtils.getMessageText(Messages.GUI_NEW_RESOURCE_TITLE_0));
    if (CmsAppWorkplaceUi.isOnlineProject()) {
      m_newButton.setEnabled(false);
      m_newButton.setDescription(
          CmsVaadinUtils.getMessageText(Messages.GUI_TOOLBAR_NOT_AVAILABLE_ONLINE_0));
    }
    m_newButton.addClickListener(
        new ClickListener() {
    ...
    if (CmsAppWorkplaceUi.isOnlineProject()) {
      ...
      m_uploadButton.setDescription(
          CmsVaadinUtils.getMessageText(Messages.GUI_TOOLBAR_NOT_AVAILABLE_ONLINE_0));
      m_specialUploadButton.setDescription(
          CmsVaadinUtils.getMessageText(Messages.GUI_TOOLBAR_NOT_AVAILABLE_ONLINE_0));
    } else {
      m_uploadButton.setDescription(
          CmsVaadinUtils.getMessageText(Messages.GUI_UPLOAD_BUTTON_TITLE_0));
      m_specialUploadButton.setDescription(
          CmsVaadinUtils.getMessageText(Messages.GUI_UPLOAD_BUTTON_TITLE_0));
    }
    m_uploadButton.addUploadListener(
        new I_UploadListener() {
    ...
    m_specialUploadButton.addClickListener(
        event -> {
          try {
            @SuppressWarnings("unchecked")
            Class<I_CmsWorkplaceAction> actionClass =
                (Class<I_CmsWorkplaceAction>) getClass().getClassLoader().loadClass(m_uploadAction);
            I_CmsWorkplaceAction action = actionClass.newInstance();
            List<CmsResource> resources = new ArrayList<>();
            resources.add(m_uploadFolder);
            CmsExplorerDialogContext uploadContext =
                new CmsExplorerDialogContext(ContextType.fileTable, m_fileTable, this, resources);
  ...
  /**
   * Normalizes the state string. Ensuring it starts with the right number of slashes resolving an
   * issue with the vaadin state handling.
   *
   * <p>
   *
   * @param state the state string
  ...
  /**
   * Sets the toolbar buttons enabled.
   *
   * <p>
   *
  ...
  private void setToolbarButtonsEnabled(boolean enabled) {
    ...
    if (enabled) {
      m_publishButton.setDescription(
    ...
    try {
      uploadAction =
          OpenCms.getResourceManager()
              .getResourceType(folder)
              .getConfiguration()
              .get("gallery.upload.action");
    } catch (Exception e) {
    ...
    if (uploadAction != null) {
      ...
      boolean enabled =
          OpenCms.getWorkplaceManager()
              ...
              .getUploadRestrictionInfo(A_CmsUI.getCmsObject())
              .isUploadEnabled(folder.getRootPath());
