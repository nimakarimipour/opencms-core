...
I_CmsContextProvider, CmsFileTable.I_FolderSelectHandler {
    ...
    static class StateBean {
         ...
         */
        public StateBean(@RUntainted String siteRoot, @RUntainted String folder, @RUntainted String projectId) {
         ...
         */
        public static StateBean parse(@RUntainted String state) {
    ...
    private @RUntainted String m_currentState;
     ...
     */
    public void update(Collection<@RUntainted CmsUUID> ids) {
     ...
     */
    public void updateResourceInTree(CmsObject cms, @RUntainted CmsUUID id) {
    ...
    void openPath(@RUntainted String path, boolean initTree) {
        ...
        Collection<@RUntainted ?> rootItems = m_treeContainer.rootItemIds();
        if (rootItems.size() != 1) {
        ...
        Collection<@RUntainted ?> children = m_treeContainer.getChildren(folderId);
     ...
     * @param openPathFragment the open path fragment
     */
    void readTreeLevel(@RUntainted CmsUUID parentId, String openPathFragment) {
    ...
    void toggleOnlineOffline() {
        ...
        if (cms.getRequestContext().getCurrentProject().isOnlineProject()) {
            ...
            if (targetProject == null) {
                ...
                if (targetProject == null) {
                    List<@RUntainted CmsProject> availableProjects = CmsVaadinUtils.getAvailableProjects(cms);
     ...
     */
    private @RUntainted CmsUUID getProjectIdFromState() {
     ...
     * @return uuid as string
     */
    private String getSelectionFromState(@RUntainted String state) {
     ...
     */
    private @RUntainted String normalizeState(@RUntainted String state) {
