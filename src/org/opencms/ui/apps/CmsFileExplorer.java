...
I_CmsContextProvider, CmsFileTable.I_FolderSelectHandler {
    ...
    public class ExplorerDropHandler implements DropHandler {
        ...
        public AcceptCriterion getAcceptCriterion() {
            ...
            return new ServerSideCriterion() {
                ...
                public boolean accept(@RUntainted DragAndDropEvent dragEvent) {
                    ...
                    @RUntainted CmsUUID targetId = getTargetId(dragEvent);
         ...
         */
        protected @RUntainted CmsUUID getTargetId(DragAndDropEvent dragEvent) {

            @RUntainted CmsUUID targetId = null;
         ...
         */
        protected boolean mayDrop(@RUntainted CmsUUID targetId) {
        ...
        CmsExplorerDialogContext getContext(@RUntainted DragAndDropEvent dragEvent) throws CmsException {
            ...
            if ((dragEvent.getTransferable().getSourceComponent() instanceof Table)
                ...
                CmsObject cms = A_CmsUI.getCmsObject();
                @RUntainted CmsUUID sourceId = m_fileTable.getUUIDFromItemID((String)dragEvent.getTransferable().getData("itemId"));
     ...
     * @param id the
     */
    public void updateTree(@RUntainted CmsUUID id) {
