...
public class CmsSearchindexRebuild extends VerticalLayout {
  ...
  public CmsSearchindexRebuild(CmsSearchindexApp app, Set<@RUntainted String> data) {
    ...
    m_confirm.setValue(
        CmsVaadinUtils.getMessageText(
            Messages.GUI_SEARCHINDEX_REBUILD_CONFIRM_1, getCommaSeperatedIndexes(data)));
  ...
  /**
   * Creates a comma seperated string with all indexes represented by a string using the
   * CmsSearchindexApp.SEPERATOR_INDEXNAMES.
   *
   * <p>
   *
