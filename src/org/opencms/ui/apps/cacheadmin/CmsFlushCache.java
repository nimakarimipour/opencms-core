...
public class CmsFlushCache extends Panel {
        ...
        getFlushButton(
            ...
            new CmsConfirmSimpleFlushDialog(
                CmsVaadinUtils.getMessageText(
                    Messages.GUI_CACHE_CORECACHE_CLEAN_ADMIN_TOOL_CONF_0)),
            new Runnable() {
            ...
            new Runnable() {
              ...
              public void run() {
                ...
                try {
                  ...
                  OpenCms.fireCmsEvent(
                      I_CmsEventListener.EVENT_CLEAR_CACHES, new HashMap<String, Object>());
                  clickedRunnable.run();
  ...
  /**
   * Creates Button to flush cashes.
   *
   * <p>
   *
