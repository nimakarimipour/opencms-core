...
public class CmsImageCacheTable extends Table {
  ...
  /**
   * Column for dimensions of image.
   *
   * <p>
   */
  ...
  public CmsImageCacheTable(
      VerticalLayout intro, VerticalLayout nullResult, TextField siteTableFilter) {
        ...
        new ItemClickListener() {
          ...
          public void itemClick(ItemClickEvent event) {
            ...
            if (event.getButton().equals(MouseButton.RIGHT) || (event.getPropertyId() == null)) {
              ...
              m_menu.openForTable(
                  event, event.getItemId(), event.getPropertyId(), CmsImageCacheTable.this);
            }
  ...
  public void filterTable(String search) {
    ...
    if (CmsStringUtil.isNotEmptyOrWhitespaceOnly(search)) {
      m_container.addContainerFilter(
          new Or(new SimpleStringFilter(PROP_NAME, search, true, false)));
    }
    if ((getValue() != null)) {
        ...
        .showApp(
            ...
            A_CmsUI.getCmsObject().getRequestContext().getCurrentProject().getUuid()
                ...
                + parentPath.substring(
                    A_CmsUI.getCmsObject().getRequestContext().getSiteRoot().length())
                + A_CmsWorkplaceApp.PARAM_SEPARATOR
                + uuid
                + A_CmsWorkplaceApp.PARAM_SEPARATOR);
  }
  ...
  /**
   * Fills table with entries from image cache helper.
   *
   * <p>
   */
