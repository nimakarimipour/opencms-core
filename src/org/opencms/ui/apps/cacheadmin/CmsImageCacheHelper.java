...
public class CmsImageCacheHelper {
  ...
  public CmsImageCacheHelper(
      CmsObject cms, boolean withVariations, boolean showSize, boolean statsOnly) {
  ...
  /**
   * Reads out the path of a given image (by its name).
   *
   * <p>
   *
  ...
  private CmsObject getClonedCmsObject(CmsObject cms) throws CmsException {
    ...
    clonedCms
        .getRequestContext()
        .setCurrentProject(clonedCms.readProject(CmsProject.ONLINE_PROJECT_ID));
  ...
  private void visitImages(
      CmsObject cms, File directory, boolean withVariations, boolean showSize, boolean statsOnly) {
