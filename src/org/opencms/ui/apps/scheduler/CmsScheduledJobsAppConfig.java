...
public class CmsScheduledJobsAppConfig extends A_CmsWorkplaceAppConfiguration {
  ...
  public String getHelpText(Locale locale) {
    ...
    return org.opencms.workplace.tools.scheduler.Messages.get()
        .getBundle(locale)
        .key(org.opencms.workplace.tools.scheduler.Messages.GUI_JOBS_ADMIN_TOOL_HELP_0);
  }
  ...
  public String getName(Locale locale) {
    ...
    return org.opencms.workplace.tools.scheduler.Messages.get()
        .getBundle(locale)
        .key(org.opencms.workplace.tools.scheduler.Messages.GUI_JOBS_ADMIN_TOOL_SHORTNAME_0);
  }
