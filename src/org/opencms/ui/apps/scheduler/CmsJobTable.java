 ...
 *
 * <p>The columns containing the buttons are implemented as generated columns.
 */
public class CmsJobTable extends Table {
  ...
  protected enum TableProperty {
    ...
    /** Class name column. */
    className(
        "className", org.opencms.workplace.tools.scheduler.Messages.GUI_JOBS_LIST_COL_CLASS_0),
    ...
    lastExecution(
        "lastExecution",
        org.opencms.workplace.tools.scheduler.Messages.GUI_JOBS_LIST_COL_LASTEXE_0),
    ...
    /**
     * returns property from it's name used for table column ids.
     *
     * <p>
     *
    ...
    /**
     * Returns all columns with header.
     *
     * <p>
     *
  ...
  /**
   * Enum representing the actions for which buttons exist in the table rows.
   *
   * <p>
   */
  enum Action {
    /** Enable / disable. */
    activation(
        org.opencms.workplace.tools.scheduler.Messages.GUI_JOBS_LIST_ACTION_MACTIVATE_NAME_0,
    ...
    /**
     * Gets the message key for the action.
     *
     * <p>
     *
  ...
  /**
   * The activate job context menu entry.
   *
   * <p>
   */
  ...
  /**
   * The copy job context menu entry.
   *
   * <p>
   */
  ...
  /**
   * The delete job context menu entry.
   *
   * <p>
   */
  ...
  /**
   * The edit job context menu entry.
   *
   * <p>
   */
  class EditEntry
    ...
    public void executeAction(Set<String> data) {
      ...
      CmsConfirmationDialog.show(
              ...
              CmsVaadinUtils.getMessageText(
                  Messages.GUI_SCHEDULER_CONFIRM_EXECUTE_1, job.getJobName()),
              new Runnable() {
        ...
        new CellStyleGenerator() {
          ...
          public String getStyle(Table source, Object itemId, Object propertyId) {
            ...
            CmsScheduledJobInfo job =
                ((BeanItem<CmsJobBean>) source.getItem(itemId)).getBean().getJob();
  ...
  /**
   * Calls the edit formular to edit a job.
   *
   * <p>
   *
