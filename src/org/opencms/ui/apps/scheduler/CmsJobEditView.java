...
public class CmsJobEditView extends CmsBasicDialog {
  ...
  /**
   * Validator for the cron expression field.
   *
   * <p>
   */
  ...
  /**
   * TODO this is the same like CmsRemovableFormRow Widget used to display a line of text and also a
   * remove button to remove the widget.
   *
   * <p>
   */
  class ParamLine extends HorizontalLayout {
    ...
    public ParamLine(String content) {
      ...
      deleteButton.setDescription(
          CmsVaadinUtils.getMessageText(Messages.GUI_SCHEDULER_REMOVE_PARAMETER_0));
  ...
  public CmsJobEditView(CmsJobManagerApp manager, CmsScheduledJobInfo job) {
    ...
    BeanFieldGroup<CmsScheduledJobInfo> group =
        new BeanFieldGroup<CmsScheduledJobInfo>(CmsScheduledJobInfo.class);
    ...
    m_buttonAddParam.addClickListener(
        new ClickListener() {
  ...
  /**
   * Adds a new parameter input field with the given content.
   *
   * <p>
   *
  ...
  /**
   * Binds the given component to the given bean property.
   *
   * <p>
   *
  ...
  /**
   * Reads the job parameters from the parameter input fields.
   *
   * <p>
   *
  ...
  /**
   * Adds a new widget for entering a job parameter.
   *
   * <p>
   *
