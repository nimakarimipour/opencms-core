...
public class CmsSitesTable extends Table implements I_CmsFilterableTable {
  ...
  public class EditEntry
    ...
    public CmsMenuItemVisibilityMode getVisibility(Set<String> data) {
      ...
      if ((data == null)
          || (data.size() != 1)
          || (m_manager.getElement(data.iterator().next()) == null)) {
  ...
  class FavIconColumn implements Table.ColumnGenerator {
    ...
    /**
     * @see com.vaadin.v7.ui.Table.ColumnGenerator#generateCell(com.vaadin.v7.ui.Table,
  ...
  class PageEditorEntry implements I_CmsSimpleContextMenuEntry<Set<String>> {
    ...
    public CmsMenuItemVisibilityMode getVisibility(Set<String> data) {
      ...
      if (!((Boolean) getItem(siteRoot).getItemProperty(TableProperty.OK).getValue())
          .booleanValue()) {
        return CmsMenuItemVisibilityMode.VISIBILITY_INACTIVE;
      }
  ...
  /**
   * The menu entry to switch to the sitemap editor of concerning site.
   *
   * <p>
   */
          ...
          public String getStyle(Table source, Object itemId, Object propertyId) {
                  ...
                  " "
                      + getSSLStyle(
                          (CmsSite)
                              source
                                  .getItem(itemId)
                                  .getItemProperty(TableProperty.CmsSite)
                                  .getValue());
            }

            if (TableProperty.Server.equals(propertyId)) {
              styles += " " + OpenCmsTheme.HOVER_COLUMN;
              if (!((Boolean) source.getItem(itemId).getItemProperty(TableProperty.OK).getValue())
                  .booleanValue()) {
                if (((Boolean)
                        source.getItem(itemId).getItemProperty(TableProperty.Changed).getValue())
                    .booleanValue()) {
                ...
                if (((Boolean) source.getItem(itemId).getItemProperty(TableProperty.New).getValue())
                    .booleanValue()) {
            ...
            if (TableProperty.Title.equals(propertyId)
                & ((Boolean)
                        source
                            .getItem(itemId)
                            .getItemProperty(TableProperty.Is_Webserver)
                            .getValue())
                    .booleanValue()) {
  ...
  /**
   * Returns number of correctly configured sites.
   *
   * <p>
   *
  ...
  /**
   * Reads sites from Site Manager and adds them to table.
   *
   * <p>
   */
      ...
      if (site.getSiteMatcher() != null) {
        ...
        if (OpenCms.getSiteManager().isOnlyOfflineSite(site)) {
          ...
          item.getItemProperty(TableProperty.Icon)
              .setValue(new Label(icon.getHtmlWithOverlay(), ContentMode.HTML));
        } else {
          item.getItemProperty(TableProperty.Icon)
              .setValue(new Label(icon.getHtml(), ContentMode.HTML));
        }
    ...
    if (!event.isCtrlKey() && !event.isShiftKey()) {
      ...
      if (event.getButton().equals(MouseButton.RIGHT) || (propertyId == TableProperty.Icon)) {
        ...
        m_menu.openForTable(event, itemId, propertyId, this);
          ...
          && TableProperty.Server.equals(propertyId)) {
  ...
  private Resource getFavIconResource(String siteRoot) {
    ...
    try {
      CmsResource favicon =
          m_manager.getRootCmsObject().readResource(siteRoot + "/" + CmsSiteManager.FAVICON);
  ...
  /**
   * Is the given site NOT nested in any of the given sites?
   *
   * <p>
   *
   * @param site to check
