...
public class CmsResourceTypeApp extends A_CmsWorkplaceApp {
  ...
  protected Component getComponentForState(String state) {
    ...
    m_resourcetypeTableFilter.addTextChangeListener(
    ...
    add.addClickListener(
        new ClickListener() {
          ...
          public void buttonClick(ClickEvent event) {
            ...
            CmsNewResourceTypeDialog dialog =
                new CmsNewResourceTypeDialog(window, CmsResourceTypeApp.this);
