...
public class CmsLinkValidationApp extends A_CmsWorkplaceApp {
  ...
  public class InternalValidator extends A_CmsLinkValidator {
    ...
    /**
     * get string to show for broken link.
     *
     * <p>1:1 the same like old workplace app
     *
     * <p>
     *
  ...
  /**
   * Returns the component for the internal link validation.
   *
   * <p>
   *
  ...
  private HorizontalSplitPanel getInternalComponent() {
    ...
    VerticalLayout nullResult =
        CmsVaadinUtils.getInfoLayout(Messages.GUI_LINKVALIDATION_NO_BROKEN_LINKS_0);

    nullResult.setVisible(false);
    CmsLinkValidationInternalTable table =
        new CmsLinkValidationInternalTable(intro, nullResult, new InternalValidator());
