...
public class CmsLinkInFolderValidationApp extends A_CmsWorkplaceApp implements I_CmsUpdatableComponent {
    ...
    static class CmsStateBean {
        ...
        /**List of resources. */
        private @RUntainted List<String> m_resources;

        /**Reverse the output? */
        private @RUntainted boolean m_reverse;
         ...
         *
         */
        public CmsStateBean(List<String> resources, @RUntainted boolean reverse) {
         ...
         * @param reverse boolean
         */
        public CmsStateBean(@RUntainted String resources, @RUntainted boolean reverse) {
         ...
         */
        private @RUntainted String getResourceString() {
