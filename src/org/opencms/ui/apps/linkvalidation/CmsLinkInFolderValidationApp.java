...
public class CmsLinkInFolderValidationApp extends A_CmsWorkplaceApp
  ...
  public class InFolderValidator extends A_CmsLinkValidator {
      ...
      try {
        ...
        brokenResources =
            CmsDeleteDialog.getBrokenLinks(
                cms, res, false, CmsVaadinUtils.isButtonPressed(m_revertButton));
    ...
    /**
     * @see
     *     org.opencms.ui.apps.linkvalidation.A_CmsLinkValidator#failMessage(org.opencms.file.CmsResource)
     */
    @Override
      ...
      return new ItemClickListener() {
        ...
        public void itemClick(@RUntainted ItemClickEvent event) {
          ...
          try {
            ...
            window.setContent(
                new CmsResourceListDialog(
                    new ArrayList<CmsResource>(brokenResources.get(resource))));
    ...
    public Map<CmsResourceTableProperty, Integer> getTableProperties() {
      ...
      property =
          new CmsResourceTableProperty(
              getPropertyName(), String.class, "", getCaptionKey(), true, 0, 200);
      Map<CmsResourceTableProperty, Integer> res =
  ...
  static class CmsStateBean {
    ...
    /**
     * Gets resources from state string.
     *
     * <p>
     *
    ...
    /**
     * Get the state string of the resources.
     *
     * <p>
     *
    ...
    private String getResourceString() {
      ...
      try {
        ...
        for (String resource : m_resources) {
          res +=
              m_cms.readResource(resource).getStructureId().getStringValue() + RESOURCE_SEPERATOR;
        }
  ...
  public void update(List<String> resources) {
    ...
    openSubView(
        new CmsStateBean(resources, CmsVaadinUtils.isButtonPressed(m_revertButton)).getState(),
        true);
  }
  ...
  protected Component getComponentForState(String state) {
    ...
    result.setSizeFull();
    VerticalLayout intro =
        CmsVaadinUtils.getInfoLayout(Messages.GUI_LINKVALIDATION_CHECK_FOLDER_RELATIONS_INTRO_0);
    VerticalLayout nullResult =
  ...
  protected void toggleTable() {
    ...
    openSubView(
        new CmsStateBean(m_stateBean.getResources(), CmsVaadinUtils.isButtonPressed(m_revertButton))
            .getState(),
        true);
  }
  ...
  private void addToolbars() {
    ...
    m_revertButton.addClickListener(
        new ClickListener() {
