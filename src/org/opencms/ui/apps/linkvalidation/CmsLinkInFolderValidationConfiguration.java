...
/**
 * Configuration for Check relation to resources outside of folder - app.<p>
 */
public class CmsLinkInFolderValidationConfiguration extends A_CmsWorkplaceAppConfiguration {

    /** The app id. */
    public static final String APP_ID = "link-validation-infolder";
    ...
    public String getAppCategory() {
        ...
        return CmsLinkValidationFolder.ID;
    }
    ...
    public I_CmsWorkplaceApp getAppInstance() {
        ...
        return new CmsLinkInFolderValidationApp();
    }
    ...
    public String getHelpText(@RUntainted Locale locale) {
        ...
        return Messages.get().getBundle(locale).key(Messages.GUI_LINKVALIDATION_CHECK_FOLDER_RELATIONS_HELP_0);
    }
    ...
    public String getName(@RUntainted Locale locale) {
        ...
        return Messages.get().getBundle(locale).key(Messages.GUI_LINKVALIDATION_CHECK_FOLDER_RELATIONS_0);
    }
