...
public class CmsLinkValidationExternalConfiguration extends A_CmsWorkplaceAppConfiguration {
  ...
  public String getButtonStyle() {
    ...
    return FontOpenCms.SPHERE.getButtonOverlayStyle() + " " + OpenCmsTheme.BUTTON_OVERLAY_BLUE;
  }
  ...
  public String getHelpText(@RUntainted Locale locale) {
    ...
    return Messages.get()
        .getBundle(locale)
        .key(Messages.GUI_LINKVALIDATION_EXTERNALLINK_ADMIN_TOOL_NAME_HELP_0);
  }
  ...
  public String getName(@RUntainted Locale locale) {
    ...
    return Messages.get()
        .getBundle(locale)
        .key(Messages.GUI_LINKVALIDATION_EXTERNALLINK_ADMIN_TOOL_NAME_0);
  }
