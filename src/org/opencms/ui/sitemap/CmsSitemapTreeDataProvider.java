...
public class CmsSitemapTreeDataProvider {
     ...
     * @return the children
     */
    public List<@RUntainted CmsSitemapTreeNodeData> getChildren(CmsSitemapTreeNodeData nodeData) {

        CmsClientSitemapEntry entry = nodeData.getClientEntry();

        List<@RUntainted CmsSitemapTreeNodeData> result = Lists.newArrayList();
