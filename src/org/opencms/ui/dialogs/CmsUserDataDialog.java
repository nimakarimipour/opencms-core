...
public class CmsUserDataDialog extends CmsBasicDialog implements I_CmsHasTitle {
  ...
  public String getTitle(Locale locale) {
    ...
    return org.opencms.ui.components.Messages.get()
        .getBundle(locale)
        .key(org.opencms.ui.components.Messages.GUI_USER_EDIT_0);
  }
    ...
    try {
      bundle =
          CmsResourceBundleLoader.getBundle(
              "org.opencms.userdatacheck.custom", A_CmsUI.get().getLocale());
      return bundle.getString("userdatacheck.text");
    } catch (MissingResourceException e) {
      return CmsVaadinUtils.getMessageText(
          org.opencms.ui.dialogs.Messages.GUI_USER_DATA_CHECK_INFO_0);
    }
  }
