...
public class CmsPermissionBean {
   ...
   */
  public static CmsPermissionBean getBeanForPrincipal(
      Set<CmsPermissionBean> beans, String principalName) {
  ...
  public boolean equals(Object o) {
    ...
    return bean.getPrincipalName().equals(m_principalName)
        && bean.getPrincipalType().equals(m_principalType);
  }
