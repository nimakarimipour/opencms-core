...
public class CmsGalleryOptimizeDialog extends CmsBasicDialog {
      ...
      if (uuid != null) {
        try {
          ...
          CmsResource resource =
              getCms().readResource(new CmsUUID(uuid), CmsResourceFilter.ONLY_VISIBLE);
          ...
          Notification notification =
              new Notification(message, "", Notification.Type.HUMANIZED_MESSAGE);
          ...
          Notification notification =
              new Notification("", e.getLocalizedMessage(), Notification.Type.ERROR_MESSAGE);
  ...
  /**
   * Class representing an editable gallery item.
   *
   * <p>
   */
  private class DataItem {
    ...
    /**
     * Returns the binder of this editable gallery item.
     *
     * <p>
     *
     * @return the binder
    ...
    /**
     * Returns the file composite of this editable gallery item.
     *
     * <p>
     *
    ...
    /**
     * Returns the file delete composite of this editable gallery item.
     *
     * <p>
     *
    ...
    /**
     * Returns the form composite of this editable gallery item.
     *
     * <p>
     *
    ...
    /**
     * Returns the copyright information of this editable gallery item.
     *
     * <p>
     *
    ...
    /**
     * Returns the date when this editable gallery item was last modified.
     *
     * <p>
     *
     * @return the date
    ...
    /**
     * Returns whether this editable gallery item shall be deleted.
     *
     * <p>
     *
    ...
    /**
     * Returns the description of this editable gallery item.
     *
     * <p>
     *
    ...
    /**
     * Returns whether this editable gallery item is used.
     *
     * <p>
     *
    ...
    /**
     * Returns the name of this editable gallery item.
     *
     * <p>
     *
     * @return the name
    ...
    /**
     * Returns whether this data item has no copyright information.
     *
     * <p>
     *
    ...
    /**
     * Returns the full path of this editable gallery item.
     *
     * <p>
     *
    ...
    /**
     * Converts the form data of this editable gallery item into a list of CMS properties.
     *
     * <p>
     *
    ...
    public List<CmsProperty> getPropertyList() {
      ...
      propertyList.add(
          new CmsProperty(CmsPropertyDefinition.PROPERTY_COPYRIGHT, m_copyright, null));
      propertyList.add(
          new CmsProperty(CmsPropertyDefinition.PROPERTY_DESCRIPTION, m_description, null));
      return propertyList;
    }

    /**
     * Returns the CMS resource this editable gallery item was created from.
     *
     * <p>
     *
    ...
    /**
     * Returns the CMS resource utility class for this editable gallery item.
     *
     * <p>
     *
    ...
    /**
     * Returns the title of this editable gallery item.
     *
     * <p>
     *
     * @return the title
    ...
    /**
     * Returns whether this editable gallery item has value changes compared to the property values
     * actually persisted.
     *
     * <p>
     *
    ...
    /**
     * Returns whether this editable gallery item is renamed compared to the resource actually
     * persisted.
     *
     * <p>
     *
    ...
    /**
     * Returns whether this editable gallery item is an image.
     *
     * <p>
     *
    ...
    public boolean isTypeImage() {
      ...
      return OpenCms.getResourceManager().getResourceType(m_resource)
          instanceof CmsResourceTypeImage;
    }

    /**
     * Sets the copyright information of this editable gallery item.
     *
     * <p>
     *
    ...
    /**
     * Sets the flag that states whether this editable gallery item shall be deleted.
     *
     * <p>
     *
    ...
    /**
     * Sets the description of this editable gallery item.
     *
     * <p>
     *
    ...
    /**
     * Sets the name of this editable gallery item.
     *
     * <p>
     *
     * @param name the name
    ...
    /**
     * Sets the CMS resource of this editable gallery item and re-initializes all data and
     * components.
     *
     * <p>
     *
    ...
    /**
     * Sets the title of this editable gallery item.
     *
     * <p>
     *
    ...
    /**
     * Initializes all UI components of this editable gallery item and initializes all data fields.
     *
     * <p>
     */
    ...
    /**
     * Initializes all data of this editable gallery item.
     *
     * <p>
     */
    private void initData() {
      ...
      try {
        List<CmsRelation> relations =
            getCms().getRelationsForResource(m_resource, CmsRelationFilter.SOURCES);
    ...
    /**
     * Reads the persisted resource name.
     *
     * <p>
     *
    ...
    /**
     * Reads the persisted copyright property value.
     *
     * <p>
     *
    ...
    private String readPropertyCopyright() throws CmsException {
      ...
      String value =
          getCms()
              .readPropertyObject(m_resource, CmsPropertyDefinition.PROPERTY_COPYRIGHT, false)
              .getValue();
      return value == null ? "" : value;
    }

    /**
     * Reads the persisted description property value.
     *
     * <p>
     *
    ...
    private String readPropertyDescription() throws CmsException {
      ...
      String value =
          getCms()
              .readPropertyObject(m_resource, CmsPropertyDefinition.PROPERTY_DESCRIPTION, false)
              .getValue();
      return value == null ? "" : value;
    }

    /**
     * Reads the persisted title property value.
     *
     * <p>
     *
    ...
    private String readPropertyTitle() throws CmsException {
      ...
      String value =
          getCms()
              .readPropertyObject(m_resource, CmsPropertyDefinition.PROPERTY_TITLE, false)
              .getValue();
      return value == null ? "" : value;
    }
  }
  ...
  /**
   * Class representing the data list header view with components for sorting, paging, and filtering
   * the gallery item list.
   *
   * <p>
   */
  private class DataListHeaderComposite extends AbsoluteLayout {
    ...
    /**
     * Programmatically selects a page according to a given index.
     *
     * <p>
     *
    ...
    /**
     * Creates a select box for page select.
     *
     * <p>
     *
    ...
    /**
     * Creates a select box for sort order select.
     *
     * <p>
     *
    ...
    private NativeSelect<String> createSelectSortOrder() {
      ...
      selectSortOrder.addValueChangeListener(
          event -> {
            if (event.isUserOriginated()) {
              selectPage(0);
    ...
    /**
     * Creates a text field for filtering.
     *
     * <p>
     *
    ...
    private TextField createTextFieldFilter() {
      ...
      textField.setPlaceholder(
          CmsVaadinUtils.getMessageText(org.opencms.ui.apps.Messages.GUI_EXPLORER_FILTER_0));
    ...
    /**
     * Filter change event handler. Updates the page info label and the gallery list.
     *
     * <p>
     *
    ...
    /**
     * Page change event handler. Updates the page info label.
     *
     * <p>
     *
  ...
  /**
   * Class representing a file composite offering a file preview.
   *
   * <p>
   */
  private class FileComposite extends HorizontalLayout {
    ...
    private static final String SCALE_PARAMETERS =
        "t:1,c:ffffff,w:" + IMAGE_WIDTH + ",h:" + IMAGE_HEIGHT;
    ...
    /**
     * Creates a new file composite for a given data item.
     *
     * <p>
     *
     * @param dataItem the data item
    ...
    /**
     * Utility function to create a clickable image.
     *
     * <p>
     *
    ...
    private Label createClickableImage() {
      ...
      String a =
          "<a target=\"_blank\" href=\"" + getPermanentUri(resource) + "\">" + image + "</a>";
      String div =
          "<div class=\""
    ...
    /**
     * Utility function to create a permanent URI for a file preview.
     *
     * <p>
     *
     * @param resource the CMS resource
    ...
    /**
     * Utility function to create a permanent URI for a scaled preview image.
     *
     * <p>
     *
     * @param resource the CMS resource
  ...
  /**
   * Class representing a file delete composite with a check box to mark a file as deleted.
   *
   * <p>
   */
  private class FileDeleteComposite extends VerticalLayout {
    ...
    /**
     * Creates a new file delete composite for a given data item.
     *
     * <p>
     *
     * @param dataItem the data item
    ...
    /**
     * Creates a component displaying the dimension of this editable gallery item.
     *
     * <p>
     *
    ...
    /**
     * Creates a component displaying the size of this editable gallery item.
     *
     * <p>
     *
     * @return the display component
    ...
    /**
     * Creates a component displaying whether this editable gallery item is used.
     *
     * <p>
     *
     * @return the display component
    ...
    private Label createDisplayInUseInfo() {
      ...
      String notInUse =
          CmsVaadinUtils.getMessageText(Messages.GUI_GALLERY_OPTIMIZE_LABEL_NOT_IN_USE_0);
      return new Label(notInUse);
    }

    /**
     * Creates a check box to mark an item as deleted.
     *
     * <p>
     *
    ...
    private CheckBox createFieldDeleteFlag() {
      ...
      String caption =
          CmsVaadinUtils.getMessageText(Messages.GUI_GALLERY_OPTIMIZE_INPUT_DELETE_UNUSED_0);
    ...
    /**
     * Returns the dimension of this file in the case the file is an image.
     *
     * <p>
     *
    ...
    private String getFormattedDimension() {
      ...
      try {
        imageSize =
            getCms()
                .readPropertyObject(
                    m_dataItem.getResource(), CmsPropertyDefinition.PROPERTY_IMAGE_SIZE, false)
                .getValue();
      } catch (CmsException e) {
        LOG.warn(e.getLocalizedMessage(), e);
      }
    ...
    /**
     * Returns the size of this editable gallery item in a formatted way.
     *
     * <p>
     *
  ...
  /**
   * Filter handler. Keeps track of the query string with which the user currently filters the
   * gallery.
   */
  ...
  /**
   * Class representing a form composite to edit gallery item data.
   *
   * <p>
   */
  private class FormComposite extends VerticalLayout {
    ...
    /**
     * Creates a new form composite for a given data item.
     *
     * <p>
     *
     * @param dataItem the data item
    ...
    private CmsResourceInfo createCompositeResourceInfo() {
      ...
      CmsGwtContextMenuButton contextMenu =
          new CmsGwtContextMenuButton(
              m_dataItem.getResource().getStructureId(), new ContextMenu(m_dataItem));
    ...
    /**
     * Returns a component to display resource date information.
     *
     * <p>
     *
     * @return the component
    ...
    /**
     * Creates the copyright form field.
     *
     * <p>
     *
    ...
    /**
     * Creates the description form field.
     *
     * <p>
     *
    ...
    private TextField createFieldDescription() {
      ...
      String caption =
          CmsVaadinUtils.getMessageText(Messages.GUI_GALLERY_OPTIMIZE_INPUT_DESCRIPTION_0);
      TextField field = new TextField(caption);
      field.setWidthFull();
      field.setEnabled(!CmsGalleryOptimizeDialog.this.isReadOnly());
    ...
    private TextField createFieldTitle() {
      ...
      String caption =
          CmsVaadinUtils.getMessageText(org.opencms.workplace.explorer.Messages.GUI_INPUT_TITLE_0);
      TextField field = new TextField(caption);
      field.setWidthFull();
      field.setEnabled(!CmsGalleryOptimizeDialog.this.isReadOnly());
  ...
  private class PageHandler {
    ...
    /**
     * Returns the number of the first item on the page currently selected. The first item on the
    ...
    /**
     * Returns the number of the last item on the page currently selected. The number of the last
     * item on the last page is equal to the total number of items.
     *
    ...
    /**
     * Returns the index of the first item on the page currently selected. The index of the first
     * item on the first page is 0.
     *
     * <p>
     *
    ...
    /**
     * Sets the current page index to a given value. The index of the first page is 0.
     *
     * <p>
     *
  ...
  private class Provider extends ListDataProvider<DataItem> {
    ...
    final SerializableComparator<DataItem> SORT_DATE_ASCENDING =
        Comparator.comparing(DataItem::getDateLastModified)::compare;

    /** Comparator. */
    final SerializableComparator<DataItem> SORT_DATE_DESCENDING =
        Comparator.comparing(DataItem::getDateLastModified).reversed()::compare;

    /** Comparator. */
    final SerializableComparator<DataItem> SORT_PATH_ASCENDING =
        Comparator.comparing(DataItem::getPath, String.CASE_INSENSITIVE_ORDER)::compare;

    /** Comparator. */
    final SerializableComparator<DataItem> SORT_PATH_DESCENDING =
        Comparator.comparing(DataItem::getPath, String.CASE_INSENSITIVE_ORDER).reversed()::compare;

    /** Comparator. */
    final SerializableComparator<DataItem> SORT_TITLE_ASCENDING =
        Comparator.comparing(DataItem::getTitle, String.CASE_INSENSITIVE_ORDER)::compare;

    /** Comparator. */
    final SerializableComparator<DataItem> SORT_TITLE_DESCENDING =
        Comparator.comparing(DataItem::getTitle, String.CASE_INSENSITIVE_ORDER).reversed()::compare;

    /** Comparator. */
    final SerializableComparator<DataItem> SORT_UNUSED_FIRST =
        Comparator.comparing(DataItem::getIsUsed)::compare;

    /** Comparator. */
    final SerializableComparator<DataItem> SORT_NOCOPYRIGHT_FIRST =
        Comparator.comparing(DataItem::getNoCopyright)::compare;
    ...
    /**
     * Fetches one page of the sorted, filtered in-memory data item list.
     *
     * <p>
     *
    ...
    public List<DataItem> fetch(PageHandler pageHandler, FilterHandler filterHandler) {
      ...
      Query<DataItem, SerializablePredicate<DataItem>> query =
    ...
    /**
     * Composes a provider query for a given filter handler.
     *
     * <p>
     *
  ...
  /**
   * Utility class to handle dialog save actions. Keeps track of the changes the user has made since
   * opening the dialog on the one hand and the changes since the last save action on the other.
   */
  private class SaveHandler {
    ...
    /**
     * Marks the last save action as cancelled.
     *
     * <p>
     *
    ...
    /**
     * Returns the data items modified or marked deleted since the last save action.
     *
     * <p>
     *
    ...
    /**
     * Returns the data items marked deleted since the last save action.
     *
     * <p>
     *
     * @return the data items
    ...
    /**
     * Returns the resources marked deleted since the last save action.
     *
     * <p>
     *
    ...
    /**
     * Whether data items have been marked as deleted since the last save action.
     *
     * <p>
     *
    ...
    /**
     * Handles a save action for a given list of data items.
     *
     * <p>
     *
  ...
  /**
   * Creates a new instance of a gallery optimize dialog.
   *
   * <p>
   *
  ...
  /**
   * Refreshes the UI state after a list of data items has been successfully deleted.
   *
   * <p>
   *
  ...
  /**
   * Refreshes the UI state after a list of data items has been successfully updated.
   *
   * <p>
   *
  ...
  void handleDataListUpdate(List<DataItem> dataItemList) throws CmsException {
    ...
    for (DataItem dataItem : dataItemList) {
      CmsResourceFilter resourceFilter = CmsResourceFilter.IGNORE_EXPIRATION.addRequireFile();
      CmsResource reload =
          getCms().readResource(dataItem.getResource().getStructureId(), resourceFilter);
  ...
  /**
   * Event handler that discards all data edited and closes the dialog. Asks the user for
  ...
  void handleDialogCancel() {
    ...
    if (dataListHasChanges()) {
      String title =
          CmsVaadinUtils.getMessageText(Messages.GUI_GALLERY_OPTIMIZE_CONFIRM_CANCEL_TITLE_0);
      String message =
          CmsVaadinUtils.getMessageText(Messages.GUI_GALLERY_OPTIMIZE_CONFIRM_CANCEL_0);
  ...
  void handleDialogSave(boolean exit) {
    ...
    if (m_saveHandler.hasDeletedCurrent()) {
      String title =
          CmsVaadinUtils.getMessageText(Messages.GUI_GALLERY_OPTIMIZE_CONFIRM_DELETE_TITLE_0);
      String message =
          CmsVaadinUtils.getMessageText(Messages.GUI_GALLERY_OPTIMIZE_CONFIRM_DELETE_0);
      CmsConfirmationDialog confirmationDialog =
          CmsConfirmationDialog.show(
              title,
              message,
              new Runnable() {
      ...
      confirmationDialog.displayResourceInfo(
          m_saveHandler.getDeletedCurrentResource(), org.opencms.ui.Messages.GUI_SELECTED_0);
    } else {
      persist();
      if (exit) {
        finishDialog(m_saveHandler.getChangedIds());
  ...
  /**
   * For a given gallery folder resource, creates a panel with information whether this gallery is
   * in use.
   *
   * <p>
   *
  ...
  /**
   * Creates a component showing a warning if this dialog was opened from the online project
   * context.
   *
   * <p>
   *
  ...
  /**
   * Whether one of the editable gallery items has been modified by the user.
   *
   * <p>
   *
  ...
  /**
   * Displays the UI component representing the dialog header view.
   *
   * <p>
   */
  private void displayDataListHeaderView() {
    ...
    if (isReadOnly()) {
      ...
      try {
        List<CmsRelation> relations =
            getCms().getRelationsForResource(m_gallery, CmsRelationFilter.SOURCES);
  ...
  /**
   * Displays the UI component representing the scrollable gallery item list.
   *
   * <p>
   *
  ...
  /**
   * Sorts the gallery item list according to a given sort order and re-renders the gallery item
   * list view.
   *
   * <p>
   *
  ...
  /**
   * Returns the gallery title for a given gallery folder resource.
   *
   * <p>
   *
   * @return the title
  ...
  private String getGalleryTitle() throws CmsException {
    ...
    String galleryTitle =
        getCms()
            .readPropertyObject(m_gallery, CmsPropertyDefinition.PROPERTY_TITLE, false)
            .getValue();
  ...
  /**
   * Returns the current sort order saved in the user session with lazy initialization.
   *
   * <p>
   *
  ...
  private String getSessionSortOrder() {
    ...
    String currentSortOrder =
        (String) wrappedSession.getAttribute(GALLERY_OPTIMIZE_ATTR_SORT_ORDER);
  ...
  private void initEvents() {
    ...
    m_buttonSave.addClickListener(
        event -> {
          CmsGalleryOptimizeDialog.this.handleDialogSave(false);
        });
    m_buttonSaveAndExit.addClickListener(
        event -> {
  ...
  private void initMessages() {
    ...
    m_messageSortDateLastModifiedAscending =
        CmsVaadinUtils.getMessageText(Messages.GUI_GALLERY_OPTIMIZE_SORT_DATE_MODIFIED_ASCENDING_0);
    m_messageSortDateLastModifiedDescending =
        CmsVaadinUtils.getMessageText(
            Messages.GUI_GALLERY_OPTIMIZE_SORT_DATE_MODIFIED_DESCENDING_0);
    m_messageSortPathAscending =
        CmsVaadinUtils.getMessageText(Messages.GUI_GALLERY_OPTIMIZE_SORT_PATH_ASCENDING_0);
    m_messageSortPathDescending =
        CmsVaadinUtils.getMessageText(Messages.GUI_GALLERY_OPTIMIZE_SORT_PATH_DESCENDING_0);
    m_messageSortTitleAscending =
        CmsVaadinUtils.getMessageText(Messages.GUI_GALLERY_OPTIMIZE_SORT_TITLE_ASCENDING_0);
    m_messageSortTitleDescending =
        CmsVaadinUtils.getMessageText(Messages.GUI_GALLERY_OPTIMIZE_SORT_TITLE_DESCENDING_0);
    m_messageSortUnusedFirst =
        CmsVaadinUtils.getMessageText(Messages.GUI_GALLERY_OPTIMIZE_SORT_UNUSED_FIRST_0);
    m_messageSortNoCopyrightFirst =
        CmsVaadinUtils.getMessageText(Messages.GUI_GALLERY_OPTIMIZE_SORT_NOCOPYRIGHT_FIRST_0);
  }

  /**
   * Persists all data changes that have not been saved yet. Refreshes the UI. Informs the user
   * about failed updates, failed renames and failed deletes.
   *
   * <p>
   */
  private void persist() {
    ...
    if (errorMessageList.length() == 0) {
      String message =
          CmsVaadinUtils.getMessageText(Messages.GUI_GALLERY_OPTIMIZE_LABEL_SUCCESSFULLY_SAVED_0);
      Notification notification =
          new Notification(message, "", Notification.Type.HUMANIZED_MESSAGE);
      notification.setPosition(Position.TOP_CENTER);
      notification.show(Page.getCurrent());
      ...
      Notification notification =
          new Notification("", errorMessageList.toString(), Notification.Type.ERROR_MESSAGE);
      notification.setHtmlContentAllowed(true);
      notification.setPosition(Position.TOP_CENTER);
      notification.show(Page.getCurrent());
    }
  ...
  /**
   * Persists all deleted gallery items.
   *
   * <p>
   *
  ...
  private void persistDelete(StringBuilder errorMessageList) {
    ...
    for (DataItem dataItem : m_saveHandler.getDeletedCurrent()) {
      ...
      try {
        getCms()
            .deleteResource(getCms().getSitePath(resource), CmsResource.DELETE_PRESERVE_SIBLINGS);
  ...
  /**
   * Persists all updated and renamed gallery items.
   *
   * <p>
   *
   * @param errorMessageList string builder to append error messages
  ...
  private void persistUpdateAndRename(StringBuilder errorMessageList) {
    ...
    for (DataItem dataItem : m_saveHandler.getChangedCurrent()) {
      ...
      if (dataItem.isRenamed()) {
        ...
        String destination =
            CmsStringUtil.joinPaths(CmsResource.getParentFolder(source), dataItem.getName());
        try {
  ...
  /**
   * Saves the selected sort order in the user session.
   *
   * <p>
   *
   * @param sortOrder the sort order
