...
public class CmsResourceTableProperty implements Serializable {
  ...
  public static class DateConverter implements Converter<String, Long> {
    ...
    /**
     * @see com.vaadin.v7.data.util.converter.Converter#convertToModel(java.lang.Object,
    ...
    /**
     * @see com.vaadin.v7.data.util.converter.Converter#convertToPresentation(java.lang.Object,
     *     java.lang.Class, java.util.Locale)
     */
  ...
  public static final CmsResourceTableProperty PROPERTY_DISABLED =
      new CmsResourceTableProperty(
          "PROPERTY_DISABLED", Boolean.class, Boolean.FALSE, "", true, 0, 0);

  /** Resource table property. */
  public static final CmsResourceTableProperty PROPERTY_INSIDE_PROJECT =
      new CmsResourceTableProperty(
          "PROPERTY_INSIDE_PROJECT", Boolean.class, Boolean.TRUE, null, true, 0, 0);

  /** Resource table property. */
  public static final CmsResourceTableProperty PROPERTY_IS_FOLDER =
      new CmsResourceTableProperty("PROPERTY_IS_FOLDER", Boolean.class, null, null, true, 0, 0);

  /** Resource table property. */
  public static final CmsResourceTableProperty PROPERTY_NAVIGATION_POSITION =
      new CmsResourceTableProperty(
          "PROPERTY_NAVIGATION_POSITION", Float.class, null, null, true, 0, 0);
  ...
  public static final CmsResourceTableProperty PROPERTY_IN_NAVIGATION =
      new CmsResourceTableProperty(
          "PROPERTY_IN_NAVIGATION", Boolean.class, Boolean.FALSE, null, true, 0, 0);

  /** Resource table property. */
  public static final CmsResourceTableProperty PROPERTY_PERMISSIONS =
      new CmsResourceTableProperty(
          "PROPERTY_PERMISSIONS", String.class, null, GUI_INPUT_PERMISSIONS_0, true, 0, 100);

  /** Resource table property. */
  public static final CmsResourceTableProperty PROPERTY_PROJECT =
      new CmsResourceTableProperty(
          "PROPERTY_PROJECT", Component.class, null, GUI_LABEL_PROJECT_0, true, 0, 40);

  /** Resource table property. */
  public static final CmsResourceTableProperty PROPERTY_RELEASED_NOT_EXPIRED =
      new CmsResourceTableProperty(
          "PROPERTY_RELEASED_NOT_EXPIRED", Boolean.class, Boolean.TRUE, null, true, 0, 0);

  /** Resource table property. */
  public static final CmsResourceTableProperty PROPERTY_RESOURCE_NAME =
      new CmsResourceTableProperty(
          "PROPERTY_RESOURCE_NAME", String.class, null, GUI_INPUT_NAME_0, false, 2, 0);

  /** Resource table property. */
  public static final CmsResourceTableProperty PROPERTY_RESOURCE_TYPE =
      new CmsResourceTableProperty(
          "PROPERTY_RESOURCE_TYPE", String.class, null, GUI_INPUT_TYPE_0, true, 0, 180);
  ...
  public static final CmsResourceTableProperty PROPERTY_SITE_PATH =
      new CmsResourceTableProperty(
          "PROPERTY_SITE_PATH", String.class, null, GUI_INPUT_PATH_0, true, 0, 0);

  /** Resource table property. */
  public static final CmsResourceTableProperty PROPERTY_SIZE =
      new CmsResourceTableProperty(
          "PROPERTY_SIZE", Integer.class, null, GUI_INPUT_SIZE_0, true, 0, 100);

  /** Resource table property. */
  public static final CmsResourceTableProperty PROPERTY_STATE =
      new CmsResourceTableProperty(
          "PROPERTY_STATE", CmsResourceState.class, null, null, true, 0, 0);

  /** Resource table property. */
  public static final CmsResourceTableProperty PROPERTY_STATE_NAME =
      new CmsResourceTableProperty(
          "PROPERTY_STATE_NAME", String.class, null, GUI_INPUT_STATE_0, true, 0, 100);
  ...
  public static final CmsResourceTableProperty PROPERTY_TREE_CAPTION =
      new CmsResourceTableProperty("PROPERTY_TREE_CAPTION", String.class, null, "", false, 0, 40);

  /** Resoure table property. */
  public static final CmsResourceTableProperty PROPERTY_TYPE_ICON =
      new CmsResourceTableProperty("PROPERTY_TYPE_ICON", Component.class, null, "", false, 0, 40);

  /** Resource table property. */
  public static final CmsResourceTableProperty PROPERTY_USER_CREATED =
      new CmsResourceTableProperty(
          "PROPERTY_USER_CREATED", String.class, null, GUI_INPUT_USERCREATED_0, true, 0, 150);

  /** Resource table property. */
  public static final CmsResourceTableProperty PROPERTY_USER_LOCKED =
      new CmsResourceTableProperty(
          "PROPERTY_USER_LOCKED", String.class, null, GUI_INPUT_LOCKEDBY_0, true, 0, 150);

  /** Resource table property. */
  public static final CmsResourceTableProperty PROPERTY_USER_MODIFIED =
      new CmsResourceTableProperty(
          "PROPERTY_USER_MODIFIED", String.class, null, GUI_INPUT_USERLASTMODIFIED_0, true, 0, 150);
  ...
  public boolean equals(Object other) {
    ...
    return (other instanceof CmsResourceTableProperty)
        && ((CmsResourceTableProperty) other).m_id.equals(m_id);
  }
  ...
  /**
   * Checks whether this is an edit property.
   *
   * <p>
   *
