...
public class CmsExternalLayout extends AbstractComponent implements HasComponents {
  ...
  /**
   * Create a layout that renders the given component to an external HTML element that has the
   * specified id
   *
   * @param divId id for the target element, cannot be null
   * @param component component to be rendered, cannot be null
   */
