...
public abstract class A_CmsFileSelectField<T> extends CustomField<T>
  ...
  protected CssLayout initContent() {
    ...
    m_fileSelectButton.addClickListener(
        new ClickListener() {
  ...
  protected void openFileSelector() {
    ...
    try {
      ...
      fileSelect.addSelectionHandler(
  ...
  private String getWindowCaption() {
    ...
    if (m_requireFolder) {
      return CmsVaadinUtils.getMessageText(
          org.opencms.ui.components.Messages.GUI_FOLDER_SELECT_CAPTION_0);
    }
    return CmsVaadinUtils.getMessageText(
        org.opencms.ui.components.Messages.GUI_FILE_SELECT_CAPTION_0);
  }
}
