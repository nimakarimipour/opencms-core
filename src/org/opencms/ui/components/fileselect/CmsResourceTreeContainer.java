...
public class CmsResourceTreeContainer extends HierarchicalContainer {
  ...
  protected void defineProperties() {
    ...
    addContainerProperty(
        CmsResourceTableProperty.PROPERTY_INSIDE_PROJECT, Boolean.class, Boolean.TRUE);
    ...
    addContainerProperty(
        CmsResourceTableProperty.PROPERTY_IN_NAVIGATION, Boolean.class, Boolean.FALSE);
    addContainerProperty(
  ...
  protected void fillProperties(
      CmsObject cms, Item resourceItem, CmsResource resource, CmsUUID parentId) {
    ...
    try {
      ...
      resourceItem
          .getItemProperty(CmsResourceTableProperty.PROPERTY_IN_NAVIGATION)
          .setValue(Boolean.valueOf(inNavigation));
      String navText = null;
      if (nav != null) {
        if (inNavigation) {
          resourceItem
      ...
      resourceItem
          .getItemProperty(CmsResourceTableProperty.PROPERTY_NAVIGATION_TEXT)
          .setValue(navText);
