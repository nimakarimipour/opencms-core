...
public class CmsCodeMirror extends AbstractJavaScriptComponent
  ...
  static {
    ...
    try {
      BLUR_METHOD =
          FieldEvents.BlurListener.class.getDeclaredMethod(
              "blur", new Class[] {FieldEvents.BlurEvent.class});
    } catch (final java.lang.NoSuchMethodException e) {
      // This should never happen
      throw new java.lang.RuntimeException("Internal error finding methods in ValueChangeListener");
    }
      ...
      JAVASCRIPT_URIS =
          new String[] {
            ...
            CmsWorkplace.getStaticResourceUri(
                "/editors/codemirror/dist/addon/search/searchcursor.js"),
            CmsWorkplace.getStaticResourceUri("/editors/codemirror/js/search.js"),
            CmsWorkplace.getStaticResourceUri(
                "/editors/codemirror/dist/addon/edit/closebrackets.js"),
            CmsWorkplace.getStaticResourceUri("/editors/codemirror/dist/addon/edit/closetag.js"),
            CmsWorkplace.getStaticResourceUri(
                "/editors/codemirror/dist/addon/edit/matchbrackets.js"),
            ...
            CmsWorkplace.getStaticResourceUri(
                "/editors/codemirror/dist/addon/hint/javascript-hint.js"),
            ...
            CmsWorkplace.getStaticResourceUri(
                "/editors/codemirror/dist/addon/selection/active-line.js"),
            ...
            CmsWorkplace.getStaticResourceUri(
                "/editors/codemirror/dist/mode/javascript/javascript.js"),
            CmsWorkplace.getStaticResourceUri("/editors/codemirror/dist/mode/css/css.js"),
            CmsWorkplace.getStaticResourceUri(
                "/editors/codemirror/dist/mode/htmlmixed/htmlmixed.js"),
  ...
  /**
   * @see
   *     com.vaadin.v7.data.Property.ValueChangeNotifier#addListener(com.vaadin.v7.data.Property.ValueChangeListener)
   * @deprecated use {@link
  ...
  /**
   * @see
   *     com.vaadin.v7.data.Property.ValueChangeNotifier#addValueChangeListener(com.vaadin.v7.data.Property.ValueChangeListener)
   */
  ...
  /**
   * @see
   *     com.vaadin.v7.data.Property.ValueChangeNotifier#removeListener(com.vaadin.v7.data.Property.ValueChangeListener)
   * @deprecated use {@link
   *     #removeValueChangeListener(com.vaadin.v7.data.Property.ValueChangeListener)}
   */
  @Deprecated
  ...
  /**
   * @see
   *     com.vaadin.v7.data.Property.ValueChangeNotifier#removeValueChangeListener(com.vaadin.v7.data.Property.ValueChangeListener)
   */
  ...
  /**
   * Returns the code mirror localization JSON.
   *
   * <p>
   *
  ...
  /**
   * Returns the localized short cut messages HTML.
   *
   * <p>
   *
   * @param messages the message bundle to use
  ...
  private String getShortcutMessages(CmsMessages messages) {
    ...
    buffer
        .append("<span class=\"col1\"><b>")
        .append(messages.key(Messages.GUI_CODEMIRROR_SHORTCUT_SEARCH_0));
    buffer.append("</b> ").append(messages.key(Messages.GUI_CODEMIRROR_SHORTCUT_SEARCH_HELP_0));
    buffer
        .append(" </span><span class=\"col2\"><b>")
        .append(messages.key(Messages.GUI_CODEMIRROR_SHORTCUT_FIND_NEXT_0));
    buffer.append("</b> ").append(messages.key(Messages.GUI_CODEMIRROR_SHORTCUT_FIND_NEXT_HELP_0));
    buffer
        .append(" </span><span class=\"col3\"><b>")
        .append(messages.key(Messages.GUI_CODEMIRROR_SHORTCUT_FIND_PREVIOUS_0));
    buffer
        .append("</b> ")
        .append(messages.key(Messages.GUI_CODEMIRROR_SHORTCUT_FIND_PREVIOUS_HELP_0));
    buffer
        .append(" </span><span class=\"col1\"><b>")
        .append(messages.key(Messages.GUI_CODEMIRROR_SHORTCUT_REPLACE_0));
    buffer.append("</b> ").append(messages.key(Messages.GUI_CODEMIRROR_SHORTCUT_REPLACE_HELP_0));
    buffer
        .append(" </span><span class=\"col2\"><b>")
        .append(messages.key(Messages.GUI_CODEMIRROR_SHORTCUT_REPLACE_ALL_0));
    buffer
        .append("</b> ")
        .append(messages.key(Messages.GUI_CODEMIRROR_SHORTCUT_REPLACE_ALL_HELP_0))
        .append("</span>");
