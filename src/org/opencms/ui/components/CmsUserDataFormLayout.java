...
public class CmsUserDataFormLayout extends FormLayout {
  ...
  /**
   * Validator employing the configured OpenCms validation handler.
   *
   * <p>
   */
  ...
  /**
   * Builds the text field for the given property.
   *
   * <p>
   *
    ...
    if (info.isAdditionalInfo()) {
      String label =
          CmsVaadinUtils.getMessageText(
              "GUI_USER_DATA_" + info.getAddInfoKey().toUpperCase() + "_0");
      ...
      return CmsVaadinUtils.getMessageText(
          "GUI_USER_DATA_" + info.getField().name().toUpperCase() + "_0");
    }
  }
