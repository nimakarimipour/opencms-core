 ...
 *
 * <p>From the client side, the extension allows to return an Array of UUIDs of changed resources
 * over an Rpc-Interface.
 *
 * <p>
 */
public class CmsJSPBrowserFrameExtension extends AbstractExtension
   ...
   * Private constructor.
   *
   * <p>Only called from static method in this class.
   *
   * <p>
   *
   * @param link of jsp
  ...
  /**
   * Creates Set of type CmsUUID from String array.
   *
   * <p>
   *
