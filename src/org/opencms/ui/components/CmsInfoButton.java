...
public class CmsInfoButton extends Button {
  ...
  /**
   * Bean holding further Vaadin elements and theire position.
   *
   * <p>
   */
  ...
  protected VerticalLayout getLayout(
      final List<String> htmlLines, final List<InfoElementBean> additionalElements) {
  ...
  /**
   * Creates html code from given map.
   *
   * <p>
   *
