...
public class CmsResourceTable extends CustomComponent {
  ...
  /**
   * Helper class for easily configuring a set of columns to display, together with their visibility
   * / collapsed status.
   *
   * <p>
   */
  ...
  /**
   * Contains the data for the given column, along with some flags to control visibility/collapsed
   * status.
   *
   * <p>
   */
  ...
  public static class DefaultItemDescriptionGenerator implements ItemDescriptionGenerator {
    ...
    /**
     * @see
     *     com.vaadin.v7.ui.AbstractSelect.ItemDescriptionGenerator#generateDescription(com.vaadin.ui.Component,
    ...
    public String generateDescription(Component source, Object itemId, Object propertyId) {
      ...
      try {
        if ((propertyId != null) && (itemId != null)) {
          Property prop =
              table.getContainerDataSource().getItem(itemId).getItemProperty(propertyId);
          ...
          if (CmsResourceTableProperty.PROPERTY_RESOURCE_NAME == propertyId) {
            ...
            return converter.convertToPresentation(
                prop.getValue(), String.class, A_CmsUI.get().getLocale());
   ...
   *
   * <p>This constructor does *not* set up the columns of the table; use the ColumnBuilder inner
   * class for this.
   */
  ...
  /**
   * Static helper method to initialize the 'standard' properties of a data item from a given
   * resource.
   *
   * <p>
   *
  ...
  public static void fillItemDefault(
    ...
    if (resourceItem.getItemProperty(PROPERTY_TYPE_ICON) != null) {
      resourceItem
          .getItemProperty(PROPERTY_TYPE_ICON)
    ...
    if (resourceItem.getItemProperty(PROPERTY_PROJECT) != null) {
      ...
      switch (resUtil.getProjectState().getMode()) {
        case 1:
          projectFlag =
              new Label(
                  new CmsCssIcon(OpenCmsTheme.ICON_PROJECT_CURRENT)
                      .getHtml(resUtil.getLockedInProjectName()),
                  ContentMode.HTML);
          break;
        case 2:
          projectFlag =
              new Label(
                  new CmsCssIcon(OpenCmsTheme.ICON_PROJECT_OTHER)
                      .getHtml(resUtil.getLockedInProjectName()),
                  ContentMode.HTML);
          break;
        case 5:
          projectFlag =
              new Label(
                  new CmsCssIcon(OpenCmsTheme.ICON_PUBLISH)
                      .getHtml(resUtil.getLockedInProjectName()),
                  ContentMode.HTML);
          break;
        default:
    ...
    if ((resourceItem.getItemProperty(PROPERTY_NAVIGATION_TEXT) != null)
        && (resourceProps != null)) {
      resourceItem
          .getItemProperty(PROPERTY_NAVIGATION_TEXT)
          .setValue(
    ...
    if ((resourceItem.getItemProperty(PROPERTY_NAVIGATION_POSITION) != null)
      ...
      try {
        Float navPos =
            resourceProps.containsKey(CmsPropertyDefinition.PROPERTY_NAVPOS)
    ...
    if ((resourceItem.getItemProperty(PROPERTY_COPYRIGHT) != null) && (resourceProps != null)) {
      resourceItem
          .getItemProperty(PROPERTY_COPYRIGHT)
          .setValue(
    ...
    if ((resourceItem.getItemProperty(PROPERTY_CACHE) != null) && (resourceProps != null)) {
      resourceItem
          .getItemProperty(PROPERTY_CACHE)
          .setValue(
    ...
    if (resourceItem.getItemProperty(PROPERTY_RESOURCE_TYPE) != null) {
      resourceItem
          .getItemProperty(PROPERTY_RESOURCE_TYPE)
    ...
    if (resourceItem.getItemProperty(PROPERTY_IS_FOLDER) != null) {
      resourceItem
          .getItemProperty(PROPERTY_IS_FOLDER)
          .setValue(Boolean.valueOf(resource.isFolder()));
    }
    ...
    if (resourceItem.getItemProperty(PROPERTY_DATE_CREATED) != null) {
      resourceItem
          .getItemProperty(PROPERTY_DATE_CREATED)
          .setValue(Long.valueOf(resource.getDateCreated()));
    }
  ...
  public void fillTable(
      CmsObject cms, List<CmsResource> resources, boolean clearFilter, boolean sort) {
