...
public class CmsCategorySelectDialog extends CmsBasicDialog {
  ...
  public void removeSelectionHandler(
      I_CmsSelectionHandler<Collection<CmsCategory>> selectionHandler) {
  ...
  /**
   * Adds a filter to the category tree container.
   *
   * <p>
   *
          ...
          new Filter() {
            ...
            public boolean passesFilter(Object itemId, Item item)
              ...
              return cat.getPath().toLowerCase().contains(lowerCaseFilter)
                  || ((cat.getTitle() != null)
                      && cat.getTitle().toLowerCase().contains(lowerCaseFilter));
            }
          });
    }
  }
