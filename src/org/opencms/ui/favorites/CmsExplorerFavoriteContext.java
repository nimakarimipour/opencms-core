...
public class CmsExplorerFavoriteContext implements I_CmsFavoriteContext {
  ...
  public void changeProject(CmsUUID value) {
    ...
    CmsExplorerDialogContext context =
        new CmsExplorerDialogContext(ContextType.fileTable, null, m_explorer, new ArrayList<>());
    CmsProjectSelectDialog.changeSiteOrProject(context, value, null);
  }

  /**
   * @see
   *     org.opencms.ui.favorites.I_CmsFavoriteContext#changeSite(org.opencms.ui.components.CmsExtendedSiteSelector.SiteSelectorOption)
   */
  ...
  /**
   * @see
   *     org.opencms.ui.favorites.I_CmsFavoriteContext#openFavorite(org.opencms.ui.favorites.CmsFavoriteEntry)
   */
