 ...
 *
 * <p>When loading favorites, the individual entries are validated by trying to read the
 * resources/projects they reference. If this fails, the entries are discareded from the returned
 * list.
 */
public class CmsFavoriteDAO {
   ...
   *
   * <p>If the favorite entry references a resource or project that can't be read, this will return
   * false.
   *
