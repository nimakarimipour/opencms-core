 ...
 *
 * <p>The lock state is combination of how, by whom and in which project a resource is currently
 * locked.
 *
 * <p>
 *
...
public class CmsLock implements Comparable<CmsLock> {
  ...
  private static final CmsLock NULL_LOCK =
      new CmsLock("", CmsUUID.getNullUUID(), new CmsProject(), CmsLockType.UNLOCKED);
   ...
   * @return true if and only if member values of this CmsLock are the same with the compared
   *     CmsLock
   */
  @Override
  ...
  public int hashCode() {
    ...
    return m_project.hashCode()
        + m_resourceName.hashCode()
        + m_userId.hashCode()
        + m_type.hashCode();
  }

  /**
   * Returns <code>true</code> if this is an directly inherited lock.
   *
   * <p>
   *
  ...
  /**
   * Returns <code>true</code> if this is an exclusive, temporary exclusive, or directly inherited
   * lock, and the given user is the owner of this lock.
   *
   * <p>
   *
   * @param user the user to compare to the owner of this lock
   * @return <code>true</code> if this is an exclusive, temporary exclusive, or directly inherited
   *     lock, and the given user is the owner of this lock
   */
  ...
  /**
   * Returns <code>true</code> if this is an exclusive, temporary exclusive, or directly inherited
   * lock, and the current user is the owner of this lock, checking also the project of the lock.
   *
   * <p>
   *
   * @param cms the CMS context to check
   * @return <code>true</code> if this is an exclusive, temporary exclusive, or directly inherited
   *     lock, and the current user is the owner of this lock
   */
  ...
  /**
   * Returns <code>true</code> if this is an exclusive, temporary exclusive, or directly inherited
   * lock, and the given user is the owner of this lock, checking also the project of the lock.
   *
   * <p>
   *
   * @param user the user to compare to the owner of this lock
  ...
  /**
   * Returns <code>true</code> if this is an exclusive (or temporary exclusive) lock, and the given
   * user is the owner of this lock.
   *
   * <p>
   *
   * @param user the user to compare to the owner of this lock
   * @return <code>true</code> if this is an exclusive (or temporary exclusive) lock, and the given
   *     user is the owner of this lock
   */
  ...
  /**
   * Returns <code>true</code> if this is an exclusive (or temporary exclusive) lock, and the given
   * user is the owner and the given project is the project of this lock.
   *
   * <p>
   *
   * @param user the user to compare to the owner of this lock
  ...
  /**
   * Returns <code>true</code> if this is an inherited lock, which may either be directly or shared
   * inherited.
   *
   * <p>
   *
   * @return <code>true</code> if this is an inherited lock, which may either be directly or shared
   *     inherited
   */
  ...
  /**
   * Returns <code>true</code> if the given project is the project of this lock.
   *
   * <p>
   *
   * @param project the project to compare to the project of this lock
   ...
   *
   * <p>The resource is not lockable if it already has a lock of type {@link CmsLockType#PUBLISH}.
   *
   * <p>The resource is lockable either - if it is currently unlocked - if it has a lock of another
   * type set and the user is the lock owner
   *
   * @param user the user to test lockeability for
   * @return <code>true</code> if this lock blocks any operation on the locked resource until it is
   *     unlocked
   */
  ...
  /**
   * Returns <code>true</code> if this lock is the <code>NULL</code> lock which can be obtained by
   * {@link #getNullLock()}.
   *
   * <p>Only for the <code>NULL</code> lock, {@link #isUnlocked()} is <code>true</code>.
   *
   * <p>
   *
  ...
  /**
   * Returns <code>true</code> if the given user is the owner of this lock, and this lock belongs to
   * the given project.
   *
   * <p>
   *
   * @param user the user to compare to the owner of this lock
   * @param project the project to compare to the project of this lock
   * @return <code>true</code> if the given user is the owner of this lock, and this lock belongs to
   *     the given project
   */
  ...
  /**
   * Returns <code>true</code> if this is a persistent lock that should be saved when the systems
   * shuts down.
   *
   * <p>
   *
   * @return <code>true</code> if this is a persistent lock that should be saved when the systems
   *     shuts down
   */
  ...
  /**
   * Returns <code>true</code> if this is a publish lock.
   *
   * <p>
   *
  ...
  /**
   * Returns <code>true</code> if this is a shared lock.
   *
   * <p>
   *
  ...
  /**
   * Returns <code>true</code> if this is a system (2nd level) lock.
   *
   * <p>
   *
  ...
  /**
   * Returns <code>true</code> if this is a temporary lock.
   *
   * <p>
   *
  ...
  /**
   * Returns <code>true</code> if this lock is in fact unlocked.
   *
   * <p>Only if this is <code>true</code>, the result lock is equal to the <code>NULL</code> lock,
   * which can be obtained by {@link #getNullLock()}.
   *
   * <p>
   *
