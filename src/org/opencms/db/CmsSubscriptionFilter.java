...
public class CmsSubscriptionFilter extends CmsVisitedByFilter {
   ...
   *
   * <p>It is required to set the user or group manually if using this constructor.
   *
   * <p>
   */
   ...
   *
   * @param cms the current users context
   * @param addUserGroups determines if the groups of the current user should be added to the list
   *     of groups of the filter
   */
  ...
  /**
   * Sets the groups of the user currently set in this filter as the list of groups to check
