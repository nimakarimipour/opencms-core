...
public class CmsImportFolder {
     ...
     */
    public CmsImportFolder(@RUntainted byte[] content, @RUntainted String importPath, CmsObject cms, boolean noSubFolder)
    throws CmsException {
    ...
    private void importResources(@RUntainted File folder, @RUntainted String importPath) throws Exception {
        ...
        for (int i = 0; i < diskFiles.length; i++) {
            ...
            if (currentFile.isDirectory()) {
                ...
                @RUntainted byte[] content = CmsFileUtil.readFile(currentFile);
                // create the file
                try {
                    m_importedResources.add(
