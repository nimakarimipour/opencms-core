...
public class CmsImportFolder {
     ...
     */
    public CmsImportFolder(byte[] content, @RUntainted String importPath, CmsObject cms, boolean noSubFolder)
    throws CmsException {
     ...
     * @throws CmsException if something goes wrong
     */
    public CmsImportFolder(@RUntainted String importFolderName, @RUntainted String importPath, CmsObject cms)
    throws CmsException {
     ...
     * @throws CmsException if something goes wrong
     */
    public void importFolder(@RUntainted String importFolderName, @RUntainted String importPath, CmsObject cms) throws CmsException {
     ...
     * @throws CmsException if something goes wrong
     */
    public void importZip(@RUntainted byte[] content, @RUntainted String importPath, CmsObject cms, boolean noSubFolder) throws CmsException {
    ...
    throws Exception {
        ...
        while (true) {
            ...
            @RUntainted String filename = m_cms.getRequestContext().getFileTranslator().translateResource(entry.getName());
