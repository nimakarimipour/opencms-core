...
public class CmsImportFolder {
     ...
     * @throws CmsException if something goes wrong
     */
    public void importZip(byte[] content, @RUntainted String importPath, CmsObject cms, boolean noSubFolder) throws CmsException {
     ...
     * @throws Exception if something goes wrong during file IO
     */
    private void importZipResource(ZipInputStream zipStreamIn, @RUntainted String importPath, boolean noSubFolder)
    throws Exception {
