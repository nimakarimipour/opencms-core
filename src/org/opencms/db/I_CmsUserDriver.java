...
public interface I_CmsUserDriver extends I_CmsDriver {
   ...
   * @return <code>true</code>, if a group with the specified name exists, <code>false</code>
   *     otherwise
   * @throws CmsDataAccessException if something goes wrong
   */
   ...
   * @throws CmsDataAccessException if operation was not successful
   */
  List<CmsResource> getResourcesForOrganizationalUnit(
   ...
   * @throws CmsDataAccessException if operation was not successful
   */
  List<CmsUser> getUsersWithoutAdditionalInfo(
  ...
  //     * @throws CmsDataAccessException if something goes wrong
  //     */
  //    void markResourceAsVisitedBy(CmsDbContext dbc, String poolName, CmsResource resource,
  // CmsUser user)
  //    throws CmsDataAccessException;
   ...
   * project.
   *
   * <p>Within the given project, the resource is identified by its offlineId, in the online
   * project, it is identified by the given onlineId.
   *
   * <p>
   *
   * @param dbc the current database context
  ...
  //     * @throws CmsDataAccessException if something goes wrong
  //     */
  //    List<CmsResource> readAllSubscribedResources(CmsDbContext dbc, String poolName, CmsPrincipal
  // principal)
  //    throws CmsDataAccessException;
   ...
   * @return an access control entry that defines the permissions of the principal for the given
   *     resource
   * @throws CmsDataAccessException if something goes wrong
   */
  ...
  //     * @throws CmsDataAccessException if something goes wrong
  //     */
  //    List<CmsResource> readResourcesVisitedBy(CmsDbContext dbc, String poolName,
  ...
  //     * @param parent the parent resource (folder) of the deleted resources, if <code>null</code>
  // all deleted resources will be returned
  //     * @param includeSubFolders indicates if the sub folders of the specified folder path should
  // be considered, too
  ...
  //     * @throws CmsDataAccessException if something goes wrong
  //     */
  //    List<CmsResource> readSubscribedResources(CmsDbContext dbc, String poolName,
   ...
   * @throws CmsDataAccessException if something goes wrong
   */
  void removeResourceFromOrganizationalUnit(
      CmsDbContext dbc, CmsOrganizationalUnit orgUnit, CmsResource resource)
      throws CmsDataAccessException;
  ...
  //     * @throws CmsDataAccessException if something goes wrong
  //     */
  //    void subscribeResourceFor(CmsDbContext dbc, String poolName, CmsPrincipal principal,
  ...
  //     * @throws CmsDataAccessException if something goes wrong
  //     */
  //    void unsubscribeResourceFor(CmsDbContext dbc, String poolName, CmsPrincipal principal,
  // CmsResource resource)
  //    throws CmsDataAccessException;
  //
  //    /**
   ...
   *
   * <p>The user id has to be a valid OpenCms user id.
   *
   * <p>The user with the given id will be completely overriden by the given data.
   *
   * <p>
   *
   * @param dbc the current database context
   ...
   * @throws CmsDataAccessException if something goes wrong
   */
  void writeUserInfo(CmsDbContext dbc, CmsUUID userId, String key, Object value)
      throws CmsDataAccessException;
}
