...
public class CmsVfsDriver extends org.opencms.db.generic.CmsVfsDriver {
  ...
  /**
   * @see org.opencms.db.generic.CmsVfsDriver#createOnlineContent(CmsDbContext, CmsUUID, byte[],
   *     int, boolean, boolean)
   */
  @Override
      ...
      if (projectId.equals(CmsProject.ONLINE_PROJECT_ID)) {
        stmt =
            m_sqlManager.getPreparedStatement(
                conn, projectId, "C_ORACLE_ONLINE_CONTENTS_UPDATECONTENT");
      } else {
        stmt =
            m_sqlManager.getPreparedStatement(
                conn, projectId, "C_ORACLE_OFFLINE_CONTENTS_UPDATECONTENT");
      }
