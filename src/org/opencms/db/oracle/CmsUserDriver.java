...
public class CmsUserDriver extends org.opencms.db.generic.CmsUserDriver {
  ...
  /**
   * Generates an Output stream that writes to a blob, also truncating the existing blob if
   * required.
   *
   * <p>Apparently Oracle requires some non-standard handling here.
   *
   * <p>
   *
   ...
   */
  public static OutputStream getOutputStreamFromBlob(ResultSet res, String name)
      throws SQLException {
