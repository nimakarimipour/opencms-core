...
public class CmsVisitedByFilter {
   ...
   *
   * <p>It is required to set the user manually if using this constructor.
   *
   * <p>
   */
   ...
   * <p>
   *
   * @return <code>true</code> if subfolders should be included to search for visited resources,
   ...
   *
   * <p>This has to be the root path of the parent resource, not the site path.
   *
   * <p>
   *
