...
public class CmsSqlManager {
   ...
   */
  public @RUntainted int getActiveConnections(String dbPoolUrl) throws CmsDbException {
   ...
   * @throws CmsDbException if something goes wrong
   */
  public @RUntainted int getIdleConnections(String dbPoolUrl) throws CmsDbException {
