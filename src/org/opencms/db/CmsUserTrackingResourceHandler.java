...
/**
 * This resource handler checks if a resource has to be marked as visited by the current user. It
 * checks the value of the <code>usertracking.mark</code> property.
 *
...
public class CmsUserTrackingResourceHandler implements I_CmsResourceInit {
  ...
  /**
   * Property that indicates if resources should be tracked, value has to be <code>true</code>,
   * <code>false</code> or <code>online</code>.
   */
  ...
  public CmsResource initResource(
    ...
    if ((resource != null) && resource.isFile()) {
      ...
      try {
        ...
        mark =
            cms.readPropertyObject(resource, PROPERTY_USERTRACKING_MARK, true)
                .getValue(CmsStringUtil.FALSE);
      ...
      if (Boolean.valueOf(mark).booleanValue()
        ...
        try {
          OpenCms.getSubscriptionManager()
              .markResourceAsVisitedBy(cms, resource, cms.getRequestContext().getCurrentUser());
        } catch (CmsException e) {
