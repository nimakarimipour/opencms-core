...
public class CmsThreadStatsTreeProfilingHandler implements I_CmsProfilingHandler {
  ...
  public static class Node {
    ...
    public void dump(Element parent) {
      ...
      Element elem =
          parent
              ...
              .addAttribute("count", "" + m_cumulativeCount)
              .addAttribute("millis", "" + (m_cumulativeNanos / 1000000));
    ...
    /**
     * Gets the cumulative driver call count (does not automatically update).
     *
     * <p>
     *
    ...
    /**
     * Gets the cumulative driver call nanos (does not automatically update).
     *
     * <p>
     *
