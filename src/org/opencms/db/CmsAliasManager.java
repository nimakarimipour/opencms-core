...
public class CmsAliasManager {
    ...
    public synchronized List<CmsAliasImportResult> importAliases(
        CmsObject cms,
        @RUntainted byte[] aliasData,
        @RUntainted String siteRoot,
        @RUntainted String separator)
    throws Exception {
     ...
     */
    protected CmsAliasImportResult processAliasLine(CmsObject cms, @RUntainted String siteRoot, @RUntainted String line, @RUntainted String separator) {
     ...
     */
    private void touch(CmsObject cms, @RUntainted CmsResource resource) {
