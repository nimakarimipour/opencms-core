...
/**
 * Manager that provides methods to subscribe resources to users, read subscribed or unvisited
 * resources and more.
 *
 * <p>
 *
...
public class CmsSubscriptionManager {
   ...
   */
  public long getDateLastVisitedBy(CmsObject cms, CmsUser user, CmsResource resource)
      throws CmsException {

    return m_securityManager.getDateLastVisitedBy(
        cms.getRequestContext(), getPoolName(), user, resource);
  }
   ...
   * @throws CmsException if something goes wrong
   */
  public long getDateLastVisitedBy(CmsObject cms, CmsUser user, String resourcePath)
      throws CmsException {
   ...
   *     {@link CmsRole#ROOT_ADMIN}</code> permissions
   */
   ...
   * <p>
   *
   * @return <code>true</code> if the subscription functionality is enabled, otherwise <code>false
   *     </code>
   */
  public boolean isEnabled() {
    ...
    return m_enabled
        ...
        && m_securityManager.isSubscriptionDriverAvailable();
  }
   ...
   * @throws CmsException if something goes wrong
   */
  public void markResourceAsVisitedBy(CmsObject cms, CmsResource resource, CmsUser user)
      throws CmsException {

    if (!isEnabled()) {
      throw new CmsRuntimeException(
          Messages.get().container(Messages.ERR_SUBSCRIPTION_MANAGER_DISABLED_0));
    }
    m_securityManager.markResourceAsVisitedBy(
        cms.getRequestContext(), getPoolName(), resource, user);
  }
   ...
   * @throws CmsException if something goes wrong
   */
  public void markResourceAsVisitedBy(CmsObject cms, String resourcePath, CmsUser user)
      throws CmsException {
   ...
   * @throws CmsException if something goes wrong
   */
  public List<CmsResource> readAllSubscribedResources(CmsObject cms, CmsPrincipal principal)
      throws CmsException {

    return m_securityManager.readAllSubscribedResources(
   ...
   * @param includeGroups indicates if the users groups should also be checked for subscribed
   *     deleted resources
   * @param folderPath the folder path of the deleted resources, if <code>null</code> all deleted
  ...
  public void setEnabled(boolean enabled) {
    ...
    if (m_frozen) {
      throw new CmsRuntimeException(
          Messages.get().container(Messages.ERR_CONFIG_SUBSCRIPTIONMANAGER_FROZEN_0));
    }
    m_enabled = enabled;
  }
   ...
   * @throws CmsException if something goes wrong
   */
  public void setSubscribedResourceAsDeleted(CmsObject cms, CmsResource resource)
      throws CmsException {
    ...
    m_securityManager.setSubscribedResourceAsDeleted(
        cms.getRequestContext(), getPoolName(), resource);
  }
   ...
   * @throws CmsException if something goes wrong
   */
  public void subscribeResourceFor(CmsObject cms, CmsPrincipal principal, CmsResource resource)
      throws CmsException {
    ...
    m_securityManager.subscribeResourceFor(
        cms.getRequestContext(), getPoolName(), principal, resource);
  }
   ...
   * @throws CmsException if something goes wrong
   */
  public void subscribeResourceFor(CmsObject cms, CmsPrincipal principal, String resourcePath)
      throws CmsException {
  ...
  public void unsubscribeAllDeletedResources(CmsObject cms, long deletedTo) throws CmsException {
    ...
    m_securityManager.unsubscribeAllDeletedResources(
        cms.getRequestContext(), getPoolName(), deletedTo);
  }
   ...
   * @throws CmsException if something goes wrong
   */
  public void unsubscribeAllResourcesFor(CmsObject cms, CmsPrincipal principal)
      throws CmsException {
  ...
  public void unsubscribeResourceFor(CmsObject cms, CmsPrincipal principal, CmsResource resource)
    ...
    m_securityManager.unsubscribeResourceFor(
        cms.getRequestContext(), getPoolName(), principal, resource);
  }
   ...
   * @throws CmsException if something goes wrong
   */
  public void unsubscribeResourceFor(CmsObject cms, CmsPrincipal principal, String resourcePath)
      throws CmsException {
