...
public class CmsDbContext {
    ...
    if (m_requestContext != null) {
      m_flexRequestContextInfo =
          (CmsFlexRequestContextInfo)
              m_requestContext.getAttribute(CmsRequestUtil.HEADER_LAST_MODIFIED);
    }
  }
   ...
   *
   * <p>If no user request context is available, the given resource name is returned unchanged.
   *
   * <p>
   *
   ...
   * @throws CmsException if the <code>throwable</code> parameter is not <code>null</code> and a
   *     {@link CmsException}
   * @throws CmsVfsException if the <code>throwable</code> parameter is not <code>null</code> and no
   *     {@link CmsException}
   */
  ...
  /**
   * Returns an exception of the same type as <code>throwable</code>, if <code>throwable</code> is
   * an OpenCms Exception with the message as a {@link CmsMessageContainer} and the <code>throwable
   * </code> as a cause.
   *
   * <p>
   *
   ...
   *     {@link CmsException}
   */
  public void throwException(CmsMessageContainer message, Throwable throwable)
      throws CmsVfsException, CmsException {
