 ...
 *
 * <p>This allows various subsequent tasks in the Cms app. (e.g. exporting files and folders) to
 * identify published resources after a resource or project was published.
 *
 * <p>The values to fill this container are read from the Cms publish history database table that is
 * written during each publishing process.
 *
 * <p>
 *
 * @since 6.0.0
...
public class CmsPublishedResource implements Serializable, Comparable<CmsPublishedResource> {
  ...
  public static final CmsPublishedResourceState STATE_MOVED_DESTINATION =
      new CmsPublishedResourceState(12, 'M');

  /** Additional state for moved resources, the (deleted) source of the moved resource. */
  public static final CmsPublishedResourceState STATE_MOVED_SOURCE =
      new CmsPublishedResourceState(11, ' ');
   ...
   *
   * <p>Do not write objects created with this constructor to db, since the publish tag is not set.
   *
   * <p>
   *
  ...
  /**
   * Returns <code>true</code> if the resource has been moved.
   *
   * <p>
   *
   ...
   *
   * <p>This is sometimes required for offline search index generation.
   *
   * <p>
   *
