 ...
 *
 * <p>The IDs are organized as following:
 *
 * <dl>
 *   <dt>1-3
 *   <dd>user actions (login successful, login failed, resource visited)
 *   <dt>11-13
 *   <dd>publish actions (modified, new, deleted)
 *   <dt>15
 *   <dd>publish list (hide)
 *   <dt>21-24
 *   <dd>resource additional information (relations, permissions, properties)
 *   <dt>30
 *   <dd>content changes
 *   <dt>31-35
 *   <dd>resource attributes (date expired, released, last modified; type, flags)
 *   <dt>40-45
 *   <dd>structure operations (create, copy, delete, move, import)
 *   <dt>50-54
 *   <dd>resource recovery (history, restore, undelete, undo changes)
 * </dl>
 *
 * @since 8.0.0
 */
public enum CmsLogEntryType {
  ...
  RESOURCE_REMOVE_RELATION(
      22, LogLevel.INFO, true, Messages.GUI_LOG_ENTRY_DETAIL_PATH_AND_RELATION_FILTER_2),
  ...
  private @RUntainted String m_detailKey;
   ...
   */
  private CmsLogEntryType(int id, LogLevel logLevel, boolean toPubList, @RUntainted String detailKey) {
  ...
  /**
   * Parses an <code>int</code> into a log entry type.
   *
   * <p>
   *
   ...
   *     {@link CmsLogEntryType}</code> object.
   */
