...
public final class CmsSecurityManager {
  ...
  public void addUserToGroup(
      CmsRequestContext context, String username, String groupname, boolean readRoles)
      throws CmsException {
  ...
  public void checkLogin(
      CmsRequestContext context, String username, String password, String remoteAddress)
      throws CmsException {
  ...
  public CmsGroup createGroup(
      CmsRequestContext context, String name, String description, int flags, String parent)
      throws CmsException, CmsRoleViolationException {
  ...
  public CmsOrganizationalUnit createOrganizationalUnit(
      CmsRequestContext context, String ouFqn, String description, int flags, CmsResource resource)
      throws CmsException {
  ...
  public void deleteStaticExportPublishedResource(
      CmsRequestContext context, String resourceName, int linkType, String linkParameter)
      throws CmsException {
  ...
  public List<CmsGroup> getChildren(
      CmsRequestContext context, String groupname, boolean includeSubChildren) throws CmsException {
  ...
  public CmsFolder readFolder(
      CmsRequestContext context, String resourcename, CmsResourceFilter filter)
      throws CmsException {
   ...
   * @throws CmsException if something goes wrong
   */
  public CmsHistoryProject readHistoryProject(CmsRequestContext context, CmsUUID projectId)
      throws CmsException {
   ...
   * @throws CmsException if something goes wrong
   */
  public CmsHistoryProject readHistoryProject(CmsRequestContext context, int publishTag)
      throws CmsException {
   ...
   * @throws CmsException if something goes wrong
   */
  public CmsOrganizationalUnit readOrganizationalUnit(CmsRequestContext context, String ouFqn)
      throws CmsException {
   ...
   * @throws CmsException if something goes wrong
   */
  public CmsResource readParentFolder(CmsRequestContext context, CmsUUID structureId)
      throws CmsException {
  ...
  public List<CmsResource> readPath(
      CmsRequestContext context, String path, CmsResourceFilter filter) throws CmsException {
  ...
  public List<CmsResource> readProjectView(
      CmsRequestContext context, CmsUUID projectId, CmsResourceState state) throws CmsException {
   ...
   */
  public CmsProperty readPropertyObject(
      CmsRequestContext context, CmsResource resource, String key, boolean search, Locale locale)
      throws CmsException {
  ...
  public I_CmsHistoryResource readResource(
      CmsRequestContext context, CmsResource resource, int version) throws CmsException {
  ...
  public List<String> readStaticExportResources(
      CmsRequestContext context, int parameterResources, long timestamp) throws CmsException {
   ...
   * @throws CmsException if operation was not successful
   */
  public CmsUser readUser(CmsRequestContext context, String username, String password)
      throws CmsException {
  ...
  public void removeResourceFromUsersPubList(
      CmsRequestContext context, Collection<CmsUUID> structureIds) throws CmsException {
   ...
   */
  public void restoreDeletedResource(CmsRequestContext context, CmsUUID structureId)
      throws CmsException {
  ...
  public void setDateLastModified(
      CmsRequestContext context, CmsResource resource, long dateLastModified)
      throws CmsException, CmsSecurityException {
   ...
   * @throws CmsException if operation was not successful
   */
  public boolean userInGroup(CmsRequestContext context, String username, String groupname)
      throws CmsException {
   ...
   * @throws CmsException if operation was not successful
   */
  public void writeHistoryProject(CmsRequestContext context, int publishTag, long publishDate)
      throws CmsException {
  ...
  public void writePropertyObjects(
      CmsRequestContext context, CmsResource resource, List<CmsProperty> properties)
      throws CmsException, CmsSecurityException {
  ...
  protected void moveResource(
      CmsDbContext dbc, CmsResource source, String destination, Set<CmsResource> allMovedResources)
      throws CmsException {
   ...
   */
  protected CmsResource readResource(
      CmsDbContext dbc, String resourcePath, CmsResourceFilter filter) throws CmsException {
