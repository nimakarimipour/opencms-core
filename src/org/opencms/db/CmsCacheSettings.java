...
public class CmsCacheSettings {
   ...
   *
   * <p>Might be <code>-1</code> if configuration entry is missing.
   *
   * <p>
   *
   ...
   * @param defaultValue a default value to be returned in case the string could not be parsed or
   *     the parsed int value is <= 0
