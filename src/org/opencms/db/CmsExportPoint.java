...
public class CmsExportPoint implements Serializable {
   ...
   *
   * <p>The configured destination path is always relative to the web application path.
   *
   * <p>
   *
    ...
    if (m_destinationPath == null) {
      m_destinationPath =
          OpenCms.getSystemInfo()
              .getAbsoluteRfsPathRelativeToWebApplication(m_configuredDestination);
    }
   ...
   * <p>The configured destination path is always relative to the web application path.
   *
   * <p>This set method will automatically set the destination path as well.
   *
   * <p>
   *
   ...
   *
   * <p>This is required by the {@link org.apache.commons.beanutils.BeanUtils} package in order to
   * enable using this Object with the digester.
   *
   * <p>The method does not actually change the value of the destination path. Use the <code>
   * {@link #setConfiguredDestination(String)}</code> method instead.
   *
