...
public class CmsSelectQuery implements I_CmsQueryFragment {
  ...
  public CmsSelectQuery() {
    ...
    // always use 1 = 1 as a condition so we don't have to worry about whether we need a "WHERE"
    // keyword
  ...
  /**
   * Helper method for generating an alias by taking a prefix and appending the first number to it
   * for which the resulting string is not already used as an alias.
   *
   * <p>
   *
