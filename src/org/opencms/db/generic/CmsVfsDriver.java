...
public class CmsVfsDriver implements I_CmsDriver, I_CmsVfsDriver {
   ...
   *     the SQL
   */
  public static CmsPair<@RUntainted String, List<I_CmsPreparedStatementParameter>>
   ...
   */
  protected static String escapeDbWildcard(@RUntainted String path) {
  ...
  public CmsResource createResource(
    ...
    try {
      ...
      if (existingResource.getState().isDeleted()) {
        ...
        List<CmsResource> modifiedResources =
  ...
  public void deleteAliases(CmsDbContext dbc, CmsProject project, CmsAliasFilter filter)
    ...
    try {
      conn = m_sqlManager.getConnection(dbc);
      CmsPair<@RUntainted String, List<String>> filterData = buildAliasConditions(filter);
  ...
  public void deleteRewriteAliases(CmsDbContext dbc, CmsRewriteAliasFilter filter)
    ...
    try {
      conn = m_sqlManager.getConnection(dbc);
      CmsPair<@RUntainted String, List<Object>> conditionAndParams = prepareRewriteAliasConditions(filter);
  ...
  public void moveResource(
      CmsDbContext dbc, CmsUUID projectId, CmsResource source, String destinationPath)
      throws CmsDataAccessException {
  ...
  public List<CmsAlias> readAliases(CmsDbContext dbc, CmsProject project, CmsAliasFilter filter)
    ...
    try {
      conn = m_sqlManager.getConnection(dbc);
      CmsPair<@RUntainted String, List<String>> conditionPair = buildAliasConditions(filter);
   ...
   */
  public CmsPropertyDefinition readPropertyDefinition(
      CmsDbContext dbc, String name, CmsUUID projectId) throws CmsDataAccessException {
  ...
  public CmsProperty readPropertyObject(
      CmsDbContext dbc, String key, CmsProject project, CmsResource resource)
      throws CmsDataAccessException {
  ...
  public CmsResource readResource(
      CmsDbContext dbc, CmsUUID projectId, CmsUUID structureId, boolean includeDeleted)
      throws CmsDataAccessException {
   ...
   */
  public CmsResource readResource(
      CmsDbContext dbc, CmsUUID projectId, String path, boolean includeDeleted)
      throws CmsDataAccessException {
   ...
   */
  protected CmsUrlNameMappingEntry internalCreateUrlNameMappingEntry(ResultSet resultSet)
      throws SQLException {
  ...
  protected void preparePathCondition(
      CmsUUID projectId, String parent, int mode, StringBuffer conditions, List<Object> params) {
  ...
  PreparedStatement getPreparedStatementForFilter(
      Connection conn, @RUntainted String baseQuery, CmsUrlNameMappingFilter filter) throws SQLException {

    CmsPair<@RUntainted String, List<I_CmsPreparedStatementParameter>> conditionData =
   ...
   *     conditions
   */
  private CmsPair<@RUntainted String, List<String>> buildAliasConditions(CmsAliasFilter filter) {

    List<String> conditions = new ArrayList<String>();
    conditions.add("1 = 1");
    @RUntainted List<String> conditionParams = new ArrayList<String>();
    ...
    @RUntainted String conditionString = CmsStringUtil.listAsString(conditions, " AND ");
   ...
   */
  private CmsPair<@RUntainted String, List<Object>> prepareRewriteAliasConditions(
