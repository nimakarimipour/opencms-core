...
public class CmsSubscriptionDriver implements I_CmsDriver, I_CmsSubscriptionDriver {
  ...
  /**
   * @see org.opencms.db.I_CmsSubscriptionDriver#deleteVisits(org.opencms.db.CmsDbContext,
   *     java.lang.String, org.opencms.db.CmsVisitEntryFilter)
   */
  ...
  /**
   * @see org.opencms.db.I_CmsSubscriptionDriver#getDateLastVisitedBy(org.opencms.db.CmsDbContext,
   *     java.lang.String, org.opencms.file.CmsUser, org.opencms.file.CmsResource)
   */
  ...
  /**
   * @see
   *     org.opencms.db.I_CmsSubscriptionDriver#markResourceAsVisitedBy(org.opencms.db.CmsDbContext,
        ...
        if (count > maxCount) {
          ...
          stmt =
              m_sqlManager.getPreparedStatement(
                  conn, dbc.currentProject(), "C_VISITED_USER_DELETE_GETDATE_2");
  ...
  /**
   * @see
   *     org.opencms.db.I_CmsSubscriptionDriver#readAllSubscribedResources(org.opencms.db.CmsDbContext,
   *     java.lang.String, org.opencms.security.CmsPrincipal)
   */
  public List<CmsResource> readAllSubscribedResources(
    ...
    try {
      ...
      stmt =
          m_sqlManager.getPreparedStatement(
              conn, dbc.currentProject(), "C_SUBSCRIPTION_READ_ALL_1");
      ...
      while (res.next()) {
        currentResource =
            m_driverManager
                .getVfsDriver(dbc)
                .createFile(res, dbc.currentProject().getUuid(), false);
  ...
  /**
   * @see org.opencms.db.I_CmsSubscriptionDriver#readResourcesVisitedBy(org.opencms.db.CmsDbContext,
   *     java.lang.String, org.opencms.db.CmsVisitedByFilter)
   */
    ...
    try {
      ...
      if (CmsStringUtil.isNotEmpty(filter.getParentPath())) {
        CmsResource parent =
            m_driverManager
                .getVfsDriver(dbc)
                .readResource(dbc, dbc.currentProject().getUuid(), filter.getParentPath(), false);
        ...
        if (filter.isIncludeSubFolders()) {
          ...
          params.add(
              CmsFileUtil.addTrailingSeparator(
                      CmsVfsDriver.escapeDbWildcard(filter.getParentPath()))
                  + "%");
        } else {
          conditions.append(
  ...
  /**
   * @see
   *     org.opencms.db.I_CmsSubscriptionDriver#readSubscribedDeletedResources(org.opencms.db.CmsDbContext,
   *     java.lang.String, org.opencms.file.CmsUser, java.util.List, org.opencms.file.CmsResource,
   *     boolean, long)
   */
    ...
    for (Iterator<CmsUUID> i = historyIDs.iterator(); i.hasNext(); ) {
      ...
      if (version > 0) {
        I_CmsHistoryResource histRes =
            m_driverManager.getHistoryDriver(dbc).readResource(dbc, id, version);
        if (parent != null) {
  ...
  /**
   * @see
   *     org.opencms.db.I_CmsSubscriptionDriver#readSubscribedResources(org.opencms.db.CmsDbContext,
   *     java.lang.String, org.opencms.db.CmsSubscriptionFilter)
   */
  public List<CmsResource> readSubscribedResources(
    ...
    if (principalIds.size() == 1) {
      ...
      conditions.append(BEGIN_CONDITION);
      conditions.append(
          m_sqlManager.readQuery(dbc.currentProject(), "C_SUBSCRIPTION_FILTER_PRINCIPAL_SINGLE"));
      ...
      conditions.append(END_CONDITION);
      conditions.append(
          m_sqlManager.readQuery(dbc.currentProject(), "C_SUBSCRIPTION_FILTER_PRINCIPALS_END"));
      conditions.append(END_CONDITION);
    }
    ...
    if ((filter.getFromDate() > 0) || (filter.getToDate() < Long.MAX_VALUE)) {
      conditions.append(BEGIN_INCLUDE_CONDITION);
      conditions.append(
          m_sqlManager.readQuery(
              dbc.currentProject(), "C_SUBSCRIPTION_FILTER_RESOURCES_DATE_MODIFIED"));
    ...
    // filter the result if in visited/unvisited mode (faster as creating a query with even more
    // joined tables)
    if (!filter.getMode().isAll()) {
      ...
      for (Iterator<CmsResource> i = resources.iterator(); i.hasNext(); ) {
        ...
        try {
          visitedDate =
              m_driverManager.getDateLastVisitedBy(dbc, poolName, filter.getUser(), resource);
  ...
  /**
   * Reads {@link CmsVisitEntry} objects from the database.
   *
   * <p>
   *
   ...
   */
  public List<CmsVisitEntry> readVisits(
      CmsDbContext dbc, String poolName, CmsVisitEntryFilter filter) throws CmsDataAccessException {
  ...
  /**
   * @see
   *     org.opencms.db.I_CmsSubscriptionDriver#setSubscribedResourceAsDeleted(org.opencms.db.CmsDbContext,
   *     java.lang.String, org.opencms.file.CmsResource)
   */
  public void setSubscribedResourceAsDeleted(
      CmsDbContext dbc, String poolName, CmsResource resource) throws CmsDataAccessException {
  ...
  /**
   * @see org.opencms.db.I_CmsSubscriptionDriver#subscribeResourceFor(org.opencms.db.CmsDbContext,
   *     java.lang.String, org.opencms.security.CmsPrincipal, org.opencms.file.CmsResource)
   */
  ...
  /**
   * @see
   *     org.opencms.db.I_CmsSubscriptionDriver#unsubscribeAllDeletedResources(org.opencms.db.CmsDbContext,
  ...
  /**
   * @see
   *     org.opencms.db.I_CmsSubscriptionDriver#unsubscribeAllResourcesFor(org.opencms.db.CmsDbContext,
   *     java.lang.String, org.opencms.security.CmsPrincipal)
   */
  ...
  /**
   * @see org.opencms.db.I_CmsSubscriptionDriver#unsubscribeResourceFor(org.opencms.db.CmsDbContext,
   *     java.lang.String, org.opencms.security.CmsPrincipal, org.opencms.file.CmsResource)
   */
  ...
  /**
   * @see
   *     org.opencms.db.I_CmsSubscriptionDriver#unsubscribeResourceForAll(org.opencms.db.CmsDbContext,
   *     java.lang.String, org.opencms.file.CmsResource)
   */
  ...
  /**
   * Creates a new {@link CmsVisitEntry} object from the given result set entry.
   *
   * <p>
   *
  ...
  protected CmsVisitEntry internalReadVisitEntry(ResultSet res) throws SQLException {
    ...
    CmsUUID structureId =
        new CmsUUID(res.getString(m_sqlManager.readQuery("C_VISIT_STRUCTURE_ID")));
