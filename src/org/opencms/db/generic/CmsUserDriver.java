...
public class CmsUserDriver implements I_CmsUserDriver {
    ...
    throws CmsDataAccessException {
        ...
        List<CmsUser> users = new ArrayList<CmsUser>();
        @RUntainted CmsPair<@RUntainted String, @RUntainted List<@RUntainted Object>> queryAndParams = createUserQuery(searchParams, false);
        @RUntainted ResultSet res = null;
        @RUntainted PreparedStatement stmt = null;
        Connection conn = null;
        try {
     ...
     */
    protected @RUntainted CmsPair<@RUntainted String, @RUntainted List<@RUntainted Object>> createUserQuery(CmsUserSearchParameters searchParams, boolean countOnly) {
