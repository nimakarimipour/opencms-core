...
public class CmsUserDriver implements I_CmsUserDriver {
  ...
  /**
   * @see
   *     org.opencms.db.I_CmsUserDriver#addResourceToOrganizationalUnit(org.opencms.db.CmsDbContext,
   *     org.opencms.security.CmsOrganizationalUnit, org.opencms.file.CmsResource)
   */
  public void addResourceToOrganizationalUnit(
    ...
    try {
      ...
      @RUntainted CmsResource ouResource =
          m_driverManager.readResource(
              dbc, ORGUNIT_BASE_FOLDER + orgUnit.getName(), CmsResourceFilter.ALL);
      ...
      if (orgUnit.getParentFqn() != null) {
        ...
        CmsOrganizationalUnit parentOu =
            m_driverManager.readOrganizationalUnit(dbc, orgUnit.getParentFqn());
        // validate
      ...
      @RUntainted CmsRelation relation = new CmsRelation(ouResource, resource, CmsRelationType.OU_RESOURCE);
      m_driverManager
          .getVfsDriver(dbc)
          .createRelation(dbc, dbc.currentProject().getUuid(), relation);
      ...
      try {
        ...
        m_driverManager
            ...
            .createProjectResource(dbc, orgUnit.getProjectId(), resource.getRootPath());
  ...
  /**
   * @see org.opencms.db.I_CmsUserDriver#countUsers(org.opencms.db.CmsDbContext,
  ...
  /**
   * @see org.opencms.db.I_CmsUserDriver#createAccessControlEntry(org.opencms.db.CmsDbContext,
   *     org.opencms.file.CmsProject, org.opencms.util.CmsUUID, org.opencms.util.CmsUUID, int, int,
   *     int)
   */
  ...
  /**
   * @see org.opencms.db.I_CmsUserDriver#createGroup(org.opencms.db.CmsDbContext,
   *     org.opencms.util.CmsUUID, java.lang.String, java.lang.String, int, java.lang.String)
   */
  public CmsGroup createGroup(
    ...
    if (existsGroup(dbc, groupFqn)) {
      CmsMessageContainer message =
          Messages.get().container(Messages.ERR_GROUP_WITH_NAME_ALREADY_EXISTS_1, groupFqn);
    ...
    try {
      ...
      stmt.setInt(5, flags);
      stmt.setString(
          6, CmsOrganizationalUnit.SEPARATOR + CmsOrganizationalUnit.getParentFqn(groupFqn));
      stmt.executeUpdate();
  ...
  /**
   * @see org.opencms.db.I_CmsUserDriver#createOrganizationalUnit(org.opencms.db.CmsDbContext,
   *     java.lang.String, java.lang.String, int, org.opencms.security.CmsOrganizationalUnit,
   *     String)
   */
    ...
    if ((parent == null) && !name.equals("")) {
      throw new CmsDataAccessException(
          org.opencms.db.Messages.get()
              .container(org.opencms.db.Messages.ERR_PARENT_ORGUNIT_NULL_0));
    }
    try {
      ...
      if ((parentFolder != null) && (resource != null)) {
        internalValidateResourceForOrgUnit(
            dbc, internalCreateOrgUnitFromResource(dbc, parentFolder), resource.getRootPath());
      }
      ...
      internalWriteOrgUnitProperty(
          dbc, ouFolder, new CmsProperty(ORGUNIT_PROPERTY_DESCRIPTION, description, null));
      ...
      if ((ou.getParentFqn() != null)) {
        ...
        internalCreateDefaultGroups(
            dbc, ou.getName(), ou.getDisplayName(locale), ou.hasFlagWebuser());
    ...
    try {
      ...
      try {
        ...
        if (CmsLog.INIT.isInfoEnabled()) {
          CmsLog.INIT.info(
              Messages.get().getBundle().key(Messages.INIT_ROOT_ORGUNIT_DEFAULTS_INITIALIZED_0));
        }
      } catch (CmsException exc) {
        ...
        throw new CmsInitException(
            Messages.get().container(Messages.ERR_INITIALIZING_USER_DRIVER_0), exc);
      }
    }
  }

  /**
   * @see org.opencms.db.I_CmsUserDriver#createUser(CmsDbContext, CmsUUID, String, String, String,
   *     String, String, long, int, long, Map)
   */
  public CmsUser createUser(
    ...
    if (existsUser(dbc, userFqn)) {
      CmsMessageContainer message =
          Messages.get().container(Messages.ERR_USER_WITH_NAME_ALREADY_EXISTS_1, userFqn);
      if (LOG.isErrorEnabled()) {
        LOG.error(message.key());
      }
      throw new CmsDbEntryAlreadyExistsException(message);
    ...
    try {
      ...
      stmt.setInt(8, flags);
      stmt.setString(
          9, CmsOrganizationalUnit.SEPARATOR + CmsOrganizationalUnit.getParentFqn(userFqn));
  ...
  /**
   * @see org.opencms.db.I_CmsUserDriver#createUserInGroup(org.opencms.db.CmsDbContext,
   *     org.opencms.util.CmsUUID, org.opencms.util.CmsUUID)
   */
  public void createUserInGroup(CmsDbContext dbc, CmsUUID userId, CmsUUID groupId)
      throws CmsDataAccessException {
   ...
   */
  public void deleteGroup(CmsDbContext dbc, @RUntainted String groupFqn) throws CmsDataAccessException {
    ...
    try {
      ...
      stmt.setString(
          2, CmsOrganizationalUnit.SEPARATOR + CmsOrganizationalUnit.getParentFqn(groupFqn));
      stmt.executeUpdate();
    } catch (SQLException e) {
      throw new CmsDbSqlException(
          Messages.get()
  ...
  /**
   * @see org.opencms.db.I_CmsUserDriver#deleteOrganizationalUnit(org.opencms.db.CmsDbContext,
  ...
  public void deleteOrganizationalUnit(CmsDbContext dbc, CmsOrganizationalUnit organizationalUnit)
    ...
    try {
      CmsResource resource =
          m_driverManager.readResource(
              dbc, ORGUNIT_BASE_FOLDER + organizationalUnit.getName(), CmsResourceFilter.DEFAULT);
      internalDeleteOrgUnitResource(dbc, resource);
      if (organizationalUnit.getProjectId() != null) {
        try {
          // maintain the default project synchronized
          m_driverManager.deleteProject(
              dbc, m_driverManager.readProject(dbc, organizationalUnit.getProjectId()), false);
        } catch (CmsDbEntryNotFoundException e) {
          // ignore
        }
      }
  ...
  public void deleteUser(CmsDbContext dbc, @RUntainted String userFqn) throws CmsDataAccessException {
    ...
    try {
      ...
      stmt.setString(
          2, CmsOrganizationalUnit.SEPARATOR + CmsOrganizationalUnit.getParentFqn(userFqn));
      stmt.executeUpdate();
    } catch (SQLException e) {
      throw new CmsDbSqlException(
          Messages.get()
  ...
  /**
   * @see org.opencms.db.I_CmsUserDriver#deleteUserInfos(org.opencms.db.CmsDbContext,
  ...
  /**
   * @see org.opencms.db.I_CmsUserDriver#deleteUserInGroup(org.opencms.db.CmsDbContext,
   *     org.opencms.util.CmsUUID, org.opencms.util.CmsUUID)
   */
  public void deleteUserInGroup(CmsDbContext dbc, CmsUUID userId, CmsUUID groupId)
      throws CmsDataAccessException {
   ...
   */
  public boolean existsGroup(CmsDbContext dbc, @RUntainted String groupFqn) throws CmsDataAccessException {
   ...
   */
  public boolean existsUser(CmsDbContext dbc, @RUntainted String userFqn) throws CmsDataAccessException {
  ...
  public void fillDefaults(CmsDbContext dbc) throws CmsInitException {
    ...
    try {
      CmsOrganizationalUnit ou =
          (CmsOrganizationalUnit) (dbc.getAttribute(CmsDriverManager.ATTR_INIT_OU));
      if (ou == null) {
      ...
      if (CmsLog.INIT.isErrorEnabled()) {
        CmsLog.INIT.error(
            Messages.get().getBundle().key(Messages.INIT_DEFAULT_USERS_CREATION_FAILED_0), e);
      }
      throw new CmsInitException(
          Messages.get().container(Messages.ERR_INITIALIZING_USER_DRIVER_0), e);
    }
  }

  /**
   * @see org.opencms.db.I_CmsUserDriver#getGroups(org.opencms.db.CmsDbContext,
   *     org.opencms.security.CmsOrganizationalUnit, boolean, boolean)
   */
  ...
  /**
   * @see org.opencms.db.I_CmsUserDriver#getOrganizationalUnits(org.opencms.db.CmsDbContext,
   *     org.opencms.security.CmsOrganizationalUnit, boolean)
   */
  public List<CmsOrganizationalUnit> getOrganizationalUnits(
      CmsDbContext dbc, CmsOrganizationalUnit parent, boolean includeChildren)
      throws CmsDataAccessException {
    ...
    try {
      ...
      Iterator<CmsResource> itResources =
          m_driverManager
              .readResources(dbc, parentFolder, CmsResourceFilter.DEFAULT, includeChildren)
              .iterator();
  ...
  /**
   * @see
   *     org.opencms.db.I_CmsUserDriver#getResourcesForOrganizationalUnit(org.opencms.db.CmsDbContext,
   *     org.opencms.security.CmsOrganizationalUnit)
   */
  public List<CmsResource> getResourcesForOrganizationalUnit(
      CmsDbContext dbc, CmsOrganizationalUnit orgUnit) throws CmsDataAccessException {
    ...
    try {
      ...
      while (itPaths.hasNext()) {
        @RUntainted String path = itPaths.next();
        try {
  ...
  /**
   * @see org.opencms.db.I_CmsUserDriver#getUsers(org.opencms.db.CmsDbContext,
   *     org.opencms.security.CmsOrganizationalUnit, boolean)
   */
  ...
  /**
   * @see org.opencms.db.I_CmsUserDriver#getUsersWithoutAdditionalInfo(org.opencms.db.CmsDbContext,
   *     org.opencms.security.CmsOrganizationalUnit, boolean)
   */
  public List<CmsUser> getUsersWithoutAdditionalInfo(
      CmsDbContext dbc, CmsOrganizationalUnit orgUnit, boolean recursive)
      throws CmsDataAccessException {
  ...
  public void init(
    ...
    @RUntainted String poolUrl = config.get("db.user.pool");
    ...
    m_digestAlgorithm =
        config.getString(CmsDriverManager.CONFIGURATION_DB + ".user.digest.type", "MD5");
    if (CmsLog.INIT.isInfoEnabled()) {
      CmsLog.INIT.info(
          Messages.get().getBundle().key(Messages.INIT_DIGEST_ALGORITHM_1, m_digestAlgorithm));
    }

    m_digestFileEncoding =
        config.getString(
            CmsDriverManager.CONFIGURATION_DB + ".user.digest.encoding", CmsEncoder.ENCODING_UTF_8);
    if (CmsLog.INIT.isInfoEnabled()) {
      CmsLog.INIT.info(
          Messages.get().getBundle().key(Messages.INIT_DIGEST_ENCODING_1, m_digestFileEncoding));
    }
  ...
  /**
   * @see org.opencms.db.I_CmsUserDriver#publishAccessControlEntries(org.opencms.db.CmsDbContext,
   *     org.opencms.file.CmsProject, org.opencms.file.CmsProject, org.opencms.util.CmsUUID,
   *     org.opencms.util.CmsUUID)
   */
  public void publishAccessControlEntries(
    ...
    List<CmsAccessControlEntry> aces =
        m_driverManager
            .getUserDriver(dbc)
            .readAccessControlEntries(dbc, offlineProject, offlineId, false);
  ...
  /**
   * @see org.opencms.db.I_CmsUserDriver#readAccessControlEntries(org.opencms.db.CmsDbContext,
   *     org.opencms.file.CmsProject, org.opencms.util.CmsUUID, boolean)
   */
  public List<CmsAccessControlEntry> readAccessControlEntries(
      CmsDbContext dbc, CmsProject project, CmsUUID resource, boolean inheritedOnly)
      throws CmsDataAccessException {
  ...
  /**
   * @see org.opencms.db.I_CmsUserDriver#readAccessControlEntry(org.opencms.db.CmsDbContext,
   *     org.opencms.file.CmsProject, org.opencms.util.CmsUUID, org.opencms.util.CmsUUID)
   */
  public CmsAccessControlEntry readAccessControlEntry(
      CmsDbContext dbc, CmsProject project, @RUntainted CmsUUID resource, @RUntainted CmsUUID principal)
      throws CmsDataAccessException {
  ...
  /**
   * @see org.opencms.db.I_CmsUserDriver#readChildGroups(org.opencms.db.CmsDbContext,
   *     java.lang.String)
   */
  public List<CmsGroup> readChildGroups(CmsDbContext dbc, @RUntainted String parentGroupFqn)
      throws CmsDataAccessException {
  ...
  /**
   * @see org.opencms.db.I_CmsUserDriver#readGroup(org.opencms.db.CmsDbContext,
   *     org.opencms.util.CmsUUID)
   */
  public CmsGroup readGroup(CmsDbContext dbc, @RUntainted CmsUUID groupId) throws CmsDataAccessException {
    ...
    try {
      ...
      if (res.next()) {
        ...
        CmsMessageContainer message =
            Messages.get().container(Messages.ERR_NO_GROUP_WITH_ID_1, groupId);
  ...
  public @RUntainted CmsGroup readGroup(CmsDbContext dbc, @RUntainted String groupFqn) throws CmsDataAccessException {
    ...
    @RUntainted CmsGroup group = null;
    ResultSet res = null;
    PreparedStatement stmt = null;
    Connection conn = null;
    ...
    try {
      ...
      if (res.next()) {
        ...
        CmsMessageContainer message =
            org.opencms.db.Messages.get()
                .container(org.opencms.db.Messages.ERR_UNKNOWN_GROUP_1, groupFqn);
        if (LOG.isDebugEnabled()) {
  ...
  /**
   * @see org.opencms.db.I_CmsUserDriver#readGroupsOfUser(CmsDbContext, CmsUUID, String, boolean,
   *     String, boolean)
   */
   ...
   */
  public CmsOrganizationalUnit readOrganizationalUnit(CmsDbContext dbc, @RUntainted String ouFqn)
      throws CmsDataAccessException {

    try {
      CmsResource resource =
          m_driverManager.readResource(dbc, ORGUNIT_BASE_FOLDER + ouFqn, CmsResourceFilter.DEFAULT);
      return internalCreateOrgUnitFromResource(dbc, resource);
    } catch (CmsVfsResourceNotFoundException e) {
      throw new CmsDbEntryNotFoundException(
          Messages.get().container(Messages.ERR_READ_ORGUNIT_1, ouFqn), e);
    } catch (CmsException e) {
      throw new CmsDataAccessException(e.getMessageContainer(), e);
    }
  }
  ...
  /**
   * @see org.opencms.db.I_CmsUserDriver#readUser(org.opencms.db.CmsDbContext,
   *     org.opencms.util.CmsUUID)
   */
  ...
  public CmsUser readUser(CmsDbContext dbc, @RUntainted String userFqn) throws CmsDataAccessException {
    ...
    try {
      ...
      if (res.next()) {
        ...
        CmsMessageContainer message =
            org.opencms.db.Messages.get()
                .container(org.opencms.db.Messages.ERR_UNKNOWN_USER_1, userFqn);
        if (LOG.isDebugEnabled()) {
          LOG.debug(message.key());
        }
        throw new CmsDbEntryNotFoundException(message);
  ...
  /**
   * @see org.opencms.db.I_CmsUserDriver#readUserInfos(org.opencms.db.CmsDbContext,
   *     org.opencms.util.CmsUUID)
   */
  public Map<String, Object> readUserInfos(CmsDbContext dbc, CmsUUID userId)
      throws CmsDataAccessException {
    ...
    try {
      ...
      // read the infos
      while (res.next()) {
        @RUntainted String key = res.getString(m_sqlManager.readQuery("C_USERDATA_KEY_0"));
        @RUntainted String type = res.getString(m_sqlManager.readQuery("C_USERDATA_TYPE_0"));
        ...
        try {
            ...
            if (value != null) {
              try {
                LOG.debug(
                    Messages.get()
                        .getBundle()
                        .key(Messages.LOG_DBG_READUSERINFO_VALUE_1, new String(value)));
              } catch (Exception e) {
                // noop
              }
            } else {
              LOG.debug(
                  Messages.get().getBundle().key(Messages.LOG_DBG_READUSERINFO_VALUE_1, null));
            }
          }
          ...
          LOG.error(
              Messages.get()
                  .container(Messages.ERR_READING_ADDITIONAL_INFO_1, userId.toString())
                  .key(),
              e);
        }
  ...
  public @RUntainted List<@RUntainted CmsUser> readUsersOfGroup(
      CmsDbContext dbc, @RUntainted String groupFqn, boolean includeOtherOuUsers)
      throws CmsDataAccessException {
  ...
  /**
   * @see org.opencms.db.I_CmsUserDriver#removeAccessControlEntries(org.opencms.db.CmsDbContext,
  ...
  /**
   * @see
   *     org.opencms.db.I_CmsUserDriver#removeAccessControlEntriesForPrincipal(org.opencms.db.CmsDbContext,
   *     org.opencms.file.CmsProject, org.opencms.file.CmsProject, org.opencms.util.CmsUUID)
   */
  public void removeAccessControlEntriesForPrincipal(
      CmsDbContext dbc, CmsProject project, CmsProject onlineProject, CmsUUID principal)
      throws CmsDataAccessException {
    ...
    if (dbc.getProjectId().isNullUUID()) {
      ...
      try {
        conn = m_sqlManager.getConnection(dbc);
        stmt =
            m_sqlManager.getPreparedStatement(conn, project, "C_ACCESS_REMOVE_ALL_FOR_PRINCIPAL_1");
    ...
    try {
      ...
      stmt =
          m_sqlManager.getPreparedStatement(
              conn, onlineProject, "C_ACCESS_REMOVE_ALL_FOR_PRINCIPAL_1");
      stmt.setString(1, principal.toString());
      stmt.executeUpdate();
    } catch (SQLException e) {
      throw new CmsDbSqlException(
  ...
  /**
   * @see org.opencms.db.I_CmsUserDriver#removeAccessControlEntry(org.opencms.db.CmsDbContext,
   *     org.opencms.file.CmsProject, org.opencms.util.CmsUUID, org.opencms.util.CmsUUID)
   */
  ...
  /**
   * @see
   *     org.opencms.db.I_CmsUserDriver#removeResourceFromOrganizationalUnit(org.opencms.db.CmsDbContext,
   *     org.opencms.security.CmsOrganizationalUnit, CmsResource)
   */
  public void removeResourceFromOrganizationalUnit(
    ...
    try {
      ...
      m_driverManager
          .getVfsDriver(dbc)
          .deleteRelations(dbc, dbc.currentProject().getUuid(), ouResource, filter);
      m_driverManager
          .getVfsDriver(dbc)
          .deleteRelations(dbc, CmsProject.ONLINE_PROJECT_ID, ouResource, filter);
      ...
      try {
        ...
        m_driverManager
            .getProjectDriver(dbc)
            .deleteProjectResource(dbc, orgUnit.getProjectId(), resource.getRootPath());
  ...
  /**
   * @see org.opencms.db.I_CmsUserDriver#searchUsers(org.opencms.db.CmsDbContext,
   *     org.opencms.file.CmsUserSearchParameters)
   */
  ...
  /**
   * @see org.opencms.db.I_CmsUserDriver#setUsersOrganizationalUnit(org.opencms.db.CmsDbContext,
   *     org.opencms.security.CmsOrganizationalUnit, org.opencms.file.CmsUser)
   */
  public void setUsersOrganizationalUnit(
      CmsDbContext dbc, CmsOrganizationalUnit orgUnit, CmsUser user) throws CmsDataAccessException {
  ...
  /**
   * @see org.opencms.db.I_CmsUserDriver#writeAccessControlEntry(org.opencms.db.CmsDbContext,
   *     org.opencms.file.CmsProject, org.opencms.security.CmsAccessControlEntry)
   */
  ...
  /**
   * @see org.opencms.db.I_CmsUserDriver#writeGroup(org.opencms.db.CmsDbContext,
  ...
  public void writeGroup(CmsDbContext dbc, CmsGroup group) throws CmsDataAccessException {
    ...
    if (group != null) {
      ...
      throw new CmsDbEntryNotFoundException(
          org.opencms.db.Messages.get()
              .container(org.opencms.db.Messages.ERR_UNKNOWN_GROUP_1, "null"));
    }
  }

  /**
   * @see org.opencms.db.I_CmsUserDriver#writeOrganizationalUnit(org.opencms.db.CmsDbContext,
   *     org.opencms.security.CmsOrganizationalUnit)
   */
  public void writeOrganizationalUnit(CmsDbContext dbc, CmsOrganizationalUnit organizationalUnit)
    ...
    try {
      CmsResource resource =
          m_driverManager.readResource(dbc, organizationalUnit.getId(), CmsResourceFilter.DEFAULT);
      ...
      m_driverManager
          .getVfsDriver(dbc)
          .writeResource(dbc, projectId, resource, CmsDriverManager.NOTHING_CHANGED);
      ...
      if (!dbc.currentProject().isOnlineProject()) {
        ...
        m_driverManager
            .getVfsDriver(dbc)
            .writeResource(
                dbc, onlineProject.getUuid(), resource, CmsDriverManager.NOTHING_CHANGED);
      }
  ...
  /**
   * @see org.opencms.db.I_CmsUserDriver#writePassword(org.opencms.db.CmsDbContext,
   *     java.lang.String, java.lang.String, java.lang.String)
   */
  public void writePassword(
      CmsDbContext dbc, @RUntainted String userFqn, String oldPassword, String newPassword)
    ...
    try {
      ...
      stmt.setString(2, CmsOrganizationalUnit.getSimpleName(userFqn));
      stmt.setString(
          3, CmsOrganizationalUnit.SEPARATOR + CmsOrganizationalUnit.getParentFqn(userFqn));
      stmt.executeUpdate();
    } catch (SQLException e) {
      throw new CmsDbSqlException(
          Messages.get()
  ...
  /**
   * @see org.opencms.db.I_CmsUserDriver#writeUser(org.opencms.db.CmsDbContext,
  ...
  /**
   * @see org.opencms.db.I_CmsUserDriver#writeUserInfo(org.opencms.db.CmsDbContext,
   *     org.opencms.util.CmsUUID, java.lang.String, java.lang.Object)
   */
   ...
   * @param countOnly if true, the query will only count the total number of results instead of
   *     returning them
   ...
   * @return a new {@link CmsAccessControlEntry} initialized with the values from the current
   *     database record
  ...
  protected CmsAccessControlEntry internalCreateAce(@RUntainted ResultSet res) throws SQLException {
    ...
    return internalCreateAce(
        res, new CmsUUID(res.getString(m_sqlManager.readQuery("C_ACCESS_RESOURCE_ID_0"))));
  }
   ...
   * @throws SQLException if something goes wrong
   */
  protected CmsAccessControlEntry internalCreateAce(@RUntainted ResultSet res, @RUntainted CmsUUID newId)
      throws SQLException {
   ...
   */
  protected void internalCreateDefaultGroups(
      CmsDbContext dbc, @RUntainted String ouFqn, String ouDescription, boolean webuser) throws CmsException {
    ...
    try {
      for (CmsRole role : CmsRole.getSystemRoles()) {
        ...
        @RUntainted String groupName = ouFqn + role.getGroupName();
      ...
      if (isRootOu && CmsLog.INIT.isErrorEnabled()) {
        CmsLog.INIT.error(
            Messages.get().getBundle().key(Messages.INIT_SYSTEM_ROLES_CREATION_FAILED_0), e);
      }
      throw new CmsInitException(
          Messages.get().container(Messages.ERR_INITIALIZING_USER_DRIVER_0), e);
    }
    ...
    // create groups
    @RUntainted String administratorsGroup = ouFqn + OpenCms.getDefaultUsers().getGroupAdministrators();
    String guestGroup = ouFqn + OpenCms.getDefaultUsers().getGroupGuests();
    @RUntainted String usersGroup = ouFqn + OpenCms.getDefaultUsers().getGroupUsers();
    ...
    @RUntainted String groupDescription =
        (CmsStringUtil.isNotEmptyOrWhitespaceOnly(ouDescription)
            ? CmsMacroResolver.localizedKeyMacro(
                Messages.GUI_DEFAULTGROUP_OU_USERS_DESCRIPTION_1, new String[] {ouDescription})
            : CmsMacroResolver.localizedKeyMacro(
    ...
    CmsGroup guests =
        createGroup(
            ...
            guestGroup,
            CmsMacroResolver.localizedKeyMacro(
                Messages.GUI_DEFAULTGROUP_ROOT_GUESTS_DESCRIPTION_0, null),
    ...
    createGroup(
        ...
        administratorsGroup,
        CmsMacroResolver.localizedKeyMacro(
            Messages.GUI_DEFAULTGROUP_ROOT_ADMINS_DESCRIPTION_0, null),
    ...
    if (!OpenCms.getDefaultUsers().getUserExport().equals(OpenCms.getDefaultUsers().getUserAdmin())
        && !OpenCms.getDefaultUsers()
            .getUserExport()
            .equals(OpenCms.getDefaultUsers().getUserGuest())) {
      ...
      CmsUser export =
          createUser(
              ...
              Collections.singletonMap(
                  ...
                  (Object)
                      CmsMacroResolver.localizedKeyMacro(
                          Messages.GUI_DEFAULTUSER_ROOT_EXPORT_DESCRIPTION_0, null)));
      createUserInGroup(dbc, export.getId(), guests.getId());
    }

    if (!OpenCms.getDefaultUsers()
            .getUserDeletedResource()
            .equals(OpenCms.getDefaultUsers().getUserAdmin())
        && !OpenCms.getDefaultUsers()
            .getUserDeletedResource()
            .equals(OpenCms.getDefaultUsers().getUserGuest())
        && !OpenCms.getDefaultUsers()
            .getUserDeletedResource()
            .equals(OpenCms.getDefaultUsers().getUserExport())) {
      ...
      createUser(
          ...
          Collections.singletonMap(
              ...
              (Object)
                  CmsMacroResolver.localizedKeyMacro(
                      Messages.GUI_DEFAULTUSER_ROOT_DELETED_DESCRIPTION_0, null)));
    }
   ...
   * @throws CmsException if something goes wrong
   */
  protected CmsOrganizationalUnit internalCreateOrgUnitFromResource(
      CmsDbContext dbc, CmsResource resource) throws CmsException {
    ...
    String description =
        m_driverManager
            .readPropertyObject(dbc, resource, ORGUNIT_PROPERTY_DESCRIPTION, false)
            .getStructureValue();
    int flags = (resource.getFlags() & ~CmsResource.FLAG_INTERNAL); // remove the internal flag
    String projectId =
        m_driverManager
            .readPropertyObject(dbc, resource, ORGUNIT_PROPERTY_PROJECTID, false)
            .getStructureValue();
    // create the object
   ...
   * @throws CmsException if something goes wrong
   */
  protected CmsResource internalCreateResourceForOrgUnit(CmsDbContext dbc, @RUntainted String path, @RUntainted int flags)
      throws CmsException {
    ...
    if (!dbc.currentProject().isOnlineProject() && dbc.getProjectId().isNullUUID()) {
      ...
      m_driverManager
          .getVfsDriver(dbc)
          .createResource(dbc, onlineProject.getUuid(), resource, null);
    }
  ...
  protected @RUntainted CmsUser internalCreateUser(CmsDbContext dbc, @RUntainted ResultSet res) throws SQLException {
    ...
    @RUntainted String userName = res.getString(m_sqlManager.readQuery("C_USERS_USER_NAME_0"));
    @RUntainted String ou =
        CmsOrganizationalUnit.removeLeadingSeparator(
   ...
   * @throws CmsException if something goes wrong
   */
  protected void internalDeleteOrgUnitResource(CmsDbContext dbc, @RUntainted CmsResource resource)
      throws CmsException {
    ...
    if (!dbc.currentProject().isOnlineProject()) {
      ...
      dbc.getRequestContext()
          .setCurrentProject(m_driverManager.readProject(dbc, CmsProject.ONLINE_PROJECT_ID));
      ...
      try {
        ...
        m_driverManager
            .getVfsDriver(dbc)
            .deleteRelations(
                dbc, dbc.getRequestContext().getCurrentProject().getUuid(), resource, filter);
      } finally {
    ...
    OpenCms.fireCmsEvent(
        new CmsEvent(
            ...
            Collections.<String, Object>singletonMap(
                I_CmsEventListener.KEY_RESOURCES, Collections.singletonList(resource))));
    OpenCms.fireCmsEvent(
        new CmsEvent(
  ...
  /**
   * Returns the folder for the given organizational units, or the base folder if <code>null</code>.
   *
   * <p>The base folder will be created if it does not exist.
   *
   * <p>
   *
   * @param dbc the current db context
  ...
  protected CmsResource internalOrgUnitFolder(CmsDbContext dbc, CmsOrganizationalUnit orgUnit)
    ...
    if (orgUnit != null) {
      return m_driverManager.readResource(
          dbc, ORGUNIT_BASE_FOLDER + orgUnit.getName(), CmsResourceFilter.DEFAULT);
    } else {
      return null;
    }
  }
  ...
  /**
   * Returns the list of root paths associated to the organizational unit represented by the given
   * resource.
   *
   * <p>
   *
   ...
   * @throws CmsException if something goes wrong
   */
  protected List<String> internalResourcesForOrgUnit(CmsDbContext dbc, CmsResource ouResource)
      throws CmsException {

    List<CmsRelation> relations =
        m_driverManager.getRelationsForResource(dbc, ouResource, CmsRelationFilter.TARGETS);
  ...
  protected void internalUpdateRoleGroup(CmsDbContext dbc, @RUntainted String groupName, CmsRole role)
    ...
    if (LOG.isDebugEnabled()) {
      LOG.debug(
          Messages.get()
              .getBundle()
              .key(Messages.LOG_DBG_UPDATE_ROLEGROUP_2, role.getRoleName(), groupName));
    }

    CmsGroup group = readGroup(dbc, groupName);
    if ((CmsRole.valueOf(group) == null) || !CmsRole.valueOf(group).equals(role)) {
      @RUntainted CmsGroup roleGroup = readGroup(dbc, role.getGroupName());
      ...
      while (it.hasNext()) {
        @RUntainted CmsUser user = it.next();
      ...
      try {
        ...
        LOG.error(
            "Could not write group flags in internalUpdateRoleGroup: " + e.getLocalizedMessage(),
            e);
      }
    }
  }
  ...
  protected void internalUpdateUserInfo(CmsDbContext dbc, @RUntainted CmsUUID userId, String key, Object value)
    ...
    try {
      ...
      throw new CmsDbIoException(
          Messages.get().container(Messages.ERR_SERIALIZING_USER_DATA_1, userId), e);
    } finally {
      m_sqlManager.closeAll(dbc, conn, stmt, null);
    }
  }
  ...
  /**
   * Validates the given root path to be in the scope of the resources of the given organizational
   * unit.
   *
   * <p>
   *
   ...
   * @throws CmsException if something goes wrong
   */
  protected void internalValidateResourceForOrgUnit(
      CmsDbContext dbc, CmsOrganizationalUnit orgUnit, @RUntainted String rootPath) throws CmsException {
  ...
  protected void internalWriteOrgUnitProperty(
      CmsDbContext dbc, CmsResource resource, CmsProperty property) throws CmsException {
    ...
    dbc.getRequestContext()
        .setCurrentProject(m_driverManager.readProject(dbc, CmsProject.ONLINE_PROJECT_ID));
    try {
      m_driverManager.writePropertyObject(
          dbc, resource, property); // assume the resource is identical in both projects
      resource.setState(CmsResource.STATE_UNCHANGED);
      m_driverManager
          .getVfsDriver(dbc)
          .writeResource(
              dbc, dbc.currentProject().getUuid(), resource, CmsDriverManager.NOTHING_CHANGED);
    } finally {
      dbc.getRequestContext().setCurrentProject(project);
    }
  }
   ...
   */
  protected void internalWriteUserInfos(
      CmsDbContext dbc, CmsUUID userId, Map<String, Object> additionalInfo)
      throws CmsDataAccessException {
