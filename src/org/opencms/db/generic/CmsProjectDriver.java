...
public class CmsProjectDriver implements I_CmsDriver, I_CmsProjectDriver {
  ...
  /**
   * This private class is a temporary storage for the method {@link
   * CmsProjectDriver#readLocks(CmsDbContext)}.
   *
   * <p>
   */
  private class CmsTempResourceLock {
     ...
     */
    public CmsTempResourceLock(
        String resourcePath, CmsUUID userId, CmsUUID projectId, int lockType) {
  ...
  public static final String DBC_ATTR_READ_PROJECT_FOR_RESOURCE =
  ...
  /**
   * @see org.opencms.db.I_CmsProjectDriver#cleanupPublishHistory(org.opencms.db.CmsDbContext,
  ...
  public int cleanupPublishHistory(CmsDbContext dbc, CmsPublishHistoryCleanupFilter filter)
    ...
    try {
      ...
      LOG.info(
          "executed publish list cleanup in mode "
              + filter.getMode()
              + ", "
              + rowsAffected
              + " rows deleted");
  ...
  /**
   * @see org.opencms.db.I_CmsProjectDriver#createProject(org.opencms.db.CmsDbContext, CmsUUID,
   *     org.opencms.file.CmsUser, org.opencms.file.CmsGroup, org.opencms.file.CmsGroup,
   *     java.lang.String, java.lang.String, int, CmsProject.CmsProjectType)
   */
  public CmsProject createProject(
    ...
    try {
      ...
      stmt.setString(
          10, CmsOrganizationalUnit.SEPARATOR + CmsOrganizationalUnit.getParentFqn(projectFqn));
  ...
  /**
   * @see org.opencms.db.I_CmsProjectDriver#createPublishJob(org.opencms.db.CmsDbContext,
  ...
  /**
   * @see
   *     org.opencms.db.I_CmsProjectDriver#deleteAllStaticExportPublishedResources(org.opencms.db.CmsDbContext,
   *     int)
   */
  ...
  /**
   * @see org.opencms.db.I_CmsProjectDriver#deleteLog(org.opencms.db.CmsDbContext,
  ...
  public void deleteLog(CmsDbContext dbc, CmsLogFilter filter) throws CmsDataAccessException {
    ...
    try {
      ...
      CmsPair<String, List<I_CmsPreparedStatementParameter>> conditionsAndParams =
          prepareLogConditions(filter);
  ...
  /**
   * @see org.opencms.db.I_CmsProjectDriver#deleteProject(org.opencms.db.CmsDbContext,
  ...
  /**
   * @see org.opencms.db.I_CmsProjectDriver#deleteProjectResource(org.opencms.db.CmsDbContext,
   *     CmsUUID, java.lang.String)
   */
  ...
  /**
   * @see org.opencms.db.I_CmsProjectDriver#deleteProjectResources(org.opencms.db.CmsDbContext,
   *     org.opencms.file.CmsProject)
   */
  public void deleteProjectResources(CmsDbContext dbc, CmsProject project)
      throws CmsDataAccessException {
  ...
  /**
   * @see org.opencms.db.I_CmsProjectDriver#deletePublishHistory(org.opencms.db.CmsDbContext,
   *     CmsUUID, int)
   */
  ...
  /**
   * @see org.opencms.db.I_CmsProjectDriver#deletePublishHistoryEntry(org.opencms.db.CmsDbContext,
   *     org.opencms.util.CmsUUID, org.opencms.db.CmsPublishedResource)
   */
  public void deletePublishHistoryEntry(
      CmsDbContext dbc, CmsUUID publishHistoryId, CmsPublishedResource publishedResource)
      throws CmsDataAccessException {
  ...
  /**
   * @see org.opencms.db.I_CmsProjectDriver#deletePublishJob(org.opencms.db.CmsDbContext,
  ...
  /**
   * @see org.opencms.db.I_CmsProjectDriver#deletePublishList(org.opencms.db.CmsDbContext,
   *     org.opencms.util.CmsUUID)
   */
  ...
  /**
   * @see
   *     org.opencms.db.I_CmsProjectDriver#deleteStaticExportPublishedResource(org.opencms.db.CmsDbContext,
  ...
  /**
   * @see
   *     org.opencms.db.I_CmsProjectDriver#deleteUserPublishListEntries(org.opencms.db.CmsDbContext,
   *     java.util.List)
   */
  public void deleteUserPublishListEntries(
      CmsDbContext dbc, List<CmsUserPublishListEntry> publishListDeletions)
  ...
  public void fillDefaults(CmsDbContext dbc) throws CmsDataAccessException {
    ...
    m_driverManager
        .getVfsDriver(dbc)
        .createResource(dbc, onlineProject.getUuid(), rootFolder, null);

    // important: must access through driver manager to ensure proper cascading
    m_driverManager
        .getProjectDriver(dbc)
        .createProjectResource(dbc, onlineProject.getUuid(), rootFolder.getRootPath());

    // create the system-folder for the online project
    CmsFolder systemFolder =
        new CmsFolder(
            new CmsUUID(),
            new CmsUUID(),
            "/system",
    ...
    m_driverManager
        .getVfsDriver(dbc)
        .createResource(dbc, onlineProject.getUuid(), systemFolder, null);
    ...
    CmsResource offlineRootFolder =
        m_driverManager
            .getVfsDriver(dbc)
            .createResource(dbc, setupProject.getUuid(), rootFolder, null);
    ...
    m_driverManager
        .getVfsDriver(dbc)
        .writeResource(
            dbc, setupProject.getUuid(), offlineRootFolder, CmsDriverManager.NOTHING_CHANGED);

    // important: must access through driver manager to ensure proper cascading
    m_driverManager
        .getProjectDriver(dbc)
        .createProjectResource(dbc, setupProject.getUuid(), offlineRootFolder.getRootPath());

    systemFolder.setState(CmsResource.STATE_CHANGED);
    // create the system-folder for the offline project
    CmsResource offlineSystemFolder =
        m_driverManager
            .getVfsDriver(dbc)
            .createResource(dbc, setupProject.getUuid(), systemFolder, null);
    ...
    m_driverManager
        .getVfsDriver(dbc)
        .writeResource(
            dbc, setupProject.getUuid(), offlineSystemFolder, CmsDriverManager.NOTHING_CHANGED);
  }
  ...
  /**
   * @see org.opencms.db.I_CmsProjectDriver#getUsersPubList(org.opencms.db.CmsDbContext,
   *     org.opencms.util.CmsUUID)
   */
  ...
  /**
   * @see org.opencms.db.I_CmsDriver#init(CmsDbContext, CmsConfigurationManager, List,
   *     CmsDriverManager)
   */
  public void init(
      CmsDbContext dbc,
  ...
  public void log(CmsDbContext dbc, List<CmsLogEntry> logEntries) throws CmsDbSqlException {
    ...
    try {
      ...
      for (CmsLogEntry logEntry : logEntries) {
        ...
        stmt.setString(
            3, logEntry.getStructureId() == null ? null : logEntry.getStructureId().toString());
  ...
  /**
   * @see org.opencms.db.I_CmsProjectDriver#publishDeletedFolder(org.opencms.db.CmsDbContext,
   *     org.opencms.report.I_CmsReport, int, int, org.opencms.file.CmsProject,
   *     org.opencms.file.CmsFolder, org.opencms.util.CmsUUID, int)
   */
  public void publishDeletedFolder(
    ...
    try {
      ...
      CmsResourceState folderState =
          fixMovedResource(dbc, onlineProject, currentFolder, publishHistoryId, publishTag);

      // read the folder online
      CmsFolder onlineFolder =
          m_driverManager.readFolder(dbc, currentFolder.getRootPath(), CmsResourceFilter.ALL);
      ...
      for (CmsResource delFile : movedFiles) {
        try {
          CmsResource offlineResource =
              vfsDriver.readResource(
                  dbc, dbc.currentProject().getUuid(), delFile.getStructureId(), true);
          if (offlineResource.isFile()) {
            CmsFile offlineFile = new CmsFile(offlineResource);
            offlineFile.setContents(
                vfsDriver.readContent(
                    dbc, dbc.currentProject().getUuid(), offlineFile.getResourceId()));
      ...
      try {
        ...
        if (LOG.isErrorEnabled()) {
          LOG.error(
              Messages.get()
                  .getBundle()
                  .key(Messages.LOG_DELETING_PROPERTIES_1, currentFolder.getRootPath()),
              e);
        }
        throw e;
      }
      ...
      try {
        ...
        if (LOG.isErrorEnabled()) {
          LOG.error(
              Messages.get()
                  .getBundle()
                  .key(Messages.LOG_REMOVING_RESOURCE_1, currentFolder.getRootPath()),
              e);
        }
        throw e;
      }
      ...
      try {
        ...
        m_driverManager
            .getUserDriver(dbc)
            .removeAccessControlEntries(dbc, onlineProject, onlineFolder.getResourceId());
        m_driverManager
            .getUserDriver(dbc)
        ...
        if (LOG.isErrorEnabled()) {
          LOG.error(
              Messages.get()
                  .getBundle()
                  .key(Messages.LOG_REMOVING_ACL_1, currentFolder.getRootPath()),
              e);
        }
        throw e;
      }
      ...
      try {
        vfsDriver.deleteRelations(
            dbc, onlineProject.getUuid(), onlineFolder, CmsRelationFilter.TARGETS);
        vfsDriver.deleteRelations(
            dbc, dbc.currentProject().getUuid(), currentFolder, CmsRelationFilter.TARGETS);
      } catch (CmsDataAccessException e) {
        if (LOG.isErrorEnabled()) {
          LOG.error(
              Messages.get()
                  .getBundle()
                  .key(Messages.LOG_REMOVING_RELATIONS_1, currentFolder.getRootPath()),
              e);
        }
        throw e;
      }
      ...
      Iterator<CmsProject> itProjects =
          readProjectsForResource(dbc, deletedResourceRootPath).iterator();
      ...
      try {
        m_driverManager
            .getVfsDriver(dbc)
            .deleteAliases(
                dbc, onlineProject, new CmsAliasFilter(null, null, currentFolder.getStructureId()));
      } catch (CmsDataAccessException e) {
  ...
  /**
   * @see org.opencms.db.I_CmsProjectDriver#publishFile(org.opencms.db.CmsDbContext,
   *     org.opencms.report.I_CmsReport, int, int, org.opencms.file.CmsProject,
   *     org.opencms.file.CmsResource, java.util.Set, org.opencms.util.CmsUUID, int)
   */
  public void publishFile(
    ...
    try {
      ...
      if (offlineResource.getState().isDeleted()) {
        ...
        boolean removeDeleted =
            Boolean.parseBoolean(
                CmsProperty.get(CmsPropertyDefinition.PROPERTY_HISTORY_REMOVE_DELETED, props)
                    .getValue("false"));
        ...
        report.print(
            Messages.get().container(Messages.RPT_PUBLISH_FILE_0), I_CmsReport.FORMAT_NOTE);
        report.print(
            org.opencms.report.Messages.get()
                .container(
                    org.opencms.report.Messages.RPT_ARGUMENT_1,
        ...
        publishChangedFile(
            dbc, onlineProject, offlineResource, publishedContentIds, publishHistoryId, publishTag);
      ...
      OpenCms.fireCmsEvent(
          new CmsEvent(I_CmsEventListener.EVENT_RESOURCE_AND_PROPERTIES_MODIFIED, data));
    }
  }

  /**
   * @see org.opencms.db.I_CmsProjectDriver#publishFileContent(CmsDbContext, CmsProject, CmsProject,
   *     CmsResource, Set, boolean, int)
   */
  public CmsFile publishFileContent(
    ...
    try {
      ...
      CmsUUID projectIdForReading =
          (!dbcHasProjectId ? offlineProject.getUuid() : CmsProject.ONLINE_PROJECT_ID);
      dbc.setProjectId(offlineProject.getUuid());
      byte[] offlineContent =
          m_driverManager
              .getVfsDriver(dbc)
              .readContent(dbc, projectIdForReading, offlineResource.getResourceId());
      CmsFile offlineFile = new CmsFile(offlineResource);
      ...
      if (!offlineFile.getState().isNew()) {
        ...
        if (!m_driverManager
            .getVfsDriver(dbc)
            .validateResourceIdExists(dbc, onlineProject.getUuid(), offlineFile.getResourceId())) {
      ...
      if (createSibling) {
        if (!alreadyPublished) {
          // create the file online, the first time a sibling is published also the resource entry
          // has to be actualized
          m_driverManager
              .getVfsDriver(dbc)
              .createResource(dbc, onlineProject.getUuid(), newFile, null);
        } else {
      ...
      // mark the resource as written to avoid that the same content is written for each sibling
      // instance
      ...
      if (LOG.isErrorEnabled()) {
        LOG.error(
            Messages.get()
                .getBundle()
                .key(Messages.LOG_PUBLISHING_FILE_CONTENT_1, offlineResource.toString()),
            e);
      }
      throw e;
    }
  ...
  /**
   * @see org.opencms.db.I_CmsProjectDriver#publishFolder(org.opencms.db.CmsDbContext,
   *     org.opencms.report.I_CmsReport, int, int, org.opencms.file.CmsProject,
   *     org.opencms.file.CmsFolder, org.opencms.util.CmsUUID, int)
   */
  public void publishFolder(
    ...
    try {
      report.print(
          ...
          I_CmsReport.FORMAT_NOTE);
      report.print(
          Messages.get().container(Messages.RPT_PUBLISH_FOLDER_0), I_CmsReport.FORMAT_NOTE);
      report.print(
          org.opencms.report.Messages.get()
              .container(
                  org.opencms.report.Messages.RPT_ARGUMENT_1,
      ...
      CmsResourceState resourceState =
          fixMovedResource(dbc, onlineProject, offlineFolder, publishHistoryId, publishTag);
      ...
      if (offlineFolder.getState().isNew()) {
        try {
          ...
          onlineFolder =
              m_driverManager
                  .getVfsDriver(dbc)
                  .createResource(dbc, onlineProject.getUuid(), newFolder, null);
          m_driverManager
              .getVfsDriver(dbc)
              .publishResource(dbc, onlineProject, onlineFolder, offlineFolder);
          // update version numbers
          ...
          if (!offlineFolder.getRootPath().equals("/")
            ...
            LOG.warn(
                Messages.get()
                    .getBundle()
                    .key(Messages.LOG_WARN_FOLDER_WRONG_STATE_CN_1, offlineFolder.getRootPath()));
          }
          try {
            onlineFolder =
                m_driverManager
                    .getVfsDriver(dbc)
                    .readFolder(dbc, onlineProject.getUuid(), offlineFolder.getRootPath());
            m_driverManager
                .getVfsDriver(dbc)
                .publishResource(dbc, onlineProject, onlineFolder, offlineFolder);
            // update version numbers
            ...
            if (LOG.isErrorEnabled()) {
              LOG.error(
                  Messages.get()
                      .getBundle()
                      .key(Messages.LOG_READING_RESOURCE_1, offlineFolder.getRootPath()),
                  e);
            }
            throw e1;
          }
          ...
          if (LOG.isErrorEnabled()) {
            LOG.error(
                Messages.get()
                    .getBundle()
                    .key(Messages.LOG_PUBLISHING_RESOURCE_1, offlineFolder.getRootPath()),
                e);
          }
          throw e;
        }
        ...
        try {
          ...
          onlineFolder =
              m_driverManager
                  .getVfsDriver(dbc)
                  .readFolder(dbc, onlineProject.getUuid(), offlineFolder.getStructureId());
        } catch (CmsVfsResourceNotFoundException e) {
          if (LOG.isWarnEnabled()) {
            LOG.warn(
                Messages.get()
                    .getBundle()
                    .key(Messages.LOG_WARN_FOLDER_WRONG_STATE_NC_1, offlineFolder.getRootPath()));
          }
          try {
            onlineFolder =
                m_driverManager
                    .getVfsDriver(dbc)
                    .createResource(dbc, onlineProject.getUuid(), offlineFolder, null);
        ...
        try {
          ...
          if (LOG.isErrorEnabled()) {
            LOG.error(
                Messages.get()
                    .getBundle()
                    .key(Messages.LOG_PUBLISHING_ACL_1, offlineFolder.getRootPath()),
                e);
          }
          throw e;
        }
      ...
      try {
        ...
        offlineProperties =
            m_driverManager
                .getVfsDriver(dbc)
                .readPropertyObjects(dbc, dbc.currentProject(), offlineFolder);
        CmsProperty.setAutoCreatePropertyDefinitions(offlineProperties, true);
        m_driverManager
            .getVfsDriver(dbc)
            .writePropertyObjects(dbc, onlineProject, onlineFolder, offlineProperties);
      } catch (CmsDataAccessException e) {
        if (LOG.isErrorEnabled()) {
          LOG.error(
              Messages.get()
                  .getBundle()
                  .key(Messages.LOG_PUBLISHING_PROPERTIES_1, offlineFolder.getRootPath()),
              e);
        }
        throw e;
      }
      ...
      OpenCms.fireCmsEvent(
          new CmsEvent(
              I_CmsEventListener.EVENT_RESOURCE_AND_PROPERTIES_MODIFIED,
              Collections.<String, Object>singletonMap(
                  I_CmsEventListener.KEY_RESOURCE, offlineFolder)));
    }
  }

  /**
   * @see org.opencms.db.I_CmsProjectDriver#publishProject(org.opencms.db.CmsDbContext,
   *     org.opencms.report.I_CmsReport, org.opencms.file.CmsProject, org.opencms.db.CmsPublishList,
   *     int)
   */
    ...
    try {
      ...
      if (OpenCms.getSystemInfo().isHistoryEnabled()) {
        try {
          ...
          m_driverManager
              .getHistoryDriver(dbc)
              .writeProject(dbc, publishTag, System.currentTimeMillis());
          dbc.pop();
        } catch (Throwable t) {
          dbc.report(
              report,
              Messages.get()
                  .container(
                      Messages.ERR_WRITING_HISTORY_OF_PROJECT_1, dbc.currentProject().getName()),
              t);
        }
      }
      ...
      while (itFolders.hasNext()) {
        ...
        try {
          ...
          dbc.report(
              report,
              Messages.get()
                  .container(Messages.ERR_ERROR_PUBLISHING_FOLDER_1, currentFolder.getRootPath()),
              t);
        }
      }
      ...
      Set<CmsUUID> changedAndDeletedResourceIds =
      ...
      while (itFiles.hasNext()) {
        ...
        try {
          ...
          dbc.report(
              report,
              Messages.get()
                  .container(Messages.ERR_ERROR_PUBLISHING_FILE_1, currentResource.getRootPath()),
              t);
        }
      }
      ...
      while (itDeletedFolders.hasNext()) {
        ...
        try {
          ...
          dbc.report(
              ...
              Messages.get()
                  .container(
                      Messages.ERR_ERROR_PUBLISHING_DELETED_FOLDER_1, currentFolder.getRootPath()),
              t);
        }
      }
      ...
      OpenCms.fireCmsEvent(
          new CmsEvent(
              I_CmsEventListener.EVENT_CLEAR_CACHES, Collections.<String, Object>emptyMap()));
  ...
  public List<CmsLock> readLocks(CmsDbContext dbc) throws CmsDataAccessException {
    ...
    try {
      ...
      while (rs.next()) {
        String resourcePath =
            rs.getString(m_sqlManager.readQuery("C_RESOURCE_LOCKS_RESOURCE_PATH"));
        CmsUUID userId =
            new CmsUUID(rs.getString(m_sqlManager.readQuery("C_RESOURCE_LOCKS_USER_ID")));
        CmsUUID projectId =
            new CmsUUID(rs.getString(m_sqlManager.readQuery("C_RESOURCE_LOCKS_PROJECT_ID")));
        int lockType = rs.getInt(m_sqlManager.readQuery("C_RESOURCE_LOCKS_LOCK_TYPE"));
        CmsTempResourceLock tmpLock =
            new CmsTempResourceLock(resourcePath, userId, projectId, lockType);
    ...
    if (LOG.isDebugEnabled()) {
      LOG.debug(
          Messages.get().getBundle().key(Messages.LOG_DBG_READ_LOCKS_1, new Integer(locks.size())));
    }
    return locks;
  }

  /**
   * @see org.opencms.db.I_CmsProjectDriver#readLog(org.opencms.db.CmsDbContext,
   *     org.opencms.db.log.CmsLogFilter)
   */
  public List<CmsLogEntry> readLog(CmsDbContext dbc, CmsLogFilter filter)
      throws CmsDataAccessException {
    ...
    try {
      ...
      CmsPair<String, List<I_CmsPreparedStatementParameter>> conditionsAndParameters =
          prepareLogConditions(filter);
  ...
  public CmsProject readProject(CmsDbContext dbc, String projectFqn) throws CmsDataAccessException {
    ...
    try {
      ...
      stmt.setString(
          2, CmsOrganizationalUnit.SEPARATOR + CmsOrganizationalUnit.getParentFqn(projectFqn));
      res = stmt.executeQuery();
  ...
  /**
   * @see org.opencms.db.I_CmsProjectDriver#readProjectResources(org.opencms.db.CmsDbContext,
   *     org.opencms.file.CmsProject)
   */
  ...
  public List<CmsProject> readProjects(CmsDbContext dbc, String ouFqn)
      throws CmsDataAccessException {
  ...
  /**
   * @see org.opencms.db.I_CmsProjectDriver#readProjectsForGroup(org.opencms.db.CmsDbContext,
   *     org.opencms.file.CmsGroup)
   */
  public List<CmsProject> readProjectsForGroup(CmsDbContext dbc, CmsGroup group)
      throws CmsDataAccessException {
  ...
  /**
   * @see org.opencms.db.I_CmsProjectDriver#readProjectsForManagerGroup(org.opencms.db.CmsDbContext,
   *     org.opencms.file.CmsGroup)
   */
   ...
   */
  public List<CmsProject> readProjectsForResource(CmsDbContext dbc, String rootPath)
      throws CmsDataAccessException {
  ...
  /**
   * @see org.opencms.db.I_CmsProjectDriver#readProjectsForUser(org.opencms.db.CmsDbContext,
   *     org.opencms.file.CmsUser)
   */
  public List<CmsProject> readProjectsForUser(CmsDbContext dbc, CmsUser user)
      throws CmsDataAccessException {
  ...
  /**
   * @see org.opencms.db.I_CmsProjectDriver#readPublishedResources(org.opencms.db.CmsDbContext,
   *     org.opencms.util.CmsUUID)
   */
  public List<CmsPublishedResource> readPublishedResources(
      CmsDbContext dbc, CmsUUID publishHistoryId) throws CmsDataAccessException {
  ...
  /**
   * @see org.opencms.db.I_CmsProjectDriver#readPublishJob(org.opencms.db.CmsDbContext,
   *     org.opencms.util.CmsUUID)
   */
  ...
  public CmsPublishList readPublishList(CmsDbContext dbc, CmsUUID publishHistoryId)
    ...
    try {
      ...
      throw new CmsDataAccessException(
          Messages.get()
              .container(Messages.ERR_PUBLISHLIST_DESERIALIZATION_FAILED_1, publishHistoryId),
          e);
    } finally {
      m_sqlManager.closeAll(dbc, conn, stmt, res);
    }
  ...
  /**
   * @see org.opencms.db.I_CmsProjectDriver#readPublishReportContents(org.opencms.db.CmsDbContext,
   *     org.opencms.util.CmsUUID)
   */
  ...
  /**
   * @see
   *     org.opencms.db.I_CmsProjectDriver#readStaticExportPublishedResourceParameters(org.opencms.db.CmsDbContext,
   *     java.lang.String)
   */
  ...
  /**
   * @see org.opencms.db.I_CmsProjectDriver#readStaticExportResources(org.opencms.db.CmsDbContext,
   *     int, long)
   */
  public List<String> readStaticExportResources(
      CmsDbContext dbc, int parameterResources, long timestamp) throws CmsDataAccessException {
  ...
  /**
   * @see org.opencms.db.I_CmsProjectDriver#unmarkProjectResources(org.opencms.db.CmsDbContext,
   *     org.opencms.file.CmsProject)
   */
  public void unmarkProjectResources(CmsDbContext dbc, CmsProject project)
      throws CmsDataAccessException {
  ...
  public void writeLocks(CmsDbContext dbc, List<CmsLock> locks) throws CmsDataAccessException {
    ...
    try {
      ...
      if (LOG.isDebugEnabled()) {
        LOG.debug(
            Messages.get().getBundle().key(Messages.LOG_DBG_WRITE_LOCKS_1, new Integer(count)));
      }
    } catch (SQLException e) {
      throw new CmsDbSqlException(
          Messages.get()
  ...
  /**
   * @see org.opencms.db.I_CmsProjectDriver#writeProject(org.opencms.db.CmsDbContext,
   *     org.opencms.file.CmsProject)
   */
  ...
  /**
   * @see org.opencms.db.I_CmsProjectDriver#writePublishHistory(org.opencms.db.CmsDbContext,
   *     org.opencms.util.CmsUUID, org.opencms.db.CmsPublishedResource)
   */
  ...
  /**
   * @see org.opencms.db.I_CmsProjectDriver#writePublishJob(org.opencms.db.CmsDbContext,
   *     org.opencms.publish.CmsPublishJobInfoBean)
   */
  ...
  /**
   * @see org.opencms.db.I_CmsProjectDriver#writePublishReport(org.opencms.db.CmsDbContext,
  ...
  /**
   * @see
   *     org.opencms.db.I_CmsProjectDriver#writeStaticExportPublishedResource(org.opencms.db.CmsDbContext,
  ...
  /**
   * @see org.opencms.db.I_CmsProjectDriver#writeUserPublishListEntries(org.opencms.db.CmsDbContext,
   *     java.util.List)
   */
  ...
  /**
   * Creates a <code>CmsPublishJobInfoBean</code> from a result set.
   *
   * <p>
   *
  ...
  /**
   * Checks if the given resource (by id) is available in the online project, if there exists a
   * resource with a different path (a moved file), then the online entry is moved to the right
   * (new) location before publishing.
   *
   * <p>
   *
  ...
  protected CmsResourceState fixMovedResource(
    ...
    try {
      onlineResource =
          m_driverManager
              .getVfsDriver(dbc)
              .readResource(dbc, onlineProject.getUuid(), offlineResource.getStructureId(), true);
    ...
    m_driverManager
        .getVfsDriver(dbc)
        .moveResource(dbc, onlineProject.getUuid(), onlineResource, offlineResource.getRootPath());
    ...
    try {
      ...
      m_driverManager
          ...
          .writePublishHistory(
              ...
              publishHistoryId,
              new CmsPublishedResource(
                  onlineResource, publishTag, CmsPublishedResource.STATE_MOVED_SOURCE));
    } catch (CmsDataAccessException e) {
      if (LOG.isErrorEnabled()) {
        LOG.error(
            Messages.get()
                .getBundle()
                .key(Messages.LOG_WRITING_PUBLISHING_HISTORY_1, onlineResource.getRootPath()),
            e);
      }
      throw e;
    }
   ...
   *
   * <p>This is the old implementation of the user publish list and can get pretty slow.
   *
   * <p>
   *
   ...
   * @throws CmsDataAccessException if something goes wrong
   */
  protected List<CmsResource> getUsersPubListFromLog(CmsDbContext dbc, CmsUUID userId)
      throws CmsDataAccessException {
    ...
    try {
      ...
      stmt =
          m_sqlManager.getPreparedStatement(
              conn, dbc.currentProject().getUuid(), "C_LOG_READ_PUBLISH_LIST_2");
      stmt.setString(1, userId.toString());
  ...
  protected CmsProject internalCreateProject(ResultSet res) throws SQLException {
    ...
    return new CmsProject(
        ...
        CmsProject.CmsProjectType.valueOf(
            res.getInt(m_sqlManager.readQuery("C_PROJECTS_PROJECT_TYPE_0"))));
  }
  ...
  /**
   * Creates a new {@link CmsLogEntry} object from the given result set entry.
   *
   * <p>
   *
   * @param res the result set
  ...
  protected void internalResetResourceState(CmsDbContext dbc, CmsResource resource)
    ...
    try {
      ...
      m_driverManager
          .getVfsDriver(dbc)
          .writeResourceState(
              dbc, dbc.currentProject(), resource, CmsDriverManager.UPDATE_ALL, true);
    } catch (CmsDataAccessException e) {
      if (LOG.isErrorEnabled()) {
        LOG.error(
            Messages.get()
                .getBundle()
                .key(Messages.LOG_ERROR_RESETTING_RESOURCE_STATE_1, resource.getRootPath()),
            e);
      }
      throw e;
    }
  ...
  protected void internalWriteHistory(
    ...
    try {
      if (OpenCms.getSystemInfo().isHistoryEnabled()) {
        ...
        if (properties == null) {
          properties =
              m_driverManager
                  .getVfsDriver(dbc)
                  .readPropertyObjects(dbc, dbc.currentProject(), resource);
        }
      ...
      m_driverManager
          .getProjectDriver(dbc)
          .writePublishHistory(
              dbc, publishHistoryId, new CmsPublishedResource(resource, publishTag, state));
    } catch (CmsDataAccessException e) {
      if (LOG.isErrorEnabled()) {
        LOG.error(
            Messages.get()
                .getBundle()
                .key(Messages.LOG_WRITING_PUBLISHING_HISTORY_1, resource.getRootPath()),
            e);
      }
      throw e;
    }
   ...
   */
  protected CmsPair<String, List<I_CmsPreparedStatementParameter>> prepareLogConditions(
      CmsLogFilter filter) {
  ...
  protected void publishChangedFile(
    ...
    boolean existsOnline =
        m_driverManager
            ...
            .validateStructureIdExists(
                dbc, CmsProject.ONLINE_PROJECT_ID, offlineResource.getStructureId());
    CmsResourceState resourceState =
        existsOnline
    ...
    try {
      ...
      if (existsOnline) {
        ...
        onlineResource =
            m_driverManager
                .getVfsDriver(dbc)
                .readResource(
                    dbc, onlineProject.getUuid(), offlineResource.getStructureId(), false);
        ...
        if (!onlineResource.getResourceId().equals(offlineResource.getResourceId())) {
          List<CmsProperty> offlineProperties =
              m_driverManager
                  .getVfsDriver(dbc)
                  .readPropertyObjects(dbc, dbc.currentProject(), onlineResource);
          if (offlineProperties.size() > 0) {
            ...
            for (int i = 0; i < offlineProperties.size(); i++) {
              ...
              CmsProperty newProperty =
                  new CmsProperty(oldProperty.getName(), null, CmsProperty.DELETE_VALUE);
              newProperties.add(newProperty);
            }
            m_driverManager
                .getVfsDriver(dbc)
                .writePropertyObjects(dbc, dbc.currentProject(), onlineResource, newProperties);
          }
        }
      }
    } catch (CmsDataAccessException e) {
      if (LOG.isErrorEnabled()) {
        LOG.error(
            Messages.get()
                .getBundle()
                .key(Messages.LOG_DELETING_PROPERTIES_1, offlineResource.toString()),
            e);
      }
      throw e;
    }
    ...
    try {
      ...
      if (LOG.isErrorEnabled()) {
        LOG.error(
            Messages.get()
                .getBundle()
                .key(Messages.LOG_PUBLISHING_RESOURCE_1, offlineResource.getRootPath()),
            e);
      }
      throw e;
    }
    ...
    try {
      ...
      offlineProperties =
          m_driverManager
              .getVfsDriver(dbc)
              .readPropertyObjects(dbc, dbc.currentProject(), offlineResource);
      CmsProperty.setAutoCreatePropertyDefinitions(offlineProperties, true);
      m_driverManager
          .getVfsDriver(dbc)
          .writePropertyObjects(dbc, onlineProject, newFile, offlineProperties);
    } catch (CmsDataAccessException e) {
      if (LOG.isErrorEnabled()) {
        LOG.error(
            Messages.get()
                .getBundle()
                .key(Messages.LOG_PUBLISHING_PROPERTIES_1, newFile.getRootPath()),
            e);
      }
      throw e;
    }
  ...
  protected void publishDeletedFile(
      ...
      try {
        ...
        if (LOG.isErrorEnabled()) {
          LOG.error(
              Messages.get()
                  .getBundle()
                  .key(Messages.LOG_READING_RESOURCE_1, offlineResource.getRootPath()),
              e);
        }
        throw e;
      }
    }
    if (offlineResource.isLabeled()
        && !m_driverManager.labelResource(dbc, offlineResource, null, 2)) {
    ...
    offlineFile.setContents(
        m_driverManager
            .getVfsDriver(dbc)
            .readContent(dbc, dbc.currentProject().getUuid(), offlineFile.getResourceId()));
    ...
    try {
      ...
      if (offlineResource.getSiblingCount() > 1) {
        // there are other siblings- delete only structure property values and keep the resource
        // property values
      ...
      if (existsOnline) {
        m_driverManager
            .getVfsDriver(dbc)
            .deletePropertyObjects(
                dbc, onlineProject.getUuid(), onlineResource, propertyDeleteOption);
      }
      m_driverManager
          .getVfsDriver(dbc)
          .deletePropertyObjects(
              dbc, dbc.currentProject().getUuid(), offlineResource, propertyDeleteOption);
      ...
      if (LOG.isErrorEnabled()) {
        LOG.error(
            Messages.get()
                .getBundle()
                .key(Messages.LOG_DELETING_PROPERTIES_1, offlineResource.getRootPath()),
            e);
      }
      throw e;
    }
    ...
    try {
      ...
      m_driverManager
          .getVfsDriver(dbc)
          .removeFile(dbc, dbc.currentProject().getUuid(), offlineResource);
      ...
      if (LOG.isErrorEnabled()) {
        LOG.error(
            Messages.get()
                .getBundle()
                .key(Messages.LOG_REMOVING_RESOURCE_1, offlineResource.getRootPath()),
            e);
      }
      throw e;
    }
    ...
    try {
      if (existsOnline && (onlineResource != null) && (onlineResource.getSiblingCount() == 1)) {
        ...
        m_driverManager
            .getUserDriver(dbc)
            .removeAccessControlEntries(dbc, onlineProject, onlineResource.getResourceId());
      }
      if (offlineResource.getSiblingCount() == 1) {
        // only if no siblings left
        m_driverManager
            .getUserDriver(dbc)
            .removeAccessControlEntries(dbc, dbc.currentProject(), offlineResource.getResourceId());
      }
    } catch (CmsDataAccessException e) {
      if (LOG.isErrorEnabled()) {
        LOG.error(
            Messages.get().getBundle().key(Messages.LOG_REMOVING_ACL_1, offlineResource.toString()),
            e);
      }
      throw e;
    }
    ...
    try {
      ...
      if (LOG.isErrorEnabled()) {
        LOG.error(
            Messages.get()
                .getBundle()
                .key(Messages.LOG_REMOVING_RELATIONS_1, offlineResource.toString()),
            e);
      }
      throw e;
    }
    ...
    if (OpenCms.getSubscriptionManager().isEnabled()) {
      try {
        ...
        CmsVisitEntryFilter filter =
            CmsVisitEntryFilter.ALL.filterResource(offlineResource.getStructureId());
        m_driverManager
        ...
        if (LOG.isErrorEnabled()) {
          LOG.error(
              Messages.get()
                  .getBundle()
                  .key(Messages.LOG_REMOVING_VISITEDLOG_1, offlineResource.toString()),
              e);
        }
        throw e;
      }
      ...
      try {
        ...
        m_driverManager
            ...
            .setSubscribedResourceAsDeleted(
                dbc, OpenCms.getSubscriptionManager().getPoolName(), offlineResource);
      } catch (CmsDataAccessException e) {
        if (LOG.isErrorEnabled()) {
          LOG.error(
              Messages.get()
                  .getBundle()
                  .key(Messages.LOG_REMOVING_SUBSCRIPTIONS_1, offlineResource.toString()),
              e);
        }
        throw e;
      }
