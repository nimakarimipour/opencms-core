...
public class CmsUserSettings {
  ...
  public static final class CmsSearchResultStyle extends A_CmsModeStringEnumeration {
    ...
    public static final CmsSearchResultStyle STYLE_EXPLORER =
        new CmsSearchResultStyle("explorer", Messages.GUI_WORKPLACE_SEARCH_STYLE_EXPLORER_0);

    /** Workplace search result style list view with excerpts. */
    public static final CmsSearchResultStyle STYLE_LIST_WITH_EXCERPTS =
    ...
    public static final CmsSearchResultStyle STYLE_LIST_WITHOUT_EXCERPTS =
        new CmsSearchResultStyle(
  ...
  public static final String ADDITIONAL_INFO_LAST_USER_DATA_CHECK =
  ...
  public static final String ADDITIONAL_INFO_UPLOADAPPLET_CLIENTFOLDER =
      "USER_UPLOADAPPLET_CLIENTFOLDER";
  ...
  /**
   * Controls if the "create index page" check box in the new folder dialog should be initially be
   * checked or not.
   */
  private Boolean m_newFolderCreateIndexPage;

  /**
   * Controls if the "edit properties" check box in the new folder dialog should be initially be
   * checked or not.
   */
   ...
   *
   * <p>Some default settings will not be set, if no cms object is given.
   *
   * <p>
   *
   ...
   * @param useDefault true if the default value should be returned in case the preference is not
   *     set
   * @return the preference value
   */
  public String getAdditionalPreference(String name, boolean useDefault) {
    ...
    if ((value == null) && useDefault) {
      I_CmsPreference pref =
          OpenCms.getWorkplaceManager().getDefaultUserSettings().getPreferences().get(name);
      if (pref != null) {
   ...
   * <p>
   *
   * @return the default setting for direct publishing: true if siblings should be published,
   *     otherwise false
   */
  ...
  /**
   * Returns <code>{@link Boolean#TRUE}</code> if the "create index page" check box in the new
   * folder dialog should be initially be checked.
   *
   * <p>
   *
   * @return <code>{@link Boolean#TRUE}</code> if the "create index page" check box in the new
   *     folder dialog should be initially be checked.
   */
   ...
   *
   * <p>This can be either {@link CmsDefaultUserSettings#PUBLISHBUTTON_SHOW_ALWAYS}, {@link
   * CmsDefaultUserSettings#PUBLISHBUTTON_SHOW_AUTO} or {@link
  ...
  /**
   * Returns <code>true</code> if the file upload button should be shown or <code>false</code>
   * otherwise.
   *
   * <p>
   *
  ...
  /**
   * Returns <code>{@link Boolean#TRUE}</code> if the resource type selection dialog should be shown
   * in the file upload process (non - applet version).
   *
   * <p>
   *
   * @return <code>{@link Boolean#TRUE}</code> if the resource type selection dialog should be shown
   *     in the file upload process (non - applet version).
   */
  ...
  /**
   * Returns the root site path to the start gallery of the user or the constant
   * CmsPreferences.INPUT_DEFAULT.
   *
   * <p>
   *
   * @param galleryType the type of the gallery
  ...
  /**
   * Returns the current users time warp time, or {@link
   * org.opencms.main.CmsContextInfo#CURRENT_TIME} if this feature is disabled and the current time
  ...
  public void init(CmsUser user) {
    ...
    try {
      ...
      m_workplaceButtonStyle =
          OpenCms.getWorkplaceManager().getDefaultUserSettings().getWorkplaceButtonStyle();
    }
    ...
    try {
      ...
      m_listAllProjects =
          OpenCms.getWorkplaceManager().getDefaultUserSettings().getListAllProjects();
    }
    // workplace show publish notification
    try {
      m_showPublishNotification =
          ((Boolean)
                  m_user.getAdditionalInfo(
                      PREFERENCES
                          + CmsWorkplaceConfiguration.N_WORKPLACEGENERALOPTIONS
      ...
      m_showPublishNotification =
          OpenCms.getWorkplaceManager().getDefaultUserSettings().getShowPublishNotification();
    }
    ...
    try {
      ...
      m_explorerButtonStyle =
          OpenCms.getWorkplaceManager().getDefaultUserSettings().getExplorerButtonStyle();
    }
    // explorer file entries
    try {
      m_explorerFileEntries =
          ((Integer)
                  m_user.getAdditionalInfo(
                      PREFERENCES
                          + CmsWorkplaceConfiguration.N_EXPLORERGENERALOPTIONS
      ...
      m_explorerFileEntries =
          OpenCms.getWorkplaceManager().getDefaultUserSettings().getExplorerFileEntries();
    }
    // explorer settings
    try {
      m_explorerSettings =
      ...
      m_explorerSettings =
          OpenCms.getWorkplaceManager().getDefaultUserSettings().getExplorerSettings();
    }
    // dialog file copy mode
    try {
      m_dialogFileCopy =
          CmsResourceCopyMode.valueOf(
              ((Integer)
                      m_user.getAdditionalInfo(
                          PREFERENCES
      ...
      m_dialogFileCopy =
          OpenCms.getWorkplaceManager().getDefaultUserSettings().getDialogCopyFileMode();
    }
    ...
    try {
      ...
      m_dialogFolderCopy =
          OpenCms.getWorkplaceManager().getDefaultUserSettings().getDialogCopyFolderMode();
    }
    // dialog file delete mode
    try {
      m_dialogFileDelete =
          CmsResourceDeleteMode.valueOf(
              ((Integer)
                      m_user.getAdditionalInfo(
                          PREFERENCES
                              + CmsWorkplaceConfiguration.N_DIALOGSDEFAULTSETTINGS
      ...
      m_dialogFileDelete =
          OpenCms.getWorkplaceManager().getDefaultUserSettings().getDialogDeleteFileMode();
    }
    // dialog direct publish mode
    try {
      m_dialogDirectpublish =
          ((Boolean)
                  m_user.getAdditionalInfo(
                      PREFERENCES
                          + CmsWorkplaceConfiguration.N_DIALOGSDEFAULTSETTINGS
      ...
      m_dialogDirectpublish =
          OpenCms.getWorkplaceManager().getDefaultUserSettings().getDialogPublishSiblings();
    }
    ...
    try {
      m_showExportSettings =
          ((Boolean)
                  m_user.getAdditionalInfo(
                      PREFERENCES
                          + CmsWorkplaceConfiguration.N_DIALOGSDEFAULTSETTINGS
                          + CmsWorkplaceConfiguration.N_SHOWEXPORTSETTINGS))
              .booleanValue();
    } catch (Throwable t) {
      m_showExportSettings =
          OpenCms.getWorkplaceManager().getDefaultUserSettings().getDialogShowExportSettings();
    }
    // dialog permissions inheriting mode
    try {
      m_dialogPermissionsInheritOnFolder =
          ((Boolean)
                  m_user.getAdditionalInfo(
                      PREFERENCES
                          + CmsWorkplaceConfiguration.N_DIALOGSDEFAULTSETTINGS
    ...
    try {
      m_dialogExpandInheritedPermissions =
          ((Boolean)
                  m_user.getAdditionalInfo(
                      PREFERENCES
                          + CmsWorkplaceConfiguration.N_DIALOGSDEFAULTSETTINGS
    ...
    try {
      ...
      m_dialogExpandUserPermissions =
          OpenCms.getWorkplaceManager().getDefaultUserSettings().getDialogExpandUserPermissions();
    }
    // editor button style
    try {
      m_editorButtonStyle =
      ...
      m_editorButtonStyle =
          OpenCms.getWorkplaceManager().getDefaultUserSettings().getEditorButtonStyle();
    }
    // direct edit button style
    try {
      m_directeditButtonStyle =
          ((Integer)
                  m_user.getAdditionalInfo(
                      PREFERENCES
                          + CmsWorkplaceConfiguration.N_EDITORGENERALOPTIONS
      ...
      m_directeditButtonStyle =
          OpenCms.getWorkplaceManager().getDefaultUserSettings().getDirectEditButtonStyle();
    }
    // editor settings
    m_editorSettings = new TreeMap<String, String>();
    ...
    while (gKeys.hasNext()) {
      ...
      if (key.startsWith(PREFERENCES + CmsWorkplaceConfiguration.N_STARTGALLERIES)) {
        String editKey =
            key.substring((PREFERENCES + CmsWorkplaceConfiguration.N_STARTGALLERIES).length());
    ...
    try {
      ...
      m_restrictExplorerView =
          OpenCms.getWorkplaceManager().getDefaultUserSettings().getRestrictExplorerView();
    }
    // workplace search
    m_workplaceSearchIndexName =
        OpenCms.getWorkplaceManager().getDefaultUserSettings().getWorkplaceSearchIndexName();

    m_workplaceSearchViewStyle =
        CmsSearchResultStyle.valueOf(
            (String)
                m_user.getAdditionalInfo(
                    PREFERENCES
    ...
    if (m_workplaceSearchViewStyle == null) {
      m_workplaceSearchViewStyle =
          OpenCms.getWorkplaceManager().getDefaultUserSettings().getWorkplaceSearchViewStyle();
    }
    // synchronize settings
    try {
      boolean enabled =
          ((Boolean) m_user.getAdditionalInfo(PREFERENCES + SYNC_SETTINGS + SYNC_ENABLED))
              .booleanValue();
      String destination =
          (String) m_user.getAdditionalInfo(PREFERENCES + SYNC_SETTINGS + SYNC_DESTINATION);
      List<String> vfsList =
    ...
    m_uploadAppletClientFolder =
        (String) m_user.getAdditionalInfo(ADDITIONAL_INFO_UPLOADAPPLET_CLIENTFOLDER);
      ...
      if (key.startsWith(CmsUserSettings.PREFERENCES_ADDITIONAL_PREFIX)) {
        try {
          ...
          m_additionalPreferences.put(
              key.substring(CmsUserSettings.PREFERENCES_ADDITIONAL_PREFIX.length()), value);
        } catch (ClassCastException e) {
  ...
  /**
   * Saves the changed settings of the user to the users {@link CmsUser#getAdditionalInfo()} map.
   *
   * <p>If the given CmsObject is <code>null</code>, the additional user infos are only updated in
   * memory and not saved into the database.
   *
   * <p>
   *
  ...
  public void save(CmsObject cms) throws CmsException {
    ...
    if (getUploadVariant()
        != OpenCms.getWorkplaceManager().getDefaultUserSettings().getUploadVariant()) {
      m_user.setAdditionalInfo(
          PREFERENCES
              + CmsWorkplaceConfiguration.N_WORKPLACEGENERALOPTIONS
              + CmsWorkplaceConfiguration.N_UPLOADAPPLET,
    ...
    if (getStartProject() != null) {
      // start project
      if (!getStartProject()
          .equals(OpenCms.getWorkplaceManager().getDefaultUserSettings().getStartProject())) {
        try {
    ...
    if (getStartView() != null) {
      if (!getStartView()
          .equals(OpenCms.getWorkplaceManager().getDefaultUserSettings().getStartView())) {
        m_user.setAdditionalInfo(
            PREFERENCES
                + CmsWorkplaceConfiguration.N_WORKPLACESTARTUPSETTINGS
                + CmsWorkplaceConfiguration.N_WORKPLACEVIEW,
    ...
    if (getStartSite() != null) {
      // start site
      if (!getStartSite()
          .equals(OpenCms.getWorkplaceManager().getDefaultUserSettings().getStartSite())) {
        m_user.setAdditionalInfo(
            PREFERENCES
                + CmsWorkplaceConfiguration.N_WORKPLACESTARTUPSETTINGS
                + I_CmsXmlConfiguration.N_SITE,
    ...
    // dialog show lock mode
    if (getDialogShowLock()
        != OpenCms.getWorkplaceManager().getDefaultUserSettings().getDialogShowLock()) {
      m_user.setAdditionalInfo(
          PREFERENCES
              + CmsWorkplaceConfiguration.N_DIALOGSDEFAULTSETTINGS
              + CmsWorkplaceConfiguration.N_SHOWLOCK,
    ...
    if (getDialogPermissionsInheritOnFolder()
        != OpenCms.getWorkplaceManager()
            .getDefaultUserSettings()
            .getDialogPermissionsInheritOnFolder()) {
      m_user.setAdditionalInfo(
    ...
    // dialog expand inherited permissions mode
    if (getDialogExpandInheritedPermissions()
        != OpenCms.getWorkplaceManager()
            .getDefaultUserSettings()
            .getDialogExpandInheritedPermissions()) {
      m_user.setAdditionalInfo(
    ...
    // dialog expand users permissions mode
    if (getDialogExpandUserPermissions()
        != OpenCms.getWorkplaceManager()
            .getDefaultUserSettings()
    ...
    if (m_startGalleriesSettings.size() > 0) {
      Iterator<Map.Entry<String, String>> itEntries =
          m_startGalleriesSettings.entrySet().iterator();
      while (itEntries.hasNext()) {
        Map.Entry<String, String> entry = itEntries.next();
    ...
    if (CmsStringUtil.isNotEmptyOrWhitespaceOnly(m_uploadAppletClientFolder)) {
      m_user.setAdditionalInfo(
          ADDITIONAL_INFO_UPLOADAPPLET_CLIENTFOLDER, m_uploadAppletClientFolder);
    } else {
    ...
    for (String key : m_user.getAdditionalInfo().keySet()) {
      if (key.startsWith(PREFERENCES_ADDITIONAL_PREFIX)
          && !m_additionalPreferences.containsKey(
              key.substring(PREFERENCES_ADDITIONAL_PREFIX.length()))) {
   ...
   * <p>
   *
   * @param dialogShowInheritedPermissions the default setting for expanding inherited permissions
   *     in the dialog
   */
   ...
   * <p>
   *
   * @param dialogShowUserPermissions the default setting for expanding the users permissions in the
   *     dialog
   */
   ...
   * <p>
   *
   * @param dialogPermissionsInheritOnFolder the default setting for inheriting permissions on
   *     folders
   */
   ...
   * <p>
   *
   * @param publishSiblings the default setting for direct publishing: true if siblings should be
  ...
  /**
   * Sets if the "create index page" check box in the new folder dialog should be initially be
   * checked or not.
   *
   * <p>
   *
   * @param setting if the "create index page" check box in the new folder dialog should be
   *     initially be checked or not.
   */
  ...
  /**
   * Sets if the "edit properties" check box in the new folder dialog should be initially be checked
   * or not.
   *
   * <p>
   *
   * @param setting if the "edit properties" check box in the new folder dialog should be initially
   *     be checked or not.
   */
   ...
   *
   * <p>Allowed values are either {@link CmsDefaultUserSettings#PUBLISHBUTTON_SHOW_ALWAYS}, {@link
   * CmsDefaultUserSettings#PUBLISHBUTTON_SHOW_AUTO} or {@link
   * CmsDefaultUserSettings#PUBLISHBUTTON_SHOW_NEVER}.
   *
   * <p>
   ...
   * <p>
   *
   * @param showPublishNotification true if the publish notifications should be shown, otherwise
   *     false
   */
  ...
  /**
   * Sets if the resource type selection dialog should be shown in the file upload process (non -
   * applet version) or not.
   *
   * <p>
   *
   * @param showUploadTypeDialog if the resource type selection dialog should be shown in the file
   *     upload process (non - applet version)
   */
  ...
  /**
   * Sets the path to the start gallery of the user or removes the entry from user settings if no
   * path is null.
   *
   * <p>
   *
   ...
   *
   * <p>Use {@link org.opencms.main.CmsContextInfo#CURRENT_TIME} to disable this feature, ie. enable
   * the current time for each new request.
   *
   * <p>If this value is set, auto time warping will be disabled: Clicking on a resource that has
   * not been released at the given time or is already expired at the given time will not be shown -
   * an error message will pop up ("out of time window").
   *
   * <p>
   *
  ...
  /**
   * Sets a specific explorer setting depending on the set parameter.
   *
   * <p>
   *
