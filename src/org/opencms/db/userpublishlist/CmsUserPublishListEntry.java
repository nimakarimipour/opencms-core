...
public class CmsUserPublishListEntry {
   ...
   * <p>
   *
   * @param userId the user id of the owner of the entry (if this field is null, and this object is
   *     passed to a method which deletes user publsih list entries, this is interpreted as deleting
   *     user publish list entries for all users)
