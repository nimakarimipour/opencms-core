...
/**
 * Wrapper for {@link CmsSelectQuery} objects which adds SQL code for results paging.
 *
 * <p>The wrapper can either use the window function approach to paging or append a LIMIT/OFFSET
 * clause.
 *
