...
public class CmsLoginMessage {
  ...
  /**
   * Returns <code>true</code> if this message is currently active.
   *
   * <p>A message is active if it is enabled and the current time is after the message start time
   * and before the message end time.
   *
   * <p>
   *
  ...
  /**
   * Returns <code>true</code> if this login message is the enabled.
   *
   * <p>
   *
  ...
  /**
   * Returns <code>true</code> if logins are currently forbidden according to the settings of this
   * message.
   *
   * <p>This checks the time settings using <code>{@link #isActive()}</code> and <code>
   * {@link #isEnabled()}</code> as well as the <code>{@link #isLoginForbidden()}</code> flag.
   *
   * <p>
   *
   * @return <code>true</code> if logins are currently forbidden according to the settings of this
   *     message
   */
  ...
  /**
   * Returns <code>true</code> if logins are forbidden while this message is active.
   *
   * <p>
   *
  ...
  public void setMessage(String message) {
    ...
    if (isEnabled() && (message == null)) {
      throw new CmsIllegalArgumentException(
          Messages.get().container(Messages.ERR_LOGIN_MESSAGE_BAD_MESSAGE_0));
    }
  ...
  public void setTimeEnd(long timeEnd) {
    ...
    if ((m_timeStart > 0) && (timeEnd <= m_timeStart)) {
      throw new CmsIllegalArgumentException(
          Messages.get().container(Messages.ERR_LOGIN_MESSAGE_BAD_END_TIME_0));
    }
    m_timeEnd = timeEnd;
  }
