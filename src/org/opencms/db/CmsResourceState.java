...
public class CmsResourceState implements Serializable {
   ...
   * <p>
   *
   * @deprecated Don't use this constructor! It is only used to transfer the resource state via RPC
   *     call.
   */
  @Deprecated
  ...
  /**
   * Returns if this is {@link CmsResource#STATE_CHANGED}.
   *
   * <p>
   *
  ...
  /**
   * Returns if this is {@link CmsResource#STATE_DELETED}.
   *
   * <p>
   *
  ...
  /**
   * Returns if this is {@link CmsResource#STATE_KEEP}.
   *
   * <p>
   *
  ...
  /**
   * Returns if this is {@link CmsResource#STATE_NEW}.
   *
   * <p>
   *
  ...
  /**
   * Returns if this is {@link CmsResource#STATE_UNCHANGED}.
   *
   * <p>
   *
