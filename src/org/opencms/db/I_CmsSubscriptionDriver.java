...
public interface I_CmsSubscriptionDriver {
   ...
   * @param poolName the name of the database pool to use, if <code>null</code>, the default pool is
   *     used
