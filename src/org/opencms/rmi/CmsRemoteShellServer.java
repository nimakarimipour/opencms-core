...
public class CmsRemoteShellServer {
    ...
    if ((systemConfiguration.getShellServerOptions() != null)
      ...
      if (CmsLog.INIT.isInfoEnabled()) {
        CmsLog.INIT.info(
            Messages.get()
                .getBundle()
                .key(Messages.INIT_REMOTESHELL_ENABLED_1, new Integer(result.m_port)));
      }
  ...
  public void initServer() {
    ...
    try {
      ...
      I_CmsRemoteShellProvider providerStub =
          (I_CmsRemoteShellProvider) (UnicastRemoteObject.exportObject(m_provider, m_port));
