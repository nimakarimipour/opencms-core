...
public class CmsRadioSelectWidget extends Composite implements I_CmsEditWidget {
  ...
  public CmsRadioSelectWidget(String config) {
    ...
    int lineHeight =
        CmsClientStringUtil.parseInt(I_CmsLayoutBundle.INSTANCE.constants().css().lineHeightBig());
    if (lineHeight <= 0) {
      lineHeight = 17;
    }
  ...
  /**
   * Helper class for parsing the configuration in to a list of Radiobuttons.
   *
   * <p>
   *
   * @param config the configuration string.
