...
public class CmsCheckboxWidget extends Composite implements I_CmsEditWidget {
  ...
  public CmsCheckboxWidget() {
    ...
    m_checkbox.addValueChangeHandler(
        new ValueChangeHandler<Boolean>() {
          ...
          public void onValueChange(ValueChangeEvent<Boolean> event) {
            ...
            if (Boolean.parseBoolean(m_checkbox.getFormValueAsString())) {
              ...
              getParent()
                  .getElement()
                  .removeClassName(I_CmsLayoutBundle.INSTANCE.form().inActive());
            }
            fireChangeEvent();
          }
        });
  ...
  public void setActive(boolean active) {
    ...
    Element parent =
        CmsDomUtil.getAncestor(getElement(), I_CmsLayoutBundle.INSTANCE.form().attributeValue());
    if (parent != null) {
