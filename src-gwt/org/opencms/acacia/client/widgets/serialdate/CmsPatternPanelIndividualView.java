...
public class CmsPatternPanelIndividualView extends Composite implements I_CmsSerialDatePatternView {
  ...
  interface I_CmsPatternPanelIndividualUiBinder
      extends UiBinder<HTMLPanel, CmsPatternPanelIndividualView> {
    // nothing to do
  }

  /** The UI binder instance. */
  private static I_CmsPatternPanelIndividualUiBinder uiBinder =
      GWT.create(I_CmsPatternPanelIndividualUiBinder.class);
  ...
  @UiField CmsDateBox m_newDate;

  /** Button to add new dates. */
  @UiField CmsPushButton m_addButton;

  /** Button to remove selected dates. */
  @UiField CmsPushButton m_removeSelectedButton;
  ...
  public CmsPatternPanelIndividualView(
      CmsPatternPanelIndividualController controller, I_CmsObservableSerialDateValue model) {
    ...
    m_removeSelectedButton.setText(
        Messages.get().key(Messages.GUI_SERIALDATE_BUTTON_REMOVE_INDIVIDUAL_0));
  }
