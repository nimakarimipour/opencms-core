...
public class CmsPatternPanelWeeklyView extends Composite implements I_CmsSerialDatePatternView {
  ...
  @UiField FlowPanel m_dayPanel = new FlowPanel();
   ...
   */
  public CmsPatternPanelWeeklyView(
      CmsPatternPanelWeeklyController controller, I_CmsObservableSerialDateValue model) {

    m_controller = controller;
    m_model = model;
    m_model.registerValueChangeObserver(this);
    m_checkBoxValueChangeHandler =
  ...
  /**
   * Handles the days key press event.
   *
   * <p>
   *
  ...
  /**
   * Creates the day selection view.
   *
   * <p>
   */
