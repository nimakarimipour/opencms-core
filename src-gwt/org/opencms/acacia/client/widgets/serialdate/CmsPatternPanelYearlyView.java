...
public class CmsPatternPanelYearlyView extends Composite implements I_CmsSerialDatePatternView {
  ...
  private static I_CmsPatternPanelYearlyUiBinder uiBinder =
      GWT.create(I_CmsPatternPanelYearlyUiBinder.class);
  ...
  @UiField CmsSelectBox m_everyMonth;
  ...
  @UiField CmsSelectBox m_atDay;

  /** The select box for the month selection. */
  @UiField CmsSelectBox m_atMonth;
  /** The select box for the numeric selection. */
  @UiField CmsSelectBox m_atNumber;
   ...
   */
  public CmsPatternPanelYearlyView(
      CmsPatternPanelYearlyController controller, I_CmsObservableSerialDateValue model) {
    ...
    m_everyRadioButton =
        new CmsRadioButton(
            DAYS_RADIOBUTTON, Messages.get().key(Messages.GUI_SERIALDATE_YEARLY_EVERY_0));
    m_everyRadioButton.setGroup(m_group);
    m_everyRadioButton.setChecked(true);
    m_atRadioButton =
        new CmsRadioButton(
            WEEKS_RADIOBUTTON, Messages.get().key(Messages.GUI_SERIALDATE_YEARLY_AT_0));
  ...
  public void onValueChange() {
    ...
    if (m_model.getPatternType().equals(PatternType.YEARLY)) {
      ...
      if (null == m_model.getWeekDay()) {
        ...
        m_atNumber.selectValue(
            String.valueOf(m_controller.getPatternDefaultValues().getWeekOfMonth()));
      } else {
  ...
  private void initSelectBoxes() {
    ...
    m_atNumber
        .getOpener()
        .setStyleName(
            org.opencms.acacia.client.css.I_CmsWidgetsLayoutBundle.INSTANCE
                .widgetCss()
                .selectBoxSelected());
    m_atNumber
        .getSelectorPopup()
    ...
    m_atNumber.addOption(
        WeekOfMonth.LAST.toString(), Messages.get().key(Messages.GUI_SERIALDATE_WEEKDAYNUMBER_5_0));
    m_atDay
        .getOpener()
        .setStyleName(
            org.opencms.acacia.client.css.I_CmsWidgetsLayoutBundle.INSTANCE
    ...
    m_atDay.addOption(
        WeekDay.SUNDAY.toString(), Messages.get().key(Messages.GUI_SERIALDATE_DAY_SUNDAY_0));
    m_atDay.addOption(
        WeekDay.MONDAY.toString(), Messages.get().key(Messages.GUI_SERIALDATE_DAY_MONDAY_0));
    m_atDay.addOption(
        WeekDay.TUESDAY.toString(), Messages.get().key(Messages.GUI_SERIALDATE_DAY_TUESDAY_0));
    m_atDay.addOption(
        WeekDay.WEDNESDAY.toString(), Messages.get().key(Messages.GUI_SERIALDATE_DAY_WEDNESDAY_0));
    m_atDay.addOption(
        WeekDay.THURSDAY.toString(), Messages.get().key(Messages.GUI_SERIALDATE_DAY_THURSDAY_0));
    m_atDay.addOption(
        WeekDay.FRIDAY.toString(), Messages.get().key(Messages.GUI_SERIALDATE_DAY_FRIDAY_0));
    m_atDay.addOption(
        WeekDay.SATURDAY.toString(), Messages.get().key(Messages.GUI_SERIALDATE_DAY_SATURDAY_0));
    ...
    m_atMonth.addOption(
        Month.JANUARY.toString(), Messages.get().key(Messages.GUI_SERIALDATE_YEARLY_JAN_0));
    m_atMonth.addOption(
        Month.FEBRUARY.toString(), Messages.get().key(Messages.GUI_SERIALDATE_YEARLY_FEB_0));
    m_atMonth.addOption(
        Month.MARCH.toString(), Messages.get().key(Messages.GUI_SERIALDATE_YEARLY_MAR_0));
    m_atMonth.addOption(
        Month.APRIL.toString(), Messages.get().key(Messages.GUI_SERIALDATE_YEARLY_APR_0));
    m_atMonth.addOption(
        Month.MAY.toString(), Messages.get().key(Messages.GUI_SERIALDATE_YEARLY_MAY_0));
    m_atMonth.addOption(
        Month.JUNE.toString(), Messages.get().key(Messages.GUI_SERIALDATE_YEARLY_JUN_0));
    m_atMonth.addOption(
        Month.JULY.toString(), Messages.get().key(Messages.GUI_SERIALDATE_YEARLY_JUL_0));
    m_atMonth.addOption(
        Month.AUGUST.toString(), Messages.get().key(Messages.GUI_SERIALDATE_YEARLY_AUG_0));
    m_atMonth.addOption(
        Month.SEPTEMBER.toString(), Messages.get().key(Messages.GUI_SERIALDATE_YEARLY_SEP_0));
    m_atMonth.addOption(
        Month.OCTOBER.toString(), Messages.get().key(Messages.GUI_SERIALDATE_YEARLY_OCT_0));
    m_atMonth.addOption(
        Month.NOVEMBER.toString(), Messages.get().key(Messages.GUI_SERIALDATE_YEARLY_NOV_0));
    m_atMonth.addOption(
        Month.DECEMBER.toString(), Messages.get().key(Messages.GUI_SERIALDATE_YEARLY_DEC_0));
