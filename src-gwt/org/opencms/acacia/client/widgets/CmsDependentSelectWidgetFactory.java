 ...
 * <p>
 */
public class CmsDependentSelectWidgetFactory implements I_CmsWidgetFactory, I_CmsHasInit {

  /** The widget name. */
  private static final String WIDGET_NAME = "org.opencms.widgets.CmsDependentSelectWidget";
  ...
  public static void initClass() {
    ...
    WidgetRegistry.getInstance()
        .registerWidgetFactory(WIDGET_NAME, new CmsDependentSelectWidgetFactory());
  }
  ...
  public I_CmsFormEditWidget createFormWidget(String configuration) {
    ...
    return new CmsFormWidgetWrapper(new CmsDependentSelectWidget(configuration));
  }
