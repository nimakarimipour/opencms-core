...
public class CmsAdeDownloadGalleryWidgetFactory implements I_CmsWidgetFactory, I_CmsHasInit {
  ...
  public static void initClass() {
    ...
    WidgetRegistry.getInstance()
        .registerWidgetFactory(WIDGET_NAME, new CmsAdeDownloadGalleryWidgetFactory());
  }
  ...
  public I_CmsFormEditWidget createFormWidget(String configuration) {
    ...
    return new CmsFormWidgetWrapper(
        new CmsGalleryWidget(
            Messages.get().key(Messages.GUI_DOWNLOAD_GALLERY_OPEN_0), configuration, false, true));
  }
