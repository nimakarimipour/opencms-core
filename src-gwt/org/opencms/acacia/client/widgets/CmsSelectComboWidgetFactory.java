 ...
 * <p>
 */
public class CmsSelectComboWidgetFactory implements I_CmsWidgetFactory, I_CmsHasInit {

  /** The widget name. */
  private static final String WIDGET_NAME = "org.opencms.widgets.CmsSelectComboWidget";
  ...
  public static void initClass() {
    ...
    WidgetRegistry.getInstance()
        .registerWidgetFactory(WIDGET_NAME, new CmsSelectComboWidgetFactory());
  }
  ...
  public I_CmsFormEditWidget createFormWidget(String configuration) {
    ...
    return new CmsFormWidgetWrapper(new CmsSelectComboWidget(configuration));
  }
