...
public class CmsCheckBoxWidgetFactory implements I_CmsWidgetFactory, I_CmsHasInit {
  ...
  /**
   * Wrapper class for checkboxes, which is needed because the help text needs to be set on the
   * check box widgets themselves.
   */
  class CheckboxWrapper extends CmsFormWidgetWrapper {
    ...
    /**
     * @see org.opencms.acacia.client.widgets.CmsFormWidgetWrapper#setWidgetInfo(java.lang.String,
     *     java.lang.String)
     */
    @Override
