...
/**
 * Helper class that asynchronously loads all the necessary scripts and stylesheets for the
 * CodeMirror editor widget, and executes a callback at the end.
 *
 * <p>Scripts are loaded (unless they've already been loaded before) with the async=false option,
 * which causes them to be executed in order, and a special dummy script is loaded at the end to
    ...
    CmsStylesheetLoader cssLoader =
        new CmsStylesheetLoader(
            ...
            () -> {
              ...
              CmsScriptCallbackHelper helper =
