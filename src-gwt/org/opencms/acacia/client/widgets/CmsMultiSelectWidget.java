...
public class CmsMultiSelectWidget extends Composite implements I_CmsEditWidget {
  ...
  public CmsMultiSelectWidget(String config) {
    ...
    int inputHeight =
        CmsClientStringUtil.parseInt(I_CmsLayoutBundle.INSTANCE.constants().css().inputHeight());
  ...
  /**
   * Sets the checkboxes enabled or disabled.
   *
   * <p>
   *
  ...
  /**
   * Adds a button to activate or deactivate the selection.
   *
   * <p>
   */
  private void buildActivationButton() {
    ...
    m_activation.addValueChangeHandler(
        new ValueChangeHandler<Boolean>() {
