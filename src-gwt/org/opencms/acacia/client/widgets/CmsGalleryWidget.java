...
public class CmsGalleryWidget extends Composite implements I_CmsEditWidget, HasResizeHandlers {
   ...
   */
  public CmsGalleryWidget(
      String openerTitle, String config, boolean hasImage, boolean allowUploads) {

    m_linkSelect =
        new CmsGalleryField(CmsGalleryConfigurationJSO.parseConfiguration(config), allowUploads);
