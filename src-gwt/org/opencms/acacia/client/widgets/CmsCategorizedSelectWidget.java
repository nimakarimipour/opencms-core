 ...
 *
 * <p>Provides two select fields, one for filter categories and one for the actual selection to be
 * made. No RPC is used, all data for the filter categories and options has to be supplied
 * initially.
 */
public class CmsCategorizedSelectWidget extends Composite implements I_CmsEditWidget {
  ...
  /** The config factory. */
  public static I_CmsCategorizedSelectDataFactory configFactory =
  ...
  /** The category select. */
  @UiField protected CmsSelectBox m_categorySelect;

  /** The filter label. */
  @UiField protected Label m_filterLabel;

  /** The main select. */
  @UiField protected CmsSelectBox m_mainSelect;
  ...
  public CmsCategorizedSelectWidget(I_CmsCategorizedSelectData config) {
    ...
    m_categorySelect.addValueChangeHandler(
    ...
    m_mainSelect.addValueChangeHandler(
        new ValueChangeHandler<String>() {
