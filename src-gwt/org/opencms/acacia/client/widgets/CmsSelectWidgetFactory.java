...
public class CmsSelectWidgetFactory implements I_CmsWidgetFactory, I_CmsHasInit {
  ...
  private static final String WIDGET_NAME_ALLOW_UNKNOWN =
      "org.opencms.widgets.CmsSelectWidget_allowUnknown";
  ...
  public static void initClass() {
    ...
    WidgetRegistry.getInstance()
        .registerWidgetFactory(WIDGET_NAME, new CmsSelectWidgetFactory(false));
    WidgetRegistry.getInstance()
        .registerWidgetFactory(WIDGET_NAME_ALLOW_UNKNOWN, new CmsSelectWidgetFactory(true));
  }
