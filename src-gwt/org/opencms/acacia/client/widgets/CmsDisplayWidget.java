...
public class CmsDisplayWidget extends Composite implements I_CmsEditWidget {
  ...
  public CmsDisplayWidget(String config) {
    ...
    m_textbox
        .getTextBoxContainer()
        .addStyleName(I_CmsWidgetsLayoutBundle.INSTANCE.widgetCss().displayTextBoxPanel());
    m_textbox
        .getTextBox()
        .addStyleName(I_CmsWidgetsLayoutBundle.INSTANCE.widgetCss().displayTextBox());
  ...
  /**
   * Sets the color for the input box.
   *
   * <p>
   *
