...
public class CmsRootHandler implements I_CmsAttributeHandler {
  ...
  /**
   * @see
   *     org.opencms.acacia.client.I_CmsAttributeHandler#collectSimplePath(org.opencms.acacia.client.I_CmsAttributeHandler)
   */
  ...
  /**
   * Ensures attribute handler maps are available up to the specified index.
   *
   * <p>This is required during inline editing, where only a fragment of the handlers data structure
   * is build and used.
   *
   * <p>
   *
  ...
  /**
   * @see
   *     org.opencms.acacia.client.I_CmsAttributeHandler#getChildHandlerBySimpleName(java.lang.String,
   *     int)
   */
  ...
  /**
   * Returns the attribute handler for the given path.
   *
   * <p>
   *
  ...
  /**
   * Returns the attribute handler to the given simple path.
   *
   * <p>
   *
  ...
  public void insertHandlers(int index) {
    ...
    if (index <= m_handlers.size()) {
      ...
      throw new IndexOutOfBoundsException(
          "index of " + index + " too big, current size: " + m_handlers.size());
    }
  }
  ...
  /**
   * @see org.opencms.acacia.client.I_CmsAttributeHandler#setHandler(int, java.lang.String,
  ...
  /**
   * @see org.opencms.acacia.client.I_CmsAttributeHandler#setHandlerById(java.lang.String,
   *     org.opencms.acacia.client.CmsAttributeHandler)
   */
  ...
  /**
   * Initializes the sub handlers maps for the given value count.
   *
   * <p>
   *
