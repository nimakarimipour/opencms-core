...
public final class CmsValidationHandler
  ...
  public void displayValidation(String entityId, CmsValidationResult validationResult) {
    ...
    if (validationResult.hasWarnings(entityId)) {
      for (Entry<String[], CmsPair<String, String>> warning :
          validationResult.getWarnings(entityId).entrySet()) {
    ...
    if (validationResult.hasErrors(entityId)) {
      ...
      for (Entry<String[], CmsPair<String, String>> error :
          validationResult.getErrors(entityId).entrySet()) {
  ...
  protected void validate(final CmsEntity entity) {
    ...
    if (!m_validating) {
      m_validating = true;
      m_contentService.validateEntity(
          entity,
