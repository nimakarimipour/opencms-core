...
public final class CmsEntityBackend implements I_CmsEntityBackend {
  ...
  public static CmsEntity createFromNativeWrapper(JavaScriptObject entityWrapper) {
    ...
    for (int i = 0; i < complexAttr.length; i++) {
      JavaScriptObject[] complexAttrValues =
          getComplexAttributeValues(entityWrapper, complexAttr[i]);
  ...
  /**
   * Returns the complex attribute names of the given entity.
   *
   * <p>
   *
  ...
  /**
   * Returns the complex attribute values of the given entity.
   *
   * <p>
   *
   * @param entityWrapper the wrapped entity
  ...
  private static native JavaScriptObject[] getComplexAttributeValues(
      JavaScriptObject entityWrapper, String attributeName) /*-{
  ...
  /**
   * Returns the simple attribute names of the given entity.
   *
   * <p>
   *
   * @param entityWrapper the wrapped entity
  ...
  /**
   * Returns the simple attribute values of the given entity.
   *
   * <p>
   *
   * @param entityWrapper the wrapped entity
   ...
   */
  private static native String[] getSimpleAttributeValues(
      JavaScriptObject entityWrapper, String attributeName) /*-{
  ...
  /**
   * @see
   *     org.opencms.acacia.client.entity.I_CmsEntityBackend#changeEntityContentValues(org.opencms.acacia.shared.CmsEntity,
  ...
  /**
   * @see org.opencms.acacia.client.entity.I_CmsEntityBackend#createEntity(java.lang.String,
   *     java.lang.String)
   */
  ...
  /**
   * @see
   *     org.opencms.acacia.client.entity.I_CmsEntityBackend#getAttributeElements(org.opencms.acacia.shared.CmsEntity,
   *     java.lang.String, com.google.gwt.dom.client.Element)
   */
  public List<Element> getAttributeElements(
      CmsEntity entity, String attributeName, Element context) {

    return getAttributeElements(entity.getId(), attributeName, context);
  }

  /**
   * @see org.opencms.acacia.client.entity.I_CmsEntityBackend#getAttributeElements(java.lang.String,
   *     java.lang.String, com.google.gwt.dom.client.Element)
   */
  public List<Element> getAttributeElements(
      String entityId, String attributeName, Element context) {

    StringBuffer select = new StringBuffer();
    select
        .append("[")
        .append(CmsGwtConstants.ATTR_DATA_ID)
        .append("='")
        .append(entityId)
        .append("'][")
        .append(CmsGwtConstants.ATTR_DATA_FIELD)
        .append("$='")
  ...
  /**
   * @see
   *     org.opencms.acacia.client.entity.I_CmsEntityBackend#registerEntity(org.opencms.acacia.shared.CmsEntity)
   */
    ...
    if (!discardIds) {
      ...
      if (!m_types.containsKey(entity.getTypeName())) {
        throw new IllegalArgumentException(
            "Type " + entity.getTypeName() + " is not registered yet");
      }
  ...
  /**
   * @see
   *     org.opencms.acacia.client.entity.I_CmsEntityBackend#registerTypes(org.opencms.acacia.shared.CmsType,
   *     java.util.Map)
   */
  ...
  /**
   * Removes all attributes from the given entity.
   *
   * <p>
   *
