...
public final class CmsUndoRedoHandler implements HasValueChangeHandlers<UndoRedoState> {
  ...
  protected class ChangeTimer extends Timer {
    ...
    protected ChangeTimer(
        String valuePath, String attributeName, int valueIndex, ChangeType changeType) {
  ...
  /**
   * Representing a change stack entry.
   *
   * <p>
   */
  private class Change {
     ...
     */
    Change(
        CmsEntity entity, String entityId, String attributeName, int valueIndex, ChangeType type) {
    ...
    /**
     * Returns the change entity data.
     *
     * <p>
     *
  ...
  public void undo() {
    ...
    if (hasUndo()) {
      ...
      changeEntityContentValues(
          m_current.getEntityData(), entityId, attributeName, valueIndex, type);
      fireStateChange();
    }
  }
  ...
  /**
   * Internally adds a change to the undo stack.
   *
   * <p>
   *
   * @param valuePath the entity value path
  ...
  /**
   * Sets the editor to the given state.
   *
   * <p>
   *
  ...
  /**
   * Fires a value change event to indicate the undo/redo state has changed.
   *
   * <p>
   */
