...
public class CmsJsUtils {
  ...
  /**
   * Converts a Javascript object to a map from strings to strings, ignoring all properties of the
   * object whose value is not a string.
   *
   * <p>
   *
  ...
  /**
   * Converts a map whose keys and values are strings to a Javascript object with the keys as
   * attributes and the corresponding values as the attribute values.
   *
   * <p>
   *
