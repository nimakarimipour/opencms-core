...
public class CmsClientUgcSession implements Exportable {
  ...
  public void destroy() {
    ...
    CmsXmlContentUgcApi.SERVICE.destroySession(
  ...
  /**
   * Gets the content form API instance.
   *
   * <p>
   *
  ...
  public void getLink(String path, final I_CmsStringCallback callback) {
    ...
    m_apiRoot
        .getRpcHelper()
        .executeRpc(
            CmsXmlContentUgcApi.SERVICE.getLink(
                path,
                ...
                new AsyncCallback<Map<String, String>>() {
                  ...
                  public void onSuccess(Map<String, String> result) {
                    ...
                    if ((result == null) || result.isEmpty()) {
                      ...
                      JavaScriptObject validationErrorsJso =
                          CmsJsUtils.convertMapToJsObject(result);
                      onFailure.call(
                          CmsUgcConstants.ErrorCode.errValidation.toString(),
                          "",
                          validationErrorsJso);
                    }
                  }
  ...
  public void uploadFiles(
    ...
    m_formWrapper.uploadFields(
        fieldSet,
        new Function<Map<String, String>, Void>() {
   ...
   * <p>
   *
   * @param newValues a Javascript object with the value xpaths as keys and the corresponding
  ...
  public void validate(JavaScriptObject newValues, final I_CmsJavaScriptObjectCallback onSuccess) {
    ...
    AsyncCallback<Map<String, String>> rpcCallback =
        new AsyncCallback<Map<String, String>>() {
    ...
    m_apiRoot
        ...
        .executeRpc(
            CmsXmlContentUgcApi.SERVICE.validateContent(
                m_content.getSessionId(), CmsJsUtils.convertJsObjectToMap(newValues), rpcCallback));
  }
}
