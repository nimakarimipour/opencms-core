...
/**
 * Root access point for the Javascript form editing API exported with gwt-exporter. Can be used to
 * acquire new form editing sessions.
 *
 * <p>
 */
@Export
...
public class CmsXmlContentUgcApi implements Exportable {
  ...
  /** The service URL. */
  @NoExport public static final String SERVICE_URL;
    ...
    GWT.setUncaughtExceptionHandler(
        new UncaughtExceptionHandler() {
          ...
          public void onUncaughtException(final Throwable e) {
            ...
            handleError(
                e,
                new I_CmsErrorCallback() {

                  public void call(
                      String errorType, String message, JavaScriptObject additionalData) {
  ...
  /**
   * Passes an exception to the given error handling callback and optionally outputs some debug
   * info.
   *
   * <p>
   *
  ...
  public void initFormForSession(
    ...
    getRpcHelper()
        .executeRpc(
            SERVICE.getContent(
                new CmsUUID(sessionId),
                new AsyncCallback<CmsUgcContent>() {
                  ...
                  public void onSuccess(CmsUgcContent result) {
                    ...
                    CmsClientUgcSession session =
                        new CmsClientUgcSession(CmsXmlContentUgcApi.this, result);
  ...
  /**
   * Sets the error callback for all uncaught exceptions.
   *
   * <p>
   *
   ...
   * <p>
   *
   * @param callback a callback used to switch the wait indicator off or on.
   *     <p>
   */
