 ...
 * SynchronizedRpcRequest} annotation.
 *
 * <p>
 */
public class CmsRpcProxyCreator extends ProxyCreator {
  ...
  /**
   * @see
   *     com.google.gwt.user.rebind.rpc.ProxyCreator#generateProxyMethods(com.google.gwt.user.rebind.SourceWriter,
   *     com.google.gwt.user.rebind.rpc.SerializableTypeOracle,
   *     com.google.gwt.core.ext.typeinfo.TypeOracle, java.util.Map)
   */
  @Override
   ...
   */
  protected void generateSyncOverride(
      SourceWriter srcWriter, Map<JMethod, JMethod> syncMethToAsyncMethMap) {
