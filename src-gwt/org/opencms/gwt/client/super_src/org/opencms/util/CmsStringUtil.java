...
/**
 * Client side implementation for {@link org.opencms.util.CmsStringUtil}.
 *
 * <p>
 *
 * @since 8.0.0
...
public final class CmsStringUtil {
  ...
  /**
   * Replaces occurrences of special control characters in the given input with a HTML
   * representation.
   *
   * <p>This method currently replaces line breaks to <code>&lt;br/&gt;</code> and special HTML
   * chars like <code>&lt; &gt; &amp; &quot;</code> with their HTML entity representation.
   *
   * <p>
   *
  ...
  /**
   * Formats a resource name that it is displayed with the maximum length and path information is
   * adjusted.
   *
   * <p>In order to reduce the length of the displayed names, single folder names are
   * removed/replaced with ... successively, starting with the second! folder. The first folder is
   * removed as last.
   *
   * <p>Example: formatResourceName("/myfolder/subfolder/index.html", 21) returns <code>
   * /myfolder/.../index.html</code>.
   *
   * <p>
   *
  ...
  /**
   * Same as {@link org.opencms.util.CmsStringUtil#splitAsArray(String, String)}.
   *
   * <p>
   *
  ...
  /**
   * Checks whether one path is a prefix path of another, i.e. its path components are the initial
   * path components of the second path.
   *
   * <p>It is not enough to just use {@link String#startsWith}, because we want /foo/bar to be a
   * prefix path of /foo/bar/baz, but not of /foo/bar42.
   *
   * <p>
   *
