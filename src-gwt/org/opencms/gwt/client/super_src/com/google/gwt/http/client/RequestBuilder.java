 ...
 *
 * Modules that use this class should inherit <code>com.google.gwt.http.HTTP</code>.
 *
 * <p>{@gwt.include com/google/gwt/examples/http/InheritsExample.gwt.xml}
 */
public class RequestBuilder {
   ...
   *     com.google.gwt.http.client.URL#encode(String)} and {@link
   *     com.google.gwt.http.client.URL#encodeComponent(String)} for how to do this.
   ...
   * the {@link com.google.gwt.http.client.RequestCallback#onError(Request, Throwable)} method will
   * be called on the callback instance given to the {@link
   * com.google.gwt.http.client.RequestBuilder#sendRequest(String, RequestCallback)} method. The
   * callback method will receive an instance of the {@link
   * com.google.gwt.http.client.RequestTimeoutException} class as its {@link java.lang.Throwable}
   * argument.
   *
  ...
  /**
   * Checks whether the request data contains the sync RPC token.
   *
   * <p>This method was introduced to allow synchronised RPC calls within vaadin.
   *
  ...
  private void evaluateSync(String data) {
    if (!m_sync
        && data != null
        && data.contains(org.opencms.gwt.client.rpc.CmsRpcAction.SYNC_TOKEN)) {
      m_sync = true;
    }
  }
