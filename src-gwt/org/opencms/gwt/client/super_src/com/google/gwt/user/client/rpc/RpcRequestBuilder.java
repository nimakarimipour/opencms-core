...
/**
 * This class encapsulates the logic necessary to configure a RequestBuilder for use with an RPC
 * proxy object. Users who wish to alter the specifics of the HTTP requests issued by RPC proxy
 * objects may override the protected <code>doXyz</code> methods and pass an instance of the
 * subclass to {@link ServiceDefTarget#setRpcRequestBuilder}.
 */
public class RpcRequestBuilder {
  ...
  /**
   * Initialize the RpcRequestBuilder. This method must be called before any of the other methods in
   * this class may be called. Calling <code>create</code> before calling {@link #finish()} will
   * reset the state of the RpcRequestBuilder.
   *
   * <p>This method delegates to {@link #doCreate} to instantiate the RequestBuilder.
   *
   ...
   *
   * <p>This method will call {@link #doFinish} before returning the current RequestBuilder.
   */
  ...
  /**
   * Sets the RequestCallback to be used by the RequestBuilder. Delegates to {@link #doSetCallback}.
   *
  ...
  /**
   * Sets the MIME content type to be used by the RequestBuilder. Delegates to {@link
   * #doSetContentType}.
   *
  ...
  /**
   * Sets the request data to be sent in the request. Delegates to {@link #doSetRequestData}.
   *
   ...
   *
   * <p>The default implementation creates a <code>POST</code> RequestBuilder with the given entry
   * point.
   *
   * @param serviceEntryPoint the URL to which the request should be issued
   * @return the RequestBuilder that should be ultimately passed to the RpcRequestBuilder's caller.
   */
  ...
  /**
   * Called by {@link #finish()} prior to returning the RequestBuilder to the caller.
   *
   * <p>The default implementation sets the {@value #STRONG_NAME_HEADER} header to the value
   * returned by {@link GWT#getPermutationStrongName()}.
   *
   ...
   *
   * <p>The default implementation calls {@link RequestBuilder#setCallback(RequestCallback)}.
   *
   * @param rb the RequestBuilder that is currently being configured
   ...
   *
   * <p>The default implementation sets the {@value #CONTENT_TYPE_HEADER} header to the value
   * specified by <code>contentType</code> by calling {@link RequestBuilder#setHeader(String,
   * String)}.
   *
   * @param rb the RequestBuilder that is currently being configured
   ...
   *
   * <p>The default implementation invokes {@link RequestBuilder#setRequestData(String)}.
   *
   * @param rb the RequestBuilder that is currently being configured
   * @param data the data to send
   */
