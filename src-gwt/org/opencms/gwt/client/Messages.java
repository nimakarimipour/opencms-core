...
public final class Messages {
  ...
  public static final String ERR_DATEBOX_INVALID_DATE_FORMAT_0 =
      "ERR_DATEBOX_INVALID_DATE_FORMAT_0";

  /** Message constant for key in the resource bundle. */
  public static final String ERR_DATEBOX_INVALID_TIME_FORMAT_0 =
      "ERR_DATEBOX_INVALID_TIME_FORMAT_0";
  ...
  /** Message constant for key in the resource bundle. */
  public static final String ERR_UPLOAD_BROWSER_NOT_READABLE_0 =
      "ERR_UPLOAD_BROWSER_NOT_READABLE_0";
  ...
  /** Message constant for key in the resource bundle. */
  public static final String GUI_BINARY_UPLOAD_DIALOG_CONTENT_0 =
      "GUI_BINARY_UPLOAD_DIALOG_CONTENT_0";
  ...
  /** Message constant for key in the resource bundle. */
  public static final String GUI_CODEMIRROR_BUTTON_JUMP_TO_LINE_0 =
      "GUI_CODEMIRROR_BUTTON_JUMP_TO_LINE_0";
  ...
  /** Message constant for key in the resource bundle. */
  public static final String GUI_CODEMIRROR_TOGGLE_AUTO_CLOSE_BRACKETS_0 =
      "GUI_CODEMIRROR_TOGGLE_AUTO_CLOSE_BRACKETS_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_CODEMIRROR_TOGGLE_LINE_WRAP_0 =
      "GUI_CODEMIRROR_TOGGLE_LINE_WRAP_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_CODEMIRROR_TOGGLE_SYNTAX_HIGHLIGHTING_0 =
  ...
  /** Message constant for key in the resource bundle. */
  public static final String GUI_COPY_TO_CLIPBOARD_DESCRIPTION_0 =
  ...
  /** Message constant for key in the resource bundle. */
  public static final String GUI_CREATE_NEW_LINK_DIALOG_TITLE_0 =
      "GUI_CREATE_NEW_LINK_DIALOG_TITLE_0";
  ...
  /** Message constant for key in the resource bundle. */
  public static final String GUI_DIALOG_AVAILABILITY_AVAILABILITY_0 =
      "GUI_DIALOG_AVAILABILITY_AVAILABILITY_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_DIALOG_AVAILABILITY_DIALOG_ERR_0 =
      "GUI_DIALOG_AVAILABILITY_DIALOG_ERR_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_DIALOG_AVAILABILITY_ERR_BEFORE_0 =
      "GUI_DIALOG_AVAILABILITY_ERR_BEFORE_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_DIALOG_AVAILABILITY_ERR_PAST_0 =
      "GUI_DIALOG_AVAILABILITY_ERR_PAST_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_DIALOG_AVAILABILITY_ERR_POS_0 =
      "GUI_DIALOG_AVAILABILITY_ERR_POS_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_DIALOG_AVAILABILITY_EXPIRED_DATE_0 =
      "GUI_DIALOG_AVAILABILITY_EXPIRED_DATE_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_DIALOG_AVAILABILITY_INHERITED_FROM_1 =
      "GUI_DIALOG_AVAILABILITY_INHERITED_FROM_1";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_DIALOG_AVAILABILITY_MODIFY_SIBLINGS_0 =
      "GUI_DIALOG_AVAILABILITY_MODIFY_SIBLINGS_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_DIALOG_AVAILABILITY_NOTI_INTERVAL_0 =
      "GUI_DIALOG_AVAILABILITY_NOTI_INTERVAL_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_DIALOG_AVAILABILITY_NOTI_SETTINGS_0 =
      "GUI_DIALOG_AVAILABILITY_NOTI_SETTINGS_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_DIALOG_AVAILABILITY_PUB_SCHEDULED_0 =
      "GUI_DIALOG_AVAILABILITY_PUB_SCHEDULED_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_DIALOG_AVAILABILITY_PUB_SCHEDULED_DATE_0 =
      "GUI_DIALOG_AVAILABILITY_PUB_SCHEDULED_DATE_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_DIALOG_AVAILABILITY_RELEASED_DATE_0 =
      "GUI_DIALOG_AVAILABILITY_RELEASED_DATE_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_DIALOG_AVAILABILITY_RES_USERS_0 =
      "GUI_DIALOG_AVAILABILITY_RES_USERS_0";
  ...
  /** Message constant for key in the resource bundle. */
  public static final String GUI_DIALOG_CHANGES_PUBLISH_TEXT_0 =
      "GUI_DIALOG_CHANGES_PUBLISH_TEXT_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_DIALOG_CHANGES_PUBLISH_TITLE_0 =
  ...
  /** Message constant for key in the resource bundle. */
  public static final String GUI_GALLERY_SELECT_DIALOG_TITLE_0 =
      "GUI_GALLERY_SELECT_DIALOG_TITLE_0";
  ...
  /** Message constant for key in the resource bundle. */
  public static final String GUI_HISTORY_REVERT_CONFIRMATION_0 =
      "GUI_HISTORY_REVERT_CONFIRMATION_0";
  ...
  /** Message constant for key in the resource bundle. */
  public static final String GUI_LOCK_REPORT_STEAL_ALL_LOCKS_MESSAGE_0 =
      "GUI_LOCK_REPORT_STEAL_ALL_LOCKS_MESSAGE_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_LOCK_REPORT_STEAL_LOCK_MESSAGE_0 =
      "GUI_LOCK_REPORT_STEAL_LOCK_MESSAGE_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_LOCK_REPORT_TITLE_0 = "GUI_LOCK_REPORT_TITLE_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_LOCK_REPORT_UNLOCK_ALL_MESSAGE_0 =
      "GUI_LOCK_REPORT_UNLOCK_ALL_MESSAGE_0";
  ...
  /** Message constant for key in the resource bundle. */
  public static final String GUI_RENAME_DIALOG_NEW_NAME_LABEL_0 =
      "GUI_RENAME_DIALOG_NEW_NAME_LABEL_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_RENAME_DIALOG_OLD_NAME_LABEL_0 =
      "GUI_RENAME_DIALOG_OLD_NAME_LABEL_0";
  ...
  /** Message constant for key in the resource bundle. */
  public static final String GUI_REPLACE_WRONG_FILE_EXTENSION_0 =
      "GUI_REPLACE_WRONG_FILE_EXTENSION_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_RESET_0 = "GUI_RESET_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_RESOURCE_INFO_TAB_ATTRIBUTES_0 =
      "GUI_RESOURCE_INFO_TAB_ATTRIBUTES_0";
  ...
  /** Message constant for key in the resource bundle. */
  public static final String GUI_RESOURCEINFO_FIELDSET_TITLE_0 =
      "GUI_RESOURCEINFO_FIELDSET_TITLE_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_RESOURCEINFO_LABEL_DATECREATED_0 =
      "GUI_RESOURCEINFO_LABEL_DATECREATED_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_RESOURCEINFO_LABEL_DATEEXPIRED_0 =
      "GUI_RESOURCEINFO_LABEL_DATEEXPIRED_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_RESOURCEINFO_LABEL_DATEMODIFIED_0 =
      "GUI_RESOURCEINFO_LABEL_DATEMODIFIED_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_RESOURCEINFO_LABEL_DATERELEASED_0 =
      "GUI_RESOURCEINFO_LABEL_DATERELEASED_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_RESOURCEINFO_LABEL_LASTPROJECT_0 =
      "GUI_RESOURCEINFO_LABEL_LASTPROJECT_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_RESOURCEINFO_LABEL_LOCALES_0 = "GUI_RESOURCEINFO_LABEL_LOCALES_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_RESOURCEINFO_LABEL_LOCKOWNER_0 =
      "GUI_RESOURCEINFO_LABEL_LOCKOWNER_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_RESOURCEINFO_LABEL_LOCKSTATE_0 =
      "GUI_RESOURCEINFO_LABEL_LOCKSTATE_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_RESOURCEINFO_LABEL_NAVTEXT_0 = "GUI_RESOURCEINFO_LABEL_NAVTEXT_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_RESOURCEINFO_LABEL_PERMISSIONS_0 =
      "GUI_RESOURCEINFO_LABEL_PERMISSIONS_0";
  ...
  /** Message constant for key in the resource bundle. */
  public static final String GUI_RESOURCEINFO_LABEL_USERCREATED_0 =
      "GUI_RESOURCEINFO_LABEL_USERCREATED_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_RESOURCEINFO_LABEL_USERMODIFIED_0 =
      "GUI_RESOURCEINFO_LABEL_USERMODIFIED_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_RESOURCEINFO_OTHERSITES_LEGEND_0 =
      "GUI_RESOURCEINFO_OTHERSITES_LEGEND_0";
  ...
  /** Message constant for key in the resource bundle. */
  public static final String GUI_UNPUBLISHED_CHANGES_NEW_TITLE_0 =
      "GUI_UNPUBLISHED_CHANGES_NEW_TITLE_0";
  ...
  /** Message constant for key in the resource bundle. */
  public static final String GUI_UPLOAD_FINISH_UPLOADED_VALUE_4 =
      "GUI_UPLOAD_FINISH_UPLOADED_VALUE_4";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_UPLOAD_INFO_CREATING_RESOURCES_0 =
  ...
  /** Message constant for key in the resource bundle. */
  public static final String GUI_UPLOAD_PROGRESS_CURRENT_FILE_0 =
      "GUI_UPLOAD_PROGRESS_CURRENT_FILE_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_UPLOAD_PROGRESS_CURRENT_VALUE_3 =
  ...
  /** Message constant for key in the resource bundle. */
  public static final String GUI_UPLOAD_PROGRESS_UPLOADING_VALUE_2 =
      "GUI_UPLOAD_PROGRESS_UPLOADING_VALUE_2";
