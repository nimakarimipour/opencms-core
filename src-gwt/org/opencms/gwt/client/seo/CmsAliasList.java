...
public class CmsAliasList extends Composite {
  ...
  protected AsyncCallback<Map<String, String>> m_defaultValidationHandler =
  ...
  public void addAlias(final CmsAliasBean alias) {
    ...
    selectbox.addValueChangeHandler(
  ...
  /**
   * Checks whether there have been validation errors since the validation errors were cleared the
   * last time.
   *
   * <p>
   *
  ...
  /**
   * Simplified method to perform a full validation of the aliases in the list and execute an action
   * afterwards.
   *
   * <p>
   *
  ...
  public void validateAliases(
    ...
    CmsRpcAction<Map<String, String>> action =
        new CmsRpcAction<Map<String, String>>() {
