...
public class CmsSimplePropertyEditor extends A_CmsPropertyEditor {
   ...
   */
  public CmsSimplePropertyEditor(
  ...
  /**
   * Checks whether an empty string should always be allowed for the property, regardless of
   * validation settings.
   *
  ...
  private void buildField(
    ...
    CmsPathValue pathValue =
        CmsClientProperty.getPathValue(ownProp, mode).prepend(id + "/" + propName + "/");
