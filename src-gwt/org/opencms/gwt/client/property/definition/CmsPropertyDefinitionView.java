...
public class CmsPropertyDefinitionView extends Composite {
  ...
  interface I_CmsPropertyDefinitionViewUiBinder
      extends UiBinder<Widget, CmsPropertyDefinitionView> {
    // empty
  }
  ...
  private static I_CmsPropertyDefinitionViewUiBinder uiBinder =
      GWT.create(I_CmsPropertyDefinitionViewUiBinder.class);

  /** The Cancel button. */
  @UiField CmsPushButton m_cancelButton;

  /**
   * The panel displaying the existing properties.
   *
   * <p>
   */
  @UiField Panel m_existingProperties;
  ...
  @UiField CmsTextBox m_propertyNameField;
  ...
  public CmsPropertyDefinitionView(Collection<String> existingProperties) {
    ...
    m_propertyNameField.addKeyPressHandler(
        new KeyPressHandler() {
  ...
  /**
   * Checks whether the property name is valid.
   *
   * <p>
   *
  ...
  /**
   * Saves the property definition and closes the dialog.
   *
   * <p>
   *
