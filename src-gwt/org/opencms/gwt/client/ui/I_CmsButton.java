...
/**
 * Interface to hold button related enumerations. To be used with {@link
 * org.opencms.gwt.client.ui.CmsPushButton} and {@link org.opencms.gwt.client.ui.CmsToggleButton}.
 *
 * <p>
 */
public interface I_CmsButton {
  ...
  public enum ButtonData {
    ...
    /** Toolbar button. */
    ADD_TO_FAVORITES(
        "opencms-icon-favorite", Messages.get().key(Messages.GUI_TOOLBAR_ADD_TO_FAVORITES_0)),
    ...
    /**
     * Returns the icon class for small icons of 20x20.
     *
     * <p>
     *
  ...
  public enum ButtonStyle {
    ...
    /** Menu button. */
    MENU(
        I_CmsLayoutBundle.INSTANCE.buttonCss().cmsMenuButton(),
        I_CmsLayoutBundle.INSTANCE.generalCss().cornerAll()),

    /** Default button. */
    TEXT(
        I_CmsLayoutBundle.INSTANCE.buttonCss().cmsTextButton(),
        I_CmsLayoutBundle.INSTANCE.generalCss().buttonCornerAll()),

    /** Transparent button. */
    TRANSPARENT(
        I_CmsLayoutBundle.INSTANCE.buttonCss().cmsTransparentButton(),
        I_CmsLayoutBundle.INSTANCE.generalCss().cornerAll());
