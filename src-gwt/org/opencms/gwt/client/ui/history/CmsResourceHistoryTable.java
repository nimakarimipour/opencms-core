 ...
 *
 * <p>Has buttons to preview or restore a previous version.
 *
 * <p>
 */
public class CmsResourceHistoryTable extends CellTable<CmsHistoryResourceBean> {
  ...
  static interface Templates extends SafeHtmlTemplates {
    ...
    /**
     * Template for a span with a title.
     *
     * <p>
     *
   ...
   */
  public CmsResourceHistoryTable(
      CmsHistoryResourceCollection data, I_CmsHistoryActionHandler handler) {
    ...
    ListDataProvider<CmsHistoryResourceBean> dataProvider =
        new ListDataProvider<CmsHistoryResourceBean>();
    dataProvider.addDataDisplay(this);
    dataProvider.setList(data.getResources());
  }

  /**
   * Helper method for adding a table column with a given width and label.
   *
   * <p>
   *
  ...
  private void addModificationDateColumn() {
    ...
    addColumn(
        CmsHistoryMessages.columnModificationDate(),
        190,
        new TextColumn<CmsHistoryResourceBean>() {
  ...
  private void addPathColumn() {
    ...
    Column<CmsHistoryResourceBean, ?> col =
        new TextColumn<CmsHistoryResourceBean>() {
  ...
  private void addPreviewColumn() {
    ...
    CmsButtonCell<CmsHistoryResourceBean> previewCell =
        new CmsButtonCell<CmsHistoryResourceBean>(
    ...
    addColumn(
        CmsHistoryMessages.columnPreview(),
        30,
        new IdentityColumn<CmsHistoryResourceBean>(previewCell));
  }
  ...
  private void addPublishDateColumn() {
    ...
    addColumn(
        CmsHistoryMessages.columnPublishDate(),
        190,
        new TextColumn<CmsHistoryResourceBean>() {
  ...
  private void addRevertColumn() {
    ...
    CmsButtonCell<CmsHistoryResourceBean> replaceCell =
        new CmsButtonCell<CmsHistoryResourceBean>(
    ...
    addColumn(
        CmsHistoryMessages.columnReplace(),
        30,
        new IdentityColumn<CmsHistoryResourceBean>(replaceCell));
  }
  ...
  private void addUserLastModifiedColumn() {
    ...
    addColumn(
        CmsHistoryMessages.columnUserLastModified(),
        120,
        new TextColumn<CmsHistoryResourceBean>() {
  ...
  private void addVersionColumn() {
    ...
    addColumn(
        CmsHistoryMessages.columnVersion(), 40, new IdentityColumn<CmsHistoryResourceBean>(cell));
  }
}
