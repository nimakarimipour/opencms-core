...
public class CmsRestoreView extends Composite {
  ...
  @UiField protected FlowPanel m_infoBoxContainer;

  /** The label which informs the user that the resource has moved. */
  @UiField protected Label m_movedLabel;

  /** The section which is displayed when the resource was moved. */
  @UiField protected Panel m_movedSection;
  ...
  public CmsRestoreView(CmsRestoreInfoBean restoreInfo, Runnable afterRestoreAction) {
    ...
    listInfo.addAdditionalInfo(
        CmsRestoreMessages.messageDateModified(), restoreInfo.getOfflineDate());
    listInfo.addAdditionalInfo(
        CmsRestoreMessages.messageDateModifiedOnline(), restoreInfo.getOnlineDate());
    ...
    if (restoreInfo.isMoved() && restoreInfo.canUndoMove()) {
      m_movedLabel.setText(
          CmsRestoreMessages.messageMoved(
              restoreInfo.getOnlinePath(), restoreInfo.getOfflinePath()));
  ...
  /**
   * Gets the list of buttons for the dialog.
   *
   * <p>
   *
