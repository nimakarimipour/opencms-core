...
public interface I_CmsLayoutBundle extends ClientBundle {
  ...
  /**
   * Highlighting CSS, used within the {@link org.opencms.gwt.client.ui.CmsHighlightingBorder}
   * widget.
   */
  ...
  /**
   * Access method. These CSS classes are used to indicate the state of ui items, use them within a
   * dedicated CSS resources. Do not inject this CSS, as it contains no style information.
   *
   * <p>
   *
