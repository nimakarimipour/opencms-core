 ...
 *
 * <p>Layout class for a panel with several tabs. The tabbed panel should be set inside a widget
 * with given width and height. For table based layouts the height of the parent cell should be set
 * explicitly.
 *
 * <p>As layout options two height for the tabbar are provided: 32px("standard") and 25px("small").
 *
...
public class CmsTabbedPanel<E extends Widget> extends Composite
  ...
  public enum CmsTabbedPanelStyle {
    ...
    buttonTabs(
        30,
        I_CmsLayoutBundle.INSTANCE.tabbedPanelCss().buttonTabs(),
   ...
   *
   * <p>Wrapper function for {@link
   * com.google.gwt.user.client.ui.TabLayoutPanel#addSelectionHandler(SelectionHandler)}
   *
   ...
   *
   * <p>Wrapper function for {@link com.google.gwt.user.client.ui.TabLayoutPanel#getSelectedIndex()}
   *
   ...
   *
   * <p>This will not be the tab content but the tab itself.
   *
   * <p>
   *
  ...
  /**
   * Returns <code>true</code> if the tab with the given index is disabled, <code>false</code>
   * otherwise.
   *
   * <p>
   *
   * @param tabIndex the tab index
   * @return <code>true</code> if the tab with the given index is disabled, <code>false</code>
   *     otherwise
   */
