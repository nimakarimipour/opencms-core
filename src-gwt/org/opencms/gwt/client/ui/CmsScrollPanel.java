...
public class CmsScrollPanel extends ScrollPanel
    implements HasResizeHandlers, I_CmsDescendantResizeHandler {
  ...
  /**
   * Constructor to be used by {@link org.opencms.gwt.client.ui.CmsScrollPanelImpl}.
   *
   * <p>
   *
   ...
   *
   * <p>Focused scrolling is enabled by default.
   *
   * <p>
   *
            ...
            new MouseDownHandler() {
              ...
              public void onMouseDown(MouseDownEvent event) {
                ...
                m_previewHandlerRegistration =
                    Event.addNativePreviewHandler(new ResizeEventPreviewHandler());
              }
            });
      } else {
