...
public class CmsListItemWidget extends Composite
    implements HasOpenHandlers<CmsListItemWidget>,
        HasCloseHandlers<CmsListItemWidget>,
        HasMouseOutHandlers,
        HasClickHandlers,
  ...
  protected interface I_CmsListItemWidgetUiBinder
      extends UiBinder<CmsHoverPanel, CmsListItemWidget> {
  ...
  private static I_CmsListItemWidgetUiBinder uiBinder =
      GWT.create(I_CmsListItemWidgetUiBinder.class);

  /** DIV for additional item info. */
  @UiField protected FlowPanel m_additionalInfo;

  /** Panel to hold buttons. */
  @UiField protected FlowPanel m_buttonPanel;

  /** Panel to hold the content. */
  @UiField protected FlowPanel m_contentPanel;
  ...
  @UiField protected SimplePanel m_iconPanel;
  ...
  private ClickHandler m_iconSuperClickHandler =
      new ClickHandler() {
  ...
  /**
   * @see
   *     com.google.gwt.event.dom.client.HasDoubleClickHandlers#addDoubleClickHandler(com.google.gwt.event.dom.client.DoubleClickHandler)
   */
  ...
  /**
   * Sets the extra info text, and hides or displays the extra info label depending on whether the
   * text is null or not null.
   *
   * <p>
   *
  ...
  public void setTopRightIcon(String iconClass, String title) {
    ...
    m_topRightIcon.setStyleName(
        I_CmsLayoutBundle.INSTANCE.listItemWidgetCss().topRightIcon() + " " + iconClass);
    if (title != null) {
   ...
   *
   * <p>Use after changing any text on the widget.
   *
   * <p>
   */
  ...
  protected void editTitle() {
    ...
    final boolean restoreUnselectable =
        CmsDomUtil.hasClass(
  ...
  /**
   * Combines the main icon title with the title for a status icon overlayed over the main icon.
   *
   * <p>
   *
