...
public class CmsRenameView extends Composite {
  ...
  @UiField protected HasText m_newNameLabel;

  /** The OK button. */
  @UiField protected CmsPushButton m_okButton;

  /** The label for the old name. */
  @UiField protected HasText m_oldNameLabel;

  /** The label containing the old name. */
  @UiField protected HasText m_oldNameValue;
   ...
   * @param renameCallback the callback which should be called when the resource has been
  ...
  public CmsRenameView(CmsRenameInfoBean renameInfo, AsyncCallback<String> renameCallback) {
    ...
    m_newNameInput.addKeyPressHandler(
        new KeyPressHandler() {
  ...
  /**
   * Closes the dialog containing this widget.
   *
   * <p>
   */
  void close() {
  ...
  /**
   * Sets the validation error in the widget.
   *
   * <p>
   *
