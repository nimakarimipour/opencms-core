 ...
 *
 * <p>It contains two panels, the "primary" (or main) panel and the "float" panel, to which widgets
 * can be added. The float panel is styled so as to float left of the primary panel, and the primary
 * panel's left margin is set to the width of the float panel. If the widget starts out as hidden,
 * the float panel width can not be measured, so you have to call the updateLayout method manually
...
public class CmsFloatDecoratedPanel extends Composite implements I_CmsTruncable {
  ...
  static final I_CmsFloatDecoratedPanelCss CSS =
      I_CmsLayoutBundle.INSTANCE.floatDecoratedPanelCss();
  ...
  /**
   * Returns the width of the float box.
   *
   * <p>
   *
   * @return a width
  ...
  /**
   * Updates the vertical margin of the float box such that its vertical middle point coincides with
   * the vertical middle point of the primary panel.
   *
   * <p>
   */
