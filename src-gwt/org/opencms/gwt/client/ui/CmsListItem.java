...
public class CmsListItem extends Composite implements I_CmsListItem {
   ...
   *
   * <p>This method will return a checkbox if this list item has one, or null if it doesn't.
   *
  ...
  public Element getDragHelper(I_CmsDropTarget target) {
    ...
    if (m_helper == null) {
      ...
      List<com.google.gwt.dom.client.Element> elems =
  ...
  /**
   * Returns the list item widget of this list item, or null if this item doesn't have a list item
   * widget.
   *
   * <p>
   *
  ...
  /**
   * Initializes the move handle with the given drag and drop handler and adds it to the list item
   * widget.
   *
   * <p>This method will not work for list items that don't have a list-item-widget.
   *
   * <p>
   *
   ...
   *
   * <p>In most cases, the widget will be a list item widget. If this is the case, then further
   * calls to {@link CmsListItem#getListItemWidget()} will return the widget which was passed as a
   * parameter to this method. Otherwise, the method will return null.
   *
   * <p>
   *
  ...
  /**
   * This internal helper method creates the actual contents of the widget by combining the
   * decorators and the main widget.
   *
   * <p>
   */
  protected void initContent() {
    ...
    m_decoratedPanel =
        new CmsSimpleDecoratedPanel(m_decorationWidth, m_mainWidget, m_decorationWidgets);
    m_panel.insert(m_decoratedPanel, 0);
    setSmallView(m_smallView);
  }

  /**
   * This method is a convenience method which sets the checkbox and main widget of this widget, and
   * then calls {@link CmsListItem#initContent()}.
   *
   * <p>
   *
