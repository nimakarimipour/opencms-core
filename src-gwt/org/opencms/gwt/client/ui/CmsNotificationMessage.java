...
public class CmsNotificationMessage extends Composite {
  ...
  private static I_CmsNotificationMessageUiBinder uiBinder =
      GWT.create(I_CmsNotificationMessageUiBinder.class);
  ...
  @UiField Element m_messageContent;
   ...
   */
  public CmsNotificationMessage(
      CmsNotification.Mode mode, CmsNotification.Type type, String message) {
    m_mode = mode;
