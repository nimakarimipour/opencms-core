 ...
 *
 * <p>The loaded additional info items will be displayed after the additional info items contained
 * in the bean which is passed into the constructor.
 *
 * <p>
 *
 * @since 8.0.0
...
public class CmsInfoLoadingListItemWidget extends CmsListItemWidget {
  ...
  public class DummyAdditionalInfoLoader implements I_CmsAdditionalInfoLoader {
    ...
    /**
     * @see
     *     org.opencms.gwt.client.util.I_CmsAdditionalInfoLoader#load(com.google.gwt.user.client.rpc.AsyncCallback)
     */
  ...
  /**
   * @see
   *     org.opencms.gwt.client.ui.CmsListItemWidget#initAdditionalInfo(org.opencms.gwt.shared.CmsListInfoBean)
   */
  @Override
            ...
            public void onClick(ClickEvent event) {
              ...
              if (m_additionalInfoOpen) {
                ...
                if (!m_loading) {
                  ...
                  m_additionalInfoLoader.load(
                      new AsyncCallback<List<AdditionalInfoItem>>() {
