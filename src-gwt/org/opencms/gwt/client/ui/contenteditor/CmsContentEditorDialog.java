...
public final class CmsContentEditorDialog {
   ...
   */
  public static FormElement generateForm(
      I_CmsEditableData editableData, boolean isNew, String target, String mode) {
              ...
              if (CmsStringUtil.isNotEmptyOrWhitespaceOnly(result)) {
                ...
                CmsAlertDialog alert =
                    new CmsAlertDialog(
                        ...
                        Messages.get()
                            .key(
                                Messages.ERR_RESOURCE_UNAVAILABLE_1,
  ...
  protected void close() {
    ...
    if (m_dialog != null) {
      ...
      m_editorHandler.onClose(
          m_editableData.getSitePath(), m_editableData.getStructureId(), m_isNew, false, false);
   ...
   *
   * <p>Will ask the user if the edited content should be saved.
   *
   * <p>
   */
  protected void onWindowClose() {
    ...
    boolean savePage =
        Window.confirm(
            Messages.get()
                .key(Messages.GUI_EDITOR_SAVE_BEFORE_LEAVING_1, m_editableData.getSitePath()));
    if (savePage) {
      saveEditorContent();
    }
  }
  ...
  protected void openDialog(DialogOptions dlgOptions) {
    ...
    m_dialog.addDialogClose(
        new Command() {

          /** @see com.google.gwt.user.client.Command#execute() */
          public void execute() {

            CmsConfirmDialog confirmDlg =
            ...
            confirmDlg.setHandler(
                new I_CmsConfirmDialogHandler() {
                  ...
                  public void onOk() {
                    ...
                    // make sure the onunload event is triggered within the editor frames for ALL
                    // browsers
  ...
  /**
   * Saves the current editor content synchronously.
   *
   * <p>
   */
