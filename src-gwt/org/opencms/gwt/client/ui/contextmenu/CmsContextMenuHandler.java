...
public class CmsContextMenuHandler implements I_CmsContextMenuHandler {
  ...
  public void loadContextMenu(
      final CmsUUID structureId, final AdeContext context, final CmsContextMenuButton menuButton) {

    CmsRpcAction<List<CmsContextMenuEntryBean>> action =
  ...
  protected I_CmsContextMenuEntry transformSingleEntry(
      CmsContextMenuEntryBean bean, CmsUUID structureId) {
