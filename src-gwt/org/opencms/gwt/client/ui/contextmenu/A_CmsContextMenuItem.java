...
public abstract class A_CmsContextMenuItem extends Composite
  ...
  /**
   * Returns <code>true</code> if this menu item has a sub menu, <code>false</code> otherwise.
   *
   * <p>
   *
  ...
  /**
   * Returns <code>true</code> if the item is active <code>false</code> otherwise.
   *
   * <p>
   *
  ...
  /**
   * The action that is executed on click depends on the concrete implementation of a menu item. So
   * the onClick Method has to be implemented in the sub class.
   *
   * <p>
   *
   * @see
   ...
   *
   * <p>If the item is inactive all handlers are removed.
   *
   * <p>
   *
   ...
   *
   * <p>First closes all sub menus that are not required anymore. And then reopens the necessary sub
   * menus and activates the selected item.
   *
   * <p>
   *
   ...
   *
   * <p>If a menu item has no sub menu it will be deselected.
   *
   * <p>
   *
