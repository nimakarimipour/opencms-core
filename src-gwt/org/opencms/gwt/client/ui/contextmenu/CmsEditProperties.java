...
public final class CmsEditProperties implements I_CmsHasContextMenuCommand {
  ...
  /**
   * Helper class which encapsulates the differences between the contexts where the property edit
   * dialog is opened.
   *
   * <p>
   */
  public static class PropertyEditingContext {
    ...
    /**
     * Flag to control whether the file name field should be focused after opening the property
     * dialog.
     */
    ...
    /**
     * The restart command (used to open the property dialog again after closing e.g. the property
     * definition dialog).
     */
    ...
    public CmsPropertyDefinitionButton createPropertyDefinitionButton() {
      ...
      return new CmsPropertyDefinitionButton() {
        ...
        /**
         * @see
         *     org.opencms.gwt.client.property.definition.CmsPropertyDefinitionButton#onClosePropertyDefinitionDialog()
         */
    ...
    /**
     * Gets the file navigation object.
     *
     * <p>
     *
  ...
  public static class WorkplacePropertyEditorContext implements I_CmsFormHandler {
    ...
    public WorkplacePropertyEditorContext(
      ...
      if (fileNavigation != null) {
        ...
        String prevText =
            org.opencms.gwt.client.Messages.get()
                .key(org.opencms.gwt.client.Messages.GUI_BUTTON_PREV_RESOURCE_0);
        prevButton.setTitle(prevText);
        String nextText =
            org.opencms.gwt.client.Messages.get()
                .key(org.opencms.gwt.client.Messages.GUI_BUTTON_NEXT_RESOURCE_0);
        ...
        final AsyncCallback<CmsUUID> loadHandler =
      ...
      m_editContext.setRestart(
          () -> {
            WorkplacePropertyEditorContext context =
      ...
      String boxStyle =
          org.opencms.gwt.client.ui.css.I_CmsLayoutBundle.INSTANCE.dialogCss().leftButtonBox();
    ...
    /**
     * Updates the property dialog with the next resource.
     *
     * <p>
     *
    ...
    private void updateData(CmsPropertiesBean result) {
      ...
      final CmsVfsModePropertyEditor editor =
          new CmsVfsModePropertyEditor(result.getPropertyDefinitions(), handler);
      m_editor = editor;
  ...
  protected static class PropertyEditorHandler extends CmsSimplePropertyEditorHandler {
    ...
    /**
     * Enables or disables the ADE template select box for pages.
     *
     * <p>
     *
    ...
    /**
     * Stores an action to execute after successful submits.
     *
     * <p>
     *
  ...
  /**
   * Property dialog subclass which keeps track of which way the dialog is exited.
   *
   * <p>
   */
  ...
  public static void openPropertyDialog(
    ...
    final CmsFormDialog dialog =
        new PropertiesFormDialog(handler.getDialogTitle(), editor.getForm());
