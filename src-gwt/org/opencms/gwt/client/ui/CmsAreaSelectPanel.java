...
public class CmsAreaSelectPanel extends Composite
    implements HasWidgets,
        IndexedPanel,
        HasValueChangeHandlers<CmsPositionBean>,
  ...
  private static I_CmsAreaSelectPanelUiBinder m_uiBinder =
      GWT.create(I_CmsAreaSelectPanelUiBinder.class);

  /** The marker. */
  @UiField protected Element m_marker;

  /** Select overlay. */
  @UiField protected Element m_overlayBottom;

  /** Select overlay. */
  @UiField protected Element m_overlayLeft;

  /** Select overlay. */
  @UiField protected Element m_overlayRight;

  /** Select overlay. */
  @UiField protected Element m_overlayTop;

  /** The panel holding added widgets. */
  @UiField protected FlowPanel m_panel;
  ...
  /**
   * Returns the position of the selected area, or <code>null</code> if nothing is selected.
   *
   * <p>
   *
   * @param relative if <code>true</code> the relative position is returned, otherwise the absolute
   *     position
  ...
  /**
   * @see
   *     com.google.gwt.user.client.ui.IndexedPanel#getWidgetIndex(com.google.gwt.user.client.ui.Widget)
   */
  ...
  /**
   * Returns if the value change event will always be fired, or only when a select/resize/move
  ...
  public void onMouseDown(MouseDownEvent event) {
    ...
    switch (m_state) {
      ...
      default:
        ...
        // May happen if mouse-cursor was moved outside the window or frame while button pressed and
        // button was released outside.
  ...
  /**
   * @see
   *     com.google.gwt.event.dom.client.MouseMoveHandler#onMouseMove(com.google.gwt.event.dom.client.MouseMoveEvent)
   */
    ...
    switch (m_state) {
      case SELECTING:
        if (m_heightToWidth > 0) {
          ...
          if (((tempX > secondX) && (secondX > m_firstX))
              || ((tempX < secondX) && (secondX < m_firstX))) {
  ...
  /**
   * @see
   *     com.google.gwt.event.dom.client.MouseUpHandler#onMouseUp(com.google.gwt.event.dom.client.MouseUpEvent)
   */
   ...
   * <p>
   *
   * @param relative <code>true</code> if provided position is relative to the select area, not
  ...
  /**
   * Sets if the value change event will always be fired, or only when a select/resize/move
   * operation is finished.
   *
   * <p>
   *
  ...
  /**
   * Sets a fixed selection ratio. Set <code>0</code> to remove the fix.
   *
   * <p>
   *
  ...
  /**
   * Caches the select area element size.
   *
   * <p>
   */
  ...
  /**
   * Calculates the matching X (left/width) value in case of a fixed height/width ratio.
   *
   * <p>
   *
  ...
  /**
   * Calculates the matching Y (top/height) value in case of a fixed height/width ratio.
   *
   * <p>
   *
   * @param newX the cursor X offset to the selection area
  ...
  /**
   * Moves the select area to the specified position, while keeping the size.
   *
   * <p>
   *
  ...
  private void moveTo(int posX, int posY) {
    ...
    m_overlayBottomStyle.setHeight(
        m_elementHeight - posY - m_currentSelection.getHeight(), Unit.PX);
  ...
  /**
   * Setting a new left/top value for the selection.
   *
   * <p>
   *
  ...
  /**
   * Setting a new top/height value for the selection.
   *
   * <p>
   *
  ...
  /**
   * Sets self as mouse down, up and move handler.
   *
   * <p>
   */
  ...
  /**
   * Adjusts the select area height, while keeping the Y position of the top/left corner.
   *
   * <p>
   *
  ...
  /**
   * Sets position and size of the select area.
   *
   * <p>
   *
   * @param posX the new X position
  ...
  /**
   * Sets X position and width of the select area.
   *
   * <p>
   *
   * @param posX the new X position
  ...
  /**
   * Sets Y position and height of the select area.
   *
   * <p>
   *
   * @param posY the new Y position
  ...
  /**
   * Adjusts the select area width, while keeping the X position of the top/left corner.
   *
   * <p>
   *
   * @param width the new width
  ...
  /**
   * Shows or hides the select area.
   *
   * <p>
   *
