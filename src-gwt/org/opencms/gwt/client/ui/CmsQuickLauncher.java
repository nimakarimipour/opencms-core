...
public class CmsQuickLauncher extends CmsMenuButton implements I_CmsToolbarButton {
  ...
  public abstract static class A_QuickLaunchHandler implements I_QuickLaunchHandler {
    ...
    /**
     * @see
     *     org.opencms.gwt.client.ui.CmsQuickLauncher.I_QuickLaunchHandler#handleQuickLaunch(org.opencms.gwt.shared.CmsQuickLaunchData)
     */
    public void handleQuickLaunch(CmsQuickLaunchData data) {

      if (data.getErrorMessage() != null) {
        CmsAlertDialog alert =
            new CmsAlertDialog("" + data.getErrorTitle(), data.getErrorMessage());
        alert.center();
  ...
  public class QuickLaunchButton extends HTML {
    ...
    /**
     * Creates a new button instance for the given bean.
     *
     * <p>
     *
  ...
  protected interface I_ButtonTemplates extends SafeHtmlTemplates {
     ...
     */
    @Template(
        "<span class=\"v-button-wrap\"><img src=\"{0}\" class=\"v-icon\"/><span class=\"v-button-caption\">{1}</span></span>")
  ...
  public void onToolbarActivate() {
    ...
    CmsRpcAction<List<CmsQuickLaunchData>> action =
        new CmsRpcAction<List<CmsQuickLaunchData>>() {
          ...
          public void execute() {
            ...
            CmsCoreProvider.getVfsService()
                .loadQuickLaunchItems(m_quickLaunchHandler.getParameters(), this);
          }
