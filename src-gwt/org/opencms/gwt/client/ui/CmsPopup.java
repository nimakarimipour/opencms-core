...
public class CmsPopup extends PopupPanel implements I_CmsAutoHider {
   ...
   *
   * <p>Only used for GWT dialogs opened from Vaadin.
   */
  ...
  /**
   * Returns <code>true</code> if a caption is set for this popup <code>false</code> otherwise.
   *
   * <p>
   *
  ...
  /**
   * Called on mouse move in the caption area, continues dragging if it was started by {@link
   * #beginDragging}.
   *
   * @see #beginDragging
   * @see #endDragging
  ...
  /**
   * @see
   *     com.google.gwt.user.client.ui.PopupPanel#onPreviewNativeEvent(com.google.gwt.user.client.Event.NativePreviewEvent)
   */
  @Override
  ...
  /**
   * Resets the notification to the parent notification widget and detaches the own notification
   * widget.
   *
   * <p>
   */
  ...
  /**
   * Returns <code>true</code> if this popup has buttons <code>false</code> otherwise.
   *
   * <p>
   *
  ...
  /**
   * Checks if the target of the given event is the caption or a child of the caption.
   *
   * <p>
   *
   * @param event the event to check
   * @return <code>true</code> if the target of the given event is the caption <code>false</code>
   *     otherwise
   */
