...
public class CmsFieldSet extends Composite
  ...
  @UiField protected FlowPanel m_content;

  /** The wrapping panel for this fieldset. */
  @UiField protected FlowPanel m_fieldset;
  ...
  /** The legend of the fieldset. */
  @UiField protected FlowPanel m_wrapper;
   ...
   * Default constructor.
   *
   * <p>Because this class has a default constructor, it can be used as a binder template. In other
   * words, it can be used in other *.ui.xml files:
   */
  public CmsFieldSet() {
  ...
  protected void handleClick(ClickEvent e) {
    ...
    if (!m_opened) {
      ...
      m_animation =
          CmsSlideAnimation.slideIn(
              m_content.getElement(),
              new Command() {
