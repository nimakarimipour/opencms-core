...
public class CmsColorPicker extends Composite implements I_CmsFormWidget, I_CmsHasInit {
  ...
  public CmsColorPicker() {
    ...
    String jsUri =
        CmsStringUtil.joinPaths(
            CmsCoreProvider.get().getWorkplaceResourcesPrefix(), COLOR_PICKER_JS);
    ...
    m_textboxColorValue.addBlurHandler(
        new BlurHandler() {
  ...
  public Object getFormValue() {
    ...
    if ((m_textboxColorValue.getText() == null)
        || !validateColorValue(m_textboxColorValue.getText())) {
  ...
  /**
   * Initializes the native color picker.
   *
   * <p>
   *
  ...
  /**
   * Checks if the given string is a valid colorvalue.
   *
   * <p>
   *
