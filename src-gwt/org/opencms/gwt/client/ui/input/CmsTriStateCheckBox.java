 ...
 * <p>
 */
public class CmsTriStateCheckBox extends Composite
    implements HasValueChangeHandlers<CmsTriStateCheckBox.State> {
  ...
  /**
   * The state to use as a next state if the user clicks on the checkbox while it is in its third
   * state.
   */
  ...
  /**
   * Sets the state which the check box should transition to if the user clicks on it while it is
   * neither on nor off.
   *
   * <p>
   *
  ...
  /**
   * Gets the image class to use for the check box.
   *
   * <p>
   *
  ...
  /**
   * Gets the state which the check box would change to if cilcked on in a given state.
   *
   * <p>
   *
  ...
  /**
   * Updates the UI state according to the logical state.
   *
   * <p>
   */
