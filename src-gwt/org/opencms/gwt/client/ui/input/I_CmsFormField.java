 ...
 *
 * <p>A form field consists of a widget for entering values, some metadata like a label
 * text/description, and a set of validators for validating the field.
 *
 * @since 8.0.0
 */
public interface I_CmsFormField {
   ...
   *
   * <p>If a form field without an id is added to a form, typically it will receive a synthetic id.
   *
   * @return the id
   */
  String getId();
   ...
   *
   * <p>If the field has no validator, this should always return <code>valid</code>.
   *
   ...
   *
   * <p>This will only have an effect if the field has a validator.
   *
   * <p>
   *
