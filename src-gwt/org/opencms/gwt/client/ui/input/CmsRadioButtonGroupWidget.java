 ...
 *
 * <p>This is mostly a 'convenience widget' for creating and handling multiple radio buttons as a
 * single widget. The radio buttons will be layed out vertically. If you need more control about the
 * layout of the radio buttons, use multiple {@link CmsRadioButton} instances and link them with a
 * {@link CmsRadioButtonGroup}.
 *
 * <p>
 *
 * @since 8.0.0
...
public class CmsRadioButtonGroupWidget extends Composite
   ...
   *
   * <p>The first component of each pair is the value of the radio buttons, the second component is
   * used as the label.
   *
   ...
   *
   * <p>The keys of the map are used as the values of the radio buttons, and the values of the map
   * are used as labels for the radio buttons.
   *
  ...
  /**
   * Fires a ValueChangedEvent on this widget.
   *
   * <p>
   *
