...
public class CmsTextBox extends Composite
  ...
  /**
   * Event handler for this text box.
   *
   * <p>
   */
  private class TextBoxHandler
    ...
    /**
     * Updates the ghost style and text box content depending on the real and ghost value.
     *
     * <p>
     */
    ...
    /**
     * This method is called when the value in the text box is changed.
     *
     * <p>
     *
  ...
  /**
   * Flag which controls whether validation should be inhibited when value change events are fired
   * as a consequence of key presses.
   */
  ...
  /**
   * @see
   *     com.google.gwt.event.dom.client.HasBlurHandlers#addBlurHandler(com.google.gwt.event.dom.client.BlurHandler)
   */
  ...
  public CmsTextBox colorWhite() {
    ...
    getTextBoxContainer()
        .addStyleName(I_CmsInputLayoutBundle.INSTANCE.inputCss().textBoxPanelWhite());
    return this;
  }
  ...
  /**
   * Returns <code>true</code> if this textbox has an error set.
   *
   * <p>
   *
  ...
  /**
   * Returns if the text box is set to trigger the value changed event on key press and not on blur
   * only.
   *
   * <p>
   *
   * @return <code>true</code> if the text box is set to trigger the value changed event on key
   *     press
   */
   ...
   *
   * <p>This *only* changes the style, not the actual mode.
   *
   * @param enabled <code>true</code> if the ghost mode style should be enabled, false if it should
   *     be disabled
   */
   ...
   * <p>
   *
   * @param triggerOnKeyPress <code>true</code> if the value changed event should be triggered on
   *     key press
   */
   ...
   * <p>
   *
   * @param inhibitValidation if true, some additional information will be added to the event to ask
   *     event handlers to not perform any validation directly
   */
  protected void fireValueChangedEvent(boolean inhibitValidation) {
    ...
    if (!inhibitValidation) {
      ...
      CmsExtendedValueChangeEvent<String> e =
          new CmsExtendedValueChangeEvent<String>(getFormValueAsString());
