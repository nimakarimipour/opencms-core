...
public abstract class A_CmsFormFieldPanel extends Composite {
   ...
   *
   * <p>This should only be called once, when the form is being built.
   *
   * <p>
   *
   ...
   *
   * <p>Not supported by all subclasses.
   *
   * <p>
   *
  ...
  protected CmsFormRow createRow(
    ...
    if (description != NO_DESCRIPTION) {
      label.setTitle(
          CmsStringUtil.isNotEmptyOrWhitespaceOnly(description) ? description : labelText);
    }
