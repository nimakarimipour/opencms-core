...
public class CmsFieldTooltip extends Composite {
  ...
  public static class Handler implements NativePreviewHandler {
    ...
    /**
     * Gets the tooltip data for the active tooltip, or null if no tooltip is active.
     *
     * <p>
     *
  ...
  @UiField protected HTML m_label;

  /** The tooltip data. */
  private Data m_data;

  /**
   * Flag indicating whether tooltip is persistent (i.e. not closed when the mouse cursor leaves the
   * icon).
   */
  ...
  /**
   * Checks if the tooltip is persistent, i.e. it can no longer be closed by leaving the button with
   * the mouse cursor, but needs to be closed by clicking somewhere else.
   *
   * <p>
   *
  ...
  /**
   * Makes the tooltip persistent, i.e. it can no longer be closed by leaving the button with the
   * mouse cursor, but needs to be closed by clicking somewhere else.
   *
   * <p>
   */
