 ...
 *
 * <p>This widget contains both a label and a panel into which an input widget for the form field
 * can be placed. These widgets are next to each other horizontally.
 *
 * @since 8.0.0
 */
public class CmsFormRow extends Composite {
  ...
  public static List<String> ICON_STYLES =
      Arrays.asList(
   ...
   *
   * <p>The supplier passed in should not create a new tooltip data instance each time, but cache
   * the different possible tooltip data instances.
   *
   * @param icon the help icon
   * @param dataSupplier provides the tooltip data at the time the DOM events occur
   */
  public static void installTooltipEventHandlers(
      final Panel icon, final Supplier<Data> dataSupplier) {
