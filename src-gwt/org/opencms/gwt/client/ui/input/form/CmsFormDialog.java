...
public class CmsFormDialog extends CmsPopup {
   ...
   * @param title the title of the form dialog
   * @param form the form to use
   * @param dialogWidthObj the dialog width (if null, don't set any width; if negative, set default
   *     width)
   */
  public CmsFormDialog(String title, CmsForm form, Integer dialogWidthObj) {
    ...
    if (dialogWidthObj != null) {
      ...
      if (dialogWidth > 0) {
        ...
        dialogWidth =
            (windowWidth - 100) > STANDARD_DIALOG_WIDTH ? windowWidth - 100 : STANDARD_DIALOG_WIDTH;
        ...
        .scheduleDeferred(
            new ScheduledCommand() {
              ...
              public void execute() {
                ...
                // The event handling of GWT gets confused if we don't execute this as a scheduled
                // command
  ...
  protected void registerPreviewHandler() {
    ...
    if (m_previewHandlerRegistration == null) {
      NativePreviewHandler eventPreviewHandler =
            ...
            public void onPreviewNativeEvent(NativePreviewEvent event) {
              ...
              if (DOM.eventGetType(nativeEvent) == Event.ONKEYDOWN) {
                ...
                if (keyCode == KeyCodes.KEY_ESCAPE) {
                  ...
                  boolean isTextarea =
                      (element != null) && element.getTagName().equalsIgnoreCase("textarea");
                  if (!isTextarea) {
                    onClickOk();
                  }
                }
