...
public class CmsBasicFormField implements I_CmsFormField {
  ...
  private I_CmsFormField.ValidationStatus m_validationStatus =
      I_CmsFormField.ValidationStatus.unknown;
  ...
  public CmsBasicFormField(
      String id, String description, String label, Object defaultValue, I_CmsFormWidget widget) {
  ...
  public static CmsBasicFormField createField(
      CmsXmlContentProperty propertyConfig, Map<String, String> additionalParams) {
  ...
  public static CmsBasicFormField createField(
    ...
    I_CmsFormWidget widget =
        factory.createFormWidget(
            widgetType, widgetConfig, Optional.fromNullable(propertyConfig.getDefault()));
    CmsBasicFormField field =
        new CmsBasicFormField(fieldId, description, label, propertyConfig.getDefault(), widget);
   ...
   */
  public static Map<String, I_CmsFormField> createFields(
      Collection<CmsXmlContentProperty> propertyConfigurations) {
  ...
  /**
   * @see
   *     org.opencms.gwt.client.ui.input.I_CmsFormField#bind(org.opencms.gwt.client.ui.input.I_CmsStringModel)
   */
  public void bind(I_CmsStringModel model) {

    assert m_model == null;
    m_model = model;
    m_handlerRegistration =
        m_model.addValueChangeHandler(
  ...
  /**
   * @see
   *     org.opencms.gwt.client.ui.input.I_CmsFormField#setValidationStatus(org.opencms.gwt.client.ui.input.I_CmsFormField.ValidationStatus)
   */
  ...
  /**
   * @see
   *     org.opencms.gwt.client.ui.input.I_CmsFormField#setValidator(org.opencms.gwt.client.validation.I_CmsValidator)
   */
