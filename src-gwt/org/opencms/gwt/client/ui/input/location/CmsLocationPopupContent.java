...
public class CmsLocationPopupContent extends Composite {
  ...
  protected interface I_CmsLocationPopupContentUiBinder
      extends UiBinder<HTMLPanel, CmsLocationPopupContent> {
    // GWT interface, nothing to do here
  }

  /** The ui-binder instance for this class. */
  private static I_CmsLocationPopupContentUiBinder uiBinder =
      GWT.create(I_CmsLocationPopupContentUiBinder.class);
  ...
  /** The address label. */
  @UiField Label m_addressLabel;

  /** The cancel button. */
  @UiField CmsPushButton m_cancelButton;

  /** The height field. */
  @UiField CmsTextBox m_heightField;

  /** The label field. */
  @UiField CmsTextBox m_latitudeField;

  /** The label label. */
  @UiField Label m_latitudeLabel;

  /** The longitude field. */
  @UiField CmsTextBox m_longitudeField;

  /** The longitude label. */
  @UiField Label m_longitudeLabel;

  /** The map canvas element. */
  @UiField Element m_mapCanvas;
  ...
  /** The mode label. */
  @UiField Label m_modeLabel;

  /** The OK button. */
  @UiField CmsPushButton m_okButton;

  /** The map size label. */
  @UiField Label m_sizeLabel;
  ...
  /** The width field. */
  @UiField CmsTextBox m_widthField;
