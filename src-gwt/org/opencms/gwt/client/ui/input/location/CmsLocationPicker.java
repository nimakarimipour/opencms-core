 ...
 * <p>
 */
public class CmsLocationPicker extends Composite
    implements HasValueChangeHandlers<String>, I_CmsHasResizeOnShow {
  ...
  private static I_CmsLocationPickerUiBinder uiBinder =
      GWT.create(I_CmsLocationPickerUiBinder.class);

  /** The location picker controller. */
  CmsLocationController m_controller;

  /** The location info panel. */
  @UiField Element m_locationInfoPanel;
