 ...
 * @since 8.5.0
 */
public class CmsMultiSelectBox extends A_CmsSelectBox<CmsMultiSelectCell>
        ...
        .registerFactory(
            ...
            new I_CmsFormWidgetFactory() {
              ...
              public I_CmsFormWidget createWidget(
                ...
                Map<String, CmsPair<String, Boolean>> entries =
                    new HashMap<String, CmsPair<String, Boolean>>();
                String label = "Select";
