 ...
 * @since 8.0.0
 */
public class CmsUploadButton extends Composite
    implements HasHorizontalAlignment, I_CmsUploadButton {
  ...
  /** The button face. */
  @UiField protected HTML m_buttonFace;
   ...
   *
   * <p>Creates a new upload button. This upload button opens a new OS file selector on click.
   *
   * <p>On change the button handler passed into the constructor is notified.
   *
   * <p>
   *
  ...
  /**
   * Enables the button, switching the button title attribute from the disabled reason to the
   * original title.
   *
   * <p>
   */
  ...
  /**
   * Updates the CSS classes according to the button state.
   *
   * <p>
   *
