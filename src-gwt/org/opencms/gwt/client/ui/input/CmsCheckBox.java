...
/**
 * This class represents a labeled checkbox which is not represented as an INPUT element in the DOM,
 * but is displayed as an image.
 *
 * <p>It can be checked/unchecked and enabled/disabled, which means 4 combinations in total. So you
 * need to supply 4 images, one for each of the combinations.
 *
 * <p>
 *
 * @since 8.0.0
...
public class CmsCheckBox extends Composite
   ...
   *
   * <p>The label text passed will be displayed to the right of the checkbox. If it is null, no
   * label is displayed.
   *
   * <p>
   *
  ...
  public CmsCheckBox(String labelText) {
    ...
    m_button.addValueChangeHandler(
  ...
  /**
   * Enables the checkbox, switching the checkbox title attribute from the disabled reason to the
   * original title.
   *
   * <p>
   */
  ...
  /**
   * This is the alignment of the text in reference to the checkbox, possible values are left or
   * right.
   *
   * <p>
   *
   ...
   *
   * @see
   *     com.google.gwt.user.client.ui.HasHorizontalAlignment#setHorizontalAlignment(com.google.gwt.user.client.ui.HasHorizontalAlignment.HorizontalAlignmentConstant)
   */
