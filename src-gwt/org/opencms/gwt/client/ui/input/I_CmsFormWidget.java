...
public interface I_CmsFormWidget {
  ...
  /**
   * Returns the "apparent value", i.e. either the real value if available, or else the ghost value
   ...
   *
   * <p>If the error message is null, no error message will be displayed.
   *
