...
/**
 * Widget for selecting one of multiple items from a drop-down list which opens after the user
...
public class CmsComboBox extends A_CmsSelectBox<CmsLabelSelectCell>
   ...
   *
   * <p>The keys of the map are the values of the select options, and the values of the map are the
   * labels to be displayed for each option.
   *
  ...
  /**
   * @see
   *     org.opencms.gwt.client.ui.input.A_CmsSelectBox#addValueChangeHandler(com.google.gwt.event.logical.shared.ValueChangeHandler)
   */
  @Override
   ...
   *
   * <p>Note: This will only affect select options added *after* calling this method!
   *
  ...
  protected void initOpener() {
    ...
    m_openerWidget.addFocusHandler(
        new FocusHandler() {
  ...
  /**
   * This method should be used to make changes to the CSS style of the select box when the value
   * changes.
   *
   * <p>
   */
