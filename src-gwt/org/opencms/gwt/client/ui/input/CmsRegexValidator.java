...
public class CmsRegexValidator implements I_CmsValidator {
   ...
   *
   * <p>The regular expression passed as a parameter is used to match complete strings, not parts of
   * strings. For example, a regex of "AAA" will only match the string "AAA", and not "BAAA". If the
   * regex starts with an exclamation mark ("!"), the match will be inverted, i.e. only strings that
   * don't match the rest of the regular expression will be interpreted as valid.
   *
  ...
  /**
   * Matches a string against a regex, and inverts the match if the regex starts with a '!'.
   *
   * <p>
   *
