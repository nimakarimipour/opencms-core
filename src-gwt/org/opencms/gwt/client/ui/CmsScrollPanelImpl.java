...
public class CmsScrollPanelImpl extends CmsScrollPanel {
  ...
  public void onResizeDescendant() {
    ...
    // appending div to measure panel width, doing it every time anew to avoid rendering bugs in
    // Chrome
   ...
   *
   * <p>This throws away any old resize observers and creates a new one to observe the element of
   * the scroll panel itself, and the element with the scrollable content.
   */
  ...
  private void setVerticalScrollbar(final CmsScrollBar scrollbar, int width) {
    ...
    m_verticalScrollbarHandlerRegistration =
        scrollbar.addValueChangeHandler(
