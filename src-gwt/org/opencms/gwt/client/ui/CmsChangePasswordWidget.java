...
public class CmsChangePasswordWidget extends Composite {
  ...
  private static I_CmsPasswordWidgetUiBinder uiBinder =
      GWT.create(I_CmsPasswordWidgetUiBinder.class);

  /** Label for displaying error messages. */
  @UiField protected Label m_errorLabel;
  ...
  public static void showDialog() {
    ...
    final CmsPopup popup =
        new CmsPopup(
            Messages.get()
                .key(
                    Messages.GUI_PASSWORD_CHANGE_TITLE_1,
                    CmsCoreProvider.get().getUserInfo().getName()));
    popup.setModal(true);
        ...
        new CmsRpcAction<String>() {
          ...
          public void execute() {
            ...
            CmsCoreProvider.getService()
                .changePassword(oldPassword, newPassword1, newPassword2, this);
          }
