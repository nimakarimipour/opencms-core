...
public class CmsDeleteWarningDialog extends CmsConfirmDialog {
   ...
   * <p>
   *
   * @param callback the callback that is executed when the resource was deleted (can be <code>null
   *     </code>)
   */
  ...
  private void checkBrokenLinks() {
    ...
    if (m_sitePath != null) {
      ...
      CmsRpcAction<CmsDeleteResourceBean> action =
          new CmsRpcAction<CmsDeleteResourceBean>() {
