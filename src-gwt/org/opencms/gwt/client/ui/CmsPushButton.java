 ...
 * Push button class.
 *
 * <p>Uses CSS classes cmsState and dependent from 'button.css', make sure it is injected.
 *
 * <p>
 *
 * @since 8.0.0
...
public class CmsPushButton extends PushButton implements HasHorizontalAlignment {
   ...
   *
   * <p>Use when opening modal popups to ensure the button is not left in hovered state.
   *
   * <p>
   */
  ...
  /**
   * @see
   *     com.google.gwt.user.client.ui.CustomButton#onBrowserEvent(com.google.gwt.user.client.Event)
   */
  @Override
   ...
   *
   * <p>If <code>true</code> the button will not be accessible by tab navigation.
   *
   * <p>
   *
