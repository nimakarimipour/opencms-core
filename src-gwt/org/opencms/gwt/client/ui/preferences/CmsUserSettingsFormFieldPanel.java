...
public class CmsUserSettingsFormFieldPanel extends A_CmsFormFieldPanel {
  ...
  public interface I_CmsUserSettingsFormFieldPanelUiBinder
      extends UiBinder<Widget, CmsUserSettingsFormFieldPanel> {
    // empty
  }
  ...
  public I_CmsUserSettingsFormFieldPanelUiBinder uiBinder =
      GWT.create(I_CmsUserSettingsFormFieldPanelUiBinder.class);

  /** Form field container. */
  @UiField protected FlowPanel m_basicSettingsPanel;

  /** Tab. */
  @UiField protected CmsScrollPanel m_basicTab;

  /** Form field container. */
  @UiField protected FlowPanel m_extendedSettingsPanel;

  /** Tab. */
  @UiField protected CmsScrollPanel m_extendedTab;

  /** The style from the ui.xml file. (Note: the field needs to */
  @UiField protected ExternalStyle style;

  /** The tab panel. */
  private CmsTabbedPanel<CmsScrollPanel> m_tabPanel =
      new CmsTabbedPanel<CmsScrollPanel>(CmsTabbedPanelStyle.buttonTabs);
  ...
  public CmsUserSettingsFormFieldPanel(CmsUserSettingsBean userSettings) {
    ...
    uiBinder.createAndBindUi(
        this); // don't use the return value, since we use the created widgets as tabs for the tab
               // panel
  ...
  /**
   * Gets the container in which the field should be placed.
   *
   * <p>
   *
