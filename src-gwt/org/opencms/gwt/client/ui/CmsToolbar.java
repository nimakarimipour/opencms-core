...
public class CmsToolbar extends Composite {
  ...
  @UiField protected FlowPanel m_buttonPanelLeft;

  /** Holds right-side buttons associated with the tool-bar. */
  @UiField protected FlowPanel m_buttonPanelRight;

  /** The quick launcher (initially invisible). */
  @UiField protected CmsQuickLauncher m_quickLauncher;

  /** The user info button HTML. */
  @UiField protected CmsUserInfo m_userInfo;
  ...
  public static void showToolbar(
      final CmsToolbar toolbar, final boolean show, final CmsStyleVariable toolbarVisibility) {
  ...
  /**
   * Returns all {@link com.google.gwt.user.client.ui.Widget} added to the tool-bar in order of
   * addition first left than right.
   *
   * <p>
   *
