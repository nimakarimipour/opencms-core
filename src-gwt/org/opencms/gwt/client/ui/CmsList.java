...
/**
 * A very basic list implementation to hold {@link CmsListItemWidget}.
 *
 * <p>
 *
 ...
 * @since 8.0.0
 */
public class CmsList<I extends I_CmsListItem> extends ComplexPanel
  ...
  /**
   * Flag to indicate if the list will always return <code>true</code> on check target requests
   * within drag and drop.
   */
  ...
  /**
   * Returns if the list will always return <code>true</code> on check target requests within drag
   * and drop.
   *
   * <p>
   *
  ...
  /**
   * Sets if the list will always return <code>true</code> on check target requests within drag and
   * drop.
   *
   * <p>
   *
