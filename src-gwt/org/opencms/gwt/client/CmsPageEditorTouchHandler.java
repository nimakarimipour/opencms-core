...
public class CmsPageEditorTouchHandler {
                  ...
                  if (Element.is(target)) {
                    ...
                    Element optionBar =
                        CmsDomUtil.getAncestor(
                            element, I_CmsElementToolbarContext.ELEMENT_OPTION_BAR_CSS_CLASS);
                    if (optionBar == null) {
                      deactivateContext();
                    }
                  }
  ...
  /**
   * This method is called to give this class a chance to process clicks on toolbar buttons by
   * itself, for the purpose of showing / hiding toolbars in touch-only mode. If this class decided
   * to handle the click event, returns true, otherwise false.
   *
