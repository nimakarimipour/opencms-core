...
/**
 * Singleton that creates and manages access to the shared iframe used for embedded Vaadin dialogs,
 * mainly in the page editor.
 */
public class CmsEmbeddedDialogFrame implements I_CmsEmbeddedDialogFrame {
  ...
  /**
   * @see org.opencms.gwt.client.util.I_CmsEmbeddedDialogFrame#loadDialog(java.lang.String,
   *     org.opencms.gwt.client.util.I_CmsEmbeddedDialogHandlerJsCallbacks)
   */
  @Override
   ...
   */
  private native void setDialogHandlerCallbacks(
      String frameName, I_CmsEmbeddedDialogHandlerJsCallbacks handler) /*-{
