...
public class CmsScrollToBottomHandler implements ScrollHandler {
   ...
   *
   * <p>The scroll threshold is the distance from the bottom edge of the scrolled content such that
   * when the distance from the bottom edge of the scroll viewport to the bottom edge of the
