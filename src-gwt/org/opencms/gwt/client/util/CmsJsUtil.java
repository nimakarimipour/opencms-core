...
public final class CmsJsUtil {
  ...
  /**
   * Calls a named global function (i.e. a function-valued attribute of window) with a string
   * argument.
   *
   * <p>
   *
   ...
   */
  public static native void callNamedFunctionWithString2(
      String name, String param1, String param2) /*-{
        var w = $wnd;
   ...
   */
  public static native void fillStringMapFromJsObject(
      JavaScriptObject jso, Map<String, String> map) /*-{
        var k;
        for (k in jso) {
            var v = jso[k];
  ...
  /**
   * Opens the given URI in the current browser window, ensuring that a request to the server is
   * triggered.
   *
  ...
  public static native void setAttribute(
      JavaScriptObject jso, String attr, JavaScriptObject newValue) /*-{
        jso[attr] = newValue;
    }-*/;
  ...
  /**
   * Wraps a native JavaScript callback taking a string argument into an AsyncCallback so that it
   * can easily be called from GWT Java code.
   *
   * <p>
   *
