...
/**
 * A utility class for partitioning a list of items (each of which has a given size) into one or
 * more batches of consecutive items such that each batch except the last one consists of just
 * enough items to make the total sum of item sizes in the batch greater or equal than a given
 * parameter.
 *
 * <p>
 *
...
public class CmsListSplitter<T extends I_CmsHasSize> {
   ...
   *
   * <p>This will fail if there are no more items.
   *
