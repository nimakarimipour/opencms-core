...
/**
 * Move animation. Moving the given element from it's start to it's end position and executing the
 * given call-back on complete.
 *
 * <p>
 *
 * @since 8.0.0
...
public class CmsMoveAnimation extends A_CmsAnimation {
  ...
  public CmsMoveAnimation(
      Element element, int startTop, int startLeft, int endTop, int endLeft, Command callback) {
