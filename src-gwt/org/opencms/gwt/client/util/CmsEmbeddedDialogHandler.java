...
public class CmsEmbeddedDialogHandler
  ...
  public static void openDialog(
      String dialogId, List<CmsUUID> structureIds, Consumer<CmsUUID> finishCallback) {
    ...
    handler.openDialog(
        dialogId, CmsGwtConstants.CONTEXT_TYPE_FILE_TABLE, structureIds, new HashMap<>());
  }
  ...
  public void leavePage(String targetUri) {
    ...
    if (m_handler != null) {
      ...
      // the timer is a workaround for weird Safari behavior, just calling Location.assign doesn't
      // work there
      Timer timer =
          new Timer() {
  ...
  public void openDialog(
      String dialogId, String contextType, List<CmsUUID> resources, Map<String, String> params) {
