...
public class CmsNewLinkFunctionTable {
  ...
  /**
   * The map from collector context ids to the corresponding actions.
   *
   * <p>
   */
  ...
  /**
   * Static method for used to create a new element based on a collector's context id and open the
   * editor for id.
   *
   * <p>
   *
  ...
  /**
   * Triggers creation and editing of a new element for the given collector, identified by its
   * context id.
   *
   * <p>
   *
  ...
  /**
   * Installs a Javascript function which can be used to create and edit a new element given the
  ...
  /**
   * Sets the action which should be executed if cmsCreateAndEditNewElement is called with the given
   * collector context id.
   *
   * <p>
   *
