...
public interface I_CmsResourcePreview<T extends CmsResourceInfoBean> {
  ...
  /**
   * Returns the preview name, should return the same as in {@link
   * org.opencms.ade.galleries.preview.I_CmsPreviewProvider#getPreviewName()}.
   *
   * <p>
   *
   ...
   * provided integrator functions <code>setLink</code> and <code>setImage</code>.
   *
   * <p>Returning <code>true</code> when all data has been. If there are any changes, the user will
   * be requested to save those and the editor OK function will be called again.
   *
   * <p>
   *
   * @return <code>true</code> when all data has been set, <code>false</code> if there were any
