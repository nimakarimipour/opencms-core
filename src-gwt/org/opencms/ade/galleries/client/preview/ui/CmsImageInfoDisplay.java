...
public class CmsImageInfoDisplay extends Composite {
  ...
  private static I_CmsImageInfosTabUiBinder m_uiBinder =
      GWT.create(I_CmsImageInfosTabUiBinder.class);

  /** Label. */
  @UiField protected Label m_displayCropFormat;

  /** The format label. */
  @UiField protected Label m_displayFormat;

  /** The path label. */
  @UiField protected Label m_displayPath;

  /** Label. */
  @UiField protected Label m_displayPoint;

  /** The type label. */
  @UiField protected Label m_displayType;

  /** Label. */
  @UiField protected Label m_labelCropFormat;

  /** The format label. */
  @UiField protected Label m_labelFormat;

  /** The path label. */
  @UiField protected Label m_labelPath;

  /** Label. */
  @UiField protected Label m_labelPoint;

  /** The type label. */
  @UiField protected Label m_labelType;
