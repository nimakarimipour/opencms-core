...
public abstract class A_CmsPreviewDetailTab extends Composite {
  ...
  protected interface I_CmsPreviewDetailTabUiBinder
      extends UiBinder<FlowPanel, A_CmsPreviewDetailTab> {
    // gwt interface, nothing to do
  }

  /** The ui-binder instance for this class. */
  private static I_CmsPreviewDetailTabUiBinder uiBinder =
      GWT.create(I_CmsPreviewDetailTabUiBinder.class);
