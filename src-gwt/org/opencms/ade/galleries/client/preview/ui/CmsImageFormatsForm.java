 ...
 * @since 8.0.0
 */
public class CmsImageFormatsForm extends Composite
    implements ValueChangeHandler<String>, KeyPressHandler {
  ...
  private static I_CmsImageFormatsFormUiBinder uiBinder =
      GWT.create(I_CmsImageFormatsFormUiBinder.class);
  /** The cropping button. */
  ...
  @UiField protected HTMLPanel m_panel;
  ...
  /**
   * Parses <code>String</code> to <code>int</code>. Return -1 for invalid input.
   *
   * <p>
   *
  ...
  public void onKeyPress(KeyPressEvent event) {
    ...
    if (((key >= '0') && (key <= '9'))
        || (code == KeyCodes.KEY_BACKSPACE)
        || (code == KeyCodes.KEY_DELETE)) {
      // the value of the input box will probably have changed, so fire an event after the input has
      // been processed
