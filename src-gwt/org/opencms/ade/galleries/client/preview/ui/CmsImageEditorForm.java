...
public class CmsImageEditorForm extends Composite {
  ...
  /** Ui binder interface. */
  protected interface I_CmsImageEditorFormatsTabUiBinder
      extends UiBinder<Widget, CmsImageEditorForm> {
    // GWT interface, nothing to do
  }

  /** Ui binder instance. */
  private static I_CmsImageEditorFormatsTabUiBinder m_uiBinder =
      GWT.create(I_CmsImageEditorFormatsTabUiBinder.class);
  ...
  @UiField protected Label m_labelAlign;

  /** The alt/title field label. */
  @UiField protected Label m_labelAltTitle;

  /** The copyright field label. */
  @UiField protected Label m_labelCopyright;

  /** The hSpace field label. */
  @UiField protected Label m_labelHSpace;

  /** The image spacing check-box label. */
  @UiField protected Label m_labelImageSpacing;

  /** The insert copyright check-box label. */
  @UiField protected Label m_labelInsertCopyright;

  /** The insert link to original check-box label. */
  @UiField protected Label m_labelInsertLinkOrig;

  /** The insert subtitles check-box label. */
  @UiField protected Label m_labelInsertSubtitle;

  /** The vSpace field label. */
  @UiField protected Label m_labelVSpace;

  /** The alignment select-box. */
  @UiField CmsSelectBox m_selectAlign;
  ...
  public CmsImageEditorForm() {
    ...
    for (CmsCheckBox checkBox :
        Arrays.asList(
            m_checkboxInsertCopyright, m_checkboxInsertLinkOrig, m_checkboxInsertSubtitle)) {
    ...
    m_checkboxSpacing.addValueChangeHandler(
