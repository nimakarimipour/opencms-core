 ...
 *
 * <p>This class handles the communication between preview dialog and the server.
 *
 * @param <T> the resource info bean type
 * @since 8.0.0
 */
public abstract class A_CmsResourcePreview<T extends CmsResourceInfoBean>
  ...
  protected static I_CmsPreviewServiceAsync getService() {
    ...
    if (m_previewService == null) {
      ...
      String serviceUrl =
          CmsCoreProvider.get().link("org.opencms.ade.galleries.CmsPreviewService.gwt");
  ...
  /**
   * Removes the preview service reference.
   *
   * <p>
   */
  ...
  /**
   * @see
   *     org.opencms.ade.galleries.client.preview.I_CmsResourcePreview#selectResource(java.lang.String,
