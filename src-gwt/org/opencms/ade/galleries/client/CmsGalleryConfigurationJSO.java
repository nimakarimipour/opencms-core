 ...
 * <p>
 */
public final class CmsGalleryConfigurationJSO extends JavaScriptObject
    implements I_CmsGalleryConfiguration {
  ...
  public boolean isGalleriesSelectable() {
    ...
    return Boolean.valueOf(getString(I_CmsGalleryProviderConstants.CONFIG_GALLERIES_SELECTABLE))
        .booleanValue();
  }
  ...
  /**
   * @see
   *     org.opencms.ade.galleries.shared.I_CmsGalleryConfiguration#setCurrentElement(java.lang.String)
   */
  ...
  /**
   * @see
   *     org.opencms.ade.galleries.shared.I_CmsGalleryConfiguration#setStartFolder(java.lang.String)
   */
  ...
  /**
   * Gets a string-valued attribute.
   *
   * <p>
   *
  ...
  /**
   * Gets the tab configuration string.
   *
   * <p>
   *
  ...
  /**
   * Returns the gallery types in a comma separated list.
   *
   * <p>
   *
  ...
  /**
   * Returns the resource types in a comma separated list.
   *
   * <p>
   *
  ...
  /**
   * Returns the search types in a comma separated list.
   *
   * <p>
   *
