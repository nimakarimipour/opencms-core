 ...
 *
 * <p>Delegates the actions of the gallery controller to the gallery dialog.
 *
 * @since 8.0.0
 */
public class CmsGalleryControllerHandler implements ValueChangeHandler<CmsGallerySearchBean> {
  ...
  public void onInitialSearch(
    ...
    if (m_galleryDialog.getVfsTab() != null) {
      if (vfsPreloadData != null) {
        ...
        m_galleryDialog
            .getVfsTab()
            .fillInitially(dialogBean.getVfsRootFolders(), controller.getDefaultVfsTabSiteRoot());
      }
    }
    ...
    if (CmsStringUtil.isNotEmptyOrWhitespaceOnly(searchObj.getResourcePath())
      ...
      if (m_galleryDialog.isAttached()) {
        ...
        m_galleryDialog.setOnAttachCommand(
            new Command() {
   ...
   */
  public void onUpdateCategoriesList(
      List<CmsCategoryBean> categoriesList, List<String> selectedCategories) {
   ...
   * @param selectedCategories the selected categories
   */
  public void onUpdateCategoriesTree(
      List<CmsCategoryTreeEntry> categoryTreeEntry, List<String> selectedCategories) {
   ...
   */
  public void onUpdateGalleryTree(
   ...
   */
  public void setCategoriesTabContent(
      List<CmsCategoryTreeEntry> categoryRoot, List<String> selected) {
  ...
  public void setGalleriesTabContent(
      List<CmsGalleryFolderBean> galleryInfos, List<String> selectedGalleries) {
