 ...
 *
 * <p>It displays the available categories in the given sort order.
 *
 * @since 8.0.
 */
public class CmsCategoriesTab extends A_CmsListTab {
  ...
  public List<CmsSearchParamPanel> getParamPanels(CmsGallerySearchBean searchObj) {
    ...
    for (String categoryPath : searchObj.getCategories()) {
      ...
      CmsSearchParamPanel panel =
          new CmsSearchParamPanel(Messages.get().key(Messages.GUI_PARAMS_LABEL_CATEGORIES_0), this);
  ...
  public void updateContentList(
      List<CmsCategoryBean> categoriesBeans, List<String> selectedCategories) {
  ...
  public void updateContentTree(
      List<CmsCategoryTreeEntry> treeEntries, List<String> selectedCategories) {
  ...
  private void addChildren(
      CmsTreeItem parent, List<CmsCategoryTreeEntry> children, List<String> selectedCategories) {
  ...
  private CmsTreeItem buildTreeItem(
      CmsCategoryTreeEntry category, List<String> selectedCategories) {
