...
public class CmsGalleryField extends Composite
  ...
  protected class OpenCloseHandler
      implements CloseHandler<CmsListItemWidget>, OpenHandler<CmsListItemWidget> {
  ...
  /** The fading element. */
  @UiField protected Label m_fader;

  /** The DIV carrying the input field. */
  @UiField protected DivElement m_fieldBox;

  /** The image preview element. */
  @UiField protected DivElement m_imagePreview;
  ...
  @UiField protected FlowPanel m_resourceInfoPanel;
        ...
        .registerFactory(
            ...
            new I_CmsFormWidgetFactory() {
              ...
              public I_CmsFormWidget createWidget(
                ...
                CmsGalleryConfigurationJSO conf =
                    CmsGalleryConfigurationJSO.parseConfiguration(config);
  ...
  public void setDropZoneElement(Element dropZone) {
    ...
    if (m_allowUploads && (dropZone != null) && (m_uploadDropZone == null)) {
      ...
      m_uploadDropZone.setTitle(
          org.opencms.ade.upload.client.Messages.get()
              .key(org.opencms.ade.upload.client.Messages.GUI_UPLOAD_DRAG_AND_DROP_ENABLED_0));
  ...
  protected void updateUploadTarget(String uploadTarget) {
    ...
    if (CmsStringUtil.isEmptyOrWhitespaceOnly(m_uploadTarget)) {
      ...
      m_uploadButton.disable(
          org.opencms.ade.upload.client.Messages.get()
              .key(org.opencms.ade.upload.client.Messages.GUI_UPLOAD_BUTTON_NO_TARGET_0));
    } else {
      CmsRpcAction<CmsGalleryActionInfo> action =
          new CmsRpcAction<CmsGalleryActionInfo>() {
            ...
            protected void onResponse(CmsGalleryActionInfo result) {
              ...
              if ((result == null) || (result.getUploadAction() == null)) {
                ...
                ((CmsDialogUploadButtonHandler) m_uploadButton.getButtonHandler())
                    .setTargetFolder(m_uploadTarget);
  ...
  /**
   * Handles styling changes on drag out.
   *
   * <p>
   */
  void onDragOut() {
  ...
  /**
   * Handles styling changes on drag over.
   *
   * <p>
   */
  void onDragOver() {
  ...
  /**
   * Toggles the fading element.
   *
   * <p>
   *
   * @param faded <code>true</code> to show the fading element.
   *     <p>
   */
  ...
  void updateResourceInfo(final String path) {
    ...
    if (CmsStringUtil.isEmptyOrWhitespaceOnly(path)) {
      ...
      CmsRpcAction<CmsResultItemBean> action =
          new CmsRpcAction<CmsResultItemBean>() {
  ...
  private CmsPushButton createSpecialUploadButton() {
    ...
    // uploadButton.setTitle(Messages.get().key(Messages.GUI_GALLERY_UPLOAD_TITLE_1,
    // gallery.getPath()));
                ...
                new CmsRpcAction<CmsUUID>() {
                  ...
                  protected void onResponse(CmsUUID result) {
                    ...
                    CmsEmbeddedDialogHandler.openDialog(
                        m_uploadAction, resultIds, params, id -> updateValueFromId(id));
                  }
                };
            action.execute();
          }
