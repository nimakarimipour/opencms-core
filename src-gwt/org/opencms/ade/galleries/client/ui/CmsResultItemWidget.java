 ...
 *
 * <p>Enabling the image tile view.
 *
 * <p>
 *
 * @since 8.0.0
...
public class CmsResultItemWidget extends CmsListItemWidget {
  ...
  public void setSubtitleTitle(final String subtitleTitle) {
    ...
    m_subtitle.setTitleGenerator(
        new I_TitleGenerator() {
  ...
  /**
   * Generates the HTML for the item tool-tip.
   *
   * <p>
   *
  ...
  private String generateTooltipHtml(CmsListInfoBean infoBean) {
    ...
    appendDom(appendDom(root, "p"), "b")
        .setInnerText(CmsClientStringUtil.shortenString(infoBean.getTitle(), 70));
  ...
  /**
   * Returns the scale parameter for big thumbnail images.
   *
   * <p>
   *
  ...
  /**
   * Returns the scale parameter for small thumbnail images.
   *
   * <p>
   *
