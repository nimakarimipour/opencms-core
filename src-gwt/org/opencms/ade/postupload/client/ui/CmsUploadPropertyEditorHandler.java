...
public class CmsUploadPropertyEditorHandler implements I_CmsPropertyEditorHandler {
   ...
   */
  public CmsUploadPropertyEditorHandler(
      CmsUploadPropertyDialog dialog, CmsPostUploadDialogPanelBean data) {
        ...
        new CmsRpcAction<Void>() {
          ...
          public void execute() {
            ...
            CmsPropertyChangeSet changeBean =
                new CmsPropertyChangeSet(m_data.getStructureId(), propertyChanges);
