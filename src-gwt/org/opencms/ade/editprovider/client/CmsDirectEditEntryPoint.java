...
public class CmsDirectEditEntryPoint extends A_CmsEntryPoint {
  ...
  public void initializeButtons() {
    ...
    List<Element> editableElements =
        CmsDomUtil.getElementsByClass(CmsGwtConstants.CLASS_EDITABLE, Tag.div);
  ...
  public void onModuleLoad() {
    ...
    RootPanel.get()
        .addStyleName(
            I_CmsToolbarButtonLayoutBundle.INSTANCE.toolbarButtonCss().editButtonsVisible());
    installToolbar();
    Scheduler.get()
        .scheduleDeferred(
  ...
  protected void installToolbar() {
    ...
    m_toolbar.setQuickLaunchHandler(
        new A_QuickLaunchHandler() {
  ...
  protected boolean isToolbarVisible() {
    ...
    return m_toolbarVisibility
        .getValue()
        .equals(I_CmsLayoutBundle.INSTANCE.toolbarCss().simpleToolbarShow());
  }
