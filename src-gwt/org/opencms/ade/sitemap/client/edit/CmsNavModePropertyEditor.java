...
public class CmsNavModePropertyEditor extends A_CmsPropertyEditor {
  ...
  public CmsNavModePropertyEditor(
      Map<String, CmsXmlContentProperty> propertyConfig, I_CmsPropertyEditorHandler handler) {
  ...
  private void buildSimpleField(
    ...
    if (inheritedProperty != null) {
      String message =
          Messages.get()
              .key(Messages.GUI_PROPERTY_ORIGIN_2, inheritedProperty.getOrigin(), inherited);
  ...
  /**
   * Helper method which converts an object to a string and returns null if it is null.
   *
   * <p>
   *
