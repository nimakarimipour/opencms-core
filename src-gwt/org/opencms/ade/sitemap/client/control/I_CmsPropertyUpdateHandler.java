...
/**
 * Handler class for property updates which are caused by the user editing the properties of a
 * sitemap entries.
 *
 * <p>
 *
...
public interface I_CmsPropertyUpdateHandler {
  ...
  /**
   * This method is called when the properties of the entry are updated because the user edited this
   * or another entry.
   *
   * <p>
   *
