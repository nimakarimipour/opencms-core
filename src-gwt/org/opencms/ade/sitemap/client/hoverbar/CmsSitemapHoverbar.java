...
public final class CmsSitemapHoverbar extends FlowPanel {
  ...
  /**
   * Constructor to be used for gallery tree items.
   *
   * <p>
   *
   * @param controller the controller
   ...
   */
  private CmsSitemapHoverbar(
      CmsSitemapController controller, CmsUUID entryId, String sitePath, boolean contextmenu) {
  ...
  public static void installOn(
      CmsSitemapController controller, CmsTreeItem treeItem, CmsUUID entryId) {
  ...
  public static CmsSitemapHoverbar installOn(
    ...
    CmsSitemapHoverbar hoverbar =
        new CmsSitemapHoverbar(controller, entryId, movable, contextmenu, menuItemProvider);
    installHoverbar(hoverbar, treeItem.getListItemWidget());
    return hoverbar;
  }
  ...
  public static void installOn(
    ...
    CmsSitemapHoverbar hoverbar =
        new CmsSitemapHoverbar(controller, entryId, true, true, menuItemProvider);
    installHoverbar(hoverbar, treeItem.getListItemWidget());
  }
  ...
  public static void installOn(
    ...
    CmsSitemapHoverbar hoverbar =
        new CmsSitemapHoverbar(controller, entryId, sitePath, contextmenu);
    installHoverbar(hoverbar, treeItem.getListItemWidget());
  }
   ...
   */
  public static CmsSitemapHoverbar installOn(
      CmsSitemapController controller, CmsTreeItem treeItem, Collection<Widget> buttons) {
  ...
  private static void installHoverbar(final CmsSitemapHoverbar hoverbar, CmsListItemWidget widget) {
    ...
    A_CmsHoverHandler handler =
        new A_CmsHoverHandler() {
