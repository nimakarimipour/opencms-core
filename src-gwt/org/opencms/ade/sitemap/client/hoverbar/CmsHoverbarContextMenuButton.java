...
public class CmsHoverbarContextMenuButton extends CmsMenuButton
  ...
  public CmsHoverbarContextMenuButton(
      final CmsSitemapHoverbar hoverbar, I_CmsContextMenuItemProvider menuItemProvider) {
  ...
  /**
   * @see
   *     org.opencms.ade.sitemap.client.hoverbar.I_CmsContextMenuItemProvider#createContextMenu(org.opencms.ade.sitemap.client.hoverbar.CmsSitemapHoverbar)
   */
  ...
  protected void setMenuVisible(final CmsSitemapHoverbar hoverbar) {
    ...
    updateVisibility();
    CmsContextMenu menu =
        new CmsContextMenu(new ArrayList<I_CmsContextMenuEntry>(m_entries), false, getPopup());
  ...
  /**
   * Updates the visibility for an entry and its sub-entries.
   *
   * <p>
   *
