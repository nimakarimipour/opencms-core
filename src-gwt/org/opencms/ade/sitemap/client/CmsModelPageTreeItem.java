...
public class CmsModelPageTreeItem extends CmsTreeItem {
  ...
  public CmsModelPageTreeItem(boolean isModelGroup, String title, String subTitle) {
    ...
    content.setIcon(
        isModelGroup ? CmsIconUtil.ICON_MODEL_GROUP_COPY_BIG : CmsIconUtil.ICON_MODEL_GROUP_BIG);
    initContent(content);
  }
  ...
  public CmsModelPageTreeItem(
      CmsModelPageEntry modelpage, boolean isModelGroup, boolean isParentModel) {
  ...
  public static CmsModelPageTreeItem createRootItem(
      boolean isModelGroup, String title, String subTitle) {
