...
public class CmsRewriteAliasTable extends CellTable<CmsRewriteAliasTableRow> {
  ...
  public CmsRewriteAliasTable(CmsAliasTableController controller) {
    ...
    A_CmsAliasTableColumn<CmsRewriteAliasTableRow, ?, CmsRewriteAliasTable>[] columns =
    ...
    ColumnSortEvent.ListHandler<CmsRewriteAliasTableRow> sortHandler =
        new ColumnSortEvent.ListHandler<CmsRewriteAliasTableRow>(m_dataProvider.getList());
    ...
    final MultiSelectionModel<CmsRewriteAliasTableRow> selectionModel =
        new MultiSelectionModel<CmsRewriteAliasTableRow>(getKeyProvider());
  ...
  /**
   * Gets the controller instance for the alias view.
   *
   * <p>
   *
