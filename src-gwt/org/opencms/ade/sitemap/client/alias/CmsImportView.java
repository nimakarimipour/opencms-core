 ...
 *
 * <p>It contains buttons for uploading a file, a form used to submit the file to the server, and an
 * area used for displaying the result of the import operation on the server.
 *
 * <p>
 */
public class CmsImportView extends Composite {
  ...
  /** The actual form. */
  @UiField protected FormPanel m_formPanel;

  /** The panel containing the form elements. */
  @UiField protected FlowPanel m_formPanelContents;

  /** The label containing the path or name of the CSV file to import. */
  @UiField protected Label m_pathLabel;
  ...
  @UiField protected HasText m_separator;
  ...
  public CmsImportView() {
    ...
    initWidget(content);
    I_CmsUploadButtonHandler handler =
        new I_CmsUploadButtonHandler() {
  ...
  protected void addImportResult(CmsAliasImportResult result) {
    ...
    m_results.addRow(
        CmsAliasMessages.messageAliasImportLine(result), result.getMessage(), cssClass);
  }
  ...
  protected void initializeForm() {
    ...
    m_formPanel.addSubmitCompleteHandler(
        new SubmitCompleteHandler() {
          ...
          public void onSubmitComplete(SubmitCompleteEvent event) {
            ...
            CmsRpcAction<List<CmsAliasImportResult>> action =
                new CmsRpcAction<List<CmsAliasImportResult>>() {
