...
/**
 * This is the controller class for the alias editor which is responsible for reacting to edit
 * operations on the client by triggering the corresponding validation or save actions on the
 * server.
 *
 * <p>
 */
public class CmsAliasTableController {
  ...
  public void editNewRewrite(String rewriteRegex, String rewriteReplacement, CmsAliasMode mode) {
    ...
    CmsRewriteAliasTableRow row =
        new CmsRewriteAliasTableRow(
            new CmsUUID(CmsClientStringUtil.randomUUID()), rewriteRegex, rewriteReplacement, mode);
  ...
  public void load(final Runnable afterLoad) {
    ...
    CmsRpcAction<CmsAliasInitialFetchResult> action =
        new CmsRpcAction<CmsAliasInitialFetchResult>() {
  ...
  public void save() {
    ...
    CmsRpcAction<CmsAliasEditValidationReply> action =
        new CmsRpcAction<CmsAliasEditValidationReply>() {
  ...
  /**
   * Enables or disables the save button of the view depending on whether there are validation
   * errors.
   *
   * <p>
   */
  ...
  /**
   * Triggers server-side validation of the alias table and of a new entry which should be added to
   * it.
   *
   * <p>
   *
  ...
  protected void validateRewrite() {
    ...
    CmsRpcAction<CmsRewriteAliasValidationReply> action =
        new CmsRpcAction<CmsRewriteAliasValidationReply>() {
          ...
          public void execute() {
            ...
            CmsRewriteAliasValidationRequest request =
                new CmsRewriteAliasValidationRequest(rowsToValidate);
