...
public class CmsAliasView extends Composite {
  ...
  @UiField protected HasText m_countLabel;
   ...
   * <p>
   */
  @UiField protected Panel m_rewriteTableContainer;
  ...
  @UiField protected Panel m_tableContainer;
  ...
  public CmsAliasView(CmsAliasTableController controller) {
    ...
    initWidget(
        ((UiBinder<Widget, CmsAliasView>) GWT.create(I_CmsAliasViewUiBinder.class))
    ...
    m_table.addRowCountChangeHandler(
   ...
   *
   * <p>Rows in the table for which a row with the same key is also contained in the 'data'
   * parameter will be updated, the other rows from the 'data' list will be added.
   *
   * <p>
   *
  ...
  /**
   * The click handler for the 'Download' button.
   *
   * <p>
   *
   * @param e the click event
  ...
  /**
   * The click handler for the 'New' button.
   *
   * <p>
   *
   * @param e the click event
  ...
  void onClickNew(ClickEvent e) {
    ...
    m_controller.editNewAlias(
        aliasPath, resourcePath, CmsAliasMode.valueOf(m_newMode.getFormValueAsString()));
  }

  /**
   * The event handler for the button for adding new rewrite aliases.
   *
   * <p>
   *
   * @param e the click event
  ...
  /**
   * Styles a button for adding new aliases.
   *
   * <p>
   *
