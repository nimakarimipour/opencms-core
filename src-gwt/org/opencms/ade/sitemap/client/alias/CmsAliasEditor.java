...
public class CmsAliasEditor {
   ...
   *
   * <p>In addition to displaying the alias editor, this also sets up a timer which regularly
   * informs the server that the alias table for the current site is being edited by the current
   * user. This timer is deactivated when the dialog is closed.
   *
   * <p>
   */
  public void show() {
    ...
    final RepeatingCommand updateCommand =
