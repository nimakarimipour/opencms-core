...
public class CmsImportResultList extends Composite {
  ...
  /**
   * Static instance of the resource bundle for this widget.
   *
   * <p>
   */
  ...
  /**
   * The main panel containing the other parts of this widget.
   *
   * <p>
   */
  ...
  /**
   * Ensures that the table is present in the widget.
   *
   * <p>
   */
