 ...
 * <p>
 */
public class CmsAliasModeColumn
    extends A_CmsAliasTableColumn<CmsAliasTableRow, String, CmsAliasCellTable> {

  /**
   * A map used to translate between the internal names and the user readable names of the
   * selectable values.
   */
  ...
  /**
   * Translates a user-readable mode name to the internal mode value.
   *
   * <p>
   *
