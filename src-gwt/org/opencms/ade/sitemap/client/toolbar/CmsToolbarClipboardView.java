...
public class CmsToolbarClipboardView {
   ...
   */
  public CmsToolbarClipboardView(
      CmsToolbarClipboardButton clipboardButton, final CmsSitemapController controller) {
        ...
        new ClickHandler() {
          ...
          public void onClick(ClickEvent event) {
            ...
            CmsSitemapView.getInstance()
                .getController()
                .undelete(entry.getId(), entry.getSitePath());
          }
        });
