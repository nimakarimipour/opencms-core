 ...
 * @since 8.0.0
 */
public abstract class A_CmsToolbarListMenuButton extends CmsMenuButton
  ...
  public A_CmsToolbarListMenuButton(
      String title, String iconClass, CmsSitemapToolbar toolbar, CmsSitemapController controller) {
  ...
  /**
   * @see
   *     org.opencms.ade.sitemap.client.toolbar.I_CmsToolbarActivatable#onActivation(com.google.gwt.user.client.ui.Widget)
   */
  ...
  public void updateSize() {
    ...
    int height =
        (availableHeight > requiredHeight) && (requiredHeight > 50)
            ? requiredHeight
            : availableHeight;
