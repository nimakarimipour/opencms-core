...
public class CmsCreateGalleryDialog extends CmsPopup {
   ...
   */
  public CmsCreateGalleryDialog(
      CmsSitemapController controller, int resourceTypeId, CmsUUID parentId) {

    super(
        org.opencms.ade.sitemap.client.Messages.get()
            .key(org.opencms.ade.sitemap.client.Messages.GUI_GALLERIES_CREATE_0));
    ...
    addInputRow(
        org.opencms.ade.sitemap.client.Messages.get()
            .key(org.opencms.ade.sitemap.client.Messages.GUI_GALLERIES_LABEL_TITLE_0),
        m_titleInput);
    addDialogClose(null);
  ...
  protected void onOk() {
    ...
    m_controller.createNewGallery(
        m_parentId, m_resourceTypeId, m_titleInput.getFormValueAsString());
    hide();
  }
  ...
  protected void setOkEnabled(boolean enabled) {
    ...
    if (enabled) {
      ...
      m_okButton.disable(
          org.opencms.ade.sitemap.client.Messages.get()
              .key(org.opencms.ade.sitemap.client.Messages.GUI_NEW_GALLERY_VALIDATION_0));
    }
  }
