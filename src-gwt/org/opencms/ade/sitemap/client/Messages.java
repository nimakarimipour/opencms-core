...
public final class Messages {
  ...
  public static final String GUI_ALIAS_EDITING_NOT_PERMITTED_0 =
  ...
  /** Message constant for key in the resource bundle. */
  public static final String GUI_ALIASES_LEGEND_REWRITE_TABLE_0 =
      "GUI_ALIASES_LEGEND_REWRITE_TABLE_0";
  ...
  /** Message constant for key in the resource bundle. */
  public static final String GUI_CATEGORIES_NONLOCAL_SUBTITLE_0 =
  ...
  /** Message constant for key in the resource bundle. */
  public static final String GUI_CATEGORY_VALIDATION_TITLE_NOTEMPTY_0 =
  ...
  /** Message constant for key in the resource bundle. */
  public static final String GUI_COPY_AS_MODEL_GROUP_PAGE_DIALOG_TITLE_0 =
  ...
  /** Message constant for key in the resource bundle. */
  public static final String GUI_COPY_MODEL_PAGE_DIALOG_TITLE_0 =
      "GUI_COPY_MODEL_PAGE_DIALOG_TITLE_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_COPYPAGE_MENU_ENTRY_0 = "GUI_COPYPAGE_MENU_ENTRY_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_CREATE_MODEL_GROUP_PAGE_BUTTON_TITLE_0 =
      "GUI_CREATE_MODEL_GROUP_PAGE_BUTTON_TITLE_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_CREATE_MODEL_GROUP_PAGE_DIALOG_TITLE_0 =
      "GUI_CREATE_MODEL_GROUP_PAGE_DIALOG_TITLE_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_CREATE_MODEL_PAGE_BUTTON_TITLE_0 =
      "GUI_CREATE_MODEL_PAGE_BUTTON_TITLE_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_CREATE_MODEL_PAGE_DIALOG_TITLE_0 =
      "GUI_CREATE_MODEL_PAGE_DIALOG_TITLE_0";
  ...
  /** Message constant for key in the resource bundle. */
  public static final String GUI_DISABLED_BLOCKING_LOCKED_CHILDREN_0 =
      "GUI_DISABLED_BLOCKING_LOCKED_CHILDREN_0";
  ...
  /** Message constant for key in the resource bundle. */
  public static final String GUI_EDIT_MODEL_GROUP_CONFIRM_CONTENT_0 =
      "GUI_EDIT_MODEL_GROUP_CONFIRM_CONTENT_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_EDIT_MODEL_GROUPS_CONFIRM_TITLE_0 =
      "GUI_EDIT_MODEL_GROUPS_CONFIRM_TITLE_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_EDIT_MODELPAGE_BUTTON_TITLE_0 =
      "GUI_EDIT_MODELPAGE_BUTTON_TITLE_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_EDIT_MODELPAGE_CONFIRM_CONTENT_0 =
      "GUI_EDIT_MODELPAGE_CONFIRM_CONTENT_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_EDIT_MODELPAGE_CONFIRM_TITLE_0 =
  ...
  /** Message constant for key in the resource bundle. */
  public static final String GUI_EDIT_TITLE_ERROR_DIALOG_TITLE_0 =
      "GUI_EDIT_TITLE_ERROR_DIALOG_TITLE_0";
  ...
  /** Message constant for key in the resource bundle. */
  public static final String GUI_GALLERIES_LABEL_FOLDER_NAME_0 =
      "GUI_GALLERIES_LABEL_FOLDER_NAME_0";
  ...
  /** Message constant for key in the resource bundle. */
  public static final String GUI_GALLERY_MANAGER_ROLE_REQUIRED_0 =
      "GUI_GALLERY_MANAGER_ROLE_REQUIRED_0";
  ...
  /** Message constant for key in the resource bundle. */
  public static final String GUI_HOVERBAR_GOTO_EXPLORER_0 = "GUI_HOVERBAR_GOTO_EXPLORER_0";
  ...
  /** Message constant for key in the resource bundle. */
  public static final String GUI_MERGE_SITEMAP_CONFIRM_TITLE_0 =
      "GUI_MERGE_SITEMAP_CONFIRM_TITLE_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_MODEL_GROUP_PAGE_TREE_ROOT_SUBTITLE_0 =
      "GUI_MODEL_GROUP_PAGE_TREE_ROOT_SUBTITLE_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_MODEL_GROUP_PAGE_TREE_ROOT_TITLE_0 =
      "GUI_MODEL_GROUP_PAGE_TREE_ROOT_TITLE_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_MODEL_PAGE_DESCRIPTION_LABEL_0 =
      "GUI_MODEL_PAGE_DESCRIPTION_LABEL_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_MODEL_PAGE_TITLE_LABEL_0 = "GUI_MODEL_PAGE_TITLE_LABEL_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_MODEL_PAGE_TREE_ROOT_SUBTITLE_0 =
      "GUI_MODEL_PAGE_TREE_ROOT_SUBTITLE_0";
  ...
  /** Message constant for key in the resource bundle. */
  public static final String GUI_NAVIGATION_LEVEL_UNKOWN_TARGET_0 =
      "GUI_NAVIGATION_LEVEL_UNKOWN_TARGET_0";
  ...
  /** Message constant for key in the resource bundle. */
  public static final String GUI_NON_NAVIGATION_BUTTON_TITLE_0 =
      "GUI_NON_NAVIGATION_BUTTON_TITLE_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_ONLY_GALLERIES_BUTTON_TITLE_0 =
      "GUI_ONLY_GALLERIES_BUTTON_TITLE_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_ONLY_NAVIGATION_BUTTON_TITLE_0 =
      "GUI_ONLY_NAVIGATION_BUTTON_TITLE_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_PARENT_MODEL_PAGE_TREE_ROOT_TITLE_0 =
      "GUI_PARENT_MODEL_PAGE_TREE_ROOT_TITLE_0";
  ...
  /** Message constant for key in the resource bundle. */
  public static final String GUI_REDIRECTION_FIELD_DESCRIPTION_0 =
      "GUI_REDIRECTION_FIELD_DESCRIPTION_0";
  ...
  /** Message constant for key in the resource bundle. */
  public static final String GUI_RETURN_PAGE_NOT_FOUND_TITLE_0 =
  ...
  /** Message constant for key in the resource bundle. */
  public static final String GUI_SITEMAP_CONTEXT_MENU_CREATE_CATEGORY_0 =
      "GUI_SITEMAP_CONTEXT_MENU_CREATE_CATEGORY_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_SITEMAP_CREATE_CATEGORY_TITLE_0 =
      "GUI_SITEMAP_CREATE_CATEGORY_TITLE_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_SITEMAP_CREATE_SUBCATEGORY_TITLE_1 =
      "GUI_SITEMAP_CREATE_SUBCATEGORY_TITLE_1";
