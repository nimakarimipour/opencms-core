...
public final class Messages {
  ...
  /** Message constant for key in the resource bundle. */
  public static final String GUI_UPLOAD_BUTTON_OK_DISABLE_CHECKING_0 =
      "GUI_UPLOAD_BUTTON_OK_DISABLE_CHECKING_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_UPLOAD_BUTTON_OK_DISABLE_UPLOADING_0 =
  ...
  /** Message constant for key in the resource bundle. */
  public static final String GUI_UPLOAD_DRAG_AND_DROP_DISABLED_0 =
      "GUI_UPLOAD_DRAG_AND_DROP_DISABLED_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_UPLOAD_DRAG_AND_DROP_ENABLED_0 =
      "GUI_UPLOAD_DRAG_AND_DROP_ENABLED_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_UPLOAD_FILE_EXISTING_DELETED_1 =
  ...
  /** Message constant for key in the resource bundle. */
  public static final String GUI_UPLOAD_FILE_MAX_SIZE_REACHED_2 =
  ...
  /** Message constant for key in the resource bundle. */
  public static final String GUI_UPLOAD_NOTIFICATION_NO_FILES_0 =
      "GUI_UPLOAD_NOTIFICATION_NO_FILES_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_UPLOAD_NOTIFICATION_RUNNING_0 =
