...
public class CmsDefaultWidgetService extends CmsWidgetService {
  ...
  /**
   * @see org.opencms.acacia.client.CmsWidgetService#getDefaultAttributeValue(java.lang.String,
   *     java.lang.String)
   */
  @Override
  ...
  /**
   * Returns the paths to be skipped during locale synchronization.
   *
   * <p>
   *
  ...
  /**
   * Sets the paths to be skipped during locale synchronization.
   *
   * <p>
   *
  ...
  /**
   * Sets the locale synchronization values.
   *
   * <p>
   *
  ...
  /**
   * @see
   *     org.opencms.acacia.client.CmsWidgetService#shouldRemoveLastValueAfterUnfocus(org.opencms.acacia.client.widgets.I_CmsEditWidget)
   */
  @Override
  ...
  /**
   * Returns if the given path should be skipped for locale synchronization.
   *
   * <p>
   *
