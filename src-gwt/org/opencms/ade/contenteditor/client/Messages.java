...
public final class Messages {
  ...
  public static final String ERR_RESOURCE_ALREADY_LOCKED_BY_OTHER_USER_0 =
      "ERR_RESOURCE_ALREADY_LOCKED_BY_OTHER_USER_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_CHOICE_ADD_CHOICE_1 =
      "GUI_CHOICE_ADD_CHOICE_1"; // Acacia message: Add choice {0}

  /** Message constant for key in the resource bundle. */
  public static final String GUI_CONFIRM_DELETE_LOCALE_TEXT_0 = "GUI_CONFIRM_DELETE_LOCALE_TEXT_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_CONFIRM_DELETE_LOCALE_TITLE_0 =
      "GUI_CONFIRM_DELETE_LOCALE_TITLE_0";
  ...
  /** Message constant for key in the resource bundle. */
  public static final String GUI_LOCALE_DIALOG_NO_LANGUAGE_SELECTED_0 =
      "GUI_LOCALE_DIALOG_NO_LANGUAGE_SELECTED_0";
  ...
  /** Message constant for key in the resource bundle. */
  public static final String GUI_LOCALE_DIALOG_SYNCHRONIZE_TITLE_0 =
      "GUI_LOCALE_DIALOG_SYNCHRONIZE_TITLE_0";
  ...
  /** Message constant for key in the resource bundle. */
  public static final String GUI_SERIALDATE_DAILY_EVERYWORKINGDAY_0 =
  ...
  /** Message constant for key in the resource bundle. */
  public static final String GUI_SERIALDATE_MONTHLY_MONTHDAY_AT_0 =
      "GUI_SERIALDATE_MONTHLY_MONTHDAY_AT_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_SERIALDATE_MONTHLY_MONTHDAY_DAY_EVERY_0 =
  ...
  /** Message constant for key in the resource bundle. */
  public static final String GUI_SERIALDATE_MONTHLY_WEEKDAY_AT_0 =
      "GUI_SERIALDATE_MONTHLY_WEEKDAY_AT_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_SERIALDATE_MONTHLY_WEEKDAY_EVERY_0 =
  ...
  /** Message constant for key in the resource bundle. */
  public static final String GUI_SERIALDATE_DURATION_ENDTYPE_OCC_0 =
      "GUI_SERIALDATE_DURATION_ENDTYPE_OCC_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_SERIALDATE_DURATION_ENDTYPE_OCC_POSTFIX_0 =
      "GUI_SERIALDATE_DURATION_ENDTYPE_OCC_POSTFIX_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_SERIALDATE_DURATION_ENDTYPE_DATE_0 =
      "GUI_SERIALDATE_DURATION_ENDTYPE_DATE_0";

  /** Name of the used resource bundle. */
  public static final String GUI_SERIALDATE_PANEL_EXCEPTIONS_0 =
      "GUI_SERIALDATE_PANEL_EXCEPTIONS_0";

  /** Name of the used resource bundle. */
  public static final String GUI_SERIALDATE_PANEL_SERIAL_OPTIONS_0 =
      "GUI_SERIALDATE_PANEL_SERIAL_OPTIONS_0";

  /** Name of the used resource bundle. */
  public static final String GUI_SERIALDATE_SERIES_CHECKBOX_0 = "GUI_SERIALDATE_SERIES_CHECKBOX_0";

  /** Name of the used resource bundle. */
  public static final String GUI_SERIALDATE_WHOLE_DAY_CHECKBOX_0 =
      "GUI_SERIALDATE_WHOLE_DAY_CHECKBOX_0";

  /** Name of the used resource bundle. */
  public static final String GUI_SERIALDATE_BUTTON_MANAGE_EXCEPTIONS_0 =
  ...
  /** Name of the used resource bundle. */
  public static final String GUI_SERIALDATE_ERROR_INVALID_INTERVAL_0 =
      "GUI_SERIALDATE_ERROR_INVALID_INTERVAL_0";

  /** Name of the used resource bundle. */
  public static final String GUI_SERIALDATE_ERROR_INVALID_OCCURRENCES_1 =
      "GUI_SERIALDATE_ERROR_INVALID_OCCURRENCES_1";

  /** Name of the used resource bundle. */
  public static final String GUI_SERIALDATE_ERROR_SERIAL_END_BEFORE_START_0 =
      "GUI_SERIALDATE_ERROR_SERIAL_END_BEFORE_START_0";

  /** Name of the used resource bundle. */
  public static final String GUI_SERIALDATE_ERROR_SERIESEND_TOO_FAR_AWAY_1 =
      "GUI_SERIALDATE_ERROR_SERIESEND_TOO_FAR_AWAY_1";

  /** Name of the used resource bundle. */
  public static final String GUI_SERIALDATE_ERROR_END_BEFORE_START_0 =
      "GUI_SERIALDATE_ERROR_END_BEFORE_START_0";

  /** Name of the used resource bundle. */
  public static final String GUI_SERIALDATE_ERROR_INVALID_DAYOFMONTH_0 =
      "GUI_SERIALDATE_ERROR_INVALID_DAYOFMONTH_0";

  /** Name of the used resource bundle. */
  public static final String GUI_SERIALDATE_ERROR_NO_WEEKOFMONTH_SPECIFIED_0 =
      "GUI_SERIALDATE_ERROR_NO_WEEKOFMONTH_SPECIFIED_0";

  /** Name of the used resource bundle. */
  public static final String GUI_SERIALDATE_ERROR_NO_WEEKDAY_SPECIFIED_0 =
      "GUI_SERIALDATE_ERROR_NO_WEEKDAY_SPECIFIED_0";

  /** Name of the used resource bundle. */
  public static final String GUI_SERIALDATE_BUTTON_ADD_INDIVIDUAL_0 =
      "GUI_SERIALDATE_BUTTON_ADD_INDIVIDUAL_0";

  /** Name of the used resource bundle. */
  public static final String GUI_SERIALDATE_BUTTON_REMOVE_INDIVIDUAL_0 =
      "GUI_SERIALDATE_BUTTON_REMOVE_INDIVIDUAL_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_TOOLBAR_CANT_DELETE_LAST_LOCALE_0 =
      "GUI_TOOLBAR_CANT_DELETE_LAST_LOCALE_0";
  ...
  /** Message constant for key in the resource bundle. */
  public static final String GUI_TOOLBAR_HELP_BUBBLES_HIDDEN_0 =
      "GUI_TOOLBAR_HELP_BUBBLES_HIDDEN_0";
  ...
  /** Message constant for key in the resource bundle. */
  public static final String GUI_VIEW_MOVE_DOWN_0 =
      "GUI_VIEW_MOVE_DOWN_0"; // Acacia message: Move down
  ...
  /** Name of the used resource bundle. */
  public static final String GUI_SERIALDATE_CONFIRM_EXCEPTION_DIALOG_CAPTION_0 =
      "GUI_SERIALDATE_CONFIRM_EXCEPTION_DIALOG_CAPTION_0";

  /** Name of the used resource bundle. */
  public static final String GUI_SERIALDATE_CONFIRM_DIALOG_YES_BUTTON_0 =
      "GUI_SERIALDATE_CONFIRM_DIALOG_YES_BUTTON_0";

  /** Name of the used resource bundle. */
  public static final String GUI_SERIALDATE_CONFIRM_DIALOG_NO_BUTTON_0 =
      "GUI_SERIALDATE_CONFIRM_DIALOG_NO_BUTTON_0";

  /** Name of the used resource bundle. */
  public static final String GUI_SERIALDATE_CONFIRM_EXCEPTION_DIALOG_MESSAGE_0 =
      "GUI_SERIALDATE_CONFIRM_EXCEPTION_DIALOG_MESSAGE_0";

  /** Name of the used resource bundle. */
  public static final String GUI_SERIALDATE_OVERVIEW_POPUP_TITLE_0 =
      "GUI_SERIALDATE_OVERVIEW_POPUP_TITLE_0";

  /** Name of the used resource bundle. */
  public static final String GUI_SERIALDATE_CONFIRM_SERIES_BINDING_DIALOG_CAPTION_0 =
      "GUI_SERIALDATE_CONFIRM_SERIES_BINDING_DIALOG_CAPTION_0";

  /** Name of the used resource bundle. */
  public static final String GUI_SERIALDATE_CONFIRM_SERIES_BINDING_DIALOG_MESSAGE_0 =
      "GUI_SERIALDATE_CONFIRM_SERIES_BINDING_DIALOG_MESSAGE_0";

  /** Name of the used resource bundle. */
  public static final String GUI_SERIALDATE_FROM_SERIES_INFORMATION_0 =
      "GUI_SERIALDATE_FROM_SERIES_INFORMATION_0";

  /** Name of the used resource bundle. */
  public static final String GUI_SERIALDATE_CURRENT_TILL_END_CHECKBOX_0 =
      "GUI_SERIALDATE_CURRENT_TILL_END_CHECKBOX_0";

  /** Name of the used resource bundle. */
  public static final String GUI_SERIALDATE_CURRENT_TILL_END_CHECKBOX_HELP_0 =
