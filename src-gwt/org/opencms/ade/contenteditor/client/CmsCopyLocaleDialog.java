...
public class CmsCopyLocaleDialog extends CmsPopup {
  ...
  private class CopyLocaleChangeHandler implements ValueChangeHandler<Boolean> {
    ...
    /**
     * The copy locale checkbox change handler.
     *
     * <p>
     *
  ...
  public CmsCopyLocaleDialog(
    ...
    message.setMessageText(
        Messages.get()
            .key(Messages.GUI_LOCALE_DIALOG_DESCRIPTION_1, availableLocales.get(currentLocale)));
    main.add(message);
    ...
    if (hasSync) {
      ...
      m_synchronizeLocaleButton.setText(
          Messages.get().key(Messages.GUI_LOCALE_DIALOG_SYNCHRONIZE_0));
      m_synchronizeLocaleButton.setTitle(
          Messages.get().key(Messages.GUI_LOCALE_DIALOG_SYNCHRONIZE_TITLE_0));
      m_synchronizeLocaleButton.addClickHandler(
          new ClickHandler() {
