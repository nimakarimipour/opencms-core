...
public final class WidgetRegistry {
  ...
  public void registerExternalWidgets(
      List<CmsExternalWidgetConfiguration> externalWidgetConfigurations, final Command callback) {
  ...
  /**
   * Tries to initializes a widget with the given initialization call. Returns false if the init
   * method was not available within the window context yet.
   *
   * <p>
   *
  ...
  /**
   * Exports the widget registration.
   *
   * <p>
   */
  ...
  /**
   * Registers a widget wrapper as widget.
   *
   * <p>
   *
