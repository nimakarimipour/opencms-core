...
/**
 * Helper class for periodically checking a set of elements for publish locks and then reloading the
 * corresponding elements when they are no longer locked.
 */
public class CmsPublishLockChecker {
  ...
  private void startCheck() {
    ...
    CmsRpcAction<Set<CmsUUID>> action =
        new CmsRpcAction<Set<CmsUUID>>() {
