 ...
 *
 * <p>The group-container acts as a draggable element and if edited as a container.
 *
 * <p>
 *
 * @since 8.0.0
 */
public class CmsGroupContainerElementPanel extends CmsContainerPageElementPanel
  ...
  /**
   * Gets the consumed group elements.
   *
   * <p>
   *
  ...
  /**
   * @see
   *     org.opencms.ade.containerpage.client.ui.CmsContainerPageElementPanel#hideEditableListButtons()
   */
  @Override
  ...
  public void highlightContainer(CmsPositionBean positionInfo) {
    ...
    m_highlighting =
        new CmsHighlightingBorder(m_ownPosition, CmsHighlightingBorder.BorderColor.red);
    RootPanel.get().add(m_highlighting);
  }

  /**
   * @see
   *     org.opencms.ade.containerpage.client.ui.CmsContainerPageElementPanel#initInlineEditor(org.opencms.ade.containerpage.client.CmsContainerpageController)
   */
  @Override
  ...
  public void repositionPlaceholder(int x, int y, Orientation orientation) {
    ...
    switch (orientation) {
      case HORIZONTAL:
        m_placeholderIndex =
            CmsDomUtil.positionElementInside(
                m_placeholder, getElement(), m_placeholderIndex, x, -1);
        break;
      case VERTICAL:
        m_placeholderIndex =
            CmsDomUtil.positionElementInside(
                m_placeholder, getElement(), m_placeholderIndex, -1, y);
        break;
      case ALL:
      default:
        m_placeholderIndex =
            CmsDomUtil.positionElementInside(m_placeholder, getElement(), m_placeholderIndex, x, y);
        break;
    }
  ...
  /**
   * Sets the editing marker. Used to highlight the container background while editing.
   *
   * <p>
   *
  ...
  /**
   * @see
   *     org.opencms.ade.containerpage.client.ui.CmsContainerPageElementPanel#showEditableListButtons()
   */
  @Override
  ...
  /**
   * @see
   *     org.opencms.ade.containerpage.client.ui.CmsContainerPageElementPanel#updateOptionBarPosition()
   */
  @Override
