 ...
 *
 * <p>This is used to access all galleries in the system (including download and image galleries),
 * but can not be used to add elements to the container page.
 *
 * <p>
 *
 * @since 8.0.0
...
public class CmsToolbarAllGalleriesMenu extends A_CmsToolbarMenu<CmsContainerpageHandler> {
  ...
  /**
   * Marker string to distinguish search results from the 'all galleries' dialog from results from
   * other instances of the gallery dialog.
   */
  ...
  protected static CmsGalleryDialog createDialog(
      I_CmsGalleryConfiguration configuration, I_CmsGalleryHandler galleryHandler) {
  ...
  private void loadConfiguration() {
    ...
    CmsRpcAction<CmsGalleryConfiguration> action =
        new CmsRpcAction<CmsGalleryConfiguration>() {
