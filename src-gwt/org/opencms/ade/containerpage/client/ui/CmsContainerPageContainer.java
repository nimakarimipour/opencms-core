...
public class CmsContainerPageContainer extends ComplexPanel implements I_CmsDropContainer {
  ...
  /**
   * Helper class for resizing containers in the drag/drop process when an element is dropped into
   * them that is of lower height than the empty container HTML.
   */
  public static class ContainerResizeHelper {
    ...
    public void onShowPlaceholder(Element placeholder) {
      ...
      if (curHeight < m_origHeight) {
        ...
        // but adding a normal element would interfere with drag and drop, so we use the ::after
        // pseudoelement
  ...
  protected class ElementPositionInfo {
    ...
    public ElementPositionInfo(Element element) {
      ...
      m_isAbsolute =
          Position.ABSOLUTE.getCssName().equals(positioning)
  ...
  /**
   * Static variable for storing the container layout change helper for the current drag/drop
   * process.
   */
  ...
  /**
   * The list of nested sub containers that are also valid drop targets during the current drag and
   * drop.
   */
   ...
   *
   * <p>This sets the overflow-y style property to auto to prevent margin collapsing.
   *
   ...
   *
   * <p>The previously created layout changes object (if any) will be reset.
   *
   * @param container the container
  ...
  /**
   * @see
   *     org.opencms.ade.containerpage.client.ui.I_CmsDropContainer#addDndChild(org.opencms.gwt.client.dnd.I_CmsDropTarget)
   */
  ...
  /**
   * @see
   *     org.opencms.ade.containerpage.client.ui.I_CmsDropContainer#adoptElement(org.opencms.ade.containerpage.client.ui.CmsContainerPageElementPanel)
   */
    ...
    if (getWidgetCount() == 0) {
      if (m_emptyContainerElement != null) {
        m_emptyContainerElement.getStyle().clearDisplay();
          ...
          m_containerData.getEmptyContainerContent())) {
        // add empty container element
        try {
          m_emptyContainerElement =
              CmsDomUtil.createElement(m_containerData.getEmptyContainerContent());
  ...
  public void checkMaxElementsOnEnter() {
    ...
    if (count >= m_containerData.getMaxElements()) {
      ...
      for (Widget widget : this) {
        boolean isDummy =
            widget.getStyleName().contains(CmsTemplateContextInfo.DUMMY_ELEMENT_MARKER);
        if (!isDummy) {
          index++;
  ...
  /**
   * In case of a former copy model, and a max elements setting of one, the id of the overflowing
   * element is returned.
   *
   * <p>
   *
  ...
  /**
   * @see
   *     org.opencms.ade.containerpage.client.ui.I_CmsDropContainer#insert(com.google.gwt.user.client.ui.Widget,
   *     int)
   */
  public void insert(Widget w, int beforeIndex) {
    ...
    for (int i = 0; i < children.getLength(); i++) {
      ...
      if ((child.getNodeType() == Node.ELEMENT_NODE)
          && ((Element) child)
              .hasClassName(I_CmsLayoutBundle.INSTANCE.containerpageCss().optionBar())) {
  ...
  /**
   * @see
   *     org.opencms.gwt.client.dnd.I_CmsDropTarget#insertPlaceholder(com.google.gwt.dom.client.Element,
   *     int, int, Orientation)
   */
  ...
  public boolean isShowingEmptyContainerElement() {
    ...
    return (m_emptyContainerElement != null)
        && (m_emptyContainerElement.getParentElement() == getElement());
  }

  /**
   * @see
   *     org.opencms.ade.containerpage.client.ui.I_CmsDropContainer#onConsumeChildren(java.util.List)
   */
  ...
  /**
   * @see
   *     org.opencms.gwt.client.dnd.I_CmsDropTarget#onDrop(org.opencms.gwt.client.dnd.I_CmsDraggable)
   */
  ...
  /**
   * Refreshes position and dimension of the highlighting border. Call when anything changed during
   * the drag process.
   *
   * <p>
   */
  ...
  /**
   * @see
   *     org.opencms.ade.containerpage.client.ui.I_CmsDropContainer#refreshHighlighting(org.opencms.gwt.client.util.CmsPositionBean)
   */
  ...
  /**
   * @see
   *     org.opencms.ade.containerpage.client.ui.I_CmsDropContainer#setPlaceholderVisibility(boolean)
   */
  ...
  /**
   * Updates the element position cache during drag and drop.
   *
   * <p>
   */
