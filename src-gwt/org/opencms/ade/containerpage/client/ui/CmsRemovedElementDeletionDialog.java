...
/**
 * Dialog for asking the user whether elements which were removed from the container page should be
 * deleted.
 *
 * <p>
 */
public class CmsRemovedElementDeletionDialog extends CmsPopup {
  ...
  public static class Messages {
    ...
    public static String messageCancel() {
      ...
      return org.opencms.ade.containerpage.client.Messages.get()
          .key(org.opencms.ade.containerpage.client.Messages.GUI_KEEP_ELEMENT_0);
    }
    ...
    public static String messageMainText() {
      ...
      return org.opencms.ade.containerpage.client.Messages.get()
          .key(org.opencms.ade.containerpage.client.Messages.GUI_ASK_DELETE_REMOVED_ELEMENT_0);
    }
    ...
    public static String messageOk() {
      ...
      return org.opencms.gwt.client.Messages.get()
          .key(org.opencms.gwt.client.Messages.GUI_DELETE_0);
    }
  ...
  /**
   * UiBinder interface for this dialog.
   *
   * <p>
   */
  ...
  @UiField protected Panel m_infoBoxContainer;
  ...
  protected void onClickOk(ClickEvent e) {
    ...
    CmsRpcAction<Void> deleteAction =
  ...
  /**
   * Gets a list of the dialog buttons.
   *
   * <p>
   *
