...
public class CmsConfirmRemoveWidget extends Composite {
  ...
  public CmsConfirmRemoveWidget(
      CmsListInfoBean elementInfo, boolean canDelete, AsyncCallback<Boolean> removeCallback) {
