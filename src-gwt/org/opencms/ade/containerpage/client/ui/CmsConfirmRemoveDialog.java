...
public class CmsConfirmRemoveDialog extends CmsPopup {
   ...
   * @param removeCallback the callback which should be called when the user has confirmed or
   *     cancelled the element removal
   */
  ...
  /**
   * @see
   *     org.opencms.gwt.client.ui.CmsPopup#onPreviewNativeEvent(com.google.gwt.user.client.Event.NativePreviewEvent)
   */
  @Override
