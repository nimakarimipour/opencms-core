...
public interface I_CmsDropContainer extends I_CmsNestedDropTarget {
  ...
  /**
   * Adopts a container-page element registering it as a child of this container. Used for elements
   * that are already child nodes of the container-element node in DOM.
   *
   * <p>
   *
  ...
  /**
   * Inserts a child widget before the specified index. If the widget is already a child of this
   * panel, it will be moved to the specified index.
   *
   * <p>
   *
  ...
  /**
   * Returns <code>true</code> if this container is a detail view only container.
   *
   * <p>
   *
  ...
  /**
   * Returns <code>true</code> if this container is being currently used to display a detail view.
   *
   * <p>
   *
  ...
  /**
   * This is called when the elements of this container/group have been processed into
   * CmsContainerPageElementPanels.
   *
   * <p>
   *
