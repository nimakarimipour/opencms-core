...
public class CmsClientVariantFrame extends Composite {
  ...
  private static I_CmsClientVariantFrameUiBinder uiBinder =
      GWT.create(I_CmsClientVariantFrameUiBinder.class);

  /** The iframe for the template variant. */
  protected Frame m_iframe;

  /** The iframe container. */
  @UiField protected Panel m_iframeContainer;

  /** Placeholder widget which is displayed until the iframe is loaded. */
  @UiField protected Widget m_iframePlaceholder;
        ...
        new LoadHandler() {
          ...
          public void onLoad(LoadEvent event) {
            ...
            m_iframe
                .getElement()
                .getStyle()
                .setVisibility(com.google.gwt.dom.client.Style.Visibility.VISIBLE);
            ...
            // increase the screen width by the measured scroll bar width to simulate the configured
            // width
