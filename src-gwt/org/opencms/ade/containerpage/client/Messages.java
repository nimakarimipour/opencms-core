...
public final class Messages {
  ...
  /** Message constant for key in the resource bundle. */
  public static final String ERR_LOCK_TITLE_RESOURCE_CHANGED_0 =
      "ERR_LOCK_TITLE_RESOURCE_CHANGED_0";

  /** Message constant for key in the resource bundle. */
  public static final String ERR_LOCK_TITLE_RESOURCE_LOCKED_0 = "ERR_LOCK_TITLE_RESOURCE_LOCKED_0";

  /** Message constant for key in the resource bundle. */
  public static final String ERR_READING_CONTAINER_PAGE_DATA_0 =
      "ERR_READING_CONTAINER_PAGE_DATA_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_ADDINFO_FORMATTER_CONTAINER_0 =
      "GUI_ADDINFO_FORMATTER_CONTAINER_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_NO_FORMATTER_4 = "GUI_NO_FORMATTER_4";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_ADDINFO_FORMATTER_CONTAINER_TYPE_0 =
      "GUI_ADDINFO_FORMATTER_CONTAINER_TYPE_0";
  ...
  /** Message constant for key in the resource bundle. */
  public static final String GUI_ASK_DELETE_REMOVED_ELEMENT_TITLE_0 =
      "GUI_ASK_DELETE_REMOVED_ELEMENT_TITLE_0";
  ...
  /** Message constant for key in the resource bundle. */
  public static final String GUI_CLIPBOARD_ITEM_CAN_NOT_BE_EDITED_0 =
      "GUI_CLIPBOARD_ITEM_CAN_NOT_BE_EDITED_0";
  ...
  /** Message constant for key in the resource bundle. */
  public static final String GUI_CONFIRM_REMOVAL_DELETE_CHECKBOX_0 =
      "GUI_CONFIRM_REMOVAL_DELETE_CHECKBOX_0";
  ...
  /** Message constant for key in the resource bundle. */
  public static final String GUI_EDIT_HANDLER_SELECT_DELETE_OPTION_0 =
      "GUI_EDIT_HANDLER_SELECT_DELETE_OPTION_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_EDIT_HANDLER_SELECT_EDIT_OPTION_0 =
      "GUI_EDIT_HANDLER_SELECT_EDIT_OPTION_0";
  ...
  /** Message constant for key in the resource bundle. */
  public static final String GUI_GROUPCONTAINER_LABEL_DESCRIPTION_0 =
      "GUI_GROUPCONTAINER_LABEL_DESCRIPTION_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_GROUPCONTAINER_LABEL_TITLE_0 = "GUI_GROUPCONTAINER_LABEL_TITLE_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_GROUPCONTAINER_LOADING_DATA_0 =
      "GUI_GROUPCONTAINER_LOADING_DATA_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_INHERITANCECONTAINER_CAPTION_0 =
      "GUI_INHERITANCECONTAINER_CAPTION_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_INHERITANCECONTAINER_CONFIG_NAME_0 =
      "GUI_INHERITANCECONTAINER_CONFIG_NAME_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_INHERITANCECONTAINER_HIDE_ELEMENTS_0 =
      "GUI_INHERITANCECONTAINER_HIDE_ELEMENTS_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_INHERITANCECONTAINER_NO_HIDDEN_ELEMENTS_0 =
      "GUI_INHERITANCECONTAINER_NO_HIDDEN_ELEMENTS_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_INHERITANCECONTAINER_SHOW_HIDDEN_0 =
      "GUI_INHERITANCECONTAINER_SHOW_HIDDEN_0";
  ...
  /** Message constant for key in the resource bundle. */
  public static final String GUI_MODEL_GROUP_OPTION_DISABLED_0 =
      "GUI_MODEL_GROUP_OPTION_DISABLED_0";
  ...
  /** Message constant for key in the resource bundle. */
  public static final String GUI_NOTIFICATION_ADD_TO_FAVORITES_0 =
      "GUI_NOTIFICATION_ADD_TO_FAVORITES_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_NOTIFICATION_FAVORITES_SAVED_0 =
      "GUI_NOTIFICATION_FAVORITES_SAVED_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_NOTIFICATION_GROUP_CONTAINER_SAVED_0 =
      "GUI_NOTIFICATION_GROUP_CONTAINER_SAVED_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_NOTIFICATION_INHERITANCE_CONTAINER_SAVED_0 =
  ...
  /** Message constant for key in the resource bundle. */
  public static final String GUI_NOTIFICATION_UNABLE_TO_LOCK_0 =
      "GUI_NOTIFICATION_UNABLE_TO_LOCK_0";
  ...
  /** Message constant for key in the resource bundle. */
  public static final String GUI_SELECT_COPY_OR_REUSE_CAPTION_0 =
      "GUI_SELECT_COPY_OR_REUSE_CAPTION_0";
  ...
  /** Message constant for key in the resource bundle. */
  public static final String GUI_SWITCH_ELEMENT_VIEW_NOTIFICATION_1 =
      "GUI_SWITCH_ELEMENT_VIEW_NOTIFICATION_1";
  ...
  /** Message constant for key in the resource bundle. */
  public static final String GUI_TEMPLATE_CONTEXT_NO_VARIANT_0 =
