...
public class CmsPublishDataModel {
  ...
  public static class HasProblems implements I_CmsPublishResourceCheck {
    ...
    /**
     * @see
     *     org.opencms.ade.publish.client.CmsPublishDataModel.I_CmsPublishResourceCheck#check(org.opencms.ade.publish.shared.CmsPublishResource)
     */
   ...
   */
  public CmsPublishDataModel(
      List<CmsPublishGroup> publishGroups, I_CmsPublishItemStatusUpdateHandler handler) {
    ...
    for (CmsPublishGroup group : publishGroups) {
      ...
      for (CmsPublishResource res : group.getResources()) {
        CmsPublishItemStatus status =
            new CmsPublishItemStatus(res.getId(), State.normal, hasProblems(res), handler);
   ...
   */
  public int countResourcesInGroup(
      I_CmsPublishResourceCheck check, List<CmsPublishResource> group) {
  ...
  /**
   * Executes the action defined for selection changes.
   *
   * <p>
   */
