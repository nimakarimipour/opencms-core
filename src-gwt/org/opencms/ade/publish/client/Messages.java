...
public final class Messages {
  ...
  public static final String ERR_CANT_PUBLISH_RESOURCE_TITLE_0 =
      "ERR_CANT_PUBLISH_RESOURCE_TITLE_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_BROKEN_LINK_SHOW_IN_EXPLORER_0 =
      "GUI_BROKEN_LINK_SHOW_IN_EXPLORER_0";

  /** Message constant for key in the resource bundle. */
  public static final String ERR_PUBLISH_CANT_PUBLISH_DELETED_RESOURCE_2 =
      "ERR_PUBLISH_CANT_PUBLISH_DELETED_RESOURCE_2";

  /** Message constant for key in the resource bundle. */
  public static final String ERR_PUBLISH_CANT_PUBLISH_NEW_RESOURCE_2 =
      "ERR_PUBLISH_CANT_PUBLISH_NEW_RESOURCE_2";
  ...
  /** Message constant for key in the resource bundle. */
  public static final String GUI_CHECKBOX_ADD_CONTENT_SINGULAR_0 =
      "GUI_CHECKBOX_ADD_CONTENT_SINGULAR_0";
  /** Message constant for key in the resource bundle. */
  ...
  /** Message constant for key in the resource bundle. */
  public static final String GUI_CONFIRMATION_WORKPLACE_BUTTON_0 =
      "GUI_CONFIRMATION_WORKPLACE_BUTTON_0";
  ...
  /** Message constant for key in the resource bundle. */
  public static final String GUI_PUBLISH_CHECKBOXES_PROBLEMS_0 =
  ...
  /** Message constant for key in the resource bundle. */
  public static final String GUI_PUBLISH_CHECKBOXES_SIBLINGS_0 =
      "GUI_PUBLISH_CHECKBOXES_SIBLINGS_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_PUBLISH_DIALOG_BACK_0 = "GUI_PUBLISH_DIALOG_BACK_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_PUBLISH_DIALOG_BROKEN_LINKS_0 =
      "GUI_PUBLISH_DIALOG_BROKEN_LINKS_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_PUBLISH_DIALOG_CANCEL_BUTTON_0 =
  ...
  /** Message constant for key in the resource bundle. */
  public static final String GUI_PUBLISH_TOP_PANEL_ALL_BUTTON_0 =
      "GUI_PUBLISH_TOP_PANEL_ALL_BUTTON_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_PUBLISH_TOP_PANEL_LEFT_LABEL_0 =
      "GUI_PUBLISH_TOP_PANEL_LEFT_LABEL_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_PUBLISH_TOP_PANEL_NONE_BUTTON_0 =
      "GUI_PUBLISH_TOP_PANEL_NONE_BUTTON_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_PUBLISH_TOP_PANEL_RIGHT_LABEL_0 =
      "GUI_PUBLISH_TOP_PANEL_RIGHT_LABEL_0";
