...
/**
 * Client-side implementation for the ExternalLayout addon. A simple, single-component panel that
 * renders the contained component in the given element.
 *
 * <p>
 *
...
public class CmsExternalLayout extends SimplePanel {
  ...
  /** This is overridden so that {@link #setWidget(Widget)} uses the specified external element. */
  @Override
