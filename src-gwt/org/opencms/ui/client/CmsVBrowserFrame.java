...
/**
 * Extension of the standard browser frame widget which supports setting the name correctly in
 * Chrome.
 *
 * <p>The difference from the standard implementation is that here the name attribute is set on the
 * iframe element before it is inserted into the DOM, which is necessary in Chrome because setting
 * this attribute in Chrome does not change the corresponding frame window object's 'name' attribute
