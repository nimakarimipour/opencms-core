...
public class CmsContextMenuItemWidget extends FocusWidget {
  ...
  /**
   * Removes all the items from the submenu of this item. If this menu item does not have a sub
   * menu, this call has no effect.
   *
   * <p>
   */
   ...
   * @return <code>true</code> if given event targets the overlay of this menu item or overlay of
   *     any of this item's child item.
   */
