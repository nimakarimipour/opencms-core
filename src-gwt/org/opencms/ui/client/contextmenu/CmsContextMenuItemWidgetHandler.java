...
/**
 * ContextMenuItemWidgetHandler is context menu item specific object that handles the server
 * communication when item is interacted with.
 *
 * <p>Adapted from ContextMenu by Peter Lehto / Vaadin Ltd.
 *
 * <p>
 */
public class CmsContextMenuItemWidgetHandler
    implements ClickHandler, MouseOverHandler, MouseOutHandler, KeyUpHandler {

  /** The menu RPC. */
  private I_CmsContextMenuServerRpc m_contextMenuRpc;

  /** The menu timer. */
  private final Timer m_openTimer =
      new Timer() {
   ...
   */
  public CmsContextMenuItemWidgetHandler(
      CmsContextMenuItemWidget widget, ServerConnector connector) {
