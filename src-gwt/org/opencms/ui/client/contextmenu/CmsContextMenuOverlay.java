...
/**
 * Menu is a visible item of ContextMenu component. For every child menu new instance of Menu class
...
class CmsContextMenuOverlay extends VOverlay {
  ...
  /**
   * Returns whether the sub menu is open.
   *
   * <p>
   *
  ...
  /**
   * Opens next to the given parent item.
   *
   * <p>
   *
  ...
  /**
   * @see
   *     com.google.gwt.user.client.ui.PopupPanel#setPopupPositionAndShow(com.google.gwt.user.client.ui.PopupPanel.PositionCallback)
   */
  @Override
  ...
  /**
   * Shows the overlay at the given position.
   *
   * <p>
   *
    ...
    setPopupPositionAndShow(
        new PopupPanel.PositionCallback() {
          ...
          public void setPosition(int offsetWidth, int offsetHeight) {
            ...
            int exceedingWidth =
                (offsetWidth + left) - (Window.getClientWidth() + Window.getScrollLeft());
            if (exceedingWidth > 0) {
              left -= exceedingWidth;
              if (left < 0) {
                left = 0;
            ...
            int exceedingHeight =
                (offsetHeight + top) - (Window.getClientHeight() + Window.getScrollTop());
  ...
  /**
   * Returns whether the given event targets the popup.
   *
   * <p>
   *
  ...
  /**
   * Removes the focus from all items.
   *
   * <p>
   */
  void unfocusAll() {
  ...
  /**
   * Measures the width of a context menu item.
   *
   * <p>
   *
