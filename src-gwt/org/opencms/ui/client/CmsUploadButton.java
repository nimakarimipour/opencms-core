...
public class CmsUploadButton extends VButton implements I_CmsUploadButton, HasWidgets {
  ...
  public CmsFileInput createFileInput() {
    ...
    m_inputChangeHandlerRegistration =
  ...
  /**
   * @see
   *     org.opencms.gwt.client.ui.input.upload.I_CmsUploadButton#reinitButton(org.opencms.gwt.client.ui.input.upload.I_CmsUploadButtonHandler)
   */
