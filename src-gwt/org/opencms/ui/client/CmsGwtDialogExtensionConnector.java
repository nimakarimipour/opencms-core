...
public class CmsGwtDialogExtensionConnector extends AbstractExtensionConnector
    implements I_CmsGwtDialogClientRpc {
  ...
  public void editPointer(String pointerStructureId) {
    ...
    CmsEditExternalLinkDialog dialog =
        CmsEditExternalLinkDialog.loadAndShowDialog(new CmsUUID(pointerStructureId));
    dialog.setContextMenuHandler(
        new I_CmsContextMenuHandler() {

          public void ensureLockOnResource(
              CmsUUID lockStructureId, I_CmsSimpleCallback<Boolean> callback) {
  ...
  /**
   * @see
   *     org.opencms.ui.shared.components.I_CmsGwtDialogClientRpc#openCategoriesDialog(java.lang.String,
   *     boolean)
   */
  ...
  /**
   * @see
   *     org.opencms.ui.shared.components.I_CmsGwtDialogClientRpc#openContentEditor(java.lang.String,
   *     java.lang.String)
   */
  ...
  /**
   * @see
   *     org.opencms.ui.shared.components.I_CmsGwtDialogClientRpc#openGalleryDialog(java.lang.String)
   */
  public void openGalleryDialog(String galleryConfiguration) {

    CmsGalleryPopup popup =
        new CmsGalleryPopup(
            null, CmsGalleryConfigurationJSO.parseConfiguration(galleryConfiguration));
  ...
  /**
   * @see
   *     org.opencms.ui.shared.components.I_CmsGwtDialogClientRpc#openPublishDialog(java.lang.String)
   */
  public void openPublishDialog(String serializedPublishData) {
    ...
    try {
      ...
      CmsPublishData initData =
          (CmsPublishData)
              CmsRpcPrefetcher.getSerializedObjectFromString(publishService, serializedPublishData);
      Runnable menuRefreshAction =
          new Runnable() {
  ...
  /**
   * @see
   *     org.opencms.ui.shared.components.I_CmsGwtDialogClientRpc#openReplaceDialog(java.lang.String)
   */
  ...
  /**
   * @see org.opencms.ui.shared.components.I_CmsGwtDialogClientRpc#showPreview(java.lang.String,
   *     java.lang.String)
   */
        ...
        new CmsRpcAction<CmsPreviewInfo>() {
          ...
          public void execute() {
            ...
            CmsCoreProvider.getVfsService()
                .getHistoryPreviewInfo(id, CmsCoreProvider.get().getLocale(), version, this);
          }
