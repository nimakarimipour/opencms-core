...
/**
 * Connector between {@link org.opencms.ui.components.CmsExternalLayout} and {@link
 * CmsExternalLayout}.
 *
 * <p>
 *
...
public class CmsExternalLayoutConnector extends AbstractHasComponentsConnector {
  ...
  /**
   * @see
   *     com.vaadin.client.ConnectorHierarchyChangeEvent.ConnectorHierarchyChangeHandler#onConnectorHierarchyChange(com.vaadin.client.ConnectorHierarchyChangeEvent)
   */
  @Override
  ...
  /**
   * @see
   *     com.vaadin.client.HasComponentsConnector#updateCaption(com.vaadin.client.ComponentConnector)
   */
  @Override
