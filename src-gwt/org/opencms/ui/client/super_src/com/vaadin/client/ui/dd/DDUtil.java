...
/**
 * Overriding default vaadin drag and drop behavior.
 *
 * <p>In case a marker CSS class 'o-simple-drag' is set, the drag and drop over item highlighting
 * will be changed from top, middle, bottom variants to middle only.
 *
 * <p>
 */
public class DDUtil {
  ...
  /**
   * Unchanged from the original class.
   *
   * <p>
   */
  ...
  public static VerticalDropLocation getVerticalDropLocation(
      Element element, NativeEvent event, double topBottomRatio) {
  ...
  public static VerticalDropLocation getVerticalDropLocation(
      Element element, int offsetHeight, NativeEvent event, double topBottomRatio) {
  ...
  public static VerticalDropLocation getVerticalDropLocation(
      Element element, int offsetHeight, int clientY, double topBottomRatio) {

    if (isSimpleMode(element)) {
      return VerticalDropLocation.MIDDLE;
    } else {
      return internalGetVerticalDropLocation(element, offsetHeight, clientY, topBottomRatio);
    }
  }

  private static VerticalDropLocation internalGetVerticalDropLocation(
      Element element, int offsetHeight, NativeEvent event, double topBottomRatio) {
  ...
  /**
   * Matches the original getVerticalDropLocation(Element, int, int, double) method.
   *
   * <p>
   */
  private static VerticalDropLocation internalGetVerticalDropLocation(
  ...
  /**
   * Checks if the simple mode should be applied.
   *
   * <p>
   */
