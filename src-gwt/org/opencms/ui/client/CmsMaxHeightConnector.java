...
public class CmsMaxHeightConnector extends AbstractExtensionConnector {
  ...
  protected void handleMutation() {
    ...
    if (m_currentHeight > 0) {
      removeObserver(); // prevent 'recursive' call of handleMutation (it's not actually recursive
                        // since it's async, but would still lead to an infinite number of calls)
  ...
  /**
   * Adds a native mutation observer to the widget element.
   *
   * <p>
   *
  ...
  /**
   * Restores saved scroll positions of scrollable containers.
   *
   * <p>
   *
  ...
  /**
   * Creates a list of pairs of v-scrollable elements and their respective scrollTop attribute
   * beneath the given DOM element.
   *
   * <p>
   *
