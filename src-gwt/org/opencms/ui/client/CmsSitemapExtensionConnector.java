...
public class CmsSitemapExtensionConnector extends AbstractExtensionConnector
    implements I_CmsSitemapClientRpc {
  ...
  /**
   * @see org.opencms.ui.shared.rpc.I_CmsSitemapClientRpc#finishPageCopyDialog(java.lang.String,
   *     java.lang.String)
   */
  ...
  /**
   * Installs the native JavaScript functions used to access Vaadin functionality from the sitemap
   * editor's GWT module.
   *
   * <p>
   */
  ...
  /**
   * @see org.opencms.ui.shared.rpc.I_CmsSitemapClientRpc#openPropertyDialog(java.lang.String,
   *     java.lang.String)
   */
  public void openPropertyDialog(String structureIdStr, String rootIdStr) {

    CmsJsUtil.callNamedFunctionWithString2(
        CmsGwtConstants.LOCALECOMPARE_EDIT_PROPERTIES, structureIdStr, rootIdStr);
  }

  /**
   * @see org.opencms.ui.shared.rpc.I_CmsSitemapClientRpc#showInfoHeader(java.lang.String,
  ...
  protected void extend(ServerConnector target) {
    ...
    CmsScriptCallbackHelper callbackHelper =
    ...
    CmsScriptCallbackHelper propertySaveHelper =
        new CmsScriptCallbackHelper() {
