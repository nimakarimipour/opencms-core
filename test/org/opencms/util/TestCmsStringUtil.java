...
public class TestCmsStringUtil extends OpenCmsTestCase {
  ...
  public void testFormatResourceName() {
    ...
    assertEquals(
        "/myfolder/.../subsubfolder/index.html", CmsStringUtil.formatResourceName(test, 40));
    ...
    assertEquals(
        "/demopages/search-demo/example-documents/", CmsStringUtil.formatResourceName(test, 41));
  }
  ...
  public void testGetCommonPrefixPath() {
    ...
    assertEquals("/foo", CmsStringUtil.getCommonPrefixPath("/foo/bar/", "/foo/baz/"));
    assertEquals(
        "/foo/bar", CmsStringUtil.getCommonPrefixPath("/foo/bar/baz/qux", "/foo/bar/xyzzy/narf"));
    assertEquals("/foo/bar", CmsStringUtil.getCommonPrefixPath("/foo/bar/baz/qux", "/foo/bar/"));
    assertEquals(
        "/foo/bar",
        CmsStringUtil.getCommonPrefixPath("/foo/bar/baz/qux", "/foo/bar/xyzzy/narf/quop"));
  ...
  /**
   * Test case for join path method-
   *
   * <p>
   */
  public void testJoinPath() {
    ...
    assertEquals("/foo/bar/baz", CmsStringUtil.joinPaths("/foo/////////bar/", "/baz"));
    assertEquals(
        "/foo/bar/baz", CmsStringUtil.joinPaths("//////////foo/////////bar/////", "//////baz"));
  }

  /**
   * Test case for {@link CmsStringUtil#lastIndexOf(String, char[])} method.
   *
   * <p>
   */
  ...
  public void testRemovePrefixPath() {
    ...
    assertEquals(
        java.util.Optional.of("/bar"), CmsStringUtil.removePrefixPath("/foo/", "/foo/bar"));
    assertEquals(
        java.util.Optional.of("/bar"), CmsStringUtil.removePrefixPath("/foo/", "/foo/bar/"));
    assertEquals(
        java.util.Optional.of("/bar"), CmsStringUtil.removePrefixPath("/foo", "/foo/bar/"));
  ...
  /**
   * Tests <code>{@link CmsStringUtil#replacePrefix(String, String, String, boolean)}</code>.
   *
   * <p>
   */
  ...
  /**
   * Tests <code>{@link CmsStringUtil#splitAsArray(String, char)}</code>.
   *
   * <p>
   */
  ...
  /**
   * Tests <code>{@link CmsStringUtil#splitAsArray(String, String)}</code>.
   *
   * <p>
   */
  public void testSplitStringDelimiter() {
    ...
    toSplit =
        "/delim//delim fake at start/delim//not a delim//delim//delim//delim fake at end/delim/";
    arrayResult = CmsStringUtil.splitAsArray(toSplit, delimString);
    assertEquals(4, arrayResult.length);
    assertEquals("/delim fake at start", arrayResult[0]);
    assertEquals("/not a delim/", arrayResult[1]);
  ...
  public void testSubstitute() {
    ...
    content =
        "/delim//delim fake at start/delim//not a delim//delim//delim//delim fake at end/delim/";
    result =
        "REPLACED!/delim fake at startREPLACED!/not a delim/REPLACED!REPLACED!/delim fake at endREPLACED!";
  ...
  /**
   * Test case for {@link CmsStringUtil#trimToSize(String, int)} method.
   *
   * <p>
   */
  ...
  /**
   * Test case for {@link CmsStringUtil#trimToSize(String, int, int, String)}.
   *
   * <p>
   */
