...
public class TestCmsFileUtil extends OpenCmsTestCase {
  ...
  /**
   * An input stream that provides 24 bytes of data in two chunks, the first of 16 bytes, the second
   * of 8 bytes.
   *
   * <p>This simulates the behavior of calls to <code>available()</code> and <code>read()</code> on
   * buffered file or zip input streams, where the size of the underlying data slightly exceeds the
   * size of the stream's internal buffers.
   *
   * <p>
   */
  private static class TestInputStream extends InputStream {
    ...
    /**
     * Input stream implementation that exploits an error with {@link
    ...
    /**
     * Returns <code>true</code> if this stream was closed.
     *
     * <p>
     *
  ...
  /**
   * Test the behavior of {@link CmsFileUtil#readFully(InputStream)} when the read takes more than
