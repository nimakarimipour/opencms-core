...
/**
 * Test cases for the class <code>{@link org.opencms.util.CmsXmlSaxWriter}</code>.
 *
 * <p>
 *
 * @since 6.0.0
...
public class TestCmsXmlSaxWriter extends OpenCmsTestCase {
  ...
  private static final String TEXT_3 =
      " This is a text containing international chars like \u00e4\u00f6\u00fc\u00c4\u00d6\u00dc\u00df\u20ac ";

  private static final String TEXT_3_ESC =
      " This is a text containing international chars like &#228;&#246;&#252;&#196;&#214;&#220;&#223;&#8364; ";

  private static final String TEXT_4 =
      " This is a text with \u00e4\u00f6\u00fc\u00c4\u00d6\u00dc\u00df\u20ac as well as <> and & ";

  private static final String TEXT_4_ESC =
      " This is a text with &#228;&#246;&#252;&#196;&#214;&#220;&#223;&#8364; as well as &lt;&gt; and &amp; ";
  ...
  /**
   * Test HTML escaping in XML using the <code>{@link org.opencms.util.CmsXmlSaxWriter}</code>.
   *
   * <p>
   *
  ...
  /**
   * Test if disabling escaping in <code>{@link org.opencms.util.CmsXmlSaxWriter}</code> causes
   * expected issues.
   *
   * <p>
   *
  ...
  public void testWithoutEntityEscaping() throws Exception {
    ...
    if (error != null) {
      assertSame(
          org.opencms.xml.Messages.ERR_UNMARSHALLING_XML_DOC_1,
          error.getMessageContainer().getKey());
    }
  }

  /**
   * Test round-trip generation of an XML using the <code>{@link org.opencms.util.CmsXmlSaxWriter}
   * </code>.
   *
   * <p>
   *
  ...
  public void testXmlRoundtrip() throws Exception {
    ...
    CmsXmlSaxWriter saxHandler =
        new CmsXmlSaxWriter(new StringWriter(4096), CmsEncoder.ENCODING_ISO_8859_1);
    saxHandler.setEscapeXml(true);
    saxHandler.setEscapeUnknownChars(false);
    SAXWriter writer = new SAXWriter(saxHandler, saxHandler);
  ...
  /**
   * Asserts all values in the given focument match.
   *
   * <p>
   *
