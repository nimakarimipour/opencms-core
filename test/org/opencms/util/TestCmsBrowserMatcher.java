...
public class TestCmsBrowserMatcher extends OpenCmsTestCase {
  ...
  /**
   * Tests the browser matching regular expressions.
   *
   * <p>
   */
  ...
  public void testRegex() {
    ...
    String source =
        "addMenuEntry(resource_id, \"language_key(explorer.context.copy)\", \"/WORKPLACE/copy.html?initial=true\", \"''\", \"rules_key(d d aaai aaai dddd dddd dddd)\");";
    String target =
        "addMenuEntry(resource_id, \"language_key(explorer.context.copy)\", \"/system/workplace/jsp/copy.html?initial=true\", \"''\", \"rules_key(d d aaai aaai dddd dddd dddd)\");";
