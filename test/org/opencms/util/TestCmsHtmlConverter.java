...
public class TestCmsHtmlConverter extends OpenCmsTestCase {
  ...
  private static final String SIMPLE_HTML =
      "<h1>Test</h1><div><p>This is a test<p>some content<p>last line</div><pre>Some pre<br>\r\n   More pre\r\n</pre>Final line.";
  // some test Strings
  private static final String STRING_1 = "Test: &#228;&#246;&#252;&#196;&#214;&#220;&#223;";
  private static final String STRING_1_UTF8_RESULT =
      "Test: \u00e4\u00f6\u00fc\u00c4\u00d6\u00dc\u00df";
  private static final String STRING_2 = "Test: &#228;&#246;&#252;&#196;&#214;&#220;&#223;&#8364;";

  private static final String STRING_2_UTF8_RESULT =
      "Test: \u00e4\u00f6\u00fc\u00c4\u00d6\u00dc\u00df\u20ac";
  ...
  /**
   * Tests an issue with white space insertion after href tags.
   *
   * <p>Tidy sometimes inserts unwanted, visible whitespace in a href tag because of the formatting
   * used.
   *
   * <p>
   *
  ...
  public void testHrefWhitespaceIssue() throws Exception {
    ...
    CmsHtmlConverter converter =
        new CmsHtmlConverter(CmsEncoder.ENCODING_UTF_8, CmsHtmlConverter.PARAM_XHTML);
    String input =
        CmsFileUtil.readFile(
            "org/opencms/util/testConverter_03.html", CmsEncoder.ENCODING_ISO_8859_1);
  ...
  /**
   * Tests conversion of ISO-encoded entities.
   *
   * <p>
   *
   * @throws Exception in case the test fails
  ...
  public void testISO() throws Exception {
    ...
    CmsHtmlConverter converter =
        new CmsHtmlConverter(CmsEncoder.ENCODING_US_ASCII, CmsHtmlConverter.PARAM_WORD);
  ...
  public void testPrettyPrint() throws Exception {
    ...
    CmsHtmlConverter converter =
        new CmsHtmlConverter(CmsEncoder.ENCODING_ISO_8859_1, CmsHtmlConverter.PARAM_ENABLED);
  ...
  /**
   * Tests conversion of UTF8-encoded entities.
   *
   * <p>
   *
   * @throws Exception in case the test fails
  ...
  public void testUTF8() throws Exception {
    ...
    CmsHtmlConverter converter =
        new CmsHtmlConverter(CmsEncoder.ENCODING_UTF_8, CmsHtmlConverter.PARAM_WORD);
    String convertedHtml1 = converter.convertToString(STRING_1);
    String convertedHtml2 = converter.convertToString(STRING_2);
