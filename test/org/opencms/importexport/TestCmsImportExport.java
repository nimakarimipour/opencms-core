...
/**
 * Comment for <code>TestCmsImportExport</code>.
 *
 * <p>
 */
...
public class TestCmsImportExport extends OpenCmsTestCase {
  ...
  /**
   * Creates a temporary file for module exports.
   *
   * <p>
   *
  ...
  /**
   * Tests the import of a resource that has been edited.
   *
   * <p>
   *
  ...
  public void testImportChangedContent() throws Exception {
    ...
    String zipExportFilename =
        OpenCms.getSystemInfo()
            .getAbsoluteRfsPathRelativeToWebInf("packages/testImportChangedContent.zip");
    ...
    try {
      ...
      OpenCms.getImportExportManager()
          .exportData(
              cms, vfsExportHandler, new CmsShellReport(cms.getRequestContext().getLocale()));
      ...
      assertFilter(
          cms, cms.readResource(filename1), OpenCmsTestResourceFilter.FILTER_REPLACERESOURCE);
  ...
  /**
   * Tests the import of a resource overwriting a sibling with different type.
   *
   * <p>
   *
   * @throws Exception if something goes wrong
  ...
  public void testImportContentIssue() throws Exception {
    ...
    String zipExportFilename =
        OpenCms.getSystemInfo()
            .getAbsoluteRfsPathRelativeToWebInf("packages/testImportContentIssue.zip");
    ...
    try {
      ...
      OpenCms.getPublishManager()
          .publishResource(
              cms, sibname, true, new CmsShellReport(cms.getRequestContext().getLocale()));
      OpenCms.getPublishManager().waitWhileRunning();
      ...
      cms.createResource(
          filename, CmsResourceTypePlain.getStaticTypeId(), "hello txt".getBytes(), null);
      ...
      OpenCms.getPublishManager()
          .publishResource(
              cms, filename, true, new CmsShellReport(cms.getRequestContext().getLocale()));
      OpenCms.getPublishManager().waitWhileRunning();
      ...
      OpenCmsTestResourceConfigurableFilter filter =
          new OpenCmsTestResourceConfigurableFilter(OpenCmsTestResourceFilter.FILTER_EQUAL);
      filter.disableSiblingCountTest();
      assertFilter(cms, cms.readResource(sibname), filter);
      filter =
          new OpenCmsTestResourceConfigurableFilter(OpenCmsTestResourceFilter.FILTER_IMPORTEXPORT);
      filter.disableSiblingCountTest();
  ...
  /**
   * Tests the import of linked XmlPages in a different site, so that the link paths get broken.
   *
   * <p>
   *
   * @throws Exception if something goes wrong
  ...
  public void testImportExportBrokenLinksHtml() throws Exception {
    ...
    echo(
        "Testing the import of linked XmlPages in a different site, so that the link paths get broken.");
    String filename1 = "xmlpage1.html";
    String filename2 = "xmlpage2.html";
    String zipExportFilename =
        OpenCms.getSystemInfo()
            .getAbsoluteRfsPathRelativeToWebInf("packages/testImportExportBrokenLinks.zip");
    ...
    try {
      ...
      I_CmsResourceType type =
          OpenCms.getResourceManager().getResourceType(CmsResourceTypeXmlPage.getStaticTypeId());
  ...
  /**
   * Tests the import of linked XmlContent in a different site, so that the link paths get broken.
   *
   * <p>
   *
   * @throws Exception if something goes wrong
  ...
  public void testImportExportBrokenLinksXml() throws Exception {
    ...
    echo(
        "Testing the import of linked Xml Content in a different site, so that the link paths get broken.");
    ...
    xmlcontent2
        .getValue("Text", Locale.ENGLISH, 0)
        .setStringValue(cms, "<a href='" + filename1 + "'>test</a>");
    ...
    CmsXmlContent xmlcontent1 =
        CmsXmlContentFactory.unmarshal(content1, CmsEncoder.ENCODING_UTF_8, resolver);
    xmlcontent1
        .getValue("Text", Locale.ENGLISH, 0)
        .setStringValue(cms, "<a href='" + filename2 + "'>test</a>");
    ...
    vfsExportHandler.setExportParams(params);
    OpenCms.getImportExportManager()
        .exportData(cms, vfsExportHandler, new CmsShellReport(cms.getRequestContext().getLocale()));
    ...
    try {
      ...
      I_CmsResourceType type =
          OpenCms.getResourceManager().getResourceType(OpenCmsTestCase.ARTICLE_TYPEID);
      I_CmsLinkParseable validatable = (I_CmsLinkParseable) type;
  ...
  /**
   * Tests an overwriting import of VFS data.
   *
   * <p>
   *
   * @throws Exception if something goes wrong
  ...
  public void testImportExportFolder() throws Exception {
    ...
    String zipExportFilename =
        OpenCms.getSystemInfo()
            .getAbsoluteRfsPathRelativeToWebInf("packages/testImportExportFolder.zip");
  ...
  /**
   * Tests import with structure id.
   *
   * <p>
   *
   * @throws Exception if something goes wrong
  ...
  public void testImportExportId() throws Exception {
    ...
    String zipExportFilename =
        OpenCms.getSystemInfo()
            .getAbsoluteRfsPathRelativeToWebInf("packages/testImportExportId.zip");
  ...
  /**
   * Tests the import of a folder that has been moved.
   *
   * <p>
   *
   * @throws Exception if something goes wrong
  ...
  public void testImportMovedFolder() throws Exception {
    ...
    String zipExportFilename =
        OpenCms.getSystemInfo()
            .getAbsoluteRfsPathRelativeToWebInf("packages/testImportExportMovedFolder.zip");

    try {
      cms.getRequestContext().setSiteRoot("/");
      // create test file & folder
      CmsResource folderBefore =
  ...
  /**
   * Tests the import of a resource that has been moved.
   *
   * <p>
   *
   * @throws Exception if something goes wrong
  ...
  public void testImportMovedResource() throws Exception {
    ...
    String zipExportFilename =
        OpenCms.getSystemInfo()
            .getAbsoluteRfsPathRelativeToWebInf("packages/testImportExportMovedResource.zip");
  ...
  /**
   * Tests the import of a resource with permissions.
   *
   * <p>
   *
   * @throws Exception if something goes wrong
  ...
  public void testImportPermissionIssue() throws Exception {
    ...
    String zipExportFilename =
        OpenCms.getSystemInfo()
            .getAbsoluteRfsPathRelativeToWebInf("packages/testImportPermissionIssue.zip");
  ...
  /**
   * Tests the import of a resource that has been recreated.
   *
   * <p>
   *
   * @throws Exception if something goes wrong
  ...
  public void testImportRecreatedFile() throws Exception {
    ...
    String zipExportFilename =
        OpenCms.getSystemInfo()
            .getAbsoluteRfsPathRelativeToWebInf("packages/testImportRecreatedFile.zip");
  ...
  /**
   * Tests the import of a sibling that has been recreated.
   *
   * <p>
   *
   * @throws Exception if something goes wrong
  ...
  public void testImportRelations() throws Exception {
    ...
    String zipExportFilename =
        OpenCms.getSystemInfo()
            .getAbsoluteRfsPathRelativeToWebInf("packages/testImportRelations.zip");

    try {
      // first there are no relations
      assertTrue(
          cms.getRelationsForResource(
                  filename, CmsRelationFilter.TARGETS.filterNotDefinedInContent())
              .isEmpty());
      ...
      assertRelation(
          new CmsRelation(
              cms.readResource(filename), cms.readResource(cat.getId()), CmsRelationType.CATEGORY),
  ...
  /**
   * Tests the resource translation during import.
   *
   * <p>
   *
   * @throws Exception if something goes wrong
  ...
  public void testImportResourceTranslator() throws Exception {
    ...
    // import the files
    String importFile =
        OpenCms.getSystemInfo().getAbsoluteRfsPathRelativeToWebInf("packages/testimport01.zip");
    OpenCms.getImportExportManager()
        .importData(
            cms,
            new CmsShellReport(cms.getRequestContext().getLocale()),
  ...
  /**
   * Tests the resource translation during import with multiple sites.
   *
   * <p>
   *
   * @throws Exception if something goes wrong
  ...
  public void testImportResourceTranslatorMultipleSite() throws Exception {
    ...
    // import the files
    String importFile =
        OpenCms.getSystemInfo().getAbsoluteRfsPathRelativeToWebInf("packages/testimport02.zip");
    OpenCms.getImportExportManager()
        .importData(
            cms,
            new CmsShellReport(cms.getRequestContext().getLocale()),
  ...
  public void testImportSibling() throws Exception {
    ...
    try {
      ...
      assertFilter(
          cms, cms.readResource(filename1), OpenCmsTestResourceFilter.FILTER_IMPORTEXPORT_SIBLING);
    } finally {
      try {
        if (zipExportFilename != null) {
          File file = new File(zipExportFilename);
  ...
  /**
   * Tests the import of a (non-existing) sibling of a file in a different site.
   *
   * <p>
   *
   * @throws Exception if something goes wrong
  ...
  public void testImportSiblingIssue() throws Exception {
    ...
    String zipExportFilename =
        OpenCms.getSystemInfo()
            .getAbsoluteRfsPathRelativeToWebInf("packages/testImportSiblingIssue.zip");
  ...
  /**
   * Tests the import xml validation.
   *
   * <p>
   *
   * @throws Exception if something goes wrong
  ...
  public void testImportValidation() throws Exception {
    ...
    String zipExportFilename =
        OpenCms.getSystemInfo()
            .getAbsoluteRfsPathRelativeToWebInf("packages/testImportValidation.zip");
    ...
    try {
      ...
      // re-import the exported files
      OpenCms.getImportExportManager()
          .importData(cms, new CmsShellReport(cms.getRequestContext().getLocale()), impar);
  ...
  /**
   * Tests the import of a resource in the wrong site.
   *
   * <p>
   *
   * @throws Exception if something goes wrong
  ...
  public void testImportWrongSite() throws Exception {
    ...
    String zipExportFilename =
        OpenCms.getSystemInfo()
            .getAbsoluteRfsPathRelativeToWebInf("packages/testImportWrongSite.zip");
    ...
    try {
      ...
      while (itPath.hasNext()) {
        ...
        assertTrue(
            "Path " + path + " does not exist as expected",
            cms.existsResource(path)); // the old file
        assertFalse(
            "Path " + newSite + path + " should not exist",
            cms.existsResource(newSite + path)); // the new file
      }
    } finally {
      try {
        if (zipExportFilename != null) {
  ...
  /**
   * Tests the import of resources during setup.
   *
   * <p>
   *
   * @throws Exception if something goes wrong
  ...
  /**
   * Compares imported and exported resources.
   *
   * <p>
   *
   ...
   */
  private void assertResources(CmsObject cms, String path, List<CmsResource> startResources)
      throws CmsException {
   ...
   *
   * <p>The timestamp is either the string representation of a long value (old export format) or a
