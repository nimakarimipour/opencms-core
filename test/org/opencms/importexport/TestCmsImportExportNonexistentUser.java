...
/**
 * Tests exporting/import VFS data with nonexistent users.
 *
 * <p>
 */
public class TestCmsImportExportNonexistentUser extends OpenCmsTestCase {
  ...
  /**
   * Tests exporting and import of VFS data with a nonexistent/deleted user.
   *
   * <p>The username of the deleted user should in the export manifest be replaced by the name of
   * the Admin user.
   *
   * <p>
   *
    ...
    try {
      ...
      zipExportFilename =
          OpenCms.getSystemInfo()
              .getAbsoluteRfsPathRelativeToWebInf("packages/testImportExportNonexistentUser.zip");
