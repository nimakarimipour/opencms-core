...
/**
 * Test cases for the parameter configuration.
 *
 * <p>
 */
public class TestParameterConfiguration extends OpenCmsTestCase {
  ...
  /**
   * Tests escaping and unescaping values in the parameter configuration.
   *
   * <p>
   *
  ...
  /**
   * Test merging the parameter configuration.
   *
   * <p>
   *
   * @throws Exception in case the test fails
  ...
  /**
   * Test reading the parameter configuration.
   *
   * <p>
   *
   * @throws Exception in case the test fails
