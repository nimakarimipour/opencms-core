...
/**
 * Unit test for the OpenCms scheduler in a running system.
 *
 * <p>
 */
public class TestCmsSchedulerInSystem extends OpenCmsTestCase {
  ...
  public void testDefaultConfiguration() throws Exception {
    ...
    System.out.println(
        "Trying to run a persistent OpenCms job 5x with the OpenCms system scheduler.");
  ...
  /**
   * Test case for accessing the {@link org.opencms.file.CmsObject} in a scheduled job.
   *
   * <p>
   *
   * @throws Exception if the test fails
  ...
  public void testAccessToCmsObject() throws Exception {
    ...
    System.out.println(
        "Trying to run an OpenCms job with access to the CmsObject the OpenCms system scheduler.");
