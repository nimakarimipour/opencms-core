...
public class TestCmsSetupBean extends OpenCmsTestCase {
  ...
  /**
   * Tests the method saveProperties.
   *
   * <p>
   *
  ...
  public void testSaveProperties() throws IOException {
    ...
    if (!bean.getErrors().isEmpty()) {
      ...
      assertTrue(
          "There shouldn't be any errors copying the properties files",
          !bean.getErrors().isEmpty());
    }
    ...
    if (!bean.getErrors().isEmpty()) {
      ...
      assertTrue(
          "There shouldn't be any errors saving the properties files", !bean.getErrors().isEmpty());
    }
