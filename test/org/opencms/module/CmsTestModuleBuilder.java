...
public class CmsTestModuleBuilder {
   ...
   * @throws CmsException
   */
  public CmsResource addAbsoluteFile(String type, String text, String path)
  ...
  /**
   * Instead of adding the module with the name passed in the constructor, add it with a different
   * name and explicitly set list of module resources. This is used to simulate modules like the
   * Apollo modules which have their resources under system/modules/org.opencms.apollo, which is not
   * a module resource itself.
   *
   * @param moduleName the real module name
   * @param moduleResources the module resource list
   * @throws CmsException if something goes wrong
   */
  public void addExplodedModule(String moduleName, List<String> moduleResources)
      throws CmsException {
  ...
  /**
   * Adds the module object to the module manager.
   *
   * <p>
   *
   * @throws CmsException if something goes wrong
  ...
  /**
   * Creates an explorer type for the module.
   *
   * <p>
   *
   * @param name the type name
  ...
  /**
   * Creates a resource type for the module.
   *
   * <p>
   *
   * @param name the name
  ...
  public void delete() throws CmsException {
    ...
    OpenCms.getModuleManager()
        .deleteModule(m_cms, m_module.getName(), false, new CmsShellReport(Locale.ENGLISH));
  }

  /**
   * Exports the module to the given file.
   *
   * <p>
   *
  ...
  /**
   * Sets the next structure id (if not set, it will be automatically generated).
   *
   * <p>
   *
   ...
   *
   * <p>If a resource id has been set, it will be returned and cleared, otherwise the resource id
   * will be generated from the parameter passed in.
   *
  ...
  /**
   * Gets the next structure id.
   *
   * <p>If a structure has been set, it will be returned and cleared, otherwise the structure id
   * will be generated from the parameter passed in.
   *
   * @param name the resource name
  ...
  private CmsResource importResource(
      String path, CmsResource resource, byte[] data, List<CmsProperty> props) throws CmsException {
