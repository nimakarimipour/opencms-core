...
public class TestCmsEncoder extends OpenCmsTestCase {
  ...
  private static final String STRING_5 =
      "&#228;&#246;&#252;&#8364;#|#12|&#12|&#;&#196;&#214;&#220;test";
  private static final String STRING_6 =
      "Test: \\u00e4\\u00f6\\u00fc\\u00c4\\u00d6\\u00dc\\u00df\\u20ac";
  ...
  /**
   * Tests wether two subsequent calls to <code>{@link CmsEncoder#escapeWBlanks(String, String)}
   * </code> lead to an expected result and ensures that the 2nd call does not do any further
   * modifications.
   *
   * <p>
   */
  ...
  /**
   * Encodes a single '%' and ensures that it is transformed. Encodes a sequence that is already an
   * encoded special character (e.g.: "%25") and ensures that this sequence is not encoded several
   * times.
   *
   * <p>
   */
  ...
  /**
   * Tests encoding of string lists as request parameters using base64 encoding.
   *
   * <p>
   */
  ...
  /**
   * Tests wether two subsequent calls to <code>{@link CmsEncoder#escapeWBlanks(String, String)}
   * </code> are undone by onde decode call (the 2nd encode call must not modify anything.
   *
   * <p>
   */
