...
public class TestCmsMessages extends OpenCmsTestCase {
  ...
  public void testLocale() throws Exception {
    ...
    assertEquals(
        "Locale manager leerte die Caches nachdem Event TestParam empfangen wurde.", value);
  }
  ...
  public void testMessageWithParameters() throws Exception {
    ...
    value =
        messages.key(
            "GUI_EDITOR_XMLCONTENT_VALIDATION_WARNING_2", new Object[] {"some value", "the rule"});
  ...
  public void testUnknownKeys() throws Exception {
    ...
    CmsMessages messages =
        new CmsMessages(org.opencms.workplace.Messages.get().getBundleName(), Locale.ENGLISH);
