...
public class TestSelectWidgetOption extends OpenCmsTestCase {
  ...
  /**
   * Tests parsing of select widget options.
   *
   * <p>
   *
  ...
  public void testOptionParser() throws Exception {
    ...
    assertEquals(
        Collections.EMPTY_LIST, CmsSelectWidgetOption.parseOptions("option='some' default='true'"));
    assertEquals(
    ...
    assertEquals(
        CmsSelectWidgetOption.parseOptions(
            "value='some value' default='true' option='some option'"),
        CmsSelectWidgetOption.parseOptions("some value*:some option"));
    ...
    List<CmsSelectWidgetOption> result1 =
        CmsSelectWidgetOption.parseOptions(
    ...
    assertEquals(
        result1,
        CmsSelectWidgetOption.parseOptions(
            CmsSelectWidgetOption.createConfigurationString(result1)));

    // check a second list with "shortcut" syntax
    List<CmsSelectWidgetOption> result2 =
        CmsSelectWidgetOption.parseOptions("1 default='true'|2|3|4|5|6|7|8|9|10");
    ...
    String options3 =
        "value='beginn_de_dt: [* TO NOW]' option='vergangen'|value='beginn_de_dt: [NOW TO *]' option='zukünftig'|value='beginn_de_dt: NOW/YEAR' option='dieses Jahr'";
  ...
  /**
   * Incomplete test for the creation of the options string from a list of options, just checking if
   * escapings are added as necessary.
   */
