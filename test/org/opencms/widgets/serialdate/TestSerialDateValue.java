...
public class TestSerialDateValue extends OpenCmsTestCase {
  ...
  public void testCurrentTillEnd() {
    ...
    String patternDefinition =
        "{\"from\":\"1491202800000\", \"to\":\"1491231600000\", \"pattern\":{\"type\":\"NONE\"}, \"currenttillend\":false}";
    ...
    patternDefinition =
        "{\"from\":\"1491202800000\", \"to\":\"1491231600000\", \"pattern\":{\"type\":\"NONE\"}}";
  ...
  /**
   * Test for the daily pattern, whole day and defined on a daily base, as well as with exceptions
   * and occurrences specified.
   */
  @Test
  public void testDailyEndTimesWithExceptions() {

    String patternDefinition =
        "{\"from\":\"1491202800000\", \"to\":\"1491231600000\", \"wholeday\":true, \"pattern\":{\"type\":\"DAILY\", \"interval\":\"5\"}, \"exceptions\":[\"1491289200000\",\"1491462000000\"], \"occurrences\":\"3\"}";
    CmsSerialDateValue wrapper = new CmsSerialDateValue(patternDefinition);
    // general
    assertTrue(wrapper.isValid());
  ...
  /**
   * Test for the daily pattern, not whole day and defintion on for workdays with a series end date
   * specified.
   */
  @Test
  public void testDailyWorkingDayEndDate() {
    ...
    String patternDefinition =
        "{\"from\":\"1491202800000\", \"to\":\"1491231600000\", \"pattern\":{\"type\":\"DAILY\", \"everyworkingday\":true}, \"enddate\":\"1492207200000\"}";
    CmsSerialDateValue wrapper = new CmsSerialDateValue(patternDefinition);
    // general
    assertTrue(wrapper.isValid());
    assertEquals(1491202800000L, wrapper.getStart().getTime());
  ...
  public void testIndividual() {
    ...
    String patternDefinition =
        "{\"from\":\"1491202800000\", \"to\":\"1491231600000\", \"pattern\":{\"type\":\"INDIVIDUAL\", \"dates\":[\"1501489020000\",\"1501748220000\"]}}";
    CmsSerialDateValue wrapper = new CmsSerialDateValue(patternDefinition);
    // general
    assertTrue(wrapper.isValid());
    assertEquals(1491202800000L, wrapper.getStart().getTime());
  ...
  public void testMonthlyDay() {
    ...
    String patternDefinition =
        "{\"from\":\"1491202800000\", \"to\":\"1491231600000\", \"pattern\":{\"type\":\"MONTHLY\", \"interval\":\"2\", \"day\":\"15\"}, \"occurrences\":\"3\"}";
    CmsSerialDateValue wrapper = new CmsSerialDateValue(patternDefinition);
    // general
    assertTrue(wrapper.isValid());
    assertEquals(1491202800000L, wrapper.getStart().getTime());
  ...
  public void testMonthlyWeeks() {
    ...
    String patternDefinition =
        "{\"from\":\"1491202800000\", \"to\":\"1491231600000\", \"pattern\":{\"type\":\"MONTHLY\", \"interval\":\"5\", \"weekdays\":[\"WEDNESDAY\"], \"weeks\":[\"SECOND\",\"LAST\"]}, \"occurrences\":\"3\"}";
    CmsSerialDateValue wrapper = new CmsSerialDateValue(patternDefinition);
    // general
    assertTrue(wrapper.isValid());
    assertEquals(1491202800000L, wrapper.getStart().getTime());
  ...
  public void testParentSeriesId() {
    ...
    String patternDefinitionWithParent =
        "{\"from\":\"1491202800000\", \"to\":\"1491231600000\", \"pattern\":{\"type\":\"NONE\"}, \"parentseries\":\""
            + parentId
            + "\"}";
    ...
    String patternDefinitionWithoutParent =
        "{\"from\":\"1491202800000\", \"to\":\"1491231600000\", \"pattern\":{\"type\":\"NONE\"}}";
  ...
  public void testWeekly() {
    ...
    String patternDefinition =
        "{\"from\":\"1491202800000\", \"to\":\"1491231600000\", \"pattern\":{\"type\":\"WEEKLY\", \"interval\":\"5\", \"weekdays\":[\"TUESDAY\",\"THURSDAY\"]}, \"occurrences\":\"3\"}";
    CmsSerialDateValue wrapper = new CmsSerialDateValue(patternDefinition);
    // general
    assertTrue(wrapper.isValid());
    assertEquals(1491202800000L, wrapper.getStart().getTime());
  ...
  public void testYearlyDay() {
    ...
    String patternDefinition =
        "{\"from\":\"1491202800000\", \"to\":\"1491231600000\", \"pattern\":{\"type\":\"YEARLY\", \"day\":\"31\", \"month\":\"JULY\"}, \"occurrences\":\"3\"}";
    CmsSerialDateValue wrapper = new CmsSerialDateValue(patternDefinition);
    // general
    assertTrue(wrapper.isValid());
    assertEquals(1491202800000L, wrapper.getStart().getTime());
  ...
  public void testYearlyWeeks() {
    ...
    String patternDefinition =
        "{\"from\":\"1491202800000\", \"to\":\"1491231600000\", \"pattern\":{\"type\":\"YEARLY\", \"weekdays\":[\"WEDNESDAY\"], \"weeks\":[\"SECOND\"], \"month\":\"JULY\"}, \"occurrences\":\"3\"}";
    CmsSerialDateValue wrapper = new CmsSerialDateValue(patternDefinition);
    // general
    assertTrue(wrapper.isValid());
    assertEquals(1491202800000L, wrapper.getStart().getTime());
