...
public class TestXmlUtils extends OpenCmsTestCase {
  ...
  public void testCreateXpath() throws Exception {
    ...
    assertEquals(
        "Title[4]/Test[2]/Toast[1]", CmsXmlUtils.createXpath("Title[4]/Test[2]/Toast[1]", 1));
    assertEquals("Title[1]/Test[2]/Toast[2]", CmsXmlUtils.createXpath("Title/Test[2]/Toast", 2));
    assertEquals(
        "Title[1]/Test[1]/Toast[1]/Toll[5]", CmsXmlUtils.createXpath("Title/Test/Toast/Toll", 5));
  }
  ...
  public void testRemoveXpath() throws Exception {
    ...
    assertEquals(
        "Title/Test/Toast/Toll", CmsXmlUtils.removeXpath("Title[1]/Test[1]/Toast[1]/Toll[5]"));
  }
