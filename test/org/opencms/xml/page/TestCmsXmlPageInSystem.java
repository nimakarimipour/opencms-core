...
public class TestCmsXmlPageInSystem extends OpenCmsTestCase {
  ...
  public void testCommentInSource() throws Exception {
    ...
    cms.createResource(
        filename, CmsResourceTypeXmlPage.getStaticTypeId(), content.getBytes(UTF8), properties);
    ...
    content =
        "<!-- First comment --><h1>Comment Test 2</h1>\n<!-- This is a comment -->\nSome text here...<!-- Another comment -->";
    page.setStringValue(cms, element, Locale.ENGLISH, content);
    result = page.getStringValue(cms, element, Locale.ENGLISH);
    assertEquals(content, result);
   ...
   *
   * <p>Description of the issue: links with parameters <code>
   * &lt;a href="form.jsp?a=b&language=xy"&gt;</code> are replaced by <code>
   * &lt;a href="form.jsp?a=b?uage=xy"&gt;</code>.
   *
   * <p>This issue turned out to be a bug in the HtmlParser component, updating the component from
   * version 1.4 to version 1.5 solved the issue.
   *
   * <p>
   *
   * @throws Exception if something goes wrong
  ...
  public void testLinkParameterIssue() throws Exception {
    ...
    page.setStringValue(
        cms, element, Locale.ENGLISH, "<a href=\"index.html?a=b&someparam=de\">link</a>");
    text = page.getStringValue(cms, element, Locale.ENGLISH);
    assertEquals(
        "<a href=\""
            + getVfsPrefix()
            + "/folder1/subfolder11/index.html?a=b&amp;someparam=de\">link</a>",
        text);

    page.setStringValue(
        cms, element, Locale.ENGLISH, "<a href=\"index.html?language=de\">link</a>");
    text = page.getStringValue(cms, element, Locale.ENGLISH);
    assertEquals(
        "<a href=\"" + getVfsPrefix() + "/folder1/subfolder11/index.html?language=de\">link</a>",
        text);

    page.setStringValue(
        cms, element, Locale.ENGLISH, "<a href=\"index.html?a=b&language=de\">link</a>");
    text = page.getStringValue(cms, element, Locale.ENGLISH);
    assertEquals(
        "<a href=\""
            + getVfsPrefix()
            + "/folder1/subfolder11/index.html?a=b&amp;language=de\">link</a>",
        text);

    page.setStringValue(
        cms, element, Locale.ENGLISH, "<a href=\"index_noexist.html?a=b&language=de\">link</a>");
    text = page.getStringValue(cms, element, Locale.ENGLISH);
    assertEquals(
        "<a href=\""
            + getVfsPrefix()
            + "/folder1/subfolder11/index_noexist.html?a=b&amp;language=de\">link</a>",
        text);
  ...
  public void testLinkReplacement() throws Exception {
    ...
    text = page.getStringValue(cms, element, Locale.ENGLISH);
    assertEquals(
        "<a href=\"" + getVfsPrefix() + "/folder1/subfolder11/index.html\">link</a>", text);
    file.setContents(page.marshal());
    ...
    text = page.getStringValue(cms, element, Locale.ENGLISH);
    assertEquals(
        "<a href=\"" + getVfsPrefix() + "/folder1/subfolder11/index_new.html\">link</a>", text);
    assertEquals(
    ...
    text = page.getStringValue(cms, element, Locale.ENGLISH);
    assertEquals(
        "<a href=\"" + getVfsPrefix() + "/folder1/subfolder11/index_noexist.html\">link</a>", text);
  }
   ...
   *
   * <p>Description of the issue: After the initial publish, the XML page schema does not work
   * anymore.
   *
   * <p>
   *
  ...
  public void testSchemaCachePublishIssue() throws Exception {
    ...
    assertEquals(
        "This is a another test", page.getValue("body", Locale.ENGLISH).getStringValue(cms));
    file.setContents(page.marshal());
    cms.writeFile(file);
  }
