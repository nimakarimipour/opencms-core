...
/**
 * Tests the OpenCms XML contents with real VFS operations for features introduced in OpenCms 7.5.
 *
 * <p>
 */
public class TestCmsXmlContent75Features extends OpenCmsTestCase {
  ...
  /**
   * Test accessing the XML through a value wrapper.
   *
   * <p>
   *
  ...
  public void testDirectXmlAccesss() throws Exception {
    ...
    assertEquals(
        "/sites/default/noexist/index.html",
        html.getXmlText().get("links/link[@name='link1']/target"));
