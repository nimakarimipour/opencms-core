...
public class TestCmsXmlContentSearchSettings extends OpenCmsTestCase {
  ...
  /** The schema id. */
  private static final String SCHEMA_SYSTEM_ID_1 =
      "http://www.opencms.org/xmlcontent-searchsettings-image.xsd";

  /** The schema id. */
  private static final String SCHEMA_SYSTEM_ID_2 =
      "http://www.opencms.org/xmlcontent-searchsettings.xsd";
  ...
  public void testSearchSettings() throws Exception {
    ...
    cacheXmlSchema(
        "org/opencms/xml/content/xmlcontent-searchsettings-image.xsd", SCHEMA_SYSTEM_ID_1);

    content =
        CmsFileUtil.readFile(
            "org/opencms/xml/content/xmlcontent-searchsettings.xsd", CmsEncoder.ENCODING_UTF_8);
    ...
    CmsXmlEntityResolver.cacheSystemId(
        SCHEMA_SYSTEM_ID_2, definition.getSchema().asXML().getBytes(CmsEncoder.ENCODING_UTF_8));

    // store content definition in entitiy resolver
    content =
        CmsFileUtil.readFile(
            "org/opencms/xml/content/test-searchsettings.xml", CmsEncoder.ENCODING_UTF_8);
