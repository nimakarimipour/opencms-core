...
public class TestCmsXmlContentWithVfs extends OpenCmsTestCase {
  ...
  /**
   * The current VFS prefix as added to internal links according to the configuration in
  ...
  public static Test suite() {
    ...
    suite.addTest(
        new TestCmsXmlContentWithVfs("testVarLinkPreservePercentEncodingForSpecialCharacters"));
  ...
  public void testAccessNestedElements() throws Exception {
    ...
    content =
        CmsFileUtil.readFile(
            "org/opencms/xml/content/xmlcontent-definition-7.xsd", CmsEncoder.ENCODING_UTF_8);
    // store content definition in entitiy resolver
    CmsXmlEntityResolver.cacheSystemId(
        SCHEMA_SYSTEM_ID_7, content.getBytes(CmsEncoder.ENCODING_UTF_8));

    // now read the XML content
    content =
        CmsFileUtil.readFile("org/opencms/xml/content/xmlcontent-7.xml", CmsEncoder.ENCODING_UTF_8);
    ...
    CmsXmlContentValueSequence level0Sequence =
        xmlcontent.getValueSequence("DeepCascade[1]", Locale.ENGLISH);
    ...
    CmsXmlContentValueSequence level1Sequence =
        xmlcontent.getValueSequence("DeepCascade[1]/Cascade", Locale.ENGLISH);
    assertEquals(1, level1Sequence.getElementCount());

    // check nested cascade level 2
    CmsXmlContentValueSequence level2Sequence =
        xmlcontent.getValueSequence("DeepCascade[1]/Cascade[1]/VfsLink", Locale.ENGLISH);
    ...
    xmlcontent =
        CmsXmlContentFactory.unmarshal(xmlcontent.toString(), CmsEncoder.ENCODING_UTF_8, resolver);
    // validate the XML structure
    xmlcontent.validateXmlStructure(resolver);
    ...
    level2Sequence =
        xmlcontent.getValueSequence("DeepCascade[1]/Cascade[2]/VfsLink", Locale.ENGLISH);
    assertEquals(1, level2Sequence.getElementCount());
    ...
    level2Sequence =
        xmlcontent.getValueSequence("DeepCascade[1]/Cascade[2]/Option", Locale.ENGLISH);
  ...
  public void testAddFileReference() throws Exception {
    ...
    links =
        cms.getRelationsForResource(
            filename, CmsRelationFilter.TARGETS.filterType(CmsRelationType.XML_WEAK));
    assertEquals(links.size(), 1);
    assertRelation(new CmsRelation(file, file, CmsRelationType.XML_WEAK), links.get(0));

    links =
        cms.getRelationsForResource(
            filename, CmsRelationFilter.TARGETS.filterType(CmsRelationType.HYPERLINK));
    assertEquals(links.size(), 1);
  ...
  public void testAddRemoveElements() throws Exception {
    ...
    content =
        CmsFileUtil.readFile(
            "org/opencms/xml/content/xmlcontent-definition-6.xsd", CmsEncoder.ENCODING_UTF_8);
    // store content definition in entitiy resolver
    CmsXmlEntityResolver.cacheSystemId(
        SCHEMA_SYSTEM_ID_6, content.getBytes(CmsEncoder.ENCODING_UTF_8));

    // now read the XML content
    content =
        CmsFileUtil.readFile("org/opencms/xml/content/xmlcontent-6.xml", CmsEncoder.ENCODING_UTF_8);
    xmlcontent = CmsXmlContentFactory.unmarshal(content, CmsEncoder.ENCODING_UTF_8, resolver);
  ...
  public void testAutoXsd() throws Exception {
    ...
    org.xml.sax.InputSource source =
        resolver.resolveEntity(null, org.opencms.xml.CmsXmlContentDefinition.XSD_INCLUDE_OPENCMS);
  ...
  public void testContentHandler() throws Exception {
    ...
    content =
        CmsFileUtil.readFile(
            "org/opencms/xml/content/xmlcontent-definition-3.xsd", CmsEncoder.ENCODING_UTF_8);
    CmsXmlContentDefinition definition =
        CmsXmlContentDefinition.unmarshal(content, SCHEMA_SYSTEM_ID_3, resolver);
    // store content definition in entitiy resolver
    CmsXmlEntityResolver.cacheSystemId(
        SCHEMA_SYSTEM_ID_3, content.getBytes(CmsEncoder.ENCODING_UTF_8));

    // now create the XML content
    content =
        CmsFileUtil.readFile("org/opencms/xml/content/xmlcontent-3.xml", CmsEncoder.ENCODING_UTF_8);
    CmsXmlContent xmlcontent =
        CmsXmlContentFactory.unmarshal(content, CmsEncoder.ENCODING_UTF_8, resolver);
    ...
    assertSame(
        definition.getContentHandler().getClass().getName(), TestXmlContentHandler.class.getName());
  }
  ...
  public void testCopyMoveRemoveLocale() throws Exception {
    ...
    content =
        CmsFileUtil.readFile(
            "org/opencms/xml/content/xmlcontent-definition-8.xsd", CmsEncoder.ENCODING_UTF_8);
    // store content definition in entitiy resolver
  ...
  public void testDefaultNested() throws Exception {
    ...
    content =
        CmsFileUtil.readFile(
            "org/opencms/xml/content/xmlcontent-definition-4.xsd", CmsEncoder.ENCODING_UTF_8);
    // store content definition in entitiy resolver
    CmsXmlEntityResolver.cacheSystemId(
        SCHEMA_SYSTEM_ID_4, content.getBytes(CmsEncoder.ENCODING_UTF_8));

    // now create the XML content
    content =
        CmsFileUtil.readFile("org/opencms/xml/content/xmlcontent-4.xml", CmsEncoder.ENCODING_UTF_8);
    CmsXmlContent xmlcontent =
        CmsXmlContentFactory.unmarshal(content, CmsEncoder.ENCODING_UTF_8, resolver);
    System.out.println(xmlcontent.toString());
  ...
  /**
   * Test default values in the appinfo node using a nested XML content schema when creating a new
   * content.
   *
   * <p>The nested content definition must be non-optional, and must have non-optional element.
   *
   * <p>
   *
   * @throws Exception in case something goes wrong
  ...
  public void testDefaultOnCreationWithNested() throws Exception {
    ...
    content =
        CmsFileUtil.readFile(
            "org/opencms/xml/content/xmlcontent-definition-3b.xsd", CmsEncoder.ENCODING_UTF_8);
    // store content definition in entitiy resolver
    CmsXmlEntityResolver.cacheSystemId(
        SCHEMA_SYSTEM_ID_3B, content.getBytes(CmsEncoder.ENCODING_UTF_8));
    content =
        CmsFileUtil.readFile(
            "org/opencms/xml/content/xmlcontent-definition-4b.xsd", CmsEncoder.ENCODING_UTF_8);
    // store content definition in entitiy resolver
    CmsXmlEntityResolver.cacheSystemId(
        SCHEMA_SYSTEM_ID_4B, content.getBytes(CmsEncoder.ENCODING_UTF_8));

    // create the content definition
    CmsXmlContentDefinition cd =
        CmsXmlContentDefinition.unmarshal(content, SCHEMA_SYSTEM_ID_4B, resolver);

    CmsXmlContent xmlcontent =
        CmsXmlContentFactory.createDocument(cms, Locale.ENGLISH, content, cd);
  ...
  public void testEmptyLocale() throws Exception {
    ...
    // store content definition in entitiy resolver
    CmsXmlEntityResolver.cacheSystemId(SCHEMA_SYSTEM_ID_8, content.getBytes(iso));
    CmsXmlContentDefinition cd1 =
        CmsXmlContentDefinition.unmarshal(content, SCHEMA_SYSTEM_ID_8, resolver);
    ...
    xmlcontent =
        CmsXmlContentFactory.createDocument(null, Locale.ENGLISH, CmsEncoder.ENCODING_UTF_8, cd1);
    xmlcontent.validateXmlStructure(resolver);
  ...
  public void testLayoutWidgetMapping() throws Exception {
    ...
    content =
        CmsFileUtil.readFile(
            "org/opencms/xml/content/xmlcontent-definition-5.xsd", CmsEncoder.ENCODING_UTF_8);
    CmsXmlContentDefinition definition =
        CmsXmlContentDefinition.unmarshal(content, SCHEMA_SYSTEM_ID_5, resolver);
    // store content definition in entitiy resolver
    CmsXmlEntityResolver.cacheSystemId(
        SCHEMA_SYSTEM_ID_5, content.getBytes(CmsEncoder.ENCODING_UTF_8));

    // now read the XML content
    content =
        CmsFileUtil.readFile("org/opencms/xml/content/xmlcontent-5.xml", CmsEncoder.ENCODING_UTF_8);
    CmsXmlContent xmlcontent =
        CmsXmlContentFactory.unmarshal(content, CmsEncoder.ENCODING_UTF_8, resolver);
    ...
    widget =
        CmsWidgetUtil.collectWidgetInfo(cms, xmlcontent.getValue("Title", Locale.ENGLISH))
            .getWidget();
    assertNotNull(widget);
    assertEquals(CmsCheckboxWidget.class.getName(), widget.getClass().getName());
    assertEquals(
        "Configuration for Title",
        handler.getConfiguration(xmlcontent.getValue("Title", Locale.ENGLISH)));

    // make sure the alias name works
    widget =
        CmsWidgetUtil.collectWidgetInfo(cms, xmlcontent.getValue("Test", Locale.ENGLISH))
            .getWidget();
    assertNotNull(widget);
    assertEquals(CmsHtmlWidget.class.getName(), widget.getClass().getName());
    assertEquals(
        "Configuration for Test",
        handler.getConfiguration(xmlcontent.getValue("Test", Locale.ENGLISH)));

    // make sure the custom class name works
    widget =
        CmsWidgetUtil.collectWidgetInfo(cms, xmlcontent.getValue("Toast", Locale.ENGLISH))
            .getWidget();
    assertNotNull(widget);
    assertEquals(TestCustomInputWidgetImpl.class.getName(), widget.getClass().getName());
    assertEquals(
        "Configuration for Toast",
        handler.getConfiguration(xmlcontent.getValue("Toast", Locale.ENGLISH)));
  ...
  public void testLinkResolver() throws Exception {
    ...
    content =
        CmsFileUtil.readFile(
            "org/opencms/xml/content/xmlcontent-definition-2.xsd", CmsEncoder.ENCODING_UTF_8);
    CmsXmlContentDefinition definition =
        CmsXmlContentDefinition.unmarshal(content, SCHEMA_SYSTEM_ID_2, resolver);
    // store content definition in entitiy resolver
    CmsXmlEntityResolver.cacheSystemId(
        SCHEMA_SYSTEM_ID_2, content.getBytes(CmsEncoder.ENCODING_UTF_8));

    // now create the XML content
    content =
        CmsFileUtil.readFile("org/opencms/xml/content/xmlcontent-2.xml", CmsEncoder.ENCODING_UTF_8);
    CmsXmlContent xmlcontent =
        CmsXmlContentFactory.unmarshal(content, CmsEncoder.ENCODING_UTF_8, resolver);
    ...
    CmsXmlVfsFileValue vfsValue =
        (CmsXmlVfsFileValue) xmlcontent.getValue("VfsLink", Locale.ENGLISH);
    ...
    while (i.hasNext()) {
      ...
      if (link.getTarget().equals("/sites/default/index.html") && link.isInternal()) {
        ...
        result++;
          ...
          && link.getQuery()
              .equals("a=b&c=d") // at this point the & in the link should be unescaped
          && link.getAnchor().equals("anchor")
          && link.isInternal()) {
        result++;
      } else if (link.getTarget().equals("/sites/default/folder1/index.html")
          && link.getQuery()
              .equals("a2=b2&c2=d2") // at this point the & in the link should be unescaped
          && link.isInternal()) {
        result++;
      }
    }
  ...
  public void testMacros() throws Exception {
    ...
    content =
        CmsFileUtil.readFile(
            "org/opencms/xml/content/xmlcontent-definition-9.xsd", CmsEncoder.ENCODING_UTF_8);
    // store content definition in entitiy resolver
    CmsXmlEntityResolver.cacheSystemId(
        SCHEMA_SYSTEM_ID_9, content.getBytes(CmsEncoder.ENCODING_UTF_8));

    // now read the XML content
    content =
        CmsFileUtil.readFile("org/opencms/xml/content/xmlcontent-9.xml", CmsEncoder.ENCODING_UTF_8);
    xmlcontent = CmsXmlContentFactory.unmarshal(content, CmsEncoder.ENCODING_UTF_8, resolver);
  ...
  public void testMappings() throws Exception {
    ...
    // store content definition in entitiy resolver
    CmsXmlEntityResolver.cacheSystemId(
        SCHEMA_SYSTEM_ID_8, content.getBytes(CmsEncoder.ENCODING_ISO_8859_1));

    // now read the XML content
    content =
        CmsFileUtil.readFile(
            "org/opencms/xml/content/xmlcontent-8.xml", CmsEncoder.ENCODING_ISO_8859_1);
    ...
    CmsProperty titleProperty =
        cms.readPropertyObject(resourcename, CmsPropertyDefinition.PROPERTY_TITLE, false);
    ...
    CmsProperty localeProperty =
        cms.readPropertyObject(resourcename, CmsPropertyDefinition.PROPERTY_LOCALE, false);
    assertSame(localeProperty, CmsProperty.getNullProperty());

    CmsProperty navImageProperty =
        cms.readPropertyObject(resourcename, CmsPropertyDefinition.PROPERTY_NAVIMAGE, false);
    assertSame(navImageProperty, CmsProperty.getNullProperty());

    CmsProperty navInfoProperty =
        cms.readPropertyObject(resourcename, CmsPropertyDefinition.PROPERTY_NAVINFO, false);
    ...
    titleInfo =
        xmlcontent
            ...
            .getContentHandler()
            .getTitleMapping(cms, xmlcontent, Locale.ENGLISH);
  ...
  public void testMappingsAsList() throws Exception {
    ...
    cms.writeFile(file);
    CmsProperty p =
        cms.readPropertyObject(resourcename, CmsPropertyDefinition.PROPERTY_NAVTEXT, false);
  ...
  public void testMappingsWithManyLocales() throws Exception {
    ...
    properties.add(
        new CmsProperty(CmsPropertyDefinition.PROPERTY_LOCALE, Locale.ENGLISH.toString(), null));
    ...
    CmsProperty titlePropertyEn =
        cms.readPropertyObject(resourcenameEn, CmsPropertyDefinition.PROPERTY_TITLE, false);
    assertEquals(titleStrEn, titlePropertyEn.getValue());
    assertDateReleased(cms, resourcenameEn, timeEN);

    CmsProperty titlePropertyDe =
        cms.readPropertyObject(resourcenameDe, CmsPropertyDefinition.PROPERTY_TITLE, false);
  ...
  public void testNestedSchema() throws Exception {
    ...
    content =
        CmsFileUtil.readFile(
            "org/opencms/xml/content/xmlcontent-definition-4.xsd", CmsEncoder.ENCODING_UTF_8);
    CmsXmlContentDefinition definition =
        CmsXmlContentDefinition.unmarshal(content, SCHEMA_SYSTEM_ID_4, resolver);
    // store content definition in entitiy resolver
    CmsXmlEntityResolver.cacheSystemId(
        SCHEMA_SYSTEM_ID_4, content.getBytes(CmsEncoder.ENCODING_UTF_8));
  ...
  public void testResourceBundle() throws Exception {
    ...
    assertEquals(
        ...
        messages.key(
            org.opencms.xml.content.Messages.GUI_EDITOR_XMLCONTENT_VALIDATION_ERROR_TITLE_0));
  }
  ...
  public void testResourceBundleFromXml() throws Exception {
    ...
    // no test with a "real" XSD schema to make sure flushing of the caches does not "kill" the
    // localization
    String filename = "/xmlcontent/article_0001.html";
    // now read the XML content
    CmsFile file = cms.readFile(filename);
    ...
    // the messages that where just injected must not be null because the permanent cache is NOT
    // cleared
    messagesEN = contentHandler.getMessages(Locale.ENGLISH);
    assertNotNull(messagesEN);
    assertEquals("The author is NOW", messagesEN.key("label.author"));
    ...
    // but we better not depend on that as "old" references to content objects may be held when the
    // clear cache is done
  ...
  public void testResourceBundleFromXmlWithDefault() throws Exception {
    ...
    CmsXmlEntityResolver.cacheSystemId(
        SCHEMA_SYSTEM_ID_1L2, content.getBytes(CmsEncoder.ENCODING_UTF_8));

    CmsXmlContent xmlcontentDE =
        CmsXmlContentFactory.createDocument(cms, Locale.GERMAN, content, definition);
    ...
    CmsXmlContent xmlcontentEN =
        CmsXmlContentFactory.createDocument(cms, Locale.ENGLISH, content, definition);

    assertEquals(
        "This is some text ONE", xmlcontentEN.getStringValue(cms, "StringOne", Locale.ENGLISH));
    assertEquals(
        "This is some text TWO", xmlcontentEN.getStringValue(cms, "StringTwo", Locale.ENGLISH));
    ...
    assertEquals(
        "This is some text NEW ONE", xmlcontentEN.getStringValue(cms, "StringOne", Locale.ENGLISH));
    assertEquals(
        "This is some text NEW TWO", xmlcontentEN.getStringValue(cms, "StringTwo", Locale.ENGLISH));
  }
  ...
  public void testValidationExtended() throws Exception {
    ...
    // store content definition in entitiy resolver
    CmsXmlEntityResolver.cacheSystemId(
        SCHEMA_SYSTEM_ID_8, content.getBytes(CmsEncoder.ENCODING_UTF_8));

    // now read the XML content
    content =
        CmsFileUtil.readFile("org/opencms/xml/content/xmlcontent-8.xml", CmsEncoder.ENCODING_UTF_8);
    xmlcontent = CmsXmlContentFactory.unmarshal(content, CmsEncoder.ENCODING_UTF_8, resolver);
    // validate the XML structure
    xmlcontent.validateXmlStructure(resolver);
  ...
  public void testValidationLocale() throws Exception {
    ...
    value.setStringValue(
        cms, "Dieser String enth�llt einen Fehler (English: 'error') und eine Warnung!");
  ...
  public void testVarLinkPreservePercentEncodingForSpecialCharacters() throws Exception {
    ...
    CmsXmlContentDefinition definition =
        CmsXmlContentDefinition.unmarshal(content, schemaId, resolver);
    // store content definition in entitiy resolver
    ...
    content =
        CmsFileUtil.readFile(
            "org/opencms/xml/content/xmlcontent-VarLink-1.xml", CmsEncoder.ENCODING_UTF_8);
    CmsXmlContent xmlcontent =
        CmsXmlContentFactory.unmarshal(content, CmsEncoder.ENCODING_UTF_8, resolver);
    ...
    CmsXmlContent xmlcontent2 =
        CmsXmlContentFactory.unmarshal(content2, CmsEncoder.ENCODING_UTF_8, resolver);
  ...
  /**
   * Test resolving a {@link CmsXmlVarLinkValue} in an XML content.
   *
   * <p>
   *
   * @throws Exception in case something goes wrong
  ...
  public void testVarLinkResolver() throws Exception {
    ...
    CmsXmlVfsFileValue vfsValue =
        (CmsXmlVfsFileValue) xmlcontent.getValue("VfsLink", Locale.ENGLISH);
    CmsXmlVarLinkValue varValue1 =
        (CmsXmlVarLinkValue) xmlcontent.getValue("VarLink", Locale.ENGLISH, 0);
    CmsXmlVarLinkValue varValue2 =
        (CmsXmlVarLinkValue) xmlcontent.getValue("VarLink", Locale.ENGLISH, 1);
    ...
    CmsXmlContent newContent =
        CmsXmlContentFactory.createDocument(cms, Locale.ENGLISH, CmsEncoder.ENCODING_UTF_8, cd);
  ...
  public void testXmlContentCreate() throws Exception {
    ...
    xmlcontent
        .getValue("Author", Locale.ENGLISH)
        .setStringValue(cms, "Alkacon Software GmbH & Co. KG");
