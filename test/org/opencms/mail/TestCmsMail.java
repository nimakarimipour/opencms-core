...
/**
 * Unit test for the cms mail functionality.
 *
 * <p>
 */
public class TestCmsMail extends OpenCmsTestCase {
  ...
  /**
   * Port the SMTP server will listen to. Must be greater than 1000, depending on the underlying OS.
   */
  ...
  /**
   * Tests sending mails to invalid email address.
   *
   * <p>
   */
