...
/**
 * Test cases for the OpenCms shell.
 *
 * <p>
 *
 * @since 6.0.0
...
public class TestCmsShell extends OpenCmsTestCase {
  ...
  /**
   * Tests the Junit OpenCms VFS test setup using the "base" test class.
   *
   * <p>
   *
  ...
  /**
   * Tests the CmsShell and setup procedure.
   *
   * <p>
   *
   * @throws Throwable if something goes wrong
  ...
  public void testCmsShell() throws Throwable {
    ...
    File configBackupDir =
        new File(getTestDataPath("WEB-INF/" + CmsSystemInfo.FOLDER_CONFIG_DEFAULT + "backup/"));
