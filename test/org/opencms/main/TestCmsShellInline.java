...
/**
 * Test cases for the OpenCms shell when used "inline".
 *
 * <p>
 *
 * @since 9.5.0
...
public class TestCmsShellInline extends OpenCmsTestCase {
  ...
  private final String ARROW_UP =
      new String(new byte[] {KeyEvent.VK_ESCAPE, KeyEvent.VK_OPEN_BRACKET, 'A'});
  ...
  /**
   * Tests creation of users using the shell.
   *
   * <p>
   *
  ...
  /**
   * Tests the shell without 'echo on'.
   *
   * <p>
   *
   * @throws Exception in case something goes wrong
  ...
  public void testShellEchoOff() throws Exception {
    ...
    // some variables in the String so that we don't have to change the test case every version /
    // year
    String expected =
        "\n"
  ...
  /**
   * Tests basic inline shell invocation.
   *
   * <p>
   *
   * @throws Exception in case something goes wrong
  ...
  /**
   * Tests setting some properties using the shell.
   *
   * <p>
   *
   * @throws Exception in case something goes wrong
