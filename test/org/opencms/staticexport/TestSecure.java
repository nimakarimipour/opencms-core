...
public class TestSecure extends OpenCmsTestCase {
   ...
   *
   * <p>make a link from one site to another site, and check, if the correct prefixes are set
   *
   ...
   *
   * <p>Description of the issue: links from secure pages to insecure pages must have a normal
   * server prefix.
   *
   * <p>links from normal pages to secure pages must have a secure server prefix.
   *
   * <p>links from secure pages to secure pages have no server prefix.
   *
   * <p>
   *
   * @throws Exception in case something goes wrong
