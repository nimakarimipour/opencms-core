  ...
  public void testExportScaledImage() throws Throwable {
    ...
    CmsStaticExportData data =
        new CmsStaticExportData(
            rootPath, rootPath, imageFile, CmsImageScaler.PARAM_SCALE + "=" + scaleParams);
        ...
        .export(
            ...
            new HttpServletResponse() {
              ...
              public ServletOutputStream getOutputStream() throws IOException {
                ...
                // Returning dummy output stream, since we do not want to actually write somewhere
    ...
    byte[] expectedContent =
        (new CmsImageScaler(scaleParams)).scaleImage(cms.readFile(resourcename));
