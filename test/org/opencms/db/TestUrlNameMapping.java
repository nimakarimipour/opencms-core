...
public class TestUrlNameMapping extends OpenCmsTestCase {
  ...
  /**
   * Creates an XML content for testing URL name mappings.
   *
   * <p>
   *
  ...
  /**
   * Creates an XML content with the given string as file content.
   *
   * <p>
   *
  ...
  public CmsResource createContent(String content) throws Exception {
    ...
    CmsResource created =
        getCmsObject()
            .createResource(
                "/file" + m_fileCounter++, 7, contentBytes, new ArrayList<CmsProperty>());
        ...
        getCmsObject()
            .createResource(
                ...
                OpenCms.getResourceManager()
                    .getResourceType(CmsResourceTypeXmlContent.getStaticTypeName())
                    .getTypeId(),
                new byte[] {},
                new ArrayList<>());
    return result;
  ...
  /**
   * Tests adding normal mappings after having added 'replace' mappings.
   *
   * <p>
   *
   * @throws Exception
  ...
  /**
   * Tests that when a not-new resource is deleted and published, its URL name mappings are also
   * deleted.
   *
   * <p>
   *
  ...
  /**
   * Tests that the urlname.replace property mapping is handled correctly, and that the
   * urlname.replace property works the way it should.
   *
   * <p>
   *
   * @throws Exception
  ...
  /**
   * Tests that when the changes of a resource are undone, its unpublished URL name mapping will be
   * removed.
   *
   * <p>
   *
  ...
  /**
   * Tests replace-on-publish functionality for URL names.
   *
   * <p>
   *
   * @throws Exception
  ...
  /**
   * Adds a 'replace' mapping to a resource.
   *
   * <p>
   *
  ...
  /**
   * Reads the best URL name for the given structure id.
   *
   * <p>
   *
