...
/**
 * Unit tests for OpenCms subscription manager.
 *
 * <p>
 */
public class TestSubscriptionManager extends OpenCmsTestCase {
  ...
  /**
   * Test reading subscribed resources.
   *
   * <p>
   *
  ...
  public void testReadSubscribedResources() throws Throwable {
    ...
    List<I_CmsHistoryResource> subscribedDeletedResources =
        subMan.readSubscribedDeletedResources(cms, user, false, "/folder2/", false, 0);
    ...
    subscribedDeletedResources =
        subMan.readSubscribedDeletedResources(cms, user, false, null, false, 0);
  ...
  public void testVisitResources() throws Throwable {
    ...
    assertNotSame(
        Long.valueOf(0L),
        Long.valueOf(subMan.getDateLastVisitedBy(cms, user, "/folder1/page2.html")));
    assertNotSame(
        Long.valueOf(0L),
        Long.valueOf(subMan.getDateLastVisitedBy(cms, user, "/folder1/index.html")));
    assertSame(
        Long.valueOf(0L), Long.valueOf(subMan.getDateLastVisitedBy(cms, user, "/index.html")));
