...
public class TestSiteConfigSerialization extends OpenCmsTestCase {
  ...
  public void testSiteBeanConversion() throws Exception {
    ...
    String inputFile =
        CmsResource.getParentFolder(
            OpenCmsTestProperties.getResourcePathFromClassloader(
                "org/opencms/configuration/opencms.xml"));
    ...
    CmsSitesConfiguration config =
        (CmsSitesConfiguration) manager.getConfiguration(CmsSitesConfiguration.class);
  ...
  /**
   * Generates string representation of CmsSite via reflection, for the purpose of comparisons in
   * test cases.
   *
   * @param site the site
  ...
  String siteToString(CmsSite site) {
    ...
    ReflectionToStringBuilder builder =
        new ReflectionToStringBuilder(site, ToStringStyle.SHORT_PREFIX_STYLE);
   ...
   */
  private void checkSiteBeanConversion(CmsSiteManagerImpl siteManager, CmsSite site)
      throws Exception {
