...
public class TestInheritedContainer extends OpenCmsTestCase {
  ...
  public static class CacheLoadLogHandler implements I_CmsLogHandler {
    ...
    /**
     * Resets the offline/online load counters to 0.
     *
     * <p>
     */
    public void clear() {
    ...
    /**
     * Gets the number of offline loads since the last call to clear().
     *
     * <p>
     *
    ...
    /**
     * Gets the number of single readResource calls for offline mode.
     *
     * <p>
     *
    ...
    /**
     * Gets the number of online loads since the last call to clear().
     *
     * <p>
     *
    ...
    /**
     * Gets the number of online readResource calls.
     *
     * <p>
     *
  ...
  /**
   * Tests that new elements in parent configurations which are not explicitly referenced by a child
   * configuration's ordering are inserted at the end of the element list.
   *
   * <p>
   */
  ...
  /**
   * Tests the correctness of the offline cache results.
   *
   * <p>
   *
  ...
  /**
   * Tests the correctness of the online cache results.
   *
   * <p>
   *
   * @throws Exception in case writing configuration fails
  ...
  /**
   * Tests whether the cache only loads configuration files when necessary.
   *
   * <p>
   *
   * @throws Exception in case writing configuration fails
  ...
  /**
   * Tests whether the inherited container cache is cleared correctly.
   *
   * <p>
   *
   * @throws Exception in case writing configuration fails
  ...
  public void testClearCaches() throws Exception {
    ...
    try {
      ...
      checkConfigurationForPath(
          "/system/level1/level2/level3", "alpha", OFFLINE, "key=c", "key=a", "key=b");
      checkConfigurationForPath(
          "/system/level1/level2/level3", "alpha", ONLINE, "key=c", "key=a", "key=b");
      OpenCms.getEventManager().fireEvent(I_CmsEventListener.EVENT_CLEAR_CACHES);
      checkConfigurationForPath(
          "/system/level1/level2/level3", "alpha", OFFLINE, "key=c", "key=a", "key=b");
      checkConfigurationForPath(
  ...
  /**
   * Tests that the 'new' states of inherited container elements are correct.
   *
   * <p>
   */
  ...
  /**
   * Tests that the configuration cache works if there are no configuration files, or there are
   * configuration files which don't contain a configuration for a given name.
   *
   * <p>
   *
   * @throws Exception in case writing configuration fails
  ...
  /**
   * Tests that only correctly named inherited container configuration files are evaluated.
   *
   * <p>
   *
   * @throws Exception in case writing configuration fails
  ...
  /**
   * Test case for saving the configuration.
   *
   * <p>
   *
   * @throws Exception in case writing configuration fails
  ...
  public void testReadAndSaveBack() throws Exception {
    ...
    CmsInheritedContainerState state =
        OpenCms.getADEManager().getInheritedContainerState(cms, "/system/level1/level2", "alpha");
  ...
  /**
   * Tests looking up inheritance groups by element resource.
   *
   * <p>
   *
   * @throws Exception in case writing configuration fails
  ...
  public void testReverseLookup() throws Exception {
    ...
    Set<String> result =
        CmsInheritanceGroupUtils.getNamesOfGroupsContainingResource(cms, inheritanceConfig, target);
  ...
  /**
   * Tests saving an inherited container element list with a new element added.
   *
   * <p>
   *
   * @throws Exception in case writing configuration fails
  ...
  public void testSaveChangeVisibility() throws Exception {
    ...
    try {
      ...
      List<CmsContainerElementBean> elements =
          OpenCms.getADEManager().getInheritedContainerState(cms, x2, "alpha").getElements(true);
      ...
      OpenCms.getADEManager()
          .saveInheritedContainer(cms, "/system/x1/x2", "alpha", false, elements);
      checkConfigurationForPath(
          "/system/x1/x2",
          "alpha",
          OFFLINE,
  ...
  /**
   * Test the removal of left over keys.
   *
   * <p>
   *
   * @throws Exception in case writing configuration fails
  ...
  /**
   * Tests saving a reordered list of inherited container elements.
   *
   * <p>
   *
   * @throws Exception in case writing configuration fails
  ...
  /**
   * Tests serialization of a single configuration node.
   *
   * <p>
   *
   * @throws Exception in case writing configuration fails
  ...
  public void testSerialization1() throws Exception {
    ...
    CmsXmlContentProperty setting1def =
        new CmsXmlContentProperty(
            "setting_a", "string", null, null, null, null, null, null, null, null, null);
    final Map<String, CmsXmlContentProperty> settingDefs =
        new HashMap<String, CmsXmlContentProperty>();
    settingDefs.put("setting_a", setting1def);
    CmsContainerConfigurationWriter writer =
        new CmsContainerConfigurationWriter() {
    ...
    Element element =
        writer.serializeSingleConfiguration(
            getCmsObject(), "configname", config, document.getRootElement());
  ...
  /**
   * Tests whether a configuration file which has been first updated and then deleted is removed
  ...
  /**
   * Helper method to create a dummy configuration from a specification string.
   *
   * <p>The specification string consists of 4 fields separated by the pipe symbol, which correspond
   * to different parts of the configuration bean. The first field describes the ordering keys of
   * the container configuration; the second field describes the keys which have been made visible
   * by the configuration; the third field describes which keys have been hidden by the
   * configuration, and the last field describes which new elements are contained in the
   * configuration.
   *
   * <p>
   *
  ...
  /**
   * Checks whether a given element contains a nested CDATA node with a given text.
   *
   * <p>
   *
  ...
  /**
   * Checks whether a container element bean with inheritance information fulfills a given
   * specification string.
   *
   * <p>The string has the form 'key1=value1 key2=value2....'.
   *
   * <p>Each key-value pair corresponds to a check to perform on the given container element bean:
   * The key 'key' performs a test whether the key of the inheritance info has a given value.
   *
   * <p>The key 'new' performs a test whether the element bean was inherited from a parent
   * configuration or is new.
   *
   * <p>The key 'visible' performs a test whether the element bean is marked as visible
   *
  ...
  /**
   * Checks whether the container element beans contained in a list satisfy a list of constraints.
   *
   * <p>
   *
   * @param elements the elements for which the checks should be performed
   * @param specs the constraints for the element beans, in the same order as the container element
   *     beans
   */
   ...
   * root path satisfies a list of constraints.
   *
   * <p>
   *
   ...
   */
  protected void checkConfigurationForPath(
      String rootPath, String name, boolean online, String... specs) throws CmsException {
    ...
    CmsInheritedContainerState state =
        OpenCms.getADEManager().getInheritedContainerState(cms, rootPath, name);
    List<CmsContainerElementBean> elementBeans = state.getElements(true);
    checkConfiguration(elementBeans, specs);
  }

  /**
   * Creates a document given a root element as a string.
   *
   * <p>
   *
  ...
  /**
   * Deletes a configuration at the given level of the /level1/level2/level3 tree branch.
   *
   * <p>
   *
  ...
  protected void deleteConfiguration(int level) throws CmsException {
    ...
    String configPath =
        CmsStringUtil.joinPaths(
            dirPath, CmsContainerConfigurationCache.INHERITANCE_CONFIG_FILE_NAME);
    deleteConfiguration(configPath);
    OpenCms.getADEManager().flushInheritanceGroupChanges();
  }

  /**
   * Deletes the configuration for a given path.
   *
   * <p>
   *
  ...
  protected CmsContainerElementBean generateDummyElement(String key) {
    ...
    CmsContainerElementBean elementBean =
        new CmsContainerElementBean(id, CmsUUID.getNullUUID(), settings, false);
    return elementBean;
  }

  /**
   * Helper method for generating a test configuration which contains a single configured container
   * elements.
   *
   * <p>
   *
   ...
   */
  protected byte[] generateTestConfig(String newName)
  ...
  /**
   * Helper method for getting a path for the given level in the level1/level2/level3 tree branch.
   *
   * <p>
   *
  ...
  /**
   * Gets the nested text of an element.
   *
   * <p>
   *
  ...
  /**
   * Helper method to lock a resource.
   *
   * <p>
   *
  ...
  /**
   * Helper method to create dummy structure ids from a name.
   *
   * <p>
   *
   * @param name the name
  ...
  /**
   * Helper method which publishes the offline project.
   *
   * <p>
   *
  ...
  /**
   * Helper method for reading the contents of the path into a file.
   *
   * <p>
   *
   ...
   * @throws Exception if something goes wrong
   */
  protected void saveConfiguration(String path, CmsContainerConfiguration config, String name)
      throws Exception {

    CmsContainerConfigurationWriter writer = new CmsContainerConfigurationWriter();
    CmsXmlContent content =
        writer.saveInContentObject(getCmsObject(), null, Locale.ENGLISH, name, config);
  ...
  /**
   * Writes a dummy configuration file at a given level in the level1/level2/level3 tree branch.
   *
   * <p>
   *
   ...
   * @throws UnsupportedEncodingException in case of an unsupported encoding
   */
  protected void writeConfiguration(int level, String name)
      throws CmsException, UnsupportedEncodingException {
  ...
  /**
   * Writes a dummy configuration file to a given path.
   *
   * <p>
   *
   ...
   */
  @SuppressWarnings("deprecation")
  protected void writeConfiguration(String path, String name)
      throws CmsException, UnsupportedEncodingException {
