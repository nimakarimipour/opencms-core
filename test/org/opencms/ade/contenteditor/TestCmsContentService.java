...
/**
 * Tests the content service for generating serializable XML content entities and type definitions
 * and persisting those entities.
 *
 * <p>
 */
public class TestCmsContentService extends OpenCmsTestCase {
  ...
  public void testReadEntity() throws Exception {
    ...
    if (xmlcontent.hasLocale(locale)) {
      ...
      result =
          service.readEntity(
              xmlcontent, element, locale, "myEntity", "", baseTypeName, visitor, true, null);
    }
  ...
  public void testReadTypes() throws Exception {
    ...
    assertEquals(
        "Should contain 5 types, the base type and 4 simple types", 5, registeredTypes.size());
  }
}
