...
/**
 * Unit test for the ADE sitemap navigation position calculation algorithm.
 *
 * <p>
 */
public class TestNavPosCalculator extends OpenCmsTestCase {
  ...
  /**
   * Tests filtering of non-navigation entries from the navigation list.
   *
   * <p>
   */
  public void testFilterNonNavEntries() {
    ...
    CmsSitemapNavPosCalculator npc =
        new CmsSitemapNavPosCalculator(list(a, b, c), dummyRes("fasdf"), 3);
  ...
  /**
   * Tests insertion between entries with the same nav pos value.
   *
   * <p>
   */
  public void testInserBetweenEquals() {
    ...
    CmsJspNavElement c = dummyNav("baz", 3);
    CmsSitemapNavPosCalculator npc =
        new CmsSitemapNavPosCalculator(list(a, b, c), dummyRes("fasdf"), 1);
    List<CmsJspNavElement> navs = npc.getResultList();
  ...
  /**
   * Tests insertion after a Float.MAX_VALUE navigation entry.
   *
   * <p>
   */
  ...
  /**
   * Tests insertion between two Float.MAX_VALUE navigation entries.
   *
   * <p>
   */
  public void testInsertAtMax() {
    ...
    CmsJspNavElement c = dummyNav("baz", Float.MAX_VALUE);
    CmsSitemapNavPosCalculator npc =
        new CmsSitemapNavPosCalculator(list(a, b, c), dummyRes("fasdf"), 2);
    List<CmsJspNavElement> navs = npc.getResultList();
    int pos = npc.getInsertPositionInResult();
    checkIntegrity(navs, pos);
    assertTrue(checkIncreasing(navs));
  ...
  /**
   * Tests insertion before a Float.MAX_VALUE navigation entry.
   *
   * <p>
   */
  ...
  /**
   * Tests insertion between navigation entries with different NavPos values.
   *
   * <p>
   */
  ...
  /**
   * Tests insertion at the end of the navigation.
   *
   * <p>
   */
  ...
  /**
   * Tests insertion at the front of the navigation.
   *
   * <p>
   */
  public void testInsertFrontNormal() {
    ...
    CmsJspNavElement c = dummyNav("baz", 3);
    CmsSitemapNavPosCalculator npc =
        new CmsSitemapNavPosCalculator(list(a, b, c), dummyRes("fasdf"), 0);
    List<CmsJspNavElement> navs = npc.getResultList();
    int pos = npc.getInsertPositionInResult();
    checkIntegrity(navs, pos);
    assertTrue(checkIncreasing(navs));
  ...
  /**
   * Tests the normal insertion case.
   *
   * <p>
   */
  ...
  /**
   * Helper method to check whether a list of navigation entries have increasing nav pos values.
   *
   * <p>
   *
  ...
  /**
   * Performs a sanity check after a navigation entry insertion.
   *
   * <p>This checks whether the list of entries have non-decreasing navigation positions and whether
   * the sequence (left neighbor of inserted entry, inserted entry, right neighbor of inserted
   * entry) have increasing navigation positions.
   *
   * @param navs the list of navigation entries
  ...
  /**
   * Helper method to check whether a list of navigation entries have non-decreasing navigation
   * positions.
   *
   * <p>
   *
  ...
  /**
   * Helper method to create a dummy resource.
   *
   * <p>
   *
  ...
  /**
   * Helper method for generating a dummy CmsJspNavElement instance which is not in the navigation.
   *
   * <p>
   *
   * @param name the name of the navigation entry
  ...
  /**
   * Helper method for printing a list of navigation entries.
   *
   * <p>
   *
   * @param navs the list of navigation entries
