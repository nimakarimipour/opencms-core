...
/**
 * Tests for the ADE configuration mechanism which read the configuration data from multiple files
 * in the VFS.
 *
 * <p>
 */
public class TestLiveConfig extends OpenCmsTestCase {
  ...
  /**
   * Generates a sitemap config XML with the given types.
   *
   * <p>
   *
   ...
   */
  public static String generateSitemapConfigWithTypes(
      Map<String, String> types, List<String> masterConfigIds) {
    ...
    st.setAttribute(
        "masterConfigs", masterConfigIds != null ? masterConfigIds : Collections.emptyList());
    return st.toString();
  }
  ...
  public void testAttributeUpdates() throws Exception {
...

    {
      ...
      CmsSitemapAttributeUpdater updater = new CmsSitemapAttributeUpdater(cms, content);
      assertEquals(
          CmsStringUtil.splitAsMap("bar:2|baz:3", "|", ":"), updater.getAttributesFromContent());
    }
  }
  ...
  public void testCategoryDetailPages() throws Exception {
    ...
    createCategoryDetailPageTestSitemap(
        base + "/a", preferDetailPages, excludeExternalContents, false);
    OpenCms.getADEManager().waitForCacheUpdate(false);
    CmsADEConfigData config =
        OpenCms.getADEManager()
            .lookupConfiguration(cms, cms.readResource(base + "/a").getRootPath());
    List<CmsDetailPageInfo> pages = config.getDetailPagesForType("article1");
    List<String> types =
        pages.stream().map(page -> page.getQualifiedType()).collect(Collectors.toList());
  ...
  /**
   * Tests cross-site detail page links.
   *
   * <p>
   *
   * @throws Exception -
  ...
  public void testCrossSiteDetailPageLinks1() throws Exception {
    ...
    assertEquals(
        "http://foo.org" + getVfsPrefix() + "/main/blog/" + res.getStructureId() + "/", link);
  ...
  /**
   * Tests that multiple default detail pages can be returned
   * CmsADEConfigData#getDetailPagesForType().
   *
   * @throws Exception
   */
  public void testDefaultDetailPagesPreserved() throws Exception {
    ...
    assertEquals(
        Arrays.asList(
            "article1", "article1|category:foo", "##DEFAULT##", "##DEFAULT##|category:foo"),
        types);
  }
  ...
  public void testDetailPage1() throws Exception {
    ...
    String detailPage =
        OpenCms.getADEManager()
            ...
            .getDetailPage(
                cms, "/sites/default/.content/a1/blarg.html", "/sites/default/today/news", null);
    ...
    detailPage =
        OpenCms.getADEManager()
            .getDetailPageHandler()
            .getDetailPage(cms, "/sites/default/.content/a1/blarg.html", "/today/news", null);
    assertEquals("/sites/default/", detailPage);
  }
  ...
  public void testIncludeInSiteSelector() throws Exception {
    ...
    try {
      OpenCms.getSiteManager()
          .getSiteForRootPath(getCmsObject().getRequestContext().getSiteRoot())
          .setSubsiteSelectionEnabled(true);
      ...
      List<CmsExtendedSiteSelector.SiteSelectorOption> options =
          CmsExtendedSiteSelector.getExplorerSiteSelectorOptions(getCmsObject(), true);
      ...
      for (CmsExtendedSiteSelector.SiteSelectorOption option : options) {
        if (option.getPath() != null) {
          ...
          assertTrue(
              "Site does not match",
              CmsStringUtil.comparePaths(
                  option.getSite(), getCmsObject().getRequestContext().getSiteRoot()));
        }
      }
      expected =
          new HashSet<>(
              list(
                  ...
                  "/includeInSiteSelector/alpha/gamma",
                  "/includeInSiteSelector/beta"));
      assertEquals(expected, actual);
    } finally {
      OpenCms.getSiteManager()
          .getSiteForRootPath(getCmsObject().getRequestContext().getSiteRoot())
          .setSubsiteSelectionEnabled(false);
    }
  }
  ...
  public void testLevel2Configuration() throws Exception {
    ...
    OpenCms.getADEManager().refresh();
    checkResourceTypes(
        offlineCms, "/sites/default/today/events", "foldername", "d2", "a1", "c1", "foo1");
    checkResourceTypes(
        offlineCms, "/sites/default/today/events/foo", "foldername", "d2", "a1", "c1", "foo1");
    checkResourceTypes(
        onlineCms, "/sites/default/today/events/", "foldername", "d2", "a1", "c1", "foo1");
    checkResourceTypes(
        onlineCms, "/sites/default/today/events/foo", "foldername", "d2", "a1", "c1", "foo1");

    checkResourceTypes(
        onlineCms, "/sites/default/today/news", "foldername", "c3", "e3", "a1", "b1", "foo1");
    checkResourceTypes(
        onlineCms, "/sites/default/today/news/foo/", "foldername", "c3", "e3", "a1", "b1", "foo1");
    checkResourceTypes(
        offlineCms, "/sites/default/today/news", "foldername", "c3", "e3", "a1", "b1", "foo1");
    checkResourceTypes(
        offlineCms, "/sites/default/today/news/foo", "foldername", "c3", "e3", "a1", "b1", "foo1");
  }

  /**
   * Tests the master configuration feature.
   *
   * <p>
   *
   * @throws Exception -
  ...
  public void testMasterConfiguration() throws Exception {
    ...
    try {
      I_CmsResourceType configType = OpenCms.getResourceManager().getResourceType("sitemap_config");
      I_CmsResourceType masterConfigType =
      ...
      CmsResource masterConfigResource =
          cms.createResource(
              "/system/.master",
              masterConfigType,
      ...
      types3.put("cc", "cc3");
      String config3 =
          generateSitemapConfigWithTypes(
              types3, Arrays.asList("" + masterConfigResource.getStructureId()));
      cms.createResource(
  ...
  /**
   * Tests the master configuration chaining feature.
   *
   * <p>
   *
   * @throws Exception -
  ...
  public void testMasterConfigurationChaining() throws Exception {
    ...
    CmsResource masterConfigResource2 =
        cms.createResource(
            "/system/.chainmaster2",
            masterConfigType,
            config3.getBytes("UTF-8"),
    ...
    String config4 =
        generateSitemapConfigWithTypes(
            ...
            Arrays.asList(
                ...
                "" + masterConfigResource2.getStructureId()));
    CmsResource masterConfigResource3 =
        cms.createResource(
            "/system/.chainmaster3",
            masterConfigType,
    ...
    String config1 =
        generateSitemapConfigWithTypes(
            types1, Arrays.asList("" + masterConfigResource3.getStructureId()));
    cms.createResource(
  ...
  public void testMasterConfigurationMultiple() throws Exception {
    ...
    try {
      ...
      cms.createResource(
          ...
          Collections.<CmsProperty>emptyList());
      OpenCms.getADEManager().waitForCacheUpdate(false);
      checkResourceTypesSet(
          cms, "/system/mastertest/subfolder", "foldername", "aa1", "bb3", "cc4", "dd2");
  ...
  public void testMove1() throws Exception {
    ...
    try {
      ...
      checkResourceTypes(
          cms, "/sites/default/today/news", "foldername", "c3", "e3", "a1", "b1", "foo1");
      checkResourceTypes(
          cms, "/sites/default/today/news/events/", "foldername", "d2", "c3", "e3", "a1", "foo1");
    } finally {
      restoreFiles();
    }
  }
  ...
  public void testMoveDetailPages() throws Exception {
    ...
    try {
      ...
      CmsADEConfigData configData =
          OpenCms.getADEManager().lookupConfiguration(cms, "/sites/default/today");
  ...
  public void testPublish() throws Exception {
    ...
    try {
      ...
      waitForUpdate(false);
      checkResourceTypes(
          onlineCms, "/sites/default/today/", "foldername", "c3", "e3", "a1", "b1", "foo1");
      checkResourceTypes(
          onlineCms, "/sites/default/today/events", "foldername", "d2", "c3", "e3", "a1", "foo1");
    } finally {
      restoreFiles();
    }
  }
  ...
  /**
   * Tests whether getSubsiteFolder works correctly with the shared folder.
   *
   * <p>
   *
  ...
  public void testSharedGetSubSite() throws Exception {
    ...
    assertEquals(
        ...
        CmsFileUtil.removeTrailingSeparator(
            OpenCms.getADEManager().getSubSiteRoot(cms, "/shared")));
  }

  /**
   * Tests that sitmeap folder types override module folder types.
   *
   * <p>
   *
   * @throws Exception -
    ...
    try {
      ...
      String parentFolderType =
          OpenCms.getADEManager()
              .getOfflineCache()
              .getState()
              .getParentFolderType("/sites/default/.content/a1/foo");
  ...
  public void testSpecifiedTargetDetailPage() throws Exception {
    ...
    String detailPage =
        OpenCms.getADEManager()
            .getDetailPageHandler()
            .getDetailPage(
                cms, "/sites/default/.content/a1/blarg.html", "/today/news", "/otherpage");
  ...
  /**
   * Waits until the configuration update task has been run.
   *
   * <p>
   *
  ...
  /**
   * Helper method to compare attributes of configured resource types with a list of expected
   * values.
   *
   * <p>
   *
  ...
  /**
   * Helper method to compare attributes of configured resource types with a set of expected values.
   *
   * <p>
   *
   * @param cms the CMS context
   ...
   * @param expected the expected resource type names
   */
  protected void checkResourceTypesSet(
      CmsObject cms, String path, String attr, String... expected) {
  ...
  private void createCategoryDetailPageTestSitemap(
    ...
    cms.createResource(
        path + "/detail/index.html", OpenCms.getResourceManager().getResourceType("containerpage"));
    ...
    String config =
        "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n"
            ...
            + "";
    cms.createResource(
        path + "/.content/.config", OpenCms.getResourceManager().getResourceType("sitemap_config"));
  ...
  private String createLinkFromTo(String subsite1, String subsite2) throws Exception {
    ...
    return OpenCms.getLinkManager()
        .substituteLinkForUnknownTarget(cms, subsite2 + "/.content/blogentries/article.xml");
  }
