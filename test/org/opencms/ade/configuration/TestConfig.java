...
/**
 * Lightweight tests for the ADE configuration mechanism which mostly do not read the configuration
 * data from the VFS.
 *
 * <p>
 */
public class TestConfig extends OpenCmsTestCase {
  ...
  public static final List<CmsDetailPageInfo> NO_DETAILPAGES =
      Collections.<CmsDetailPageInfo>emptyList();

  /** Empty model page list. * */
  public static final List<CmsModelPageConfig> NO_MODEL_PAGES =
      Collections.<CmsModelPageConfig>emptyList();

  /** Empty property definition list. * */
  public static final List<CmsPropertyConfig> NO_PROPERTIES =
      Collections.<CmsPropertyConfig>emptyList();

  /** Empty resource type list. * */
  public static final List<CmsResourceTypeConfig> NO_TYPES =
      Collections.<CmsResourceTypeConfig>emptyList();
  ...
  public void testCreatable() throws Exception {
    ...
    CmsContentFolderDescriptor folder =
        new CmsContentFolderDescriptor(baseDirectory + "/.content", "plain");
    CmsResourceTypeConfig typeConf1 =
        new CmsResourceTypeConfig("plain", false, folder, "pattern_%(number)");
    CmsResourceTypeConfig typeConf2 =
    ...
    CmsTestConfigData config1 =
        new CmsTestConfigData(
            baseDirectory,
  ...
  public void testCreateContentsLocally() throws Exception {
    ...
    CmsResourceTypeConfig typeConf1 =
        new CmsResourceTypeConfig(typename, false, folder, "file_%(number)");

    CmsTestConfigData config1 =
        new CmsTestConfigData(
            baseDirectory, list(typeConf1), NO_PROPERTIES, NO_DETAILPAGES, NO_MODEL_PAGES);
    config1.initialize(rootCms());
    CmsTestConfigData config2 =
        new CmsTestConfigData(
            baseDirectory2, NO_TYPES, NO_PROPERTIES, NO_DETAILPAGES, NO_MODEL_PAGES);
  ...
  public void testCreateContentsLocally2() throws Exception {
    ...
    CmsTestConfigData config2 =
        new CmsTestConfigData(
            baseDirectory2, list(typeConf2), NO_PROPERTIES, NO_DETAILPAGES, NO_MODEL_PAGES);
    config2.setParent(config1);
    config2.initialize(rootCms());

    CmsTestConfigData config3 =
        new CmsTestConfigData(
            baseDirectory3, NO_TYPES, NO_PROPERTIES, NO_DETAILPAGES, NO_MODEL_PAGES);
    ...
    assertEquals(
        ...
        set(
            typeConfigs.get(0).getFolderPath(rootCms(), null),
            typeConfigs.get(1).getFolderPath(rootCms(), null)));
  ...
  public void testCreateContentsLocally4() throws Exception {
    ...
    String baseDirectory2 = "/sites/default/foo";
    CmsResourceTypeConfig typeConf1 =
        new CmsResourceTypeConfig(typename, false, null, "file_%(number)");
  ...
  public void testCreateElements() throws Exception {
    ...
    CmsContentFolderDescriptor folder =
        new CmsContentFolderDescriptor(baseDirectory + "/.content", typename);
    CmsResourceTypeConfig typeConf1 =
        new CmsResourceTypeConfig(typename, false, folder, "file_%(number)");
    CmsTestConfigData config1 =
        new CmsTestConfigData(
  ...
  public void testDefaultFolderName() throws Exception {
    ...
    CmsResourceTypeConfig typeConf1 =
        new CmsResourceTypeConfig("foo", false, null, "pattern_%(number)");
    CmsTestConfigData config1 =
        new CmsTestConfigData(
  ...
  public void testDefaultFolderName2() throws Exception {
    ...
    CmsResourceTypeConfig typeConf2 =
        new CmsResourceTypeConfig("foo", false, null, "patternx_%(number)");
    CmsTestConfigData config2 =
        new CmsTestConfigData(
            "/blah", list(typeConf2), NO_PROPERTIES, NO_DETAILPAGES, NO_MODEL_PAGES);
    config2.setParent(config1);
    config2.initialize(rootCms());
  ...
  public void testDetailPageFiltering() throws Exception {
    ...
    CmsDetailPageInfo foo1 =
        new CmsDetailPageInfo(new CmsUUID(), "/sites/default/a1", "a", "foo", "");
    CmsDetailPageInfo foo2 =
        new CmsDetailPageInfo(new CmsUUID(), "/sites/default/a2", "a", "foo", "");
    CmsDetailPageInfo bar =
        new CmsDetailPageInfo(new CmsUUID(), "/sites/default/a3", "a", "bar", "");
    CmsDetailPageInfo unqualified1 =
        new CmsDetailPageInfo(new CmsUUID(), "/sites/default/a4", "a", null, "");
    CmsDetailPageInfo unqualified2 =
        new CmsDetailPageInfo(new CmsUUID(), "/sites/default/a5", "a", null, "");
    CmsDetailPageInfo unqualifiedDefault =
        new CmsDetailPageInfo(new CmsUUID(), "/sites/default/a6", "##DEFAULT##", null, "");
    CmsDetailPageInfo fooDefault =
        new CmsDetailPageInfo(new CmsUUID(), "/sites/default/a7", "##DEFAULT##", "foo", "");
    final Set<String> qualifiersToMatch = new HashSet<>();
    // we use a dummy that doesn't check categories and just uses the set qualifierToMatch for
    // testing qualifiers
    CmsDetailPageFilter filter =
        new CmsDetailPageFilter(getCmsObject(), (CmsResource) null) {
    ...
    List<CmsDetailPageInfo> infos2 =
        filter
            .filterDetailPages(
                Arrays.asList(
                    fooDefault, unqualifiedDefault, unqualified1, unqualified2, bar, foo1, foo2))
    ...
    infos2 =
        filter
            .filterDetailPages(
                Arrays.asList(
                    foo1, foo2, bar, unqualified1, unqualified2, unqualifiedDefault, fooDefault))
            .collect(Collectors.toList());
    assertEquals(Arrays.asList(unqualified1, unqualified2, unqualifiedDefault), infos2);
    ...
    infos2 =
        filter
            ...
            .collect(Collectors.toList());
    assertEquals(
        Arrays.asList(foo1, foo2, unqualified1, unqualified2, fooDefault, unqualifiedDefault),
        infos2);
  ...
  public void testDetailPages2() throws Exception {
    ...
    CmsDetailPageInfo a1 =
        new CmsDetailPageInfo(getId("/sites/default/a1"), "/sites/default/a1", "a", null, "");
    CmsDetailPageInfo a2 =
        new CmsDetailPageInfo(getId("/sites/default/a2"), "/sites/default/a2", "a", null, "");
    CmsDetailPageInfo a3 =
        new CmsDetailPageInfo(getId("/sites/default/a3"), "/sites/default/a3", "a", null, "");
    CmsDetailPageInfo a4 =
        new CmsDetailPageInfo(getId("/sites/default/a4"), "/sites/default/a4", "a", null, "");

    CmsDetailPageInfo b1 =
        new CmsDetailPageInfo(getId("/sites/default/b1"), "/sites/default/b1", "b", null, "");
    CmsDetailPageInfo b2 =
        new CmsDetailPageInfo(getId("/sites/default/b2"), "/sites/default/b2", "b", null, "");
    ...
    types.add(
        new CmsResourceTypeConfig(
            "a", false, null, null, false, false, false, false, false, false, null, null, true,
            false, 1, null));

    CmsTestConfigData config1 =
        new CmsTestConfigData(
            "/sites/default", types, NO_PROPERTIES, parentDetailPages, NO_MODEL_PAGES);
    config1.initialize(rootCms());

    CmsTestConfigData config2 =
        new CmsTestConfigData(
            "/sites/default/foo", NO_TYPES, NO_PROPERTIES, childDetailPages, NO_MODEL_PAGES);
    config2.initialize(rootCms());
    config2.setParent(config1);
  ...
  public void testDiscardInheritedModelPages() throws Exception {
    ...
    CmsModelPageConfig m1 =
        new CmsModelPageConfig(rootCms().readResource("/sites/default/a1"), true, false);
    CmsModelPageConfig m2 =
        new CmsModelPageConfig(rootCms().readResource("/sites/default/a2"), true, false);
    CmsModelPageConfig m3 =
        new CmsModelPageConfig(rootCms().readResource("/sites/default/a3"), true, false);

    CmsTestConfigData config1 =
        new CmsTestConfigData("/", NO_TYPES, NO_PROPERTIES, NO_DETAILPAGES, list(m1, m2, m3));
    CmsTestConfigData config2 =
        new CmsTestConfigData("/blah", NO_TYPES, NO_PROPERTIES, NO_DETAILPAGES, NO_MODEL_PAGES);
    config1.initialize(rootCms());
    config2.initialize(rootCms());
    config2.setParent(config1);
  ...
  public void testDiscardInheritedProperties() throws Exception {
    ...
    CmsTestConfigData config1 =
        new CmsTestConfigData("/", NO_TYPES, list(foo, bar), NO_DETAILPAGES, NO_MODEL_PAGES);
    CmsTestConfigData config2 =
        new CmsTestConfigData("/blah", NO_TYPES, list(baz), NO_DETAILPAGES, NO_MODEL_PAGES);
  ...
  public void testDiscardInheritedTypes() throws Exception {
    ...
    CmsResourceTypeConfig typeConf1 =
        new CmsResourceTypeConfig("foo", false, folder, "pattern_%(number)");
    CmsResourceTypeConfig typeConf2 =
        new CmsResourceTypeConfig(
            "bar",
            false,
    ...
    CmsTestConfigData config2 =
        new CmsTestConfigData(
            "/", list(typeConf3.copy()), NO_PROPERTIES, NO_DETAILPAGES, NO_MODEL_PAGES);
  ...
  /**
   * Tests that the 'disable all' option in an intermediate sitemap level does not prevent resource
   * type configurations from being inherited.
   *
   * <p>
   *
   * @throws Exception -
  ...
  public void testDiscardInheritedTypesMultilevel() throws Exception {
    ...
    CmsTestConfigData config2 =
        new CmsTestConfigData("/", NO_TYPES, NO_PROPERTIES, NO_DETAILPAGES, NO_MODEL_PAGES);
    config2.setIsDiscardInheritedTypes(true);

    CmsResourceTypeConfig typeConf4 = new CmsResourceTypeConfig("baz", false, null, null);
    CmsTestConfigData config3 =
        new CmsTestConfigData("/", list(typeConf4), NO_PROPERTIES, NO_DETAILPAGES, NO_MODEL_PAGES);
  ...
  public void testInheritedFolderName1() throws Exception {
    ...
    CmsContentFolderDescriptor folder =
        new CmsContentFolderDescriptor("/somefolder/.content", "blah");
    CmsResourceTypeConfig typeConf1 =
        new CmsResourceTypeConfig("foo", false, folder, "pattern_%(number)");
    CmsTestConfigData config1 =
        new CmsTestConfigData(
            "/somefolder", list(typeConf1), NO_PROPERTIES, NO_DETAILPAGES, NO_MODEL_PAGES);
    config1.initialize(rootCms());

    CmsTestConfigData config2 =
        new CmsTestConfigData(
            "/somefolder/somesubfolder", NO_TYPES, NO_PROPERTIES, NO_DETAILPAGES, NO_MODEL_PAGES);
  ...
  public void testInheritNamePattern() throws Exception {
    ...
    CmsTestConfigData config1 =
        new CmsTestConfigData("/", list(typeConf1), NO_PROPERTIES, NO_DETAILPAGES, NO_MODEL_PAGES);
    config1.initialize(rootCms());
    CmsTestConfigData config2 =
        new CmsTestConfigData(
            "/sites/default", list(typeConf2), NO_PROPERTIES, NO_DETAILPAGES, NO_MODEL_PAGES);
    config2.initialize(rootCms());
    config2.setParent(config1);
  ...
  public void testInheritProperties() throws Exception {
    ...
    List<CmsPropertyConfig> propConf1 =
        list(
    ...
    CmsTestConfigData config1 =
        new CmsTestConfigData("/somefolder", NO_TYPES, propConf1, NO_DETAILPAGES, NO_MODEL_PAGES);
    config1.initialize(rootCms());
    List<CmsPropertyConfig> propConf2 =
        list(
    ...
    CmsTestConfigData config2 =
        new CmsTestConfigData(
            "/somefolder/somesubfolder", NO_TYPES, propConf2, NO_DETAILPAGES, NO_MODEL_PAGES);
    config2.initialize(rootCms());
    config2.setParent(config1);
  ...
  public void testInheritResourceTypes1() throws Exception {
    ...
    CmsTestConfigData config1 =
        new CmsTestConfigData("/", list(typeConf1), NO_PROPERTIES, NO_DETAILPAGES, NO_MODEL_PAGES);
    CmsTestConfigData config2 =
        new CmsTestConfigData("/", list(typeConf2), NO_PROPERTIES, NO_DETAILPAGES, NO_MODEL_PAGES);
    config1.initialize(rootCms());
    config2.initialize(rootCms());
    config2.setParent(config1);
    List<CmsResourceTypeConfig> resourceTypeConfig = config2.getResourceTypes();
  ...
  public void testModelPages1() throws Exception {
    ...
    CmsTestConfigData config1 =
        new CmsTestConfigData(
            "/sites/default", NO_TYPES, NO_PROPERTIES, NO_DETAILPAGES, list(a1, a2));
    config1.initialize(rootCms());

    CmsTestConfigData config2 =
        new CmsTestConfigData(
            "/sites/default/foo", NO_TYPES, NO_PROPERTIES, NO_DETAILPAGES, list(b1, b2));
    config2.initialize(rootCms());
    config2.setParent(config1);

    List<CmsModelPageConfig> modelpages = config2.getModelPages();
    assertEquals(
        b1.getResource().getStructureId(), modelpages.get(0).getResource().getStructureId());
    assertEquals(
        b2.getResource().getStructureId(), modelpages.get(1).getResource().getStructureId());
    assertEquals(
        a1.getResource().getStructureId(), modelpages.get(2).getResource().getStructureId());
    assertEquals(
        a2.getResource().getStructureId(), modelpages.get(3).getResource().getStructureId());
    assertEquals(
        b1.getResource().getStructureId(),
        config2.getDefaultModelPage().getResource().getStructureId());
  }
  ...
  public void testParseConfiguration() throws Exception {
    ...
    CmsADEConfigDataInternal configDataInternal =
        configReader.parseSitemapConfiguration("/", cms.readResource("/sites/default/test.config"));
  ...
  public void testParseModuleConfiguration() throws Exception {
    ...
    CmsConfigurationReader configReader = new CmsConfigurationReader(rootCms());
    CmsADEConfigDataInternal configDataInternal =
        configReader.parseSitemapConfiguration(
  ...
  public void testPluginInheritance() throws Exception {
    ...
    CmsTestConfigData c0 =
        CmsTestConfigData.buildTestDataForPlugins(
            getCmsObject(), "/", false, new HashSet<>(Arrays.asList(d)), new HashSet<>());
    CmsTestConfigData c1 =
        CmsTestConfigData.buildTestDataForPlugins(
            getCmsObject(), "/foo", true, new HashSet<>(Arrays.asList(a, b)), new HashSet<>());
    CmsTestConfigData c2 =
        CmsTestConfigData.buildTestDataForPlugins(
            getCmsObject(),
            "/foo/bar",
            false,
  ...
  public void testRemoveResourceType() throws Exception {
    ...
    CmsTestConfigData config2 =
        new CmsTestConfigData("/", list(removeType), NO_PROPERTIES, NO_DETAILPAGES, NO_MODEL_PAGES);
  ...
  public void testResolveFolderName1() throws Exception {
    ...
    CmsContentFolderDescriptor folder =
        new CmsContentFolderDescriptor("/somefolder/somesubfolder/.content", "blah");
    CmsResourceTypeConfig typeConf1 =
        new CmsResourceTypeConfig("foo", false, folder, "pattern_%(number)");
    CmsTestConfigData config1 =
        new CmsTestConfigData(
  ...
  public void testResourceTypeConfigObjectsNotSame() throws Exception {
    ...
    CmsTestConfigData t1 =
        new CmsTestConfigData("/", list(c1), NO_PROPERTIES, NO_DETAILPAGES, NO_MODEL_PAGES);
    CmsTestConfigData t2 =
        new CmsTestConfigData("/", NO_TYPES, NO_PROPERTIES, NO_DETAILPAGES, NO_MODEL_PAGES);
  ...
  public void testUnsetTypeAvailability() throws Exception {
    ...
    types.add(
        new CmsResourceTypeConfig(
            "a", false, null, null, false, true, true, false, false, false, null, null, true, false,
            1, null));

    List<CmsResourceTypeConfig> childTypes = new ArrayList<CmsResourceTypeConfig>();
    childTypes.add(
        new CmsResourceTypeConfig(
            "a", false, null, null, false, false, false, false, false, true, null, null, true,
            false, 1, null));

    CmsTestConfigData config1 =
        new CmsTestConfigData(
            "/sites/default", types, NO_PROPERTIES, new ArrayList<>(), NO_MODEL_PAGES);
    config1.initialize(rootCms());

    CmsTestConfigData config2 =
        new CmsTestConfigData(
            "/sites/default/foo", childTypes, NO_PROPERTIES, new ArrayList<>(), NO_MODEL_PAGES);
    config2.initialize(rootCms());
    config2.setParent(config1);
  ...
  protected void assertPathEquals(String path1, String path2) {
    ...
    assertEquals(
        CmsStringUtil.joinPaths("/", path1, "/"), CmsStringUtil.joinPaths("/", path2, "/"));
  }
  ...
  protected CmsXmlContentProperty createXmlContentProperty(String name, String description) {
    ...
    return new CmsXmlContentProperty(
        name, "string", "string", "", "", "", "", "", description, null, null);
  }
  ...
  protected void dumpTree(CmsObject cms, CmsResource res, int indentation) throws CmsException {
    ...
    if (resType.isFolder()) {
      List<CmsResource> children =
          cms.getResourcesInFolder(res.getRootPath(), CmsResourceFilter.ALL);
