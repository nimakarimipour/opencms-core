...
public class TestBaseModule extends OpenCmsTestCase {
        ...
        if (schema != null) {
          if (!schemaBlacklist.contains(schema)) {
            CmsXmlContentDefinition contentDef =
                CmsXmlContentDefinition.unmarshal("opencms:/" + schema, entityResolver);
  ...
  private void checkContentDefinition(
      CmsContentTypeVisitor visitor, String schema, CmsXmlContentDefinition contentDef)
      throws Exception {
