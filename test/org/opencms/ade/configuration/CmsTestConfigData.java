...
public class CmsTestConfigData extends CmsADEConfigData {
  ...
  private Map<Integer, CmsFormatterConfiguration> m_schemaFormatterConfiguration =
      new HashMap<Integer, CmsFormatterConfiguration>();
  ...
  /**
   * Sets the CmsObject for testing.
   *
   * <p>
   *
  ...
  /**
   * Registers a schema formatter which will be returned from getSchemaFormatters if a resource with
   * the matching type is passed in.
   *
   * <p>
   *
   ...
   * <p>
   *
   * @param createContentsLocally the flag to control whether contents from inherited resource types
   *     are stored in the local .content folder
   */
   ...
   * <p>
   *
   * @param discardInheritedModelPages the flag to control whether inherited model pages are
   *     discarded
   */
  ...
  /**
   * Sets the formatter cache state.
   *
   * <p>
   *
  ...
  /**
   * Marks this as a module configuration or normal sitemap configuration.
   *
   * <p>
   *
  ...
  /**
   * @see
   *     org.opencms.ade.configuration.CmsADEConfigData#getFormattersFromSchema(org.opencms.file.CmsObject,
