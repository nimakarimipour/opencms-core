...
public class TestCmsGallerySearchBasic extends OpenCmsTestCase {
  ...
  public static void printResults(
      CmsGallerySearchResultList searchResult, CmsObject cms, boolean showExcerpt) {
  ...
  /**
   * Creates the configured search indexes for all other test cases in this class.
   *
   * <p>
   *
  ...
  /**
   * Tests searching documents by their structure ID.
   *
   * <p>
   *
   * @throws Exception
  ...
  public void testSearchById() throws Exception {
    ...
    CmsGallerySearchResult result =
        search.searchById(new CmsUUID("7d6c22cd-4e3a-11db-9016-5bf59c6009b3"), new Locale("en"));
