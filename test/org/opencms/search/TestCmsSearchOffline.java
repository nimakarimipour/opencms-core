...
/**
 * Unit test for searching in "offline" indexes, added with OpenCms version 7.5.
 *
 * <p>
 */
public class TestCmsSearchOffline extends OpenCmsTestCase {
  ...
  /**
   * Tests automatic index update after modification of a resource.
   *
   * <p>
   *
  ...
  public void testIndexUpdateOnModification() throws Exception {
    ...
    cms.writePropertyObject(
        fileName,
        new CmsProperty(
            CmsPropertyDefinition.PROPERTY_TITLE, "Alkacon OpenCms IN THE NEW FILE", ""));
    ...
    cms.createResource(
        fileName222, CmsResourceTypePlain.getStaticTypeId(), text222.getBytes(), null);
    // wait for the offline index
    waitForUpdate();
