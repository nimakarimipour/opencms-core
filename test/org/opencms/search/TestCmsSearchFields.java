...
public class TestCmsSearchFields extends OpenCmsTestCase {
  ...
  public void testExcerptCreationFromFields() throws Exception {
    ...
    // so an excerpt is generated for some results even though the searches "special" field has no
    // excerpt at all
  ...
  /**
   * Tests searching in non-standard fields for specific Strings that are placed in various document
   * formats.
   *
   * <p>
   *
  ...
  /**
   * Tests searching with a field query, that is a query over multiple fields with different search
   * terms per field.
   *
   * <p>
   *
