...
/**
 * Utility class for thread analyzing.
 *
 * <p>
 */
public final class TestThreadUtils {
  ...
  /**
   * Returns the thread that is blocking the given one.
   *
   * <p>
   *
  ...
  /**
   * Returns a list of all threads belonging to one thread group.
   *
   * <p>
   *
  ...
  /**
   * Returns the thread that is locking the thread identified by the given id.
   *
   * <p>
   *
  ...
  /**
   * Returns the locking thread for the given object.
   *
   * <p>
   *
  ...
  /**
   * Returns the thread for the given id.
   *
   * <p>
   *
  ...
  /**
   * Returns the thread for the given name.
   *
   * <p>
   *
  ...
  /**
   * Returns the thread info for the thread identified by the given id.
   *
   * <p>
   *
   * @param id the id og the thread to get the info for
   * @return the thread info for the thread identified by the given id or <code>null</code> if not
   *     existent
   */
  ...
  /**
   * Returns the thread info for the thread identified by the given name.
   *
   * <p>
   *
   * @param name the name of the thread to get the info for
   * @return the thread info for the thread identified by the given name or <code>null</code> if not
   *     existent
   */
  ...
  /**
   * Returns the thread info of the given thread.
   *
   * <p>
   *
