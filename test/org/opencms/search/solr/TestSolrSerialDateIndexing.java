...
public class TestSolrSerialDateIndexing extends OpenCmsTestCase {
  ...
  /**
   * Tests if a series content is indexed correctly many times and if all entries are removed, if
  ...
  public void testIndexingAndDeletion() throws Exception {
    ...
    results = index.search(cms, query);
    assertEquals(
        "The content should not be found anymore, since it was deleted.", 0, results.getNumFound());
