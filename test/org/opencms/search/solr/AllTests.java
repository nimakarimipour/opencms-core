...
/**
 * Main test suite for the package <code>{@link org.opencms.search.solr}</code>.
 *
 * <p>
 *
 * @since 8.5.0
...
public final class AllTests {
  ...
  /**
   * Returns the search resource from the result by the given path.
   *
   * <p>
   *
          ...
          CmsStringUtil.padRight(
              ""
                  + CmsDateUtil.getDateTime(
                      new Date(res.getDateLastModified()), DateFormat.SHORT, Locale.GERMAN),
              17));
