...
public class TestSolrConfiguration extends OpenCmsTestCase {
  ...
  public void testExtractionResults() throws Throwable {
    ...
    CmsResource res =
        cms.createSibling(
            "/xmlcontent/link_article_0001.html", "/xmlcontent/link2_article_0001.html", null);
    ...
    I_CmsDocumentFactory factory =
        OpenCms.getSearchManager().getDocumentFactoryForName(docTypeName);
  ...
  public void testMaxResultConfiguration() {
    ...
    assertEquals(
        ...
        OpenCms.getSearchManager()
            .getIndexSolr(CmsSolrIndex.DEFAULT_INDEX_NAME_ONLINE)
            .getMaxProcessedResults());
    assertEquals(
        1000,
        OpenCms.getSearchManager()
            .getIndexSolr(CmsSolrIndex.DEFAULT_INDEX_NAME_OFFLINE)
            .getMaxProcessedResults());
  }
  ...
  public void testPostProcessor() throws Exception {
    ...
    CmsSearchResource res =
        AllTests.getByPath(results, "/sites/default/xmlcontent/article_0001.html");
    String link = res.getDocument().getFieldValueAsString("link");
    assertEquals(getVfsPrefix() + "/xmlcontent/article_0001.html", link);
  }

  /**
   * Test result count for changed content of two siblings.
   *
   * <p>
   *
  ...
  public void testReindexPublishedSiblings() throws Throwable {
    ...
    CmsProperty firstTitleProperty =
        new CmsProperty(CmsPropertyDefinition.PROPERTY_TITLE, "BROTHER AND SISTER", null);
  ...
  public void testShutDown() throws Throwable {
    ...
    OpenCms.getSearchManager()
        .rebuildIndex(AllTests.INDEX_TEST, new CmsShellReport(Locale.ENGLISH));
    for (int i = 0; i < 250; i++) {
