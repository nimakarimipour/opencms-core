...
public class TestMsExcelExtraction extends OpenCmsTestCase {
  ...
  /**
   * Tests the Excel text extraction for old OLE2 documents.
   *
   * <p>
   *
  ...
  public void testExcelExtractionOLE2() throws Exception {
    ...
    InputStream in =
        getClass().getClassLoader().getResourceAsStream("org/opencms/search/extractors/test1.xls");
  ...
  /**
   * Tests the Excel text extraction for new (MS Office 2007) OOXML documents.
   *
   * <p>
   *
   * @throws Exception if the test fails
  ...
  public void testExcelExtractionOOXML() throws Exception {
    ...
    @SuppressWarnings("resource")
    InputStream in =
        getClass().getClassLoader().getResourceAsStream("org/opencms/search/extractors/test1.xlsx");
