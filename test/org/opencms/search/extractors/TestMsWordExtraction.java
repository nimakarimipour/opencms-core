...
/**
 * Tests the text extraction form a Word file.
 *
 * <p>
 */
public class TestMsWordExtraction extends OpenCmsTestCase {
  ...
  /**
   * Tests the Word text extraction for old OLE2 documents.
   *
   * <p>
   *
  ...
  public void testWordExtractionOLE2() throws Exception {
    ...
    InputStream in =
        getClass().getClassLoader().getResourceAsStream("org/opencms/search/extractors/test1.doc");
  ...
  public void testWordExtractionOOXML() throws Exception {
    ...
    @SuppressWarnings("resource")
    InputStream in =
        getClass().getClassLoader().getResourceAsStream("org/opencms/search/extractors/test1.docx");
    ...
    System.out.println("\n\n---------------------------------------------------------------");
    System.out.println("Extracted from MS Word (Office 2007 OOXML):");
    Iterator<Map.Entry<String, String>> i = items.entrySet().iterator();
    while (i.hasNext()) {
      Map.Entry<String, String> e = i.next();
      System.out.println("\nKey: " + e.getKey());
