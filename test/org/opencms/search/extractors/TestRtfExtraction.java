...
/**
 * Tests the text extraction form a RTF file.
 *
 * <p>
 */
public class TestRtfExtraction extends OpenCmsTestCase {
  ...
  /**
   * Tests the basic RTF extraction.
   *
   * <p>
   *
  ...
  public void testBasicRtfExtraction() throws Exception {
    ...
    InputStream in =
        getClass().getClassLoader().getResourceAsStream("org/opencms/search/extractors/test1.rtf");
    ...
    // This should be 6, adding 5 for CmsTextExtractor.extractText, and adding one for new
    // CmsExtractionResult.
