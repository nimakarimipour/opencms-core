...
public class TestCmsSearchInDocuments extends OpenCmsTestCase {
  ...
  public void testExceptHighlighting() throws Exception {
    ...
    OpenCms.getSearchManager()
        .rebuildIndex(INDEX_ONLINE, new CmsLogReport(Locale.ENGLISH, getClass()));
   ...
   *
   * <p>Please note: This method need to be called first in this test suite, the other methods
   * depend on the index generated here.
   *
   * <p>
   *
   * @throws Exception if the test fails
