...
public class TestCmsSearchAdvancedFeatures extends OpenCmsTestCase {
  ...
  public void testLimitTimeRanges() throws Exception {
    ...
    assertTrue(
        "Index '" + INDEX_OFFLINE + "' not checking time range as expected",
  ...
  public void testLimitTimeRangesOptimized() throws Exception {
    ...
    assertFalse(
        "Index '" + INDEX_OFFLINE + "' checking time range but should not",
        index.isCheckingTimeRange());
  ...
  public void testSearchCategories() throws Exception {
    ...
    CmsProperty cat1 =
        new CmsProperty(CmsPropertyDefinition.PROPERTY_SEARCH_CATEGORY, "category_1", null, true);
    CmsProperty cat2 =
        new CmsProperty(CmsPropertyDefinition.PROPERTY_SEARCH_CATEGORY, "category_2", null, true);
    CmsProperty cat3 =
        new CmsProperty(CmsPropertyDefinition.PROPERTY_SEARCH_CATEGORY, "category_3", null, true);
    ...
    OpenCms.getSearchManager()
        .rebuildIndex(INDEX_OFFLINE, new CmsShellReport(cms.getRequestContext().getLocale()));
  ...
  public void testSearchRestriction() throws Exception {
    ...
    // now create a restriction to search for an additional "Alkacon" (effectivly searching for
    // "OpenCms Alkacon")
    ...
    restriction =
        new CmsSearchParameters(
            "Alkacon", Arrays.asList(new String[] {"meta"}), null, null, null, false, null);
