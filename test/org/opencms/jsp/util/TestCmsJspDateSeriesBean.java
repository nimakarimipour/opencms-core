...
public class TestCmsJspDateSeriesBean extends OpenCmsTestCase {
  ...
  /**
   * Tests if the correct event info is returned, specifically if for missing insatncedate, the
   * first instance is returned.
   */
  public void testGetEventInfo() {

    String config =
        "{\"from\":\"1508396400000\", \"to\":\"1508511600000\", \"pattern\":{\"type\":\"NONE\"}}";
  ...
  public void testGetSpecialInstances() {
    ...
    String config =
        "{\"from\":\"1491202800000\", \"to\":\"1491231600000\", \"pattern\":{\"type\":\"INDIVIDUAL\", \"dates\":[\""
            + twoDaysAgo
            + "\",\""
            + oneDayAgo
            + "\",\""
