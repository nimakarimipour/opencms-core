...
/**
 * Unit tests for the <code>{@link CmsJspResourceWrapper}</code>.
 *
 * <p>
 */
public class TestCmsJspResourceWrapper extends OpenCmsTestCase {
  ...
  /**
   * Tests for basic wrapper methods.
   *
   * <p>
   *
  ...
  public void testBasics() throws Exception {
    ...
    CmsJspResourceWrapper topFileRes =
        CmsJspResourceWrapper.wrap(cms, cms.readResource("/index.html"));
    CmsJspResourceWrapper folderRes =
        CmsJspResourceWrapper.wrap(cms, cms.readResource("/folder1/"));
    CmsJspResourceWrapper fileRes =
        CmsJspResourceWrapper.wrap(cms, cms.readResource("/folder1/index.html"));
    CmsJspResourceWrapper subFolderRes =
        CmsJspResourceWrapper.wrap(cms, cms.readResource("/folder1/subfolder12/"));
    CmsJspResourceWrapper subFileRes =
        CmsJspResourceWrapper.wrap(cms, cms.readResource("/folder1/subfolder12/index.html"));
  ...
  /**
   * Tests for nav elements with wrapper.
   *
   * <p>
   *
   * @throws Exception if the test fails
  ...
  public void testNavElements() throws Exception {
    ...
    // default file access
    CmsJspResourceWrapper indexRes =
        CmsJspResourceWrapper.wrap(cms, cms.readResource("/folder1/index.html"));
  ...
  /**
   * Tests for parent folder access.
   *
   * <p>
   *
   * @throws Exception if the test fails
  ...
  public void testParentFolders() throws Exception {
    ...
    CmsJspResourceWrapper topFolderRes = CmsJspResourceWrapper.wrap(cms, cms.readResource("/"));
    CmsJspResourceWrapper folder1Res =
        CmsJspResourceWrapper.wrap(cms, cms.readResource("/folder1/"));
    CmsJspResourceWrapper folderRes =
        CmsJspResourceWrapper.wrap(cms, cms.readResource("/folder1/subfolder12/"));
    CmsJspResourceWrapper fileRes =
  ...
  /**
   * Tests for wrapper access to properties.
   *
   * <p>
   *
   * @throws Exception if the test fails
  ...
  public void testProperties() throws Exception {
    ...
    CmsJspResourceWrapper wrap1 =
        CmsJspResourceWrapper.wrap(cms, cms.readResource("/test_read_property_locale/test.txt"));
  ...
  public void testRelations() throws Exception {
    ...
    assertEquals(
        ...
        srcWrapper.getOutgoingRelations().stream()
    ...
    assertEquals(
        ...
        tgtWrapper.getIncomingRelations().stream()
            .map(res -> res.getStructureId())
            .collect(Collectors.toList()));
  ...
  /**
   * Tests for resource wrapper identities.
   *
   * <p>
   *
   * @throws Exception if the test fails
  ...
  public void testResourceIdentities() throws Exception {
    ...
    // wrapper created from different contexts with different URI are not the same, but must be
    // equal
  ...
  /**
   * Tests for the {@link CmsJspVfsAccessBean#getReadXml()} method.
   *
   * <p>
   *
   * @throws Exception if the test fails
  ...
  public void testXml() throws Exception {
    ...
    // access XML content
    CmsJspResourceWrapper res1 =
        CmsJspResourceWrapper.wrap(cms, cms.readResource("/xmlcontent/article_0001.html"));
    ...
    // access file as XML
    CmsJspResourceWrapper fileRes =
        CmsJspResourceWrapper.wrap(cms, cms.readResource("/folder1/image1.gif"));
