...
public class TestCmsJspVfsAccessBean extends OpenCmsTestCase {
  ...
  /**
   * Sets up a locale properties test scenario.
   *
   * <p>
   *
  ...
  /**
   * Tests for the {@link CmsJspVfsAccessBean#getExistsXml()} method.
   *
   * <p>
   *
  ...
  /**
   * Tests for the {@link CmsJspVfsAccessBean#getReadProperties()} method.
   *
   * <p>
   *
   * @throws Exception if the test fails
  ...
  public void testReadProperties() throws Exception {
    ...
    CmsProperty titleProp =
        cms.readPropertyObject("/index.html", CmsPropertyDefinition.PROPERTY_TITLE, false);
    assertEquals(titleProp.getValue(), title);
  }

  /**
   * Tests for the {@link CmsJspVfsAccessBean#getReadPropertiesLocale()} method.
   *
   * <p>
   *
   * @throws Exception if the test fails
  ...
  /**
   * Tests for the {@link CmsJspVfsAccessBean#getReadResource()} method.
   *
   * <p>
   *
   * @throws Exception if the test fails
