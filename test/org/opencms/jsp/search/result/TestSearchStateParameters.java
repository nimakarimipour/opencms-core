...
public class TestSearchStateParameters extends OpenCmsTestCase {
   ...
   */
  @org.junit.Test
  public void testAddRemoveAdditionalParam()
      throws CmsException, IOException, URISyntaxException, JSONException {
   ...
   */
  @org.junit.Test
  public void testCheckAndUncheckFacetItems()
      throws CmsException, IOException, URISyntaxException, JSONException {
   ...
   * @throws JSONException ...
   */
  private I_CmsSearchResultWrapper search()
      throws CmsException, IOException, URISyntaxException, JSONException {

    String configString =
        new String(Files.readAllBytes(Paths.get(getClass().getResource("config.json").toURI())));
    ...
    if (common.getState().getQuery().isEmpty()
      ...
      searchResult =
          new CmsSearchResultWrapper(searchController, solrResultList, query, getCmsObject(), null);
    }
    return searchResult;
  }
}
