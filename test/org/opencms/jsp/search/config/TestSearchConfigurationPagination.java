...
public class TestSearchConfigurationPagination extends OpenCmsTestCase {
  ...
  public static Test suite() {
    ...
    suite.addTest(
        new TestSearchConfigurationPagination("testGetNumPagesForSingleMultiplePageSizes"));
    suite.addTest(new TestSearchConfigurationPagination("testGetNumPagesForSinglePageSize"));
    suite.addTest(
        new TestSearchConfigurationPagination("testPageSizeAndStartForMultiplePageSizes"));
  ...
  public void testGetNumPagesForSingleMultiplePageSizes() {
    ...
    I_CmsSearchConfigurationPagination config =
        new CmsSearchConfigurationPagination(null, pageSizes, null);
  ...
  /**
   * Test if the page sizes and the index of the first items on the page are calculated correctly,
   * if all pages have the same size.
   */
  @org.junit.Test
  ...
  /**
   * Test if the page sizes and the index of the first items on the page are calculated correctly,
   * if the first few pages have different sizes.
   */
  @org.junit.Test
