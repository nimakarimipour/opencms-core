...
public class OpenCmsTestResourceStorage {
   ...
   *
   * <p>This is required to find resources in the resource storage afer their path in the vfs has
   * changed (e.g. after a copy operation).
   *
   * <p>
   *
  ...
  /**
   * Precalculates the state of a resource after an operation based on its state before the
   * operation is excecuted.
   *
   * <p>The following states are precalculated:
   *
   * <ul>
   *   <li>Unchanged -> Changed
   *   <li>Changed -> Changed
   *   <li>New -> New
   *   <li>Deleted -> Deleted
   * </ul>
