...
/**
 * Allows to run an {@link org.opencms.test.OpenCmsTestCase} in a separate Thread, for concurrent
 * execution.
 *
 * <p>Usually this class is created by a {@link org.opencms.test.OpenCmsThreadedTestCaseSuite}.
 *
 * <p>
 *
 * @since 6.5.0
...
public class OpenCmsThreadedTestCase extends Thread {
  ...
  /**
   * Returns the total runtime of this thread, or <code>-1</code> if the thread was not run at all.
   *
   * <p>
   *
  ...
  /**
   * Returns the stored Throwable that was thrown when executing the selected test method, or <code>
   * null</code> if the test method did not cause an exception.
   *
   * <p>
   *
   * @return the stored Throwable that was thrown when executing the selected test method, or <code>
   *     null</code> if the test method did not cause an exception
   */
