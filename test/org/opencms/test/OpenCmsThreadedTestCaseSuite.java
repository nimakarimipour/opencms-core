...
/**
 * Allows to run a specific method of an {@link org.opencms.test.OpenCmsTestCase} case concurrently.
 *
 * <p>
 *
 * @since 6.5.0
...
public class OpenCmsThreadedTestCaseSuite {
   ...
   *
   * <p>The <code>parameters</code> array may contain the following placeholders:
   *
   * <ul>
   *   <li>{@link #PARAM_CMSOBJECT}: This will be replaced by a new {@link CmsObject} instance.
   *   <li>{@link #PARAM_COUNTER}: This will be replaced by an integer counter with the number of
   ...
   */
  public OpenCmsThreadedTestCaseSuite(
      int count, OpenCmsTestCase testCase, String method, Object[] parameters) {
  ...
  /**
   * Returns a list of {@link OpenCmsThreadedTestCase} instances that will be executed concurrently
   * by this suite.
   *
   * <p>
   *
   ...
   * @return a list of {@link OpenCmsThreadedTestCase} instances that will be executed concurrently
   *     by this suite
   * @throws Exception if something goes wrong
   */
  private static OpenCmsThreadedTestCase[] initThreads(
      int count, OpenCmsTestCase testCase, Method method, Object[] parameters) throws Exception {
   ...
   *
   * <p>If the given limit is exceeded, then this suite will stop waiting for the running test cases
   * to finish and generate an internal exception.
   *
   * <p>The default is the number of threads multiplied by 100 milliseconds.
   *
   * <p>
   *
  ...
  /**
   * Returns the error that that may have been caused while initializing or running this suite, or
   * <code>null</code> in case no error was thrown.
   *
   * <p>
   *
   * @return the error that that may have been caused while initializing or running this suite, or
   *     <code>null</code> in case no error was thrown
   */
   ...
   *
   * <p>Returns the array of generated {@link OpenCmsThreadedTestCase} instances, which contain
   * information about the individual test results.
   *
   * <p>*
   *
  ...
  public OpenCmsThreadedTestCase[] run() {
    ...
    if (m_throwable == null) {
      // there may have been an exception acessing the selected method, so the test cases can not
      // run at all
