...
/**
 * OpenCms main test suite, executes the individual test suites of all core packages.
 *
 * <p>
 *
 * @since 6.0
...
public final class AllTests {
  ...
  public static Test suite() {
    ...
    suite.addTest(
        org.opencms.jsp.search.config.parser.simplesearch.preconfiguredrestrictions.AllTests
            .suite());
