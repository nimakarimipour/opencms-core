...
/**
 * Base filter class for OpenCms VFS access method tests.
 *
 * <p>A filter defines the attributes of a CmsResource which must not be changed after a method call
 * in the CmsObject.
 *
 * <p>To use a filter, either use the static filters provided by this class, or create an instance
 * of {@link org.opencms.test.OpenCmsTestResourceConfigurableFilter}.
 *
 * <p>
 */
public abstract class OpenCmsTestResourceFilter {
  ...
  public static final OpenCmsTestResourceFilter FILTER_COPY_SOURCE_DESTINATION_AS_SIBLING =
      getFilterCopySourceDestinationAsSibling();
  ...
  public static final OpenCmsTestResourceFilter FILTER_EQUAL =
      new OpenCmsTestResourceConfigurableFilter();

  /**
   * Definition of a filter used to validate the existing and the new sibling after a copy
   * operation.
   */
  public static final OpenCmsTestResourceFilter FILTER_EXISTING_AND_NEW_SIBLING =
      getFilterExistingAndNewSibling();

  /** Definition of a filter used to validate an existing sibling after a copy operation. */
  public static final OpenCmsTestResourceFilter FILTER_EXISTING_SIBLING =
      getFilterExistingSibling();
  ...
  public static final OpenCmsTestResourceFilter FILTER_IMPORTEXPORT_OVERWRITE =
      getFilterImportExportOverwrite();

  /** Definition of a filter used to validate an existing sibling after a copy operation. */
  public static final OpenCmsTestResourceFilter FILTER_IMPORTEXPORT_SIBLING =
      getFilterImportExportSibling();

  /**
   * Definition of a filter used for the move/rename method, will also check the structure id and
   * sibling count.
   */
  public static final OpenCmsTestResourceFilter FILTER_MOVE_DESTINATION =
      getFilterMoveDestination();
  ...
  /**
   * Definition of a filter used for the writeProperty method, for an individual property in the
   * other sibling.
   */
  public static final OpenCmsTestResourceFilter FILTER_SIBLING_PROPERTY =
      getFilterSiblingProperty();
  ...
  /** Definition of a filter used for the undoChanges method. */
  public static final OpenCmsTestResourceFilter FILTER_UNDOCHANGES_CONTENT =
      getFilterUndoChangesContent();
  ...
  /**
   * Compares two lists of properties and returns those that are included only in the source but not
   * in the targer list and not part of a seperade exclude list.
   *
   * <p>
   *
  ...
  public static List<CmsProperty> compareProperties(
      List<CmsProperty> source, List<CmsProperty> target, List<CmsProperty> exclude) {
  ...
  /**
   * Creates a new filter used for the "chflags" method.
   *
   * <p>
   *
   * @return the created filter
  ...
  /**
   * Creates a new filter used for the "chtype" method.
   *
   * <p>
   *
   * @return the created filter
  ...
  /**
   * Creates a new filter used for the "copy a file as new" method.
   *
   * <p>
   *
   * @return the created filter
  ...
  /**
   * Creates a new filter used for the "copy a folder" method.
   *
   * <p>
   *
   * @return the created filter
  ...
  /**
   * Creates a new filter used for the "copy as sibling" method.
   *
   * <p>
   *
   * @return the created filter
  ...
  /**
   * Creates a new filter used for the "create resource" method.
   *
   * <p>
   *
   * @return the created filter
  ...
  /**
   * Creates a new filter used to validate the fields of a new sibling different from the existing
   * sibling(s) from which it was created.
   *
   * <p>
   *
   * @return the created filter
  ...
  /**
   * Creates a new filter used to validate the modified fields of an existing resource from which a
   * new sibling was created.
   *
   * <p>
   *
   * @return the created filter
  ...
  /**
   * Creates a new filter used for the "import/export" of a new file.
   *
   * <p>
   *
   * @return the created filter
  ...
  /**
   * Creates a new filter used for the "import/export" when overwriting an existing file.
   *
   * <p>
   *
   * @return the created filter
  ...
  /**
   * Creates a new filter used for the "import/export" of sibling of an existing file.
   *
   * <p>
   *
   * @return the created filter
  ...
  /**
   * Creates a new filter used for the "move/rename" method.
   *
   * <p>
   *
   * @return the created filter
  ...
  /**
   * Creates a new filter used for the "publishResource" method.
   *
   * <p>
   *
   * @return the created filter
  ...
  /**
   * Creates a new filter used for the "replaceResource" method.
   *
   * <p>
   *
   * @return the created filter
  ...
  /**
   * Creates a new filter used for the "write property" method, with individual property on the
   * other sibling.
   *
   * <p>
   *
  ...
  /**
   * Creates a new filter used for the "touch" method.
   *
   * <p>
   *
   * @return the created filter
  ...
  /**
   * Creates a new filter used for the "undoChanges" method.
   *
   * <p>
   *
   * @return the created filter
  ...
  /**
   * Creates a new filter used for the "undoChanges" method without move operation.
   *
   * <p>
   *
   * @return the created filter
  ...
  /**
   * Creates a new filter used for the "write property" method.
   *
   * <p>
   *
   * @return the created filter
  ...
  /**
   * Returns true if the ace test is enabled.
   *
   * <p>
   *
  ...
  /**
   * Returns true if the acl test is enabled.
   *
   * <p>
   *
   * @return true or false
  ...
  /**
   * Returns true if the Contents test is enabled.
   *
   * <p>
   *
   * @return true or false
  ...
  /**
   * Returns true if the date content test is enabled.
   *
   * <p>
   *
   * @return true or false
  ...
  /**
   * Returns true if the date created test is enabled.
   *
   * <p>
   *
   * @return true or false
  ...
  /**
   * Returns true if the date created test (rounded to seconds, for imports) is enabled.
   *
   * <p>
   *
   * @return true or false
  ...
  /**
   * Returns true if the date expired test is enabled.
   *
   * <p>
   *
   * @return true or false
  ...
  /**
   * Returns true if the date last modified test is enabled.
   *
   * <p>
   *
   * @return true or false
  ...
  /**
   * Returns true if the date last modified test (rounded to seconds, for imports) is enabled.
   *
   * <p>
   *
   * @return true or false
  ...
  /**
   * Returns true if the date released test is enabled.
   *
   * <p>
   *
   * @return true or false
  ...
  /**
   * Returns true if the flags test is enabled.
   *
   * <p>
   *
   * @return true or false
  ...
  /**
   * Returns true if the length test is enabled.
   *
   * <p>
   *
   * @return true or false
  ...
  /**
   * Returns true if the lockstate test is enabled.
   *
   * <p>
   *
   * @return true or false
  ...
  /**
   * Returns true if the name test is enabled.
   *
   * <p>
   *
   * @return true or false
  ...
  /**
   * Returns true if non-content relations should be compared.
   *
   * <p>
   *
  ...
  /**
   * Returns true if the project last modified test is enabled.
   *
   * <p>
   *
   * @return true or false
  ...
  /**
   * Returns true if the properties test is enabled.
   *
   * <p>
   *
   * @return true or false
  ...
  /**
   * Returns true if the resource Id test is enabled.
   *
   * <p>
   *
   * @return true or false
  ...
  /**
   * Returns true if the sibling count test is enabled..
   *
   * <p>
   *
   * @return true or false
  ...
  /**
   * Returns true if the state test is enabled.
   *
   * <p>
   *
   * @return true or false
  ...
  /**
   * Returns true if the structure Id test is enabled.
   *
   * <p>
   *
   * @return true or false
  ...
  /**
   * Returns true if the touched test is enabled.
   *
   * <p>
   *
   * @return true or false
  ...
  /**
   * Returns true if the type test is enabled.
   *
   * <p>
   *
   * @return true or false
  ...
  /**
   * Returns true if the user created test is enabled.
   *
   * <p>
   *
   * @return true or false
  ...
  /**
   * Returns true if the user last modified test is enabled.
   *
   * <p>
   *
   * @return true or false
