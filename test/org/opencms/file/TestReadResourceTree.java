...
/**
 * Unit test for the "readResources" method of the CmsObject to test reading resource lists within a
 * subtree.
 *
 * <p>
 */
public class TestReadResourceTree extends OpenCmsTestCase {
  ...
  public void testReadModifiedResources() throws Throwable {
    ...
    // read new resources
    List result =
        cms.readResources("/", CmsResourceFilter.ALL.addRequireState(CmsResource.STATE_NEW));
  ...
  public void testReadResourcesInTimerange() throws Throwable {
    ...
    // now touch a resource with a timestamp before timestamp1 and check that it is now modified
    // before timestamp1
    ...
    // now touch the resource with a timestamp after timestamp2 and check that it is now modified
    // after timestamp2
    cms.lockResource(resourcename);
