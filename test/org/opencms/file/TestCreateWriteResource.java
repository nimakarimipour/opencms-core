...
public class TestCreateWriteResource extends OpenCmsTestCase {
  ...
  public void testCreateResourceAgain() throws Throwable {
    ...
    if (created.getResourceId().equals(original.getResourceId())) {
      fail(
          "A created resource that replaced a deleted resource must not have the same resource id!");
    }
  ...
  public void testImportSibling() throws Throwable {
    ...
    CmsProperty prop2 =
        new CmsProperty(CmsPropertyDefinition.PROPERTY_DESCRIPTION, "The description", null);
    CmsProperty prop3 =
        new CmsProperty(CmsPropertyDefinition.PROPERTY_KEYWORDS, "The keywords", null);
