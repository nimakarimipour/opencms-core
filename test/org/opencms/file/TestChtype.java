...
/**
 * Unit test for the "chtype" method of the CmsObject.
 *
 * <p>
 */
public class TestChtype extends OpenCmsTestCase {
  ...
  /**
   * Test the chtype method on a new file.
   *
   * <p>
   *
  ...
  public static void chtypeNewFile(
      OpenCmsTestCase tc, CmsObject cms, String resource1, int originalResType, int newResType)
      throws Throwable {
  ...
  /**
   * Test the chtype method on a file to jsp without permissions.
   *
   * <p>
   *
   * @throws Throwable if something goes wrong
