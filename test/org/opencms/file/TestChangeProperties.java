 ...
 * {@link CmsObject#changeResourcesInFolderWithProperty(String, String, String, String, boolean)}
 * </code> method.
 *
 * <p>
 */
public class TestChangeProperties extends OpenCmsTestCase {
  ...
  /**
   * Tries to change the "Description" property of the two files "/folder1/index.html" and
   * "/folder2/index.html" with the site-root "/sites/default".
   *
   * <p>The test fails, if the <code>recursive</code> parameter of <code>
   * changeResourcesInFolderWithProperty()</code> changes the semantics of the method call.
   *
   * <p>
   *
  ...
  public void testChangeResourcesRelativePath() throws Throwable {
    ...
    List l1 =
        cms.changeResourcesInFolderWithProperty(
            resource1,
  ...
  /**
   * Tries to change the "Description" property of the two files "/sites/default/folder1/index.html"
   * and "/sites/default/folder2/index.html" with the site-root "".
   *
   * <p>The test fails, if the <code>recursive</code> parameter of <code>
   * changeResourcesInFolderWithProperty()</code> changes the semantics of the method call.
   *
