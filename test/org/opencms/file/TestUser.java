...
/**
 * Unit tests for OpenCms user object.
 *
 * <p>
 */
public class TestUser extends OpenCmsTestCase {
  ...
  /**
   * Test import/export of additional user info.
   *
   * <p>
   *
   * @throws Throwable if something goes wrong
  ...
  public void testUserExport() throws Throwable {
    ...
    try {
      ...
      new CmsExport(cms, new CmsShellReport(Locale.ENGLISH))
          .exportData(
  ...
  /**
   * Test operations with additional user info.
   *
   * <p>
   *
   * @throws Throwable if something goes wrong
   ...
   */
  private CmsUser createUserWithEmail(CmsObject cms, String name, String email)
      throws CmsException {
