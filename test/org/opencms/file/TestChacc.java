...
public class TestChacc extends OpenCmsTestCase {
      ...
      ace =
          new CmsAccessControlEntry(
              ...
              flags
                  ...
                  + CmsAccessControlEntry.ACCESS_FLAGS_INHERITED);
  ...
  public void testChaccFileAllOthers() throws Throwable {
    ...
    while (j.hasNext()) {
      ...
      permission = new CmsPermissionSet(permissions.getAllowedPermissions(), denied);
      assertAcl(
          cms, resource, subResName, CmsAccessControlEntry.PRINCIPAL_ALL_OTHERS_ID, permission);
    }
  }
  ...
  public void testChaccFileOverwriteAll() throws Throwable {
    ...
    while (j.hasNext()) {
      ...
      permission = new CmsPermissionSet(permissions.getAllowedPermissions(), denied);
      assertAcl(
          cms, resource, subResName, CmsAccessControlEntry.PRINCIPAL_OVERWRITE_ALL_ID, permission);
    }
  }
  ...
  public void testChaccFileUser() throws Throwable {
    ...
    chaccFileUser(
        this, cms, "/folder1/index.html", cms.readUser("Guest"), CmsPermissionSet.ACCESS_WRITE, 0);
  }
