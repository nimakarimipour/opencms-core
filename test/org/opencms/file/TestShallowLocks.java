...
public class TestShallowLocks extends OpenCmsTestCase {
  ...
  public void testGetBlockingResources() throws Exception {
    ...
    List<CmsResource> blocking =
        otherCms.getBlockingLockedResources("/testGetBlockingResources/folder");
    assertEquals(
  ...
  public void testShallowLockDoesNotAllowDelete() throws Exception {
    ...
    assertThrows(
        ...
        () ->
            cms.deleteResource(
                "/testShallowLockDoesNotAllowDelete", CmsResource.DELETE_PRESERVE_SIBLINGS));
  }
  ...
  public void testShallowLockDoesNotAllowMove() throws Exception {
    ...
    assertThrows(
        ...
        () ->
            cms.moveResource(
                "/testShallowLockDoesNotAllowMove", "/testShallowLockDoesNotAllowMove2"));
  }
  ...
  public void testUpgradeLockFails() throws Exception {
    ...
    cms.lockResourceShallow(tb);
    assertThrows(
        "Trying to normally lock a shallow-locked folder should fail.", () -> cms.lockResource(tb));
  }
   ...
   *
   * <p>All created resources are unlocked.
   *
  ...
  /**
   * Tries to set the Title property to a new value on the given resources, and then verifies that
   * the value has actually been written.
   *
   * @param cms the CMS context to use
  ...
  private void tryChangeTitle(CmsObject cms, String path) throws Exception {
    ...
    cms.writePropertyObjects(
        cms.readResource(path), Arrays.asList(new CmsProperty("Title", s, null)));
