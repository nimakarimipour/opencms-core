 ...
 * "readAllPropertyDefintions" methods of the CmsObject.
 *
 * <p>
 */
public class TestPropertyDefinition extends OpenCmsTestCase {
   ...
   */
  public static void createPropertyDefinition(
      OpenCmsTestCase tc, CmsObject cms, String propertyDefiniton1) throws Throwable {
    ...
    CmsPropertyDefinition prop =
        new CmsPropertyDefinition(CmsUUID.getNullUUID(), propertyDefiniton1);
  ...
  public static void createReadDeletePropertyDefinition(CmsObject cms) throws Throwable {
    ...
    if (!found) {
      fail(
          "Property definition "
              ...
              + " is not in the list of all property definitions");
    }
    ...
    if (found) {
      fail(
          "Property definition "
              + propertyDefinitionName
              + " is still in the list of all property definitions");
    }
  }
