...
/**
 * Unit tests for the link parseable resource types.
 *
 * <p>
 */
public class TestLinkParseableResourceTypes extends OpenCmsTestCase {
  ...
  /**
   * Test chType method, change type link parseable with non link parseable.
   *
   * <p>
   *
  ...
  public void testChTypeLinkParseable() throws Throwable {
    ...
    List<CmsRelation> relations =
        cms.getRelationsForResource(targetName, CmsRelationFilter.TARGETS);
  ...
  /**
   * Test chType method, change type non link parseable with link parseable.
   *
   * <p>
   *
   * @throws Throwable if something goes wrong
  ...
  /**
   * Test deleteResource method for a folder.
   *
   * <p>
   *
   * @throws Throwable if something goes wrong
  ...
  public void testDeleteFolder() throws Throwable {
    ...
    List<CmsRelation> relations =
        cms.getRelationsForResource(sourceName, CmsRelationFilter.TARGETS);
  ...
  /**
   * Test importResource method for link parseable resources.
   *
   * <p>
   *
   * @throws Throwable if something goes wrong
  ...
  public void testImportResourceLinkParseable() throws Throwable {
    ...
    String zipExportFilename =
        OpenCms.getSystemInfo()
            .getAbsoluteRfsPathRelativeToWebInf("packages/testImportChangeType.zip");
  ...
  /**
   * Test importResource method for non link parseable resources.
   *
   * <p>
   *
   * @throws Throwable if something goes wrong
  ...
  /**
   * Test the links after the setup.
   *
   * <p>
   *
   * @throws Throwable if something goes wrong
  ...
  public void testReplaceLinkParseableResource() throws Throwable {
    ...
    CmsObject cms = getCmsObject();
    echo(
        "Testing 'replaceResource' method, replace link parseable with non link parseable resource");
  ...
  public void testReplaceNonLinkParseableResource() throws Throwable {
    ...
    CmsObject cms = getCmsObject();
    echo(
        "Testing 'replaceResource' method, replace non link parseable with link parseable resource");
  ...
  public void testUndoChanges() throws Throwable {
    ...
    cms.deleteRelationsFromResource(
        sourceName, CmsRelationFilter.TARGETS.filterResource(target).filterNotDefinedInContent());
  ...
  public void testWriteFile() throws Throwable {
    ...
    page.setStringValue(
        cms, "body", Locale.GERMAN, page.getStringValue(cms, "body", Locale.ENGLISH));
  ...
  private void assertRelationOperation(
      CmsObject cms, CmsResource source, CmsResource target, int sources, int sourceRelations)
      throws CmsException {
