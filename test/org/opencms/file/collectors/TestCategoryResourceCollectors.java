...
/**
 * Unit test for the {@link CmsCategoryResourceCollector}.
 *
 * <p>
 */
public class TestCategoryResourceCollectors extends OpenCmsTestCase {
  ...
  /**
   * Initializes the resources needed for the tests.
   *
   * <p>
   *
  ...
  public static void initResources(CmsObject cms) throws Exception {
    ...
    CmsCategory catBusiness =
        service.createCategory(
            cms, null, "business", "business title", "business description", null);
    Thread.sleep(100);
    CmsCategory catSports =
        service.createCategory(cms, null, "sports", "sports title", "sports description", null);
    Thread.sleep(100);
  ...
  /**
   * Test the collection of resources for a category in a given folder filtered by a resource type
   * and no specified resource type.
   *
   * <p>
   *
  ...
  public void testCollectAllInFolderResourceType() throws Throwable {
    ...
    resources =
        collector.getResults(
            cms, "allKeyValuePairFiltered", "resource=/folder1/|categoryTypes=business/");

    assertEquals(2, resources.size());
  }

  /**
   * Test the collection of resources for given categories in a given folder sorted by the category.
   *
   * <p>
   *
   * @throws Throwable if something goes wrong
  ...
  /**
   * Test the collection of resources for given categories in a given folder sorted by the date.
   *
   * <p>
   *
   * @throws Throwable if something goes wrong
          ...
          CmsStringUtil.padRight(
              ""
                  + CmsDateUtil.getDateTime(
                      new Date(res.getDateLastModified()), DateFormat.LONG, Locale.GERMAN),
              17));
    }
  }

  /**
   * Test the collection of resources for a category / given categories in a given folder with
   * inculding the sub tree of the folder.
   *
   * <p>
   *
   * @throws Throwable if something goes wrong
  ...
  public void testCollectAllInFolderSubTree() throws Throwable {
    ...
    List resources =
        collector.getResults(
            cms, "allKeyValuePairFiltered", "resource=/|categoryTypes=business/|subTree=false");
    assertEquals(3, resources.size());

    resources =
        collector.getResults(
            cms, "allKeyValuePairFiltered", "resource=/|categoryTypes=business/|subTree=true");
  ...
  /**
   * Test the collection of resources for a category filtered by a resource type and no specified
   * resource type.
   *
   * <p>
   *
  ...
  /**
   * Test the collection of resources for given categories sorted by category.
   *
   * <p>
   *
   * @throws Throwable if something goes wrong
  ...
  public void testCollectAllResourcesSortByCategory() throws Throwable {
    ...
    List resources =
        collector.getResults(
            cms, "allKeyValuePairFiltered", "categoryTypes=business/,sports/|sortBy=category");
  ...
  /**
   * Test the collection of resources for given categories sorted by date.
   *
   * <p>
   *
   * @throws Throwable if something goes wrong
  ...
  public void testCollectAllResourcesSortByDate() throws Throwable {
    ...
    List resources =
        collector.getResults(
            cms, "allKeyValuePairFiltered", "categoryTypes=business/,sports/|sortBy=date");
