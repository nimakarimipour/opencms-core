...
/**
 * Tests the priority resource collectors.
 *
 * <p>
 */
public class TestPriorityResourceCollectors extends OpenCmsTestCase {
  ...
  public static void initResources(CmsObject cms) throws CmsException {
    ...
    CmsResource res =
        cms.createResource(
            "/folder1/file5", CmsResourceTypePlain.getStaticTypeId(), null, properties);
    ...
    properties.add(propDate);
    cms.createResource(
        "/folder1/sub1/file5", CmsResourceTypePlain.getStaticTypeId(), null, properties);
  }
  ...
  public static Test suite() {
    ...
    suite.addTest(
        new TestPriorityResourceCollectors("testCollectAllInFolderPriorityExcludeTimerange"));
  ...
  /**
   * Tests the "allInFolderPriorityDesc" resource collector.
   *
   * <p>
   *
  ...
  public void testCollectAllInFolderPriority() throws Throwable {
    ...
    List<CmsResource> resources =
        collector.getResults(
            cms, "allInFolderPriorityDateDesc", "/folder1/|" + resTypeIdPlain + "|3");
  ...
  public void testCollectAllInFolderPriorityExcludeTimerange() throws Throwable {
    ...
    List<CmsResource> resources =
        collector.getResults(
            cms, "allInFolderPriorityDateDesc", "/folder1/|" + resTypeIdPlain + "|0");
  ...
  public void testCollectAllInSubTreePriority() throws Throwable {
    ...
    I_CmsResourceCollector collector = new CmsPriorityResourceCollector();
    List<CmsResource> resources =
        collector.getResults(cms, "allInSubTreePriorityDateDesc", "/|" + resTypeIdPlain + "|4");
