...
/**
 * Unit tests for the history restore method.
 *
 * <p>
 */
public class TestRestoreFromHistory extends OpenCmsTestCase {
  ...
  /**
   * Tests the history overflow function.
   *
   * <p>
   *
  ...
  public void testHistoryOverflow() throws Throwable {
    ...
    cms.createResource(
        resourcename, CmsResourceTypePlain.getStaticTypeId(), contentStr.getBytes(), null);
  ...
  /**
   * Tests the re-creation of already deleted resources.
   *
   * <p>A deleted resource can be restored by creating a new one with the same path and then
   * restoring its contents from history.
   *
   * @throws Throwable if something goes wrong
   */
  ...
  /**
   * Tests the re-creation of moved resources.
   *
   * <p>
   *
   * @throws Throwable if something goes wrong
  ...
  /**
   * Test the restore resource method.
   *
   * <p>
   *
   * @throws Throwable if something goes wrong
  ...
  public void testRestoreResource() throws Throwable {
    ...
    CmsProperty sProp1 =
        new CmsProperty("StructureProp", "Structure property value version 1", null, true);
    CmsProperty rProp1 =
        new CmsProperty("ResourceProp", null, "Resource property value version 1", true);
    List props1 = new ArrayList();
    props1.add(sProp1);
    props1.add(rProp1);

    CmsProperty sProp2 =
        new CmsProperty("StructureProp", "Structure property value version 2", null, true);
    CmsProperty rProp2 =
        new CmsProperty("ResourceProp", null, "Resource property value version 2", true);
    ...
    cms.createResource(
        resourcename, CmsResourceTypePlain.getStaticTypeId(), contentStr1.getBytes(), null);
    this.storeResources(cms, resourcename);
