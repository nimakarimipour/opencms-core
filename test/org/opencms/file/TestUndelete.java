...
public class TestUndelete extends OpenCmsTestCase {
   ...
   * @throws Throwable if something goes wrong
   */
  public static void undeleteFolder(OpenCmsTestCase tc, CmsObject cms, String folder)
      throws Throwable {
   ...
   * @throws Throwable if something goes wrong
   */
  public static void undeleteFolderRecursive(OpenCmsTestCase tc, CmsObject cms, String folder)
      throws Throwable {
  ...
  public void testUndeleteWithACE() throws Throwable {
    ...
    // test the acl
    assertAcl(
        cms, resourceName, cms.readGroup("group2").getId(), new CmsPermissionSetCustom("+r-w"));
  }
