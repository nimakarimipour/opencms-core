...
public class TestUndoChanges extends OpenCmsTestCase {
   ...
   */
  public static void undoChanges(OpenCmsTestCase tc, CmsObject cms, String resource1)
      throws Throwable {
   ...
   * @throws Throwable if something goes wrong
   */
  public static void undoChangesFolder(OpenCmsTestCase tc, CmsObject cms, String resource1)
      throws Throwable {
  ...
  /**
   * Tests undo changes after a resource was deleted and another resource was copied over the
   * deleted file "as new".
   *
   * <p>
   *
   ...
   *
   * <p>having following start structure: - (black) /folder - (black) /folder/subfolder - (black)
   * /folder/subfolder/subsubfolder
   *
   * <p>a. move /folder/subfolder to /subfolder b. move /subfolder/subsubfolder to /subsubfolder c.
   * move /subfolder back to its starting location: /folder/subfolder d. undo changes of move
   * operation for /subsubfolder
   *
   * <p>to get following scenario: - (black) /folder - (red) /folder/subfolder - (black)
   * /folder/subfolder/subsubfolder
   *
   * <p>e. undo changes of move operation for /folder/subfolder
   *
   * @throws Throwable if something goes wrong
   */
  public void testUndoChangesScenario1() throws Throwable {
    ...
    cms.createResource(
        folder + "/" + subfolder + "/" + file, CmsResourceTypePlain.getStaticTypeId());
    cms.createResource(
        folder + "/" + subfolder + "/" + subsubfolder, CmsResourceTypeFolder.RESOURCE_TYPE_ID);
    cms.createResource(
    ...
    assertFilter(
        cms, "/" + folder + "/" + subfolder + "/" + file, OpenCmsTestResourceFilter.FILTER_TOUCH);
    assertFilter(
        cms,
        "/" + folder + "/" + subfolder + "/" + subsubfolder + "/",
  ...
  public void testUndoChangesMove() throws Throwable {
    ...
    cms.writePropertyObject(
        destination + sourceFile, new CmsProperty("test property", "a", "b", true));
  ...
  public void testUndoChangesOnNewResource() throws Throwable {
    ...
    try {
      ...
      if (!e.getMessageContainer()
          .getKey()
          .equals(org.opencms.db.Messages.ERR_UNDO_CHANGES_FOR_RESOURCE_1)) {
  ...
  public void testUndoChangesSharedProperty() throws Throwable {
    ...
    CmsProperty property =
        new CmsProperty(CmsPropertyDefinition.PROPERTY_NAVTEXT, "undoChanges navText", null);
    cms.writePropertyObject(sibling, property);
    // write a persistent shared property to test with
    CmsProperty property1 =
        new CmsProperty(
            CmsPropertyDefinition.PROPERTY_DESCRIPTION, null, "undoChanges description");
    ...
    CmsProperty property2 =
        new CmsProperty(CmsPropertyDefinition.PROPERTY_TITLE, null, "undoChanges title");
