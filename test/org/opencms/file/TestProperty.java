...
public class TestProperty extends OpenCmsTestCase {
  ...
  public static void createProperties(
      OpenCmsTestCase tc, CmsObject cms, String resource1, List propertyList1) throws Throwable {
  ...
  public static void createProperty(
      OpenCmsTestCase tc, CmsObject cms, String resource1, CmsProperty property1) throws Throwable {
  ...
  public void testCaseSensitiveProperties() throws Throwable {
    ...
    assertEquals(
        "myValue", cms.readPropertyObject("/index.html", "myProperty", false).getResourceValue());
    assertEquals(
        "myvalue", cms.readPropertyObject("/index.html", "myproperty", false).getResourceValue());
  }
  ...
  public void testFrozenProperty() throws Throwable {
    ...
    try {
      ...
      assertEquals(
          org.opencms.file.Messages.ERR_PROPERTY_FROZEN_1, e.getMessageContainer().getKey());
      gotException = true;
    }
  ...
  public void testNullProperty() throws Exception {
    ...
    assertTrue(
        "NULL_PROPERTY must be identical to itself", nullProperty == CmsProperty.getNullProperty());
  }
  ...
  public void testReadResourcesWithProperty() throws Throwable {
    ...
    cms.writePropertyObject(
        typesUri, new CmsProperty(CmsPropertyDefinition.PROPERTY_EXPORTNAME, "myfolder", null));
    // publish the changes
    OpenCms.getPublishManager().publishProject(cms);
    OpenCms.getPublishManager().waitWhileRunning();
  ...
  public void testRemoveProperties() throws Throwable {
    ...
    CmsProperty property5 =
        new CmsProperty("Title", CmsProperty.DELETE_VALUE, CmsProperty.DELETE_VALUE);
    CmsProperty property6 =
        new CmsProperty("NavPos", CmsProperty.DELETE_VALUE, CmsProperty.DELETE_VALUE);
   ...
   *
   * <p>Scenario: A file A has property P set with value V as shared property. Now A is renamed to
   * B. Then B is published directly with all siblings (A is now deleted and removed). Issue:
   * Property P is now empty in B, but should still have the V value.
   *
   * <p>
   *
   * @throws Throwable if something goes wrong
  ...
  public void testSharedPropertyIssue1() throws Throwable {
    ...
    CmsProperty descProperty =
        new CmsProperty(CmsPropertyDefinition.PROPERTY_DESCRIPTION, null, "A shared value");
    ...
    OpenCms.getPublishManager()
        .publishResource(cms, dest, true, new CmsShellReport(Locale.ENGLISH));
    OpenCms.getPublishManager().waitWhileRunning();

    CmsProperty resultProperty =
        cms.readPropertyObject(dest, CmsPropertyDefinition.PROPERTY_DESCRIPTION, false);
