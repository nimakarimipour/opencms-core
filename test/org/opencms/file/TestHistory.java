...
public class TestHistory extends OpenCmsTestCase {
  ...
  /**
   * Creates and deletes a file n-times and tests if the historical data are correct and if the
   * content can be properly restored.
   *
   * <p>
   *
  ...
  public void testCreateAndDeleteFile() throws Throwable {
    ...
    CmsResource res =
        cms.createResource(
            filename, CmsResourceTypePlain.getStaticTypeId(), "content version 0".getBytes(), null);
  ...
  /**
   * Creates and deletes a folder n-times and tests if the historical data are correct and if the
   * properties can be properly restored.
   *
   * <p>
   *
   * @throws Throwable if something goes wrong
    ...
    for (int i = 0; i < (counter + 2); i++) {
      ...
      CmsProperty property =
          cms.readPropertyObject(
              cms.readResource(importFolder), CmsPropertyDefinition.PROPERTY_TITLE, false);
  ...
  public void testDeleteDate() throws Throwable {
    ...
    cms.createResource(
        folderName + fileName, CmsResourceTypePlain.getStaticTypeId(), "hallo".getBytes(), null);
    OpenCms.getPublishManager().publishResource(cms, folderName);
    OpenCms.getPublishManager().waitWhileRunning();
    ...
    echo(
        "dlm: "
            + cms.readResource(folderName + fileName, CmsResourceFilter.ALL).getDateLastModified());
  ...
  /**
   * Creates a file, modifies and publishes it n-times, create a sibling, publishes both and
  ...
  public void testFileHistory() throws Throwable {
    ...
    cms.createResource(
        filename, CmsResourceTypePlain.getStaticTypeId(), contentStr.getBytes(), null);
    OpenCms.getPublishManager().publishResource(cms, filename);
    OpenCms.getPublishManager().waitWhileRunning();
  ...
  /**
   * creates a file, modifies and publishes it n-times, create 2 siblings, delete file and sibling
   * N2, delete some versions from history, restore file and sibling from history and compare
   * contents.
   *
   * <p>
   *
  ...
  public void testFileHistoryFileWithSibling() throws Throwable {
    ...
    for (int i = 1; i <= counter; i++) {
      ...
      cms.writeFile(file);
      CmsProperty property =
          new CmsProperty(CmsPropertyDefinition.PROPERTY_TITLE, "RootTitle" + i, null);
    ...
    for (int i = 1; i <= counterSibl; i++) {
      ...
      cms.writeFile(file);
      CmsProperty property =
          new CmsProperty(CmsPropertyDefinition.PROPERTY_TITLE, "SiblingTitle" + i, null);
    ...
    for (int i = 1; i <= counterSibl2; i++) {
      ...
      cms.writeFile(file);
      CmsProperty property =
          new CmsProperty(CmsPropertyDefinition.PROPERTY_TITLE, "Sibling2Title" + i, null);
    ...
    assertEquals(
        3 + counterSibl2,
        allFiles.size()); // it is not 3 since there are more versions coming from the siblings!
    ...
    CmsProperty prop =
        cms.readPropertyObject(siblingname, CmsPropertyDefinition.PROPERTY_TITLE, false);
  ...
  public void testFileRestore() throws Throwable {
    ...
    CmsResource res =
        cms.createResource(
            "testFolder/test.txt", CmsResourceTypePlain.getStaticTypeId(), "test".getBytes(), null);
    // create a relation
    cms.addRelationToResource(
        "index.html", "testFolder/test.txt", CmsRelationType.CATEGORY.getName());
    // write props
    cms.writePropertyObject(
        "testFolder/test.txt",
  ...
  public void testFileVersions() throws Throwable {
    ...
    cms.lockResource(resName);
    cms.writePropertyObject(
        resName, new CmsProperty(CmsPropertyDefinition.PROPERTY_TITLE, "test", null));
    ...
    cms.lockResource(resName);
    cms.writePropertyObject(
        resName, new CmsProperty(CmsPropertyDefinition.PROPERTY_NAVPOS, null, "1.5"));
  ...
  /**
   * Moves a resource n-times and tests if the version ID of the history resources are correct and
   * if the content could be restored for a specified version ID.
   *
   * <p>
   *
   * @throws Throwable if something goes wrong
  ...
  public void testMoveFile() throws Throwable {
    ...
    CmsResource res =
        cms.createResource(
            resName, CmsResourceTypePlain.getStaticTypeId(), "content version 0".getBytes(), null);
  ...
  public void testPathHistory() throws Throwable {
    ...
    assertEquals(
        counter + 2,
        historyResources.size()); // 1 (created) + counter (modified/moved) + 1 (deleted)
  ...
  public void testReadDeleted() throws Throwable {
    ...
    cms.readResource(
        cms.getRequestContext()
            .removeSiteRoot(((I_CmsHistoryResource) deleted.get(0)).getRootPath()));
  }
  ...
  public void testRestoreFileInRenamedFolder() throws Exception {
    ...
    assertEquals(
        fileToDelete.getStructureId(), cms.readResource(base + "/b/1.txt").getStructureId());
  }
  ...
  public void testSiblingsEdition() throws Throwable {
    ...
    CmsResource s1 =
        cms.createResource(
            s1name, CmsResourceTypePlain.getStaticTypeId(), "first sibling".getBytes(), null);
    ...
    cms.writePropertyObject(
        s1name, new CmsProperty(CmsPropertyDefinition.PROPERTY_TITLE, null, "resource change"));
    ...
    cms.writePropertyObject(
        s2name, new CmsProperty(CmsPropertyDefinition.PROPERTY_NAVTEXT, "structure change", null));
    ...
    cms.changeLock(s2name);
    cms.writePropertyObject(
        s2name, new CmsProperty(CmsPropertyDefinition.PROPERTY_TITLE, "structure change", null));
    ...
    cms.lockResource(s1name);
    cms.writePropertyObject(
        s1name, new CmsProperty(CmsPropertyDefinition.PROPERTY_TITLE, null, "new resource change"));
  ...
  public void testSiblingsRestoration() throws Throwable {
    ...
    CmsResource s1 =
        cms.createResource(s1name, CmsResourceTypePlain.getStaticTypeId(), txt1.getBytes(), null);
  ...
  public void testSiblingVersions() throws Throwable {
    ...
    OpenCms.getPublishManager()
        .publishResource(cms, sib1, true, new CmsShellReport(Locale.ENGLISH));
    OpenCms.getPublishManager().waitWhileRunning();
