...
public class TestResourceOperations extends OpenCmsTestCase {
  ...
  public static Test suite() {
    ...
    suite.addTest(
        new TestResourceOperations(
            "testGenerateFileNameAfterReinitializingResourceManagerWithTemporaryProject"));
   ...
   * @throws Exception
   */
  public void testGenerateFileNameAfterReinitializingResourceManagerWithTemporaryProject()
      throws Exception {
    ...
    CmsProject tempProject =
        cms.createProject(
            "Temp", "temp", "Administrators", "Administrators", CmsProject.PROJECT_TYPE_TEMPORARY);
    ...
    String s =
        OpenCms.getResourceManager()
            .getNameGenerator()
            .getNewFileName(getCmsObject(), "/testGenerateFileName/f_%(number)", 4);
  }
