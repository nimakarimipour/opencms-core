...
/**
 * Tests the default resource collectors.
 *
 * <p>
 */
public class TestDefaultResourceCollectors extends OpenCmsTestCase {
  ...
  /**
   * Tests the "singleFile" resource collector.
   *
   * <p>
   *
  ...
  /**
   * Tests the "allInFolder" resource collector.
   *
   * <p>
   *
   * @throws Throwable if something goes wrong
  ...
  /**
   * Tests the "allInFolderDateReleasedDesc" resource collector.
   *
   * <p>
   *
   * @throws Throwable if something goes wrong
  ...
  public void testCollectAllInFolderDateReleasedDesc() throws Throwable {
    ...
    resources =
        collector.getResults(cms, "allInFolderDateReleasedDesc", "/folder1/|" + resTypeIdPlain);
