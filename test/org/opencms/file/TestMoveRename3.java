...
/**
 * Unit tests for move/delete/publish operations.
 *
 * <p>
 */
public class TestMoveRename3 extends OpenCmsTestCase {
  ...
  /**
   * Container for structure entries.
   *
   * <p>
   */
  class CmsVfsStructureEntry {
    ...
    /**
     * Constructor for a structure entry.
     *
     * <p>Immutable object.
     *
     * <p>
     ...
     */
    public CmsVfsStructureEntry(
        String structureId, String parentId, String resourceId, String resourcePath) {
  ...
  /**
   * Test delete and undelete of a moved file.
   *
   * <p>
   *
  ...
  /**
   * Test delete and undelete and publish of a moved file.
   *
   * <p>
   *
  ...
  /**
   * Test that renaming a folder fails if a folder with the same name already exists.
   *
   * <p>
   *
   * @throws Exception in case the test fails
  ...
  /**
   * Test all entries in <code>strEntries</code>, and adds the broken entries to the <code>
   * brokenEntries</code> list.
   *
   * <p>
   *
