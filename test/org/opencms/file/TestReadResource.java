...
/**
 * Unit test for the "readFileHeader" method of the CmsObject to test the release and expiration
 * date.
 *
 * <p>
 */
public class TestReadResource extends OpenCmsTestCase {
  ...
  public static void readBeforeReleaseDate(
      OpenCmsTestCase tc, CmsObject cms, String resource1, CmsResourceFilter filter)
      throws Throwable {
   ...
   *
   * <p>The valid time range will be ignored.
   *
   * @throws Throwable if something goes wrong
   */
