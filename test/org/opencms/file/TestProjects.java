...
public class TestProjects extends OpenCmsTestCase {
  ...
  public void testAccessibleProjects() throws Exception {
    ...
    OpenCms.getRoleManager()
        .addUserToRole(cms, CmsRole.WORKPLACE_USER.forOrgUnit("/test/"), "/test/user1");
    cms.loginUser("/test/user1", "user1");
  ...
  public void testCopyResourceToProject() throws Exception {
    ...
    assertTrue(
        CmsProject.isInsideProject(
            currentResources, "/sites/default/folder1/subfolder11/index.html"));
  ...
  public void testDeleteProjectWithResources() throws Exception {
    ...
    cms.createResource(
        "/folder3/", CmsResourceTypeFolder.getStaticTypeId(), null, Collections.EMPTY_LIST);
    cms.createResource(
        "/folder3/test.txt",
