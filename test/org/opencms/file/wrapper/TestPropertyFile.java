 ...
 * {@link org.opencms.file.wrapper.CmsResourceWrapperUtils#createPropertyFile(org.opencms.file.CmsObject, org.opencms.file.CmsResource, String)}
 * </code> method.
 *
 * <p>
 */
public class TestPropertyFile extends OpenCmsTestCase {
  ...
  /**
   * Test if line breaks in the values of properties appears correctly in the generated property
   * file.
   *
   * <p>
   *
  ...
  public void testEscapedCharacters() throws Throwable {
    ...
    CmsFile propFile =
        CmsResourceWrapperUtils.createPropertyFile(
            getCmsObject(), res, res.getRootPath() + ".properties");
  ...
  /**
   * Test if unicode characters are read correctly in the property files.
   *
   * <p>
   *
   * @throws Throwable if an error occurs while the test is running
  ...
  /**
   * Test if unicode characters are written correctly in the property files.
   *
   * <p>
   *
   * @throws Throwable if an error occurs while the test is running
  ...
  public void testWriteUnicodeChars() throws Throwable {
    ...
    CmsResourceWrapperUtils.writePropertyFile(
        getCmsObject(), resourcename, content.toString().getBytes(CmsEncoder.ENCODING_UTF_8));
