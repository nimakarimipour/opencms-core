...
/**
 * Tests for the acacia editor data back-end.
 *
 * <p>
 */
public class EntityBackendTest extends GWTTestCase {
  ...
  /**
   * Tests the deep copy and remove methods.
   *
   * <p>
   */
  ...
  /**
   * Tests if a new entity can be created within VIE.
   *
   * <p>
   */
  public void testCreateEntity() {
    ...
    assertEquals(
        "The type name should match the initial type name", entityType, entity.getTypeName());
  }

  /**
   * Tests the type creation.
   *
   * <p>
   */
  ...
  /**
   * Tests the creation of new type attributes.
   *
   * <p>
   */
  public void testEntityAttribute() {
    ...
    //        assertFalse("This should be no simple type, as it has attributes.",
    // complex.isSimpleType());
    assertNotNull("The attribute list should not be null.", complex.getAttributeNames());
    assertEquals(
        "The attribute names list should have a length of 1.",
        1,
        complex.getAttributeNames().size());
    String attributeType = complex.getAttributeTypeName(ATTRIBUTE_NAME);
    assertEquals(
        "The attribute should be of the type: " + SIMPLE_TYPE_ID, SIMPLE_TYPE_ID, attributeType);
    assertEquals(
    ...
    assertEquals(
        "The attribute value should match the previously set value",
        value,
        attribute.getSimpleValue());
    ...
    assertFalse(
        "The attribute should no longer be a single value attribute", attribute.isSingleValue());
    ...
    assertNotNull(
        "The entity should have an attribute even though the value was an empty string: "
            + ATTRIBUTE_NAME,
        attribute2);
    assertEquals(
  ...
  /**
   * Tests the event handling on entities.
   *
   * <p>Relies on the types created in {@link #testEntityAttribute()}.
   *
   * <p>
   */
  ...
  /**
   * Tests if an attribute with three identical values remains intact as a nested entity.
   *
   * <p>
   */
  public void testSameValueAttributes() {
    ...
    assertEquals(
        ...
        3,
        mainEntity
            .getAttribute(nestedAttributeName)
            .getComplexValue()
  ...
  /**
   * Tests the DOM element selector methods of VIE.
   *
   * <p>
   */
  public void testSelectors() {
    ...
    List<com.google.gwt.dom.client.Element> elements =
        getBackendInstance().getAttributeElements("http://testEntity", ATTRIBUTE_NAME, null);
  ...
  /**
   * Returns the {@link CmsEntityBackend} instance.
   *
   * <p>
   *
