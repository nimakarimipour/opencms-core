...
public class CmsTinyMCEWidget extends A_CmsHtmlWidget {
  ...
  public static final String BASE_CONTENT_CSS =
      "/system/workplace/editors/tinymce/base_content.css";
        ...
        getJSIncludeFile(
            OpenCms.getLinkManager()
                .substituteLinkForRootPath(
                    cms, "/system/workplace/editors/tinymce/opencms_plugin.js")));
    result.append("\n");
    // special TinyMCE widget functions
    result.append(
        getJSIncludeFile(CmsWorkplace.getStaticResourceUri("components/widgets/tinymce.js")));
    String pluginCssUri =
        OpenCms.getLinkManager()
            .substituteLinkForRootPath(cms, "/system/workplace/editors/tinymce/opencms_plugin.css");
  ...
  public String getDialogWidget(
    ...
    result
        .append("contentFields[contentFields.length] = document.getElementById(\"")
        .append(id)
        .append("\");\n");
    result.append("</script>\n");
    result.append("</td>");
      ...
      if (optionBean.useCss()) {
        ...
        try {
          ...
          String editedResourceSitePath =
              editedResource == null ? null : cms.getSitePath(editedResource);
          while (i.hasNext()) {
  ...
  private JSONObject getToolbarJson(CmsObject cms) throws JSONException {
    ...
    String toolbar =
        CmsTinyMceToolbarHelper.createTinyMceToolbarStringFromGenericToolbarItems(barItems);
