...
/**
 * Provides helper methods for the usage of the CodeMirror editor that can be used for syntax
 * highlighting of text based files.
 *
 * <p>
 */
public class CmsCodeMirror extends CmsSimpleEditor {
  ...
  protected static final String VFS_PATH_EDITOR =
      CmsStringUtil.joinPaths(
          OpenCms.getSystemInfo().getStaticResourceContext(), SUBPATH_CODEMIRROR);
