...
public class CmsSearchResultsList extends A_CmsListExplorerDialog {
  ...
  public void executeListSingleActions() throws IOException, ServletException {
    ...
    if (getParamListAction().equals(LIST_ACTION_EDIT)) {
      ...
      params.put(
          CmsDialog.PARAM_CLOSELINK, new String[] {CmsWorkplace.VFS_PATH_VIEWS + "workplace.jsp"});
      params.put(
          CmsEditor.PARAM_BACKLINK, new String[] {CmsWorkplace.VFS_PATH_VIEWS + "workplace.jsp"});
      params.put(
          CmsDialog.PARAM_RESOURCE,
          new String[] {(String) getSelectedItem().get(LIST_COLUMN_NAME)});
  ...
  public I_CmsListResourceCollector getCollector() {
    ...
    if (m_collector == null) {
      m_collector =
          new CmsSearchResourcesCollector(
              this,
  ...
  protected void setIndependentActions(CmsListMetadata metadata) {
    ...
    excerptDetails.setShowActionName(
        Messages.get().container(Messages.GUI_SEARCH_DETAIL_SHOW_EXCERPT_NAME_0));
    excerptDetails.setShowActionHelpText(
        Messages.get().container(Messages.GUI_SEARCH_DETAIL_SHOW_EXCERPT_HELP_0));
    excerptDetails.setHideActionName(
        Messages.get().container(Messages.GUI_SEARCH_DETAIL_HIDE_EXCERPT_NAME_0));
    excerptDetails.setHideActionHelpText(
        Messages.get().container(Messages.GUI_SEARCH_DETAIL_HIDE_EXCERPT_HELP_0));
    excerptDetails.setName(Messages.get().container(Messages.GUI_SEARCH_DETAIL_EXCERPT_NAME_0));
    excerptDetails.setFormatter(
  ...
  /**
   * Returns the search parameter bean.
   *
   * <p>
   *
