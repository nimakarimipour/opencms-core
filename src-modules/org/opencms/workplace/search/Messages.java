...
public final class Messages extends A_CmsMessageBundle {
  ...
  /** Message constant for key in the resource bundle. */
  public static final String GUI_SEARCH_DETAIL_HIDE_EXCERPT_HELP_0 =
      "GUI_SEARCH_DETAIL_HIDE_EXCERPT_HELP_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_SEARCH_DETAIL_HIDE_EXCERPT_NAME_0 =
      "GUI_SEARCH_DETAIL_HIDE_EXCERPT_NAME_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_SEARCH_DETAIL_SHOW_EXCERPT_HELP_0 =
      "GUI_SEARCH_DETAIL_SHOW_EXCERPT_HELP_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_SEARCH_DETAIL_SHOW_EXCERPT_NAME_0 =
      "GUI_SEARCH_DETAIL_SHOW_EXCERPT_NAME_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_SEARCH_EXPLORER_RESULTS_TOOL_GROUP_0 =
      "GUI_SEARCH_EXPLORER_RESULTS_TOOL_GROUP_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_SEARCH_EXPLORER_RESULTS_TOOL_HELP_0 =
      "GUI_SEARCH_EXPLORER_RESULTS_TOOL_HELP_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_SEARCH_EXPLORER_RESULTS_TOOL_NAME_0 =
      "GUI_SEARCH_EXPLORER_RESULTS_TOOL_NAME_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_SEARCH_EXPLORER_RESULTS_TOOL_NAVNAME_0 =
      "GUI_SEARCH_EXPLORER_RESULTS_TOOL_NAVNAME_0";
  ...
  /** Message constant for key in the resource bundle. */
  public static final String GUI_SEARCH_LIST_COLS_SCORE_HELP_0 =
      "GUI_SEARCH_LIST_COLS_SCORE_HELP_0";
