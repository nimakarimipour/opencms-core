...
/**
 * Implements the widget parameter interface for the use of OpenCms widgets on dialogs that are not
...
public class CmsWidgetDialogParameter implements I_CmsWidgetParameter {
  ...
  public CmsWidgetDialogParameter(
      Object base, String property, String dialogPage, I_CmsWidget widget) {
   ...
   */
  public CmsWidgetDialogParameter(
      Object base, String property, String htmlName, String dialogPage, I_CmsWidget widget) {
    ...
    if ((base instanceof List) || (base instanceof SortedMap)) {
      ...
      if (!bean.isReadable(m_baseObject, m_baseObjectProperty)
        ...
        try {
          ...
          throw new CmsIllegalArgumentException(
              Messages.get()
                  .container(Messages.ERR_NO_PROPERTY_2, base.getClass().getName(), property));
        }
      }
      ...
      try {
        ...
        throw new CmsRuntimeException(
            Messages.get()
                .container(Messages.ERR_PROPERTY_READ_2, property, base.getClass().getName()),
            e);
      }
      ...
      if (CmsStringUtil.isNotEmptyOrWhitespaceOnly(m_value)) {
        ...
        if ((pos > 0) && (pos < (m_value.length() - 1))) {
          ...
          if (map.containsKey(key)) {
            ...
            CmsWidgetException error =
                new CmsWidgetException(
                    Messages.get()
                        .container(
   ...
   *
   * <p>This information can be used to create multi-page dialogs where the widgets are spread over
   * several pages.
   *
   * <p>
   *
  ...
  /**
   * Returns the Exception caused when this parameter value was commited, or <code>null</code> if
   * error occurred.
   *
   * <p>
   *
   ...
   *
   * <p>This should only be used if the base object is a collection.
   *
   * <p>
   *
  ...
  /**
   * Returns <code>true</code> if this widget parameter is mapped to a Collection base object.
   *
   * <p>
   *
   ...
   *
   * <p>This is required if the base type is mapped to a Collection object, because the collection
   * needs to be cleared before the new values are set.
   *
   * <p>
   */
   ...
   *
   * <p>If the argument is <code>null</code> then the state is set to "no error".
   *
   * <p>
   *
  ...
  /**
   * @see org.opencms.widgets.I_CmsWidgetParameter#setStringValue(org.opencms.file.CmsObject,
   *     java.lang.String)
   */
