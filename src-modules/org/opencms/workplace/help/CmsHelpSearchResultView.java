...
public class CmsHelpSearchResultView {
  ...
  /**
   * A small cache for the forms generated by <code>{@link #toPostParameters(String)}</code> during
   * a request.
   *
   ...
   */
  public CmsHelpSearchResultView(
  ...
  public String displaySearchResult(CmsSearch search) {
    ...
    CmsMessages messages =
        org.opencms.search.Messages.get().getBundle(m_jsp.getRequestContext().getLocale());
          ...
          result.append(
              m_jsp.link(
                  new StringBuffer(
                      ...
                      .append(m_jsp.getRequestContext().removeSiteRoot(entry.getPath()))
                      .append("&")
  ...
  private void initSearch(CmsSearch search) {
    ...
    search.setSearchRoot(
        new StringBuffer("/system/workplace/locales/")
            .append(m_jsp.getRequestContext().getLocale())
            .append("/help/")
            .toString());
