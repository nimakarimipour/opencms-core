...
/**
 * Generates a simple TOC - list by using a navigation model obtained from a <code>
 * {@link org.opencms.jsp.CmsJspNavBuilder}</code>.
 *
 * <p>This is a simpler facade to a fixed html - list based layout. Only a navigation root path and
 * a desired depth have to be set. It is not specific to the online help.
 *
 * <p>
 *
 * @since 6.0.0
...
public final class CmsHelpNavigationListView {
  ...
  /**
   * Creates a <code>CmsNaviationListView</code> which uses the given <code>CmsJspActionElement
   * </code> for accessing the underlying navigation API.
   *
   * <p>
   *
  ...
  /**
   * Creates a <code>CmsNaviationListView</code> which creates a <code>CmsJspActionElement</code>
   * for accessing the underlying navigation API with the given arguments .
   *
   * <p>
   *
  ...
  public CmsHelpNavigationListView(
      PageContext context, HttpServletRequest request, HttpServletResponse response) {
   ...
   *
   * <p>The navigation is a nested html list.
   *
   * <p>
   *
  ...
  public String createNavigation() {
    ...
    if (m_navRootPath != null) {
      ...
      List<CmsJspNavElement> navElements =
          m_jsp.getNavigation().getSiteNavigation(m_navRootPath, endlevel);
      ...
      CmsIllegalArgumentException ex =
          new CmsIllegalArgumentException(
              Messages.get()
                  .container(Messages.GUI_HELP_ERR_SITEMAP_MISSING_PARAM_1, "navRootPath"));
      throw ex;
    }
  }
   ...
   *
   * <p>The navigation will start there.
   *
   * <p>
   *
  ...
  /**
   * Calculates and returns the navigation end level.
   *
   * <p>
   *
  ...
  /**
   * Creates the HTML for the internal help.
   *
   * <p>
   *
