...
public class CmsHtmlDifferenceDialog extends CmsDifferenceDialog {
   ...
   */
  public CmsHtmlDifferenceDialog(
  ...
  public void displayDialog() throws Exception {
    ...
    try {
      ...
      if (MODE_TEXT.equals(getParamTextmode())) {
        originalSource =
            CmsHtml2TextConverter.html2text(originalSource, CmsEncoder.ENCODING_ISO_8859_1);
      ...
      if (CmsStringUtil.isNotEmpty(diff)) {
        ...
        if (CmsStringUtil.isNotEmpty(htmlDiff)) {
          ...
          out.println(
              Messages.get()
                  .container(Messages.GUI_COMPARE_IDENTICAL_TEXT_DIFFERENT_HTML_0)
                  .key(getLocale()));
