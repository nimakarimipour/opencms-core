...
public abstract class A_CmsDiffViewDialog extends CmsDialog {
  ...
  public void displayDialog() throws Exception {
    ...
    out.println("</form>");
    // icon is displayed on the right in order that the user needs not scroll to the icon for long
    // lines
    out.println("<p>");
    ...
    try {
      CmsHtmlDifferenceConfiguration conf =
          new CmsHtmlDifferenceConfiguration(
              getMode() == CmsDiffViewMode.ALL ? -1 : getLinesBeforeSkip(), getLocale());
  ...
  public String getTwoButtonsHtml(
      String label1, String label2, String onClick1, String onClick2, boolean firstActive) {
