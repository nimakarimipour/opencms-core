...
public class CmsUndelete extends CmsMultiDialog {
  ...
  /**
   * Returns the HTML for the localized undelete confirmation message depending on single or multi
   * operation.
   *
   * <p>
   *
  ...
  protected boolean performDialogOperation() throws CmsException {
    ...
    // on folder undelete or multi operation display "please wait" screen, not for simple file
    // undeletion
