...
public class CmsLockedResourcesList extends A_CmsListExplorerDialog {
  ...
  public CmsLockedResourcesList(
    ...
    getList()
        .getMetadata()
        .getItemDetailDefinition(LIST_DETAIL_OWN_LOCKS)
        .setVisible(
  ...
  /**
   * @see
   *     org.opencms.workplace.list.A_CmsListExplorerDialog#setIndependentActions(org.opencms.workplace.list.CmsListMetadata)
   */
  @Override
  protected void setIndependentActions(CmsListMetadata metadata) {
    ...
    abstract class DetailsJsAction extends A_CmsListIndependentJsAction {
      ...
      /**
       * Returns an ajax request call code.
       *
       * <p>
       *
    ...
    I_CmsListAction hideAction =
        new DetailsJsAction(LIST_DETAIL_OWN_LOCKS_HIDE) {
    ...
    hideAction.setHelpText(
        Messages.get().container(Messages.GUI_LOCK_DETAIL_HIDE_OWN_LOCKS_HELP_0));

    I_CmsListAction showAction =
        new DetailsJsAction(LIST_DETAIL_OWN_LOCKS_SHOW) {
    ...
    showAction.setHelpText(
        Messages.get().container(Messages.GUI_LOCK_DETAIL_SHOW_OWN_LOCKS_HELP_0));
