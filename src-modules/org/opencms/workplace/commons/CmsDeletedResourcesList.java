...
public class CmsDeletedResourcesList extends A_CmsListDialog {
  ...
  protected void setColumns(CmsListMetadata metadata) {
    ...
    // add icon action
    CmsListResourceIconAction iconAction =
        new CmsListResourceIconAction(LIST_ACTION_ICON, LIST_COLUMN_TYPEID, getCms());
    ...
    conflictCol.setName(
        Messages.get().container(Messages.GUI_DELETED_RESOURCES_LIST_COLS_CONFLICT_0));
    conflictCol.setWidth("20");
    conflictCol.setAlign(CmsListColumnAlignEnum.ALIGN_CENTER);
    conflictCol.setSorteable(false);

    // add conflict action
    CmsListDirectAction conflictAction =
        new CmsListResourceIconAction(LIST_ACTION_CONFLICT, null, getCms()) {
    ...
    conflictAction.setName(
        Messages.get().container(Messages.GUI_DELETED_RESOURCES_LIST_ACTION_WARNING_0));
    ...
    delDateCol.setName(
        Messages.get().container(Messages.GUI_DELETED_RESOURCES_LIST_COLS_DEL_DATE_0));
    ...
    versionCol.setName(
        Messages.get().container(Messages.GUI_DELETED_RESOURCES_LIST_COLS_VERSION_0));
