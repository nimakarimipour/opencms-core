 ...
 * @since 6.0.0
 */
public class CmsPropertyAdvanced extends CmsTabDialog
    implements I_CmsDialogHandler, I_CmsPostUploadDialogHandler {
   ...
   *
   * <p>Do not use this constructor on JSP pages.
   *
   * <p>
   */
   ...
   *
   * <p>This method overwrites the close dialog method in the super class, because in case a new
   * folder is created, after this dialog a new xml page might be created.
   *
   * <p>It tries to include the URI stored in the workplace settings. This URI is determined by the
   * frame name, which has to be set in the framename parameter.
   *
   * <p>
   *
  ...
  public void actionCloseDialog() throws JspException {
    ...
    if ((getAction() == ACTION_SAVE_EDIT) && MODE_WIZARD.equals(getParamDialogmode())) {
      ...
      // set request attribute to reload the folder tree after creating an xml page in a new created
      // folder in wizard mode
      getSettings()
          .setExplorerResource(
   ...
   *
   * <p>If the dialog is not in wizard mode, the resource is not deleted.
   *
   * <p>
   *
   ...
   *
   * <p>The values of the form are set delayed, have a look at the JavaDoc of buildSetFormValues()
  ...
  public String buildEditForm() {
    ...
    if (properties.size() > 0) {
      ...
      while (i.hasNext()) {
        ...
        result.append(
            buildPropertyRow(curProp[0], curProp[1], curProp[2], curProp[3], disabled, activeTab));
      }
      result.append("</table>");
    } else {
   ...
   *
   * <p>The values of the properties are not inserted directly in the &lt;input&gt; tag, because
   * there is a display issue when the property values are very long. This method creates JavaScript
   * to set the property input field values delayed. On the JSP, the code which is created from this
   * method has to be executed delayed after the creation of the html form, e.g. in the &lt;body&gt;
   * tag with the attribute onload="window.setTimeout('doSet()',50);".
   *
   * <p>
   *
  ...
  /**
   * @see org.opencms.workplace.I_CmsDialogHandler#getDialogUri(java.lang.String,
   *     CmsJspActionElement)
   */
  public String getDialogUri(String resource, CmsJspActionElement jsp) {
    ...
    try {
      ...
      String resTypeName =
          OpenCms.getResourceManager().getResourceType(res.getTypeId()).getTypeName();
   ...
   *
   * <p>The dialogmode parameter stores the different modes of the property dialog, e.g. for
   * displaying other buttons in the new resource wizard.
   *
   * <p>
   *
   ...
   *
   * <p>The new property parameter stores the name of the new defined property.
   *
   * <p>
   *
  ...
  /**
   * Returns the value of the usetempfileproject parameter, or null if this parameter was not
   * provided.
   *
   * <p>The usetempfileproject parameter stores if the file resides in the temp file project.
   *
   * <p>
   *
   * @return the value of the usetempfileproject parameter
  ...
  /**
   * @see org.opencms.workplace.CmsDialog#dialogButtonsHtml(java.lang.StringBuffer, int,
   *     java.lang.String)
   */
  @Override
  ...
  protected Map<String, CmsProperty> getActiveProperties() {
    ...
    if (m_activeProperties == null) {
      try {
        m_activeProperties =
            CmsPropertyAdvanced.getPropertyMap(
  ...
  /**
   * Returns the explorer type settings of the resource type, considering eventual references to
   * another type.
   *
   * <p>
   *
  ...
  protected void initWorkplaceRequestValues(
    ...
    if (DIALOG_SHOW_DEFINE.equals(getParamAction())) {
      ...
      setParamTitle(
          key(
              Messages.GUI_PROPERTY_NEW_DEF_1,
  ...
  /**
   * Returns whether the properties are editable or not depending on the lock state of the resource
   ...
   *
   * <p>The output depends on the currently active tab (shared or individual properties) and on the
   * present values of the current property.
   *
   * <p>The values of the property are not inserted directly in the &lt;input&gt; tag, because there
   * is a display issue when the property values are very long. Have a look at buildSetFormValues()
   * for a detailed description.
   *
   * <p>
   *
   ...
   *
   * <p>The list items consist of the following Strings:
   *
   * <ol>
   *   <li>The name of the property
   *   <li>The currently active property value
   *   <li>The value of the structure
   *   <li>The value of the resource
   * </ol>
   *
        ...
        if (m_tabSwitched) {
          ...
          if (structurePanelName.equals(activeTab)) {
            ...
            if (CmsStringUtil.isNotEmptyOrWhitespaceOnly(valueStructure)
              ...
              // the resource value was shown in the input field, set structure value to empty
              // String
              valueStructure = "";
            }
          }
  ...
  /**
   * Performs the definition of a new property.
   *
   * <p>
   *
      ...
      while (i.hasNext()) {
        ...
        if (key(Messages.GUI_PROPERTIES_INDIVIDUAL_0).equals(activeTab)) {
          ...
          if ((valueStructure != null)
              ...
              && valueStructure.equals(valueResource)) {
            // the resource value was shown/entered in input field, set structure value to empty
            // String
            valueStructure = "";
          }
        } else {
        ...
        // write the structure value if the existing structure value is not null and we want to
        // delete the structure value
        ...
        // write the resource value if the existing resource value is not null and we want to delete
        // the resource value
