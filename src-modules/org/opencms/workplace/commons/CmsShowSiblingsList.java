...
public class CmsShowSiblingsList extends A_CmsListExplorerDialog {
  ...
  public CmsShowSiblingsList(CmsJspActionElement jsp) {
    ...
    resUtil.setRelativeTo(
        getCms().getRequestContext().addSiteRoot(jsp.getRequestContext().getFolderUri()));
      ...
      m_collector =
          new A_CmsListResourceCollector(this) {
            ...
            public List<CmsResource> getResources(CmsObject cms, Map<String, String> params)
              ...
              return getCms()
                  .readSiblings(
                      ((CmsShowSiblingsList) getWp()).getParamResource(), CmsResourceFilter.ALL);
            }
  ...
  protected void setColumns(CmsListMetadata metadata) {
    ...
    metadata
        .getColumnDefinition(A_CmsListExplorerDialog.LIST_COLUMN_NAME)
        .setName(
