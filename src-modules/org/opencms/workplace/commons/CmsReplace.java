...
public class CmsReplace extends CmsDialog {
      ...
      if (fi != null) {
        ...
        if ((maxFileSizeBytes > 0) && (size > maxFileSizeBytes)) {
          ...
          throw new CmsException(
              Messages.get()
                  .container(
                      Messages.ERR_FILE_SIZE_TOO_LARGE_1, new Long((maxFileSizeBytes / 1024))));
        }
        byte[] content = fi.get();
        fi.delete();
        ...
        try {
          ...
          // SQL error, probably the file is too large for the database settings, restore old
          // content
  ...
  protected void initWorkplaceRequestValues(
    ...
    if (DIALOG_OK.equals(getParamAction())) {
      ...
      setParamTitle(
          key(Messages.GUI_REPLACE_FILE_1, new Object[] {CmsResource.getName(getParamResource())}));
    }
  }
}
