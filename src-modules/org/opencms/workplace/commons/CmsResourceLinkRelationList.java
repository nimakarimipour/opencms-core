...
public class CmsResourceLinkRelationList extends A_CmsListExplorerDialog {
  ...
  protected String defaultActionHtmlStart() {
    ...
    return getList().listJs()
        + CmsListExplorerColumn.getExplorerStyleDef()
        + dialogContentStart(getParamTitle());
  }
  ...
  protected List<CmsListItem> getListItems() throws CmsException {
    ...
    while (itItems.hasNext()) {
      ...
      CmsListItem newItem =
          getList().newItem(localizedRelationType + "_" + resource.getStructureId().toString());
  ...
  protected void setColumns(CmsListMetadata metadata) {
    ...
    CmsListColumnDefinition projStateIconCol =
        metadata.getColumnDefinition(LIST_COLUMN_PROJSTATEICON);
        ...
        new CmsListResourceProjStateAction(LIST_ACTION_PROJSTATEICON) {
          ...
          public String getIconPath() {
            ...
            if (((CmsResourceLinkRelationList) getWp()).getBrokenLinks() != null) {
              if (((CmsResourceLinkRelationList) getWp())
                  .getBrokenLinks()
                  .contains(getItem().getId())) {
    ...
    CmsListColumnDefinition relationTypeCol =
        new CmsListResourceLinkRelationExplorerColumn(LIST_COLUMN_RELATION_TYPE);
