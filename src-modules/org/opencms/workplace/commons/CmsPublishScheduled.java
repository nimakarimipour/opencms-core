...
public class CmsPublishScheduled extends CmsDialog {
  ...
  protected String computeProjectName(String rootPath, Date date) {
    ...
    String projectName =
        key(Messages.GUI_PUBLISH_SCHEDULED_PROJECT_NAME_2, new Object[] {rootPath, dateTime});
  ...
  protected boolean performDialogOperation() throws CmsException, ParseException {
    ...
    long lDate =
        org.opencms.widgets.CmsCalendarWidget.getCalendarDate(
            getMessages(), publishScheduledDate, true);
    ...
    if (date.getTime() < new Date().getTime()) {
      ...
      throw new CmsException(
          Messages.get().container(Messages.ERR_PUBLISH_SCHEDULED_DATE_IN_PAST_1, date));
    }
