...
public class CmsEditPointer extends CmsDialog {
  ...
  /**
   * Stores the value of the link target.
   *
   * <p>
   */
    ...
    if (CmsStringUtil.isEmpty(getParamLinkTarget())) {
      ...
      try {
        ...
        setParamMessage(
            Messages.get()
                .getBundle(getLocale())
                .key(Messages.ERR_GET_LINK_TARGET_1, getParamResource()));
  ...
  protected void initWorkplaceRequestValues(
    ...
    if (DIALOG_OK.equals(getParamAction())) {
      ...
      setParamTitle(
          key(Messages.GUI_CHLINK_1, new Object[] {CmsResource.getName(getParamResource())}));
    }
  }
}
