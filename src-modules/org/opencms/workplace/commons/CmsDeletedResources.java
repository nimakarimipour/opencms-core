...
public class CmsDeletedResources extends CmsDialog {
  ...
  public String buildIncludeJs() {
    ...
    html.append(
        CmsStringUtil.escapeJavaScript(
            key(org.opencms.workplace.list.Messages.GUI_LIST_ACTION_NO_SELECTION_0)));
    html.append("';\n");
  ...
  public String buildReport() throws JspException, ServletException, IOException {
    ...
    CmsDeletedResourcesList list =
        new CmsDeletedResourcesList(
            getJsp(), getParamResource(), Boolean.valueOf(getParamReadtree()).booleanValue());
