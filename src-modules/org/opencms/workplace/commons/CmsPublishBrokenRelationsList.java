...
public class CmsPublishBrokenRelationsList extends A_CmsListExplorerDialog {
      ...
      if (detailId.equals(LIST_DETAIL_RELATIONS)) {
        ...
        while (itRelations.hasNext()) {
          ...
          if (relationName.startsWith(infoEntry.getSiteRoot())) {
            ...
            relationName = CmsStringUtil.formatResourceName(relationName, 50);
            relationName =
                key(Messages.GUI_PUBLISH_SITE_RELATION_2, new Object[] {siteName, relationName});
          }
  ...
  protected void setIndependentActions(CmsListMetadata metadata) {
    ...
    hideAction.setName(
        Messages.get()
            .container(Messages.GUI_PUBLISH_BROKENRELATIONS_DETAIL_HIDE_RELATIONS_NAME_0));
    hideAction.setHelpText(
        Messages.get()
            .container(Messages.GUI_PUBLISH_BROKENRELATIONS_DETAIL_HIDE_RELATIONS_HELP_0));
    ...
    showAction.setName(
        Messages.get()
            .container(Messages.GUI_PUBLISH_BROKENRELATIONS_DETAIL_SHOW_RELATIONS_NAME_0));
    showAction.setHelpText(
        Messages.get()
            .container(Messages.GUI_PUBLISH_BROKENRELATIONS_DETAIL_SHOW_RELATIONS_HELP_0));
    ...
    CmsListItemDetails relationsDetailsPrint =
        new CmsListItemDetails(LIST_DETAIL_RELATIONS_PRINT) {
