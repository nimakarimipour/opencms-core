...
public class CmsTouch extends CmsMultiDialog {
   ...
   *
   * <p>The content parameter on files decides if also the content is rewritten.
   *
   * <p>
   *
   ...
   *
   * <p>The timestamp parameter stores the new timestamp as String.
   *
   * <p>
   *
  ...
  protected boolean performDialogOperation() throws CmsException {
    ...
    // on folder touch or multi resource operation display "please wait" screen, not for simple file
    // copy
    ...
    try {
      ...
      throw new CmsException(
          Messages.get().container(Messages.ERR_PARSE_TIMESTAMP_1, getParamNewtimestamp()), e);
    }
    ...
    while (i.hasNext()) {
      ...
      try {
        ...
        checkLock(resName);
        touchSingleResource(
            getCms(), resName, timeStamp, touchRecursive, correctDate, touchContent);
