...
public abstract class A_CmsResourceCategoriesList extends A_CmsListDialog {
    ...
    while (itCategories.hasNext()) {
      ...
      try {
        CmsCategory category =
            m_categoryService.readCategory(getCms(), categoryPath, getParamResource());
  ...
  protected List<CmsListItem> getListItems() throws CmsException {
    ...
    cats =
        CmsCategoryService.getInstance()
            .localizeCategories(
                getCms(), cats, OpenCms.getWorkplaceManager().getWorkplaceLocale(getCms()));
  ...
  protected List<CmsCategory> getResourceCategories() throws CmsException {
    ...
    if (m_resCats == null) {
      m_resCats =
          m_categoryService.readResourceCategories(getJsp().getCmsObject(), getParamResource());
    }
    return m_resCats;
  }
  ...
  protected void setIndependentActions(CmsListMetadata metadata) {
    ...
    pathDetails.setShowActionName(
        Messages.get().container(Messages.GUI_CATEGORIES_DETAIL_SHOW_PATH_NAME_0));
    pathDetails.setShowActionHelpText(
        Messages.get().container(Messages.GUI_CATEGORIES_DETAIL_SHOW_PATH_HELP_0));
    pathDetails.setHideActionName(
        Messages.get().container(Messages.GUI_CATEGORIES_DETAIL_HIDE_PATH_NAME_0));
    pathDetails.setHideActionHelpText(
        Messages.get().container(Messages.GUI_CATEGORIES_DETAIL_HIDE_PATH_HELP_0));
    ...
    descriptionDetails.setName(
        Messages.get().container(Messages.GUI_CATEGORIES_DETAIL_DESCRIPTION_NAME_0));
