 ...
 *
 * <p>If the list items column definition has at least one direct action, the icon of the first
 * visible action is used for sorting (using the <code>
 * {@link I_CmsListDirectAction#setItem(CmsListItem)}</code> method); if not, the <code>
 * {@link Comparable}</code> interface is used.
 *
 * <p>
 *
 * @since 6.0.0
