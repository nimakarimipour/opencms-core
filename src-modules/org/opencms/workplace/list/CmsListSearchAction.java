 ...
 *
 * <p>It allows to search in several columns, including item details.
 *
 * <p>
 *
 * @since 6.0.0
...
public class CmsListSearchAction extends A_CmsListSearchAction {
  ...
  public String barHtml(CmsWorkplace wp) {
    ...
    if (wp instanceof A_CmsListDialog) {
      // http://www.securityfocus.com/archive/1/490498: searchfilter cross site scripting
      // vulnerability:
      html.append(
  ...
  /**
   * @see
   *     org.opencms.workplace.list.A_CmsListSearchAction#buttonHtml(org.opencms.workplace.CmsWorkplace)
   */
  @Override
    ...
    if (getHelpText() == EMPTY_MESSAGE) {
      ...
      setHelpText(
          new CmsMessageContainer(
              Messages.get(), Messages.GUI_LIST_ACTION_SEARCH_HELP_1, new Object[] {columns}));
    }
