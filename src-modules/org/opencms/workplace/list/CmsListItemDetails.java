...
/**
 * For adding detail information to the list items add an instance of this class to the list
 * metadata and fill the data like an additional column.
 *
 * <p>For detail contents you may use HTML code.
 *
 * <p>
 *
 * @since 6.0.0
...
public class CmsListItemDetails extends CmsListColumnDefinition {
  ...
  /**
   * @see
   *     org.opencms.workplace.list.CmsListColumnDefinition#setWp(org.opencms.workplace.list.A_CmsListDialog)
   */
  @Override
