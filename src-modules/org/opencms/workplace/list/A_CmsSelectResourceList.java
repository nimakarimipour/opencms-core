 ...
 *
 * <p>This dialog can be used as part of a wizard based dialog by forwarding to it and after the
 * selection switching back to the wizard. Necessary request parameters have to be passed through.
 *
 * <p>
 *
 * @since 6.5.6
...
public abstract class A_CmsSelectResourceList extends A_CmsListExplorerDialog {
  ...
  protected A_CmsSelectResourceList(
    ...
    getList()
        .getMetadata()
        .getIndependentAction(CmsListPrintIAction.LIST_ACTION_ID)
        .setVisible(false);
   ...
   *
   * <p>Usually you have to set the "action" parameter to another value before forwarding.
   *
   * <p>
   *
   ...
   *
   * <p>Override this to have special buttons for your dialog.
   *
   * <p>
   *
  ...
  /**
   * @see
   *     org.opencms.workplace.list.A_CmsListExplorerDialog#initWorkplaceRequestValues(org.opencms.workplace.CmsWorkplaceSettings,
  ...
  /**
   * The following columns are visible by default: type icon, resource name, title and last
   * modification date.
   *
   * <p>Override this to set different column visibilities.
   *
   * <p>
   *
  ...
  /**
   * @see
   *     org.opencms.workplace.list.A_CmsListExplorerDialog#setColumns(org.opencms.workplace.list.CmsListMetadata)
   */
  @Override
