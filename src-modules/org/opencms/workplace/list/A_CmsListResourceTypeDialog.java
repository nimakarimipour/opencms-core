...
public abstract class A_CmsListResourceTypeDialog extends A_CmsListDialog {
        ...
        public Comparator<CmsListItem> getComparator(final String columnId, final Locale locale) {
          ...
          return new Comparator<CmsListItem>() {
            ...
            public int compare(CmsListItem li1, CmsListItem li2) {
              ...
              CmsExplorerTypeSettings set1 =
                  OpenCms.getWorkplaceManager().getExplorerTypeSetting(li1.getId());
              CmsExplorerTypeSettings set2 =
                  OpenCms.getWorkplaceManager().getExplorerTypeSetting(li2.getId());
              if (set1 == null) {
                return -1;
              } else if (set2 == null) {
                return 1;
  ...
  public void actionDialog() throws JspException, ServletException, IOException {
    ...
    // set selected type
    I_CmsListDirectAction action =
        getList()
            .getMetadata()
            .getColumnDefinition(LIST_COLUMN_SELECT)
            .getDirectAction(LIST_ACTION_SEL);
    if (action != null) {
      ...
      if (detailId.equals(LIST_DETAIL_DESCRIPTION)) {
        ...
        try {
          ...
          CmsExplorerTypeSettings set =
              OpenCms.getWorkplaceManager().getExplorerTypeSetting(resType);
          if (set != null) {
  ...
  protected void setColumns(CmsListMetadata metadata) {
    ...
    CmsListItemSelectionCustomAction selAction =
        new CmsListItemSelectionCustomAction(LIST_ACTION_SEL, PARAM_SELECTED_TYPE);
