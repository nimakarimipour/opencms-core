...
/**
 * A list item comparator can be set at a column definition to set the sorting method for that
 * column.
 *
 * <p>
 *
...
public interface I_CmsListItemComparator {
  ...
  /**
   * Returns a new comparator for comparing list items by the given column, and using the given
   * locale.
   *
   * <p>
   *
