 ...
 *
 * <p>Do not forget to add parameter evaluation code overwritting the A_CmsListDialog#getList()
 * method, like in <tt>CmsProjectFilesDialog</tt>.
 *
 * <p>
 *
 * @since 6.0.0
...
public class CmsListDropdownAction extends CmsListIndependentAction {
  ...
  private CmsIdentifiableObjectContainer<CmsMessageContainer> m_items =
      new CmsIdentifiableObjectContainer<CmsMessageContainer>(true, false);
