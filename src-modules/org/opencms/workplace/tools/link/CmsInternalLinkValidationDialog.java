...
public class CmsInternalLinkValidationDialog extends CmsWidgetDialog {
   ...
   */
  public CmsInternalLinkValidationDialog(
  ...
  /**
   * Returns the list of VFS resources.
   *
   * <p>
   *
  ...
  /**
   * Initializes the session object to work with depending on the dialog state and request
   * parameters.
   *
   * <p>
   */
