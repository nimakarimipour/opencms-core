...
public final class Messages extends A_CmsMessageBundle {
  ...
  /** Message constant for key in the resource bundle. */
  public static final String GUI_BROKENLINKS_DETAIL_HIDE_LINKS_HELP_0 =
      "GUI_BROKENLINKS_DETAIL_HIDE_LINKS_HELP_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_BROKENLINKS_DETAIL_HIDE_LINKS_NAME_0 =
      "GUI_BROKENLINKS_DETAIL_HIDE_LINKS_NAME_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_BROKENLINKS_DETAIL_LINKS_NAME_0 =
      "GUI_BROKENLINKS_DETAIL_LINKS_NAME_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_BROKENLINKS_DETAIL_SHOW_LINKS_HELP_0 =
      "GUI_BROKENLINKS_DETAIL_SHOW_LINKS_HELP_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_BROKENLINKS_DETAIL_SHOW_LINKS_NAME_0 =
  ...
  /** Message constant for key in the resource bundle. */
  public static final String GUI_BROKENLINKS_NOT_VISIBLE_RESOURCES_1 =
  ...
  /** Message constant for key in the resource bundle. */
  public static final String GUI_CHECK_INTERNAL_LINK_LIST_HELP_0 =
      "GUI_CHECK_INTERNAL_LINK_LIST_HELP_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_CHECK_INTERNAL_LINK_LIST_NAME_0 =
  ...
  /** Message constant for key in the resource bundle. */
  public static final String GUI_EXTERNALLINK_ADMIN_TOOL_GROUP_0 =
      "GUI_EXTERNALLINK_ADMIN_TOOL_GROUP_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_EXTERNALLINK_ADMIN_TOOL_HELP_0 =
      "GUI_EXTERNALLINK_ADMIN_TOOL_HELP_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_EXTERNALLINK_ADMIN_TOOL_NAME_0 =
      "GUI_EXTERNALLINK_ADMIN_TOOL_NAME_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_EXTERNALLINK_CHECK_VIEW_RESULTS_GROUP_0 =
      "GUI_EXTERNALLINK_CHECK_VIEW_RESULTS_GROUP_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_EXTERNALLINK_CHECK_VIEW_RESULTS_HELP_0 =
      "GUI_EXTERNALLINK_CHECK_VIEW_RESULTS_HELP_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_EXTERNALLINK_CHECK_VIEW_RESULTS_NAME_0 =
      "GUI_EXTERNALLINK_CHECK_VIEW_RESULTS_NAME_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_INTERNALLINK_EDITOR_LABEL_BLOCK_0 =
  ...
  /** Message constant for key in the resource bundle. */
  public static final String GUI_NEW_EXTERNAL_LINK_CHECK_GROUP_0 =
      "GUI_NEW_EXTERNAL_LINK_CHECK_GROUP_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_NEW_EXTERNAL_LINK_CHECK_HELP_0 =
      "GUI_NEW_EXTERNAL_LINK_CHECK_HELP_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_NEW_EXTERNAL_LINK_CHECK_NAME_0 =
  ...
  /** Message constant for key in the resource bundle. */
  public static final String GUI_VALIDATE_EXTERNAL_LINKS_CONFIRMATION_0 =
