...
public class CmsModulesUploadFromServer extends CmsWidgetDialog {
  ...
  protected static final String IMPORT_ACTION_REPORT =
      "/system/workplace/admin/modules/reports/import.jsp";
  ...
  /** The replace action. */
  protected static final String REPLACE_ACTION_REPORT =
      "/system/workplace/admin/modules/reports/replace.jsp";
   ...
   */
  public CmsModulesUploadFromServer(
    ...
    try {
      ...
      importpath =
          OpenCms.getSystemInfo()
              .getAbsoluteRfsPathRelativeToWebInf(importpath + "modules/" + m_moduleupload);
      ...
      if (!dependencies.isEmpty()) {
        ...
        errors.add(
            new CmsRuntimeException(
                Messages.get()
                    .container(
                        Messages.ERR_ACTION_MODULE_DEPENDENCY_2, m_moduleupload, new String(dep))));
      }

    } catch (CmsConfigurationException e) {
      errors.add(
          new CmsRuntimeException(
              Messages.get().container(Messages.ERR_ACTION_MODULE_UPLOAD_1, m_moduleupload), e));
    }
  ...
  /**
   * Returns the list of all modules available on the server in prepared CmsSelectWidgetOption
   * objects.
   *
   * <p>
   *
