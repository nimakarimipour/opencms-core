...
public class CmsDependenciesEdit extends CmsWidgetDialog {
  ...
  /**
   * Gets the module dependency parameter.
   *
   * <p>
   *
  ...
  /**
   * Sets the module dependency parameter.
   *
   * <p>
   *
  ...
  protected void defineWidgets() {
    ...
    addWidget(
        new CmsWidgetDialogParameter(
            m_dependency, "name", PAGES[0], new CmsSelectWidget(getModules())));
    addWidget(
        new CmsWidgetDialogParameter(
  ...
  /**
   * Checks if the new dependency dialog has to be displayed.
   *
   * <p>
   *
