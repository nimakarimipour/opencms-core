...
public class CmsExportpointsEdit extends CmsWidgetDialog {
  ...
  /**
   * Gets the module exportpoint parameter.
   *
   * <p>
   *
  ...
  /**
   * Sets the module exportpoint parameter.
   *
   * <p>
   *
  ...
  protected void defineWidgets() {
    ...
    addWidget(
        new CmsWidgetDialogParameter(
            m_exportpoint, "configuredDestination", PAGES[0], new CmsComboWidget(destinations)));
    addWidget(
        new CmsWidgetDialogParameter(
  ...
  /**
   * Returns the list of default destinations for export points.
   *
  ...
  /**
   * Checks if the new export point dialog has to be displayed.
   *
   * <p>
   *
