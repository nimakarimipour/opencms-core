...
public class CmsModuleAddResourceTypes extends CmsWidgetDialog {
  ...
  private static final String ADD_TYPE_REPORT =
      "/system/workplace/admin/modules/add_type_report.jsp";
   ...
   */
  public CmsModuleAddResourceTypes(
    ...
    try {
      ...
      if (OpenCms.getResourceManager().hasResourceType(m_resInfo.getName())) {
        throw new CmsException(
            Messages.get()
                .container(Messages.ERR_RESOURCE_TYPE_ALREADY_EXISTS_1, m_resInfo.getName()));
      }
  ...
  /**
   * Returns the next available resource type id.
   *
   * <p>
   *
