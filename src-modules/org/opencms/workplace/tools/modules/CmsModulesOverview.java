...
public class CmsModulesOverview extends CmsWidgetDialog {
  ...
  protected void defineWidgets() {
    ...
    addWidget(
        new CmsWidgetDialogParameter(m_module, "description", PAGES[0], new CmsDisplayWidget()));
    addWidget(
        new CmsWidgetDialogParameter(
            m_module, "version.version", PAGES[0], new CmsDisplayWidget()));
    addWidget(new CmsWidgetDialogParameter(m_module, "group", PAGES[0], new CmsDisplayWidget()));
    addWidget(
        new CmsWidgetDialogParameter(m_module, "actionClass", PAGES[0], new CmsDisplayWidget()));
    addWidget(
        new CmsWidgetDialogParameter(m_module, "authorName", PAGES[0], new CmsDisplayWidget()));
    addWidget(
        new CmsWidgetDialogParameter(m_module, "authorEmail", PAGES[0], new CmsDisplayWidget()));
  }
