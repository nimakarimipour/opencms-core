...
public class CmsCloneModuleInfo {
  ...
  /**
   * A module name where the formatters are located that are referenced within the XSDs of the
   * module to clone.
   */
  private String m_formatterSourceModule = "com.alkacon.bootstrap.formatters";

  /**
   * A module name where the formatters are located that should be referenced by the XSDs of the
   * clone.
   */
