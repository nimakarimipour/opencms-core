 ...
 *
 * <p>If the advanced button is pressed or the validation is false, then the {@link #MODE_ADVANCED}
 * mode of {@link CmsHtmlImportDialog} is shown.
 *
 * <p>The following files use this class:
 *
 * <ul>
 *   <li><code>/commons/newresource_uploadHtml.jsp</code> (Contains only a redirect to the
 *       uploadhtml.jsp)
 *   <li><code>/explorer/uploadhtml/uploadhtml.jsp</code>
 * </ul>
 *
 * <p>
 *
 * @see CmsHtmlImportDialog
 *     <p>
 */
public class CmsNewResourceExtendedHtmlImport extends CmsHtmlImportDialog {
   ...
   */
  public CmsNewResourceExtendedHtmlImport(
