...
public class CmsSitesRemoveReport extends A_CmsListReport {
        ...
        for (String sitePath : CmsStringUtil.splitAsList(m_sites, ",")) {
          try {
            OpenCms.getSiteManager()
                .removeSite(getCms(), OpenCms.getSiteManager().getSiteForSiteRoot(sitePath));
            getReport()
                .println(
  ...
  /**
   * Returns the paths of the sites to remove.
   *
   * <p>
   *
