...
/**
 * A dialog that allows to write the sites configured in OpenCms into a web server configuration
...
public class CmsSitesWebserverDialog extends CmsWidgetDialog {
  ...
  public static final String PATH_WEBSERVER_EXPORT =
      OpenCms.getSystemInfo().getAbsoluteRfsPathRelativeToWebInf("server-scripts/");
  ...
  /** The default parameter value. */
  private static final String DEFAULT_PARAM_SECURE_TEMPLATE =
      "/path/to/webserver/secure-config.template";
  ...
  private static final String DEFAULT_PATH_SCRIPT_LINUX =
      MODULE_PATH + TEMPLATE_FILES + DEFAULT_NAME_LINUX_SCRIPT;

  /** The default export point URI of the web server script (LINUX). */
  private static final String DEFAULT_PATH_SCRIPT_WIDNOWS =
      MODULE_PATH + TEMPLATE_FILES + DEFAULT_NAME_WINDOWS_SCRIPT;

  /** The default export point URI of the web server template. */
  private static final String DEFAULT_PATH_SECURE_TEMPLATE =
      MODULE_PATH + TEMPLATE_FILES + DEFAULT_NAME_WEBSERVER_SECURE;

  /** The default export point URI of the web server template. */
  private static final String DEFAULT_PATH_TEMPLATE =
      MODULE_PATH + TEMPLATE_FILES + DEFAULT_NAME_WEBSERVER_CONFIG;
   ...
   */
  public CmsSitesWebserverDialog(
  ...
  public void actionCommit() throws IOException, ServletException {
    ...
    getToolManager()
        .jspForwardPage(this, CmsSitesOverviewList.PATH_REPORTS + "webserver.jsp", params);
  }
    ...
    result.append(
        dialogBlockStart(
            Messages.get()
                ...
                .key(Messages.GUI_SITES_WEBSERVER_TITLE_0)));
    result.append(createWidgetTableStart());
  ...
  protected void defineWidgets() {
    ...
    addWidget(
        new CmsWidgetDialogParameter(this, PARAM_CONFIG_TEMPLATE, PAGES[0], new CmsInputWidget()));
    addWidget(
        new CmsWidgetDialogParameter(this, PARAM_SECURE_TEMPLATE, PAGES[0], new CmsInputWidget()));
    addWidget(
        new CmsWidgetDialogParameter(this, PARAM_TARGET_PATH, PAGES[0], new CmsInputWidget()));
    addWidget(
        new CmsWidgetDialogParameter(this, PARAM_WEBSERVER_SCRIPT, PAGES[0], new CmsInputWidget()));
    addWidget(
        new CmsWidgetDialogParameter(this, PARAM_LOGGING_DIR, PAGES[0], new CmsInputWidget()));
    addWidget(
        new CmsWidgetDialogParameter(this, PARAM_FILENAME_PREFIX, PAGES[0], new CmsInputWidget()));
  }
  ...
  protected void initMembers(Map<String, String> params) {
    ...
    m_webserverscript =
        getParameter(params, PARAM_WEBSERVER_SCRIPT, DEFAULT_PARAM_WEBSERVER_SCRIPT);
    ...
    if (DEFAULT_PARAM_WEBSERVER_SCRIPT.equals(m_webserverscript)
      ...
      for (CmsExportPoint point :
          OpenCms.getModuleManager().getModule(MODULE_NAME).getExportPoints()) {
