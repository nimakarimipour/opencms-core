...
public class CmsSitesWebserverReport extends A_CmsListReport {
   ...
   */
  public CmsSitesWebserverReport(
  ...
  /**
   * Returns the configuration template parameter.
   *
   * <p>
   *
  ...
  /**
   * Returns the file name prefix parameter.
   *
   * <p>
   *
  ...
  /**
   * Returns the paramSecuretemplate.
   *
   * <p>
   *
  ...
  public I_CmsReportThread initializeThread() {
    ...
    setParamCloseLink(
        CmsToolManager.linkForToolPath(getJsp(), "/sites/", new HashMap<String, String[]>()));
  ...
  /**
   * Sets the configuration template parameter.
   *
   * <p>
   *
  ...
  /**
   * Sets the file name prefix parameter.
   *
   * <p>
   *
