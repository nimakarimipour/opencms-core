...
public abstract class A_CmsRolesList extends A_CmsListDialog {
        ...
        if (detailId.equals(LIST_DETAIL_PATH)) {
          html.append(
              OpenCms.getOrgUnitManager()
                  .readOrganizationalUnit(getCms(), CmsOrganizationalUnit.getParentFqn(roleName))
  ...
  /**
   * Returns if the organizational unit details button should be displayed.
   *
   * <p>
   *
