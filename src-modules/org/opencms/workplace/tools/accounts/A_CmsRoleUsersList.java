...
public abstract class A_CmsRoleUsersList extends A_CmsListDialog {
  ...
  /**
   * Returns if the list of users has users of other organizational units.
   *
   * <p>
   *
  ...
  /**
   * Sets the role name parameter value.
   *
   * <p>
   *
  ...
  /**
   * Checks if other OUs are visible.
   *
   * <p>
   *
  ...
  protected void setIndependentActions(CmsListMetadata metadata) {
    ...
    otherOuDetails.setHideAction(
        new CmsListIndependentAction(LIST_DETAIL_ORGUNIT) {
    ...
    otherOuDetails.setShowActionName(
        Messages.get().container(Messages.GUI_USERS_DETAIL_SHOW_OTHEROU_NAME_0));
    otherOuDetails.setShowActionHelpText(
        Messages.get().container(Messages.GUI_USERS_DETAIL_SHOW_OTHEROU_HELP_0));
    otherOuDetails.setHideActionName(
        Messages.get().container(Messages.GUI_USERS_DETAIL_HIDE_OTHEROU_NAME_0));
    otherOuDetails.setHideActionHelpText(
        Messages.get().container(Messages.GUI_USERS_DETAIL_HIDE_OTHEROU_HELP_0));
    ...
    otherOuDetails.setFormatter(
        new CmsListItemDetailsFormatter(
            Messages.get().container(Messages.GUI_USERS_DETAIL_OTHEROU_NAME_0)));
