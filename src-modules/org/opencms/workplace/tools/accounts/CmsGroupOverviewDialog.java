...
public class CmsGroupOverviewDialog extends CmsWidgetDialog {
  ...
  public String getAssignedOu() {
    ...
    try {
      return OpenCms.getOrgUnitManager()
          .readOrganizationalUnit(getCms(), m_group.getOuFqn())
  ...
  /**
   * Dummy setter for the nice name property.
   *
   * <p>
   *
  ...
  public void setNiceName(String name) {
    ...
    // if this method doesn't exist, the constructor of CmsWidgetDialogParameter throws an
    // exception; not sure why
  }
  ...
  protected void defineWidgets() {
    ...
    if (!isOverview()) {
      ...
      addWidget(
          new CmsWidgetDialogParameter(this, "niceName", "name", PAGES[0], new CmsDisplayWidget()));
      addWidget(
          new CmsWidgetDialogParameter(this, "description", PAGES[0], new CmsDisplayWidget()));
      addWidget(new CmsWidgetDialogParameter(this, "assignedOu", PAGES[0], new CmsDisplayWidget()));
      addWidget(
          new CmsWidgetDialogParameter(this, "parentGroup", PAGES[0], new CmsDisplayWidget()));
  ...
  /**
   * Checks if the group overview has to be displayed.
   *
   * <p>
   *
