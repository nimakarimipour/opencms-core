 ...
 *
 * <p>Displays the dependencies of a user or a list of user.
 *
 * <p>
 *
 * @since 6.0.0
...
public class CmsUserDependenciesList extends CmsUserPrincipalDependenciesList {
   ...
   */
  public CmsUserDependenciesList(
  ...
  public void actionDialog() throws JspException, ServletException, IOException {
    ...
    switch (getAction()) {
      case ACTION_DELETE:
        Iterator it =
            CmsStringUtil.splitAsList(getUserName(), CmsHtmlList.ITEM_SEPARATOR, true).iterator();
        while (it.hasNext()) {
      ...
      case ACTION_TRANSFER:
        ...
        getToolManager()
            .jspForwardPage(
                this, getJsp().getRequestContext().getFolderUri() + "user_transfer.jsp", params);
        break;
