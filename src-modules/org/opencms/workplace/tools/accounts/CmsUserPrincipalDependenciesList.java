...
public class CmsUserPrincipalDependenciesList extends A_CmsListDialog {
   ...
   */
  public CmsUserPrincipalDependenciesList(
    ...
    try {
      ...
      while (itUsers.hasNext()) {
        ...
        Set<CmsResource> resources =
            getCms().getResourcesForPrincipal(user.getId(), null, m_showAttributes);
  ...
  protected void setColumns(CmsListMetadata metadata) {
    ...
    iconAction.setName(
        Messages.get().container(Messages.GUI_USER_DEPENDENCIES_LIST_ACTION_ICON_NAME_0));
    iconAction.setHelpText(
        Messages.get().container(Messages.GUI_USER_DEPENDENCIES_LIST_ACTION_ICON_HELP_0));
    ...
    createdCol.setName(
        Messages.get().container(Messages.GUI_USER_DEPENDENCIES_LIST_COLS_CREATED_0));
    ...
    lastModifiedCol.setName(
        Messages.get().container(Messages.GUI_USER_DEPENDENCIES_LIST_COLS_LASTMODIFIED_0));
    ...
    permissionsCol.setName(
        Messages.get().container(Messages.GUI_USER_DEPENDENCIES_LIST_COLS_PERMISSIONS_0));
