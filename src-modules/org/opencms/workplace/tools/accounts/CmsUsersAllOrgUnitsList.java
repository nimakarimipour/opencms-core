...
public class CmsUsersAllOrgUnitsList extends A_CmsUsersList {
   ...
   */
  public CmsUsersAllOrgUnitsList(
  ...
  public void executeListSingleActions() throws IOException, ServletException {
    ...
    params.put(
        ...
        getSelectedItem().get(LIST_COLUMN_ORGUNIT).toString().substring(1));
        ...
        if (detailId.equals(LIST_DETAIL_ORGUNIT_DESC)) {
          ...
          html.append(
              OpenCms.getOrgUnitManager()
                  .readOrganizationalUnit(getCms(), user.getOuFqn())
  ...
  /**
   * @see org.opencms.workplace.tools.accounts.A_CmsUsersList#setUserData(org.opencms.file.CmsUser,
