...
public abstract class A_CmsUserDataImexportDialog extends CmsWidgetDialog {
   ...
   */
  public A_CmsUserDataImexportDialog(
  ...
  protected List<CmsSelectWidgetOption> getSelectRoles() {
    ...
    try {
      boolean inRootOu =
          CmsStringUtil.isEmptyOrWhitespaceOnly(getParamOufqn())
      ...
      while (itRoles.hasNext()) {
        ...
        retVal.add(
            new CmsSelectWidgetOption(role.getGroupName(), false, role.getName(getLocale())));
      }
    ...
    Collections.sort(
        retVal,
        new Comparator<CmsSelectWidgetOption>() {
