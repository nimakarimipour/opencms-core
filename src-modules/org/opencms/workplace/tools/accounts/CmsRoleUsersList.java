...
public class CmsRoleUsersList extends A_CmsRoleUsersList {
        ...
        try {
          if (getCms().readUser(userName).getOuFqn().equals(getParamOufqn())) {
            OpenCms.getRoleManager()
                .removeUserFromRole(
                    getCms(), CmsRole.valueOf(getCms().readGroup(getParamRole())), userName);
          }
  ...
  protected List<CmsUser> getUsers(boolean withOtherOus) throws CmsException {
    ...
    return OpenCms.getRoleManager()
        .getUsersOfRole(
            getCms(), CmsRole.valueOf(getCms().readGroup(getParamRole())), withOtherOus, true);
  }

  /**
   * @see
   *     org.opencms.workplace.tools.accounts.A_CmsRoleUsersList#setColumns(org.opencms.workplace.list.CmsListMetadata)
   */
  @Override
  protected void setColumns(CmsListMetadata metadata) {
    ...
    stateAction.setHelpText(
        Messages.get().container(Messages.GUI_ROLEUSERS_LIST_DEFACTION_REMOVE_HELP_0));
  ...
  protected void setDefaultAction(CmsListColumnDefinition loginCol) {
    ...
    removeAction.setHelpText(
        Messages.get().container(Messages.GUI_USERS_LIST_DEFACTION_REMOVE_HELP_0));
  ...
  protected void setMultiActions(CmsListMetadata metadata) {
    ...
    removeMultiAction.setName(
        Messages.get().container(Messages.GUI_USERS_LIST_MACTION_REMOVE_NAME_0));
    removeMultiAction.setHelpText(
        Messages.get().container(Messages.GUI_USERS_LIST_MACTION_REMOVE_HELP_0));
  ...
  protected void validateParamaters() throws Exception {
    ...
    OpenCms.getRoleManager()
        .checkRole(getCms(), CmsRole.valueOf(getCms().readGroup(getParamRole())));
  }
