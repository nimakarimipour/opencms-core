...
public class CmsGroupPrincipalDependenciesList extends A_CmsListDialog {
   ...
   */
  public CmsGroupPrincipalDependenciesList(
  ...
  protected List<CmsListItem> getListItems() throws CmsException {
    ...
    CmsIdentifiableObjectContainer<CmsListItem> ret =
        new CmsIdentifiableObjectContainer<CmsListItem>(true, false);
    ...
    try {
      ...
      while (itGroups.hasNext()) {
        ...
        Set<CmsResource> resources =
            getCms().getResourcesForPrincipal(group.getId(), null, m_showAttributes);
  ...
  protected void setColumns(CmsListMetadata metadata) {
    ...
    iconCol.setHelpText(
        Messages.get().container(Messages.GUI_GROUP_DEPENDENCIES_LIST_COLS_ICON_HELP_0));
    iconCol.setWidth("20");
    ...
    permissionsCol.setName(
        Messages.get().container(Messages.GUI_GROUP_DEPENDENCIES_LIST_COLS_PERMISSIONS_0));
  ...
  protected void setIconActions(CmsListColumnDefinition iconCol) {
    ...
    CmsListDirectAction resourceIconAction =
        new CmsDependencyIconAction(
            LIST_ACTION_ICON, CmsDependencyIconActionType.RESOURCE, getCms());
    resourceIconAction.setName(
        Messages.get().container(Messages.GUI_GROUP_DEPENDENCIES_LIST_ACTION_RES_NAME_0));
    ...
    CmsListDirectAction groupIconAction =
        new CmsDependencyIconAction(LIST_ACTION_ICON, CmsDependencyIconActionType.GROUP, getCms());
    groupIconAction.setName(
        Messages.get().container(Messages.GUI_GROUP_DEPENDENCIES_LIST_ACTION_GRP_NAME_0));
    groupIconAction.setHelpText(
        Messages.get().container(Messages.GUI_GROUP_DEPENDENCIES_LIST_ACTION_GRP_HELP_0));
    groupIconAction.setEnabled(false);
    iconCol.addDirectAction(groupIconAction);

    // add group icon action
    CmsListDirectAction userIconAction =
        new CmsDependencyIconAction(LIST_ACTION_ICON, CmsDependencyIconActionType.USER, getCms());
    userIconAction.setName(
        Messages.get().container(Messages.GUI_GROUP_DEPENDENCIES_LIST_ACTION_USR_NAME_0));
    userIconAction.setHelpText(
