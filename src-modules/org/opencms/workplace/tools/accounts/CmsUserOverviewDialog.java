...
public class CmsUserOverviewDialog extends CmsWidgetDialog {
  ...
  private static final I_CmsListFormatter LAST_LOGIN_FORMATTER =
      CmsListDateMacroFormatter.getDefaultDateFormatter();
  ...
  public String getAssignedOu() {
    ...
    try {
      return OpenCms.getOrgUnitManager()
          .readOrganizationalUnit(getCms(), m_user.getOuFqn())
   ...
   *
   * <p>Auxiliary Property for better representation.
   *
   * <p>
   *
  ...
  protected void defineWidgets() {
    ...
    if (isOverview()) {
      ...
      addWidget(
          new CmsWidgetDialogParameter(this, "selfManagement", PAGES[0], new CmsDisplayWidget()));
  ...
  /**
   * Checks if the User overview has to be displayed.
   *
   * <p>
   *
