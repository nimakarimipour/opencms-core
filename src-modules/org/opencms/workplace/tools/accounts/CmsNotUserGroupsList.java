...
public class CmsNotUserGroupsList extends A_CmsUserGroupsList {
  ...
  protected void setMultiActions(CmsListMetadata metadata) {
    ...
    addMultiAction.setHelpText(
        Messages.get().container(Messages.GUI_GROUPS_LIST_MACTION_ADD_HELP_0));
    addMultiAction.setConfirmationMessage(
        Messages.get().container(Messages.GUI_GROUPS_LIST_MACTION_ADD_CONF_0));
  ...
  protected void setStateActionCol(CmsListMetadata metadata) {
    ...
    stateAction.setHelpText(
        Messages.get().container(Messages.GUI_GROUPS_LIST_DEFACTION_ADD_HELP_0));
