...
public class CmsLanguageCopyThread extends A_CmsReportThread {
  ...
  private void copyLanguageNodes() {
    ...
    for (int i = 0; i < m_copyresources.length; i++) {
      ...
      report.print(
          Messages.get()
              .container(Messages.RPT_LOCALIZATION_BYPASS_1, new Object[] {m_copyresources[i]}));
      report.print(
  ...
  /**
   * Recursively steps up to the resource that is the originator of the given resource which has an
   * inherited lock.
   *
   * <p>
   *
