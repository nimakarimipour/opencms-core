...
public class CmsChangeElementLocaleThread extends A_CmsReportThread {
  ...
  /**
   * Performs the changing of the element Locales.
   *
   * <p>
   *
  ...
  private void changeElementLocales() throws CmsException {
    ...
    while (i.hasNext()) {
      ...
      getReport()
          .print(Messages.get().container(Messages.RPT_PROCESSING_PAGE_0), I_CmsReport.FORMAT_NOTE);
      getReport()
          .print(
              org.opencms.report.Messages.get()
                  .container(
      ...
      try {
        ...
        if (checkTemplate) {
          ...
          String template =
              getCms()
                  .readPropertyObject(res, CmsPropertyDefinition.PROPERTY_TEMPLATE, true)
                  .getValue("");
        ...
        if (!page.hasLocale(oldLocale)) {
          ...
          getReport()
              .println(
                  Messages.get()
                      .container(
                          Messages.RPT_CHANGEELEMENTLOCALE_OLDLOCALE_1, m_settings.getOldLocale()),
                  I_CmsReport.FORMAT_NOTE);
          continue;
        }
        ...
        if (page.hasLocale(newLocale)) {
          ...
          getReport()
              .println(
                  Messages.get()
                      .container(
                          Messages.RPT_CHANGEELEMENTLOCALE_NEWLOCALE_1, m_settings.getNewLocale()),
                  I_CmsReport.FORMAT_NOTE);
          continue;
        }
