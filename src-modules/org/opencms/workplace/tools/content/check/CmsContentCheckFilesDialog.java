...
public class CmsContentCheckFilesDialog extends A_CmsListExplorerDialog {
   ...
   */
  public CmsContentCheckFilesDialog(
  ...
  protected void setIndependentActions(CmsListMetadata metadata) {
    ...
    errorDetails.setFormatter(
        new CmsListItemDetailsFormatter(
            Messages.get().container(Messages.GUI_CHECKCONTENT_LABEL_ERROR_0)));
    ...
    warningDetails.setFormatter(
        new CmsListItemDetailsFormatter(
            Messages.get().container(Messages.GUI_CHECKCONTENT_LABEL_WARNING_0)));
