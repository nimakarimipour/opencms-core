...
public class CmsContentCheckResult {
  ...
  /**
   * Map containing all all collected errors. Resourcenames are used as keys, lists are used as
   * values.
   */
  ...
  /**
   * Map containing all all collected warnings. Resourcenames are used as keys, lists are used as
   * values.
   */
  ...
  /**
   * Gets a list of all CmsContentCheckResource that colleced an error or a warning during the
   * content check.
   *
   * <p>
   *
   ...
   *
   * <p>The map contains the complete resource root path as keys and a list of errors as values.
   *
   ...
   *
   * <p>The map contains the complete resource root path as keys and a list of warnings as values.
   *
   * @return map of collected warnings
   */
