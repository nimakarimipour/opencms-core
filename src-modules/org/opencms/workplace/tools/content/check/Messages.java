...
public final class Messages extends A_CmsMessageBundle {
  ...
  /** Message constant for key in the resource bundle. */
  public static final String GUI_CHECKCONTENT_CONFIGURATION_PROPERTY_HELP_0 =
      "GUI_CHECKCONTENT_CONFIGURATION_PROPERTY_HELP_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_CHECKCONTENT_DETAIL_HIDE_ERRORINFO_HELP_0 =
      "GUI_CHECKCONTENT_DETAIL_HIDE_ERRORINFO_HELP_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_CHECKCONTENT_DETAIL_HIDE_ERRORINFO_NAME_0 =
      "GUI_CHECKCONTENT_DETAIL_HIDE_ERRORINFO_NAME_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_CHECKCONTENT_DETAIL_HIDE_WARNINGINFO_HELP_0 =
      "GUI_CHECKCONTENT_DETAIL_HIDE_WARNINGINFO_HELP_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_CHECKCONTENT_DETAIL_HIDE_WARNINGINFO_NAME_0 =
      "GUI_CHECKCONTENT_DETAIL_HIDE_WARNINGINFO_NAME_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_CHECKCONTENT_DETAIL_SHOW_ERRORINFO_HELP_0 =
      "GUI_CHECKCONTENT_DETAIL_SHOW_ERRORINFO_HELP_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_CHECKCONTENT_DETAIL_SHOW_ERRORINFO_NAME_0 =
      "GUI_CHECKCONTENT_DETAIL_SHOW_ERRORINFO_NAME_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_CHECKCONTENT_DETAIL_SHOW_WARNINGINFO_HELP_0 =
      "GUI_CHECKCONTENT_DETAIL_SHOW_WARNINGINFO_HELP_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_CHECKCONTENT_DETAIL_SHOW_WARNINGINFO_NAME_0 =
  ...
  /** Message constant for key in the resource bundle. */
  public static final String LOG_DEBUG_PROPERTY_CONFIG_FILENAME_1 =
      "LOG_DEBUG_PROPERTY_CONFIG_FILENAME_1";

  /** Message constant for key in the resource bundle. */
  public static final String LOG_DEBUG_PROPERTY_CONFIG_PROPERTY_3 =
      "LOG_DEBUG_PROPERTY_CONFIG_PROPERTY_3";

  /** Message constant for key in the resource bundle. */
  public static final String LOG_DEBUG_PROPERTY_CONFIG_XPATH_2 =
      "LOG_DEBUG_PROPERTY_CONFIG_XPATH_2";

  /** Message constant for key in the resource bundle. */
  public static final String LOG_DEBUG_PROPERTY_CONFIGURED_ERRORS_2 =
      "LOG_DEBUG_PROPERTY_CONFIGURED_ERRORS_2";

  /** Message constant for key in the resource bundle. */
  public static final String LOG_DEBUG_PROPERTY_CONFIGURED_WARNINGS_2 =
      "LOG_DEBUG_PROPERTY_CONFIGURED_WARNINGS_2";

  /** Message constant for key in the resource bundle. */
  public static final String LOG_DEBUG_PROPERTY_ISEMPTYCHECK_1 =
      "LOG_DEBUG_PROPERTY_ISEMPTYCHECK_1";

  /** Message constant for key in the resource bundle. */
  public static final String LOG_DEBUG_PROPERTY_ISFILENAME_1 = "LOG_DEBUG_PROPERTY_ISFILENAME_1";

  /** Message constant for key in the resource bundle. */
  public static final String LOG_DEBUG_PROPERTY_MATCHPATTERN_2 =
      "LOG_DEBUG_PROPERTY_MATCHPATTERN_2";
  ...
  /** Message constant for key in the resource bundle. */
  public static final String LOG_ERROR_PROCESSING_PROPERTIES_2 =
      "LOG_ERROR_PROCESSING_PROPERTIES_2";
