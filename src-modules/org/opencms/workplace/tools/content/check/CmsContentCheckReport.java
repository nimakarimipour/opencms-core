  ...
  public void displayReport() throws JspException {
    ...
    switch (getAction()) {
      case ACTION_REPORT_END:
        ...
        m_contentCheck =
            (CmsContentCheck) ((Map) getSettings().getDialogObject()).get(getParamClassname());
        I_CmsResourceCollector collector =
            new CmsContentCheckCollector(null, m_contentCheck.getResults());
