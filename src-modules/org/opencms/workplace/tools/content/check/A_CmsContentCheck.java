...
public abstract class A_CmsContentCheck implements I_CmsContentCheck, I_CmsToolHandler {
   ...
   */
  public abstract CmsContentCheckResource executeContentCheck(
  ...
  public String getGroup() {
    ...
    return org.opencms.workplace.tools.content.Messages.get()
        .getBundle()
        .key(
            org.opencms.workplace.tools.content.Messages
  ...
  public Map getParameters(CmsWorkplace wp) {
    ...
    parameters.put(
        CmsDialog.PARAM_CLOSELINK, CmsToolManager.linkForToolPath(wp.getJsp(), CLOSELINK));
   ...
   *     org.opencms.workplace.tools.CmsToolRootHandler, java.lang.String)
   */
