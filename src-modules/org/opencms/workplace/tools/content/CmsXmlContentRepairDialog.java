...
/**
 * Widget dialog that sets the settings to repair XML contents where the XSD was changed below a
 * given VFS folder.
 *
 * <p>
 *
...
public class CmsXmlContentRepairDialog extends CmsWidgetDialog {
  ...
  protected static final String XMLCONTENTREPAIR_ACTION_REPORT =
      PATH_WORKPLACE + "admin/contenttools/reports/xmlcontentrepair.jsp";
   ...
   */
  public CmsXmlContentRepairDialog(
  ...
  protected String createDialogHtml(String dialog) {
    ...
    result.append(
        createWidgetBlockStart(
            Messages.get()
                .getBundle(getLocale())
                .key(Messages.GUI_XMLCONTENTREPAIR_DIALOG_BLOCK_SETTINGS_0)));
  ...
  protected void defineWidgets() {
    ...
    addWidget(
        new CmsWidgetDialogParameter(m_settings, "force", PAGES[0], new CmsCheckboxWidget("")));
  ...
  /**
   * Returns the selector widget options to build a XML content resource type selector widget.
   *
   * <p>
   *
  ...
  private List getXmlContentResourceTypes() {
    ...
    result.add(
        new CmsSelectWidgetOption(
            TYPE_XMLCONTENT, false, key(Messages.GUI_XMLCONTENTREPAIR_DIALOG_RESTYPE_GENERIC_0)));
