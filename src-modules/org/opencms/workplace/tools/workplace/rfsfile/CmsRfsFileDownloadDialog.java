...
/**
 * Shows useful information about the current file chosen within the <code>
 * {@link org.opencms.util.CmsRfsFileViewer}</code> and offers a direct download link.
 *
 * <p>
 *
 * @since 6.0.0
...
public class CmsRfsFileDownloadDialog extends CmsWidgetDialog {
   ...
   */
  public CmsRfsFileDownloadDialog(
  ...
  public void actionCommit() throws IOException, ServletException {
    ...
    getToolManager()
        .jspForwardPage(
            this, "/system/workplace/admin/workplace/logfileview/dodownload.jsp", params);
  ...
  protected void defineWidgets() {
    ...
    setFiledate(
        CmsDateUtil.getDateTime(
            new Date(getDownloadFile().lastModified()), DateFormat.MEDIUM, getLocale()));
  ...
  /**
   * Returns the file that will be downloaded upon clicking the download button generated in this
   * form by <code>{@link #dialogButtonsOkCancel()}</code>.
   *
   * <p>
   *
   * @return the file that will be downloaded upon clicking the download button generated in this
   *     form by <code>{@link #dialogButtonsOkCancel()}</code>
