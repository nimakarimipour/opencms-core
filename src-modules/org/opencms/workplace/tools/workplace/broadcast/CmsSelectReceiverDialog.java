...
public class CmsSelectReceiverDialog extends CmsWidgetDialog {
   ...
   */
  public CmsSelectReceiverDialog(
  ...
  public void actionCommit() {
    ...
    try {
      ...
      if (isEmail) {
        getToolManager()
            .jspForwardPage(
                this, "/system/workplace/admin/workplace/groups_send_email.jsp", params);
      } else {
        getToolManager()
            .jspForwardPage(
                this, "/system/workplace/admin/workplace/groups_send_popup.jsp", params);
      }
    } catch (Throwable t) {
      errors.add(t);
    }
  ...
  /**
   * Returns the message type parameter value.
   *
   * <p>
   *
  ...
  /**
   * Sets the message type parameter value.
   *
   * <p>
   *
  ...
  protected void defineWidgets() {
    ...
    addWidget(
        new CmsWidgetDialogParameter(this, "groups", "", PAGES[0], new CmsGroupWidget(), 0, 10));
  }
