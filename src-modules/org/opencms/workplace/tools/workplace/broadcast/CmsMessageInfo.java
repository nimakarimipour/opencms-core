...
public class CmsMessageInfo {
   ...
   * Sets the to string.
   *
   * <p>This has to be a ';' separated string of email-addresses.
   *
   * <p>
   *
  ...
  /**
   * Throws a runtime exception if the string is null, empty or contains JavaScript.
   *
   * <p>
   *
   ...
   */
  private List<InternetAddress> createInternetAddresses(String mailAddresses)
