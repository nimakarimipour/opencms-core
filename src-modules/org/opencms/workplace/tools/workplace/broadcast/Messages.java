...
public final class Messages extends A_CmsMessageBundle {
  ...
  /** Message constant for key in the resource bundle. */
  public static final String ERR_NO_SELECTED_USER_WITH_EMAIL_0 =
  ...
  /** Message constant for key in the resource bundle. */
  public static final String GUI_MESSAGE_EDITOR_LABEL_CONTENT_BLOCK_0 =
      "GUI_MESSAGE_EDITOR_LABEL_CONTENT_BLOCK_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_MESSAGE_EDITOR_LABEL_HEADER_BLOCK_0 =
  ...
  /** Message constant for key in the resource bundle. */
  public static final String GUI_SESSIONS_DETAIL_HIDE_EMAIL_HELP_0 =
      "GUI_SESSIONS_DETAIL_HIDE_EMAIL_HELP_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_SESSIONS_DETAIL_HIDE_EMAIL_NAME_0 =
      "GUI_SESSIONS_DETAIL_HIDE_EMAIL_NAME_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_SESSIONS_DETAIL_SHOW_EMAIL_HELP_0 =
      "GUI_SESSIONS_DETAIL_SHOW_EMAIL_HELP_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_SESSIONS_DETAIL_SHOW_EMAIL_NAME_0 =
  ...
  /** Message constant for key in the resource bundle. */
  public static final String GUI_SESSIONS_LIST_ACTION_MESSAGE_HELP_0 =
      "GUI_SESSIONS_LIST_ACTION_MESSAGE_HELP_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_SESSIONS_LIST_ACTION_MESSAGE_NAME_0 =
      "GUI_SESSIONS_LIST_ACTION_MESSAGE_NAME_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_SESSIONS_LIST_ACTION_NOTPENDING_HELP_0 =
      "GUI_SESSIONS_LIST_ACTION_NOTPENDING_HELP_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_SESSIONS_LIST_ACTION_NOTPENDING_NAME_0 =
      "GUI_SESSIONS_LIST_ACTION_NOTPENDING_NAME_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_SESSIONS_LIST_ACTION_PENDING_HELP_0 =
      "GUI_SESSIONS_LIST_ACTION_PENDING_HELP_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_SESSIONS_LIST_ACTION_PENDING_NAME_0 =
      "GUI_SESSIONS_LIST_ACTION_PENDING_NAME_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_SESSIONS_LIST_COLS_CREATION_0 =
      "GUI_SESSIONS_LIST_COLS_CREATION_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_SESSIONS_LIST_COLS_INACTIVE_0 =
  ...
  /** Message constant for key in the resource bundle. */
  public static final String GUI_SESSIONS_LIST_COLS_MESSAGE_HELP_0 =
  ...
  /** Message constant for key in the resource bundle. */
  public static final String GUI_SESSIONS_LIST_MACTION_EMAIL_CONF_0 =
      "GUI_SESSIONS_LIST_MACTION_EMAIL_CONF_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_SESSIONS_LIST_MACTION_EMAIL_HELP_0 =
      "GUI_SESSIONS_LIST_MACTION_EMAIL_HELP_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_SESSIONS_LIST_MACTION_EMAIL_NAME_0 =
      "GUI_SESSIONS_LIST_MACTION_EMAIL_NAME_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_SESSIONS_LIST_MACTION_KILL_HELP_0 =
      "GUI_SESSIONS_LIST_MACTION_KILL_HELP_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_SESSIONS_LIST_MACTION_KILL_NAME_0 =
      "GUI_SESSIONS_LIST_MACTION_KILL_NAME_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_SESSIONS_LIST_MACTION_MESSAGE_CONF_0 =
      "GUI_SESSIONS_LIST_MACTION_MESSAGE_CONF_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_SESSIONS_LIST_MACTION_MESSAGE_HELP_0 =
      "GUI_SESSIONS_LIST_MACTION_MESSAGE_HELP_0";

  /** Message constant for key in the resource bundle. */
  public static final String GUI_SESSIONS_LIST_MACTION_MESSAGE_NAME_0 =
