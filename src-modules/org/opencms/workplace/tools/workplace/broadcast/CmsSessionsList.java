...
public class CmsSessionsList extends A_CmsListDialog {
  ...
  public void executeListSingleActions() throws IOException, ServletException {
    ...
    if (getParamListAction().equals(LIST_ACTION_MESSAGE)
  ...
  protected void fillDetails(String detailId) {
    ...
    while (i.hasNext()) {
      ...
      CmsSessionInfo session =
          OpenCms.getSessionManager().getSessionInfo(new CmsUUID(item.getId()));
  ...
  protected List<CmsListItem> getListItems() throws CmsException {
    ...
    List<CmsOrganizationalUnit> manageableOus =
    ...
    while (itSessions.hasNext()) {
      ...
      CmsOrganizationalUnit userOu =
          OpenCms.getOrgUnitManager().readOrganizationalUnit(getCms(), user.getOuFqn());
      ...
      item.set(
          LIST_COLUMN_INACTIVE,
          new Long(System.currentTimeMillis() - sessionInfo.getTimeUpdated()));
      try {
  ...
  protected void setColumns(CmsListMetadata metadata) {
    ...
    messageCol.setHelpText(
        Messages.get().container(Messages.GUI_SESSIONS_LIST_COLS_MESSAGE_HELP_0));
    ...
    messageAction.setName(
        Messages.get().container(Messages.GUI_SESSIONS_LIST_ACTION_MESSAGE_NAME_0));
    messageAction.setHelpText(
        Messages.get().container(Messages.GUI_SESSIONS_LIST_ACTION_MESSAGE_HELP_0));
    ...
    // add pending action
    CmsListDirectAction pendingAction =
        new CmsListDirectAction(LIST_ACTION_PENDING_ENABLED) {
    ...
    pendingAction.setName(
        Messages.get().container(Messages.GUI_SESSIONS_LIST_ACTION_PENDING_NAME_0));
    pendingAction.setHelpText(
        Messages.get().container(Messages.GUI_SESSIONS_LIST_ACTION_PENDING_HELP_0));
    ...
    // not pending action
    CmsListDirectAction notPendingAction =
    ...
    notPendingAction.setName(
        Messages.get().container(Messages.GUI_SESSIONS_LIST_ACTION_NOTPENDING_NAME_0));
    notPendingAction.setHelpText(
        Messages.get().container(Messages.GUI_SESSIONS_LIST_ACTION_NOTPENDING_HELP_0));
    ...
    messageEditAction.setName(
        Messages.get().container(Messages.GUI_SESSIONS_LIST_ACTION_MESSAGE_NAME_0));
    messageEditAction.setHelpText(
        Messages.get().container(Messages.GUI_SESSIONS_LIST_ACTION_MESSAGE_HELP_0));
  ...
  protected void setIndependentActions(CmsListMetadata metadata) {
    ...
    emailDetail.setFormatter(
        new CmsListItemDetailsFormatter(
            Messages.get().container(Messages.GUI_SESSIONS_LABEL_EMAIL_0)));
    emailDetail.setShowActionName(
        Messages.get().container(Messages.GUI_SESSIONS_DETAIL_SHOW_EMAIL_NAME_0));
    emailDetail.setShowActionHelpText(
        Messages.get().container(Messages.GUI_SESSIONS_DETAIL_SHOW_EMAIL_HELP_0));
    emailDetail.setHideActionName(
        Messages.get().container(Messages.GUI_SESSIONS_DETAIL_HIDE_EMAIL_NAME_0));
    emailDetail.setHideActionHelpText(
        Messages.get().container(Messages.GUI_SESSIONS_DETAIL_HIDE_EMAIL_HELP_0));
  ...
  protected void setMultiActions(CmsListMetadata metadata) {
    ...
    messageMultiAction.setName(
        Messages.get().container(Messages.GUI_SESSIONS_LIST_MACTION_MESSAGE_NAME_0));
    messageMultiAction.setHelpText(
        Messages.get().container(Messages.GUI_SESSIONS_LIST_MACTION_MESSAGE_HELP_0));
    ...
    emailMultiAction.setName(
        Messages.get().container(Messages.GUI_SESSIONS_LIST_MACTION_EMAIL_NAME_0));
    emailMultiAction.setHelpText(
        Messages.get().container(Messages.GUI_SESSIONS_LIST_MACTION_EMAIL_HELP_0));
