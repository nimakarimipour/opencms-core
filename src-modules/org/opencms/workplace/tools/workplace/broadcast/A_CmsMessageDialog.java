...
public abstract class A_CmsMessageDialog extends CmsWidgetDialog {
  ...
  /**
   * Returns the list of session ids parameter value.
   *
   * <p>
   *
  ...
  /**
   * Sets the list of session ids parameter value.
   *
   * <p>
   *
  ...
  /**
   * Checks if the edited message has to be sent to all sessions.
   *
   * <p>
   *
