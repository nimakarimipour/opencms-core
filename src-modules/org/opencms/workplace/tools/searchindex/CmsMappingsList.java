...
/**
 * A list that displays the mappings of a request parameter given <code>
 * {@link org.opencms.search.fields.CmsLuceneField}</code> ("field").
 *
...
public class CmsMappingsList extends A_CmsEmbeddedListDialog {
  ...
  protected static final String LIST_ICON_MAPPING =
      "tools/searchindex/icons/small/fieldconfiguration-mapping.png";
  ...
  public void executeListSingleActions() throws ServletException, IOException {
    ...
    params.put(
        A_CmsMappingDialog.PARAM_FIELDCONFIGURATION, new String[] {m_paramFieldconfiguration});
    params.put(A_CmsMappingDialog.PARAM_TYPE, new String[] {item.get(LIST_COLUMN_TYPE).toString()});
    params.put(
        A_CmsMappingDialog.PARAM_PARAM, new String[] {item.get(LIST_COLUMN_VALUE).toString()});
  ...
  /**
   * Returns the request parameter "field".
   *
   * <p>
   *
  ...
  /**
   * Sets the request parameter "field".
   *
   * <p>Method intended for workplace-proprietary automatic filling of request parameter values to
  ...
  protected void setColumns(CmsListMetadata metadata) {
    ...
    editAction.setHelpText(
        Messages.get().container(Messages.GUI_LIST_MAPPING_COL_EDIT_NAME_HELP_0));
  ...
  protected void setMultiActions(CmsListMetadata metadata) {
    ...
    deleteMultiAction.setName(
        Messages.get().container(Messages.GUI_LIST_FIELD_MACTION_DELETEMAPPING_NAME_0));
