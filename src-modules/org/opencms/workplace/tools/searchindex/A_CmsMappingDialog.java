...
/**
 * Abstract widget dialog for all dialogs working with <code>{@link CmsSearchFieldMapping}</code>.
 *
 * <p>
 *
 * @since 6.5.5
...
public class A_CmsMappingDialog extends CmsWidgetDialog {
  ...
  /**
   * The request parameter for the mapping type to work with when contacting this dialog from
   * another.
   *
   * <p>
   */
