  ...
  public I_CmsReportThread initializeThread() {
    ...
    CmsSearchReplaceSettings settings =
        (CmsSearchReplaceSettings)
            ((Map) getSettings().getDialogObject()).get(CmsSourceSearchDialog.class.getName());
    if (settings == null) {
      settings =
          (CmsSearchReplaceSettings)
              ((Map) getSettings().getDialogObject()).get(CmsSourceSearchDialog.class.getName());
    ...
    // org.opencms.workplace.list.A_CmsListReport.actionCloseDialog() method is overwritten here in
    // this class
