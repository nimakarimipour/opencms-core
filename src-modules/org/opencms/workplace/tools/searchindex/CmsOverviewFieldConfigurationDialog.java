...
/**
 * Widget dialog for an overview of a <code>
 * {@link org.opencms.search.fields.CmsLuceneFieldConfiguration}</code>.
 *
 * <p>
 *
 * @since 6.5.5
...
public class CmsOverviewFieldConfigurationDialog extends A_CmsFieldConfigurationDialog {
   ...
   */
  public CmsOverviewFieldConfigurationDialog(
  ...
  protected void defineWidgets() {
    ...
    addWidget(
        new CmsWidgetDialogParameter(
            m_fieldconfiguration, "name", PAGES[0], new CmsDisplayWidget()));
    addWidget(
        new CmsWidgetDialogParameter(
            m_fieldconfiguration, "description", PAGES[0], new CmsDisplayWidget()));
  }
}
