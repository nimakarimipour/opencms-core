...
/**
 * A list dialog that may be embedded in the output of other <code>
 * {@link org.opencms.workplace.CmsDialog}</code> instances.
 *
 * <p>With std. <code>{@link org.opencms.workplace.list.A_CmsListDialog}</code> this attempt will
 * result in double gray headers in the workplace.
 *
 * <p>
 *
 * <h4>Howto</h4>
...
public abstract class A_CmsEmbeddedListDialog extends A_CmsListDialog {
  ...
  /**
   * Overrides the implementation to skip generation of gray header.
   *
   * <p>
   *
  ...
  public String defaultActionHtmlStart() {
    ...
    return new StringBuffer(getList().listJs())
        .append(dialogContentStart(getParamTitle()))
        .toString();
  }
}
