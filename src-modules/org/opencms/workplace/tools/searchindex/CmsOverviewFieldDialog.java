...
/**
 * Widget dialog for an overview of a <code>{@link org.opencms.search.fields.CmsLuceneField}</code>.
 *
 * <p>
 *
 * @since 6.5.5
...
public class CmsOverviewFieldDialog extends A_CmsFieldDialog {
  ...
  protected void defineWidgets() {
    ...
    addWidget(
        new CmsWidgetDialogParameter(m_field, "displayName", PAGES[0], new CmsDisplayWidget()));
    ...
    addWidget(
        new CmsWidgetDialogParameter(m_field, "defaultValue", PAGES[0], new CmsDisplayWidget()));
  }
}
