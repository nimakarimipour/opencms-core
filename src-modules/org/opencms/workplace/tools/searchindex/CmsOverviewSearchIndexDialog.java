...
public class CmsOverviewSearchIndexDialog extends A_CmsEditSearchIndexDialog {
   ...
   */
  public CmsOverviewSearchIndexDialog(
  ...
  protected void defineWidgets() {
    ...
    addWidget(
        new CmsWidgetDialogParameter(
            getSearchIndexIndex(), "rebuildMode", PAGES[0], new CmsDisplayWidget()));
    addWidget(
        new CmsWidgetDialogParameter(
            getSearchIndexIndex(), "locale", PAGES[0], new CmsDisplayWidget()));
    addWidget(
        new CmsWidgetDialogParameter(
            getSearchIndexIndex(), "project", PAGES[0], new CmsDisplayWidget()));
    addWidget(
        new CmsWidgetDialogParameter(
