...
public class CmsReport extends CmsMultiDialog {
   ...
   */
  public static CmsReport initCmsReport(
   ...
   *
   * <p>This row is displayed when the first report is running.
   *
   * <p>
   *
   ...
   * Builds a button row with an "Ok", a "Cancel" and a "Details" button.
   *
   * <p>This row is used when a single report is running or after the first report has finished.
   *
   * <p>
   *
   * @param okAttrs optional attributes for the ok button
   ...
   * @return the button row
   */
  public String dialogButtonsOkCancelDetails(
      String okAttrs, String cancelAttrs, String detailsAttrs) {
      ...
      try {
        ...
        if (LOG.isInfoEnabled()) {
          LOG.info(
              Messages.get()
                  .getBundle()
                  .key(Messages.LOG_THREAD_CREATION_FAILED_1, new Integer(value)),
              e);
        }
      }
    }
