 ...
 *
 * <p>Extend this class in order to create a tab styled dialog and provide the methods getTabs() and
 * getTabParameterOrder() in the new dialog class which should return lists which represent the tabs
 * of the dialog.
 *
 * <p>This class is used for the following dialogs:
 *
 * <ul>
...
public abstract class CmsTabDialog extends CmsDialog {
   ...
   *
   * <p>This method has to be called once in initWorkplaceRequestValues after filling the request
   * parameters.
   *
   * <p>
   *
   ...
   *
   * <p>For example, all parameters stored in tab 1 have the prefix "Tab1", i.e. the getter and
   * setter methods must be getParam<b>Tab1</b>MyParameterName().
   *
   * <p>To change the tab order, simply change the order in the String array and in the generated
   * tab list.
   *
   * <p>
   *
  ...
  public String htmlStart(String helpUrl) {
    ...
    result.append(
        "\tdocument.forms[0]." + PARAM_ACTION + ".value = \"" + DIALOG_SWITCHTAB + "\";\n");
   ...
   *
   * <p>This overwrites the method in CmsWorkplace because for each tab, only the hidden parameters
   * of the non displayed tabs are added.
   *
   * <p>
   *
